...
import { generateCML } from "../src/agent3-cml.js";
...
async function runBenchmark() {
    ...
    for (const result of results) {
        ...
        console.log(`${result.axis.padEnd(11)} | ${status.padEnd(7)} | ${result.attempts}        | ${result.latencyMs.toString().padEnd(6)}ms | $${result.cost.toFixed(4).padEnd(7)} | ${result.errors}`);
    }
    // Targets
    console.log("\n\n=== TARGET VALIDATION ===\n");
