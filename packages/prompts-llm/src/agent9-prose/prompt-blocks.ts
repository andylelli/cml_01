...
export const buildLocationProfilesBlock = (
  ...
  /**
   * `sensoryGuidance` LEADS the block. It used to trail it, and the cap ate it.
   *
   * MEASURED on run mystery-1788537332588: `location_profiles` (cap 1000) is truncated in **43 of 43**
   * prose prompts, and the cut lands mid-word inside the anti-transcription rule —
   * `"…DO NOT TRANSCRIBE VERBATIM: The above profiles are structural guides only. Generate origi"`.
   * Everything after that point reached no prompt at all: the rest of that prohibition, the whole
   * SCENE OPENING RULE, and all five sensory techniques.
   *
   * The SCENE OPENING RULE is the direct prohibition on the defect reviewers keep naming — *"write
   * what the POV character directly observes… NOT a general description of the room's qualities. The
   * reader must feel present, not briefed."* A_82 §12.8 measured 10 of 10 chapter openers as
   * location-templated. The rule against it was being deleted before the model ever saw it.
   *
   * So the block handed over its sensory palette in full and dropped the instructions governing that
   * palette — the same shape as the PAGE SHAPE operations at the tail of `craft_guide`. Reference
   * data is cheap to lose; the rules that govern it are not. Rules first, data second: if a cap ever
   * bites again it now costs a location profile rather than the prohibition on copying one.
   */
  let locationResult = '\n\nLOCATION PROFILES:\n\nYou have rich location profiles to draw from. Use them to create vivid, atmospheric scenes.' + sensoryGuidance + '\n\n' + locationLine + '\n\nKey Locations Available:\n' + keyLocs + '\n\nAtmosphere (tonal cue only — do NOT reproduce this phrase verbatim in prose; translate into scene-specific, character-observed sensory language): ' + mood + '\nWeather: ' + weather + eraMarkersStr + '\n\nUSAGE GUIDELINES:\n1. First mention of location: Ground the scene using sensory details drawn from the profiles — paraphrase these into what the POV character directly observes and experiences, not a summary of the room\'s general qualities\n2. Geographic grounding: Reference the specific place (' + (geographicContext || 'setting') + ') naturally in dialogue or narrative\n3. Action scenes: Integrate physical layout details (access, sightlines, constraints)\n4. Atmospheric scenes: Reference weather, lighting, sounds from sensory palette\n5. Era details: Weave in period markers naturally\n6. Consistency: Keep all location descriptions aligned with profiles\n7. OPENING GROUNDING (required, first 1-2 paragraphs of EVERY chapter): (a) name the specific location from this list, (b) give at least 2 concrete sensory details (sound, smell, temperature, texture, light/shadow), and (c) one time-of-day or weather/atmosphere detail — BEFORE advancing plot, clues, or the mechanism. Open on the setting and the people in it, not on the puzzle.\n8. This matters most in pre-reveal chapters that withhold the mechanism: ground them in setting and character rather than rushing the investigation — a withheld chapter is not an empty one.\n9. Do NOT use generic repeated manor/storm filler without profile-specific details; vary the opening location/sense each chapter\n\nSENSORY PALETTE (use 2-3 senses per scene):\n' + sensoryExamples;
