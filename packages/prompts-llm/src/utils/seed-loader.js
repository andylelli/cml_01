...
export function loadSeedCMLFiles(examplesDir) {
...
export function extractStructuralPatterns(cmlFiles) {
...
export function selectRelevantPatterns(patterns, targetAxis, maxPatterns = 3) {
    // Filter to same axis
