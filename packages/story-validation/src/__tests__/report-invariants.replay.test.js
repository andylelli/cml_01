...
describe('GenerationReport invariant replay fixtures', () => {
    it('detects known contradiction in run_9b2fcacd report', () => {
        ...
        const reportPath = join(here, '..', '..', '..', '..', 'validation', 'quality-report-run_9b2fcacd-99b6-4b55-ae52-30bb7e5fd263.json');
...
//# sourceMappingURL=report-invariants.replay.test.js.map