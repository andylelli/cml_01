...
export function passesThreshold(score, config) {
    ...
    const meetsComponentMinimums = score.validation_score >= COMPONENT_MINIMUMS.validation_score &&
 ...
 */
export function getFailedComponents(score) {
    const failed = [];
 ...
 */
export function getThreshold(agent, config) {
    const mode = THRESHOLD_MODES[config.mode];
