...
export class EraAuthenticityValidator {
    ...
    checkPeriodMarkers(scene, era) {
        ...
        const hasPeriodTech = era.technologyAvailable.some(tech => new RegExp(`\\b${tech}\\b`, 'i').test(scene.text));
...
//# sourceMappingURL=era-validator.js.map