...
export class PhysicalPlausibilityValidator {
    ...
    validateStruggleEvidence(scene) {
        const errors = [];
...
//# sourceMappingURL=physical-validator.js.map