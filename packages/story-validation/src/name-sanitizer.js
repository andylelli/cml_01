...
function normalizeSurnameToken(s) {
    return s.replace(/[.,;:!?"'”’)]$/g, '');
}
export function buildValidSurnames(validCastNames) {
    return new Set(validCastNames
 ...
 */
export function findUnknownTitledNameMentions(text, validCastNames) {
 ...
 */
export function anonymizeUnknownTitledNames(text, validCastNames) {
    const validSurnames = buildValidSurnames(validCastNames);
