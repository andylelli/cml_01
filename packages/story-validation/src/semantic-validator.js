 ...
 */
export async function semanticValidateDiscriminatingTest(sceneText, client) {
 ...
 * - Provides evidence or reasoning
 */
export async function semanticValidateSuspectElimination(sceneText, suspectName, client) {
 ...
 */
export async function semanticValidateCulpritEvidence(sceneText, culpritName, client) {
