...
export interface MysteryGenerationInputs {
  ...
  theme: string;
  /**
   * A world for the story to draw on — "a racing stable", "a by-election" — that colours the setting,
   * the cast's occupations and the motive without being the mechanism. Generated by
   * scripts/run-params.mjs (STORY_ANGLES). Agents 2e/3b/3 see it inside the theme text; this field
   * exists because Agents 1 and 2 never see the theme at all.
   */
  storyAngle?: string;
