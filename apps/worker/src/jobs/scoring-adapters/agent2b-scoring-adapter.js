...
export function adaptCharacterProfilesForScoring(profiles) {
    const character_profiles = profiles.map(p => {
...
//# sourceMappingURL=agent2b-scoring-adapter.js.map