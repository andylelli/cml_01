...
describe("KeyboardShortcutHelp", () => {
    ...
    it("emits close when close button is clicked", async () => {
        ...
        const closeBtn = buttons.find((b) => b.text().toLowerCase().includes("close") || b.attributes("aria-label")?.toLowerCase().includes("close"));
        if (closeBtn) {
...
//# sourceMappingURL=KeyboardShortcutHelp.test.js.map