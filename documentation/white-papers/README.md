...
| [WP-003](WP-003-inspiration-without-copying.md) | Inspiration without copying | The reusable asset is the shape of the deception, and the right operation is a morph: keep an attested book’s shape on two of three dimensions, change the third, and land in a cell no book occupies — an obligation, not a prohibition, with the anti-copy gate as the guarantee. The corpus is big enough in words (12.3M) and not in shapes: 34 of 480 cells, 45% one axis, 0.67 new cells per encode and falling; the constraint is spread and a classifier that misfiles the forged-fingerprint novel, not count. Falsifier: one run, read at the CML stage, no reader | 2026-09-18 |
