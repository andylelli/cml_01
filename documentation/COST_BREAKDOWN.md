...
This document provides a complete breakdown of all chargeable costs in the mystery generation system. All costs are for Azure OpenAI API calls using GPT-4o-mini in Sweden Central, expressed in GBP (£).
...
- **Cost**: £0.00013035 per 1,000 tokens (Sweden Central regional)

**Completion Tokens** (Output):
- Everything the model generates
- The AI's response/output
- Generated text, structured data, CML
- **Cost**: £0.00052140 per 1,000 tokens (Sweden Central regional)

**Why completion costs more**: Completion tokens are priced 4× prompt tokens for GPT-4o-mini.

---

## Pricing Model (as of February 2026)

### Base Rates (Sweden Central, GPT-4o-mini)
- **GPT-4o-mini Prompt Tokens**: £0.00013035 per 1,000 tokens
- **GPT-4o-mini Completion Tokens**: £0.00052140 per 1,000 tokens

### Cost Calculation Formula
```
Total Cost = (Prompt Tokens / 1000 × £0.00013035) + (Completion Tokens / 1000 × £0.00052140)
```
...
Prompt Cost: 2,000 / 1,000 × £0.00013035 = £0.00026
Completion Cost: 1,500 / 1,000 × £0.00052140 = £0.00078
Total Cost: £0.00104
```

## Agent-by-Agent Cost Breakdown

**Note**: Token ranges remain valid; all GBP estimates below use Sweden Central GPT-4o-mini rates.
Cost tracking in run events and LLM logs is reported in GBP.
...
**Cost Breakdown**:
```
Prompt: 1,200 tokens × £0.00013035/1k = £0.00016
Completion: 800 tokens × £0.00052140/1k = £0.00042
Low: £0.00057

Prompt: 1,500 tokens × £0.00013035/1k = £0.00020
Completion: 1,200 tokens × £0.00052140/1k = £0.00063
High: £0.00082
```

**Estimated Cost per Run**: **£0.00057 - £0.00082**
...
```
Prompt: 1,500 tokens × £0.00013035/1k = £0.00020
Completion: 2,500 tokens × £0.00052140/1k = £0.00130
Low: £0.00150

Prompt: 2,000 tokens × £0.00013035/1k = £0.00026
Completion: 3,500 tokens × £0.00052140/1k = £0.00182
High: £0.00209
```

**Estimated Cost per Run**: **£0.00150 - £0.00209**
...
**Purpose**: Expands cast details into full narrative profiles (LLM)

**Configuration**:
- Temperature: 0.6 (moderate - rich characterization)
- Max Tokens: 4000
- Model: GPT-4o-mini

**Typical Token Usage**:
- Prompt Tokens: ~1,500-2,000 (cast + setting context)
- Completion Tokens: ~3,000-4,500 (4-6 paragraphs per character)
- Total: ~4,500-6,500 tokens

**Cost Breakdown**:
```
Prompt: 1,500 tokens × £0.00013035/1k = £0.00020
Completion: 3,000 tokens × £0.00052140/1k = £0.00156
Low: £0.00176

Prompt: 2,000 tokens × £0.00013035/1k = £0.00026
Completion: 4,500 tokens × £0.00052140/1k = £0.00235
High: £0.00261
```

**Estimated Cost per Run**: **£0.00176 - £0.00261**

**What You Get**:
- 1 profile per character
- Public persona + private secrets
- Motive/alibi/access context
- Multi-paragraph narrative bio
...
**Cost Breakdown**:
```
Prompt: 3,000 tokens × £0.00013035/1k = £0.00039
Completion: 5,000 tokens × £0.00052140/1k = £0.00261
Low: £0.00300

Prompt: 4,000 tokens × £0.00013035/1k = £0.00052
Completion: 7,000 tokens × £0.00052140/1k = £0.00365
High: £0.00417
```
...
**Estimated Cost per Run**: **£0.00300 - £0.00417**
...
**Estimated Cost per Run**: **£0.00313 - £0.00430** (if triggered)
...
**Total Cost if Triggered**: **Agent 3 + Agent 4 = £0.00613 - £0.00847**
...
**Estimated Cost per Run**: **£0.00104 - £0.00137**
...
**Estimated Cost per Run**: **£0.00089 - £0.00126**
...
**Estimated Cost per Run**: **£0.00163 - £0.00222**
...
**Estimated Cost per Run**: **£0.00091 - £0.00130**
...
**Purpose**: Generates full narrative prose from outline + CML + cast (LLM)

**Configuration**:
- Temperature: 0.7 (creative prose)
- Max Tokens: 4000
- Model: GPT-4o-mini

**Typical Token Usage**:
- Prompt Tokens: ~3,500-4,500 (outline + CML summary)
- Completion Tokens: ~6,000-9,000 (multi-paragraph prose)
- Total: ~9,500-13,500 tokens

**Cost Breakdown**:
```
Prompt: 3,500 tokens × £0.00013035/1k = £0.00046
Completion: 6,000 tokens × £0.00052140/1k = £0.00313
Low: £0.00358

Prompt: 4,500 tokens × £0.00013035/1k = £0.00059
Completion: 9,000 tokens × £0.00052140/1k = £0.00469
High: £0.00528
```

**Estimated Cost per Run**: **£0.00358 - £0.00528**

**What You Get**:
- Chapter-by-chapter prose
- 2-4 paragraphs per chapter
- Tone matched to narrative style
...
```
Agent 1: £0.00057 - £0.00082
Agent 2: £0.00150 - £0.00209
Agent 2b: £0.00176 - £0.00261
Agent 3: £0.00300 - £0.00417
Agent 5: £0.00104 - £0.00137
Agent 6: £0.00089 - £0.00126
Agent 7: £0.00163 - £0.00222
Agent 8: £0.00091 - £0.00130
Agent 9: £0.00358 - £0.00528
─────────────────────
TOTAL:   £0.0148 - £0.0211
```
...
```
Base minus Agent 8: £0.0139 - £0.0198
With Agent 4:       £0.0170 - £0.0241
```

### Typical Generation Cost: **£0.015 - £0.025**
...
### Regenerate Setting
- Agent 1 only: **£0.00057 - £0.00082**

### Regenerate Cast
- Agent 2 only: **£0.00150 - £0.00209**

### Regenerate Clues
- Agent 5 only: **£0.00104 - £0.00137**

### Regenerate Outline
- Agent 7 only: **£0.00163 - £0.00222**

### Regenerate Story (Prose)
- Prose agent: **£0.0035 - £0.0054** (estimated, implemented)

### Regenerate Character Profiles
- Character profiles agent: **£0.0025 - £0.0040** (estimated, implemented)
...
- **Agent 4 revision triggered** → +£0.00313-£0.00430
- **More seed patterns loaded** → Agent 3 +5-10%

### Lower Costs
- **Skip novelty check** → -£0.00091-£0.00130
...
1. **Run Events** (Advanced > History tab)
   - Final event shows: "Total cost: £X.XXXX"
   
2. **Console Logs** (for developers)
   - Each agent logs its cost
   - Format: "Agent X cost: £0.XXXX"
...
```typescript
{
   skipNoveltyCheck: true  // Save ~£0.001
}
```
**Savings**: ~7-12% per generation
...
- **Full regeneration**: £0.010-£0.018
- **Cast only**: £0.00150-£0.00209 (10-20% of full)
- **Clues only**: £0.00104-£0.00137 (6-12% of full)
...
- Completion tokens cost 4× prompt tokens
...
|--------------|----------------|-------------------|
| 10,000-12,000 | £0.0036-£0.0044 | Simple, short, 6 characters |
| 15,000-18,000 | £0.0055-£0.0066 | Medium, typical |
| 20,000-25,000 | £0.0073-£0.0091 | Complex, long, 10-12 characters |
| 30,000+ | £0.011+ | Very complex + revision |

*Assumes ~40% prompt / 60% completion mix.*
...
```
Initial Generation: £0.0211
Regenerate Cast: £0.00209
Regenerate Clues: £0.00137
Final Total: £0.0246
```
...
### vs. Human Writer
- **AI Generation**: £0.01-£0.02 per mystery (~2 minutes)
- **Human Writer**: £500-2000 per mystery (~20-40 hours)
- **AI is 25,000-100,000x cheaper**

### vs. Other AI Services
- **OpenAI API (direct)**: £0.01-£0.02
- **Anthropic Claude**: £0.02-£0.04 (estimated)
...
A: Technically yes (change deployment name), but quality will be significantly lower. GPT-4o-mini is recommended for mystery generation.
...
### Expected Costs
- **Typical mystery generation**: £0.015 - £0.025
- **Quick test**: £0.0139 - £0.0198
- **Production quality**: £0.0179 - £0.0254
- **Regenerating single component**: £0.00057 - £0.00528
...
**Average cost per publishable mystery**: **£0.020**
