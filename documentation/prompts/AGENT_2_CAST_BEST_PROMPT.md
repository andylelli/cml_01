...
- Good motive/opportunity coupling: specific motive consequence + specific time window + valid access enum.
- Weak coupling to avoid: vague motive and vague time window.
- Good red herring: plausible suspicion with later-verifiable contradiction.
- Detective rule: detective name must never appear in possibleCulprits.
