...
This folder contains production prompt templates for active pipeline agents.
...
- Agent 9: `documentation/prompts/AGENT_9_PROSE_BEST_PROMPT.md`
...
## Scope Note
Agent 9 has a dedicated runtime-equivalent prompt contract document due to its stateful
batching, obligation validation, and retry architecture.
