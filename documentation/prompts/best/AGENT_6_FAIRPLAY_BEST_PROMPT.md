...
Quality bar:
- Findings cite concrete clue IDs, inference steps, or CML fields.
- Critical fairness breaks are separated from moderate craft issues.
- Recommendations are actionable and minimally invasive.

Micro-exemplar:
- Weak violation: "Fair play is weak."
- Strong violation: "Critical Information Parity breach: step 3 depends on purchase receipt absent from early/mid clues; add reader-visible clue before discriminating test."

Silent checklist before return:
- every failed check cites exact location
- severity matches solvability impact
