...
Quality bar:
- Location detail must support mystery mechanics (access, sightlines, concealment, trace persistence).
- Sensory language should be specific and period-grounded, not generic mood filler.
- sensoryVariants must create real atmospheric contrast reusable by prose generation.
...
- Strong accessControl: "Staff enter before dawn for coal; family access resumes after breakfast; library is locked after dinner."

Silent checklist before return:
- complete top-level atmosphere object
- keyLocations are structured objects
- sensoryDetails entries are rich sentences
- required sensoryVariants coverage present
