...
Quality bar:
- Prefer concrete historical texture over broad claims.
- Keep all fields aligned to the same selected month/year.
- Ensure atmospheric material is directly reusable in scene prose.

Micro-exemplars:
- Weak majorEvents: "political tensions in Europe"
- Strong majorEvents: "cabinet instability after budget cuts debated in Westminster; shipping insurance rates rise after Atlantic losses"
- Weak typicalPrices: "bread is affordable"
- Strong typicalPrices: "Bread loaf: four pence; Coal refill: one shilling sixpence; Taxi across town: two shillings"

Silent checklist before return:
- exact generated month/year preserved
- nested objects/arrays match schema
- no anachronisms
- narrative paragraphs, not fragments
