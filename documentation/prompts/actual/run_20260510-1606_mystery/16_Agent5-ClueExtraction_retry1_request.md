...
- Project ID: `unknown`
- Timestamp: `2026-05-10T16:10:20.989Z`
...
1. Generate a clue that makes the reader directly observe: "The clock in the study shows the hands pointing to ten minutes past eleven...."
   → observation | essential | early | temporal | step 1 | terms: clock, study, shows

2. Generate a clue that provides evidence for: "This indicates the clock was not showing the correct time at the moment of the murder...."
   → contradiction | essential | early | temporal | step 1 | terms: indicates, clock, showing

3. Generate a clue that makes the reader directly observe: "A note found in the study states 'Meet me at twenty minutes past eleven'...."
   → observation | essential | early | temporal | step 2 | terms: found, study, states

4. Generate a clue that provides evidence for: "This suggests Eleanor expected to meet someone shortly after the time noted, contradicting the clock..."
   → contradiction | essential | early | temporal | step 2 | terms: suggests, eleanor, expected

5. Generate a clue that makes the reader directly observe: "Witnesses recalled hearing the clock chime at a quarter past eleven...."
   → observation | essential | mid | temporal | step 3 | terms: witnesses, recalled, hearing

6. Generate a clue that provides evidence for: "The discrepancy between the clock's time and the witness statement indicates the clock was tampered ..."
   → contradiction | essential | mid | temporal | step 3 | terms: discrepancy, between, clock's

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "This indicates the clock was not showing the correct time at the moment of the murder...."
   → contradiction | essential | mid | temporal | step 1 | terms: indicates, clock, showing

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The clock was wound back to mislead witnesses about the murder timing...."
   → observation | essential | early | temporal | terms: clock, wound, mislead

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Reconstruct the timeline by comparing the clock's chime with Dr. Mallory Finch's alibi to confirm th..."
   → observation | essential | mid | temporal | terms: reconstruct, timeline, comparing
...
10. Generate one essential mid-story clue whose description or pointsTo explicitly names Dr. Mallory Finch and states the unique trace, preparation detail, or mechanism link that points to Dr. Mallory Finch rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Dr. Mallory Finch, clock, wound, mislead

11. Generate a clue showing observable evidence of Dr. Mallory Finch's premeditation or planning (Desperation for money). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: desperation, money
...
13. Generate one essential early or mid elimination clue that explicitly rules out Captain Ivor Hale and narrows the solution toward culprit Dr. Mallory Finch. The pointsTo text must start with "Eliminates Captain Ivor Hale because ..." and cite corroborated evidence.
...
Create 2 red herrings that support the false assumption: "The clock showed the correct time at the moment of the murder."
...
Violations: 1. [critical] Clue Visibility: Essential clues regarding the clock's tampering are not revealed before the discriminating test.; 2. [critical] Information Parity: The detective has knowledge about the clock's tampering that the reader does not have access to until later.; 3. [critical] Logical Deducibility: The reader cannot logically deduce the solution due to late clue revelations.; 4. [critical] Discriminating Test Timing: The timing of the discriminating test does not align with the established quality controls.; 5. [critical] No Withholding: Key information about the clock's tampering is withheld from the reader.
Warnings: Consider adding more red herrings to enhance the complexity of the false assumption.; First-pass acceptance contract: essential early|mid mechanism, contradiction, and elimination clues; reader-solvable observation -> correction -> elimination chain before Act III.; Unified retry contract: keep cast-path coupling, discriminating evidence ID parity, and mechanism-visibility ordering non-conflicting in one output.
...
- REQUIRED CLUE CONTENT (must be covered by essential early/mid clues):
  ...
  - no_withholding
- must_fix[]:
  - [critical] Clue Visibility: Essential clues regarding the clock's tampering are not revealed before the discriminating test.
  ...
  - [critical] Logical Deducibility: The reader cannot logically deduce the solution due to late clue revelations.
  - [critical] Discriminating Test Timing: The timing of the discriminating test does not align with the established quality controls.
  - [critical] No Withholding: Key information about the clock's tampering is withheld from the reader.
  - [warning] Consider adding more red herrings to enhance the complexity of the false assumption.
...
- required_id_to_source_mappings[]:
  ...
  - clue_5 -> CASE.prose_requirements.clue_to_scene_mapping[7].clue_id
  - clue_6 -> CASE.prose_requirements.clue_to_scene_mapping[8].clue_id
  - clue_8 -> CASE.prose_requirements.clue_to_scene_mapping[9].clue_id
  - clue_fp_contradiction_step_3 -> CASE.prose_requirements.clue_to_scene_mapping[11].clue_id
...
- required_direct_culprit_clue:
  ...
  - allowed_source_paths=CASE.cast[1].access_plausibility, CASE.cast[1].alibi_window, CASE.inference_path.steps[0].observation, CASE.inference_path.steps[0].correction, CASE.inference_path.steps[2].observation, CASE.inference_path.steps[2].correction
