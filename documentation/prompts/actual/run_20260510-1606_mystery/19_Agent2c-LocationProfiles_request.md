...
- Project ID: ``
- Timestamp: `2026-05-10T16:11:20.048Z`
...
- Era-authentic markers: petrol touring cars on county roads, domestic wiring with frequent outages, typewriters standard in homes and offices, early telephones in homes, reliable automobiles for local travel, passenger trains as primary long-distance transport, early commercial aviation for urgent travel, party-line telephone exchanges common in rural areas
- Tone: Classic
- No anachronisms
...
Description: A large, imposing country estate with expansive grounds and intricate architectural details, including high ceilings, grand staircases, and a mix of Gothic and Classical elements.
...
Setting constraints:
- Physical constraints: Geographic layout creates natural movement pathways and dead ends, Architecture includes locked rooms and hidden compartments, Weather conditions can affect evidence visibility and outdoor access
- Geographic isolation: The estate is situated several miles from the nearest town, providing a degree of isolation.
- Access control: Restricted areas such as the private study and cellar, Daily routines dictate access to various parts of the house, Social hierarchies enforce who can enter specific rooms

Era constraints to include:
- Technology: petrol touring cars on county roads, domestic wiring with frequent outages, typewriters standard in homes and offices
- Transportation: reliable automobiles for local travel, passenger trains as primary long-distance transport
- Social norms: Great Depression impacting social classes, class tensions prevalent in society
