...
- Project ID: ``
- Timestamp: `2026-05-11T20:07:47.321Z`
...
Description: A large, stately country house with ornate architectural details, expansive grounds, and segregated areas for staff and guests.
...
Setting constraints:
- Physical constraints: multiple access points with restricted areas for staff, gardens and woodlands limit visibility from the main house, weather can affect outdoor evidence collection
...
- Social norms: Great Depression impacting social classes, class tensions prevalent among estate staff and owners
