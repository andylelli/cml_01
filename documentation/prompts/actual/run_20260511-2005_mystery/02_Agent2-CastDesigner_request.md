...
- Project ID: ``
- Timestamp: `2026-05-11T20:05:35.615Z`
...
**Setting**: 1930s - A large, stately country house with ornate architectural details, expansive grounds, and segregated areas for staff and guests.
**Crime Type**: Murder
**Social Context**: Great Depression impacting social classes, class tensions prevalent among estate staff and owners, rising fascism in Europe affecting local politics
**Tone**: Classic
