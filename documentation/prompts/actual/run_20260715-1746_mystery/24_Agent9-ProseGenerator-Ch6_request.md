...
- Project ID: ``
- Timestamp: `2026-07-15T17:59:26.459Z`
...
• [clue_12] beatrice, quill, expressed, jealousy, towards, eleanor, relationship
  Category: behavioral | Criticality: essential | Supports inference step 2
  Points to: beatrice, quill, motive, murder

• [clue_5] footprints, leading, away, water, match, beatrice, quill, shoe, size
  Category: physical | Criticality: essential | Supports inference step 3
  Points to: beatrice, quill, scene

• [clue_early_1] eleanor, body, twenty, past, midnight
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_4, clue_9, clue_culprit_direct_beatrice_quill, clue_7, clue_8, clue_11, clue_core_elimination_chain, clue_10, clue_culprit_direct_1 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): victim, still, alive, tide, falling | victim, drown, high, tide | victim, drowning, aligns, tide | victim, cause, death, drowning | direct, shows, beatrice, quill, means, opportunity | beatrice, quill, motive | beatrice, quill, scene, crime | timeline, events, leading, drowning | mallory, finch, culprit | captain, ivor, hale, culprit | physical, trace, opportunity, indicate, beatrice, quill
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the evening deepened, the rain eased, leaving the air heavy with the scent of wet earth and the promise of another uncertain day. Hugo gathered his notes, thanked his companions, and rose. The investigation had shifted again—Mallory Finch and Ivor Hale were..."
...
Known location profile anchors: The Azure Crest Hotel, Grand Lobby, Oceanview Dining Room, Basement Storage Room, Guest Rooms, the hotel bar
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Azure Crest Hotel", "Grand Lobby", "Oceanview Dining Room", "Basement Storage Room", "Guest Rooms", "the hotel bar"
...
- Chapter 5 (score 97/100):
  Quality gaps noted: scene grounding weakness
  Address in upcoming chapters: Open next chapter with a named location anchor plus at least two sensory cues and one atmosphere marker.
- Phrases to avoid (already overused in earlier chapters): "you must understand it s a matter", "must understand it s a matter of", "understand it s a matter of life", "s a matter of life and death", "i ve seen worse in the trenches".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=17339; context=5771; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 6:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the evening deepened, the rain eased, leaving the air heavy with the scent of wet earth and the promise of another uncertain day. Hugo gathered his notes, thanked his companions, and rose. The investigation had shifte...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • time, body, discovery, reported [clue_11]
      Points to: timeline, events, leading, drowning
    • witnesses, report, beatrice, jealousy [clue_12]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • shows, timing, victim, last, sighting [clue_6]
      Points to: victim, alive, tide, fall
    ...
    • witnesses, interviewed, eleanor, whereabouts [clue_culprit_direct_1]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • time, body, discovery, reported [clue_early_1]
      Points to: timeline, events, leading, drowning
    • witnesses, interviewed, eleanor, whereabouts [clue_fp_contradiction_step_3]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • witnesses, interviewed, eleanor, whereabouts [clue_mid_1]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The group consensus identifying Beatrice as the prime suspect."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes a convincing but flawed theory placing blame on Beatrice."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Hugo feels the weight of the room's gaze as he considers the evidence."
      ]
    },
    ...
    "emotionalRegister": "New evidence reshapes the narrative, leading to heightened emotional stakes.",
