...
- Project ID: ``
- Timestamp: `2026-07-15T17:57:23.140Z`
...
Anxiety rises as the investigation begins to uncover hidden motives.
...
Rationale: Humor can lighten the tension as the investigation begins.
...
• [clue_9] water, victim, lungs, indicates, drowning
  Category: physical | Criticality: essential | Supports inference step 3
  Points to: victim, cause, death, drowning
...
• [clue_discriminating_1] Controlled reenactment evidence
  Category: structural | Placement: early (Act 1)
  Points to: what this observation reveals about the time or circumstances of the crime.
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_4 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): victim, still, alive, tide, falling | victim, drown, high, tide | victim, drowning, aligns, tide
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Yet even as suspicion thickened, a moment of ironic relief surfaced. A bellboy, oblivious to the tension, trundled past with a cart stacked high with fresh linen, humming a tune from the wireless. The mundane intrusion broke the spell, if only briefly, and for..."
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=11208; context=12442; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_discriminating_1 must appear in Act 1, Scene 3 via Controlled reenactment evidence
...
- Chapter 3:
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • coroner, report, shows, water, lungs [clue_9] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: victim, cause, death, drowning
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
         Paragraph 2 (immediately following): The detective or POV character explicitly reasons
           about what this evidence implies — who it implicates, why it may be unreliable,
           or what inference it supports. This must be a separate full paragraph, not a sentence appended to Paragraph 1.
    • tide, charts, visible, hotel, lobby [clue_culprit_direct_beatrice_quill] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
...
Chapter 3 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Footprints leading away from the water."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes a direct link between Beatrice Quill and the crime scene."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Hugo kneels by the water, feeling the cold spray against his face."
      ]
    },
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 3: the clue [clue_4] (tide, charts, displayed, hotel, lobby, indicate, occurred, quarter, past) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: the clue [clue_9] (water, victim, lungs, indicates, drowning) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
...
□ Chapter 3: the clue [clue_discriminating_1] (victim, must, drowned, tide, contradicting, initial, belief, drowning, high) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
