...
- Project ID: ``
- Timestamp: `2026-07-15T17:58:34.776Z`
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Mallory wrestles with the ethical implications of her actions, torn between her ambition and the moral compromises she has made along the way."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Ivor is torn between his desire for revenge and the understanding that holding onto his grudges only drags him down further into darkness."
...
• [clue_core_elimination_chain] eliminates, mallory, finch, because, seen, leaving, hotel, minutes, past, eleven
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: mallory, finch, culprit

• [clue_10] eliminates, captain, ivor, hale, because, seen, different, location, time, drowning
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: captain, ivor, hale, culprit
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_4, clue_9, clue_culprit_direct_beatrice_quill, clue_7, clue_8, clue_11 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): victim, still, alive, tide, falling | victim, drown, high, tide | victim, drowning, aligns, tide | victim, cause, death, drowning | direct, shows, beatrice, quill, means, opportunity | beatrice, quill, motive | beatrice, quill, scene, crime | timeline, events, leading, drowning
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "He stepped into the corridor, the hush of the lounge receding behind him. The evidence had shifted: Beatrice’s admission of an argument, her presence near the beach, the uncertainty in her account. Motive had emerged, tangled in jealousy and ambition, complica..."
...
Known location profile anchors: The Azure Crest Hotel, Grand Lobby, Oceanview Dining Room, Basement Storage Room, Guest Rooms, the dining hall
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Azure Crest Hotel", "Grand Lobby", "Oceanview Dining Room", "Basement Storage Room", "Guest Rooms", "the dining hall"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=14606; context=6949; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 5:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "He stepped into the corridor, the hush of the lounge receding behind him. The evidence had shifted: Beatrice’s admission of an argument, her presence near the beach, the uncertainty in her account. Motive had emerged, ta...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • footprints, near, water, edge [clue_5]
    ...
    • mallory, finch, seen, leaving, hotel, multiple, witnesses [clue_core_elimination_chain]
      Points to: mallory, finch, culprit
    • captain, ivor, hale, confirmed, elsewhere [clue_10]
      Points to: captain, ivor, hale, culprit
    • witnesses, interviewed, eleanor, whereabouts [clue_culprit_direct_1]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
...
Chapter 5 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Witness confirmation of Mallory's alibi."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Dr. Mallory Finch and Captain Ivor Hale were not present at the time of the drowning."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Hugo catches a glimpse of unease in Mallory's eyes."
      ]
    },
    ...
    "emotionalRegister": "A pivotal revelation forces a re-examination of assumptions about the suspects.",
    "dominantCharacterNote": {
      "name": "Dr. Mallory Finch",
      "voiceRegister": "Mallory speaks with an authoritative tone, often using medical jargon to assert her competence."
    },
    "humourGuidance": {
