...
- Timestamp: `2026-06-30T08:31:30.642Z`
...
1. Generate a clue that makes the reader directly observe: "The mantel thermometer shows a gradual temperature rise, reaching a peak only about an hour after th..."
   → observation | essential | early | temporal | step 1 | terms: mantel, thermometer, shows

2. Generate a clue that provides evidence for: "The door bolt could not have released immediately after the fire lighting since thermal expansion re..."
   → contradiction | essential | early | temporal | step 1 | terms: released, immediately, after

3. Generate a clue that makes the reader directly observe: "Stable clock records and horse exercise logs show activity inconsistent with Reggie Harcourt's claim..."
   → observation | essential | early | temporal | step 2 | terms: stable, clock, records

4. Generate a clue that provides evidence for: "Reggie's alibi is unreliable, making him a prime suspect for having opportunity to be near the manor..."
   → contradiction | essential | early | temporal | step 2 | terms: reggie's, alibi, unreliable,

5. Generate a clue that makes the reader directly observe: "A fine soot line on the door bolt's latch plate shows uneven heating with a polished inner edge, con..."
   → observation | essential | mid | spatial | step 3 | terms: bolt's, latch, plate

6. Generate a clue that provides evidence for: "The door bolt was not forced open quickly but unlocked naturally after sufficient heat, contradictin..."
   → contradiction | essential | mid | temporal | step 3 | terms: forced, quickly, unlocked

7. Generate a clue that makes the reader directly observe: "The garden sundial shadow angle and length recorded by servants at quarter past nine contradict thei..."
   → observation | essential | mid | temporal | step 4 | terms: garden, sundial, shadow

8. Generate a clue that provides evidence for: "Edith was already incapacitated or dead before noon, supporting the delayed murder timing after the ..."
   → contradiction | essential | mid | temporal | step 4 | terms: edith, already, incapacitated

9. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The door bolt could not have released immediately after the fire lighting since thermal expansion requires sustained heat over time...."
   → contradiction | essential | mid | temporal | step 1 | terms: released, immediately, after

10. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The brass bolt securing Edith's door was designed to expand and unlock gradually as the hearth fire warmed. The fire was lit shortly before ..."
   → observation | essential | early | temporal | terms: brass, securing, edith's

11. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Compare the mantel thermometer temperature curve and soot line on the door bolt latch against the wi..."
   → observation | essential | mid | temporal | terms: compare, mantel, thermometer

12. Generate one essential mid-story clue whose description or pointsTo explicitly names Reggie Harcourt and states the unique trace, preparation detail, or mechanism link that points to Reggie Harcourt rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Reggie Harcourt, brass, securing, edith's
...
13. Generate one essential early-or-mid clue establishing that Reggie Harcourt UNIQUELY had the means/skill/access/knowledge required to execute the concealment mechanism, and that the other suspects did not — so the reveal relies only on this already-planted capability, never on a means introduced for the first time at the confrontation.
   → elimination | essential | mid | temporal | terms: Reggie Harcourt, brass, securing, edith's

14. Generate a clue showing observable evidence of Reggie Harcourt's premeditation or planning (Wished to silence Edith who threatened to reveal his debts). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: wished, silence, edith

15. Generate a clue that explicitly eliminates suspect Giles Langley using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Giles Langley because ...").
   → elimination | essential | mid | testimonial | terms: Giles Langley

16. Generate a clue that explicitly eliminates suspect Agnes Fairchild using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Agnes Fairchild because ...").
   → elimination | essential | mid | testimonial | terms: Agnes Fairchild

17. Generate a clue that explicitly eliminates suspect Mabel Thorne using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Mabel Thorne because ...").
   → elimination | essential | mid | testimonial | terms: Mabel Thorne

18. Generate one essential early or mid elimination clue that explicitly rules out Giles Langley and narrows the solution toward culprit Reggie Harcourt. The pointsTo text must start with "Eliminates Giles Langley because ..." and cite corroborated evidence.
   → elimination | essential | mid | testimonial | terms: Giles Langley, Reggie Harcourt
...
## Access Constraints
Actors: Giles Langley, Agnes Fairchild, Reggie Harcourt, Mabel Thorne
Objects: Fireplace poker, Locked bedroom door with brass bolt, Hearth fire and mantel thermometer
...
- Edith Langley: sensitive items: Lock dust, Fireplace temperature, Mantel thermometer
- Giles Langley: sensitive items: Library clock, Witness testimony
- Agnes Fairchild: sensitive items: Garden sundial, Witness accounts
- Reggie Harcourt: sensitive items: Stable clock, Footwear marks
- Mabel Thorne: sensitive items: Kitchen logs, Servants' testimonies
- Felix Dryden: sensitive items: All case evidence
...
Create 2 red herrings that support the false assumption: "The door bolt was forced open immediately after the hearth fire was lit, indicating the murder occurred shortly after quarter past nine."
