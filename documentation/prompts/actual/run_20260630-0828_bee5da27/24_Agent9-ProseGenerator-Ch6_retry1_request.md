...
- Timestamp: `2026-06-30T08:41:13.239Z`
...
• [clue_core_elimination_chain] eliminates, giles, langley, because, alibi, corroborated, multiple, servants, library, clock, shows, quarter
...
• [clue_12] reggie, harcourt, unique, trace, polished, inner, edge, wear, brass, bolt, securing, edith
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: unique, physical, linking, reggie, harcourt, bolt
...
CLUES ALREADY REVEALED TO READER: clue_1, clue_2, clue_mechanism_visibility_core, clue_10, clue_fp_contradiction_step_2, clue_garden_sundial, clue_7, clue_core_contradiction_chain, clue_3, clue_8, clue_culprit_direct_reggie_harcourt, clue_9, clue_6, clue_11 — do not reveal these as new information.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "For a moment, Felix allowed himself a sliver of relief in the kitchen’s warmth, the ordinary chaos of a household at work. But as he stepped back into the grey drizzle of the stable yard, the investigation’s weight settled on his shoulders once more. The contr..."
...
Known location profile anchors: Langley Manor, Langley Manor Library, Servants’ Hall, Estate Gardens, Stable Yard, Drawing room, Langley Manor
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Langley Manor", "Langley Manor Library", "Servants’ Hall", "Estate Gardens", "Stable Yard", "Drawing room, Langley Manor"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 6: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with an expository setup — e.g. "It was not until…" / "There had been no word since…" / "There was a note on the table…". Begin with "It was", "There was", or "There had been" followed immediately by a specific condition, event, or discovery. Do not open on generic mood alone — but still anchor the location and weave in the sensory + time-of-day grounding across the next sentence or two. Anchor opening in "Drawing room, Langley Manor". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=18635; context=5326; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, physical_plausibility, era_authenticity, temporal_context]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_11 must appear in Act 2, Scene 3 via Cross-check contradiction
...
- clue_culprit_direct_reggie_harcourt must appear in Act 2, Scene 3 via Direct observation
- clue_fp_contradiction_step_4 must appear in Act 2, Scene 3 via Cross-check contradiction
- clue_kitchen_log must appear in Act 2, Scene 3 via Kitchen activity log showing Mabel's presence
- clue_mantel_thermometer must appear in Act 2, Scene 3 via Direct observation of hearth thermometer readings
- clue_servant_testimony_giles must appear in Act 2, Scene 3 via Servants confirm Giles's presence in library
- clue_servant_testimony_mabel must appear in Act 2, Scene 3 via Servants confirm Mabel's kitchen presence
- clue_servant_witness_agnes must appear in Act 2, Scene 3 via Servants note Agnes in garden
- clue_stable_clock_logs must appear in Act 2, Scene 3 via Stable clock inspection and horse exercise logs review
...
Suspect pressure target(s): Giles Langley, Agnes Fairchild
...
- Chapter 6:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "For a moment, Felix allowed himself a sliver of relief in the kitchen’s warmth, the ordinary chaos of a household at work. But as he stepped back into the grey drizzle of the stable yard, the investigation’s weight settl...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • polished, wear, bolt, matches, reggie, harcourt, known, handling, marks [clue_12]
    ...
    • latch, plate, soot, line, fine, uneven, polished, inner, edge [clue_4]
      Points to: physical, supporting, gradual, unlocking, door, bolt
    • mantel, thermometer, curve, soot, line, latch, plate, show, gradual, heating, inconsistent, immediate [clue_5]
      Points to: comparison, temperature, soot, line, unlocking, timing
    ...
    • mantel, thermometer, shows, gradual, temperature, rise, reaching, peak, hour, fire [clue_culprit_direct_1]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • thermal, expansion, laws, require, sustained, heat, time, incompatible, immediate, bolt, release [clue_culprit_direct_reggie_harcourt]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • mantel, thermometer, shows, gradual, temperature, rise, reaching, peak, hour, fire [clue_fp_contradiction_step_4]
      Points to: edith, already, incapacitated, dead, before, noon, supporting, delayed, murder, timing, hearth, unlocked
    • medical, report, witness, testimonies, indicate, edith, incapacitated, before, noon [clue_kitchen_log]
      Points to: contradiction, immediate, murder, timing
    • mantel, thermometer, curve, soot, line, latch, plate, show, gradual, heating, inconsistent, immediate [clue_mantel_thermometer]
      Points to: comparison, temperature, soot, line, unlocking, timing
    ...
    • servants, confirm, giles, langley, library, quarter, watch, matches, clock [clue_servant_witness_agnes]
      Points to: exclusion, giles, langley, suspect
    • fine, soot, line, door, bolt, latch, plate, shows, uneven, heating, polished, inner [clue_stable_clock_logs]
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Agnes looks away, troubled by the accusation against Giles"
      ]
    },
    ...
    "emotionalRegister": "Heightened tension and darkening mood with the exposure of Reggie’s false alibi.",
    ...
    "humourGuidance": {
      ...
      "condition": "Permitted only if a character with humourLevel > 0.7 is present and no direct threat or violence occurs; otherwise forbidden."
    },
...
- VICTIM ALIVE: "Agnes Fairchild’s eyes shone with sudden tears, though she blinked them away quickly. "I have nothing to hide, Mr. Dryde"
...
- Boundary integrity failure in chapter 6: unbalanced quotation marks. Repair punctuation boundaries before commit (balanced quotes, valid contractions/possessives only).
