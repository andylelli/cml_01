...
- Timestamp: `2026-06-30T08:42:18.047Z`
...
• [clue_mantel_thermometer] compare, mantel, thermometer, temperature, curve, soot, line, door, bolt, latch, witness, statements
...
• [clue_stable_clock_logs] door, bolt, released, immediately, fire, lighting, since, thermal, expansion, requires, sustained, heat
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: contradiction, forced, immediate, bolt, release, assumption

• [clue_soot_line_bolt] stable, clock, records, horse, exercise, logs, show, activity, inconsistent, reggie, harcourt, claim
  Category: temporal | Criticality: essential | Supports inference step 2
  Points to: reggie, harcourt, alibi, contradicted, stable, clock, records

• [clue_fp_contradiction_step_4] garden, sundial, shadow, angle, length, recorded, servants, quarter, past, nine, contradict, claims
  Category: temporal | Criticality: essential | Supports inference step 4
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As Felix prepared to leave, a final question lingered in the air—unspoken, but heavy as the autumn dark pressing against the windowpanes. If the lies had been told to shield the innocent, what would be revealed when the last secret was dragged into the light?..."
...
- Chapter 7 (score 96/100):
  Quality gaps noted: scene grounding weakness
  Address in upcoming chapters: Open next chapter with a named location anchor plus at least two sensory cues and one atmosphere marker.
- Phrases to avoid (already overused in earlier chapters): "at ten minutes past seven at night", "kindled at ten minutes past seven at", "as kindled at ten minutes past seven".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=20645; context=4787; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 8:
  ...
  - Scene is set in: Study room, Langley Manor — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As Felix prepared to leave, a final question lingered in the air—unspoken, but heavy as the autumn dark pressing against the windowpanes. If the lies had been told to shield the innocent, what would be revealed when the...".
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Felix pauses, recalling Edith's quiet dignity before death"
      ]
    },
    ...
    "emotionalRegister": "Mounting pressure as the investigation narrows, leading to a charged confrontation.",
    "dominantCharacterNote": {
      "name": "Felix Dryden",
      "voiceRegister": "Precise, measured, with dry, observational wit and calm demeanor."
    },
    "humourGuidance": {
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 8: the clue [clue_soot_line_bolt] (stable, clock, records, horse, exercise, logs, show, activity, inconsistent, reggie, harcourt, claim) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
