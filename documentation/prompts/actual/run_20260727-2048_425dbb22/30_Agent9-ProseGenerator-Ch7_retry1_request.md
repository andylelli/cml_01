...
- Timestamp: `2026-07-27T21:03:21.954Z`
...
• [clue_core_contradiction_chain] presence, frost, crystals, inside, hourglass, explicitly, overturns, false, assumption, sand, normally, accurately
  Category: temporal | Criticality: essential | Supports inference step 1
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): contradiction, overturning, false, hourglass, timing, assumption

• [clue_core_elimination_chain] margaret, hensley, eliminated, servants, testimony, alibi, logs, focusing, suspicion, charles, montague, suspect
...
CLUES ALREADY REVEALED TO READER: clue_11, clue_1, clue_2, clue_3, clue_4, clue_5, clue_6, clue_7, clue_8, clue_14, clue_15, clue_16, clue_17, clue_18, clue_20 — do not reveal these as new information.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As Helen prepared to leave, she paused by the kitchen door. The lamplight caught the frost on the hourglass, the patterns at its base glinting in the gloom. She let her fingers rest on the doorknob, the cold metal grounding her. The evidence had spoken, and it..."
...
Known location profile anchors: Winthrope Manor Estate, Winthrope Manor Library, Servants’ Quarters, Winthrope Manor Gardens, Estate Gatehouse, Study room and hallway
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Winthrope Manor Estate", "Winthrope Manor Library", "Servants’ Quarters", "Winthrope Manor Gardens", "Estate Gatehouse", "Study room and hallway"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 7: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "Study room and hallway". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=20524; context=4797; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, continuity_context, pronoun_accuracy]
...
Suspect pressure target(s): Charles Montague, Margaret Hensley
...
- Chapter 7:
  ...
  - Scene is set in: Study room and hallway — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As Helen prepared to leave, she paused by the kitchen door. The lamplight caught the frost on the hourglass, the patterns at its base glinting in the gloom. She let her fingers rest on the doorknob, the cold metal ground...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • servants, testimony, alibi, logs, margaret, hensley, charles, montague, opportunity, motive [clue_core_elimination_chain]
  ...
  - PLANT OBLIGATIONS (incidental appearances): each item below MUST appear in this chapter as a passing physical detail a character sees, handles, or walks past — with its significance UNFLAGGED:
    • gardener, stable, hands, confirm, james, fletcher, presence, away, manor, murder [plant:clue_19]
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Margaret’s eyes dart nervously when questioned about the study window"
      ]
    },
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 7: the clue [clue_core_contradiction_chain] (presence, frost, crystals, inside, hourglass, explicitly, overturns, false, assumption, sand, normally, accurately) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
