...
- Timestamp: `2026-07-27T21:02:22.174Z`
...
• [clue_20] eliminates, margaret, hensley, because, multiple, servants, corroborate, presence, kitchen, charles, montague, unique
  Category: testimonial | Criticality: essential | Supports inference step 3
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): eliminates, margaret, hensley, narrows, solution, charles, montague
...
CLUES ALREADY REVEALED TO READER: clue_11, clue_1, clue_2, clue_3, clue_4, clue_5, clue_6, clue_7, clue_8, clue_14, clue_15 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): struck, heavy, antique, blunt, wound, manner | hourglass, frost, crystals, temporal, anomaly | presence, frost, crystals, contradiction, normal, sand | faint, scratch, study, window, latch, spatial | slightly, open, window, contradiction, warm, room | witness, agreement, garden, gate, latch, temporal | auditory, perception, contradiction, latch, timing | charles, montague, presence, motive, temporal, behavioral | charles, motive, opportunity, contradiction, suspects | charles, montague, unique, means, skill, elimination | blackmail, threat, victim, charles, premeditation, motive
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As Helen prepared to withdraw, she allowed herself a final, lingering glance at Charles Montague. His gaze met hers, hard and unyielding, but behind it she glimpsed something else—a flicker of fear, or perhaps regret. The evidence was mounting, but the truth r..."
...
Known location profile anchors: Winthrope Manor Estate, Winthrope Manor Library, Servants’ Quarters, Winthrope Manor Gardens, Estate Gatehouse, Library and kitchen areas
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Winthrope Manor Estate", "Winthrope Manor Library", "Servants’ Quarters", "Winthrope Manor Gardens", "Estate Gatehouse", "Library and kitchen areas"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 6: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with an expository setup — e.g. "It was not until…" / "There had been no word since…" / "There was a note on the table…". Begin with "It was", "There was", or "There had been" followed immediately by a specific condition, event, or discovery. Do not open on generic mood alone — but still anchor the location and weave in the sensory + time-of-day grounding across the next sentence or two. Anchor opening in "Library and kitchen areas". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=19618; context=4964; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, continuity_context, pronoun_accuracy]
...
- clue_15 must appear in Act 2, Scene 3 via Behavioral observation
- clue_16 must appear in Act 2, Scene 3 via Corroborated elimination
- clue_17 must appear in Act 2, Scene 3 via Corroborated elimination
- clue_18 must appear in Act 2, Scene 3 via Corroborated elimination
- clue_19 must appear in Act 2, Scene 3 via Corroborated elimination
- clue_20 must appear in Act 2, Scene 3 via Corroborated elimination
...
- clue_culprit_direct_charles_montague must appear in Act 2, Scene 3 via Direct observation
...
Suspect pressure target(s): Margaret Hensley, Edward Winthrope, Clara Simmons
...
- Chapter 6:
  ...
  - Scene is set in: Library and kitchen areas — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As Helen prepared to withdraw, she allowed herself a final, lingering glance at Charles Montague. His gaze met hers, hard and unyielding, but behind it she glimpsed something else—a flicker of fear, or perhaps regret. Th...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • testimony, access, logs, confirm, charles, montague, required, skills, opportunity, manipulate, hourglass [clue_14]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • threatening, letter, lady, beatrice, charles, montague, demanding, silence [clue_15]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    ...
    • gardener, stable, hands, confirm, james, fletcher, presence, away, manor, murder [clue_19]
      OBSERVATION ONLY: put it on the page concretely — a character sees, handles, or hears it inside the scene. The detective may NOTICE (a pause, a second glance, a pocketed item) but must NOT state what it implies.
    • servants, testimony, placing, margaret, hensley, kitchen, charles, montague, access, logs, motive [clue_20]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • witnesses, charles, montague, near, study, before, half, past, seven, blackmail, note, linking [clue_7]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • timeline, correction, based, hourglass, frost, blockage, charles, presence [clue_8]
      OBSERVATION ONLY: put it on the page concretely — a character sees, handles, or hears it inside the scene. The detective may NOTICE (a pause, a second glance, a pocketed item) but must NOT state what it implies.
  ...
  - PLANT OBLIGATIONS (incidental appearances): each item below MUST appear in this chapter as a passing physical detail a character sees, handles, or walks past — with its significance UNFLAGGED:
    • observation, sealed, hourglass, visible, frost, damp, condensation, patterns, base [plant:clue_mechanism_visibility_core]
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Margaret glances anxiously at the kitchen clock"
      ]
    },
    ...
    "emotionalRegister": "The controlled hourglass test confirms temporal deception, sharpening the investigative focus.",
    ...
    "humourGuidance": {
      ...
      "condition": "Allowed only if the character has humourLevel > 0.7 and no direct threat or violence is present; otherwise forbidden."
    },
