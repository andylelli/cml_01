...
- Timestamp: `2026-07-27T21:00:55.751Z`
...
• [clue_7] charles, montague, observed, near, study, shortly, before, half, past, seven, motive, blackmail
  Category: temporal | Criticality: essential | Supports inference step 4
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): charles, montague, presence, motive, temporal, behavioral

• [clue_8] charles, motive, opportunity, within, corrected, timeline, murder, hourglass, blocked, frost
  Category: temporal | Criticality: essential | Supports inference step 4
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): charles, motive, opportunity, contradiction, suspects

• [clue_14] charles, montague, uniquely, possessed, knowledge, access, prepare, sealed, hourglass, trapped, moisture, unlike
  Category: behavioral | Criticality: essential | Supports inference step 4
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): charles, montague, unique, means, skill, elimination, others

• [clue_15] blackmail, threat, victim, charles, montague, indicating, premeditation, motive
  Category: behavioral | Criticality: essential | Supports inference step 4
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): blackmail, threat, victim, charles, premeditation, motive
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "She let the gate swing shut behind her, the clang echoing across the grounds. The investigation had not found resolution, only deeper uncertainty. In the hush that followed, Helen felt the pressure mounting—not just on James Fletcher, but on herself. The wind..."
...
Known location profile anchors: Winthrope Manor Estate, Winthrope Manor Library, Servants’ Quarters, Winthrope Manor Gardens, Estate Gatehouse, Drawing room, Winthrope Manor Estate
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Winthrope Manor Estate", "Winthrope Manor Library", "Servants’ Quarters", "Winthrope Manor Gardens", "Estate Gatehouse", "Drawing room, Winthrope Manor Estate"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 5: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a temporal subordinate clause — e.g. "When [Name] entered…" / "After the last guest…" / "Before the household had stirred…" / "As the light faded…". Anchor opening in "Drawing room, Winthrope Manor Estate". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=17021; context=6586; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality]; truncated=[location_profiles, temporal_context, continuity_context, pronoun_accuracy]
...
- Chapter 5:
  ...
  - Scene is set in: Drawing room, Winthrope Manor Estate — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "She let the gate swing shut behind her, the clang echoing across the grounds. The investigation had not found resolution, only deeper uncertainty. In the hush that followed, Helen felt the pressure mounting—not just on J...".
  ...
  - PLANT OBLIGATIONS (incidental appearances): each item below MUST appear in this chapter as a passing physical detail a character sees, handles, or walks past — with its significance UNFLAGGED:
    • minute, frost, crystals, inside, hourglass, glass, surface [plant:clue_core_contradiction_chain]
    • experiment, shows, frost, forming, inside, sealed, hourglass, sand, flow, stopping, temperature [plant:clue_12]
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Charles’s gaze hardens when questioned about Lady Beatrice"
      ]
    },
    ...
    "emotionalRegister": "Corrected timeline and new testimonies focus suspicion on Charles Montague, deepening mistrust.",
