...
- Project ID: ``
- Timestamp: `2026-07-19T12:26:19.179Z`
...
**Setting**: 1940s - A large, coastal hotel with art deco architecture, featuring a grand lobby and a dining area overlooking the ocean. Rooms are sparsely furnished but well-kept, with a mix of sea and garden views.
**Crime Type**: Murder
**Social Context**: post-war trauma, increased presence of women in the workforce, early Cold War tensions
**Tone**: Classic
