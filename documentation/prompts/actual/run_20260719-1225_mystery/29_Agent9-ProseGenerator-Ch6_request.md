...
- Project ID: ``
- Timestamp: `2026-07-19T12:33:47.004Z`
...
• [clue_id_9] eliminates, beatrice, quill, because, seen, dining, guests, time, murder
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: beatrice, quill, ruled, suspect

• [clue_id_10] eliminates, eleanor, voss, because, confirmed, time, murder
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: eleanor, voss, ruled, suspect

• [clue_9] eliminates, beatrice, quill, because, seen, dining, guests, time, murder
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: beatrice, quill, ruled, suspect
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As she stepped back into the corridor, the clamor of the kitchen receded, replaced by the hush of the hotel’s dim passageways. The contradictions pressed in: a stopped clock, a chorus of alibis, a murder that refused to resolve itself into a tidy narrative. El..."
...
Known location profile anchors: The Grand Seaside Hotel, Grand Lobby, Dining Area, Rooftop Terrace, Hotel Kitchen, the hotel entrance
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Grand Seaside Hotel", "Grand Lobby", "Dining Area", "Rooftop Terrace", "Hotel Kitchen", "the hotel entrance"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 6: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with an expository setup — e.g. "It was not until…" / "There had been no word since…" / "There was a note on the table…". Begin with "It was", "There was", or "There had been" followed immediately by a specific condition, event, or discovery. Do not open on generic mood alone — but still anchor the location and weave in the sensory + time-of-day grounding across the next sentence or two. Anchor opening in "the hotel entrance". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Chapter 5 (score 96/100):
  Quality gaps noted: scene grounding weakness
  Address in upcoming chapters: Open next chapter with a named location anchor plus at least two sensory cues and one atmosphere marker.
- Phrases to avoid (already overused in earlier chapters): "one must play the cards one is", "must play the cards one is dealt".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=18684; context=4866; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_id_10 must appear in Act 2, Scene 3 via Direct observation
- clue_id_4 must appear in Act 2, Scene 3 via Witness account
...
- clue_id_7 must appear in Act 2, Scene 3 via Witness statement
- clue_id_8 must appear in Act 2, Scene 3 via Witness statement
- clue_id_9 must appear in Act 2, Scene 3 via Direct observation
...
- Chapter 6:
  ...
  - Scene is set in: the hotel entrance — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As she stepped back into the corridor, the clamor of the kitchen receded, replaced by the hush of the hotel’s dim passageways. The contradictions pressed in: a stopped clock, a chorus of alibis, a murder that refused to...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • sylvia, trent, alibi, confirmed, kitchen, staff [clue_10]
    ...
    • eleanor, voss, alibi, corroborated, staff [clue_8]
      Points to: eleanor, voss, ruled, suspect
    • beatrice, quill, presence, confirmed, multiple, witnesses [clue_9]
      Points to: beatrice, quill, ruled, suspect
    • witnesses, confirming, presence, staff, member, serving, drinks [clue_culprit_direct_1]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    ...
    • eleanor, voss, alibi, corroborated, staff [clue_id_10]
      Points to: eleanor, voss, ruled, suspect
    • captain, ivor, hale, nervous, demeanor [clue_id_4]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    ...
    • beatrice, quill, presence, confirmed, multiple, witnesses [clue_id_9]
      Points to: beatrice, quill, ruled, suspect
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Witness confirmations of Hugo's departure."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Hugo was seen leaving the hotel at the time of the murder."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Hugo's smile fades as Eleanor presses him for details."
      ]
    },
    ...
    "emotionalRegister": "The confrontation with the murderer forces Eleanor to confront her own vulnerabilities.",
