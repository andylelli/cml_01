...
- Project ID: ``
- Timestamp: `2026-07-19T12:30:37.094Z`
...
- Eleanor Voss
  ...
  Connection to victim: Professional acquaintances with underlying distrust.; Eleanor has written articles critical of the medical profession, which Mallory resents..
  Investigation relevance: is actively driving interviews and credibility checks in this scene.
  Suspicion/pressure cue seed: Solving the case and restoring her reputation.
...
- Captain Ivor Hale
  ...
  Suspicion/pressure cue seed: Protecting his reputation.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.
...
- Beatrice Quill
  ...
  Suspicion/pressure cue seed: Maintaining her position.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Sylvia Trent
  Public identity anchor: Wealthy Socialite; suspect 
  Connection to victim: Mutual disdain due to class differences.; Mallory disapproves of Sylvia's treatment of staff and her elitist attitude..
  Investigation relevance: access plausibility: medium | alibi window: none.
  Suspicion/pressure cue seed: Prote
...
• [clue_mechanism_visibility_core] witnesses, state, hotel, staff, member, serving, drinks, dining, area, quarter, past, nine
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: staff, member, seen, dining, area, time, murder

• [clue_id_1] witnesses, state, hotel, staff, member, serving, drinks, dining, area, quarter, past, nine
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: staff, member, seen, dining, area, time, murder

• [clue_id_3] indicates, someone, used, disguise, impersonate, hotel, staff
...
Known location profile anchors: The Grand Seaside Hotel, Grand Lobby, Dining Area, Rooftop Terrace, Hotel Kitchen, the dining area of the hotel
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Grand Seaside Hotel", "Grand Lobby", "Dining Area", "Rooftop Terrace", "Hotel Kitchen", "the dining area of the hotel"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the dining area of the hotel". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=8143; context=12326; dropped=[none]; truncated=[first_appearance_contracts, location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • witnesses, confirming, presence, staff, member, serving, drinks [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
  ...
  - Sensory obligation — use at least two of: cloudy skies reflected in the windows, raindrops sliding down glass | soft patter of rain, quiet whispers of early diners | freshly brewed tea. Mood: melancholic.
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The clock in the dining area showing a quarter past nine."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the victim died no later than a quarter past nine, contradicting several suspects' alibis."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor stares at the lifeless body, heart racing as the gravity of the situation sinks in."
      ]
    },
    ...
    "emotionalRegister": "The excitement of the charity event is overshadowed by the weight of hidden truths.",
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (witnesses, state, hotel, staff, member, serving, drinks, dining, area, quarter, past, nine) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_id_1] (witnesses, state, hotel, staff, member, serving, drinks, dining, area, quarter, past, nine) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_id_3] (indicates, someone, used, disguise, impersonate, hotel, staff) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
