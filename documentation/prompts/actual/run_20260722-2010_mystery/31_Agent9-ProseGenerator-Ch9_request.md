...
- Project ID: ``
- Timestamp: `2026-07-22T20:25:56.913Z`
...
• [clue_late_optional_slot_1] small, screwdriver, near, clock
  Category: physical | Criticality: optional | Supports inference step 3
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): possible, tampering

• [clue_core_contradiction_chain] clock, tampered, show, false, time
  Category: temporal | Criticality: essential | Supports inference step 1
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): clock, cannot, trusted, time, death
...
CLUES ALREADY REVEALED TO READER: clue_1, clue_2, clue_core_contradiction_chain, clue_fp_contradiction_step_2, clue_3, clue_core_elimination_chain, clue_culprit_direct_captain_ivor_hale, clue_culprit_direct_1, clue_fp_contradiction_step_3 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): time, arrival, guests | discrepancy, time, indicates, possible, foul, play | clock, cannot, trusted, time, death | indicates, clock, tampered | timeline, events, surrounding, murder | mallory, finch, alibi, corroborated | captain, ivor, hale, direct, means, opportunity | physical, trace, opportunity, indicate, captain, ivor | recent, tampering, suggests, premeditation
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "The evening deepened, the wind outside rising to a mournful crescendo. Within the ballroom, the tension thickened, each breath drawn in anticipation of the confrontation to come. The timeline discrepancies had been laid bare, the emotional cost revealed in eve..."
...
This is a **Comparison of timepieces** test. The detective must:

**Test mechanism (paraphrase — do NOT copy verbatim):**
Render this test MECHANISM as live, in-scene action and dialogue, composing ENTIRELY in your own words from these elements (reproducing any briefing phrase verbatim FAILS validation): time, indicated, victim, watch, clock, proves, tampered, show, false
...
- Phrases to avoid (already overused in earlier chapters): "truth is a slippery fish isn t", "silence was broken only by the distant", "to the drama unfolding within these walls", "scratched across her notepad the sound sharp", "across her notepad the sound sharp in", "her notepad the sound sharp in the".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=24017; context=4997; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 9:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "The evening deepened, the wind outside rising to a mournful crescendo. Within the ballroom, the tension thickened, each breath drawn in anticipation of the confrontation to come. The timeline discrepancies had been laid...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • screwdriver, lying, floor [clue_late_optional_slot_1]
      Points to: possible, tampering
    • tampering, visible, clock [clue_core_contradiction_chain] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: clock, cannot, trusted, time, death
  - ⚠ SUSPECT CLEARANCE REQUIRED (MANDATORY): each suspect below MUST be named explicitly and cleared with on-page evidence and a reasoning connector (because / therefore / which proves):
    • "Dr. Mallory Finch": write a dedicated paragraph that (a) names Dr. Mallory Finch explicitly, (b) states the clearance method ("Solid alibi verified by multiple witnesses."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have". Cite clues: Witnesses testify to Dr. Finch's activities during the time of death..
    • "Beatrice Quill": write a dedicated paragraph that (a) names Beatrice Quill explicitly, (b) states the clearance method ("Broken necklace was from a different incident."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have". Cite clues: Witnesses confirm the necklace incident occurred earlier in the day..
    • "Sylvia Trent": write a dedicated paragraph that (a) names Sylvia Trent explicitly, (b) states the clearance method ("No motive or opportunity."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have". Cite clues: Witness confirms Sylvia was in another part of the hotel..
  ...
  - ⚠ DISCRIMINATING TEST (trap) — MANDATORY real-time scene with dialogue and confrontation. DO NOT summarize it after the fact.
    ...
    Elements the test must dramatize (compose the scene ENTIRELY in your own sentences from these — reproducing any briefing phrase verbatim FAILS validation): time, indicated, victim, watch, clock, proves, tampered, show, false
    Cite these already-revealed clue IDs during the test: clue_core_contradiction_chain, clue_2, clue_1, clue_fp_contradiction_step_2
    ...
    Motive statement REQUIRED: the culprit must explicitly state or acknowledge their motive during or immediately after the confrontation. Canonical motive: "Financial gain from insurance". Do not omit it.
...
Chapter 9 (Act 3) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The comparison of the victim's watch and the clock."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the clock was tampered with to mislead the investigation."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Hale's breath catches as Hugo prepares to reveal the final piece of evidence."
      ]
    },
    ...
    "emotionalRegister": "The confrontation reveals the murderer, shattering the fragile bonds among the characters.",
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 9: the clue [clue_core_contradiction_chain] (clock, tampered, show, false, time) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
