...
- Project ID: `unknown`
- Timestamp: `2026-07-22T20:16:39.402Z`
...
1. Generate a clue that makes the reader directly observe: "The clock shows the time as ten minutes past ten...."
   → observation | essential | early | temporal | step 1 | terms: clock, shows, minutes

2. Generate a clue that provides evidence for: "The clock was tampered with to show a false time...."
   → contradiction | essential | early | temporal | step 1 | terms: clock, tampered, false

3. Generate a clue that makes the reader directly observe: "The victim's watch shows a different time than the clock...."
   → observation | essential | early | temporal | step 2 | terms: victim's, watch, shows

4. Generate a clue that provides evidence for: "This indicates the clock has been tampered with...."
   → contradiction | essential | early | temporal | step 2 | terms: indicates, clock, tampered

5. Generate a clue that makes the reader directly observe: "Scratch marks on the clock indicate recent tampering...."
   → observation | essential | mid | temporal | step 3 | terms: scratch, marks, clock

6. Generate a clue that provides evidence for: "Recent tampering suggests premeditation...."
   → contradiction | essential | mid | testimonial | step 3 | terms: recent, tampering, suggests

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The clock was tampered with to show a false time...."
   → contradiction | essential | mid | temporal | step 1 | terms: clock, tampered, false

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "A clock was rewound to mislead witnesses about the time of death...."
   → observation | essential | early | temporal | terms: clock, rewound, mislead
...
10. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Comparing the time indicated by the victim's watch with the clock proves that the clock was tampered..."
   → observation | essential | mid | temporal | terms: comparing, indicated, victim's
...
11. Generate one essential mid-story clue whose description or pointsTo explicitly names Captain Ivor Hale and states the unique trace, preparation detail, or mechanism link that points to Captain Ivor Hale rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Captain Ivor Hale, clock, rewound, mislead
...
12. Generate one essential early-or-mid clue establishing that Captain Ivor Hale UNIQUELY had the means/skill/access/knowledge required to execute the concealment mechanism, and that the other suspects did not — so the reveal relies only on this already-planted capability, never on a means introduced for the first time at the confrontation.
   → elimination | essential | mid | temporal | terms: Captain Ivor Hale, clock, rewound, mislead

13. Generate a clue showing observable evidence of Captain Ivor Hale's premeditation or planning (Financial gain from insurance). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: financial, insurance
...
15. Generate one essential early or mid elimination clue that explicitly rules out Dr. Mallory Finch and narrows the solution toward culprit Captain Ivor Hale. The pointsTo text must start with "Eliminates Dr. Mallory Finch because ..." and cite corroborated evidence.
...
Objects: The clock, Eleanor's watch
...
Create 2 red herrings that support the false assumption: "The victim died during the party as indicated by the clock."
...
- STRICT STRUCTURAL CONTRACT (author ALL of these YOURSELF, as concrete scene-register clues — a character sees/hears/finds something. NEVER meta-boilerplate like "adds texture to the case background"; if you omit any, a deterministic pass will synthesize flat machine text in its place, which reads as machine-made):
    ...
    • DIRECT CULPRIT CLUE: id="clue_culprit_direct_captain_ivor_hale" — observable evidence tying Captain Ivor Hale uniquely to the crime (source from: CASE.cast[2].alibi_window, CASE.cast[2].access_plausibility); the pointsTo must include: Captain Ivor Hale, direct evidence, means and opportunity, no other eligible suspect
