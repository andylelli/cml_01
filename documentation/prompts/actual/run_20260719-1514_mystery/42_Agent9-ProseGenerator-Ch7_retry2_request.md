...
- Project ID: ``
- Timestamp: `2026-07-19T15:25:39.769Z`
...
• [clue_core_elimination_chain] eliminates, eleanor, voss, because, seen, gala, multiple, witnesses, before, hugo, collapse
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: eleanor, voss, cleared, suspect

• [clue_late_1] analysis, reveals, stems, contained, rare, toxin
...
CLUES ALREADY REVEALED TO READER: clue_early_1, clue_1, clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_culprit_direct_dr_mallory_finch, clue_fp_contradiction_step_2, clue_2, clue_3, clue_fp_elimination_captain_ivor_hale, clue_mid_1, clue_4, clue_fp_elimination_beatrice_quill, clue_5, clue_6, clue_fp_elimination_sylvia_trent — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): hugo, collapse, suspicious | bouquet, crucial, understanding, cause, death | bouquet, linked, hugo, death | hugo, collapse, suspicious | direct, shows, mallory, finch, means, opportunity | damage, bouquet, suggests, played, role, death | bouquet, linked, foul, play | bouquet, piece | eliminates, captain, ivor, hale, because, independent | bouquet, crucial, understanding, cause, death | foul, play, confirmed | eliminates, beatrice, quill, because, independent, corroboration | mallory, finch, prime, suspect | motive, murder | eliminates, sylvia, trent, because, independent, corroboration
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Eleanor’s lyrical cadence surfaced as she reflected aloud, “It’s a canvas of life, isn’t it? Each stroke tells a story, but some stains refuse to fade. ” She caught Dr. Finch’s gaze, and for a moment, vulnerability passed between them. The investigation had pi..."
...
Known location profile anchors: The Crestview Hotel, The Dining Room, The Kitchen, Room 203, The Rooftop Terrace, the hotel kitchen, bustling with staff
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Crestview Hotel", "The Dining Room", "The Kitchen", "Room 203", "The Rooftop Terrace", "the hotel kitchen, bustling with staff"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 7: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the hotel kitchen, bustling with staff". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Chapter 6 (score 93/100):
  Quality gaps noted: word density below preferred target (883/1000); scene grounding weakness
  Address in upcoming chapters: Increase chapter density with concrete investigation action and sensory-grounded beats; avoid recap-only padding. | Open next chapter with a named location anchor plus at least two sensory cues and one atmosphere marker.
- Phrases to avoid (already overused in earlier chapters): "with the clasp of her stylish handbag", "a little fish in a big pond", "eleanor voss pressed on to the next", "voss pressed on to the next concrete", "pressed on to the next concrete detail", "on to the next concrete detail the", "to the next concrete detail the record", "the next concrete detail the record now", "next concrete detail the record now held", "that detail shifted the reasoning weighed against".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=18423; context=4812; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context]; truncated=[location_profiles, temporal_context, continuity_context, pronoun_accuracy]
...
- Chapter 7:
  ...
  - Scene is set in: the hotel kitchen, bustling with staff — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Eleanor’s lyrical cadence surfaced as she reflected aloud, “It’s a canvas of life, isn’t it? Each stroke tells a story, but some stains refuse to fade. ” She caught Dr. Finch’s gaze, and for a moment, vulnerability passe...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • eleanor, voss, confirmed, gala [clue_core_elimination_chain]
      Points to: eleanor, voss, cleared, suspect
...
Chapter 7 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The toxic reaction observed when the crushed stems are heated."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the bouquet contained a rare toxin, confirming foul play in Hugo's death."
...
[
  {
    ...
    "setting": {
      "location": "the hotel kitchen, bustling with staff",
      "timeOfDay": "Late afternoon",
      "atmosphere": "An air of anticipation as Eleanor prepares the test"
    },
    "characters": [
      "Eleanor Voss",
      "Dr. Mallory Finch"
    ...
    "dramaticElements": {
      ...
      "tension": "The stakes are high as the test is conducted.",
      "microMomentBeats": [
        "Eleanor's heart races as she prepares the bouquet for the test."
      ]
    },
    "summary": "In the bustling hotel kitchen, Eleanor prepares to execute the discriminating test, using the crushed stems from the bouquet. As she observes the reaction and resulting symptoms, the implications of the bouquet's role in Hugo's death become clear. The tension mounts as Eleanor draws her conclusions.",
    "beat": "final_trap",
    "estimatedWordCount": 2000,
    "pivotElement": "The toxic reaction observed when the crushed stems are heated.",
    "factEstablished": "Establishes that the bouquet contained a rare toxin, confirming foul play in Hugo's death.",
    ...
    "emotionalRegister": "Mounting pressure leads to confrontations among the suspects, revealing deeper emotional stakes.",
