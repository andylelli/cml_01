...
- Project ID: ``
- Timestamp: `2026-07-20T20:35:38.217Z`
...
- Eleanor Voss
  Public identity anchor: Amateur Sleuth; detective 
  Connection to victim: They have a cordial but competitive friendship rooted in their shared commitment to the community.; Eleanor and Mallory often collaborate on projects at the local clinic and museum, but Eleanor is suspicious of Mallory's recent behavior..
  Investigation relevance: is actively driving interviews and credibility checks in this scene.
  Suspicion/pressure cue seed: Calm demeanor.
...
Known location profile anchors: Hotel Le Rivage, The Observation Deck, The Grand Lounge, The Kitchen, The Library, the scene
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Hotel Le Rivage", "The Observation Deck", "The Grand Lounge", "The Kitchen", "The Library", "the scene"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=7372; context=9373; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The body of Dr. Mallory Finch lying on the floor."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the victim was murdered in the hotel room, heightening the suspense."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Dr. Finch stares blankly at the floor, lost in shock."
      ]
    },
    "summary": "Eleanor Voss arrives at the luxurious hotel in Cannes, where the body of Dr. Mallory Finch has been discovered. The atmosphere is thick with tension as she enters the room, only to find Dr. Finch's lifeless body sprawled on the floor. Shocked, she realizes the implications of the murder and the potential suspects surrounding her.",
    "beat": "gathering",
    "estimatedWordCount": 1800,
    "pivotElement": "The body of Dr. Mallory Finch lying on the floor.",
    "factEstablished": "Establishes the victim was murdered in the hotel room, heightening the suspense.",
    ...
    "emotionalRegister": "The ambiance is elegant yet foreboding, setting the stage for the unraveling mystery.",
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (clock, finch, room, rewound, misrepresent, time, death) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
