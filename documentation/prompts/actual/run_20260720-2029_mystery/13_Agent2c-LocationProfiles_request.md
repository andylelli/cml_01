...
- Project ID: ``
- Timestamp: `2026-07-20T20:32:43.452Z`
...
- Era-authentic markers: radio broadcasting, early television sets, automobiles with limited production due to wartime rationing, rationed petrol, post-war automobile boom, bicycles for local travel, long-distance telephone calls, military-style coded messages
- Tone: Classic
- No anachronisms
...
Description: A grand seaside hotel with Art Deco architecture, featuring ocean views and luxurious amenities, but showing signs of wear from wartime neglect.
Crime Scene: Cannes
Weather: overcast with occasional rain showers typical of coastal climates
Mood: tense, with an undercurrent of suspicion among guests
...
Setting constraints:
- Physical constraints: narrow hallways limiting movement, restricted access to certain floors and back areas, oceanfront cliffs affecting escape routes
- Geographic isolation: Located several miles from the nearest town, limiting quick access to outside help.
- Access control: staff-only areas such as the kitchen and maintenance rooms, guest rooms requiring key access, restricted access to the roof and observation deck

Era constraints to include:
- Technology: radio broadcasting, early television sets, automobiles with limited production due to wartime rationing
- Transportation: rationed petrol, post-war automobile boom
- Social norms: post-WWII societal shifts, increased female workforce participation
