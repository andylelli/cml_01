...
- Project ID: ``
- Timestamp: `2026-07-20T20:37:47.877Z`
...
A pivotal clue about the tampered clock shifts the investigation's direction.
...
Rationale: Tension scenes require a focus on emotional conflict without humor.
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Ivor faces the demons of his past, battling the effects of PTSD while grappling with the shame of his addiction, torn between the desire for redemption and the fear of exposure."
...
• [clue_core_elimination_chain] witnesses, confirm, captain, hale, dining, room, eight, thirty
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: eliminates, captain, ivor, hale, because, corroborated, alibi
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As she gathered herself to dismiss the guests, Eleanor caught a final glance exchanged between Sylvia and Hugo—an unspoken warning, or perhaps a shared relief that suspicion had not yet settled squarely upon them. The uneasy alliance among the survivors was as..."
...
Chapter 3: Chapter 3: Suspect Introductions
  Events: By late morning, the rain had faded to a persistent drizzle, but the air in Dr.
...
Known location profile anchors: Hotel Le Rivage, The Observation Deck, The Grand Lounge, The Kitchen, The Library, Dining room of the hotel
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Hotel Le Rivage", "The Observation Deck", "The Grand Lounge", "The Kitchen", "The Library", "Dining room of the hotel"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 4: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a noun-phrase atmosphere — e.g. "The smell of damp stone in the cellar…" / "A chill from the landing…" / "The sound of the clock in the hall…". Pattern: "The/A [noun] of/in/from [place]…". Anchor opening in "Dining room of the hotel". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=13139; context=10427; dropped=[humour_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 4:
  ...
  - Scene is set in: Dining room of the hotel — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As she gathered herself to dismiss the guests, Eleanor caught a final glance exchanged between Sylvia and Hugo—an unspoken warning, or perhaps a shared relief that suspicion had not yet settled squarely upon them. The un...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • multiple, witnesses, state, hale, presence, dining, room, eight, thirty [clue_core_elimination_chain]
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Ivor's insistence on his alibi."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes Ivor Hale's alibi as potentially unreliable, given his defensiveness."
...
[
  {
    "sceneNumber": 4,
    "act": 2,
    "title": "Interrogating Ivor Hale",
    "setting": {
      "location": "Dining room of the hotel",
      "timeOfDay": "Afternoon",
    ...
    "purpose": "Interrogate Ivor Hale and establish his alibi",
    "cluesRevealed": [
      "clue_core_elimination_chain",
      "clue_2"
    ],
    "dramaticElements": {
      "conflict": "Eleanor presses Ivor for details.",
      "tension": "Ivor becomes increasingly defensive.",
      "microMomentBeats": [
        "Eleanor notices Ivor's clenched fists as he answers her questions."
      ]
    },
    "summary": "Eleanor questions Ivor Hale about his whereabouts during the murder, focusing on his alibi. Ivor insists he was in the dining room at eight-thirty, but his defensiveness raises Eleanor's suspicions. She begins to piece together the timeline.",
    "beat": "motives",
    "estimatedWordCount": 1800,
    "pivotElement": "Ivor's insistence on his alibi.",
    "factEstablished": "Establishes Ivor Hale's alibi as potentially unreliable, given his defensiveness.",
    ...
    "emotionalRegister": "A pivotal clue about the tampered clock shifts the investigation's direction.",
