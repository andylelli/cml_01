...
- Project ID: ``
- Timestamp: `2026-07-20T20:39:41.967Z`
...
• [clue_2] suggests, clock, manipulated, misrepresent, time
...
• [clue_4] eliminates, beatrice, quill, because, eleanor, voss, theater
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: eliminates, beatrice, quill, corroborated

• [clue_5] eliminates, sylvia, trent, because, dinner, party, eight, thirty
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: eliminates, sylvia, trent, corroborated, alibi

• [clue_6] eliminates, hugo, vane, because, seen, club, eight, forty, five
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: eliminates, hugo, vane, corroborated
...
• [clue_fp_contradiction_step_3] faint, scratch, clock, casing, indicating, tampering
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: suggests, clock, manipulated, misrepresent, time
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the first lamps flickered on in the corridors and the last rays of daylight slipped away, Eleanor felt the weight of history pressing in. 'Ah, history has a way of repeating itself, doesn’t it? ' she murmured, recalling past investigations where the truth h..."
...
Known location profile anchors: Hotel Le Rivage, The Observation Deck, The Grand Lounge, The Kitchen, The Library, Eleanor's temporary lodging
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Hotel Le Rivage", "The Observation Deck", "The Grand Lounge", "The Kitchen", "The Library", "Eleanor's temporary lodging"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 6: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with an expository setup — e.g. "It was not until…" / "There had been no word since…" / "There was a note on the table…". Begin with "It was", "There was", or "There had been" followed immediately by a specific condition, event, or discovery. Do not open on generic mood alone — but still anchor the location and weave in the sensory + time-of-day grounding across the next sentence or two. Anchor opening in "Eleanor's temporary lodging". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Chapter 5 (score 96/100):
  Quality gaps noted: scene grounding weakness
  Address in upcoming chapters: Open next chapter with a named location anchor plus at least two sensory cues and one atmosphere marker.
- Phrases to avoid (already overused in earlier chapters): "it just delightful how the world works", "all about the bottom line he said".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=17454; context=6541; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_3 must appear in Act 2, Scene 3 via Physical evidence examination
...
- Chapter 6:
  ...
  - Scene is set in: Eleanor's temporary lodging — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the first lamps flickered on in the corridors and the last rays of daylight slipped away, Eleanor felt the weight of history pressing in. 'Ah, history has a way of repeating itself, doesn’t it? ' she murmured, recalli...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • clock, shows, time, inconsistent, witness, statements [clue_2]
      Points to: clock, time, accurate
    • eleanor, voss, ticket, stub, theater [clue_3]
      Points to: eliminates, eleanor, voss, corroborated, alibi
    • beatrice, quill, presence, confirmed, theater [clue_4]
      Points to: eliminates, beatrice, quill, corroborated
    • sylvia, trent, dinner, invitation, timestamps [clue_5]
      Points to: eliminates, sylvia, trent, corroborated, alibi
    • hugo, vane, club, receipts, time [clue_6]
      Points to: eliminates, hugo, vane, corroborated
    • clock, shows, time, inconsistent, actual, death [clue_culprit_direct_1]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • clock, shows, time, inconsistent, actual, death [clue_fp_contradiction_step_3]
      Points to: suggests, clock, manipulated, misrepresent, time
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Eleanor's theory implicating Hugo Vane."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Eleanor believes Hugo Vane is the murderer, despite her doubts."
...
[
  {
    ...
    "setting": {
      "location": "Eleanor's temporary lodging",
      "timeOfDay": "Evening",
    ...
    "purpose": "Eleanor develops a theory that points to an innocent suspect",
    "cluesRevealed": [
      "clue_2",
      "clue_3",
      "clue_4",
    ...
    "dramaticElements": {
      ...
      "tension": "The pressure mounts as she feels she is close to solving the case.",
      "microMomentBeats": [
        "Eleanor stares out the window, contemplating the weight of suspicion."
      ]
    },
    "summary": "Eleanor pieces together the information she has gathered and develops a theory that points to Hugo Vane as the murderer. The evidence seems compelling, but a nagging doubt lingers in her mind. She resolves to confront Hugo the next day.",
    "beat": "false_solution",
    "estimatedWordCount": 1800,
    "pivotElement": "Eleanor's theory implicating Hugo Vane.",
    "factEstablished": "Eleanor believes Hugo Vane is the murderer, despite her doubts.",
    ...
    "emotionalRegister": "Revelations about the suspects deepen the emotional stakes and tensions.",
...
```text
{
  ...
  "chapters": [
    {
      ...
      "summary": "Eleanor, alone in her temporary lodging, pieces together the evidence and—under mounting pressure—develops a theory that points to Hugo Vane as the murderer. The clues seem to fit, but she is unsettled by doubts she cannot quite name.",
      "paragraphs": [
  ...
  "note": "",
  "audit": {
    "locked_fact_phrases": "present in paragraph 2, 3, 4, 6, 7 | absent",
    "season_words_used": "summery, summer, midsummer",
    "discriminating_test_present": "no",
    "required_clues_present": "clue_2: paragraph 2; clue_3: paragraph 3, 6, 8; clue_4: paragraph 6, 8; clue_5: paragraph 6; clue_6: paragraph 5, 6; clue_culprit_direct_1: paragraph 7; clue_fp_contradiction_step_3: paragraph 7",
    "early_observation_present": "Eleanor reviews the contradiction between the clocks and the ticket stub: paragraph 2, 3",
...
PRIMARY FAILURES
- Chapter 6: scene cast coverage missing — expected at least one of [Eleanor Voss] to appear by name in prose.
