...
- Project ID: ``
- Timestamp: `2026-07-13T20:45:07.236Z`
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Dr. Finch wrestles with guilt and fear, torn between her professional integrity and the desire for personal happiness that comes with her secret affair."
...
• [clue_5] eliminates, eleanor, voss, because, seen, different, location, time, murder
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: eliminates, eleanor, voss, suspect

• [clue_6] eliminates, mallory, finch, because, attending, medical, conference, time, murder
  Category: testimonial | Criticality: essential | Supports inference step 2
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Outside, the fog pressed close against the windows, the world reduced to shadows and uncertainty. Eleanor Voss stood in the dim lamplight, notebook in hand, and wondered which truth would survive the coming storm. The parlor was silent now, save for the rain—a..."
...
Known location profile anchors: The Grand Seaside Hotel, Grand Lobby, Ocean View Dining Hall, Guest Rooms, Rooftop Terrace, the local medical conference
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Grand Seaside Hotel", "Grand Lobby", "Ocean View Dining Hall", "Guest Rooms", "Rooftop Terrace", "the local medical conference"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 5: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a temporal subordinate clause — e.g. "When [Name] entered…" / "After the last guest…" / "Before the household had stirred…" / "As the light faded…". Anchor opening in "the local medical conference". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=15831; context=6625; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_5 must appear in Act 2, Scene 2 via Witness alibi confirmation.
...
- Chapter 5:
  ...
  - Scene is set in: the local medical conference — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Outside, the fog pressed close against the windows, the world reduced to shadows and uncertainty. Eleanor Voss stood in the dim lamplight, notebook in hand, and wondered which truth would survive the coming storm. The pa...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • eleanor, voss, confirmed, elsewhere [clue_5]
      Points to: eliminates, eleanor, voss, suspect
...
Chapter 5 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Finch's confirmed alibi with multiple witnesses"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Finch was not at the scene during the murder, but her motives remain unclear."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Finch's gaze flickers nervously as she recounts her day, a hint of fear in her eyes."
      ]
    },
    ...
    "emotionalRegister": "Key evidence reveals the method of deception that complicates the timeline of the murder.",
