...
- Project ID: ``
- Timestamp: `2026-07-31T15:42:31.382Z`
...
- Hugo Vane
  ...
  Connection to victim: Friend of Sylvia Trent.
  Investigation relevance: is actively driving interviews and credibility checks in this scene.
  Suspicion/pressure cue seed: Overly focused on details.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Eleanor Voss
  Public identity anchor: Hotel Owner; suspect 
  Connection to victim: Friend of Sylvia Trent.
  Investigation relevance: access plausibility: medium | alibi window: 9:00 PM to 10:00 PM | opportunity channel: Lobby.
  Suspicion/pressure cue seed: Nervous around Captain Hale.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Dr. Mallory Finch
  Public identity anchor: General Practitioner; suspect 
  Connection to victim: directly affected by Sylvia Trent's death and its fallout.
  Investigation relevance: access plausibility: medium | alibi window: 9:15 PM to 10:15 PM | opportunity channel: Medical supply room.
  Suspicion/pressure cue seed: Defensive about medical credentials.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Beatrice Quill
  Public identity anchor: Socialite; suspect 
  Connection to victim: Cousins; Beatrice admires Sylvia’s success and has always sought her approval, but it's not reciprocated..
  Investigation relevance: access plausibility: high | alibi window: 9:00 PM to 10:00 PM | opportunity channel: Staff areas.
  Suspicion/pressure cue seed: Overly eager to please.
  Investigator read: in
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=7759; context=12262; dropped=[none]; truncated=[first_appearance_contracts, location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - PLANT OBLIGATIONS (incidental appearances): each item below MUST appear in this chapter as a passing physical detail a character sees, handles, or walks past — with its significance UNFLAGGED:
    • witnesses, testimonies, argument [plant:clue_core_contradiction_chain]
    • captain, ivor, hale, nervous, behavior [plant:clue_mid_2]
  ...
  - Sensory obligation — use at least two of: grey light filtering through windows, raindrops streaking the glass | steady rain on the roof, soft whispers of guests | freshly brewed tea. Mood: somber reflection.
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The lifeless body of Sylvia Trent discovered in the lobby."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the victim is dead, heightening the stakes for all present."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor glances nervously at the door, her hands trembling."
      ]
    },
    ...
    "emotionalRegister": "The discovery of Sylvia's body casts a pall over the hotel, introducing a profound sense of loss.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 1: the clue [clue_early_1] (clock, lobby, shows, time, minutes, past, eight) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
