...
- Project ID: `unknown`
- Timestamp: `2026-07-31T15:37:59.974Z`
...
1. Generate a clue that makes the reader directly observe: "The clock in the lobby shows the time as ten...."
   → observation | essential | early | temporal | step 1 | terms: clock, lobby, shows

2. Generate a clue that provides evidence for: "This indicates a tampering that misrepresents the actual time of death...."
   → contradiction | essential | early | temporal | step 1 | terms: indicates, tampering, misrepresents

3. Generate a clue that makes the reader directly observe: "Witnesses recall arguing between Sylvia and Dr. Finch shortly before ten...."
   → observation | essential | early | temporal | step 2 | terms: witnesses, recall, arguing

4. Generate a clue that provides evidence for: "This suggests Dr. Finch was present but does not prove guilt...."
   → contradiction | essential | early | testimonial | step 2 | terms: suggests, finch, present

5. Generate a clue that makes the reader directly observe: "The clock shows signs of tampering with a layer of dust on its surface...."
   → observation | essential | mid | temporal | step 3 | terms: clock, shows, signs

6. Generate a clue that provides evidence for: "This implies that the clock was manipulated recently...."
   → contradiction | essential | mid | temporal | step 3 | terms: implies, clock, manipulated

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "This indicates a tampering that misrepresents the actual time of death...."
   → contradiction | essential | mid | temporal | step 1 | terms: indicates, tampering, misrepresents

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "A mechanical clock has been strategically tampered with to mislead witnesses about the time of death...."
   → observation | essential | early | temporal | terms: mechanical, clock, strategically

9. Generate one essential EARLY clue giving a concrete, fair-play indicator of the manner of death (struck with a heavy clock) observable at the body-discovery scene — e.g. for blunt-force: a head wound, a bloodied heavy object, or bruising. Do NOT name or explain the concealment trick; only the physical tell a witness could see at the scene.
   → observation | essential | early | temporal | terms: struck, heavy, clock, wound, blood, bruis, blunt

10. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Comparing the chime time with witness accounts and the forensic report reveals the tampering...."
   → observation | essential | mid | temporal | terms: comparing, chime, witness
...
11. Generate one essential mid-story clue whose description or pointsTo explicitly names Captain Ivor Hale and states the unique trace, preparation detail, or mechanism link that points to Captain Ivor Hale rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Captain Ivor Hale, mechanical, clock, strategically
...
12. Generate one essential early-or-mid clue establishing that Captain Ivor Hale UNIQUELY had the means/skill/access/knowledge required to execute the concealment mechanism, and that the other suspects did not — so the reveal relies only on this already-planted capability, never on a means introduced for the first time at the confrontation.
   → elimination | essential | mid | temporal | terms: Captain Ivor Hale, mechanical, clock, strategically

13. Generate a clue showing observable evidence of Captain Ivor Hale's premeditation or planning (Disgrace from scandal). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: disgrace, scandal
...
15. Generate one essential early or mid elimination clue that explicitly rules out Eleanor Voss and narrows the solution toward culprit Captain Ivor Hale. The pointsTo text must start with "Eliminates Eleanor Voss because ..." and cite corroborated evidence.
...
Create 2 red herrings that support the false assumption: "Sylvia was killed shortly after the clock chimed at ten."
...
- STRICT STRUCTURAL CONTRACT (author ALL of these YOURSELF, as concrete scene-register clues — a character sees/hears/finds something. NEVER meta-boilerplate like "adds texture to the case background"; if you omit any, a deterministic pass will synthesize flat machine text in its place, which reads as machine-made):
    ...
    • DIRECT CULPRIT CLUE: id="clue_culprit_direct_captain_ivor_hale" — observable evidence tying Captain Ivor Hale uniquely to the crime (source from: CASE.cast[2].alibi_window, CASE.cast[2].access_plausibility, CASE.inference_path.steps[1].observation, CASE.inference_path.steps[1].correction); the pointsTo must include: Captain Ivor Hale, direct evidence, means and opportunity, no other eligible suspect
