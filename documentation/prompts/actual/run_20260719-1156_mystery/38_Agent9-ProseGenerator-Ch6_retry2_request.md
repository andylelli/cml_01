...
- Project ID: ``
- Timestamp: `2026-07-19T12:07:15.977Z`
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=17163; context=5868; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
PRIMARY FAILURES
- Chapter 6: Chapter 6 contains control-plane leakage (instruction_shape): "Eleanor recited the chain of logic: opportunity, motive rooted in professional criticism, and the technical knowledge required to manipulate the poison." (Remove prompt, validation, retry, or scaffold terminology from reader-facing prose)
- VICTIM ALIVE: "Eleanor’s gaze drifted to the sticky residue still visible on Hugo Vane’s glass, which now sat on a tray beside the hear"
...
ATTEMPT: 2/3
OFFENDING TEXT: Eleanor recited the chain of logic: opportunity, motive rooted in professional criticism, and the technical knowledge required to manipulate the poison.
MANDATORY FIXES:
- Resolve template issues before accepting this batch.
- Chapter 6: Chapter 6 contains control-plane leakage (instruction_shape): "Eleanor recited the chain of logic: opportunity, motive rooted in professional criticism, and the technical knowledge required to manipulate the poison." (Remove prompt, validation, retry, or scaffold terminology from reader-facing prose)
- VICTIM ALIVE: "Eleanor’s gaze drifted to the sticky residue still visible on Hugo Vane’s glass, which now sat on a tray beside the hear"
