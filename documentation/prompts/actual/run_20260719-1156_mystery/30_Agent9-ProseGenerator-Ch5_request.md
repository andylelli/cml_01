...
- Project ID: ``
- Timestamp: `2026-07-19T12:04:25.668Z`
...
• [clue_core_elimination_chain] eliminates, mallory, finch, because, attending, patients, time, murder
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: narrowing, suspicion, towards, suspects

• [clue_3] residue, indicates, poison, likely, beverage
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: drink, source, poison

• [clue_id_2] suggests, indeed, poisoned, drink, left, alone
  Category: testimonial | Criticality: essential | Supports inference step 2
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_id_1, clue_1, clue_4, clue_9, clue_culprit_direct_beatrice_quill, clue_5, clue_6, clue_early_1 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): poison, become, lethal | victim, drink, untouched, until, dinner | timing, drink, exposure, crucial | poison, likely, beverage | timing, drink, exposure, crucial | victim, likely, poisoned | direct, shows, beatrice, quill, means, opportunity | beatrice, culprit | beatrice, motive, strengthens, case | drink, source, poison
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Eleanor’s final glance at Beatrice confirmed the shift: the artist’s vulnerability was no longer hidden, and the investigator’s understanding of the case had changed. The pressure had mounted, but resolution was still distant. As Eleanor prepared to press furt..."
...
- Phrases to avoid (already overused in earlier chapters): "curiosity killed the cat but satisfaction brought", "killed the cat but satisfaction brought it", "the cat but satisfaction brought it back", "murder were as straightforward as a crossword", "were as straightforward as a crossword puzzle", "as straightforward as a crossword puzzle the", "straightforward as a crossword puzzle the guests", "the clues were present but the truth", "clues were present but the truth remained", "is subjective but murder is not beatrice".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=14519; context=8082; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_2 must appear in Act 2, Scene 2 via Corroborated elimination
...
- Chapter 5:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Eleanor’s final glance at Beatrice confirmed the shift: the artist’s vulnerability was no longer hidden, and the investigator’s understanding of the case had changed. The pressure had mounted, but resolution was still di...".
...
Chapter 5 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Beatrice's conflicting timeline."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Beatrice's alibi does not align with the others, raising suspicion."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor's heart races as she realizes the implications of the alibis."
      ]
    },
    ...
    "emotionalRegister": "A revelation about Beatrice's access reshapes the understanding of events.",
