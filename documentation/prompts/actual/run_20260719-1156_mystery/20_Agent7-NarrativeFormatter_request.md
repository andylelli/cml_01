...
- Project ID: `unknown`
- Timestamp: `2026-07-19T12:01:26.469Z`
...
**Era & Setting**: 1940s - A mid-century seaside hotel with art deco influences
**Setting Lock**: All scenes must remain within this setting: A mid-century seaside hotel with art deco influences. Do not move to a different location type.
...
Hugo was poisoned at a time when everyone was accounted for.
*Revealed: final act*
...
### Early Clues (Act I)
- [clue_mechanism_visibility_core] temporal: The thermometer on the bar reads eighty degrees Fahrenheit when checked.
- [clue_core_contradiction_chain] testimonial: Witnesses confirm the dinner began at seven.
- [clue_1] testimonial: Glass residue with a sticky substance is found near the sunlit area.
- [clue_4] temporal: The poison requires a temperature of at least eighty degrees Fahrenheit to activate.
- [clue_9] physical: The victim shows signs of convulsion with no visible wounds.
...
- [clue_id_1] temporal: The poison requires a temperature of at least eighty degrees Fahrenheit to activate.

### Mid Clues (Act II)
- [clue_core_elimination_chain] testimonial: Eliminates Dr. Mallory Finch because he was attending to patients at the time of the murder.
- [clue_2] testimonial: Witnesses remember seeing Hugo drinking alone after the bar was cleared.
- [clue_3] testimonial: This residue indicates the poison was likely in the beverage.
- [clue_5] behavioral: Beatrice Quill is known to have a background in toxicology.
- [clue_6] behavioral: Beatrice Quill has a motive related to inheritance.
- [clue_7] testimonial: This suggests he was indeed poisoned after the drink was left alone.
- [clue_8] physical: The hotel clock stopped at half past three in the afternoon.
...
- [clue_early_1] testimonial: This residue indicates the poison was likely in the beverage.
- [clue_id_2] testimonial: This suggests he was indeed poisoned after the drink was left alone.
- [clue_fp_contradiction_step_3] temporal: Witnesses remember seeing Hugo drinking alone after the bar was cleared.

### Late Clues (Act III)
- [clue_late_optional_slot_1] temporal: The hotel clock stopped at a specific time. remains a late texture detail in the case background.

### Red Herrings
- [rh_1] Several guests claim they saw Hugo with his drink during dinner.
- [rh_2] Eleanor Voss mentions hearing a loud argument between Hugo and another guest before dinner.
...
- **Dr. Mallory Finch**: Act 3, Scene 5
  - Method: His medical alibi during the time of serving drinks clears him.
  - Clues: clue_id_1, clue_id_2
- **Captain Ivor Hale**: Act 3, Scene 5
  - Method: His location was verified at the time of the incident by multiple witnesses.
  - Clues: clue_id_1, clue_id_2
- **Sylvia Trent**: Act 3, Scene 5
  - Method: Her alibi is confirmed by her interactions with other guests.
  - Clues: clue_id_1, clue_id_2
...
- **Revelation method:** Confrontation with evidence linking Beatrice to the poisoned drink.
...
- **temperature_activation**: "eighty degrees" — The temperature required for the poison to become lethal
- **time_exposure**: "half past three in the afternoon" — The time the drink was left in the sun
- **amount_poison**: "two ounces" — The amount of poison administered in the drink


## PILLAR 4 — OUTLINE COMPLETENESS CONTRACT DATA

### Character Permitted Behaviours (use for permittedBehavioursByAct per scene)
- **Eleanor Voss**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Curiosity about the strange happenings in the hotel" — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Haunted by the repercussions of her past article, Eleanor grapples with the fear that her pursuit of truth might lead her to hurt others again." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Dr. Mallory Finch**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Victim discovered malpractice and intended to expose it." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Dr. Finch is torn between his ambition to maintain his practice's reputation and the guilt of his unethical actions that could ruin lives." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Captain Ivor Hale**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Victim insulted his military service in a public forum." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Captain Hale is tormented by his past decisions and survivor's guilt, struggling with the notion of honor versus the reality of his actions." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Beatrice Quill**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Victim ridiculed her artwork in a public setting." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Beatrice wrestles with her self-worth, torn between her passion for art and the fear that she will never be good enough." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Sylvia Trent**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "The victim threatened to expose her connections to illicit activities." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Sylvia is torn between her desire for power and the fear that her secrets will unravel, exposing her vulnerabilities." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Hugo Vane**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "N/A" — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted.  | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.

### Red Herrings (must be seeded in Act I–II scenes via redHerringPlacement)
- **rh_1**: Several guests claim they saw Hugo with his drink during dinner. (misdirection: This leads to the false assumption that no one could have tampered with his drink.)
- **rh_2**: Eleanor Voss mentions hearing a loud argument between Hugo and another guest before dinner. (misdirection: This creates a distraction from the actual timeline of events.)
```
