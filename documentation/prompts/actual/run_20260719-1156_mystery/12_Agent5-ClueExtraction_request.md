...
- Project ID: `unknown`
- Timestamp: `2026-07-19T11:59:05.555Z`
...
1. Generate a clue that makes the reader directly observe: "The thermometer on the bar reads eighty degrees Fahrenheit when checked...."
   → observation | essential | early | temporal | step 1 | terms: thermometer, reads, eighty

2. Generate a clue that provides evidence for: "The poison could only activate at this temperature...."
   → contradiction | essential | early | testimonial | step 1 | terms: poison, activate, temperature.

3. Generate a clue that makes the reader directly observe: "Glass residue with a sticky substance is found near the sunlit area...."
   → observation | essential | early | testimonial | step 2 | terms: glass, residue, sticky

4. Generate a clue that provides evidence for: "This residue indicates the poison was likely in the beverage...."
   → contradiction | essential | early | testimonial | step 2 | terms: residue, indicates, poison

5. Generate a clue that makes the reader directly observe: "Witnesses remember seeing Hugo drinking alone after the bar was cleared...."
   → observation | essential | mid | temporal | step 3 | terms: witnesses, remember, seeing

6. Generate a clue that provides evidence for: "This suggests he was indeed poisoned after the drink was left alone...."
   → contradiction | essential | mid | temporal | step 3 | terms: suggests, indeed, poisoned

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The poison could only activate at this temperature...."
   → contradiction | essential | mid | testimonial | step 1 | terms: poison, activate, temperature.

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The poison requires a temperature of at least eighty degrees Fahrenheit to activate, which was only reached after the drink was left unatten..."
   → observation | essential | early | temporal | terms: poison, requires, temperature

9. Generate one essential EARLY clue giving a concrete, fair-play indicator of the manner of death (poisoned with delayed-action toxin) observable at the body-discovery scene — e.g. for poison: numbness, a bitter almond residue, constriction, or sudden collapse with no wound. Do NOT name or explain the concealment trick; only the physical tell a witness could see at the scene.
...
10. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Reenacting the drink serving process while checking the residue on various glasses to compare with H..."
   → observation | essential | mid | testimonial | terms: reenacting, drink, serving
...
11. Generate one essential mid-story clue whose description or pointsTo explicitly names Beatrice Quill and states the unique trace, preparation detail, or mechanism link that points to Beatrice Quill rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Beatrice Quill, poison, requires, temperature
...
12. Generate one essential early-or-mid clue establishing that Beatrice Quill UNIQUELY had the means/skill/access/knowledge required to execute the concealment mechanism, and that the other suspects did not — so the reveal relies only on this already-planted capability, never on a means introduced for the first time at the confrontation.
   → elimination | essential | mid | temporal | terms: Beatrice Quill, poison, requires, temperature

13. Generate a clue showing observable evidence of Beatrice Quill's premeditation or planning (inheritance). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
...
## Access Constraints
Actors: All suspects had access to the bar., Hugo had access to all hotel areas.
Objects: The poison was kept in the bar's locked cabinet., The drinks were served from the main bar.
...
Create 2 red herrings that support the false assumption: "Hugo was poisoned at a time when everyone was accounted for."
