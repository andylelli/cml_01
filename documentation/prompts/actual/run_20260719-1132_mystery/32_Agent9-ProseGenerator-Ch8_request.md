...
- Project ID: ``
- Timestamp: `2026-07-19T11:42:44.244Z`
...
• [clue_late_optional_slot_1] dinner, time, approximately, seven, clock, evening, remains, late, texture, detail, case, background
...
CLUES ALREADY REVEALED TO READER: clue_early_1, clue_fp_contradiction_step_2, clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_3, clue_7, clue_culprit_direct_dr_mallory_finch, clue_4, clue_5, clue_6, clue_9, clue_11, clue_culprit_direct_1, clue_8, clue_core_elimination_chain — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): links, sylvia, meal, dandelion, toxin | indicates, dandelion, involved, poisoning | suggests, poison, administered, well, before, dinner | contradicts, assumption, finch, poisoned, sylvia, before | indicates, dandelion, involved, poisoning | links, sylvia, meal, dandelion, toxin | direct, shows, mallory, finch, means, opportunity | raises, questions, finch, involvement | suggests, finch, alibi | contradicts, assumption, finch, involved | establishes, finch, expertise, toxin | further, narrows, suspects | physical, trace, opportunity, indicate, mallory, finch | suggests, potential, guilt, knowledge, crime | narrows, focus, toward, mallory, finch
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "She lingered by the mantel, her gaze drawn once more to the envelope and the silent dandelion leaf within. Outside, the wind howled, and inside, the lounge braced for what must come next. The truth, Eleanor sensed, was not a single thread but a knot—one that w..."
...
Render this test MECHANISM as live, in-scene action and dialogue, composing ENTIRELY in your own words from these elements (reproducing any briefing phrase verbatim FAILS validation): discriminating, compares, poison, witness, report, claimed, timeline
...
☐ **Evidence Integration**
  ...
  ☐ Explicitly reference or use clue: "clue_7" (clue) (appears in Act 1, Scene 3)
...
- Phrases to avoid (already overused in earlier chapters): "inside the lounge of the seaside hotel", "with the scent of damp wool and", "you know it s a curious thing", "know it s a curious thing how", "s a curious thing how the smallest", "fascinating how people can be so complex", "the scent of damp wool and the", "let s not beat around the bush", "s not beat around the bush shall", "not beat around the bush shall we".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=22697; context=4788; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
Manner of death (MUST be named in the reveal): state plainly how the victim died — cause of death: poisoned with dandelion toxin. Surface it in the prose in plain words (e.g. "poisoned with dandelion toxin") — not only how the clock/timeline was manipulated. A reveal that explains the concealment but never the killing fails the fair-play contract.
...
- Chapter 8:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "She lingered by the mantel, her gaze drawn once more to the envelope and the silent dandelion leaf within. Outside, the wind howled, and inside, the lounge braced for what must come next. The truth, Eleanor sensed, was n...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • dinner, time, approximately, seven, clock, evening, remains, late, texture, detail, case, background [clue_late_optional_slot_1]
      Points to: adds, late, texture, changing, essential, deduction, chain
  ...
  - ⚠ DISCRIMINATING TEST (trap) — MANDATORY real-time scene with dialogue and confrontation. DO NOT summarize it after the fact.
    ...
    Elements the test must dramatize (compose the scene ENTIRELY in your own sentences from these — reproducing any briefing phrase verbatim FAILS validation): discriminating, compares, poison, witness, report, claimed, timeline
    Cite these already-revealed clue IDs during the test: clue_mechanism_visibility_core, clue_7, clue_culprit_direct_1
    ...
    Motive statement REQUIRED: the culprit must explicitly state or acknowledge their motive during or immediately after the confrontation. Canonical motive: "Unrequited love". Do not omit it.
...
Chapter 8 (Act 3) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Eleanor's staged test involving the dandelion leaf."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Dr. Finch's reaction will determine her guilt."
...
[
  {
    ...
    "purpose": "Stage the discriminating test to expose the culprit",
    "cluesRevealed": [
      "clue_late_optional_slot_1",
      "clue_mechanism_visibility_core"
    ],
    "dramaticElements": {
      "conflict": "Tension mounts as Eleanor prepares her trap.",
      "tension": "The atmosphere is thick with anticipation.",
      "microMomentBeats": [
        "Eleanor's hands tremble as she sets the stage for the confrontation."
      ]
    },
    "summary": "Eleanor stages a test to reveal the truth about the poisoning, using the dandelion leaf as a focal point. She carefully lays out the timeline and presents the evidence to Dr. Finch, watching for her reaction. The tension in the room escalates as Eleanor prepares to confront the doctor with her deductions.",
    "beat": "final_trap",
    "estimatedWordCount": 1800,
    "pivotElement": "Eleanor's staged test involving the dandelion leaf.",
    "factEstablished": "Establishes that Dr. Finch's reaction will determine her guilt.",
    ...
    "emotionalRegister": "Pressure mounts as hidden truths come to light.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 8: the clue [clue_mechanism_visibility_core] (witnesses, report, seeing, sylvia, looking, healthy, vibrant, thirty) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
