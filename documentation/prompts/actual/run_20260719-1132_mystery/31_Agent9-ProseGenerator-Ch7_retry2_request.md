...
- Project ID: ``
- Timestamp: `2026-07-19T11:42:14.033Z`
...
• [clue_8] mallory, finch, exhibits, signs, nervousness, questioned, sylvia
  Category: behavioral | Criticality: essential | Supports inference step 2
  Points to: suggests, potential, guilt, knowledge, crime

• [clue_core_elimination_chain] eliminates, eleanor, voss, because, seen, leaving, premises, seven, fifteen
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: narrows, focus, toward, mallory, finch
...
CLUES ALREADY REVEALED TO READER: clue_early_1, clue_fp_contradiction_step_2, clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_3, clue_7, clue_culprit_direct_dr_mallory_finch, clue_4, clue_5, clue_6, clue_9, clue_11, clue_culprit_direct_1 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): links, sylvia, meal, dandelion, toxin | indicates, dandelion, involved, poisoning | suggests, poison, administered, well, before, dinner | contradicts, assumption, finch, poisoned, sylvia, before | indicates, dandelion, involved, poisoning | links, sylvia, meal, dandelion, toxin | direct, shows, mallory, finch, means, opportunity | raises, questions, finch, involvement | suggests, finch, alibi | contradicts, assumption, finch, involved | establishes, finch, expertise, toxin | further, narrows, suspects | physical, trace, opportunity, indicate, mallory, finch
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "She lingered by the mantel, her gaze drawn once more to the envelope and the silent dandelion leaf within. The clues were converging, but the answer remained elusive. Outside, the wind howled, and inside, the lounge of the seaside hotel braced for the next rev..."
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=19323; context=4635; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
Chapter 7 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Hidden truths about the relationships among the guests."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that personal motives intertwine with the murder investigation, complicating the suspects' profiles."
...
[
  {
    ...
    "dramaticElements": {
      "conflict": "Revelations shake the group, altering their perceptions.",
      "tension": "Eleanor senses shifting alliances.",
      "microMomentBeats": [
        "Eleanor feels a chill as secrets are laid bare."
      ]
    },
    "summary": "Eleanor uncovers unsettling truths about the relationships among the guests. Hidden motives and past grievances surface, complicating the investigation. The group grapples with their pasts, and Eleanor realizes that the red herrings may have been distractions from the true nature of the crime.",
    "beat": "secrets",
    "estimatedWordCount": 1800,
    "pivotElement": "Hidden truths about the relationships among the guests.",
    "factEstablished": "Establishes that personal motives intertwine with the murder investigation, complicating the suspects' profiles.",
