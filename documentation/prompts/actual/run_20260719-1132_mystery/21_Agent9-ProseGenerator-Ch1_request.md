...
- Project ID: ``
- Timestamp: `2026-07-19T11:37:51.573Z`
...
- Eleanor Voss
  ...
  Connection to victim: Acquaintances; Eleanor attends social gatherings where Sylvia is often present but knows little about her personal life..
...
- Dr. Mallory Finch
  ...
  Investigation relevance: access plausibility: medium | alibi window: Claims to have been in the lounge | opportunity channel: Medical supplies.
...
- Captain Ivor Hale
  ...
  Connection to victim: directly affected by Sylvia Trent's death and its fallout.
  Investigation relevance: access plausibility: high | alibi window: Claims to be in the garden.
  Suspicion/pressure cue seed: Professional integrity.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Beatrice Quill
  Public identity anchor: Aspiring Artist; suspect 
  Connection to victim: Rival Artists; Both are vying for the same art grant and have had heated arguments about their work..
  Investigation relevance: access plausibility: medium | alibi window: Claims to have
...
• [clue_early_1] witnesses, recall, sylvia, last, meal, dandelion, salad
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: links, sylvia, meal, dandelion, toxin

• [clue_fp_contradiction_step_2] dandelion, leaf, sylvia, pocket
  Category: testimonial | Criticality: essential | Supports inference step 2
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=8017; context=12566; dropped=[none]; truncated=[first_appearance_contracts, location_profiles, temporal_context, pronoun_accuracy]
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The dandelion leaf found in Sylvia's hand."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that a murder has occurred, stirring suspicion among the guests."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor stares blankly at the floor, lost in thought."
      ]
    },
    "summary": "As the morning light filters through the windows, the guests of the seaside hotel gather in the lounge, their faces pale and anxious. Eleanor Voss, having been invited to the hotel, discovers Sylvia Trent's lifeless body sprawled on the floor, a dandelion leaf clutched in her hand. Shock grips the room as the others react to the grim discovery, and Eleanor's instinct as an amateur detective kicks in.",
    "beat": "gathering",
    "estimatedWordCount": 1800,
    "pivotElement": "The dandelion leaf found in Sylvia's hand.",
    "factEstablished": "Establishes that a murder has occurred, stirring suspicion among the guests.",
    ...
    "emotionalRegister": "The atmosphere is thick with unease as guests gather for dinner.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (witnesses, report, seeing, sylvia, looking, healthy, vibrant, thirty) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_early_1] (witnesses, recall, sylvia, last, meal, dandelion, salad) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_fp_contradiction_step_2] (dandelion, leaf, sylvia, pocket) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
