...
- Project ID: ``
- Timestamp: `2026-07-19T11:40:25.651Z`
...
• [clue_11] eliminates, hugo, vane, because, theater, time, murder
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: further, narrows, suspects
...
CLUES ALREADY REVEALED TO READER: clue_early_1, clue_fp_contradiction_step_2, clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_3, clue_7, clue_culprit_direct_dr_mallory_finch, clue_4, clue_5, clue_6, clue_9 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): links, sylvia, meal, dandelion, toxin | indicates, dandelion, involved, poisoning | suggests, poison, administered, well, before, dinner | contradicts, assumption, finch, poisoned, sylvia, before | indicates, dandelion, involved, poisoning | links, sylvia, meal, dandelion, toxin | direct, shows, mallory, finch, means, opportunity | raises, questions, finch, involvement | suggests, finch, alibi | contradicts, assumption, finch, involved | establishes, finch, expertise, toxin
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Eleanor returned to the mantel, her gaze lingering on the envelope and the silent dandelion leaf within. The clues were converging, but the truth remained elusive, shrouded in the same fog that pressed against the glass. She knew only this: the investigation h..."
...
- Phrases to avoid (already overused in earlier chapters): "with the scent of damp wool and", "you know it s a curious thing", "know it s a curious thing how", "s a curious thing how the smallest", "fascinating how people can be so complex", "the scent of damp wool and the", "let s not beat around the bush", "s not beat around the bush shall", "not beat around the bush shall we".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=17639; context=5808; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 6:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Eleanor returned to the mantel, her gaze lingering on the envelope and the silent dandelion leaf within. The clues were converging, but the truth remained elusive, shrouded in the same fog that pressed against the glass....".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • hugo, ticket, stub, witnesses, confirm, presence [clue_11]
      Points to: further, narrows, suspects
    • timeline, finch, movements [clue_6]
      Points to: contradicts, assumption, finch, involved
    • finch, body, language, questioning [clue_8]
    ...
    • records, finch, medical, practice [clue_9]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • witnesses, confirm, eleanor, departure [clue_core_elimination_chain]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • witnesses, recall, sylvia, appearance [clue_culprit_direct_1]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Eleanor's flawed theory implicating Captain Hale."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes a false solution that misdirects the group, but Eleanor feels something is off."
...
[
  {
    ...
    "dramaticElements": {
      "conflict": "Eleanor proposes a theory that points to one suspect.",
      "tension": "The group reacts with disbelief and fear.",
      "microMomentBeats": [
        "Eleanor's heart sinks as she realizes the flaw in her theory."
      ]
    },
    "summary": "Eleanor presents a theory that implicates Captain Hale, citing his potential motive linked to family secrets. The group is shaken, but Eleanor soon realizes a critical flaw in her reasoning. The case appears solved to the others, but Eleanor remains unconvinced, sensing something deeper at play.",
    "beat": "false_solution",
    "estimatedWordCount": 1800,
    "pivotElement": "Eleanor's flawed theory implicating Captain Hale.",
    "factEstablished": "Establishes a false solution that misdirects the group, but Eleanor feels something is off.",
    ...
    "emotionalRegister": "Eleanor must confront her self-doubt and insecurities.",
