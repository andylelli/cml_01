...
- Project ID: ``
- Timestamp: `2026-07-20T22:32:37.479Z`
...
- Era-authentic markers: radio broadcasting, early television sets, manual typewriters, rationed fuel, post-war automobile boom, public transport with limited schedules, long-distance telephone calls, military-style coded messages
- Tone: Classic
- No anachronisms
...
Description: A grand seaside hotel with Art Deco architecture, featuring a lobby with high ceilings, ocean views, and a variety of guest amenities.
...
Setting constraints:
- Physical constraints: narrow hallways, restricted access to certain floors, security measures for guest privacy
- Geographic isolation: The hotel is situated on a cliffside, making it difficult for outside help to arrive quickly, especially during inclement weather.
- Access control: staff-only areas, guest check-in protocols, restricted access to the roof and maintenance areas
...
- Social norms: women in workforce due to WWII, post-war family dynamics
