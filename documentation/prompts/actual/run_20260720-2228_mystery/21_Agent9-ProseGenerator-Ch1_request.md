...
- Project ID: ``
- Timestamp: `2026-07-20T22:35:17.561Z`
...
- Dr. Mallory Finch
  Public identity anchor: Surgeon; suspect 
  ...
  Investigation relevance: access plausibility: medium | alibi window: 9:40-10:10 PM | opportunity channel: lobby.
...
- Captain Ivor Hale
  ...
  Connection to victim: directly affected by Hugo Vane's death and its fallout.
  Investigation relevance: access plausibility: high | alibi window: 9:30-10:30 PM | opportunity channel: beach.
  Suspicion/pressure cue seed: nervous around money matters.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Beatrice Quill
  Public identity anchor: Socialite; suspect 
  Connection to victim: directly affected by Hugo Vane's death and its fallout.
  Investigation relevance: access plausibility: medium | alibi window: 9:45-10:15 PM | opportunity channel: beach.
  Suspicion/pressure
...
• [clue_mechanism_visibility_core] witnesses, hugo, vane, beach, quarter
  Category: testimonial | Criticality: essential | Supports inference step 1
  Points to: hugo, vane, presence, beach, before, murder
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=7677; context=12774; dropped=[none]; truncated=[first_appearance_contracts, location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • witnesses, report, seeing, beach [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The body found washed ashore, lifeless and cold."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the victim's presence at the beach, raising questions about how they ended up there."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_1] Witnesses claim to have seen a shadowy figure near the water just before high tide.
...
[
  {
    ...
    "setting": {
      ...
      "atmosphere": "Tense, with a cold breeze sweeping over the sand"
    },
    "characters": [
      "Eleanor Voss",
      "Dr. Mallory Finch",
    ...
    "dramaticElements": {
      "conflict": "The tension among the gathered suspects heightens as they await the detective.",
      "tension": "The body is discovered, raising immediate concerns and suspicions.",
      "microMomentBeats": [
        "Eleanor Voss stares at the waves, contemplating the life lost too soon."
      ]
    },
    "summary": "As the morning sun breaks over the horizon, the beach reveals the lifeless body of an unknown victim, sending shockwaves through the gathered group. Eleanor Voss, a journalist, is drawn into the chaos, while the suspects exchange wary glances. Dr. Mallory Finch's voice quivers as he identifies the victim, leading to the first contradiction about the time of death.",
    "beat": "gathering",
    "estimatedWordCount": 1250,
    "pivotElement": "The body found washed ashore, lifeless and cold.",
    "factEstablished": "Establishes the victim's presence at the beach, raising questions about how they ended up there.",
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_1",
      "placementDetail": "Witnesses claim to have seen a shadowy figure near the water just before high tide."
    },
    "emotionalRegister": "The atmosphere is thick with tension and uncertainty as the murder disrupts the hotel’s tranquility.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (witnesses, hugo, vane, beach, quarter) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
