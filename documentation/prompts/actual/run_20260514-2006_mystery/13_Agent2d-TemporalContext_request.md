...
- Project ID: ``
- Timestamp: `2026-05-14T20:09:16.985Z`
...
- Technology available: domestic wiring with frequent outages, petrol touring cars on county roads, typewriters standard in offices
- Forensics: fingerprinting standard for crime scene evidence, basic toxicology tests available, emerging ballistics analysis
- Social norms: class tensions heightened by the Great Depression, social expectations dictated by strict hierarchies, fascism rising in Europe affecting local politics
