...
- Project ID: ``
- Timestamp: `2026-07-20T20:52:04.195Z`
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As she sat once more at the table, the lamplight pooling around her, Eleanor allowed herself a single, steadying breath. The recollection of Dr. Mallory Finch’s last appearance—alive and untroubled at the stroke of eight—became Eleanor’s fulcrum. The timeline..."
...
Render this test MECHANISM as live, in-scene action and dialogue, composing ENTIRELY in your own words from these elements (reproducing any briefing phrase verbatim FAILS validation): clock, internal, mechanism, guest, register, proves, captain, hale, opportunity, tamper
...
- Phrases to avoid (already overused in earlier chapters): "hands fixed at ten minutes past eight", "heard the clock chime at eight thirty", "the hands fixed at ten minutes past", "if the clock had truly chimed at", "the clock had truly chimed at eight", "clock had truly chimed at eight thirty", "a gust of wind rattled the windows", "at the time dr mallory finch was", "the time dr mallory finch was last", "time dr mallory finch was last seen".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=25165; context=5203; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 9:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As she sat once more at the table, the lamplight pooling around her, Eleanor allowed herself a single, steadying breath. The recollection of Dr. Mallory Finch’s last appearance—alive and untroubled at the stroke of eight...".
  ...
  - ⚠ SUSPECT CLEARANCE REQUIRED (MANDATORY): each suspect below MUST be named explicitly and cleared with on-page evidence and a reasoning connector (because / therefore / which proves):
    • "Beatrice Quill": write a dedicated paragraph that (a) names Beatrice Quill explicitly, (b) states the clearance method ("Alibi confirmed by witnesses."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
    • "Sylvia Trent": write a dedicated paragraph that (a) names Sylvia Trent explicitly, (b) states the clearance method ("Witness statements corroborate her whereabouts."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
    • "Hugo Vane": write a dedicated paragraph that (a) names Hugo Vane explicitly, (b) states the clearance method ("Alibi verified by bar staff."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
  ...
  - ⚠ DISCRIMINATING TEST (trap) — MANDATORY real-time scene with dialogue and confrontation. DO NOT summarize it after the fact.
    ...
    Elements the test must dramatize (compose the scene ENTIRELY in your own sentences from these — reproducing any briefing phrase verbatim FAILS validation): clock, internal, mechanism, guest, register, proves, captain, hale, opportunity, tamper
    Cite these already-revealed clue IDs during the test: clue_4, clue_culprit_direct_1, clue_mechanism_visibility_core, clue_culprit_direct_captain_ivor_hale
...
Chapter 9 (Act 3) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The internal mechanism of the clock shows evidence of tampering."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Hale had the opportunity and motive to commit the murder."
...
[
  {
    ...
    "setting": {
      ...
      "timeOfDay": "Evening",
      "atmosphere": "Charged with tension as Eleanor sets her trap"
    },
    "characters": [
      "Eleanor Voss",
      "Captain Ivor Hale"
    ...
    "dramaticElements": {
      ...
      "tension": "The atmosphere is thick with anticipation as the truth hangs in the balance.",
      "microMomentBeats": [
        "Eleanor's heart races as she prepares to reveal her findings."
      ]
    },
    "summary": "Eleanor stages a confrontation with Captain Hale, using the clock's discrepancies as a test. As she lays out the evidence, Hale's reaction reveals his guilt, confirming Eleanor's suspicions.",
    "beat": "final_trap",
    "estimatedWordCount": 1800,
    "pivotElement": "The internal mechanism of the clock shows evidence of tampering.",
    "factEstablished": "Establishes that Hale had the opportunity and motive to commit the murder.",
    ...
    "emotionalRegister": "The final confrontation unveils the truth, leading to a resolution.",
