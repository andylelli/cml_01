...
- Project ID: `unknown`
- Timestamp: `2026-07-20T19:04:19.515Z`
...
1. Generate a clue that makes the reader directly observe: "Witnesses report seeing Captain Hale at the ballroom entrance shortly before the murder...."
   → observation | essential | early | temporal | step 1 | terms: witnesses, report, seeing

2. Generate a clue that provides evidence for: "This suggests that Captain Hale had a presence near the time of the murder...."
   → contradiction | essential | early | temporal | step 1 | terms: suggests, captain, presence

3. Generate a clue that makes the reader directly observe: "The heavy object used for the murder was positioned unusually close to the ballroom exit...."
   → observation | essential | early | spatial | step 2 | terms: heavy, object, murder

4. Generate a clue that provides evidence for: "This indicates someone with access to the ballroom could have set up the murder...."
   → contradiction | essential | early | spatial | step 2 | terms: indicates, someone, access

5. Generate a clue that makes the reader directly observe: "Footprints leading away from the dining room match a common shoe type...."
   → observation | essential | mid | spatial | step 3 | terms: footprints, leading, dining

6. Generate a clue that provides evidence for: "This suggests the footprints belong to a hotel staff member rather than Captain Hale...."
   → contradiction | essential | mid | physical | step 3 | terms: suggests, footprints, belong

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "This suggests that Captain Hale had a presence near the time of the murder...."
   → contradiction | essential | mid | temporal | step 1 | terms: suggests, captain, presence

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The mechanism relies on witness, report, and seeing to expose the false timing...."
...
10. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "The discriminating test compares witness, presence, and report against the claimed timeline...."
...
11. Generate one essential mid-story clue whose description or pointsTo explicitly names Hugo Vane and states the unique trace, preparation detail, or mechanism link that points to Hugo Vane rather than any non-culprit.
   → observation | essential | mid | testimonial | terms: Hugo Vane, mechanism, relies, witness,
...
12. Generate one essential early-or-mid clue establishing that Hugo Vane UNIQUELY had the means/skill/access/knowledge required to execute the concealment mechanism, and that the other suspects did not — so the reveal relies only on this already-planted capability, never on a means introduced for the first time at the confrontation.
   → elimination | essential | mid | testimonial | terms: Hugo Vane, mechanism, relies, witness,

13. Generate a clue showing observable evidence of Hugo Vane's premeditation or planning (Prevent Dr. Finch from uncovering his past.). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: prevent, finch, uncovering
...
## Access Constraints
Actors: Hugo Vane, Captain Hale, Sylvia Trent
Objects: Heavy object used in the murder, Costume worn by Hugo Vane
...
Create 2 red herrings that support the false assumption: "Witnesses believed they saw Captain Hale enter and exit the ballroom shortly before the murder."
