...
- Project ID: ``
- Timestamp: `2026-07-20T19:10:47.099Z`
...
Eleanor's discovery of the costume switch marks a critical pivot in her investigation.
...
Rationale: This moment is charged with tension where humor would be inappropriate.
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Eleanor grapples with the morality of her past relationships, fearing that her pursuit of stories may have cost her genuine connections."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Captain Hale battles with the scars of his past, torn between his sense of duty and the fear that his reputation may be irreparably damaged."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Beatrice is torn between her desire for freedom and the guilt of betraying her family, fearing that her debts will ultimately consume her."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Hugo is trapped in a cycle of deceit, torn between the desire to maintain his lavish lifestyle and the fear of losing it all if his embezzlement is exposed."
...
• [clue_4] footprints, leading, away, dining, room, match, common, shoe, type
  Category: spatial | Criticality: essential | Supports inference step 3
  Points to: narrows, down, suspects, based, shoe, type

• [clue_6] hugo, vane, seen, acting, nervously, around, finch
  Category: behavioral | Criticality: essential | Supports inference step 2
  Points to: indicates, potential, premeditation, planning, regarding, finch
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_id_2, clue_fp_contradiction_step_2, clue_core_contradiction_chain, clue_id_3, clue_3, clue_5, clue_culprit_direct_hugo_vane — do not reveal these as new information.
...
Chapter 3: Chapter 3: Clue Discovery
  Events: Late morning brought little warmth to the ballroom of the Grand Seaside Hotel.
...
Known location profile anchors: The Grand Seaside Hotel, Grand Lobby, Dining Room, Kitchen, Rooftop Terrace, the dining room of the Grand Seaside Hotel
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Grand Seaside Hotel", "Grand Lobby", "Dining Room", "Kitchen", "Rooftop Terrace", "the dining room of the Grand Seaside Hotel"
...
- Phrases to avoid (already overused in earlier chapters): "the ballroom of the grand seaside hotel", "what a tangled web we weave darling", "was a slippery fish especially when everyone", "a slippery fish especially when everyone in", "slippery fish especially when everyone in the".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=13727; context=10188; dropped=[humour_guide, location_profiles, texture_pool]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 4:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "She let her gaze linger on each suspect in turn, searching for the crack in their composure, the slip that might reveal more than words ever could. The investigation was far from over, and the next question—like the next...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • footprints, visible, floor, leading, dining, room [clue_4]
      Points to: narrows, down, suspects, based, shoe, type
    • hugo, vane, fidgeting, avoiding, contact, finch [clue_6]
  ...
  - Sensory obligation — use at least two of: water droplets on window panes, dim light filtering through clouds | the patter of rain on the roof, the sound of staff preparing for the day | freshly baked bread. Mood: quiet anticipation.
...
Chapter 4 (Act 2) completeness contract:
  ...
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Dr. Finch's alibi is shaky, and the footprints suggest a hotel staff member may be involved."
...
[
  {
    ...
    "purpose": "Gather alibis and explore motives",
    "cluesRevealed": [
      "clue_4",
      "clue_6"
    ],
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor feels a chill as she realizes Dr. Finch's story doesn't add up."
      ]
    },
    "summary": "Eleanor interviews the suspects, probing their alibis. Dr. Finch appears nervous when questioned about her whereabouts, and Eleanor notes that the footprints leading away from the dining room match a common shoe type, raising suspicions.",
    "beat": "motives",
    "estimatedWordCount": 1800,
    "pivotElement": "Dr. Finch's nervous demeanor during questioning.",
    "factEstablished": "Establishes that Dr. Finch's alibi is shaky, and the footprints suggest a hotel staff member may be involved.",
    ...
    "emotionalRegister": "Eleanor's discovery of the costume switch marks a critical pivot in her investigation.",
