...
- Project ID: ``
- Timestamp: `2026-05-13T20:15:18.410Z`
...
• [clue_1] The clock shows eleven o'clock in the evening when the body is discovered.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: This establishes the time of discovery.
...
Known location profile anchors: Little Middleton Manor, The Library, The Drawing Room, The Study, The Cellar, the scene
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The Library", "The Drawing Room", "The Study", "The Cellar", "the scene"
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=5453; context=10968; dropped=[none]; truncated=[location_profiles, temporal_context]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The clock shows eleven o'clock in the evening when the body is discovered. [clue_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: This establishes the time of discovery.
...
Chapter 1 (Act 1) completeness contract:
  ...
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_1] Captain Hale mentions hearing a loud noise shortly after eleven, casting doubt on the timeline.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor lingers at the door, her face a mask of grief."
      ]
    },
    "summary": "In the dim light of the morning, Beatrice Quill arrives at the estate to find the body of the victim, a clock striking ten minutes past eleven. Eleanor Voss stands nearby, visibly shaken, while the doctor Finch and the captain Hale exchange uneasy glances.",
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_1",
      "placementDetail": "Captain Hale mentions hearing a loud noise shortly after eleven, casting doubt on the timeline."
    },
    "emotionalRegister": "The atmosphere is heavy with tension and impending doom.",
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 1: "The clock shows eleven o'clock in the evening when the body is discovered." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: "The clock time does not match the estimated time of death." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
