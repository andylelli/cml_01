...
- Project ID: ``
- Timestamp: `2026-07-23T19:47:26.627Z`
...
• [clue_late_1] footprints, leading, away, scene, murder
  Category: physical | Criticality: essential | Supports inference step 3
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): footprints, lead, identity, murderer

• [clue_fp_elimination_beatrice_quill] eight, thirty, evening, clock
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the three stood in the chill, the glow from the hotel’s windows spilling across the terrace stones, Hugo realized that the investigation had reached a critical juncture. The evidence pointed in one direction, but the truth—whatever it was—remained just out..."
...
Known location profile anchors: The Grand Mariner Hotel, Grand Lobby, Dining Room, Rooftop Terrace, Beachfront Room 12, the hotel garden
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Grand Mariner Hotel", "Grand Lobby", "Dining Room", "Rooftop Terrace", "Beachfront Room 12", "the hotel garden"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=19933; context=4025; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, continuity_context, pronoun_accuracy]
...
- Chapter 7:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the three stood in the chill, the glow from the hotel’s windows spilling across the terrace stones, Hugo realized that the investigation had reached a critical juncture. The evidence pointed in one direction, but the...".
...
Chapter 7 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The footprints leading away from the murder scene."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that someone else was present at the scene, complicating the timeline."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor's hands tremble as she speaks of her family."
      ]
    },
    ...
    "emotionalRegister": "Pressure mounts as the truth inches closer, revealing the weight of personal sacrifices.",
