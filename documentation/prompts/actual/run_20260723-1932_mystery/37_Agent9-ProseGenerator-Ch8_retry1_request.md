...
- Project ID: ``
- Timestamp: `2026-07-23T19:48:30.756Z`
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "For a moment, the only sound was the faint hum of the radio and the distant clatter of a tray in the Dining Room. Hugo allowed himself a brief, ironic smile. The investigation had not grown simpler, but at least one truth was clear: Beatrice’s lie had been bor..."
...
Render this test MECHANISM as live, in-scene action and dialogue, composing ENTIRELY in your own words from these elements (reproducing any briefing phrase verbatim FAILS validation): discriminating, compares, masquerade, witness, recall, claimed, timeline
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=23144; context=4945; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, continuity_context, pronoun_accuracy]
...
- Chapter 8:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "For a moment, the only sound was the faint hum of the radio and the distant clatter of a tray in the Dining Room. Hugo allowed himself a brief, ironic smile. The investigation had not grown simpler, but at least one trut...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • eleanor, mask, distinct, tear, left [clue_early_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: eleanor, masquerade, supporting, involvement
  - ⚠ SUSPECT CLEARANCE REQUIRED (MANDATORY): each suspect below MUST be named explicitly and cleared with on-page evidence and a reasoning connector (because / therefore / which proves):
    ...
    • "Beatrice Quill": write a dedicated paragraph that (a) names Beatrice Quill explicitly, (b) states the clearance method ("The broken mirror's history is revealed."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
    • "Sylvia Trent": write a dedicated paragraph that (a) names Sylvia Trent explicitly, (b) states the clearance method ("Witness testimony clears her of suspicion."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
  ...
  - ⚠ DISCRIMINATING TEST (trap) — MANDATORY real-time scene with dialogue and confrontation. DO NOT summarize it after the fact.
    ...
    Elements the test must dramatize (compose the scene ENTIRELY in your own sentences from these — reproducing any briefing phrase verbatim FAILS validation): discriminating, compares, masquerade, witness, recall, claimed, timeline
    Cite these already-revealed clue IDs during the test: clue_early_1, clue_culprit_direct_1, clue_mid_1, clue_culprit_direct_captain_ivor_hale
...
Chapter 8 (Act 3) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The tear in the mask found with Captain Hale."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes Hale's guilt through his own reaction to the evidence presented."
...
[
  {
    ...
    "purpose": "Conduct the discriminating test to reveal the truth Suspects are systematically cleared: alibi confirmed for three suspects, ruled out by timeline evidence, leaving only the culprit identified by a complete evidence chain.",
    "cluesRevealed": [
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Hugo's heart races as he prepares to confront Hale."
      ]
    },
    ...
    "permittedBehavioursByAct": [
      ...
      },
      {
        ...
        "behaviour": "Express nervousness when questioned about the masquerade."
      }
    ],
    "emotionalRegister": "The confrontation exposes the tangled web of deception and reveals the murderer.",
    "dominantCharacterNote": {
      "name": "Captain Ivor Hale",
      "voiceRegister": "Ivor speaks with a commanding yet self-aware tone, often using humor to mask his vulnerabilities."
    },
    "humourGuidance": {
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 8: the clue [clue_early_1] (witnesses, recall, seeing, eleanor, wearing, distinct, mask, tear, masquerade) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
