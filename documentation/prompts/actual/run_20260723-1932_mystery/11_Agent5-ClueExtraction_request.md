...
- Project ID: `unknown`
- Timestamp: `2026-07-23T19:35:13.405Z`
...
1. Generate a clue that makes the reader directly observe: "Witnesses recall seeing Eleanor wearing a distinct mask with a tear during the masquerade...."
   → observation | essential | early | testimonial | step 1 | terms: witnesses, recall, seeing

2. Generate a clue that provides evidence for: "This tear must match the mask found in Captain Hale's possession...."
   → contradiction | essential | early | testimonial | step 1 | terms: match, found, captain

3. Generate a clue that makes the reader directly observe: "A bellhop recalls delivering Eleanor's belongings to her room shortly before the murder...."
   → observation | essential | early | temporal | step 2 | terms: bellhop, recalls, delivering

4. Generate a clue that provides evidence for: "The timeline contradicts Captain Hale's alibi...."
   → contradiction | essential | early | temporal | step 2 | terms: timeline, contradicts, captain

5. Generate a clue that makes the reader directly observe: "A hotel staff member describes seeing two identical masks in Captain Hale's possession...."
   → observation | essential | mid | testimonial | step 3 | terms: hotel, staff, member

6. Generate a clue that provides evidence for: "This confirms Hale's capability to impersonate Eleanor...."
   → contradiction | essential | mid | testimonial | step 3 | terms: confirms, hale's, capability

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "This tear must match the mask found in Captain Hale's possession...."
   → contradiction | essential | mid | testimonial | step 1 | terms: match, found, captain

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "Captain Hale used an identical mask to impersonate Eleanor during the masquerade, creating a false alibi and evading suspicion...."
   → observation | essential | early | temporal | terms: captain, identical, impersonate
...
10. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "The discriminating test compares masquerade, witness, and recall against the claimed timeline...."
   → observation | essential | mid | temporal | terms: discriminating, compares, masquerade,
...
11. Generate one essential mid-story clue whose description or pointsTo explicitly names Captain Ivor Hale and states the unique trace, preparation detail, or mechanism link that points to Captain Ivor Hale rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Captain Ivor Hale, captain, identical, impersonate
...
12. Generate one essential early-or-mid clue establishing that Captain Ivor Hale UNIQUELY had the means/skill/access/knowledge required to execute the concealment mechanism, and that the other suspects did not — so the reveal relies only on this already-planted capability, never on a means introduced for the first time at the confrontation.
   → elimination | essential | mid | temporal | terms: Captain Ivor Hale, captain, identical, impersonate

13. Generate a clue showing observable evidence of Captain Ivor Hale's premeditation or planning (Fear of exposure). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
...
Create 2 red herrings that support the false assumption: "Captain Hale was seen with Eleanor shortly before the murder, establishing his alibi."
...
- STRICT STRUCTURAL CONTRACT (author ALL of these YOURSELF, as concrete scene-register clues — a character sees/hears/finds something. NEVER meta-boilerplate like "adds texture to the case background"; if you omit any, a deterministic pass will synthesize flat machine text in its place, which reads as machine-made):
    ...
    • DIRECT CULPRIT CLUE: id="clue_culprit_direct_captain_ivor_hale" — observable evidence tying Captain Ivor Hale uniquely to the crime (source from: CASE.cast[2].alibi_window, CASE.cast[2].access_plausibility, CASE.inference_path.steps[0].observation, CASE.inference_path.steps[0].correction, CASE.inference_path.steps[1].observation, CASE.inference_path.steps[1].correction); the pointsTo must include: Captain Ivor Hale, direct evidence, means and opportunity, no other eligible suspect
