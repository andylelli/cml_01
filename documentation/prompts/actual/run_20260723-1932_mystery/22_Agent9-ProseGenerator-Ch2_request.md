...
- Project ID: ``
- Timestamp: `2026-07-23T19:40:25.397Z`
...
Act 1 behaviour contract: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Killing Eleanor would eliminate his main obstacle to regaining control over family affairs and the hotel, a power he desperately yearns for." — do not surface in Act I.
...
• [clue_core_contradiction_chain] tear, must, match, mask, captain, hale, possession
  Category: testimonial | Criticality: essential | Supports inference step 1
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): hale, alibi, questionable, matching, tear
...
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): eleanor, masquerade, supporting, involvement
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Outside, the rain showed no sign of abating. The world beyond the hotel seemed distant, unreal, as if the tragedy within had severed the guests from the ordinary flow of time. Hugo stood by the window, watching droplets race down the glass, and allowed himself..."
...
Known location profile anchors: The Grand Mariner Hotel, Grand Lobby, Dining Room, Rooftop Terrace, Beachfront Room 12, the victim's room
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Grand Mariner Hotel", "Grand Lobby", "Dining Room", "Rooftop Terrace", "Beachfront Room 12", "the victim's room"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=9008; context=10461; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 2:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Outside, the rain showed no sign of abating. The world beyond the hotel seemed distant, unreal, as if the tragedy within had severed the guests from the ordinary flow of time. Hugo stood by the window, watching droplets...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • tear, mask, captain, hale, possession [clue_core_contradiction_chain] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
  ...
  - PLANT OBLIGATIONS (incidental appearances): each item below MUST appear in this chapter as a passing physical detail a character sees, handles, or walks past — with its significance UNFLAGGED:
    • bellhop, delivery, showing, eleanor, belongings, delivered [plant:clue_mid_1]
    • eleanor, mask, distinct, tear, left [plant:clue_fp_elimination_sylvia_trent]
...
Chapter 2 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The two clocks in the room showing different times."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the timeline of events is contradictory, raising questions about alibis."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Ivor clenches his fists, trying to maintain composure."
      ]
    },
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 2: the clue [clue_core_contradiction_chain] (tear, must, match, mask, captain, hale, possession) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
