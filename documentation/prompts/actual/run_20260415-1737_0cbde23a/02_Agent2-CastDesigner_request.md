...
- Timestamp: `2026-04-15T17:37:17.583Z`
...
**Setting**: 1940s - A large, stately home with expansive grounds, featuring formal gardens and a secluded atmosphere.
**Crime Type**: Murder
**Social Context**: women entering the workforce, post-war societal trauma, beginning of Cold War tensions
**Tone**: Classic

Hard requirements:
1. Create complete profiles for all 5 characters â€” the characters array MUST have exactly 5 entries
2. ONE character is the investigator/detective (roleArchetype: "Amateur Sleuth / Civilian Investigator") â€” they must NOT appear in crimeDynamics.possibleCulprits
...
8. Avoid stereotypes and clichÃ©s
...
11. Declare `gender` for each character: "male", "female", or "non-binary" (required â€” never omit)
...
- The final characters array MUST have exactly 5 entries â€” no more, no fewer
- crimeDynamics.possibleCulprits MUST name at least 3 characters (suspects only â€” never the detective)
