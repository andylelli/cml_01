...
- Project ID: ``
- Timestamp: `2026-07-16T23:38:24.384Z`
...
• [clue_2] angle, mirror, adjusted, evidenced, scratches, surface
  Category: physical | Criticality: essential | Supports inference step 2
  Points to: tampering, mirror

• [clue_3] captain, ivor, hale, observed, adjusting, mirror, shortly, before, murder
  Category: behavioral | Criticality: essential | Supports inference step 3
  Points to: captain, ivor, hale, actions, suggest, premeditation
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_1, clue_6, clue_culprit_direct_captain_ivor_hale, clue_core_elimination_chain, clue_4, clue_8 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): mechanism, deception, regarding, murderer, location | contradiction, witness, accounts, regarding, murderer | presence, footprints, indicates, escape, route | manner, death, indicates, specific, weapon | direct, shows, captain, ivor, hale, means | beatrice, quill, alibi, eliminates, suspect | sylvia, trent, alibi, eliminates, suspect | captain, ivor, hale, behavior, raises, suspicion
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "The interviews had shifted the balance. Beatrice and Sylvia were, for now, beyond suspicion. Captain Ivor Hale, by contrast, stood alone in the shadow of doubt. Hugo Vane, ever the observer, watched the proceedings with a detached amusement, but Eleanor sensed..."
...
- Chapter 5: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a temporal subordinate clause — e.g. "When [Name] entered…" / "After the last guest…" / "Before the household had stirred…" / "As the light faded…". Anchor opening in "the lobby of the Grand Seaside Hotel". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=16034; context=6846; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 5:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "The interviews had shifted the balance. Beatrice and Sylvia were, for now, beyond suspicion. Captain Ivor Hale, by contrast, stood alone in the shadow of doubt. Hugo Vane, ever the observer, watched the proceedings with...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • detectives, notice, scratches, mirror [clue_2]
      Points to: tampering, mirror
...
Chapter 5 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The scratches on the mirror's surface indicating tampering."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the mirror was adjusted, suggesting premeditation and knowledge of the lobby layout."
...
[
  {
    ...
    "setting": {
      ...
      "timeOfDay": "Afternoon",
      "atmosphere": "The tension is palpable as the investigation deepens."
    },
    "characters": [
      "Eleanor Voss",
      "Captain Ivor Hale",
    ...
    "purpose": "Re-examine the lobby for overlooked evidence.",
    "cluesRevealed": [
      "clue_2",
      "clue_3"
    ],
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor feels a chill as she realizes the implications of the adjusted mirror."
      ]
    },
    "summary": "Eleanor returns to the lobby with Captain Hale and Beatrice Quill. She notices scratches on the mirror's surface, indicating it has been tampered with. Hale's behavior becomes increasingly suspicious as he adjusts the mirror, raising Eleanor's concerns.",
    "beat": "alibis",
    "estimatedWordCount": 1800,
    "pivotElement": "The scratches on the mirror's surface indicating tampering.",
    "factEstablished": "Establishes that the mirror was adjusted, suggesting premeditation and knowledge of the lobby layout.",
    ...
    "emotionalRegister": "Revelations about the characters' pasts deepen the intrigue.",
