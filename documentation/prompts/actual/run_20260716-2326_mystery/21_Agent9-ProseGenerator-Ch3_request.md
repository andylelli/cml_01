...
- Project ID: ``
- Timestamp: `2026-07-16T23:36:46.630Z`
...
The early investigation reveals the complexity of each character's motives.
...
- Plant one subtle observable beat related to: "The moment when Eleanor first discovers the mirror's angle is crucial, as it shifts her understanding of the crime, revealing the spatial deception at play". Do not explain significance yet.
- Plant one subtle observable beat related to: "Later, the discovery of the broken vase during the investigation casts suspicion on Beatrice, only for it to be revealed as a red herring". Do not explain significance yet.
- Plant one subtle observable beat related to: "Ultimately, the climactic confrontation with Captain Hale earlier events, forcing characters to confront their inner demons and the consequences of their actions". Do not explain significance yet.
...
• [clue_1] footprints, leading, away, mirror
  Category: physical | Criticality: essential | Supports inference step 2
  Points to: presence, footprints, indicates, escape, route

• [clue_6] puncture, wound, victim, body
  Category: physical | Criticality: essential | Supports inference step 1
  Points to: manner, death, indicates, specific, weapon
...
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): mechanism, deception, regarding, murderer, location | contradiction, witness, accounts, regarding, murderer
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Outside, the rain intensified, washing the windows in streaks of grey. The lobby of the Grand Seaside Hotel felt both exposed and claustrophobic, a stage set for secrets to unravel. Eleanor drew a slow breath, her resolve hardening. The contradictions had chan..."
...
Chapter 2: Chapter 2: Initial Reactions
  Events: She cleared her throat, the sound oddly loud in the hush.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=12143; context=11088; dropped=[humour_guide, location_profiles]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 3:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Outside, the rain intensified, washing the windows in streaks of grey. The lobby of the Grand Seaside Hotel felt both exposed and claustrophobic, a stage set for secrets to unravel. Eleanor drew a slow breath, her resolv...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • detectives, find, footprints, floor [clue_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: presence, footprints, indicates, escape, route
    ...
    • detectives, examine, body [clue_6] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: manner, death, indicates, specific, weapon
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
         Paragraph 2 (immediately following): The detective or POV character explicitly reasons
           about what this evidence implies — who it implicates, why it may be unreliable,
           or what inference it supports. This must be a separate full paragraph, not a sentence appended to Paragraph 1.
    • witnesses, reflection, lobby, mirror [clue_culprit_direct_captain_ivor_hale] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
...
Chapter 3 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Footprints leading away from the mirror."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the footprints suggest someone left the scene without being detected, complicating the narrative."
...
[
  {
    "sceneNumber": 3,
    "act": 1,
    "title": "Footprints and Evidence",
    "setting": {
      "location": "the lobby of the Grand Seaside Hotel",
      "timeOfDay": "Morning after the murder",
      "atmosphere": "A sense of urgency and confusion prevails."
    },
    "characters": [
      "Eleanor Voss",
      "Captain Ivor Hale",
    ...
    "purpose": "Reveal physical evidence and establish initial clues.",
    "cluesRevealed": [
      "clue_1",
      "clue_6",
    ...
    "dramaticElements": {
      "conflict": "The detective must sift through the chaos to find clarity.",
      "tension": "Physical evidence contradicts witness accounts.",
      "microMomentBeats": [
        "Eleanor kneels to examine the footprints, her mind racing with possibilities."
      ]
    },
    "summary": "Eleanor discovers footprints leading away from the mirror in the lobby, indicating someone exited without being seen. A puncture wound on the victim's body indicates foul play. Captain Ivor Hale's presence near the evidence raises suspicions.",
    "beat": "first_enquiries",
    "estimatedWordCount": 1800,
    "pivotElement": "Footprints leading away from the mirror.",
    "factEstablished": "Establishes that the footprints suggest someone left the scene without being detected, complicating the narrative.",
    ...
    "humourGuidance": {
      ...
      "form": "dry_wit",
      "condition": "Eleanor appears with dry wit."
    },
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 3: the clue [clue_1] (footprints, leading, away, mirror) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: the clue [clue_6] (puncture, wound, victim, body) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
