...
- Project ID: `unknown`
- Timestamp: `2026-05-17T16:38:55.306Z`
...
1. Generate a clue that makes the reader directly observe: "The clock in the study shows time as quarter past seven...."
   → observation | essential | early | temporal | step 1 | terms: clock, study, shows

2. Generate a clue that provides evidence for: "Since witnesses claim dinner started at seven, the clock must have been tampered with...."
   → contradiction | essential | early | temporal | step 1 | terms: since, witnesses, claim

3. Generate a clue that makes the reader directly observe: "Dust on the clock's base is inconsistent with the clean surrounding furniture...."
   → observation | essential | early | temporal | step 2 | terms: clock's, inconsistent, clean

4. Generate a clue that provides evidence for: "The clock was recently moved, indicating tampering...."
   → contradiction | essential | early | temporal | step 2 | terms: clock, recently, moved,

5. Generate a clue that makes the reader directly observe: "Conflicting testimonies about the time of death from guests...."
   → observation | essential | mid | temporal | step 3 | terms: conflicting, testimonies, about

6. Generate a clue that provides evidence for: "The discrepancies suggest that at least one person is lying about their alibi...."
   → contradiction | essential | mid | temporal | step 3 | terms: discrepancies, suggest, least

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "Since witnesses claim dinner started at seven, the clock must have been tampered with...."
   → contradiction | essential | mid | temporal | step 1 | terms: since, witnesses, claim

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The mechanism relies on clock, study, and quarter to expose the false timing...."
   → observation | essential | early | temporal | terms: mechanism, relies, clock,

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "A controlled observation of the clock reveals discrepancies between the claims of suspects and the a..."
   → observation | essential | mid | temporal | terms: controlled, observation, clock
...
11. Generate a clue showing observable evidence of Dr. Mallory Finch's premeditation or planning (Desire for wealth). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: desire, wealth
...
- Eleanor Voss: sensitive items: Past letters, Family portraits
- Dr. Mallory Finch: sensitive items: Medical records, Prescription logs
- Captain Ivor Hale: sensitive items: Gambling receipts, Witness statements
- Beatrice Quill: sensitive items: Investigation notes, Witness statements
...
Create 2 red herrings that support the false assumption: "The murder occurred during a dinner when all suspects claimed to be occupied."
...
Violations: 1. [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 1, 2; words: claim, dinner, clock, tampering) and may support the true solution.
Warnings: None
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 1, 2; words: claim, dinner, clock, tampering) and may support the true solution.
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
