...
- Project ID: ``
- Timestamp: `2026-05-17T16:39:40.463Z`
...
- Era-authentic markers: domestic wiring with frequent outages, typewriters standard in offices, early home telephones, radio as a common household item, reliable petrol touring cars on county roads, peak passenger train services, early commercial aviation starting to develop, party-line telephone exchanges common
- Tone: Classic
- No anachronisms
...
Description: An expansive manor house set within a sprawling estate, featuring grand architecture with high ceilings, large windows, and intricate woodwork, surrounded by manicured gardens and woodlands.
...
Setting constraints:
- Physical constraints: Geography allows for limited access points, primarily through a grand entrance and a service entrance, Architecture includes locked rooms and hidden alcoves that restrict movement, Weather conditions can affect outdoor evidence collection, especially in winter months
- Geographic isolation: Isolated from the nearest town, requiring significant travel time for outside assistance, especially in poor weather.
- Access control: Access to certain areas restricted to staff only, such as the library and private study, Daily schedules dictate when rooms are occupied or empty, impacting investigation timelines, Social hierarchy dictates who may enter different areas of the estate

Era constraints to include:
- Technology: domestic wiring with frequent outages, typewriters standard in offices, early home telephones
- Transportation: reliable petrol touring cars on county roads, peak passenger train services
- Social norms: Great Depression affecting social dynamics and class tensions, growing influence of fascism in Europe
