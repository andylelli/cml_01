...
- Project ID: `unknown`
- Timestamp: `2026-05-10T19:46:08.887Z`
...
9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "The discriminating test reveals that the clock's time does not match the witness statements about th..."
   → observation | essential | mid | temporal | terms: discriminating, reveals, clock's
...
Violations: 1. [critical] Clue Visibility: Essential clues required for the discriminating test are not revealed before it.; 2. [critical] Information Parity: The detective has knowledge of the meticulous schedule that is not disclosed to the reader until after the discriminating test.
...
- REQUIRED CLUE CONTENT (must be covered by essential early/mid clues):
  ...
  - information_parity
- must_fix[]:
  - [critical] Clue Visibility: Essential clues required for the discriminating test are not revealed before it.
  - [critical] Information Parity: The detective has knowledge of the meticulous schedule that is not disclosed to the reader until after the discriminating test.
...
- required_id_to_source_mappings[]:
  ...
  - clue_fp_contradiction_step_1 -> CASE.prose_requirements.clue_to_scene_mapping[3].clue_id
  ...
  - clue_11 -> CASE.prose_requirements.clue_to_scene_mapping[8].clue_id
  - clue_12 -> CASE.prose_requirements.clue_to_scene_mapping[9].clue_id
  - clue_4 -> CASE.prose_requirements.clue_to_scene_mapping[11].clue_id
  - clue_5 -> CASE.prose_requirements.clue_to_scene_mapping[12].clue_id
  - clue_6 -> CASE.prose_requirements.clue_to_scene_mapping[13].clue_id
  - clue_7 -> CASE.prose_requirements.clue_to_scene_mapping[14].clue_id
  - clue_8 -> CASE.prose_requirements.clue_to_scene_mapping[15].clue_id
  - clue_9 -> CASE.prose_requirements.clue_to_scene_mapping[16].clue_id
