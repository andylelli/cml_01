...
- Project ID: ``
- Timestamp: `2026-07-16T20:03:44.915Z`
...
• [clue_core_contradiction_chain] contradicts, claim, attending, event
  Category: testimonial | Criticality: essential | Supports inference step 1
  Points to: hale, alibi, questionable

• [clue_late_1] contradicts, claim, attending, event
  Category: testimonial | Criticality: essential | Supports inference step 1
  Points to: hale, alibi, questionable
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_mid_3 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): indicates, hale, presence, event | hale, deception, uncovered
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Eleanor glanced once more at Dr. Finch’s still form, the clock, and the altered schedule. The pieces were scattered, the picture incomplete, but the first threads of the puzzle had begun to reveal themselves. Outside, the sound of the sea rose and fell, indiff..."
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=10298; context=12646; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 2:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Eleanor glanced once more at Dr. Finch’s still form, the clock, and the altered schedule. The pieces were scattered, the picture incomplete, but the first threads of the puzzle had begun to reveal themselves. Outside, th...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • captain, hale, claims, event, murder [clue_core_contradiction_chain] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: hale, alibi, questionable
...
Chapter 2 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Hugo Vane's insistence that he saw Hale at the event contradicts Hale's claim."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that multiple suspects contradict each other's timelines, raising suspicion."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_2] Hugo mentions seeing Hale speaking with the event organizer just before the murder — implying Hale was engaged in official duties.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor feels the weight of their eyes, each suspect hiding something."
      ]
    },
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_2",
      "placementDetail": "Hugo mentions seeing Hale speaking with the event organizer just before the murder — implying Hale was engaged in official duties."
    },
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 2: the clue [clue_core_contradiction_chain] (contradicts, claim, attending, event) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 2: the clue [clue_late_1] (contradicts, claim, attending, event) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
