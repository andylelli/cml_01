...
- Project ID: ``
- Timestamp: `2026-07-16T20:09:57.253Z`
...
• [clue_7] contradicts, claim, attending, event
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: hale, credibility, question

• [clue_13] eliminates, hugo, vane, because, corroborated, alibi
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: hugo, vane, cleared, suspicion

• [clue_mid_2] indicates, hale, manipulated, schedule, create, alibi
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_mid_3, clue_core_contradiction_chain, clue_late_1, clue_8, clue_9, clue_early_1, clue_3, clue_4, clue_culprit_direct_captain_ivor_hale, clue_5, clue_6, clue_mid_1 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): indicates, hale, presence, event | hale, deception, uncovered | hale, alibi, questionable | hale, alibi, questionable | hale, deception, uncovered | victim, strangled | indicates, hale, presence, event | suggests, hale, manipulation, event, schedule | hale, premeditated, actions, evident | direct, shows, captain, ivor, hale, means | hale, presence, scene, confirmed | hale, direct, involvement, suggested | suggests, hale, manipulation, event, schedule
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Eleanor stood alone in the dim lobby, the evidence heavy in her hands, the cold November air pressing in through the cracks. The masquerade had stripped away more than masks—it had exposed the fragile seams of every life it touched. And as the night deepened,..."
...
Known location profile anchors: The Azure Crest Hotel, The Grand Lobby, The Oceanview Dining Room, The Hotel Library, The Rooftop Terrace, the hotel bar
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Azure Crest Hotel", "The Grand Lobby", "The Oceanview Dining Room", "The Hotel Library", "The Rooftop Terrace", "the hotel bar"
...
- Chapter 4 (score 96/100):
  Quality gaps noted: scene grounding weakness
  Address in upcoming chapters: Open next chapter with a named location anchor plus at least two sensory cues and one atmosphere marker.
- Phrases to avoid (already overused in earlier chapters): "all who doesn t love a good", "who doesn t love a good scandal".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=18136; context=5709; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_late_2 must appear in Act 2, Scene 3 via Altered schedule note
- clue_mid_1 must appear in Act 2, Scene 3 via Document review
- clue_mid_2 must appear in Act 2, Scene 3 via Witness accounts
...
- Chapter 6:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Eleanor stood alone in the dim lobby, the evidence heavy in her hands, the cold November air pressing in through the cracks. The masquerade had stripped away more than masks—it had exposed the fragile seams of every life...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • witnesses, confirm, beatrice, elsewhere [clue_12]
      Points to: beatrice, quill, cleared, suspicion
    • hugo, vane, confirmed, different, event [clue_13]
      Points to: hugo, vane, cleared, suspicion
    • piece, fabric, near, body [clue_5]
      Points to: hale, presence, scene, confirmed
    • fabric, match, hale, uniform [clue_6]
      Points to: hale, direct, involvement, suggested
    • witnesses, state, hale, seen, entering, event, room [clue_7]
      Points to: hale, credibility, question
    • witnesses, report, seeing, captain, hale, enter, event, room [clue_culprit_direct_1]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    ...
    • piece, fabric, near, body [clue_late_2]
      Points to: hale, presence, scene, confirmed
    • note, discovered, captain, hale, room [clue_mid_1]
      Points to: suggests, hale, manipulation, event, schedule
    • altered, schedule, shows, discrepancies [clue_mid_2]
      Points to: hale, premeditated, actions, evident
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The theory implicating Beatrice Quill as the murderer."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes a misleading solution that points to Beatrice but raises Eleanor's suspicions."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor's heart races as she overhears a conversation about Hale."
      ]
    },
