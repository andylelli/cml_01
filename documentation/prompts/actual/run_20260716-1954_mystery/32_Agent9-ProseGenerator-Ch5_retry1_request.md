...
- Project ID: ``
- Timestamp: `2026-07-16T20:08:45.721Z`
...
• [clue_5] fabric, matching, hale, uniform, discovered, crime, scene
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: hale, presence, scene, confirmed

• [clue_6] connects, hale, directly, murder, scene
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: hale, direct, involvement, suggested

• [clue_mid_1] handwritten, note, altering, event, schedule, hale, room
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_mid_3, clue_core_contradiction_chain, clue_late_1, clue_8, clue_9, clue_early_1, clue_3, clue_4, clue_culprit_direct_captain_ivor_hale — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): indicates, hale, presence, event | hale, deception, uncovered | hale, alibi, questionable | hale, alibi, questionable | hale, deception, uncovered | victim, strangled | indicates, hale, presence, event | suggests, hale, manipulation, event, schedule | hale, premeditated, actions, evident | direct, shows, captain, ivor, hale, means
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Behind her, the dining room emptied, save for the lingering echo of whispered confessions and accusations. Eleanor pressed her hand to the cool glass, feeling the weight of the case settle more heavily on her shoulders. The stakes had grown sharper, the suspec..."
...
Known location profile anchors: The Azure Crest Hotel, The Grand Lobby, The Oceanview Dining Room, The Hotel Library, The Rooftop Terrace, the hotel lobby
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Azure Crest Hotel", "The Grand Lobby", "The Oceanview Dining Room", "The Hotel Library", "The Rooftop Terrace", "the hotel lobby"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=15783; context=7535; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 5:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Behind her, the dining room emptied, save for the lingering echo of whispered confessions and accusations. Eleanor pressed her hand to the cool glass, feeling the weight of the case settle more heavily on her shoulders....".
  ...
  - Sensory obligation — use at least two of: soft grey light, shadows lengthening | silence punctuated by laughter, the tick of a clock | old leather. Mood: uneasy stillness.
...
Chapter 5 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The fabric found at the crime scene matching Hale's uniform."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Hale's presence at the scene is now confirmed, raising further suspicion."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Hugo clenches his fists, a nervous habit he can't shake."
      ]
    },
    ...
    "emotionalRegister": "A revelation alters the understanding of past events, intensifying the urgency of the investigation.",
