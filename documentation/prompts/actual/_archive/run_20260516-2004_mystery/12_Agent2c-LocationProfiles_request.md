...
- Project ID: ``
- Timestamp: `2026-05-16T20:06:53.147Z`
...
- Era-authentic markers: petrol touring cars on gravel estate roads, early home telephones with limited range, typewriters for correspondence, reliable automobiles, passenger trains as primary long-distance travel, early commercial aviation for urgent travel, party-line telephone exchanges, telegram services from nearby towns
- Tone: Classic
- No anachronisms
...
Description: A sprawling country estate featuring a grand façade, extensive gardens, and various outbuildings, reflecting wealth and social status.
...
Setting constraints:
- Physical constraints: manor layout with locked study and library, gardens creating natural barriers, weather affecting outdoor evidence visibility
- Geographic isolation: Situated several miles from the nearest town, limiting immediate outside assistance.
- Access control: restricted areas like the private study and cellar, daily routines limiting access to key locations, expected behaviors around guests and staff

Era constraints to include:
- Technology: petrol touring cars on gravel estate roads, early home telephones with limited range, typewriters for correspondence
- Transportation: reliable automobiles, passenger trains as primary long-distance travel
- Social norms: class tensions exacerbated by the Great Depression, strict social hierarchies within manor life
