...
- Project ID: `unknown`
- Timestamp: `2026-05-13T20:47:36.346Z`
...
1. Generate a clue that makes the reader directly observe: "The mechanical clock in the grand entrance hall shows ten minutes past eleven...."
   → observation | essential | early | temporal | step 1 | terms: mechanical, clock, grand

2. Generate a clue that provides evidence for: "This indicates the time of the murder was misrepresented...."
   → contradiction | essential | early | temporal | step 1 | terms: indicates, murder, misrepresented.

3. Generate a clue that makes the reader directly observe: "A faint scratch is visible on the clock face...."
   → observation | essential | early | temporal | step 2 | terms: faint, scratch, visible

4. Generate a clue that provides evidence for: "The scratch suggests tampering with the clock mechanism...."
   → contradiction | essential | early | temporal | step 2 | terms: scratch, suggests, tampering

5. Generate a clue that makes the reader directly observe: "Dr. Mallory Finch claims to have been with the victim at the time of death...."
   → observation | essential | mid | temporal | step 3 | terms: mallory, finch, claims

6. Generate a clue that provides evidence for: "The timeline shows this cannot be true if the clock was tampered with...."
   → contradiction | essential | mid | temporal | step 3 | terms: timeline, shows, cannot

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "This indicates the time of the murder was misrepresented...."
   → contradiction | essential | mid | temporal | step 1 | terms: indicates, murder, misrepresented.

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The clock was tampered with to present a false timeline of events surrounding the murder...."
   → observation | essential | early | temporal | terms: clock, tampered, present

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Conduct a controlled comparison of the clock's mechanism and the victim's watch to reveal the discre..."
   → observation | essential | mid | temporal | terms: conduct, controlled, comparison
...
10. Generate one essential mid-story clue whose description or pointsTo explicitly names Eleanor Voss and states the unique trace, preparation detail, or mechanism link that points to Eleanor Voss rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Eleanor Voss, clock, tampered, present

11. Generate a clue showing observable evidence of Eleanor Voss's premeditation or planning (Seeks to prove herself in a challenging case.). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: seeks, prove, herself
...
Create 2 red herrings that support the false assumption: "The murder occurred just after the clock struck eleven."
...
Violations: 1. [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 2, 3; words: clock) and may support the true solution.; 2. [critical] Red Herring Separation: Red herring rh_2 overlaps inference corrections (steps: 2, 3; words: clock) and may support the true solution.
Warnings: None
...
- must_fix[]:
  ...
  - [critical] Red Herring Separation: Red herring rh_2 overlaps inference corrections (steps: 2, 3; words: clock) and may support the true solution.
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
