...
- Project ID: ``
- Timestamp: `2026-05-13T16:04:26.673Z`
...
• [clue_1] The clock shows ten minutes past eleven, but guests reported hearing sounds at ten-thirty.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: This discrepancy raises questions about the timing of the events.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=4854; context=10522; dropped=[none]; truncated=[location_profiles, temporal_context]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The clock shows ten minutes past eleven, but guests reported hearing sounds at ten-thirty. [clue_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: This discrepancy raises questions about the timing of the events.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Captain Hale's hands tremble as he recounts the events."
      ]
    },
    "summary": "In the quiet morning light, the guests of the Middleton estate gather in shock as they discover Eleanor Voss's lifeless body. the captain Hale, visibly shaken, recounts the events leading up to the tragedy, while the doctor Finch and Beatrice Quill exchange uneasy glances. The clock on the wall reads ten minutes past eleven, raising immediate questions.",
    "estimatedWordCount": 1800,
    "emotionalRegister": "The story opens with a sense of oppressive calm, hinting at the turmoil beneath the surface.",
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 1: "The clock shows ten minutes past eleven, but guests reported hearing sounds at ten-thirty." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
