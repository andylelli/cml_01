...
- Project ID: ``
- Timestamp: `2026-05-16T20:00:41.148Z`
...
Eleanor's discovery of the tampered clock shifts her focus and deepens the mystery.
...
Rationale: The tension is palpable, and humor would undermine the seriousness of the moment.
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Eleanor wrestles with the shame of her husband's past indiscretions, fearing that exposure could unravel the fragile fabric of her social world."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Dr. Finch grapples with a sense of futility in her efforts to address the healthcare disparities in her community, often feeling that her work goes unappreciated by those with power."
...
CHAPTER SENSORY PALETTE HINTS (evoke these qualities without copying verbatim):
  Chapter 4 palette — morning, rain, melancholic solitude mood [location: The Gardens]:
    • puddles forming on the paths, water droplets clinging to leaves
    • the patter
[truncated for prompt budget]
...
• [clue_5] A faint scratch is found on the winding mechanism of the clock.
  Category: physical | Criticality: essential | Supports inference step 3
  Points to: This scratch indicates potential manipulation of the clock.
...
• Suspects still unresolved: Captain Ivor Hale, Beatrice Quill
⚠ The story must move FORWARD from this log. Any beat already listed above is forbidden from repeating.

⚠ THIS CHAPTER'S REQUIRED ADVANCE (first_turn): Examine physical evidence — find at least one new clue

CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the guests began to recount their movements, Eleanor listened intently, her mind racing to piece together the fragments of their stories. Each detail felt increasingly rehearsed, and she couldn't shake the feeling that they were holding back. The clock's ti..."
...
drawing room, estate, dining room, study
...
Chapter 3: Chapter 3: The Investigation Begins
  Events: At a quarter past noon, the rain continued to pour relentlessly against the windows of the study where the victim had been found.
...
Known location profile anchors: Little Middleton Manor, The Drawing Room, The Library, The Attic, The Gardens, the garden of Eleanor Voss's estate
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The Drawing Room", "The Library", "The Attic", "The Gardens", "the garden of Eleanor Voss's estate"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 4: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a noun-phrase atmosphere — e.g. "The smell of damp stone in the cellar…" / "A chill from the landing…" / "The sound of the clock in the hall…". Pattern: "The/A [noun] of/in/from [place]…". Anchor opening in "the garden of Eleanor Voss's estate". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Chapter 3 (score 93/100):
  ...
  Address in upcoming chapters: Increase chapter density with concrete investigation action and sensory-grounded beats; avoid recap-only padding. | Open next chapter with a named location anchor plus at least two sensory cues and one atmosphere marker.
- Phrases to avoid (already overused in earlier chapters): "a time inconsistent with the guests accounts", "time inconsistent with the guests accounts of", "inconsistent with the guests accounts of the", "with the guests accounts of the victim", "the guests accounts of the victim s", "guests accounts of the victim s last", "accounts of the victim s last sighting", "suggested a deeper conspiracy at play one", "a deeper conspiracy at play one that", "deeper conspiracy at play one that she".
[END INTERNAL DIAGNOSTICS]

PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=8990; context=10972; dropped=[none]; truncated=[pronoun_accuracy, location_profiles, temporal_context]
...
- Chapter 4:
  ...
  - Scene is set in: the garden of Eleanor Voss's estate — reference it naturally within the paragraph, never as your opening phrase.
  - Opening atmosphere (MANDATORY — validator enforced): the first paragraph MUST contain at least one of: rain / wind / fog / storm / mist / thunder / evening / morning / night / dawn / dusk / season / afternoon / midday / noon / midnight / twilight / sunrise / sunset / daylight / sunlight / overcast / cloudy / bright / dark. A chapter that omits all of these from its opening paragraph will be rejected.
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the guests began to recount their movements, Eleanor listened intently, her mind racing to piece together the fragments of their stories. Each detail felt increasingly rehearsed, and she couldn't shake the feeling tha...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • A faint scratch is found on the winding mechanism of the clock. [clue_5]
      Points to: This scratch indicates potential manipulation of the clock.
  ...
  - Sensory obligation — use at least two of: puddles forming on the paths, water droplets clinging to leaves | the patter of rain on foliage, the soft drip of water from branches | wet earth. Mood: melancholic solitude.
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Dr. Finch's defensive body language"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Dr. Finch was in the garden during the critical time, but her alibi remains questionable."
...
[
  {
    ...
    "purpose": "Interview Dr. Finch to uncover her alibi",
    "cluesRevealed": [
      "clue_5",
    ...
    "dramaticElements": {
      ...
      "tension": "Eleanor presses for the truth",
      "microMomentBeats": [
        "Dr. Finch glances nervously at the ground."
      ]
    },
    "summary": "Eleanor questions Dr. Finch about her whereabouts during the murder. Dr. Finch claims she was in the garden, but her defensiveness raises Eleanor's suspicions.",
    "estimatedWordCount": 1250,
    "pivotElement": "Dr. Finch's defensive body language",
    "factEstablished": "Establishes that Dr. Finch was in the garden during the critical time, but her alibi remains questionable.",
    "permittedBehavioursByAct": [
      {
        "characterName": "Eleanor Voss",
        "behaviour": "unease and mild defensiveness"
      },
      {
    ...
    "emotionalRegister": "Eleanor's discovery of the tampered clock shifts her focus and deepens the mystery.",
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 4: "A peculiar dust pattern is observed on the clock face." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
