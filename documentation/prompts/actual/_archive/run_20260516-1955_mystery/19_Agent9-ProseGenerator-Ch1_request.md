...
- Project ID: ``
- Timestamp: `2026-05-16T20:00:06.902Z`
...
An atmosphere of dread fills the air as the storm mirrors the impending chaos.
...
Rationale: The atmosphere is too tense for humor as the murder disrupts the gathering.
...
CHAPTER SENSORY PALETTE HINTS (evoke these qualities without copying verbatim):
  Chapter 1 palette — morning, rain, oppressive mood [location: The Drawing Room]:
    • grey light filtering through clouds, puddles forming on the floor
    • steady drummi
[truncated for prompt budget]
...
• [clue_1] A peculiar dust pattern is observed on the clock face.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: This dust pattern suggests recent handling.

• [clue_2] The dust indicates that the clock has been handled recently, suggesting tampering.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: This evidence implies potential foul play.

• [clue_mechanism_visibility_core] The mechanism relies on clock, peculiar, and pattern to expose the false timing.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: This reveals the core mechanism of the clock's function.

• [clue_core_contradiction_chain] The dust indicates that the clock has been handled recently, suggesting tampering.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: This contradicts the assumption of the clock being untouched.

• [clue_3] The clock shows a time inconsistent with the guests' accounts of the victim’s last sighting.
  Category: temporal | Criticality: essential | Supports inference step 2
  Points to: This inconsistency raises questions about the timeline.

• [clue_4] This inconsistency suggests that either the clock is faulty or has been altered to mislead.
  Category: temporal | Criticality: essential | Supports inference step 2
  Points to: This raises doubts about the reliability of the clock.

• [clue_6] The scratch indicates recent tampering, confirming that the clock has been manipulated.
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: This confirms the possibility of foul play.

• [clue_core_elimination_chain] Eliminates Dr. Mallory Finch because he was seen at the medical conference from eight to ten.
...
Known location profile anchors: Little Middleton Manor, The Drawing Room, The Library, The Attic, The Gardens, the drawing room of Eleanor Voss's estate
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The Drawing Room", "The Library", "The Attic", "The Gardens", "the drawing room of Eleanor Voss's estate"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the drawing room of Eleanor Voss's estate". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.

PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=6565; context=10929; dropped=[none]; truncated=[pronoun_accuracy, location_profiles, temporal_context]
...
- clue_2 must appear in Act 1, Scene 1 via Witness statements in the dining room.
- clue_3 must appear in Act 1, Scene 1 via Inspection of the clock's mechanism.
...
- Chapter 1:
  ...
  - Scene is set in: the drawing room of Eleanor Voss's estate — reference it naturally within the paragraph, never as your opening phrase.
  - Opening atmosphere (MANDATORY — validator enforced): the first paragraph MUST contain at least one of: rain / wind / fog / storm / mist / thunder / evening / morning / night / dawn / dusk / season / afternoon / midday / noon / midnight / twilight / sunrise / sunset / daylight / sunlight / overcast / cloudy / bright / dark. A chapter that omits all of these from its opening paragraph will be rejected.
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • A peculiar dust pattern is observed on the clock face. [clue_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: This dust pattern suggests recent handling.
    ...
    • The dust indicates that the clock has been handled recently, suggesting tampering. [clue_2] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: This evidence implies potential foul play.
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
         Paragraph 2 (immediately following): The detective or POV character explicitly reasons
           about what this evidence implies — who it implicates, why it may be unreliable,
           or what inference it supports. This must be a separate full paragraph, not a sentence appended to Paragraph 1.
    • The clock shows a time inconsistent with the guests' accounts of the victim’s last sighting. [clue_3] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: This inconsistency raises questions about the timeline.
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
         Paragraph 2 (immediately following): The detective or POV character explicitly reasons
           about what this evidence implies — who it implicates, why it may be unreliable,
           or what inference it supports. This must be a separate full paragraph, not a sentence appended to Paragraph 1.
    • This inconsistency suggests that either the clock is faulty or has been altered to mislead. [clue_4] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: This raises doubts about the reliability of the clock.
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
         Paragraph 2 (immediately following): The detective or POV character explicitly reasons
           about what this evidence implies — who it implicates, why it may be unreliable,
           or what inference it supports. This must be a separate full paragraph, not a sentence appended to Paragraph 1.
    • The dust indicates that the clock has been handled recently, suggesting tampering. [clue_core_contradiction_chain] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: This contradicts the assumption of the clock being untouched.
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
         Paragraph 2 (immediately following): The detective or POV character explicitly reasons
           about what this evidence implies — who it implicates, why it may be unreliable,
           or what inference it supports. This must be a separate full paragraph, not a sentence appended to Paragraph 1.
    • The mechanism relies on clock, peculiar, and pattern to expose the false timing. [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: This reveals the core mechanism of the clock's function.
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
         Paragraph 2 (immediately following): The detective or POV character explicitly reasons
           about what this evidence implies — who it implicates, why it may be unreliable,
           or what inference it supports. This must be a separate full paragraph, not a sentence appended to Paragraph 1.
    • The scratch indicates recent tampering, confirming that the clock has been manipulated. [clue_6]
      Points to: This confirms the possibility of foul play.
    • Eliminates Dr. Mallory Finch because he was seen at the medical conference from eight to ten. [clue_core_elimination_chain]
      Points to: This corroborates his alibi and rules him out as a suspect.
  - Tonal contrast: include at least one beat of relief or ironic counterpoint. Do not sustain maximum tension for every paragraph.
  - Sensory obligation — use at least two of: grey light filtering through clouds, puddles forming on the floor | steady drumming on the roof, water dripping from the eaves | damp wood. Mood: oppressive.
...
Chapter 1 (Act 1) completeness contract:
  ...
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the victim died no later than twenty minutes past eleven, contradicting the guests' alibis."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_1] Captain Hale insists the clock was accurate, misdirecting suspicion.
...
[
  {
    ...
    "summary": "The guests gather in shock after discovering the victim's lifeless body in the study. Eleanor Voss, the host, is visibly shaken, while the others express their disbelief. The room is filled with an eerie silence as the clock ticks ominously.",
    "estimatedWordCount": 1800,
    "pivotElement": "The stopped clock showing ten minutes past eleven",
    "factEstablished": "Establishes the victim died no later than twenty minutes past eleven, contradicting the guests' alibis.",
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_1",
      "placementDetail": "Captain Hale insists the clock was accurate, misdirecting suspicion."
    },
    "emotionalRegister": "An atmosphere of dread fills the air as the storm mirrors the impending chaos.",
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 1: "A peculiar dust pattern is observed on the clock face." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: "The dust indicates that the clock has been handled recently, suggesting tampering." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: "The clock shows a time inconsistent with the guests' accounts of the victim’s last sighting." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: "This inconsistency suggests that either the clock is faulty or has been altered to mislead." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: "The dust indicates that the clock has been handled recently, suggesting tampering." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: "The mechanism relies on clock, peculiar, and pattern to expose the false timing." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
