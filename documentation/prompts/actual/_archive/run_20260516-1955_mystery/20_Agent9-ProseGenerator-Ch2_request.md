...
- Project ID: ``
- Timestamp: `2026-05-16T20:00:17.118Z`
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "The tension in the room was suffocating, each guest acutely aware of the weight of suspicion that hung in the air. Eleanor could feel their eyes on her, each one a silent accusation. She took a deep breath, steeling herself for the task ahead. The truth was ou..."
...
Known location profile anchors: Little Middleton Manor, The Drawing Room, The Library, The Attic, The Gardens, the dining room of Eleanor Voss's estate
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The Drawing Room", "The Library", "The Attic", "The Gardens", "the dining room of Eleanor Voss's estate"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 2: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with spoken dialogue — e.g. '"[words]," [Name] said/asked/replied/murmured.' The opening quote must be the first character on the line. Anchor opening in "the dining room of Eleanor Voss's estate". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=6662; context=11335; dropped=[none]; truncated=[pronoun_accuracy, temporal_context]
...
- Chapter 2:
  ...
  - Scene is set in: the dining room of Eleanor Voss's estate — reference it naturally within the paragraph, never as your opening phrase.
  - Opening atmosphere (MANDATORY — validator enforced): the first paragraph MUST contain at least one of: rain / wind / fog / storm / mist / thunder / evening / morning / night / dawn / dusk / season / afternoon / midday / noon / midnight / twilight / sunrise / sunset / daylight / sunlight / overcast / cloudy / bright / dark. A chapter that omits all of these from its opening paragraph will be rejected.
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "The tension in the room was suffocating, each guest acutely aware of the weight of suspicion that hung in the air. Eleanor could feel their eyes on her, each one a silent accusation. She took a deep breath, steeling hers...".
...
Chapter 2 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The clock on the wall, ticking away the seconds"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the clock's time does not align with the guests' accounts of the victim's last sighting."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_2] Beatrice claims to have seen the victim just before dinner, creating confusion.
...
[
  {
    ...
    "title": "The Gathering",
    "setting": {
      "location": "the dining room of Eleanor Voss's estate",
      "timeOfDay": "Late morning",
      "atmosphere": "Nervous chatter among guests"
    },
    "characters": [
      "Eleanor Voss",
      "Dr. Mallory Finch",
    ...
    "dramaticElements": {
      ...
      "tension": "Each guest's alibi is scrutinized",
      "microMomentBeats": [
        "Eleanor's hands tremble as she pours tea."
      ]
    },
    "summary": "The guests gather in the dining room, discussing the events of the previous night. Tension mounts as each one tries to establish their alibi, while Eleanor listens intently, her eyes darting nervously.",
    "estimatedWordCount": 1600,
    "pivotElement": "The clock on the wall, ticking away the seconds",
    "factEstablished": "Establishes that the clock's time does not align with the guests' accounts of the victim's last sighting.",
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_2",
      "placementDetail": "Beatrice claims to have seen the victim just before dinner, creating confusion."
    },
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 2: "The clock shows a time inconsistent with the guests' accounts of the victim’s last sighting." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
□ Chapter 2: "This inconsistency suggests that either the clock is faulty or has been altered to mislead." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
