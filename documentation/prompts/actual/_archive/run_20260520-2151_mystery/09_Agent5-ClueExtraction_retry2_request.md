...
- Project ID: `unknown`
- Timestamp: `2026-05-20T21:53:02.194Z`
...
1. Generate a clue that makes the reader directly observe: "The clock shows ten minutes past eleven when Eleanor is discovered...."
   → observation | essential | early | temporal | step 1 | terms: clock, shows, minutes

2. Generate a clue that provides evidence for: "The tampering of the clock creates a false timeline regarding Eleanor's death...."
   → contradiction | essential | early | temporal | step 1 | terms: tampering, clock, creates

3. Generate a clue that makes the reader directly observe: "Witnesses mention the unusual warmth of the room where Eleanor was found...."
   → observation | essential | early | spatial | step 2 | terms: witnesses, mention, unusual

4. Generate a clue that provides evidence for: "If Eleanor was murdered earlier, the room would not be warm, suggesting a recent death...."
   → contradiction | essential | early | spatial | step 2 | terms: eleanor, murdered, earlier,

5. Generate a clue that makes the reader directly observe: "A small timing mechanism is discovered near the clock...."
   → observation | essential | mid | temporal | step 3 | terms: small, timing, mechanism

6. Generate a clue that provides evidence for: "The mechanism indicates that the clock was wound back deliberately...."
   → contradiction | essential | mid | temporal | step 3 | terms: mechanism, indicates, clock

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The tampering of the clock creates a false timeline regarding Eleanor's death...."
   → contradiction | essential | mid | temporal | step 1 | terms: tampering, clock, creates

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The mechanism relies on clock, wound, and minut to expose the false timing...."
   → observation | essential | early | temporal | terms: mechanism, relies, clock,

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "A staged comparison of the clock's timing and the timing mechanism proves the clock was tampered wit..."
   → observation | essential | mid | temporal | terms: staged, comparison, clock's
...
Create 2 red herrings that support the false assumption: "Eleanor's death must have occurred after the last clock strike."
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 1, 2, 3; words: clock, eleanor) and may support the true solution.
  - [critical] Red Herring Separation: Red herring rh_2 overlaps inference corrections (steps: 2; words: eleanor, suggesting, recent) and may support the true solution.
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
