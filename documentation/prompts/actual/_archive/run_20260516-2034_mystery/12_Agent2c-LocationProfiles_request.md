...
- Project ID: ``
- Timestamp: `2026-05-16T20:35:58.903Z`
...
- Era-authentic markers: petrol touring cars on country roads, early home telephones with party lines, typewriters for correspondence, reliable automobiles for local travel, passenger trains for longer distances, early commercial aviation for urgent travel, telegrams sent from the nearest town, telephone calls via operator
- Tone: Classic
- No anachronisms
...
Description: A large manor house set in sprawling grounds with gardens and woodlands, featuring multiple rooms, a grand entrance, and a library.
...
Setting constraints:
- Physical constraints: large grounds create natural barriers to movement, multiple locked rooms restrict access to certain areas, weather can affect outdoor evidence visibility
- Geographic isolation: The estate is several miles from the nearest town, limiting access to outside help.
- Access control: restricted areas such as the study and cellar, daily routines dictate which rooms are occupied, permissions required for entry into staff quarters

Era constraints to include:
- Technology: petrol touring cars on country roads, early home telephones with party lines, typewriters for correspondence
- Transportation: reliable automobiles for local travel, passenger trains for longer distances
- Social norms: impact of the Great Depression on social classes, increased tensions due to rising fascism in Europe
