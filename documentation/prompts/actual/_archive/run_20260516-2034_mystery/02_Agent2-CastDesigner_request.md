...
- Project ID: ``
- Timestamp: `2026-05-16T20:34:16.209Z`
...
**Setting**: 1930s - A large manor house set in sprawling grounds with gardens and woodlands, featuring multiple rooms, a grand entrance, and a library.
**Crime Type**: Murder
**Social Context**: impact of the Great Depression on social classes, increased tensions due to rising fascism in Europe, strict social hierarchies within manor society
**Tone**: Classic
