...
- Project ID: ``
- Timestamp: `2026-05-16T06:49:43.988Z`
...
- Era-authentic markers: petrol touring cars on county roads, domestic wiring with frequent outages, typewriters in use for correspondence, reliable automobiles, passenger trains at peak use, early commercial aviation limited, party-line telephone exchange common, telegrams available for urgent messages
- Tone: Classic
- No anachronisms
...
Description: A large, isolated manor house surrounded by extensive gardens and woodlands, typical of the English countryside.
...
Setting constraints:
- Physical constraints: walled gardens limiting visibility from outside, multiple locked rooms restricting access, narrow, winding roads affecting transport access
- Geographic isolation: The estate is located several miles from the nearest village, complicating access to outside help.
- Access control: strict permissions required for entry to certain areas, daily staff routines limiting access to private quarters, social hierarchies dictating who can enter specific rooms
...
- Social norms: Great Depression creating class tensions, increased scrutiny of wealth and privilege
