...
- Project ID: ``
- Timestamp: `2026-05-12T02:45:34.507Z`
...
Known location profile anchors: Waverly Manor, The Library, The Drawing Room, The Servants' Hall, the Voss residence
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Waverly Manor", "The Library", "The Drawing Room", "The Servants' Hall", "the Voss residence"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the Voss residence". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.

PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=5050; context=9166; dropped=[none]; truncated=[location_profiles, temporal_context]
...
[
  {
    ...
    "dramaticElements": {
      "conflict": "The household is in turmoil with the discovery of Eleanor's body.",
      "tension": "Each character is a potential suspect, raising suspicions.",
      "microMomentBeats": [
        "Beatrice stares at the clock, memories flooding back."
      ]
    },
    "summary": "In the quiet of the Voss residence, the body of Eleanor Voss is discovered, sending shockwaves through the household. the doctor Finch, the captain Hale, and Beatrice Quill gather around the clock, which ominously stands still at ten minutes past eleven, hinting at the mystery to unfold.",
    "estimatedWordCount": 1800,
    "emotionalRegister": "An air of anticipation fills the manor as guests gather for Eleanor's lecture.",
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 1: "The clock hands are stuck at ten minutes past eleven." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: "Witnesses recall the clock chiming at odd intervals." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
