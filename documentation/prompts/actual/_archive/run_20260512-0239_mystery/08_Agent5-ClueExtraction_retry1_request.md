...
- Project ID: `unknown`
- Timestamp: `2026-05-12T02:41:07.488Z`
...
1. Generate a clue that makes the reader directly observe: "The clock hands are stuck at ten minutes past eleven...."
   → observation | essential | early | temporal | step 1 | terms: clock, hands, stuck

2. Generate a clue that provides evidence for: "The clock displaying the wrong time suggests it was tampered with...."
   → contradiction | essential | early | temporal | step 1 | terms: clock, displaying, wrong

3. Generate a clue that makes the reader directly observe: "Witnesses recall the clock chiming at odd intervals...."
   → observation | essential | early | temporal | step 2 | terms: witnesses, recall, clock

4. Generate a clue that provides evidence for: "The inconsistency in chiming suggests tampering occurred shortly before the murder...."
   → contradiction | essential | early | temporal | step 2 | terms: inconsistency, chiming, suggests

5. Generate a clue that makes the reader directly observe: "The clock's winding mechanism shows signs of recent tampering...."
   → observation | essential | mid | temporal | step 3 | terms: clock's, winding, mechanism

6. Generate a clue that provides evidence for: "The tampering indicates premeditated manipulation of the clock...."
   → contradiction | essential | mid | temporal | step 3 | terms: tampering, indicates, premeditated

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The clock displaying the wrong time suggests it was tampered with...."
   → contradiction | essential | mid | temporal | step 1 | terms: clock, displaying, wrong

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "A mechanical clock was wound back to mislead the timing of the murder...."
   → observation | essential | early | temporal | terms: mechanical, clock, wound

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "A controlled demonstration of the clock's tampering is staged, showing how it could mislead time of ..."
...
11. Generate a clue showing observable evidence of Eleanor Voss's premeditation or planning (Desire to maintain family legacy). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: desire, maintain, family
...
- Eleanor Voss: sensitive items: clock tampering evidence
- Dr. Mallory Finch: sensitive items: hospital logs
- Captain Ivor Hale: sensitive items: gambling debts
- Beatrice Quill: sensitive items: servant schedules
...
Create 2 red herrings that support the false assumption: "Eleanor Voss was alive at the time the clock chimed, suggesting she was murdered later than she actually was."
...
Violations: 1. [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 1, 2, 3; words: clock, shortly) and may support the true solution.
Warnings: None
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 1, 2, 3; words: clock, shortly) and may support the true solution.
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
