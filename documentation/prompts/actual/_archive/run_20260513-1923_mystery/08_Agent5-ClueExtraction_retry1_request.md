...
- Project ID: `unknown`
- Timestamp: `2026-05-13T19:24:22.383Z`
...
1. Generate a clue that makes the reader directly observe: "The clock in the study shows it stopped at ten minutes past eleven...."
   → observation | essential | early | temporal | step 1 | terms: clock, study, shows

2. Generate a clue that provides evidence for: "The clock could not have been accurate if it stopped before the time witnesses claimed to hear it st..."
   → contradiction | essential | early | temporal | step 1 | terms: clock, accurate, stopped

3. Generate a clue that makes the reader directly observe: "Witness accounts state they saw Eleanor last at eleven...."
   → observation | essential | early | testimonial | step 2 | terms: witness, accounts, state

4. Generate a clue that provides evidence for: "If Eleanor was last seen at eleven, the time of death must have been before that...."
   → contradiction | essential | early | temporal | step 2 | terms: eleanor, eleven,, death

5. Generate a clue that makes the reader directly observe: "A scrap of paper shows a schedule for the evening, indicating planned activities...."
   → observation | essential | mid | testimonial | step 3 | terms: scrap, paper, shows

6. Generate a clue that provides evidence for: "The schedule reveals that Eleanor was expected to be with guests, contradicting her being alone at t..."
   → contradiction | essential | mid | temporal | step 3 | terms: schedule, reveals, eleanor

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The clock could not have been accurate if it stopped before the time witnesses claimed to hear it strike twelve...."
   → contradiction | essential | mid | temporal | step 1 | terms: clock, accurate, stopped

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "A mechanical clock was wound back to mislead witnesses about the time of death...."
   → observation | essential | early | temporal | terms: mechanical, clock, wound

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "The discriminating test compares clock, stopp, and study against the claimed timeline...."
...
11. Generate a clue showing observable evidence of Eleanor Voss's premeditation or planning (Desire to end the affair discreetly). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: desire, affair, discreetly
...
15. Generate one essential early or mid elimination clue that explicitly rules out Dr. Mallory Finch and narrows the solution toward culprit Eleanor Voss. The pointsTo text must start with "Eliminates Dr. Mallory Finch because ..." and cite corroborated evidence.
...
Create 2 red herrings that support the false assumption: "The clock's time was accurate at the moment of the murder."
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 1; words: clock, accurate) and may support the true solution.
  - [critical] Red Herring Separation: Red herring rh_2 overlaps inference corrections (steps: 1, 2, 3; words: witnesses, claimed, eleanor) and may support the true solution.
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
...
- required_direct_culprit_clue:
  ...
  - allowed_source_paths=CASE.cast[0].access_plausibility, CASE.cast[0].alibi_window
