...
- Project ID: `unknown`
- Timestamp: `2026-05-11T20:16:53.262Z`
...
2. Generate a clue that provides evidence for: "The clock was tampered with to show a later time than actual time of death...."
   → contradiction | essential | early | temporal | step 1 | terms: clock, tampered, later

3. Generate a clue that makes the reader directly observe: "Witnesses recall hearing the clock chime at unusual times...."
   → observation | essential | early | temporal | step 2 | terms: witnesses, recall, hearing

4. Generate a clue that provides evidence for: "The clock malfunctioned due to tampering...."
   → contradiction | essential | early | temporal | step 2 | terms: clock, malfunctioned, tampering.

5. Generate a clue that makes the reader directly observe: "Fingerprints found on the clock's winding key match Dr. Mallory Finch...."
   → observation | essential | mid | temporal | step 3 | terms: fingerprints, found, clock's

6. Generate a clue that provides evidence for: "Dr. Finch had access to the clock and had the opportunity to tamper with it...."
   → contradiction | essential | mid | temporal | step 3 | terms: finch, access, clock

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The clock was tampered with to show a later time than actual time of death...."
   → contradiction | essential | mid | temporal | step 1 | terms: clock, tampered, later
...
11. Generate a clue showing observable evidence of Dr. Mallory Finch's premeditation or planning (Desire to end the affair). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: desire, affair
...
Objects: The clock in the study
...
Create 2 red herrings that support the false assumption: "Eleanor's death occurred shortly after the clock chimed eleven."
...
Violations: 1. [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 1, 2, 3; words: clock, actual, tampering) and may support the true solution.
Warnings: None
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 1, 2, 3; words: clock, actual, tampering) and may support the true solution.
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
