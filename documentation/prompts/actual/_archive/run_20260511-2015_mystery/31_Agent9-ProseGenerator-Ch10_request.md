...
- Project ID: ``
- Timestamp: `2026-05-11T20:24:43.748Z`
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=16224; context=9537; dropped=[none]; truncated=[location_profiles, temporal_context]
...
```text
Attempt 4/4 — chapters 10 — 1 validation issue(s) to resolve:

═══ PROSE QUALITY ERRORS (1) ═══
• Chapter 10 marked non-convergent after attempt 3/4: template
