...
- Project ID: ``
- Timestamp: `2026-05-14T20:12:12.545Z`
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Mallory wrestles with a profound sense of shame over his addiction, which contrasts sharply with his public image as a benevolent physician. The fear of losing everything he has worked for gnaws at him, leaving him in a state of constant tension, torn between his desires and the façade he must uphold."
...
• [clue_6] This indicates that the victim was alive longer than the clock suggests.
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: This reinforces the idea that the clock is not reliable.

• [clue_8] Eleanor Voss was seen near the study around the time of the murder.
  Category: behavioral | Criticality: essential | Supports inference step 2
  Points to: This suggests she had the means and opportunity.
...
CLUES ALREADY REVEALED TO READER: clue_1, clue_2, clue_core_contradiction_chain, clue_culprit_direct_eleanor_voss, clue_mechanism_visibility_core — do not reveal these as new information.

CONTINUITY HANDOFF — previous chapter closing beat:
  • "As Eleanor continued to speak, Beatrice felt the urgency of the investigation grow. The clock's frozen hands and the half-burnt candle were more than mere objects; they were symbols of the tangled web of deceit that surrounded the Voss family. Each detail, eac..."
...
Known location profile anchors: Little Middleton Manor, The Library, The Drawing Room, The Servants' Hall, the local hospital
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The Library", "The Drawing Room", "The Servants' Hall", "the local hospital"
...
- Phrases to avoid (already overused in earlier chapters): "mentioned hearing the clock strike the hour", "we didn t comply with their demands", "didn t comply with their demands the", "the kind of motive that could drive", "kind of motive that could drive someone", "of motive that could drive someone to".
[END INTERNAL DIAGNOSTICS]

PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=9002; context=10307; dropped=[none]; truncated=[location_profiles, temporal_context]
...
- Chapter 4:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As Eleanor continued to speak, Beatrice felt the urgency of the investigation grow. The clock's frozen hands and the half-burnt candle were more than mere objects; they were symbols of the tangled web of deceit that surr...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • This indicates that the victim was alive longer than the clock suggests. [clue_6]
      Points to: This reinforces the idea that the clock is not reliable.
    • Eleanor Voss was seen near the study around the time of the murder. [clue_8]
      Points to: This suggests she had the means and opportunity.
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Dr. Finch's anxious demeanor"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes Dr. Finch's alibi as potentially unreliable."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Dr. Finch's hands shake slightly as he speaks about the victim."
      ]
    },
    ...
    "emotionalRegister": "A critical clue shifts the direction of the investigation.",
    "dominantCharacterNote": {
      "name": "Dr. Mallory Finch",
      "voiceRegister": "Mallory's speech is measured and precise, often laced with a dry wit that surfaces unexpectedly."
    },
    "humourGuidance": {
      "permission": "forbidden"
    },
