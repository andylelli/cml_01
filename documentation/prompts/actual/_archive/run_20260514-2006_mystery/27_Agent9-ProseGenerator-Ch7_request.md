...
- Project ID: ``
- Timestamp: `2026-05-14T20:12:44.100Z`
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Eleanor grapples with the duality of her existence: the social butterfly who flits between soirées and the desperate woman who fears the collapse of her world. The weight of her secrets gnaws at her, as she questions whether the life she has built is worth the lies she tells."
...
• [clue_7] Eliminates Captain Ivor Hale because he has a verified alibi from the local pub.
...
CLUES ALREADY REVEALED TO READER: clue_1, clue_2, clue_core_contradiction_chain, clue_culprit_direct_eleanor_voss, clue_mechanism_visibility_core, clue_6, clue_8, clue_core_elimination_chain, clue_3, clue_4, clue_5 — do not reveal these as new information.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=13253; context=10367; dropped=[none]; truncated=[location_profiles, temporal_context]
...
- Chapter 7:
  ...
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • Eliminates Captain Ivor Hale because he has a verified alibi from the local pub. [clue_7]
      Points to: This confirms Captain Ivor Hale's alibi.
...
Chapter 7 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The clock's striking mechanism revealing tampering"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the clock was wound back to mislead the investigation."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Beatrice's heart races as she prepares to test the clock mechanism."
      ]
    },
    ...
    "emotionalRegister": "A shocking discovery redefines the relationships among the characters.",
