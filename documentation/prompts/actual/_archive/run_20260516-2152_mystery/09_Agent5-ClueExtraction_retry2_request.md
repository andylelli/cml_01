...
- Project ID: `unknown`
- Timestamp: `2026-05-16T21:53:23.835Z`
...
1. Generate a clue that makes the reader directly observe: "The clock in the drawing room shows ten minutes past eleven, although dinner was served at half past..."
   → observation | essential | early | temporal | step 1 | terms: clock, drawing, shows

2. Generate a clue that provides evidence for: "The clock cannot be relied upon to indicate the correct time of death given the dinner schedule...."
   → contradiction | essential | early | temporal | step 1 | terms: clock, cannot, relied

3. Generate a clue that makes the reader directly observe: "Witness statements assert that they heard the clock chime at half past eight...."
   → observation | essential | early | temporal | step 2 | terms: witness, statements, assert

4. Generate a clue that provides evidence for: "The chime timing contradicts the clock's current reading, suggesting tampering...."
   → contradiction | essential | early | temporal | step 2 | terms: chime, timing, contradicts

5. Generate a clue that makes the reader directly observe: "Fingerprint evidence found on the clock matches Dr. Mallory Finch...."
   → observation | essential | mid | temporal | step 3 | terms: fingerprint, evidence, found

6. Generate a clue that provides evidence for: "The fingerprints indicate that only Dr. Mallory Finch had accessed the clock recently...."
   → contradiction | essential | mid | temporal | step 3 | terms: fingerprints, indicate, mallory

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The clock cannot be relied upon to indicate the correct time of death given the dinner schedule...."
   → contradiction | essential | mid | temporal | step 1 | terms: clock, cannot, relied

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The mechanism relies on clock, minut, and eleven to expose the false timing...."
   → observation | essential | early | temporal | terms: mechanism, relies, clock,

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "The discriminating test compares clock, timing, and minut against the claimed timeline...."
...
11. Generate a clue showing observable evidence of Dr. Mallory Finch's premeditation or planning (Long-standing grudge). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: long-standing, grudge
...
## Access Constraints
Actors: Dr. Mallory Finch, Beatrice Quill, Eleanor Voss
Objects: The clock, The dining room, The library

## Physical Evidence
- Fingerprint evidence found on the clock.

## Evidence-Sensitive Characters
- Eleanor Voss: sensitive items: Clock timing, Witness statements
- Dr. Mallory Finch: sensitive items: Medical reports, Alibi verification
- Captain Ivor Hale: sensitive items: Witnesses from the event, Location access
- Beatrice Quill: sensitive items: Household schedules, Access logs
...
Create 2 red herrings that support the false assumption: "The murder must have occurred at the time the clock shows."
...
Violations: 1. [critical] Suspect Clue Coverage: Captain Ivor Hale is not referenced in any clue.; 2. [critical] Suspect Clue Coverage: Beatrice Quill is not referenced in any clue.
Warnings: None
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Suspect Clue Coverage: Captain Ivor Hale is not referenced in any clue.
  - [critical] Suspect Clue Coverage: Beatrice Quill is not referenced in any clue.
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
...
- required_direct_culprit_clue:
  ...
  - allowed_source_paths=CASE.cast[1].access_plausibility, CASE.cast[1].alibi_window, CASE.cast[1].evidence_sensitivity[0], CASE.inference_path.steps[0].observation, CASE.inference_path.steps[0].correction, CASE.inference_path.steps[1].observation, CASE.inference_path.steps[1].correction, CASE.inference_path.steps[2].observation
