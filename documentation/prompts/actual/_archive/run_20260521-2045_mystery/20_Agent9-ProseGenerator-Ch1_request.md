...
- Project ID: ``
- Timestamp: `2026-05-21T20:52:56.524Z`
...
Known location profile anchors: Middleton Manor, The Library, The Drawing Room, The Kitchen, Servants' Quarters, the scene
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Middleton Manor", "The Library", "The Drawing Room", "The Kitchen", "Servants' Quarters", "the scene"
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=5719; context=11252; dropped=[none]; truncated=[temporal_context, pronoun_accuracy]
...
Chapter 1 (Act 1) completeness contract:
  ...
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_1] Captain Ivor Hale mentions that the clock must be correct, leading others to assume the time of death aligns with it.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor stares at the clock, her expression a mix of anxiety and grief."
      ]
    },
    "summary": "The scene opens with Beatrice Quill arriving at the estate, where Eleanor Voss, the captain Hale, and the doctor Finch await her. They are gathered in the parlor, the tension palpable as they discuss the shocking discovery of the victim's body, which was found with the clock showing ten minutes past eleven.",
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_1",
      "placementDetail": "Captain Ivor Hale mentions that the clock must be correct, leading others to assume the time of death aligns with it."
    },
    "emotionalRegister": "An atmosphere of elegance conceals deep-seated tensions and rivalries.",
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 1: "The authority shows ten minutes past eleven, despite witnesses recalling it striking the hour before discovery." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: "The authority's shown time aligns incorrectly with witness statements, indicating possible interference." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
