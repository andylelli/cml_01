...
- Project ID: ``
- Timestamp: `2026-05-20T17:49:58.893Z`
...
- Era-authentic markers: petrol touring cars on county roads, domestic wiring with frequent outages, typewriters standard in offices, early telephones in homes, reliable automobiles for local travel, passenger trains as primary intercity transport, early commercial aviation starting to develop, party-line telephone exchanges common
- Tone: Classic
- No anachronisms
...
Description: An expansive manor house featuring a grand façade, large gardens, and multiple wings for servants and guests, set in a rural area with limited access to urban centers.
...
Setting constraints:
- Physical constraints: large gardens create natural barriers to movement, multiple access points but with restricted areas for staff, weather conditions may affect outdoor evidence visibility
- Geographic isolation: Isolated in the countryside, making outside help slow to arrive, especially during inclement weather.
- Access control: restricted areas for household staff, limited access to the upper floors for guests, daily routines of residents create predictable movement patterns, expected behaviors dictate strict adherence to social protocols
...
- Transportation: reliable automobiles for local travel, passenger trains as primary intercity transport
- Social norms: Great Depression causing class tensions, strict social hierarchies evident in behavior
