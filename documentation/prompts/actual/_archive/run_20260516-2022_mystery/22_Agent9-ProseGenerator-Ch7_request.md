...
- Project ID: ``
- Timestamp: `2026-05-16T20:27:16.110Z`
...
• [clue_4] This identifies a specific suspect who tampered with the clock.
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: This narrows down the list of suspects.

• [clue_fp_contradiction_step_3] A set of fingerprints is found on the clock's face.
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: This identifies a specific suspect who tampered with the clock.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Finally, as the evening wore on, Eleanor felt a sense of resolve settle over her. They would gather the witnesses, confirm Hale’s alibi, and then turn their attention to the clock and the fingerprints it held. The truth was within their reach, and he would not..."
...
Known location profile anchors: Little Middleton Manor, The Library, The Dining Room, The Study, The Formal Gardens, Beatrice's home
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The Library", "The Dining Room", "The Study", "The Formal Gardens", "Beatrice's home"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 7: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "Beatrice's home". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=12354; context=10674; dropped=[none]; truncated=[pronoun_accuracy, temporal_context]
...
- Chapter 7:
  ...
  - Scene is set in: Beatrice's home — reference it naturally within the paragraph, never as your opening phrase.
  - Opening atmosphere (MANDATORY — validator enforced): the first paragraph MUST contain at least one of: rain / wind / fog / storm / mist / thunder / evening / morning / night / dawn / dusk / season / afternoon / midday / noon / midnight / twilight / sunrise / sunset / daylight / sunlight / overcast / cloudy / bright / dark. A chapter that omits all of these from its opening paragraph will be rejected.
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Finally, as the evening wore on, Eleanor felt a sense of resolve settle over her. They would gather the witnesses, confirm Hale’s alibi, and then turn their attention to the clock and the fingerprints it held. The truth...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • This identifies a specific suspect who tampered with the clock. [clue_4]
      Points to: This narrows down the list of suspects.
    • A set of fingerprints is found on the clock's face. [clue_fp_contradiction_step_3]
      Points to: This identifies a specific suspect who tampered with the clock.
...
Chapter 7 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Beatrice's evasive responses during the confrontation"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Beatrice had access to the clock but lacks fingerprints, complicating her potential involvement"
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Beatrice's eyes dart around the room, avoiding Eleanor's gaze."
      ]
    },
    ...
    "emotionalRegister": "The confrontation with the suspects brings hidden tensions to the surface, complicating their relationships.",
