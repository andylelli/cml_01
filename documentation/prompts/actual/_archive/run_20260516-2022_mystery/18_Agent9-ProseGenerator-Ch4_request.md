...
- Project ID: ``
- Timestamp: `2026-05-16T20:26:34.743Z`
...
CHAPTER SENSORY PALETTE HINTS (evoke these qualities without copying verbatim):
  Chapter 4 palette — morning, rain, oppressive mood [location: The Library]:
    • grey light filtering through curtains, raindrops sliding
[truncated for prompt budget]
...
• [clue_2] The clock's winding mechanism is unusually stiff.
  Category: temporal | Criticality: essential | Supports inference step 2
  Points to: This suggests the clock may have been tampered with.

• [clue_8] This indicates the time of death is later than witness accounts suggest.
  Category: temporal | Criticality: essential | Supports inference step 2
...
• Evidence in reader's hands: The clock in the entrance hall shows ten minutes past eleven at the time of the murder. | A mechanical clock has been rewound to create a false alibi for the murderer. | This indicates the time of death is later than witness accounts suggest.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Hale nodded slowly, his expression contemplative. 'I’ll have the constable look into it when he arrives. But we must be careful. Accusations can lead to dangerous consequences,' he warned, his tone serious. Eleanor felt a chill run down her spine at the though..."
...
Known location profile anchors: Little Middleton Manor, The Library, The Dining Room, The Study, The Formal Gardens, the library
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The Library", "The Dining Room", "The Study", "The Formal Gardens", "the library"
...
- Chapter 2 (score 88/100):
  Quality gaps noted: word density below preferred target (664/1000)
  Address in upcoming chapters: Increase chapter density with concrete investigation action and sensory-grounded beats; avoid recap-only padding.
- Chapter 3 (score 89/100):
  Quality gaps noted: word density below preferred target (702/1000)
  Address in upcoming chapters: Increase chapter density with concrete investigation action and sensory-grounded beats; avoid recap-only padding.
- Phrases to avoid (already overused in earlier chapters): "eleanor s heart raced as she considered", "s heart raced as she considered the".
[END INTERNAL DIAGNOSTICS]

PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=8694; context=10362; dropped=[none]; truncated=[pronoun_accuracy, location_profiles, temporal_context]
...
- Chapter 4:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Hale nodded slowly, his expression contemplative. 'I’ll have the constable look into it when he arrives. But we must be careful. Accusations can lead to dangerous consequences,' he warned, his tone serious. Eleanor felt...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The clock's winding mechanism is unusually stiff. [clue_2]
      Points to: This suggests the clock may have been tampered with.
    • This indicates the time of death is later than witness accounts suggest. [clue_8]
      Points to: This contradicts the witness accounts of the victim's last seen time.
  - Tonal contrast: include at least one beat of relief or ironic counterpoint. Do not sustain maximum tension for every paragraph.
  - Sensory obligation — use at least two of: grey light filtering through curtains, raindrops sliding down glass | steady drumming on the roof, water pooling on the floor | damp wood. Mood: oppressive.
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Dr. Finch's nervous behavior during the questioning"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Dr. Finch's alibi is shaky and raises doubts about her involvement"
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor watches Finch's hands tremble as she speaks."
      ]
    },
    ...
    "emotionalRegister": "The discovery of the tampered clock shifts Eleanor's focus and redefines the investigation's trajectory.",
    ...
    "locationRegisterNote": "The library, shrouded in shadows and secrets, exudes an air of foreboding as the scent of old leather and musty paper envelops the room. Here, every whisper feels amplified, and the weight of unsolved mysteries lingers in the stillness, inviting both dread and curiosity. — Entering this space, a writer should feel the tension of hidden truths waiting to be uncovered, each corner echoing with the weight of history."
  }
]
```
