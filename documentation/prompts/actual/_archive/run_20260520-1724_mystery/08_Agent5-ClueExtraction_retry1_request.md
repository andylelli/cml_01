...
- Project ID: `unknown`
- Timestamp: `2026-05-20T17:25:36.163Z`
...
2. Generate a clue that provides evidence for: "The clock's time contradicts witness statements of hearing chimes at nine o'clock...."
   → contradiction | essential | early | temporal | step 1 | terms: clock's, contradicts, witness

3. Generate a clue that makes the reader directly observe: "Witness statements conflict about when they last saw Eleanor...."
   → observation | essential | early | temporal | step 2 | terms: witness, statements, conflict

4. Generate a clue that provides evidence for: "If the clock was accurate, Eleanor could not have been in the study at the time of death...."
   → contradiction | essential | early | temporal | step 2 | terms: clock, accurate,, eleanor

5. Generate a clue that makes the reader directly observe: "Footprints leading to the study are partially obscured...."
   → observation | essential | mid | physical | step 3 | terms: footprints, leading, study

6. Generate a clue that provides evidence for: "The tampering of the clock indicates premeditated access to the study...."
   → contradiction | essential | mid | temporal | step 3 | terms: tampering, clock, indicates

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The clock's time contradicts witness statements of hearing chimes at nine o'clock...."
   → contradiction | essential | mid | temporal | step 1 | terms: clock's, contradicts, witness
...
9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "A staged timeline reconstruction reveals the true time discrepancies...."
   → observation | essential | mid | temporal | terms: staged, timeline, reconstruction
...
11. Generate a clue showing observable evidence of Captain Ivor Hale's premeditation or planning (Desperation for money due to debts.). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: desperation, money, debts.
...
Create 2 red herrings that support the false assumption: "The murder must have occurred at the time the clock indicated."
...
Violations: 1. [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 2, 3; words: clock, accurate) and may support the true solution.; 2. [critical] Red Herring Separation: Red herring rh_2 overlaps inference corrections (steps: 2, 3; words: clock) and may support the true solution.
Warnings: None
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 2, 3; words: clock, accurate) and may support the true solution.
...
- required_direct_culprit_clue:
  ...
  - allowed_source_paths=CASE.cast[2].access_plausibility, CASE.cast[2].alibi_window, CASE.cast[2].evidence_sensitivity[0], CASE.inference_path.steps[2].observation, CASE.inference_path.steps[2].correction
