...
- Project ID: ``
- Timestamp: `2026-05-16T09:41:40.922Z`
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Beatrice wrestles with the tension between her ambition and her morality. The desire to rise in society often clashes with her better judgment, leading her to question the true cost of her aspirations."
...
• [clue_6] Beatrice Quill exhibited jealousy over Eleanor's attention from Captain Ivor Hale.
  Category: behavioral | Criticality: essential | Supports inference step 2
  Points to: This suggests a motive for the murder.

• [clue_7] Multiple witnesses claim they heard the clock strike after eleven.
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: This contradicts the stopped clock evidence.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the conversation progressed, Eleanor noted the subtle shifts in both Hale and Beatrice's demeanor. Each question seemed to peel back layers of their carefully constructed facades, revealing the raw nerves beneath. The tension was palpable, and Eleanor could..."
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=7859; context=10496; dropped=[none]; truncated=[pronoun_accuracy, location_profiles, temporal_context]
...
- Chapter 4:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the conversation progressed, Eleanor noted the subtle shifts in both Hale and Beatrice's demeanor. Each question seemed to peel back layers of their carefully constructed facades, revealing the raw nerves beneath. The...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • Beatrice Quill exhibited jealousy over Eleanor's attention from Captain Ivor Hale. [clue_6]
      Points to: This suggests a motive for the murder.
    • Multiple witnesses claim they heard the clock strike after eleven. [clue_7]
      Points to: This contradicts the stopped clock evidence.
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Beatrice's clenched fists as Eleanor mentions Captain Hale."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes Beatrice's jealousy over Eleanor's relationship with Captain Hale, hinting at possible motives."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Beatrice's smile falters as Eleanor mentions Captain Hale."
      ]
    },
    ...
    "emotionalRegister": "The investigation pivots as Beatrice becomes a suspect, increasing the pressure on the relationships between the characters.",
