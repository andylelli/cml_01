...
- Project ID: ``
- Timestamp: `2026-05-11T19:27:16.260Z`
...
- Era-authentic markers: petrol touring cars on county roads, domestic wiring with frequent outages, typewriters in use for correspondence, reliable passenger automobiles, peak passenger train services, early commercial aviation flights, party-line telephone exchanges common in rural areas, telegrams available via local post offices
- Tone: Classic
- No anachronisms
...
Description: An expansive country estate featuring a grand manor house with multiple floors, formal gardens, and a surrounding estate with agricultural land.
...
Setting constraints:
- Physical constraints: Layout includes restricted access to certain areas such as the library and cellar, Weather can impact movement, with muddy paths after rain limiting access, Isolation due to distance from the nearest town affects communication and assistance
...
- Social norms: Great Depression influencing social interactions and class tensions, strict adherence to social hierarchies within the estate
