...
- Project ID: ``
- Timestamp: `2026-05-20T18:11:48.323Z`
...
- Era-authentic markers: petrol-powered automobiles with limited reliability, early domestic telephones with party lines, typewriters for correspondence and reports, radio broadcasts for news and entertainment, popular passenger trains for regional travel, increasingly used automobiles for local transport, early commercial aviation for long-distance travel, telegrams for rapid communication
- Tone: Classic
- No anachronisms
...
Description: A large manor house set on sprawling grounds, featuring multiple rooms, a grand staircase, and a library filled with books.
...
Setting constraints:
- Physical constraints: Isolated location requiring travel on foot or by car to reach the nearest town, Geography includes gardens, a pond, and hedgerows which can obscure visibility, Architecture includes locked rooms and access restrictions for certain areas
- Geographic isolation: The estate is several miles from the nearest village, limiting immediate outside assistance.
- Access control: Restricted areas including the study and cellar that require permission to enter, Daily routines of staff dictate access to various parts of the house, Social hierarchies affect who can enter certain rooms and when

Era constraints to include:
- Technology: petrol-powered automobiles with limited reliability, early domestic telephones with party lines, typewriters for correspondence and reports
- Transportation: popular passenger trains for regional travel, increasingly used automobiles for local transport
- Social norms: impact of the Great Depression on social classes, rise of fascism in Europe affecting public sentiment
