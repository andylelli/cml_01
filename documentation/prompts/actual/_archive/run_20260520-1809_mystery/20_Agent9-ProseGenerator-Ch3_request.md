...
- Project ID: ``
- Timestamp: `2026-05-20T18:15:21.660Z`
...
Initial investigations spark suspicion, creating a sense of rising tension among the guests.
...
Rationale: Beatrice's humor can provide levity amidst the tension of the investigation.
...
• [clue_core_contradiction_chain] The clock's time does not match the expected time of death.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: Overturns the assumption that the time of death aligns with dinner.

• [clue_fp_contradiction_step_2] Witness statements indicated dinner was served at eight o'clock in the evening.
  Category: temporal | Criticality: essential | Supports inference step 2
  Points to: This creates a contradiction with the clock's time.

• [clue_mechanism_visibility_core] A mechanical clock was wound back to mislead the investigation.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: Reveals the method used to mislead investigators.
...
CLUES ALREADY REVEALED TO READER: clue_clock_time_stopped, clue_witness_dinner_time — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence in reader's hands: The clock in the study was found stopped at ten minutes past eleven. | Witness statements indicated dinner was served at eight o'clock.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "‘What was he doing there?’ Mallory asked, her voice sharp with curiosity. Eleanor shrugged, her expression conflicted. ‘I don’t know. I just remember seeing him. He seemed... distracted.’ Beatrice exchanged a glance with Mallory, both women grappling with the..."
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=8046; context=10937; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 3:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "‘What was he doing there?’ Mallory asked, her voice sharp with curiosity. Eleanor shrugged, her expression conflicted. ‘I don’t know. I just remember seeing him. He seemed... distracted.’ Beatrice exchanged a glance with...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The clock's time does not match the expected time of death. [clue_core_contradiction_chain] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: Overturns the assumption that the time of death aligns with dinner.
    ...
    • Witness statements indicated dinner was served at eight o'clock in the evening. [clue_fp_contradiction_step_2] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: This creates a contradiction with the clock's time.
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
         Paragraph 2 (immediately following): The detective or POV character explicitly reasons
           about what this evidence implies — who it implicates, why it may be unreliable,
           or what inference it supports. This must be a separate full paragraph, not a sentence appended to Paragraph 1.
    • A mechanical clock was wound back to mislead the investigation. [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: Reveals the method used to mislead investigators.
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
  ...
  - Sensory obligation — use at least two of: Candlelight flickering in the dim room, The shadows of books on the wall | The scratching of a pen on paper, The distant laughter from the drawing room | The scent of burning wood. Mood: Pensive, as decisions weigh heavily.
...
Chapter 3 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The clock's casing showing signs of tampering"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the clock's time does not match the expected time of death, indicating possible tampering."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Beatrice pauses, contemplating the implications of the clock's stopped time"
      ]
    },
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 3: "The clock's time does not match the expected time of death." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: "Witness statements indicated dinner was served at eight o'clock in the evening." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: "A mechanical clock was wound back to mislead the investigation." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
