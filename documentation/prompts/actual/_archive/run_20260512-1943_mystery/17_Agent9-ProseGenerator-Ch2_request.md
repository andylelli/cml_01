...
- Project ID: ``
- Timestamp: `2026-05-12T19:48:28.539Z`
...
• [clue_core_contradiction_chain] Witnesses recall hearing the specific chime at the actual time of death.
  Category: temporal | Criticality: essential | Supports inference step 2
  Points to: Contradicts the clock's indication of time.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the detective entered the study, the atmosphere shifted once more. Beatrice could sense the tension in the air, a mixture of hope and dread. The detective's presence brought with it an air of authority, a promise of clarity amidst the chaos. 'What do we hav..."
...
Chapter 1: Chapter 1: Discovery
  Events: The morning light filtered through the rain-streaked windows of the study, casting a muted glow over the somber scene.
...
Known location profile anchors: Little Middleton Manor, The Library, The Study, The Drawing Room, the drawing room
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The Library", "The Study", "The Drawing Room", "the drawing room"
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=6372; context=9872; dropped=[none]; truncated=[location_profiles, temporal_context]
...
- Chapter 2:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the detective entered the study, the atmosphere shifted once more. Beatrice could sense the tension in the air, a mixture of hope and dread. The detective's presence brought with it an air of authority, a promise of c...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • Witnesses recall hearing the specific chime at the actual time of death. [clue_core_contradiction_chain] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: Contradicts the clock's indication of time.
  ...
  - Sensory obligation — use at least two of: The daylight is muted, casting a grey pallor over the room, enhancing the atmosphere of unease., The fire crackles softly, providing the only warmth in the otherwise cool space. | The distant sound of a clock ticking is a constant reminder of time passing, heightening the tension in the air., The occasional murmur of voices from the hallway adds to the sense of intrigue and secrecy. | The air is thick with the scent of leather and old books, a reminder of the stories that fill the room.. Mood: uneasy stillness.
...
[
  {
    ...
    "purpose": "Establish suspects and alibis",
    "cluesRevealed": [
      "clue_core_contradiction_chain"
    ],
    "dramaticElements": {
      "conflict": "Tension rises as each person recounts their whereabouts.",
      "tension": "Contradictory statements create suspicion.",
      "microMomentBeats": [
        "Beatrice notices Ivor's fidgeting hands as he speaks."
      ]
    },
    "summary": "In the drawing room, Beatrice interviews the suspects. Each recounts their whereabouts during the time of the murder, but the tension escalates as their stories begin to contradict one another, particularly concerning the clock's time.",
    "estimatedWordCount": 1800,
    "emotionalRegister": "Suspicion begins to creep in, transforming the atmosphere from festive to tense.",
    ...
    "locationRegisterNote": "The drawing room exudes elegance but conceals a web of intrigue. Laughter and whispers dance in the air, yet beneath the surface, suspicion brews. This space becomes a crucible where social facades clash with hidden agendas, and every interaction carries the weight of unspoken truths. — As a writer captures this space, they should focus on the contrast between the inviting atmosphere and the undercurrents of deceit swirling beneath."
  }
]
```
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 2: "Witnesses recall hearing the specific chime at the actual time of death." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
