...
- Project ID: `unknown`
- Timestamp: `2026-05-16T21:00:51.343Z`
...
1. Generate a clue that makes the reader directly observe: "A smudge of dust is found on the clock face...."
   → observation | essential | early | temporal | step 1 | terms: smudge, found, clock

2. Generate a clue that provides evidence for: "The dust suggests recent tampering occurred before the murder...."
   → contradiction | essential | early | temporal | step 1 | terms: suggests, recent, tampering

3. Generate a clue that makes the reader directly observe: "Witnesses report hearing the clock chime at an unusual hour...."
   → observation | essential | early | temporal | step 2 | terms: witnesses, report, hearing

4. Generate a clue that provides evidence for: "The chiming indicates the clock was tampered with to create a false timeline...."
   → contradiction | essential | early | temporal | step 2 | terms: chiming, indicates, clock

5. Generate a clue that makes the reader directly observe: "The clock's pendulum shows signs of having been disturbed...."
   → observation | essential | mid | temporal | step 3 | terms: clock's, pendulum, shows

6. Generate a clue that provides evidence for: "The disturbance indicates deliberate tampering to mislead the time of death...."
   → contradiction | essential | mid | temporal | step 3 | terms: disturbance, indicates, deliberate

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The dust suggests recent tampering occurred before the murder...."
   → contradiction | essential | mid | temporal | step 1 | terms: suggests, recent, tampering

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The clock was wound back to create a false timeline for the murder...."
   → observation | essential | early | temporal | terms: clock, wound, create

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Eleanor sets a similar clock to a controlled time and observes its behavior, revealing the current c..."
   → observation | essential | mid | temporal | terms: eleanor, similar, clock
...
10. Generate one essential mid-story clue whose description or pointsTo explicitly names Beatrice Quill and states the unique trace, preparation detail, or mechanism link that points to Beatrice Quill rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Beatrice Quill, clock, wound, create

11. Generate a clue showing observable evidence of Beatrice Quill's premeditation or planning (Financial desperation). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
...
Create 2 red herrings that support the false assumption: "The time of death can be accurately determined by the clock's readings."
...
Violations: 1. [critical] Inference Path Coverage: Discriminating test evidence_clues reference missing clue id(s): clue_dust_marks, clue_chime_report, clue_pendulum_disturbance; 2. [critical] Inference Path Coverage: Discriminating test references no evidence found in the clue set
Warnings: None
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Inference Path Coverage: Discriminating test evidence_clues reference missing clue id(s): clue_dust_marks, clue_chime_report, clue_pendulum_disturbance
...
- required_id_to_source_mappings[]:
  - clue_dust_marks -> CASE.discriminating_test.evidence_clues[0]
  - clue_chime_report -> CASE.discriminating_test.evidence_clues[1]
  - clue_pendulum_disturbance -> CASE.discriminating_test.evidence_clues[2]
...
- required_direct_culprit_clue:
  ...
  - allowed_source_paths=CASE.cast[3].access_plausibility, CASE.cast[3].alibi_window, CASE.inference_path.steps[0].observation, CASE.inference_path.steps[0].correction, CASE.inference_path.steps[2].observation, CASE.inference_path.steps[2].correction
