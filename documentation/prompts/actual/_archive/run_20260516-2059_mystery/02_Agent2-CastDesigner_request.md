...
- Project ID: ``
- Timestamp: `2026-05-16T20:59:50.102Z`
...
**Setting**: 1930s - A large, stately manor house set in expansive grounds, characterized by formal gardens and an imposing façade.
**Crime Type**: Murder
**Social Context**: Great Depression impacting social classes, rising class tensions and economic disparity, traditional gender roles prevalent in society
**Tone**: Classic
