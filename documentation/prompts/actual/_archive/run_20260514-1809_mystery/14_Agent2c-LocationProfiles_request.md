...
- Project ID: ``
- Timestamp: `2026-05-14T18:12:06.069Z`
...
- Era-authentic markers: petrol touring cars on country roads, domestic wiring with frequent outages, typewriters in use for correspondence, reliable automobiles, passenger trains as primary long-distance transport, early commercial aviation for select routes, party-line telephone exchanges common, telegrams via local postal offices
- Tone: Classic
- No anachronisms
...
Description: A large, stately manor house set in expansive grounds, featuring ornate architecture typical of the period, including high ceilings, large windows, and a grand entrance.
...
Setting constraints:
- Physical constraints: geography allows for discreet movement around the estate, the architecture creates natural access restrictions to certain areas, weather can affect outdoor investigation timing and evidence visibility
...
- Access control: restricted areas such as the library and the cellar, permissions required to access the servants' quarters, daily routines dictate movement patterns within the house
...
- Transportation: reliable automobiles, passenger trains as primary long-distance transport
- Social norms: impact of the Great Depression on social dynamics, class tensions prevalent among estate workers and owners
