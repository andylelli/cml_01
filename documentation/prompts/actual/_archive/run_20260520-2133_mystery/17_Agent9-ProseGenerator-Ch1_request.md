...
- Project ID: ``
- Timestamp: `2026-05-20T21:37:50.682Z`
...
### Dr. Mallory Finch
Dr. Mallory Finch represents the challenges faced by professionals in a struggling economy. As a respected physician, she feels the pressure of maintaining her reputation amidst financial instability and growing jealousy. Mallory's rivalry with the victim symbolizes the cutthroat nature of professional ambition during the Great Depression, where survival often comes at the cost of personal relationships.
Era intersection: Her jealousy and ambition reflect the competitive environment of 1931, where professionals are increasingly threatened by their peers.
...
Dr. Finch speaks with precision and a measured tone, often using medical jargon that reflects her profession.
[comfortable] It's essential to prioritize patient care; after all, we are in the business of healing.
[evasive] I'm afraid I can't disclose patient details; confidentiality is paramount.
[stressed] One must never underestimate the impact of rivalry; it can lead to... unforeseen complications.
Humour: Her dry wit serves as a shield against her insecurities, masking deeper feelings of jealousy.
...
Mallory speaks with a precise, measured tone, often employing medical jargon that reflects her profession
She has a tendency to punctuate her statements with dry humour, using it as a shield against her insecurities.
She grapples with the gnawing jealousy that clouds her judgment, torn between her professional integrity and the darker impulses that threaten to consume her.
...
Voice & mannerisms: Mallory speaks with a precise, measured tone, often employing medical jargon that reflects her profession. She has a tendency to punctuate her statements with dry humour, using it as a shield against her insecurities.
Sample voice fragments (match this register and rhythm):
  [comfortable] "It's essential to prioritize patient care; after all, we are in the business of healing."
  [evasive] "I'm afraid I can't disclose patient details; confidentiality is paramount."
Humour: dry wit — deploy occasionally (level 0.5)
FORBIDDEN phrase (never write for Dr. Mallory Finch): "a surge of determination washed over her"
Act 1 behaviour contract: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Mallory views the victim as a professional threat, believing that if the victim's downfall could be orchestrated, her own standing in the community would be secure." — do not surface in Act I.
...
CHAPTER SENSORY PALETTE HINTS (evoke these qualities without copying verbatim):
  Chapter 1 palette — morning, rain, oppressive mood [location: The Drawing Room]:
    • dim light filtering through rain-soaked windows, wet le
...
• [clue_clock_stopped] The clock in the drawing room is stopped at ten minutes past eleven.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: This indicates a possible tampering with the timeline.
...
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the drawing room". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=5550; context=10760; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_clock_stopped must appear in Act 1, Scene 1 via Direct observation of the clock
...
- Chapter 1:
  ...
  - INVESTIGATOR ESTABLISHMENT REQUIRED: Captain Ivor Hale must claim or be recognised as the investigator in this chapter. Establish Captain Ivor Hale as the detective-in-charge within the first two paragraphs — Captain Ivor Hale IS the investigator. Do NOT have any character suggest a "real" detective is still coming, or imply that authority has not yet been delegated. Captain Ivor Hale begins the investigation in this chapter.
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The clock in the drawing room is stopped at ten minutes past eleven. [clue_clock_stopped] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: This indicates a possible tampering with the timeline.
  ...
  - Sensory obligation — use at least two of: dim light filtering through rain-soaked windows, wet leaves outside | steady patter of rain, soft rustle of fabric | damp wood. Mood: oppressive.
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The stopped clock in the drawing room, frozen at ten minutes past eleven."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the time of death as no later than ten minutes past eleven, contradicting three suspects' alibis."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_1] Eleanor Voss is seen crying, claiming she had just argued with Dr. Finch, suggesting a motive.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor Voss stands frozen, eyes wide, as the clock ticks ominously in the background."
      ]
    },
    "summary": "In the drawing room, the body of the doctor Finch is discovered, lifeless and cold. The clock on the wall stops at ten minutes past eleven, raising immediate questions. Captain Hale arrives, already suspecting foul play as he examines the scene.",
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_1",
      "placementDetail": "Eleanor Voss is seen crying, claiming she had just argued with Dr. Finch, suggesting a motive."
    },
    "emotionalRegister": "The initial atmosphere is one of grandeur tinged with impending doom.",
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 1: "The clock in the drawing room is stopped at ten minutes past eleven." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
