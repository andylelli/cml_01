...
- Project ID: `unknown`
- Timestamp: `2026-05-20T21:34:50.029Z`
...
1. Generate a clue that makes the reader directly observe: "The clock in the drawing room is stopped at ten minutes past eleven...."
   → observation | essential | early | temporal | step 1 | terms: clock, drawing, stopped

2. Generate a clue that provides evidence for: "The clock's stoppage indicates tampering that may align with the murder...."
   → contradiction | essential | early | temporal | step 1 | terms: clock's, stoppage, indicates

3. Generate a clue that makes the reader directly observe: "Guests report hearing a loud crash around the time of death, but the clock does not match their acco..."
   → observation | essential | early | temporal | step 2 | terms: guests, report, hearing

4. Generate a clue that provides evidence for: "The inconsistent timing of the clock and the crash suggests the clock was tampered with to mislead...."
   → contradiction | essential | early | temporal | step 2 | terms: inconsistent, timing, clock

5. Generate a clue that makes the reader directly observe: "A note found near the clock references a specific time, contradicting Eleanor's alibi...."
   → observation | essential | mid | temporal | step 3 | terms: found, clock, references

6. Generate a clue that provides evidence for: "The note suggests premeditation and an intent to mislead regarding the timeline...."
   → contradiction | essential | mid | temporal | step 3 | terms: suggests, premeditation, intent

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The clock's stoppage indicates tampering that may align with the murder...."
   → contradiction | essential | mid | temporal | step 1 | terms: clock's, stoppage, indicates

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The clock was wound back forty minutes, creating a false timeline and allowing the murder to occur unnoticed...."
   → observation | essential | early | temporal | terms: clock, wound, forty

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "A controlled reenactment of the murder timing using the clock's mechanism to prove it was tampered w..."
   → observation | essential | mid | temporal | terms: controlled, reenactment, murder
...
10. Generate one essential mid-story clue whose description or pointsTo explicitly names Eleanor Voss and states the unique trace, preparation detail, or mechanism link that points to Eleanor Voss rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Eleanor Voss, clock, wound, forty

11. Generate a clue showing observable evidence of Eleanor Voss's premeditation or planning (financial stress from the estate's debts). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: financial, stress, estate's
...
13. Generate one essential early or mid elimination clue that explicitly rules out Captain Ivor Hale and narrows the solution toward culprit Eleanor Voss. The pointsTo text must start with "Eliminates Captain Ivor Hale because ..." and cite corroborated evidence.
   → elimination | essential | mid | testimonial | terms: Captain Ivor Hale, Eleanor Voss
...
Create 2 red herrings that support the false assumption: "Dr. Mallory Finch was murdered shortly after Eleanor Voss left the drawing room."
...
Violations: 1. [critical] Inference Path Coverage: Discriminating test evidence_clues reference missing clue id(s): clue_clock_stopped, clue_guest_testimony, clue_note_found; 2. [critical] Inference Path Coverage: Discriminating test references no evidence found in the clue set
Warnings: Inference step 3 has no contradiction clue; Inference step 3 has clues but no contradiction/elimination evidence
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Inference Path Coverage: Discriminating test evidence_clues reference missing clue id(s): clue_clock_stopped, clue_guest_testimony, clue_note_found
...
- required_id_to_source_mappings[]:
  - clue_clock_stopped -> CASE.discriminating_test.evidence_clues[0]
  - clue_guest_testimony -> CASE.discriminating_test.evidence_clues[1]
  - clue_note_found -> CASE.discriminating_test.evidence_clues[2]
...
- required_direct_culprit_clue:
  ...
  - allowed_source_paths=CASE.cast[0].access_plausibility, CASE.cast[0].alibi_window, CASE.inference_path.steps[0].observation, CASE.inference_path.steps[0].correction, CASE.inference_path.steps[1].observation, CASE.inference_path.steps[1].correction
