...
- Project ID: ``
- Timestamp: `2026-05-20T21:35:46.766Z`
...
- Era-authentic markers: petrol touring cars on county roads, early home telephones with party lines, typewriters standard in offices, reliable automobiles for local travel, passenger trains as primary long-distance transport, early commercial aviation for major cities, telephone communication common among households, telegram services for urgent messages
- Tone: Classic
- No anachronisms
...
Description: A large manor house featuring grand architecture typical of the period, surrounded by sprawling gardens and woodlands.
...
Setting constraints:
- Physical constraints: manor layout restricts access to certain areas without permission, gardens and woodlands can obscure evidence from view, weather conditions can affect the timing of outdoor activities
- Geographic isolation: Moderately isolated, with the nearest town several miles away, limiting quick access to outside help.
- Access control: restricted areas within the manor such as private studies or servant quarters, daily routines of staff create predictable movement patterns, social hierarchies dictate who can access certain areas
...
- Social norms: Great Depression leading to economic hardship, class tensions between estate owners and workers
