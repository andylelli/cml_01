...
- Project ID: ``
- Timestamp: `2026-05-20T21:36:24.015Z`
...
- YOU MUST use the exact year and month specified above: November 1931
- This date has been specifically selected for THIS mystery to ensure uniqueness
- DO NOT change the year or month - use November 1931 exactly
...
- All details must be historically accurate for November 1931 specifically
- Generate fresh, original descriptions - do not copy example phrasing
- Make this feel like the specific moment of November 1931
...
- Technology available: petrol touring cars on county roads, early home telephones with party lines, typewriters standard in offices
- Forensics: fingerprinting standard for identification, basic toxicology testing available, emerging ballistics analysis techniques
- Social norms: Great Depression leading to economic hardship, class tensions between estate owners and workers, rising fascism influencing societal attitudes

Task:
1. Use the specified date: November 1931
