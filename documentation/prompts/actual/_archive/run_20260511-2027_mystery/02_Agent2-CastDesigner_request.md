...
- Project ID: ``
- Timestamp: `2026-05-11T20:27:34.960Z`
...
**Setting**: 1930s - A large and imposing manor house with expansive grounds, gardens, and outbuildings, reflecting the wealth of its owners.
**Crime Type**: Murder
**Social Context**: Great Depression impacting wealth distribution, class tensions between staff and owners, formal etiquette governing interactions
**Tone**: Classic
