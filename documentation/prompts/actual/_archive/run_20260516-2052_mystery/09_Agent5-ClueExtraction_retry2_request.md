...
- Project ID: `unknown`
- Timestamp: `2026-05-16T20:53:20.364Z`
...
2. Generate a clue that provides evidence for: "This indicates a potential manipulation of time since the time of death was later...."
   → contradiction | essential | early | temporal | step 1 | terms: indicates, potential, manipulation

3. Generate a clue that makes the reader directly observe: "Witnesses heard a loud argument between Finch and Voss shortly before eleven...."
   → observation | essential | early | temporal | step 2 | terms: witnesses, heard, argument

4. Generate a clue that provides evidence for: "This aligns with the clock being tampered with to create an alibi for Finch during the murder...."
   → contradiction | essential | early | temporal | step 2 | terms: aligns, clock, being

5. Generate a clue that makes the reader directly observe: "Dust patterns on the clock suggest recent tampering...."
   → observation | essential | mid | temporal | step 3 | terms: patterns, clock, suggest

6. Generate a clue that provides evidence for: "This indicates that someone adjusted the clock just before the murder...."
   → contradiction | essential | mid | temporal | step 3 | terms: indicates, someone, adjusted

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "This indicates a potential manipulation of time since the time of death was later...."
   → contradiction | essential | mid | temporal | step 1 | terms: indicates, potential, manipulation

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The clock was tampered with to create a false alibi for Dr. Mallory Finch...."
   → observation | essential | early | temporal | terms: clock, tampered, create

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "A comparison of the clock's time with the witness accounts reveals that Finch's alibi cannot hold un..."
   → observation | essential | mid | temporal | terms: comparison, clock's, witness
...
10. Generate one essential mid-story clue whose description or pointsTo explicitly names Dr. Mallory Finch and states the unique trace, preparation detail, or mechanism link that points to Dr. Mallory Finch rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Dr. Mallory Finch, clock, tampered, create

11. Generate a clue showing observable evidence of Dr. Mallory Finch's premeditation or planning (Financial desperation.). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
...
Create 2 red herrings that support the false assumption: "The murderer's motive can only be found in their immediate relationships and recent interactions."
...
- required_direct_culprit_clue:
  ...
  - allowed_source_paths=CASE.cast[1].access_plausibility, CASE.cast[1].alibi_window, CASE.cast[1].evidence_sensitivity[0], CASE.inference_path.steps[0].observation, CASE.inference_path.steps[0].correction
