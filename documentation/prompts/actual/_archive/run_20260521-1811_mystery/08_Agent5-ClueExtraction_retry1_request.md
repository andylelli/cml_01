...
- Project ID: `unknown`
- Timestamp: `2026-05-21T18:13:06.894Z`
...
1. Generate a clue that makes the reader directly observe: "The mechanical clock in the study shows the hands stuck at ten minutes past eleven...."
   → observation | essential | early | temporal | step 1 | terms: mechanical, clock, study

2. Generate a clue that provides evidence for: "This indicates tampering since it should have been wound down earlier...."
   → contradiction | essential | early | testimonial | step 1 | terms: indicates, tampering, since

3. Generate a clue that makes the reader directly observe: "A faint scratch is found on the clock's casing...."
   → observation | essential | early | temporal | step 2 | terms: faint, scratch, found

4. Generate a clue that provides evidence for: "This scratch suggests recent tampering was done to alter the time...."
   → contradiction | essential | early | temporal | step 2 | terms: scratch, suggests, recent

5. Generate a clue that makes the reader directly observe: "Witness statements report hearing the clock strike at 7:15 PM...."
   → observation | essential | mid | temporal | step 3 | terms: witness, statements, report

6. Generate a clue that provides evidence for: "This contradicts the clock's showing of 7:30 PM...."
   → contradiction | essential | mid | temporal | step 3 | terms: contradicts, clock's, showing

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "This indicates tampering since it should have been wound down earlier...."
   → contradiction | essential | mid | testimonial | step 1 | terms: indicates, tampering, since

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "A mechanical clock is systematically rewound to create a false timeline, implicating Dr. Mallory Finch...."
   → observation | essential | early | temporal | terms: mechanical, clock, systematically

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Comparing witness accounts of the clock's striking time against the altered time reveals the inconsi..."
   → observation | essential | mid | temporal | terms: comparing, witness, accounts
...
10. Generate one essential mid-story clue whose description or pointsTo explicitly names Dr. Mallory Finch and states the unique trace, preparation detail, or mechanism link that points to Dr. Mallory Finch rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Dr. Mallory Finch, mechanical, clock, systematically
...
- Eleanor Voss: sensitive items: clock tampering evidence, alibi verification
- Dr. Mallory Finch: sensitive items: clock evidence, witness statements
- Captain Ivor Hale: sensitive items: timeline evidence, mechanical clock testing
- Beatrice Quill: sensitive items: clue collection, suspect interviews
...
Create 2 red herrings that support the false assumption: "The murder occurred at the time indicated on the clock."
...
Warnings: 1 red herring(s) may accidentally support the true solution (rh_2)
...
- must_fix[]:
  ...
  - [warning] 1 red herring(s) may accidentally support the true solution (rh_2)
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
...
- required_direct_culprit_clue:
  ...
  - allowed_source_paths=CASE.cast[1].access_plausibility, CASE.cast[1].alibi_window, CASE.cast[1].evidence_sensitivity[0], CASE.inference_path.steps[0].observation, CASE.inference_path.steps[0].correction, CASE.inference_path.steps[2].observation, CASE.inference_path.steps[2].correction
