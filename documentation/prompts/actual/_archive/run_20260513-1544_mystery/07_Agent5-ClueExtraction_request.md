...
- Project ID: `unknown`
- Timestamp: `2026-05-13T15:45:24.250Z`
...
2. Generate a clue that provides evidence for: "The clock's time is not accurate as it was tampered with...."
   → contradiction | essential | early | temporal | step 1 | terms: clock's, accurate, tampered

3. Generate a clue that makes the reader directly observe: "A faint scratch is visible on the clock's casing...."
   → observation | essential | early | temporal | step 2 | terms: faint, scratch, visible

4. Generate a clue that provides evidence for: "The scratch indicates the clock was recently tampered with...."
   → contradiction | essential | early | temporal | step 2 | terms: scratch, indicates, clock

5. Generate a clue that makes the reader directly observe: "Conflicting witness statements about the time of death...."
   → observation | essential | mid | temporal | step 3 | terms: conflicting, witness, statements

6. Generate a clue that provides evidence for: "The conflicting statements suggest that the timeline has been manipulated...."
   → contradiction | essential | mid | temporal | step 3 | terms: conflicting, statements, suggest

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The clock's time is not accurate as it was tampered with...."
   → contradiction | essential | mid | temporal | step 1 | terms: clock's, accurate, tampered
...
9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Confront Dr. Mallory Finch with the evidence of the clock's tampering and his access to the clo..."
   → observation | essential | mid | temporal | terms: confront, mallory, finch
...
Create 2 red herrings that support the false assumption: "The murder must have occurred during the time indicated by the clock."
