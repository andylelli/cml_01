...
- Project ID: `unknown`
- Timestamp: `2026-05-20T22:09:46.700Z`
...
1. Generate a clue that makes the reader directly observe: "The clock in the library shows ten minutes past eleven when discovered...."
   → observation | essential | early | temporal | step 1 | terms: clock, library, shows

2. Generate a clue that provides evidence for: "The clock must have been tampered with since witnesses claim the victim was seen alive until shortly..."
   → contradiction | essential | early | temporal | step 1 | terms: clock, tampered, since

3. Generate a clue that makes the reader directly observe: "The victim's pocket contains a winding key with fresh marks...."
   → observation | essential | early | testimonial | step 2 | terms: victim's, pocket, contains

4. Generate a clue that provides evidence for: "The presence of the winding key indicates recent tampering with the clock...."
   → contradiction | essential | early | temporal | step 2 | terms: presence, winding, indicates

5. Generate a clue that makes the reader directly observe: "Witnesses provide conflicting accounts of the victim's last actions...."
   → observation | essential | mid | testimonial | step 3 | terms: witnesses, provide, conflicting

6. Generate a clue that provides evidence for: "The discrepancies indicate that at least one witness may be lying or misremembering...."
   → contradiction | essential | mid | testimonial | step 3 | terms: discrepancies, indicate, least

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The clock must have been tampered with since witnesses claim the victim was seen alive until shortly before eleven...."
   → contradiction | essential | mid | temporal | step 1 | terms: clock, tampered, since

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The clock has been rewound to mislead the investigation regarding the time of death...."
   → observation | essential | early | temporal | terms: clock, rewound, mislead

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Setting up a scenario where the suspects must account for their whereabouts when the clock was tampe..."
   → observation | essential | mid | temporal | terms: setting, scenario, suspects
...
11. Generate a clue showing observable evidence of Captain Ivor Hale's premeditation or planning (Jealousy over Eleanor's affections). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: jealousy, eleanor's, affections
...
Create 2 red herrings that support the false assumption: "The murder must have happened shortly before the clock stopped."
...
Violations: 1. [critical] Inference Path Coverage: Discriminating test evidence_clues reference missing clue id(s): clue_early_1, clue_early_2, clue_mid_1; 2. [critical] Inference Path Coverage: Discriminating test references no evidence found in the clue set
Warnings: None
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Inference Path Coverage: Discriminating test evidence_clues reference missing clue id(s): clue_early_1, clue_early_2, clue_mid_1
...
- required_id_to_source_mappings[]:
  - clue_early_1 -> CASE.discriminating_test.evidence_clues[0]
  - clue_early_2 -> CASE.discriminating_test.evidence_clues[1]
  - clue_mid_1 -> CASE.discriminating_test.evidence_clues[2]
  - clue_culprit_direct_captain_ivor_hale -> CASE.cast[2].access_plausibility
  - clue_mid_2 -> CASE.prose_requirements.clue_to_scene_mapping[3].clue_id
  - clue_mid_3 -> CASE.prose_requirements.clue_to_scene_mapping[4].clue_id
