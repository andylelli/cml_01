...
- Project ID: `unknown`
- Timestamp: `2026-05-20T22:12:18.409Z`
...
The murder must have happened shortly before the clock stopped.
*Revealed: final act*
...
### Early Clues (Act I)
- [clue_mechanism_visibility_core] temporal: The clock in the library shows ten minutes past eleven when discovered.
- [clue_core_contradiction_chain] temporal: The clock must have been tampered with since witnesses claim the victim was seen alive until shortly before eleven.
- [clue_early_2] temporal: The victim's watch shows a different time than the clock.
- [clue_early_3] physical: The victim's pocket contains a winding key with fresh marks.

### Mid Clues (Act II)
- [clue_early_1] testimonial: Witnesses provide conflicting accounts of the victim's last actions.
- [clue_mid_1] testimonial: The discrepancies indicate that at least one witness may be lying or misremembering.
- [clue_mid_2] behavioral: Captain Ivor Hale was seen near the library shortly before the clock was discovered.
- [clue_mid_3] testimonial: Witnesses recall Captain Ivor Hale arguing with the victim earlier that evening.
...
- [clue_mid_4] temporal: Setting up a scenario where the suspects must account for their whereabouts when the clock was tampered.
- [clue_fp_contradiction_step_3] temporal: Witnesses provide conflicting accounts of the victim's last actions.

### Late Clues (Act III)
- [clue_late_optional_slot_1] testimonial: Dr. Mallory Finch was attending a medical conference at the time of the murder.
...
- **Dr. Mallory Finch**: Act 3, Scene 5
  - Method: Medical records show she was with a patient.
...
- **clue_early_3**: Act 1, Scene 3 (Direct observation)
- **clue_early_1**: Act 2, Scene 1 (Direct observation)
...
- **murder_time**: "twenty minutes past ten" — The actual time of the murder, when the clock was set back


## PILLAR 4 — OUTLINE COMPLETENESS CONTRACT DATA

### Character Permitted Behaviours (use for permittedBehavioursByAct per scene)
- **Eleanor Voss**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "The fear of losing her social status is palpable; if the victim were to expose her family's financial troubles, Eleanor would be thrust into a life of scandal and disgrace." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Eleanor is torn between her desire to maintain her façade of opulence and the gnawing reality of her family's precarious financial situation. She feels guilt for prioritizing appearances over honesty." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Dr. Mallory Finch**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "When the victim threatened to expose her malpractice, Mallory felt the ground shift beneath her feet, prompting her to entertain desperate measures to protect her career." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Dr. Finch wrestles with guilt over her unethical actions, torn between her ambition and the moral implications of her choices. She fears the consequences of her actions but finds it difficult to turn back now." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Captain Ivor Hale**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Ivor's plans for retribution have taken root since the victim's actions led to his downfall, and he sees this as a chance to restore his honor." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Ivor grapples with deep resentment towards those he holds responsible for his downfall, torn between his desire for revenge and the remnants of his former honor. He fears that pursuing vengeance may lead him further away from redemption." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Beatrice Quill**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "With the victim threatening to expose her secret, Beatrice is driven to eliminate the risk to her career, believing that her future hinges on her ability to keep her scandal hidden." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Beatrice is torn between her ambition and the potential consequences of her choices. She grapples with the fear that her desire for success may lead her to betray her own values." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
