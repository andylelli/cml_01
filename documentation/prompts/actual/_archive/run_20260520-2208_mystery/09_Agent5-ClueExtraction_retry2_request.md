...
- Project ID: `unknown`
- Timestamp: `2026-05-20T22:09:55.701Z`
...
Violations: 1. [critical] Suspect Clue Coverage: Dr. Mallory Finch is not referenced in any clue.
Warnings: None
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Suspect Clue Coverage: Dr. Mallory Finch is not referenced in any clue.
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
