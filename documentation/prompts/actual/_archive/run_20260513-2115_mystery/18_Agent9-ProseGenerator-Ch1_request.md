...
- Project ID: ``
- Timestamp: `2026-05-13T21:20:20.330Z`
...
• [clue_mechanism_visibility_core] A hidden mechanism on the grandfather clock allows someone to turn back the hands, creating an alibi.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: This reveals how the clock could have been tampered with to create a false alibi.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=5204; context=10238; dropped=[none]; truncated=[location_profiles, temporal_context]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • A hidden mechanism on the grandfather clock allows someone to turn back the hands, creating an alibi. [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: This reveals how the clock could have been tampered with to create a false alibi.
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The grandfather clock with its visible mechanism, suggesting tampering."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the clock's mechanism is accessible, hinting at potential interference with timekeeping."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor lingers at the door, a mix of grief and determination in her eyes."
      ]
    },
    ...
    "emotionalRegister": "The opening sets a tense atmosphere filled with foreboding.",
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 1: "A hidden mechanism on the grandfather clock allows someone to turn back the hands, creating an alibi." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
