...
- Project ID: ``
- Timestamp: `2026-05-16T20:19:28.960Z`
...
The atmosphere is thick with anticipation, setting the stage for hidden tensions.
...
Rationale: Eleanor's dry wit can lighten the atmosphere as guests arrive.
...
Act 1 behaviour contract: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "The fear that the victim may expose his past drives Ivor to desperation, as he wrestles with the potential fallout of a revelation that could ruin him." — do not surface in Act I.
...
Act 1 behaviour contract: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "The worry that the victim would expose their relationship drives her to consider drastic measures to protect her social ascent." — do not surface in Act I.
...
• [clue_2] This contradicts the witness statements that claim the murder happened at midnight.
  Category: testimonial | Criticality: essential | Supports inference step 1
  Points to: The timeline of the murder is inconsistent with witness accounts.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As they stood in the study, the rain continued to summer outside, a steady rhythm that matched the unease in Eleanor's heart. She felt a flicker of irony at the thought that the very clock meant to keep time had instead become a harbinger of chaos. With each t..."
...
Known location profile anchors: Little Middleton Manor, The Library, The Drawing Room, The Stable, The Study, the living room
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The Library", "The Drawing Room", "The Stable", "The Study", "the living room"
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=6364; context=10479; dropped=[none]; truncated=[pronoun_accuracy, temporal_context]
...
- Chapter 2:
  ...
  - Scene is set in: the living room — reference it naturally within the paragraph, never as your opening phrase.
  - Opening atmosphere (MANDATORY — validator enforced): the first paragraph MUST contain at least one of: rain / wind / fog / storm / mist / thunder / evening / morning / night / dawn / dusk / season / afternoon / midday / noon / midnight / twilight / sunrise / sunset / daylight / sunlight / overcast / cloudy / bright / dark. A chapter that omits all of these from its opening paragraph will be rejected.
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As they stood in the study, the rain continued to summer outside, a steady rhythm that matched the unease in Eleanor's heart. She felt a flicker of irony at the thought that the very clock meant to keep time had instead...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • This contradicts the witness statements that claim the murder happened at midnight. [clue_2] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: The timeline of the murder is inconsistent with witness accounts.
...
Chapter 2 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Conflicting witness statements about the time of the murder"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that witnesses claim the murder happened at midnight, which contradicts the clock reading."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_2] Captain Hale insists he heard the clock strike twelve just before the murder.
...
[
  {
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_2",
      "placementDetail": "Captain Hale insists he heard the clock strike twelve just before the murder."
    },
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 2: "This contradicts the witness statements that claim the murder happened at midnight." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
