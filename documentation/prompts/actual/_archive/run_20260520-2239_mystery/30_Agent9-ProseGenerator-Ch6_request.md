...
- Project ID: ``
- Timestamp: `2026-05-20T22:46:22.991Z`
...
Confrontation forces characters to reckon with their hidden motives.
...
Rationale: The second interview requires a serious tone to maintain the investigation's momentum.
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Eleanor grapples with the fear of losing her social standing and the lengths she is willing to go to preserve it. This internal struggle manifests as a constant battle between her ambition and her moral compass."
...
• [clue_7] Eleanor Voss displayed signs of nervousness during dinner.
  Category: behavioral | Criticality: essential | Supports inference step 3
  Points to: This indicates potential guilt.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the conversation continued, Beatrice felt a flicker of relief at the prospect of finding corroboration for Hale's alibi. Yet, the nagging doubt in the back of her mind refused to fade. The clock's tampering, the whispers of the tavern patrons, and Hale's br..."
...
study, manor, library, drawing room, flat, bar
...
Known location profile anchors: Little Middleton Manor, The Library, The Study, The Drawing Room, The Gardens, the dining room of Eleanor Voss's manor
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The Library", "The Study", "The Drawing Room", "The Gardens", "the dining room of Eleanor Voss's manor"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 6: OPENING STYLE: Atmospheric scene-setting is permitted here — but the first sentence MUST differ structurally from both the preceding and following chapters. Do not reuse the same clause structure or sensory vocabulary as adjacent chapters. Anchor opening in "the dining room of Eleanor Voss's manor". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=10901; context=11210; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 6:
  ...
  - Scene is set in: the dining room of Eleanor Voss's manor — reference it naturally within the paragraph, never as your opening phrase.
  - Opening atmosphere (MANDATORY — validator enforced): the first paragraph MUST contain at least one of: rain / wind / fog / storm / mist / thunder / evening / morning / night / dawn / dusk / season / afternoon / midday / noon / midnight / twilight / sunrise / sunset / daylight / sunlight / overcast / cloudy / bright / dark / grey / pale / cold / warm / chill / crisp / damp / drizzle / haze / lamplight / firelight. A chapter that omits all of these from its opening paragraph will be rejected.
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the conversation continued, Beatrice felt a flicker of relief at the prospect of finding corroboration for Hale's alibi. Yet, the nagging doubt in the back of her mind refused to fade. The clock's tampering, the whisp...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    ...
    • Eleanor Voss displayed signs of nervousness during dinner. [clue_7]
      Points to: This indicates potential guilt.
    • The discriminating test compares clock, study, and twenty against the claimed timeline. [clue_8]
      Points to: This will help establish the true timeline.
    • The clock was stopped at ten minutes past eleven. [clue_9]
      Points to: This indicates the last known time the clock was functioning.
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Eleanor's visibly trembling hands as she eats."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes Eleanor displayed signs of nervousness during dinner, raising further suspicion."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor's fork clatters against her plate as she flinches at a sudden noise."
      ]
    },
    ...
    "emotionalRegister": "Confrontation forces characters to reckon with their hidden motives.",
...
```text
{
  ...
  "chapters": [
    {
      ...
      "paragraphs": [
        ...
        "As the dinner continued, Beatrice felt a flicker of sympathy for Eleanor, yet the evidence of her guilt loomed larger. The way Eleanor's hands shook, the way she avoided eye contact, all pointed to a woman who was hiding a terrible secret. Beatrice's thoughts drifted back to the clock, the tampering that had occurred, and the implications it held for Eleanor. The clock had been intentionally wound back to mislead the timeline of events, and Eleanor's access to it only deepened the suspicion surrounding her. Beatrice's resolve hardened; she needed to confront Eleanor about the evidence that tied her to the crime.",
  ...
  "audit": {
    ...
    "required_clues_present": "clue_7: paragraph 5 | clue_culprit_direct_eleanor_voss: paragraph 8",
...
• Chapter 6: clue evidence "The discriminating test compares clock, study, and twenty against the claimed timeline." is absent. Include an on-page observation or reference to "The discriminating test compares clock, study, and twenty against the claimed timeline." (this clue reveals: This will help establish the true timeline.) before the chapter ends.
• Chapter 6: clue evidence "Eliminates Dr. Mallory Finch because he was at the hospital during the murder." is absent. Include an on-page observation or reference to "Eliminates Dr. Mallory Finch because he was at the hospital during the murder." (this clue reveals: This confirms he could not have committed the crime.) before the chapter ends.
...
• REPAIR [clue_visibility — attempt 2]: chapters 6 are missing 2 clues.
  ...
  [Clue 1]: "The discriminating test compares clock, study, and twenty against the claimed timeline."
  ...
  • Inference paragraph (immediately after): The detective or POV character state explicitly: "This will help establish the true timeline.". Use first-person inference language ("She realised...", "He could not help but notice..."). This must be a full separate paragraph, not a tacked-on sentence.
  [Clue 2]: "Eliminates Dr. Mallory Finch because he was at the hospital during the murder."
  • Observation paragraph: A character directly observes or discovers this evidence. Be specific and sensory — describe what is seen, touched, or heard. Include the exact quoted phrase verbatim.
