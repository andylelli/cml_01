...
- Project ID: `unknown`
- Timestamp: `2026-05-20T22:40:39.950Z`
...
1. Generate a clue that makes the reader directly observe: "The clock in the study shows a time of twenty minutes past nine...."
   → observation | essential | early | temporal | step 1 | terms: clock, study, shows

2. Generate a clue that provides evidence for: "This contradicts guest testimonies that they heard the clock strike ten...."
   → contradiction | essential | early | temporal | step 1 | terms: contradicts, guest, testimonies

3. Generate a clue that makes the reader directly observe: "A faint scratch on the clock face indicates recent adjustment...."
   → observation | essential | early | temporal | step 2 | terms: faint, scratch, clock

4. Generate a clue that provides evidence for: "The scratches suggest tampering occurred just before the murder...."
   → contradiction | essential | early | temporal | step 2 | terms: scratches, suggest, tampering

5. Generate a clue that makes the reader directly observe: "Eleanor Voss had the clock's key in her possession...."
   → observation | essential | mid | temporal | step 3 | terms: eleanor, clock's, possession.

6. Generate a clue that provides evidence for: "This access allowed her to tamper with the clock and mislead others...."
   → contradiction | essential | mid | temporal | step 3 | terms: access, allowed, tamper

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "This contradicts guest testimonies that they heard the clock strike ten...."
   → contradiction | essential | mid | temporal | step 1 | terms: contradicts, guest, testimonies

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The clock was intentionally wound back to mislead the timeline of events...."
   → observation | essential | early | temporal | terms: clock, intentionally, wound

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "The discriminating test compares clock, study, and twenty against the claimed timeline...."
...
10. Generate one essential mid-story clue whose description or pointsTo explicitly names Eleanor Voss and states the unique trace, preparation detail, or mechanism link that points to Eleanor Voss rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Eleanor Voss, clock, intentionally, wound

11. Generate a clue showing observable evidence of Eleanor Voss's premeditation or planning (Desire for financial security). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: desire, financial, security
...
- Eleanor Voss: sensitive items: key found in possession
- Dr. Mallory Finch: sensitive items: alibi unverified
- Captain Ivor Hale: sensitive items: no solid alibi
...
Create 2 red herrings that support the false assumption: "Eleanor Voss could not have committed the murder because she was busy entertaining guests."
