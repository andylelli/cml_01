...
- Project ID: `unknown`
- Timestamp: `2026-05-23T02:47:32.842Z`
...
2. Generate a clue that provides evidence for: "Since the clock is found to show the incorrect time, the timeline of events is suspect...."
   → contradiction | essential | early | temporal | step 1 | terms: since, clock, found

3. Generate a clue that makes the reader directly observe: "The clock face has an unusual scratch indicating tampering...."
   → observation | essential | early | temporal | step 2 | terms: clock, unusual, scratch

4. Generate a clue that provides evidence for: "The scratch on the clock suggests that it was manipulated recently...."
   → contradiction | essential | early | temporal | step 2 | terms: scratch, clock, suggests

5. Generate a clue that makes the reader directly observe: "Witness statements conflict regarding the timeline of events surrounding the murder...."
   → observation | essential | mid | temporal | step 3 | terms: witness, statements, conflict

6. Generate a clue that provides evidence for: "The discrepancies in witness statements indicate potential deceit about their whereabouts...."
   → contradiction | essential | mid | testimonial | step 3 | terms: discrepancies, witness, statements

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "Since the clock is found to show the incorrect time, the timeline of events is suspect...."
   → contradiction | essential | mid | temporal | step 1 | terms: since, clock, found

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The mechanical clock in the manor's study was wound back to create a false alibi for the murderer...."
   → observation | essential | early | temporal | terms: mechanical, clock, manor's
...
10. Generate one essential mid-story clue whose description or pointsTo explicitly names Eleanor Voss and states the unique trace, preparation detail, or mechanism link that points to Eleanor Voss rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Eleanor Voss, mechanical, clock, manor's
...
Create 2 red herrings that support the false assumption: "The victim was killed after the clock showed ten minutes past eleven."
...
Violations: 1. [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 1, 2; words: clock, timeline) and may support the true solution.; 2. [critical] Red Herring Separation: Red herring rh_2 overlaps inference corrections (steps: 1, 2; words: clock, suspect) and may support the true solution.
Warnings: None
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 1, 2; words: clock, timeline) and may support the true solution.
  - [critical] Red Herring Separation: Red herring rh_2 overlaps inference corrections (steps: 1, 2; words: clock, suspect) and may support the true solution.
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
