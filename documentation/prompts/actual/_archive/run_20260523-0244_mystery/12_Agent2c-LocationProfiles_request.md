...
- Project ID: ``
- Timestamp: `2026-05-23T02:49:43.053Z`
...
- Era-authentic markers: petrol touring cars on county roads, domestic wiring with frequent outages, typewriters standard in offices, reliable automobiles for local travel, passenger trains at peak usage, early commercial aviation for long distances, party-line telephone exchanges, telegrams sent via local post offices
- Tone: Classic
- No anachronisms
...
Description: A sprawling country estate with multiple wings, extensive gardens, and a large central hall, featuring both grand and utilitarian spaces.
...
Setting constraints:
- Physical constraints: multiple locked rooms restricting access to certain areas, wide gardens providing natural barriers and places to hide evidence, narrow staircases limiting movement of larger groups
...
- Social norms: Great Depression causing economic strain and class tensions, increased social stratification in estates
