...
- Project ID: ``
- Timestamp: `2026-05-16T09:24:49.273Z`
...
**Setting**: 1930s - A sprawling country estate with a grand facade, extensive gardens, and a formal ballroom, embodying the wealth of its owners.
**Crime Type**: Murder
**Social Context**: impact of the Great Depression, class tensions heightened, growing fascist sentiments in Europe
**Tone**: Classic
