...
- Project ID: ``
- Timestamp: `2026-05-16T09:28:32.731Z`
...
• [clue_mechanism_visibility_core] The ballroom clock was set back to mislead suspects about the time of the murder.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: This reveals the mechanism of how the clock was manipulated.
...
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the ballroom of the Voss estate". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.

PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=5060; context=10158; dropped=[none]; truncated=[location_profiles, temporal_context]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The ballroom clock was set back to mislead suspects about the time of the murder. [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: This reveals the mechanism of how the clock was manipulated.
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The ballroom clock, stopped at ten minutes past eleven."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor stands at the window, staring blankly, grief-stricken."
      ]
    },
    ...
    "emotionalRegister": "The initial atmosphere is one of opulence masked by tension.",
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 1: "The ballroom clock was set back to mislead suspects about the time of the murder." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
