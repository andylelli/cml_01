...
- Project ID: ``
- Timestamp: `2026-05-13T21:37:53.815Z`
...
• [clue_late_optional_slot_1] The garden entrance is located near the study, providing easy access.
  Category: spatial | Criticality: optional | Supports inference step 3
  Points to: This location detail is relevant to the timeline of events.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As they stood in silence, the weight of the moment pressed down on them. Beatrice's determination solidified. 'We need to gather everyone again,' she said, her resolve strengthening. 'We must confront them with this evidence and see how they react. Someone her..."
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=14096; context=10659; dropped=[none]; truncated=[location_profiles, temporal_context]
...
- Chapter 8:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As they stood in silence, the weight of the moment pressed down on them. Beatrice's determination solidified. 'We need to gather everyone again,' she said, her resolve strengthening. 'We must confront them with this evid...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The garden entrance is located near the study, providing easy access. [clue_late_optional_slot_1]
      Points to: This location detail is relevant to the timeline of events.
...
Chapter 8 (Act 3) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Eleanor's name is cleared"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Eleanor cannot be implicated in her own murder."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Beatrice pauses, reflecting on Eleanor's tragic fate."
      ]
    },
    ...
    "permittedBehavioursByAct": [
      {
        ...
        "behaviour": "deceased and cannot be implicated"
      },
      {
    ...
    "emotionalRegister": "Tension peaks as the detective confronts suspects, unraveling the tightly woven web of lies.",
