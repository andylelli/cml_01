...
- Project ID: ``
- Timestamp: `2026-05-13T21:33:36.779Z`
...
- Era-authentic markers: petrol automobiles on gravel driveways, domestic telephones with party lines, typewriters in use for correspondence, reliable passenger automobiles, steam trains for intercity travel, early commercial aviation for long distances, telegrams for urgent messages, aerial mail services
- Tone: Classic
- No anachronisms
...
Description: A sprawling manor house surrounded by landscaped gardens and dense woodlands, typically hosting wealthy families.
...
Setting constraints:
- Physical constraints: layout restricts movement to main halls and staircases, gardens and woodlands provide areas for concealment, weather can impede outdoor investigations
- Geographic isolation: Located several miles from the nearest town, limiting immediate access to outside assistance.
- Access control: Restricted areas include private studies and servants' quarters, Daily routines create predictable patterns for staff and residents, Permissions required to access certain areas of the estate

Era constraints to include:
- Technology: petrol automobiles on gravel driveways, domestic telephones with party lines, typewriters in use for correspondence
- Transportation: reliable passenger automobiles, steam trains for intercity travel
- Social norms: Great Depression causing economic strain, rising class tensions among staff and owners
