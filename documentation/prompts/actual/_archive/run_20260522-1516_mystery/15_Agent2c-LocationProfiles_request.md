...
- Project ID: ``
- Timestamp: `2026-05-22T15:34:22.077Z`
...
- Era-authentic markers: petrol touring cars on county roads, domestic wiring with frequent outages, typewriters in use for correspondence, reliable passenger automobiles, peak usage of passenger trains, early commercial aviation for long distances, party-line telephone exchanges common, telegram services available via local offices
- Tone: Classic
- No anachronisms
...
Description: A large manor house set in expansive grounds, featuring formal gardens and a mix of architectural styles reflecting the wealth of its owners.
...
Setting constraints:
- Physical constraints: geographic layout restricts movement to main corridors and staircases, large grounds create barriers against quick outside assistance, weather can affect access to certain areas, especially during rain
- Geographic isolation: Moderately isolated, with nearest town several miles away, limiting outside help and resources.
- Access control: certain areas of the manor are off-limits to staff and guests, daily routines dictate movement patterns for residents, social hierarchy influences access to restricted areas
...
- Social norms: impact of the Great Depression affecting social interactions, class distinctions evident among manor residents
