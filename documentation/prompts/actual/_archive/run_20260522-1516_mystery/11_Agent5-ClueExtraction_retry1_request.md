...
- Project ID: `unknown`
- Timestamp: `2026-05-22T15:30:04.763Z`
...
2. Generate a clue that provides evidence for: "The clock must have been tampered with since it shouldn't be stuck...."
   → contradiction | essential | early | temporal | step 1 | terms: clock, tampered, since

3. Generate a clue that makes the reader directly observe: "Witnesses recall Eleanor was seen alive at ten minutes to eleven...."
   → observation | essential | early | temporal | step 2 | terms: witnesses, recall, eleanor

4. Generate a clue that provides evidence for: "This contradicts the notion that she died at eleven...."
   → contradiction | essential | early | testimonial | step 2 | terms: contradicts, notion, eleven.

5. Generate a clue that makes the reader directly observe: "A small scratch on the clock casing indicates tampering...."
   → observation | essential | mid | temporal | step 3 | terms: small, scratch, clock

6. Generate a clue that provides evidence for: "The clock's tampering must have been done recently...."
   → contradiction | essential | mid | temporal | step 3 | terms: clock's, tampering, recently.

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The clock must have been tampered with since it shouldn't be stuck...."
   → contradiction | essential | mid | temporal | step 1 | terms: clock, tampered, since

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "A mechanical clock was tampered with to alter the perceived time of death...."
   → observation | essential | early | temporal | terms: mechanical, clock, tampered

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Comparing the clock's condition with the maintenance log reveals discrepancies in the clock's recent..."
   → observation | essential | mid | temporal | terms: comparing, clock's, condition
...
11. Generate a clue showing observable evidence of Dr. Mallory Finch's premeditation or planning (Desire to protect her from her husband). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: desire, protect, husband
...
Create 2 red herrings that support the false assumption: "Eleanor Voss must have died just before the clock struck eleven."
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Red Herring Separation: Red herring rh_2 overlaps inference corrections (steps: 1, 2, 3; words: clock, eleven, tampering) and may support the true solution.
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
