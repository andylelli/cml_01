...
- Project ID: ``
- Timestamp: `2026-05-20T22:31:08.345Z`
...
- Era-authentic markers: petrol touring cars on country roads, domestic telephone systems with party lines, typewriters for correspondence, reliable automobiles for local travel, passenger trains as the primary long-distance option, early commercial flights for quick travel, telegrams for urgent messages sent from local offices, aerial mail services for faster delivery
- Tone: Classic
...
Description: A sprawling manor house with grand architecture, surrounded by extensive gardens and woodlands, isolated from the nearest town.
...
Setting constraints:
- Physical constraints: Multiple floors with restricted access to certain wings, Gardens and woods providing natural barriers and hiding places, Weather can affect access and visibility in outdoor areas
...
- Technology: petrol touring cars on country roads, domestic telephone systems with party lines, typewriters for correspondence
- Transportation: reliable automobiles for local travel, passenger trains as the primary long-distance option
- Social norms: Great Depression creating economic hardship and class tensions, rising fascism influencing political discussions
