...
- Project ID: ``
- Timestamp: `2026-05-20T22:38:48.855Z`
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=13649; context=10989; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
```text
Attempt 6/6 — chapters 9 — 1 validation issue(s) to resolve:

═══ PROSE QUALITY ERRORS (1) ═══
• Chapter 9 marked non-convergent after attempt 5/6: continuity
