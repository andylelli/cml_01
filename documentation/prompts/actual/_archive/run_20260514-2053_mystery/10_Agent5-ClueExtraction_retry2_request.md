...
- Project ID: `unknown`
- Timestamp: `2026-05-14T20:55:27.613Z`
...
2. Generate a clue that provides evidence for: "The clock's time does not match the witness accounts of Eleanor being alive at 10:50 AM...."
   → contradiction | essential | early | temporal | step 1 | terms: clock's, match, witness

3. Generate a clue that makes the reader directly observe: "A faint scratch is found on the clock casing...."
   → observation | essential | early | temporal | step 2 | terms: faint, scratch, found

4. Generate a clue that provides evidence for: "The scratch indicates recent tampering, suggesting the clock was manipulated...."
   → contradiction | essential | early | temporal | step 2 | terms: scratch, indicates, recent

5. Generate a clue that makes the reader directly observe: "Eleanor's watch shows a different time than the clock...."
   → observation | essential | mid | temporal | step 3 | terms: eleanor's, watch, shows

6. Generate a clue that provides evidence for: "Eleanor's watch indicates she was killed before the clock was tampered...."
   → contradiction | essential | mid | temporal | step 3 | terms: eleanor's, watch, indicates

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The clock's time does not match the witness accounts of Eleanor being alive at 10:50 AM...."
   → contradiction | essential | mid | temporal | step 1 | terms: clock's, match, witness

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The clock was wound back to create an alibi for Dr. Mallory Finch during the murder...."
   → observation | essential | early | temporal | terms: clock, wound, create

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "A controlled comparison of the clock's time against Eleanor's watch shows clear discrepancies, provi..."
...
Objects: The clock in the study, Eleanor's personal effects
...
- Captain Ivor Hale: sensitive items: business contracts
- Beatrice Quill: sensitive items: journalistic sources
...
Create 2 red herrings that support the false assumption: "Eleanor Voss died shortly after the clock indicated a specific time."
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 1, 2, 3; words: eleanor, clock) and may support the true solution.
  - [critical] Red Herring Separation: Red herring rh_2 overlaps inference corrections (steps: 1, 2, 3; words: eleanor, suggesting, clock) and may support the true solution.
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
