...
- Project ID: ``
- Timestamp: `2026-05-20T20:46:13.543Z`
...
- YOU MUST use the exact year and month specified above: November 1938
- This date has been specifically selected for THIS mystery to ensure uniqueness
- DO NOT change the year or month - use November 1938 exactly
...
- All details must be historically accurate for November 1938 specifically
- Generate fresh, original descriptions - do not copy example phrasing
- Make this feel like the specific moment of November 1938
...
- Technology available: petrol-powered automobiles on gravel driveways, early home telephones with party lines, typewriters standard in offices
- Forensics: fingerprinting standard practice for crime scenes, basic toxicology tests available, emerging techniques in ballistics analysis
- Social norms: Great Depression creating economic strain and class tensions, growing concerns over fascism and political unrest in Europe, strict social hierarchies influencing behavior and interactions

Task:
1. Use the specified date: November 1938
