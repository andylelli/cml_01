...
- Project ID: `unknown`
- Timestamp: `2026-05-20T20:44:20.297Z`
...
2. Generate a clue that provides evidence for: "The clock could have been tampered to show a false time...."
   → contradiction | essential | early | temporal | step 1 | terms: clock, tampered, false

3. Generate a clue that makes the reader directly observe: "Witnesses recall hearing an argument before the murder...."
   → observation | essential | early | temporal | step 2 | terms: witnesses, recall, hearing

4. Generate a clue that provides evidence for: "The argument must have occurred later than the time shown on the clock...."
   → contradiction | essential | early | temporal | step 2 | terms: argument, occurred, later

5. Generate a clue that makes the reader directly observe: "Footprints are found leading from the library to the garden...."
   → observation | essential | mid | physical | step 3 | terms: footprints, found, leading

6. Generate a clue that provides evidence for: "The footprints indicate someone left the library around the time of the argument...."
   → contradiction | essential | mid | temporal | step 3 | terms: footprints, indicate, someone

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The clock could have been tampered to show a false time...."
   → contradiction | essential | mid | temporal | step 1 | terms: clock, tampered, false

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The clock was tampered with to show a false time, misleading the timeline of events...."
   → observation | essential | early | temporal | terms: clock, tampered, false

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "A comparison of the clock's internal mechanism with witness statements about the argument timing rev..."
   → observation | essential | mid | temporal | terms: comparison, clock's, internal
...
10. Generate one essential mid-story clue whose description or pointsTo explicitly names Captain Ivor Hale and states the unique trace, preparation detail, or mechanism link that points to Captain Ivor Hale rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Captain Ivor Hale, clock, tampered, false
...
Create 2 red herrings that support the false assumption: "The murder happened when the clock showed ten minutes past eleven."
...
Violations: 1. [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 1, 2, 3; words: clock, library) and may support the true solution.; 2. [critical] Red Herring Separation: Red herring rh_2 overlaps inference corrections (steps: 1, 2, 3; words: clock, library) and may support the true solution.
Warnings: None
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 1, 2, 3; words: clock, library) and may support the true solution.
  - [critical] Red Herring Separation: Red herring rh_2 overlaps inference corrections (steps: 1, 2, 3; words: clock, library) and may support the true solution.
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
