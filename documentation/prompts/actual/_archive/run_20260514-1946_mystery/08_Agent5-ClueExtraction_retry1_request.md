...
- Project ID: `unknown`
- Timestamp: `2026-05-14T19:47:32.584Z`
...
1. Generate a clue that makes the reader directly observe: "The clock in the study shows ten minutes past eleven when Eleanor is found...."
   → observation | essential | early | temporal | step 1 | terms: clock, study, shows

2. Generate a clue that provides evidence for: "The clock's reading does not match witness accounts of when Eleanor was last seen...."
   → contradiction | essential | early | temporal | step 1 | terms: clock's, reading, match

3. Generate a clue that makes the reader directly observe: "A small scratch is found on the clock casing indicating tampering...."
   → observation | essential | early | temporal | step 2 | terms: small, scratch, found

4. Generate a clue that provides evidence for: "The scratch suggests the clock was adjusted recently...."
   → contradiction | essential | early | temporal | step 2 | terms: scratch, suggests, clock

5. Generate a clue that makes the reader directly observe: "Witnesses report hearing the chime before the clock indicated the time of death...."
   → observation | essential | mid | temporal | step 3 | terms: witnesses, report, hearing

6. Generate a clue that provides evidence for: "The conflicting account suggests the clock was tampered to mislead...."
   → contradiction | essential | mid | temporal | step 3 | terms: conflicting, account, suggests

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The clock's reading does not match witness accounts of when Eleanor was last seen...."
   → contradiction | essential | mid | temporal | step 1 | terms: clock's, reading, match

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "A mechanical clock was tampered with to indicate a time that misleads the investigation...."
   → observation | essential | early | temporal | terms: mechanical, clock, tampered

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Comparing the clock's scratch marks with tools found in Dr. Finch's medical kit reveals a match, pro..."
...
11. Generate a clue showing observable evidence of Dr. Mallory Finch's premeditation or planning (Jealousy over Eleanor's potential new relationship.). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
...
Create 2 red herrings that support the false assumption: "Eleanor must have been killed at the time the clock indicates."
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 1, 2, 3; words: reading, eleanor, clock) and may support the true solution.
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
...
- required_direct_culprit_clue:
  ...
  - allowed_source_paths=CASE.cast[1].access_plausibility, CASE.cast[1].alibi_window, CASE.inference_path.steps[1].observation, CASE.inference_path.steps[1].correction
