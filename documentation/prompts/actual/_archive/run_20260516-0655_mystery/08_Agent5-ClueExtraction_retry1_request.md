...
- Project ID: `unknown`
- Timestamp: `2026-05-16T06:56:58.816Z`
...
1. Generate a clue that makes the reader directly observe: "The clock in Eleanor's bedroom shows ten minutes past eleven...."
   → observation | essential | early | temporal | step 1 | terms: clock, eleanor's, bedroom

2. Generate a clue that provides evidence for: "The clock's displayed time suggests the murder occurred at that time...."
   → contradiction | essential | early | temporal | step 1 | terms: clock's, displayed, suggests

3. Generate a clue that makes the reader directly observe: "The clock's mechanism has distinct winding marks...."
   → observation | essential | early | temporal | step 2 | terms: clock's, mechanism, distinct

4. Generate a clue that provides evidence for: "The marks indicate recent tampering, altering the clock's time...."
   → contradiction | essential | early | temporal | step 2 | terms: marks, indicate, recent

5. Generate a clue that makes the reader directly observe: "A note found in Eleanor's pocket discusses an important meeting at quarter past eleven...."
   → observation | essential | mid | testimonial | step 3 | terms: found, eleanor's, pocket

6. Generate a clue that provides evidence for: "The note indicates Eleanor was expecting to meet someone shortly after the displayed time...."
   → contradiction | essential | mid | temporal | step 3 | terms: indicates, eleanor, expecting

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The clock's displayed time suggests the murder occurred at that time...."
   → contradiction | essential | mid | temporal | step 1 | terms: clock's, displayed, suggests
...
9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "The discriminating test compares clock, tamper, and bedroom against the claimed timeline...."
...
11. Generate a clue showing observable evidence of Dr. Mallory Finch's premeditation or planning (Personal attachment). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: personal, attachment
...
Create 2 red herrings that support the false assumption: "Eleanor was killed after the clock showed ten minutes past eleven."
...
Violations: 1. [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 2, 3; words: tampering, eleanor) and may support the true solution.
Warnings: None
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 2, 3; words: tampering, eleanor) and may support the true solution.
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
