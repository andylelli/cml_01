...
- Project ID: ``
- Timestamp: `2026-05-20T17:36:51.104Z`
...
**Setting**: 1930s - A sprawling manor house set in a large estate, featuring multiple rooms, a grand hall, and extensive gardens, with restricted areas such as the study and cellar.
**Crime Type**: Murder
**Social Context**: impact of the Great Depression on social classes, increasing class tensions within society, fascist movements influencing political discourse
**Tone**: Classic
