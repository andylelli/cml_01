...
- Project ID: `unknown`
- Timestamp: `2026-05-20T17:38:16.798Z`
...
1. Generate a clue that makes the reader directly observe: "The mechanical clock in the study shows ten minutes past eleven when discovered...."
   → observation | essential | early | temporal | step 1 | terms: mechanical, clock, study

2. Generate a clue that provides evidence for: "The clock's reading does not match the time of death reported by witnesses...."
   → contradiction | essential | early | temporal | step 1 | terms: clock's, reading, match

3. Generate a clue that makes the reader directly observe: "Witness statements conflict regarding the last time they saw the victim...."
   → observation | essential | early | temporal | step 2 | terms: witness, statements, conflict

4. Generate a clue that provides evidence for: "This indicates that the victim was likely killed before the time reported by witnesses...."
   → contradiction | essential | early | temporal | step 2 | terms: indicates, victim, likely

5. Generate a clue that makes the reader directly observe: "A note found in the study references a meeting at ten-thirty that conflicts with the clock's reading..."
   → observation | essential | mid | temporal | step 3 | terms: found, study, references

6. Generate a clue that provides evidence for: "The note suggests the victim had an appointment that was supposed to occur after the time the clock ..."
   → contradiction | essential | mid | temporal | step 3 | terms: suggests, victim, appointment

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The clock's reading does not match the time of death reported by witnesses...."
   → contradiction | essential | mid | temporal | step 1 | terms: clock's, reading, match

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The mechanical clock was wound back to create a false timeline...."
   → observation | essential | early | temporal | terms: mechanical, clock, wound

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Comparing the clock's tampering with Eleanor's known financial troubles reveals her motive and oppor..."
...
10. Generate one essential mid-story clue whose description or pointsTo explicitly names Eleanor Voss and states the unique trace, preparation detail, or mechanism link that points to Eleanor Voss rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Eleanor Voss, mechanical, clock, wound
...
Objects: Mechanical clock, Victim's diary

## Physical Evidence
- Fingerprints on the clock face.

## Evidence-Sensitive Characters
- Eleanor Voss: sensitive items: Financial records
- Dr. Mallory Finch: sensitive items: Medical records
- Captain Ivor Hale: sensitive items: Military records
- Beatrice Quill: sensitive items: Investigation notes
...
Create 2 red herrings that support the false assumption: "The victim's time of death must coincide with the clock's last visible reading."
...
- required_direct_culprit_clue:
  ...
  - allowed_source_paths=CASE.cast[0].access_plausibility, CASE.cast[0].alibi_window, CASE.cast[0].evidence_sensitivity[0], CASE.inference_path.steps[2].observation, CASE.inference_path.steps[2].correction
