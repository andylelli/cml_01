...
- Project ID: ``
- Timestamp: `2026-05-20T17:42:00.888Z`
...
The tension rises as secrets begin to unravel, revealing the precarious nature of each character's circumstances.
...
Rationale: The gravity of the murder investigation does not allow for humor.
...
Act 1 behaviour contract: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "The recent shift in the victim's attitude, which threatened her promised patronage, ignited feelings of betrayal and anger, pushing Beatrice to consider the unthinkable." — do not surface in Act I.
...
• [clue_1] Witness statements conflict regarding the last time they saw the victim.
  Category: temporal | Criticality: essential | Supports inference step 2
  Points to: Conflicting witness accounts create uncertainty in the timeline.

• [clue_2] This indicates that the victim was likely killed before the time reported by witnesses.
  Category: temporal | Criticality: essential | Supports inference step 2
  Points to: The timeline of the murder is called into question.
...
• Evidence in reader's hands: The mechanical clock in the study shows ten minutes past eleven when discovered. | The clock's reading does not match the time of death reported by witnesses.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the rain continued to fall outside, Beatrice felt a sense of urgency building within her. They were caught in a tangled web of lies and half-truths, and the truth was lurking just out of reach. "We must wait for the detective to arrive. She will know how to..."
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=7912; context=10723; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 3:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the rain continued to fall outside, Beatrice felt a sense of urgency building within her. They were caught in a tangled web of lies and half-truths, and the truth was lurking just out of reach. "We must wait for the d...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • Witness statements conflict regarding the last time they saw the victim. [clue_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: Conflicting witness accounts create uncertainty in the timeline.
    ...
    • This indicates that the victim was likely killed before the time reported by witnesses. [clue_2] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: The timeline of the murder is called into question.
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
  ...
  - Sensory obligation — use at least two of: The glow of the fireplace, Shadows cast by the desk lamp | The quiet rustle of papers, Footsteps echoing outside | The rich aroma of pipe tobacco. Mood: tense.
...
Chapter 3 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The note found in the study referencing the meeting at ten-thirty."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the victim had an appointment after the time shown on the clock, complicating the timeline."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor's hands tremble as she hands over the note, her eyes darting nervously."
      ]
    },
    ...
    "emotionalRegister": "The tension rises as secrets begin to unravel, revealing the precarious nature of each character's circumstances.",
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 3: "Witness statements conflict regarding the last time they saw the victim." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: "This indicates that the victim was likely killed before the time reported by witnesses." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
