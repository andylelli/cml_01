...
- Project ID: `unknown`
- Timestamp: `2026-05-13T20:39:59.161Z`
...
1. Generate a clue that makes the reader directly observe: "The clock displayed a time of ten minutes to eight...."
   → observation | essential | early | temporal | step 1 | terms: clock, displayed, minutes

2. Generate a clue that provides evidence for: "Eleanor could not have been alive after that time if she was found dead at 8:15...."
   → contradiction | essential | early | temporal | step 1 | terms: eleanor, alive, after

3. Generate a clue that makes the reader directly observe: "The clock hands were misaligned with the expected time...."
   → observation | essential | early | temporal | step 2 | terms: clock, hands, misaligned

4. Generate a clue that provides evidence for: "The clock was tampered with to suggest a later time than actual...."
   → contradiction | essential | early | temporal | step 2 | terms: clock, tampered, suggest

5. Generate a clue that makes the reader directly observe: "A note was found revealing the original time of an important meeting...."
   → observation | essential | mid | temporal | step 3 | terms: found, revealing, original

6. Generate a clue that provides evidence for: "The meeting time contradicts the clock's displayed time...."
   → contradiction | essential | mid | temporal | step 3 | terms: meeting, contradicts, clock's

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "Eleanor could not have been alive after that time if she was found dead at 8:15...."
   → contradiction | essential | mid | temporal | step 1 | terms: eleanor, alive, after

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The mechanism relies on clock, tamper, and display to expose the false timing...."
   → observation | essential | early | temporal | terms: mechanism, relies, clock,

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Comparing the clock's time with the noted meeting time reveals the tampering...."
   → observation | essential | mid | temporal | terms: comparing, clock's, noted
...
11. Generate a clue showing observable evidence of Captain Ivor Hale's premeditation or planning (Need to cover debts). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: cover, debts
...
Objects: The clock, Eleanor's room, Auction room
...
Create 2 red herrings that support the false assumption: "The murder occurred after the auction ended, making the timeline clear."
...
Violations: 1. [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 2; words: clock, actual) and may support the true solution.; 2. [critical] Red Herring Separation: Red herring rh_2 overlaps inference corrections (steps: 1, 2; words: eleanor, clock, tampered) and may support the true solution.
Warnings: None
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 2; words: clock, actual) and may support the true solution.
  - [critical] Red Herring Separation: Red herring rh_2 overlaps inference corrections (steps: 1, 2; words: eleanor, clock, tampered) and may support the true solution.
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
...
- required_id_to_source_mappings[]:
  ...
  - clue_early_2 -> CASE.prose_requirements.clue_to_scene_mapping[1].clue_id
  - clue_mid_1 -> CASE.prose_requirements.clue_to_scene_mapping[2].clue_id
