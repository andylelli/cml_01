...
- Project ID: ``
- Timestamp: `2026-05-11T17:03:11.457Z`
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=12245; context=9855; dropped=[none]; truncated=[location_profiles, temporal_context]
...
- Chapter 7: Chapter 7 contains instruction-shaped prose (prompt leakage) (Remove imperative instructions — these read like prompt directives, not narrative prose)
