...
- Project ID: ``
- Timestamp: `2026-05-12T20:04:32.100Z`
...
**Setting**: 1930s - A grand manor house set on sprawling grounds with gardens, stables, and limited access points.
**Crime Type**: Murder
**Social Context**: Great Depression causing economic strain, class tensions evident in social interactions, rise of fascism influencing political discussions
**Tone**: Classic
