...
- Project ID: ``
- Timestamp: `2026-05-12T20:06:55.272Z`
...
- Era-authentic markers: petrol touring cars on county roads, domestic telephones with party lines, typewriters standard in offices, reliable automobiles for local travel, passenger trains connecting major cities, early commercial flights for longer distances, telegrams sent from local telegraph offices, aerogrammes for international correspondence
- Tone: Classic
- No anachronisms
...
Description: A grand manor house set on sprawling grounds with gardens, stables, and limited access points.
...
Setting constraints:
- Physical constraints: manor layout restricts movement between floors, gardens and hedgerows create natural barriers, weather conditions affect outdoor access and visibility
- Geographic isolation: Relatively isolated, requiring at least a 30-minute drive to the nearest town.
- Access control: restricted areas like the library and cellar, scheduled access for staff and guests, protocols for entering and exiting the estate

Era constraints to include:
- Technology: petrol touring cars on county roads, domestic telephones with party lines, typewriters standard in offices
- Transportation: reliable automobiles for local travel, passenger trains connecting major cities
- Social norms: Great Depression causing economic strain, class tensions evident in social interactions
