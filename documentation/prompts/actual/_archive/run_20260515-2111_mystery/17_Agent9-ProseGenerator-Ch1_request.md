...
- Project ID: ``
- Timestamp: `2026-05-15T21:15:59.159Z`
...
• [clue_mechanism_visibility_core] The clock in the study shows the hands stuck at ten minutes past eleven.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: The clock's time is not accurate.
...
Known location profile anchors: Little Middleton Manor, The Library, The Drawing Room, The Servants' Hall, the scene
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The Library", "The Drawing Room", "The Servants' Hall", "the scene"
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=5005; context=10208; dropped=[none]; truncated=[location_profiles, temporal_context]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The clock in the study shows the hands stuck at ten minutes past eleven. [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: The clock's time is not accurate.
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The stopped clock in the study, its hands frozen at ten minutes past eleven."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the victim died no later than eleven past eleven."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor gazes at the clock, her expression a mix of grief and anxiety."
      ]
    },
    "summary": "The morning after the murder, the household is tense as the captain Hale arrives to investigate. The body of the victim is found in the study, and the clock shows ten minutes past eleven, hinting at the time of death.",
    ...
    "emotionalRegister": "The initial atmosphere is one of elegance, abruptly disrupted by the shocking crime.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 1: "The clock in the study shows the hands stuck at ten minutes past eleven." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
