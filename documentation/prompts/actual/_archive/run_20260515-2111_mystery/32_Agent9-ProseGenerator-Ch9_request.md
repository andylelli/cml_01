...
- Project ID: ``
- Timestamp: `2026-05-15T21:18:59.034Z`
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=14897; context=10690; dropped=[none]; truncated=[location_profiles, temporal_context]
...
13. RETRY MITIGATION: Strict obligation mode is active. Every required clue must be surfaced with concrete, observable prose before any deduction beat.
14. RETRY MITIGATION: Prioritize chronology and identity coherence over stylistic variation for this retry.
