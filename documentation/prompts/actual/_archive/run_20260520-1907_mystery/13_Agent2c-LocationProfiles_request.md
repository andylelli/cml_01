...
- Project ID: ``
- Timestamp: `2026-05-20T19:10:18.396Z`
...
- Era-authentic markers: petrol touring cars on country roads, domestic wiring with frequent outages, typewriters in use for correspondence, reliable automobiles for local travel, passenger trains as primary long-distance transport, early commercial air travel for distant journeys, party-line telephone exchanges in rural areas, telegrams sent via the nearest town
- Tone: Classic
- No anachronisms
...
Description: A large, sprawling country estate featuring traditional English architecture, with multiple wings, expansive gardens, and a central courtyard.
...
Setting constraints:
- Physical constraints: walled gardens limiting movement, multiple floors creating access challenges, weather-dependent access to outdoor areas
- Geographic isolation: Located several miles from the nearest town, limiting immediate outside assistance.
- Access control: guarded entrances with limited access permissions, restricted areas such as the library and study, daily routines dictating movement through the estate

Era constraints to include:
- Technology: petrol touring cars on country roads, domestic wiring with frequent outages, typewriters in use for correspondence
- Transportation: reliable automobiles for local travel, passenger trains as primary long-distance transport
- Social norms: Great Depression causing economic strain, class tensions manifesting in social interactions
