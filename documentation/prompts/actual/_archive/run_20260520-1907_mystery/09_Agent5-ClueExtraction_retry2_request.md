...
- Project ID: `unknown`
- Timestamp: `2026-05-20T19:09:17.459Z`
...
1. Generate a clue that makes the reader directly observe: "The clock in the study shows ten minutes past eleven when discovered...."
   → observation | essential | early | temporal | step 1 | terms: clock, study, shows

2. Generate a clue that provides evidence for: "The clock was wound back to mislead everyone about the time...."
   → contradiction | essential | early | temporal | step 1 | terms: clock, wound, mislead

3. Generate a clue that makes the reader directly observe: "An empty bottle of sleeping draught is found in the victim's room...."
   → observation | essential | early | spatial | step 2 | terms: empty, bottle, sleeping

4. Generate a clue that provides evidence for: "The sleeping draught indicates Finch was likely incapacitated before the murder...."
   → contradiction | essential | early | temporal | step 2 | terms: sleeping, draught, indicates

5. Generate a clue that makes the reader directly observe: "Witnesses mention hearing the clock ticking faintly during the evening...."
   → observation | essential | mid | temporal | step 3 | terms: witnesses, mention, hearing

6. Generate a clue that provides evidence for: "The ticking sound indicates the clock was operational despite being tampered with...."
   → contradiction | essential | mid | temporal | step 3 | terms: ticking, sound, indicates

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The clock was wound back to mislead everyone about the time...."
   → contradiction | essential | mid | temporal | step 1 | terms: clock, wound, mislead

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The mechanical clock in the study was wound back to create a false timeline for the murder...."
   → observation | essential | early | temporal | terms: mechanical, clock, study

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Captain Hale is confronted with the discrepancies in the clock's timing and the witness accounts, fo..."
   → observation | essential | mid | temporal | terms: captain, confronted, discrepancies
...
10. Generate one essential mid-story clue whose description or pointsTo explicitly names Captain Ivor Hale and states the unique trace, preparation detail, or mechanism link that points to Captain Ivor Hale rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Captain Ivor Hale, mechanical, clock, study
...
Create 2 red herrings that support the false assumption: "Dr. Mallory Finch's murder occurred shortly after the guests were last seen together."
...
Violations: 1. [critical] Suspect Clue Coverage: Eleanor Voss is not referenced in any clue.; 2. [critical] Suspect Clue Coverage: Beatrice Quill is not referenced in any clue.
Warnings: None
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Suspect Clue Coverage: Eleanor Voss is not referenced in any clue.
...
- required_id_to_source_mappings[]:
  ...
  - clue_early_1 -> CASE.prose_requirements.clue_to_scene_mapping[0].clue_id
  - clue_mid_1 -> CASE.prose_requirements.clue_to_scene_mapping[1].clue_id
  - clue_late_1 -> CASE.prose_requirements.clue_to_scene_mapping[2].clue_id
