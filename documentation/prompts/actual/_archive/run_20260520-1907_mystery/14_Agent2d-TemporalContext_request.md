...
- Project ID: ``
- Timestamp: `2026-05-20T19:10:58.623Z`
...
- YOU MUST use the exact year and month specified above: February 1933
- This date has been specifically selected for THIS mystery to ensure uniqueness
- DO NOT change the year or month - use February 1933 exactly
...
- All details must be historically accurate for February 1933 specifically
- Generate fresh, original descriptions - do not copy example phrasing
- Make this feel like the specific moment of February 1933
- OPTIONAL FIELD DEPTH REQUIREMENT: `fashion` and `seasonalActivities` must be specific and non-generic.
  ...
  - Include at least 3 seasonal activities tied to February and this location.
...
- Technology available: petrol touring cars on country roads, domestic wiring with frequent outages, typewriters in use for correspondence
- Forensics: fingerprinting standard for crime scenes, basic toxicology tests available, emerging ballistics analysis techniques
- Social norms: Great Depression causing economic strain, class tensions manifesting in social interactions, growing concerns over fascism in Europe influencing local politics

Task:
1. Use the specified date: February 1933
2. Provide seasonal context for February (weather, holidays, activities appropriate for this specific month)
