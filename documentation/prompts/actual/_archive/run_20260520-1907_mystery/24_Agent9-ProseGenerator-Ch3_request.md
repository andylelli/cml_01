...
- Project ID: ``
- Timestamp: `2026-05-20T19:13:59.505Z`
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=8058; context=10909; dropped=[none]; truncated=[temporal_context, pronoun_accuracy]
...
```text
Attempt 6/6 — chapters 3 — 1 validation issue(s) to resolve:

═══ PROSE QUALITY ERRORS (1) ═══
• Chapter 3 marked non-convergent after attempt 5/6: continuity
