...
- Project ID: ``
- Timestamp: `2026-05-14T19:37:01.404Z`
...
**Setting**: 1930s - An expansive manor house with multiple wings, gardens, and a large surrounding estate, designed for wealthy landowners.
**Crime Type**: Murder
**Social Context**: impact of the Great Depression on social classes, rising tensions due to fascism in Europe, strict adherence to social hierarchy in estates
**Tone**: Classic
