...
- Project ID: `unknown`
- Timestamp: `2026-05-13T18:48:09.095Z`
...
1. Generate a clue that makes the reader directly observe: "The clock in the study shows it was stopped at ten minutes past eleven...."
   → observation | essential | early | temporal | step 1 | terms: clock, study, shows

2. Generate a clue that provides evidence for: "The clock's stopped time does not match witness accounts of the time of death...."
   → contradiction | essential | early | temporal | step 1 | terms: clock's, stopped, match

3. Generate a clue that makes the reader directly observe: "Witnesses recall the clock striking the hour at an odd time...."
   → observation | essential | early | temporal | step 2 | terms: witnesses, recall, clock

4. Generate a clue that provides evidence for: "The inconsistency in the clock's striking times suggests tampering...."
   → contradiction | essential | early | temporal | step 2 | terms: inconsistency, clock's, striking

5. Generate a clue that makes the reader directly observe: "Dr. Mallory Finch was seen near the clock shortly before Eleanor's death...."
   → observation | essential | mid | temporal | step 3 | terms: mallory, finch, clock

6. Generate a clue that provides evidence for: "The proximity to the clock raises suspicion about their involvement...."
   → contradiction | essential | mid | temporal | step 3 | terms: proximity, clock, raises

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The clock's stopped time does not match witness accounts of the time of death...."
   → contradiction | essential | mid | temporal | step 1 | terms: clock's, stopped, match

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The clock was deliberately wound back to create a false timeline of events...."
...
10. Generate one essential mid-story clue whose description or pointsTo explicitly names Dr. Mallory Finch and states the unique trace, preparation detail, or mechanism link that points to Dr. Mallory Finch rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Dr. Mallory Finch, clock, deliberately, wound

11. Generate a clue showing observable evidence of Dr. Mallory Finch's premeditation or planning (Desire to protect reputation). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
...
- Eleanor Voss: sensitive items: clock details, guest lists
- Dr. Mallory Finch: sensitive items: medical records, guest lists
- Captain Ivor Hale: sensitive items: gambling records, guest lists
- Beatrice Quill: sensitive items: investigation details, guest lists
...
Create 2 red herrings that support the false assumption: "Eleanor's death must align with the last time the clock struck."
...
Violations: 1. [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 2, 3; words: tampering, clock) and may support the true solution.
Warnings: None
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 2, 3; words: tampering, clock) and may support the true solution.
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
