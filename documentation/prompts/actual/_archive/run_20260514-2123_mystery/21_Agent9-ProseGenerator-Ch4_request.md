...
- Project ID: ``
- Timestamp: `2026-05-14T21:28:15.511Z`
...
• [clue_1] The clock in the dining room shows ten minutes past eleven.
  Category: temporal | Criticality: essential | Supports inference step 2
  Points to: This indicates the time of Eleanor's death.

• [clue_4] Beatrice Quill stated she was with Eleanor until ten o'clock.
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: This supports her alibi and eliminates her as a suspect.

• [clue_fp_contradiction_step_3] A faint scratch on the clock's winding mechanism is discovered.
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: This suggests recent tampering, likely done by someone with access.
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_5 — do not reveal these as new information.

CONTINUITY HANDOFF — previous chapter closing beat:
  • "Dr. Finch's voice broke through his thoughts. "We must remain calm and collected," he urged, his tone steady despite the chaos around them. "We cannot let panic take over. We need to figure out what happened here, and fast." Eleanor nodded, but her mind was ra..."
...
Known location profile anchors: Middleton Manor, The Library, The Servants' Hall, The Drawing Room, the library
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Middleton Manor", "The Library", "The Servants' Hall", "The Drawing Room", "the library"
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=9256; context=10093; dropped=[none]; truncated=[location_profiles, temporal_context]
...
- Chapter 4:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Dr. Finch's voice broke through his thoughts. "We must remain calm and collected," he urged, his tone steady despite the chaos around them. "We cannot let panic take over. We need to figure out what happened here, and fa...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The clock in the dining room shows ten minutes past eleven. [clue_1]
      Points to: This indicates the time of Eleanor's death.
    • Beatrice Quill stated she was with Eleanor until ten o'clock. [clue_4]
      Points to: This supports her alibi and eliminates her as a suspect.
    • A faint scratch on the clock's winding mechanism is discovered. [clue_fp_contradiction_step_3]
      Points to: This suggests recent tampering, likely done by someone with access.
  - Tonal contrast: include at least one beat of relief or ironic counterpoint. Do not sustain maximum tension for every paragraph.
  - Sensory obligation — use at least two of: Raindrops cling to the windowpanes, distorting the view of the garden beyond, while the grey light casts a somber hue over the room., A single candle flickers on the desk, its flame dancing in the damp air, illuminating dust motes swirling lazily. | The rhythmic patter of rain against the roof creates a soothing backdrop, almost lulling the room into a false sense of security., A distant clock chimes the hour, its sound echoing through the stillness, a reminder of the passing time. | The scent of wet earth permeates the air, mixing with the musty aroma of the books, creating an atmosphere that feels both ancient and alive.. Mood: oppressive.
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Dr. Finch's recollection of the clock's time during dinner"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Dr. Finch was near the clock, raising doubts about his innocence."
...
[
  {
    "sceneNumber": 4,
    "act": 2,
    "title": "Questioning the Witness",
    "setting": {
      "location": "the library",
      "timeOfDay": "Next morning",
      "atmosphere": "Quiet yet charged with anticipation"
    },
    "characters": [
      "Eleanor Voss",
      "Dr. Mallory Finch"
    ],
    "purpose": "Delve into Dr. Finch's perspective and timeline",
    "cluesRevealed": [
      "clue_1",
      "clue_4",
    ...
    "dramaticElements": {
      ...
      "tension": "Dr. Finch's evasiveness raises suspicion",
      "microMomentBeats": [
        "Dr. Finch's hands tremble slightly as he recalls the night."
      ]
    },
    "summary": "Eleanor interviews Dr. Finch in the library, seeking clarity on his whereabouts during the murder. His nervous demeanor and vague responses raise questions about his involvement.",
    "estimatedWordCount": 1800,
    "pivotElement": "Dr. Finch's recollection of the clock's time during dinner",
    "factEstablished": "Establishes that Dr. Finch was near the clock, raising doubts about his innocence.",
    ...
    "emotionalRegister": "Initial clues suggest a simple timeline, but contradictions arise.",
    ...
    "locationRegisterNote": "The library is a somber refuge, its shadows concealing secrets and whispers of betrayal, creating a sense of unease that lingers in the air. — A writer entering this space should feel the tension, as if the very walls are listening for the truth."
  }
]
```
