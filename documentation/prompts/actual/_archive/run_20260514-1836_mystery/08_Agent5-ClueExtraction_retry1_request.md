...
- Project ID: `unknown`
- Timestamp: `2026-05-14T18:37:25.663Z`
...
1. Generate a clue that makes the reader directly observe: "The clock in the study stopped at ten minutes past eleven, and witnesses heard the victim mention an..."
   → observation | essential | early | temporal | step 1 | terms: clock, study, stopped

2. Generate a clue that provides evidence for: "The murder could not have happened after the clock stopped...."
   → contradiction | essential | early | temporal | step 1 | terms: murder, happened, after

3. Generate a clue that makes the reader directly observe: "The shadows cast by the sun indicate that the clock must have been wound back...."
   → observation | essential | early | temporal | step 2 | terms: shadows, indicate, clock

4. Generate a clue that provides evidence for: "The time indicated by the clock is inaccurate due to tampering...."
   → contradiction | essential | early | temporal | step 2 | terms: indicated, clock, inaccurate

5. Generate a clue that makes the reader directly observe: "The clock mechanism shows signs of tampering with fresh tool marks...."
   → observation | essential | mid | temporal | step 3 | terms: clock, mechanism, shows

6. Generate a clue that provides evidence for: "This indicates that someone adjusted the clock to mislead the timeline...."
   → contradiction | essential | mid | temporal | step 3 | terms: indicates, someone, adjusted

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The murder could not have happened after the clock stopped...."
   → contradiction | essential | mid | temporal | step 1 | terms: murder, happened, after

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "A mechanical clock was tampered with to mislead the timeline of the murder...."
   → observation | essential | early | temporal | terms: mechanical, clock, tampered

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Comparing the tampered clock with the schedule of appointments reveals inconsistencies that can only..."
   → observation | essential | mid | temporal | terms: comparing, tampered, clock
...
10. Generate one essential mid-story clue whose description or pointsTo explicitly names Captain Ivor Hale and states the unique trace, preparation detail, or mechanism link that points to Captain Ivor Hale rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Captain Ivor Hale, mechanical, clock, tampered

11. Generate a clue showing observable evidence of Captain Ivor Hale's premeditation or planning (Desire to cover gambling debts.). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: desire, cover, gambling
...
- Eleanor Voss: sensitive items: confidential witness statements, private conversations
- Dr. Mallory Finch: sensitive items: medical records, financial documents
- Captain Ivor Hale: sensitive items: gambling records, witness statements
- Beatrice Quill: sensitive items: family correspondence, guest log
...
Create 2 red herrings that support the false assumption: "The murder occurred after the clock stopped at ten minutes past eleven."
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 1, 2, 3; words: clock, stopped) and may support the true solution.
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
