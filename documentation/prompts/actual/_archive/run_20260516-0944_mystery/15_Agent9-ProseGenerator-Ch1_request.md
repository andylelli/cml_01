...
- Project ID: ``
- Timestamp: `2026-05-16T09:48:14.793Z`
...
• [clue_mechanism_visibility_core] A mechanical clock was tampered with to create an alibi for the murder, causing a chandelier to fall at a precisely timed moment.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: This reveals the core mechanism of the murder setup.
...
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the grand hall of the Quill estate". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.

PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=5274; context=10649; dropped=[none]; truncated=[pronoun_accuracy, location_profiles, temporal_context]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • A mechanical clock was tampered with to create an alibi for the murder, causing a chandelier to fall at a precisely timed moment. [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: This reveals the core mechanism of the murder setup.
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The chandelier lying shattered on the floor, with a thin wire nearby."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the chandelier was tampered with, indicating foul play rather than an accident."
...
[
  {
    ...
    "dramaticElements": {
      "conflict": "The tension of the aftermath of the chandelier incident hangs heavy.",
      "tension": "Each character's nervousness suggests they might be hiding something.",
      "microMomentBeats": [
        "Eleanor glances at the chandelier, feeling a chill despite the morning sun."
      ]
    },
    "summary": "The morning after the party, Eleanor Voss arrives at the Quill estate to discover the aftermath of the chandelier fall that killed an unknown victim. The remaining guests, including Beatrice Quill, the doctor Finch, and the captain Hale, are in shock, and Eleanor senses the underlying tension among them.",
    "estimatedWordCount": 1800,
    "pivotElement": "The chandelier lying shattered on the floor, with a thin wire nearby.",
    "factEstablished": "Establishes the chandelier was tampered with, indicating foul play rather than an accident.",
    ...
    "emotionalRegister": "The initial atmosphere is one of unease disguised by opulence.",
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 1: "A mechanical clock was tampered with to create an alibi for the murder, causing a chandelier to fall at a precisely timed moment." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
