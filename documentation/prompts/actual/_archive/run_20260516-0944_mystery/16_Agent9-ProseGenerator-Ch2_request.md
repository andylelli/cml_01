...
- Project ID: ``
- Timestamp: `2026-05-16T09:48:24.077Z`
...
The initial atmosphere is one of unease disguised by opulence.
...
Rationale: Eleanor's dry wit adds depth to the tension without undermining the gravity of the situation.
...
• [clue_core_contradiction_chain] This indicates premeditated tampering rather than an accident.
  Category: testimonial | Criticality: essential | Supports inference step 1
  Points to: This contradicts the assumption that the chandelier fell accidentally.
...
• Evidence in reader's hands: A mechanical clock was tampered with to create an alibi for the murder, causing a chandelier to fall at a precisely timed moment.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Dr. Finch cleared his throat, drawing Eleanor's attention back to him. "We should consider the timeline of events leading up to the chandelier's spring. If we can establish when the clock was tampered with, it may lead us to the perpetrator." Her voice was ste..."
...
Known location profile anchors: Little Middleton Manor, The Library, The Drawing Room, The Study, the drawing room of the Quill estate
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The Library", "The Drawing Room", "The Study", "the drawing room of the Quill estate"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 2: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with spoken dialogue — e.g. '"[words]," [Name] said/asked/replied/murmured.' The opening quote must be the first character on the line. Anchor opening in "the drawing room of the Quill estate". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=6867; context=11309; dropped=[none]; truncated=[pronoun_accuracy, location_profiles, temporal_context]
...
- Chapter 2:
  ...
  - Scene setting: the drawing room of the Quill estate — do NOT open with the location name or a location-description phrase. Ground the setting through character action or sensory detail, not a location-first sentence.
  - Opening atmosphere (MANDATORY — validator enforced): the first paragraph MUST contain at least one of: rain / wind / fog / storm / mist / thunder / evening / morning / night / dawn / dusk / season / afternoon / midday / noon / midnight / twilight / sunrise / sunset / daylight / sunlight / overcast / cloudy / bright / dark. A chapter that omits all of these from its opening paragraph will be rejected.
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Dr. Finch cleared his throat, drawing Eleanor's attention back to him. "We should consider the timeline of events leading up to the chandelier's spring. If we can establish when the clock was tampered with, it may lead u...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • This indicates premeditated tampering rather than an accident. [clue_core_contradiction_chain] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: This contradicts the assumption that the chandelier fell accidentally.
  ...
  - Sensory obligation — use at least two of: The room is bathed in a flat, grey light that drains the color from the furnishings, amplifying the sense of unease among the guests., Shadows stretch across the floor, creating an unsettling atmosphere where every corner seems to hide a secret. | The silence is occasionally broken by the sound of a clock ticking, a reminder of the time slipping away as tensions rise., Soft whispers and nervous laughter fill the room, but there is an undercurrent of anxiety that permeates the air. | The scent of dust hangs in the air, a reminder of the long hours spent in this room, while the aroma of polished furniture adds an unsettling familiarity.. Mood: uneasy stillness.
...
Chapter 2 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "A broken clock on the mantle, its hands stuck at ten minutes past eleven."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes contradictions in the suspects' stories, suggesting premeditation."
...
[
  {
    ...
    "setting": {
      "location": "the drawing room of the Quill estate",
    ...
    "purpose": "Establish initial reactions and introduce the possibility of foul play.",
    "cluesRevealed": [
      "clue_core_contradiction_chain"
    ],
    "dramaticElements": {
      "conflict": "Suspicions arise as characters share their alibis.",
      "tension": "Each character's account of the night raises more questions than answers.",
      "microMomentBeats": [
        "Eleanor notices Beatrice's trembling hands, a sign of hidden distress."
      ]
    },
    "summary": "In the drawing room, the characters discuss the events of the previous night. Eleanor listens carefully as Beatrice, Dr. Finch, and Captain Hale recount their alibis, but inconsistencies begin to surface, hinting at deeper secrets.",
    "estimatedWordCount": 1800,
    "pivotElement": "A broken clock on the mantle, its hands stuck at ten minutes past eleven.",
    "factEstablished": "Establishes contradictions in the suspects' stories, suggesting premeditation.",
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 2: "This indicates premeditated tampering rather than an accident." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
