...
- Project ID: ``
- Timestamp: `2026-05-14T19:04:47.911Z`
...
• [clue_8] Captain Ivor Hale exhibited signs of desperation to resolve financial issues.
  Category: behavioral | Criticality: essential | Supports inference step 3
  Points to: This motive links him to the crime.
...
CLUES ALREADY REVEALED TO READER: clue_1, clue_2, clue_mechanism_visibility_core, clue_4, clue_core_contradiction_chain, clue_fp_contradiction_step_2, clue_core_elimination_chain, clue_3, clue_fp_contradiction_step_3, clue_5, clue_6, clue_7 — do not reveal these as new information.

CONTINUITY HANDOFF — previous chapter closing beat:
  • "Finally, Beatrice leaned back in her chair, her gaze steady on both women. "We need to work together to uncover the truth, or we risk losing everything we hold dear. Eleanor, Dr. Finch, I know this is difficult, but we must confront our fears if we are to find..."
...
Known location profile anchors: Ashcombe Manor, The Library, The Drawing Room, The Study, the garden
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Ashcombe Manor", "The Library", "The Drawing Room", "The Study", "the garden"
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=12859; context=11093; dropped=[none]; truncated=[location_profiles, temporal_context]
...
- Chapter 7:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Finally, Beatrice leaned back in her chair, her gaze steady on both women. "We need to work together to uncover the truth, or we risk losing everything we hold dear. Eleanor, Dr. Finch, I know this is difficult, but we m...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • Captain Ivor Hale exhibited signs of desperation to resolve financial issues. [clue_8]
      Points to: This motive links him to the crime.
...
Chapter 7 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Eleanor's desperate demeanor as she interacts with Hale"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the financial desperation underlying Eleanor's behavior, hinting at possible motives."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor's laughter rings hollow in the quiet night."
      ]
    },
