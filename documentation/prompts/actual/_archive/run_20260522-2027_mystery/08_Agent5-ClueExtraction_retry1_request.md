...
- Project ID: `unknown`
- Timestamp: `2026-05-22T20:30:38.420Z`
...
1. Generate a clue that makes the reader directly observe: "The clock in the study shows the hands stopped at ten minutes past eleven...."
   → observation | essential | early | temporal | step 1 | terms: clock, study, shows

2. Generate a clue that provides evidence for: "The clock was tampered with to mislead witnesses about the time of death...."
   → contradiction | essential | early | temporal | step 1 | terms: clock, tampered, mislead

3. Generate a clue that makes the reader directly observe: "Eleanor Voss claims she was in the library at 8:00 PM, but the clock shows a false time...."
   → observation | essential | early | temporal | step 2 | terms: eleanor, claims, library

4. Generate a clue that provides evidence for: "Eleanor's alibi is compromised by the tampered clock...."
   → contradiction | essential | early | temporal | step 2 | terms: eleanor's, alibi, compromised

5. Generate a clue that makes the reader directly observe: "Dr. Mallory Finch's medical records show she was present at the hospital until 8:30 PM...."
   → observation | essential | mid | testimonial | step 3 | terms: mallory, finch's, medical

6. Generate a clue that provides evidence for: "Dr. Finch cannot be the murderer if the murder occurred at 8:00 PM...."
   → contradiction | essential | mid | testimonial | step 3 | terms: finch, cannot, murderer

7. Generate a clue that makes the reader directly observe: "Captain Ivor Hale was seen entering the study just before dinner...."
   → observation | essential | mid | temporal | step 4 | terms: captain, entering, study

8. Generate a clue that provides evidence for: "His presence near the clock gives him access to tamper with it...."
   → contradiction | essential | mid | temporal | step 4 | terms: presence, clock, gives

9. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The clock was tampered with to mislead witnesses about the time of death...."
   → contradiction | essential | mid | temporal | step 1 | terms: clock, tampered, mislead

10. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The clock was wound back to mislead witnesses about the time of death...."
   → observation | essential | early | temporal | terms: clock, wound, mislead

11. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Comparing the clock's winding mechanism with the victim's watch shows they have been set differently..."
   → observation | essential | mid | temporal | terms: comparing, clock's, winding

12. Generate one essential mid-story clue whose description or pointsTo explicitly names Eleanor Voss and states the unique trace, preparation detail, or mechanism link that points to Eleanor Voss rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Eleanor Voss, clock, wound, mislead

13. Generate a clue showing observable evidence of Eleanor Voss's premeditation or planning (Financial gain). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
...
16. Generate one essential early or mid elimination clue that explicitly rules out Dr. Mallory Finch and narrows the solution toward culprit Eleanor Voss. The pointsTo text must start with "Eliminates Dr. Mallory Finch because ..." and cite corroborated evidence.
...
- Eleanor Voss: sensitive items: Alibi check
- Dr. Mallory Finch: sensitive items: Medical records
- Captain Ivor Hale: sensitive items: Loan documents
...
Create 2 red herrings that support the false assumption: "The murder occurred during dinner, as all witnesses clearly remember the clock striking eight."
...
Violations: 1. [critical] Inference Path Coverage: Discriminating test evidence_clues reference missing clue id(s): clue_1, clue_2
Warnings: Inference step 4 has no contradiction clue; Inference step 4 has clues but no contradiction/elimination evidence; 2 red herring(s) may accidentally support the true solution (rh_1, rh_2); 1 suspect(s) (Captain Ivor Hale) are referenced but lack elimination/alibi evidence
Recommendations: Every inference step needs at least one observation clue and one contradiction clue; Set supportsInferenceStep on every essential clue; Include at least one clue that explicitly contradicts the false assumption; Uncovered steps:; Strict first-attempt contracts are active: apply strict source whitelist and required ID->source mappings exactly.; If any strict contract cannot be satisfied, return status=fail with unresolved blockers in audit.invalidSourcePaths.; Do not defer strict mapping and direct culprit evidence requirements to retry mode.
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Inference Path Coverage: Discriminating test evidence_clues reference missing clue id(s): clue_1, clue_2
  - [warning] Inference step 4 has no contradiction clue
  - [warning] Inference step 4 has clues but no contradiction/elimination evidence
  - [warning] 2 red herring(s) may accidentally support the true solution (rh_1, rh_2)
  - [warning] 1 suspect(s) (Captain Ivor Hale) are referenced but lack elimination/alibi evidence
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
...
- required_step_coverage_floors[]:
  ...
  - step 4 | contradiction=true | mapped=true
...
- required_direct_culprit_clue:
  ...
  - allowed_source_paths=CASE.cast[0].access_plausibility, CASE.cast[0].alibi_window, CASE.cast[0].evidence_sensitivity[0], CASE.inference_path.steps[1].observation, CASE.inference_path.steps[1].correction
