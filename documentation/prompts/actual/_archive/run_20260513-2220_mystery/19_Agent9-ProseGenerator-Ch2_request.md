...
- Project ID: ``
- Timestamp: `2026-05-13T22:25:02.358Z`
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "With the detective's arrival, the atmosphere shifted once more, the weight of uncertainty giving way to a renewed sense of purpose. They were no longer just witnesses to a tragedy; they were participants in a quest for justice, each of them holding a piece of..."
...
Known location profile anchors: Little Middleton Manor, The Garden Fountain, The Manor Library, The Drawing Room, the dining room
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The Garden Fountain", "The Manor Library", "The Drawing Room", "the dining room"
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=6755; context=10300; dropped=[none]; truncated=[location_profiles, temporal_context]
...
- Chapter 2:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "With the detective's arrival, the atmosphere shifted once more, the weight of uncertainty giving way to a renewed sense of purpose. They were no longer just witnesses to a tragedy; they were participants in a quest for j...".
...
Chapter 2 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The conflicting accounts of the clock striking nine."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the timing of Eleanor's death does not match the clock's striking nine."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_2] Beatrice insists she heard the clock strike nine, creating doubt about the reliability of the timeline.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Dr. Finch fidgets with her gloves, avoiding eye contact."
      ]
    },
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_2",
      "placementDetail": "Beatrice insists she heard the clock strike nine, creating doubt about the reliability of the timeline."
    },
    ...
    "humourGuidance": {
      ...
      "form": "observational",
      "condition": "if a character uses observational wit"
    },
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 2: "Witnesses recall the clock striking nine, but the timing of Eleanor's death does not match this." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
