...
- Project ID: ``
- Timestamp: `2026-05-13T22:22:44.799Z`
...
- Era-authentic markers: petrol touring cars on county roads, domestic telephones with party-line exchanges, typewriters standard in households, reliable automobiles for local travel, passenger trains connecting major cities, early commercial aviation limited to major hubs, telegrams for urgent messages via local offices, airmail services available for distant correspondence
- Tone: Classic
- No anachronisms
...
Description: A sprawling country estate with a large main house, formal gardens, and several outbuildings, reflecting the wealth of its owners.
...
Setting constraints:
- Physical constraints: large grounds with hedges creating natural barriers, multiple rooms with access limited by locked doors, weather can hinder outdoor movement and evidence visibility
- Geographic isolation: The estate is situated several miles from the nearest town, limiting immediate outside assistance.
- Access control: restricted areas such as the library and cellar, daily schedules dictating movements of staff and guests, social hierarchies influencing access to certain areas

Era constraints to include:
- Technology: petrol touring cars on county roads, domestic telephones with party-line exchanges, typewriters standard in households
- Transportation: reliable automobiles for local travel, passenger trains connecting major cities
- Social norms: impact of the Great Depression affecting social gatherings, class distinctions prominent in estate management
