...
- Project ID: ``
- Timestamp: `2026-07-20T20:02:43.191Z`
...
PRIMARY FAILURES
- Chapter 9: Chapter 9 contains control-plane leakage (obligation_term): ""Clue obligation: suspect clearance missing for 'Beatrice Quill'." (Remove prompt, validation, retry, or scaffold terminology from reader-facing prose)
...
ATTEMPT: 2/3
OFFENDING TEXT: Clue obligation: suspect clearance missing for 'Beatrice Quill'.
MANDATORY FIXES:
- Resolve template issues before accepting this batch.
- Chapter 9: Chapter 9 contains control-plane leakage (obligation_term): ""Clue obligation: suspect clearance missing for 'Beatrice Quill'." (Remove prompt, validation, retry, or scaffold terminology from reader-facing prose)
```
