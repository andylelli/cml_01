...
- Project ID: ``
- Timestamp: `2026-07-20T19:54:45.043Z`
...
- Hugo Vane
  Public identity anchor: Hotel Manager; detective 
  Connection to victim: Business partners with underlying tensions due to financial mismanagement.; Hugo has aided Eleanor in maintaining her social facade, but it strains their business relationship..
...
- Captain Ivor Hale
  ...
  Investigation relevance: access plausibility: high | alibi window: 12:00 PM to 12:20 PM | opportunity channel: Access to the beach.
  Suspicion/pressure cue seed: Defensive when questioned about the victim.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Dr. Mallory Finch
  Public identity anchor: Physician; suspect 
  Connection to victim: Social acquaintances with hidden animosity due to past betrayals.; Eleanor and Mallory were once friends, but a romantic rivalry over a man tore them apart..
  Investigation relevance: access plausibility: medium | alibi window: 12:10 PM to 12:30 PM | opportunity channel: Access to the victim's room.
  Suspicion/pressure cue seed: Nervous when discussing the tides.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Sylvia Trent
  Public identity anchor: Artist; suspect 
  Connection to victim: Oc
...
• [clue_mechanism_visibility_core] witness, statements, confirm, eleanor, last, seen, balcony, quarter, past, twelve
  Category: testimonial | Criticality: essential | Supports inference step 1
  Points to: eleanor, last, known, location, time
...
Known location profile anchors: The Grand Tides Hotel, The Rooftop Observation Deck, The Grand Lounge, The Formal Dining Room, the balcony of the seaside hotel
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Grand Tides Hotel", "The Rooftop Observation Deck", "The Grand Lounge", "The Formal Dining Room", "the balcony of the seaside hotel"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the balcony of the seaside hotel". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=7667; context=12095; dropped=[none]; truncated=[first_appearance_contracts, location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - Scene is set in: the balcony of the seaside hotel — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • witnesses, recall, time, eleanor, last, seen [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The body of Eleanor Voss lying on the balcony."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the victim died shortly before being discovered, raising immediate questions about the circumstances."
...
[
  {
    ...
    "title": "Discovery",
    "setting": {
      "location": "the balcony of the seaside hotel",
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Captain Hale stares blankly at the waves, lost in thought."
      ]
    },
    "summary": "As the morning light filtered through the clouds, the body of Eleanor Voss was discovered on the balcony of the seaside hotel. Hugo Vane, an invited guest, found her lifeless form, shocking all present. The initial reaction was a mix of horror and disbelief, as the guests began to whisper about the last time they saw her.",
    "beat": "gathering",
    "estimatedWordCount": 1250,
    "pivotElement": "The body of Eleanor Voss lying on the balcony.",
    "factEstablished": "Establishes the victim died shortly before being discovered, raising immediate questions about the circumstances.",
    ...
    "emotionalRegister": "The atmosphere is heavy with tension and foreboding.",
    "dominantCharacterNote": {
      "name": "Eleanor Voss",
      "voiceRegister": "Eleanor speaks with a refined accent, her words laced with an air of superiority."
    },
    "humourGuidance": {
      "permission": "forbidden"
    },
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (witness, statements, confirm, eleanor, last, seen, balcony, quarter, past, twelve) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
