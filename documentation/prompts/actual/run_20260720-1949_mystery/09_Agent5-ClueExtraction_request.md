...
- Project ID: `unknown`
- Timestamp: `2026-07-20T19:51:28.082Z`
...
1. Generate a clue that makes the reader directly observe: "Witness statements confirm Eleanor was last seen on the balcony at a quarter past twelve...."
   → observation | essential | early | testimonial | step 1 | terms: witness, statements, confirm

2. Generate a clue that provides evidence for: "Eleanor could not have drowned if the tide was at its lowest...."
   → contradiction | essential | early | testimonial | step 1 | terms: eleanor, drowned, lowest.

3. Generate a clue that makes the reader directly observe: "Footprints leading away from the balcony suggest someone else was present...."
   → observation | essential | early | physical | step 2 | terms: footprints, leading, balcony

4. Generate a clue that provides evidence for: "The presence of another person indicates foul play...."
   → contradiction | essential | early | testimonial | step 2 | terms: presence, another, person

5. Generate a clue that makes the reader directly observe: "The tide table shows discrepancies compared to witness accounts...."
   → observation | essential | mid | testimonial | step 3 | terms: table, shows, discrepancies

6. Generate a clue that provides evidence for: "The discrepancies indicate tampering with the tide information...."
   → contradiction | essential | mid | testimonial | step 3 | terms: discrepancies, indicate, tampering

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "Eleanor could not have drowned if the tide was at its lowest...."
   → contradiction | essential | mid | testimonial | step 1 | terms: eleanor, drowned, lowest.

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The drowning was staged to appear as an accident, using tide manipulation and false witness testimonies...."
   → observation | essential | early | testimonial | terms: drowning, staged, appear
...
10. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "A staged reenactment on the balcony using tide tables to demonstrate the impossible timing of drowni..."
   → observation | essential | mid | testimonial | terms: staged, reenactment, balcony
...
11. Generate one essential mid-story clue whose description or pointsTo explicitly names Captain Ivor Hale and states the unique trace, preparation detail, or mechanism link that points to Captain Ivor Hale rather than any non-culprit.
   → observation | essential | mid | testimonial | terms: Captain Ivor Hale, drowning, staged, appear
...
12. Generate one essential early-or-mid clue establishing that Captain Ivor Hale UNIQUELY had the means/skill/access/knowledge required to execute the concealment mechanism, and that the other suspects did not — so the reveal relies only on this already-planted capability, never on a means introduced for the first time at the confrontation.
   → elimination | essential | mid | testimonial | terms: Captain Ivor Hale, drowning, staged, appear

13. Generate a clue showing observable evidence of Captain Ivor Hale's premeditation or planning (Jealousy over property). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: jealousy, property
...
## Access Constraints
Actors: Dr. Mallory Finch, Captain Ivor Hale, Sylvia Trent
Objects: Eleanor's balcony, Tide table
...
Create 2 red herrings that support the false assumption: "Eleanor drowned during a storm surge, creating the illusion of an accidental death."
