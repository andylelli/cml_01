...
- Project ID: ``
- Timestamp: `2026-07-16T22:05:14.239Z`
...
• [clue_2] timeline, events, shows, finch, collapsed, significantly, dinner
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: timing, collapse, indicates, potential, poisoning

• [clue_9] eliminates, sylvia, trent, because, seen, time, murder
...
CLUES ALREADY REVEALED TO READER: clue_1, clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_6, clue_5, clue_core_elimination_chain, clue_10, clue_id_1, clue_7, clue_culprit_direct_beatrice_quill, clue_id_2, clue_8, clue_3, clue_4 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): glass, piece | finch, complaints, related, death | foul, play, suggested, poison | method, murder, revealed | motive, beatrice, quill | eleanor, voss, excluded, suspect | hugo, vane, excluded, suspect | glass, piece | indicates, collapse, sudden | physical, trace, opportunity, indicate, beatrice, quill | timing, collapse, indicates, potential, poisoning | captain, ivor, hale, excluded, suspect | symptoms, suggest, foul, play | symptoms, linked, poison, ingestion
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "She paused at the threshold, casting one last glance at Beatrice and Captain Ivor Hale. Their faces were drawn, their secrets exposed. The investigation was far from over, but the path ahead was clearer now, marked by the hard-won knowledge that nothing in thi..."
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=21857; context=4096; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 8:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "She paused at the threshold, casting one last glance at Beatrice and Captain Ivor Hale. Their faces were drawn, their secrets exposed. The investigation was far from over, but the path ahead was clearer now, marked by th...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • timeline, records, events, dinner [clue_2]
      Points to: timing, collapse, indicates, potential, poisoning
    • receipts, witness, statements, confirm, sylvia, presence [clue_9]
      Points to: sylvia, trent, excluded, suspect
...
Chapter 8 (Act 2) completeness contract:
  ...
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes a clear timeline that points to the culprit's opportunity."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor's mind races as she connects the dots — the truth is almost within reach."
      ]
    },
    ...
    "emotionalRegister": "The mounting pressure leads to a dramatic reveal, testing the characters' resolve.",
