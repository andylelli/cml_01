...
- Project ID: ``
- Timestamp: `2026-07-16T21:51:25.389Z`
...
**Setting**: 1940s - A coastal resort hotel with art deco architecture, featuring a grand lobby, ocean-view rooms, and a dining area with a terrace overlooking the beach.
**Crime Type**: Murder
**Social Context**: women entering the workforce, post-war trauma awareness, racial segregation in some areas
**Tone**: Classic
