...
- Project ID: ``
- Timestamp: `2026-07-16T22:02:13.368Z`
...
• [clue_id_2] timeline, events, shows, finch, collapsed, significantly, dinner
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: timing, collapse, indicates, potential, poisoning

• [clue_8] eliminates, captain, ivor, hale, because, kitchen, preparing, dinner
...
CLUES ALREADY REVEALED TO READER: clue_1, clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_6, clue_5, clue_core_elimination_chain, clue_10, clue_id_1, clue_7, clue_culprit_direct_beatrice_quill — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): glass, piece | finch, complaints, related, death | foul, play, suggested, poison | method, murder, revealed | motive, beatrice, quill | eleanor, voss, excluded, suspect | hugo, vane, excluded, suspect | glass, piece | indicates, collapse, sudden | physical, trace, opportunity, indicate, beatrice, quill
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As she turned to leave, the kitchen’s lamplight flickered, casting long shadows across the tiled floor. The scent of onions lingered, mingling with the damp chill of the autumn evening. Eleanor paused at the threshold, her mind already leaping ahead to the nex..."
...
Known location profile anchors: Seaside Resort Hotel, Grand Lobby, Dining Area, Ocean View Rooms, Staff-Only Area, the lounge of the seaside resort hotel
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Seaside Resort Hotel", "Grand Lobby", "Dining Area", "Ocean View Rooms", "Staff-Only Area", "the lounge of the seaside resort hotel"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 6: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with an expository setup — e.g. "It was not until…" / "There had been no word since…" / "There was a note on the table…". Begin with "It was", "There was", or "There had been" followed immediately by a specific condition, event, or discovery. Do not open on generic mood alone — but still anchor the location and weave in the sensory + time-of-day grounding across the next sentence or two. Anchor opening in "the lounge of the seaside resort hotel". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=18028; context=5856; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_culprit_direct_beatrice_quill must appear in Act 2, Scene 3 via Witness statement
- clue_id_2 must appear in Act 2, Scene 3 via Witness statement
...
- Chapter 6:
  ...
  - Scene is set in: the lounge of the seaside resort hotel — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As she turned to leave, the kitchen’s lamplight flickered, casting long shadows across the tiled floor. The scent of onions lingered, mingling with the damp chill of the autumn evening. Eleanor paused at the threshold, h...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • meeting, records, witness, statements, confirm, hugo, presence [clue_10]
    ...
    • conversations, indicating, tension, beatrice, finch [clue_5]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • witnesses, discussing, finch, condition, before, dinner [clue_7]
      Points to: indicates, collapse, sudden
    • witnesses, confirm, captain, hale, presence, kitchen [clue_8]
      Points to: captain, ivor, hale, excluded, suspect
    ...
    • witnesses, discussing, finch, complaints [clue_culprit_direct_1]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • witnesses, discussing, finch, complaints [clue_culprit_direct_beatrice_quill]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • timeline, records, events, dinner [clue_id_2]
      Points to: timing, collapse, indicates, potential, poisoning
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The timing of his symptoms aligns with poison ingestion, not a sudden illness."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes a convincing but ultimately flawed case against Hugo Vane."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor's heart pounds as she makes her case — the room holds its breath."
      ]
    },
...
```text
{
  ...
  "chapters": [
    {
      ...
      "summary": "Eleanor gathers Hugo Vane and Sylvia Trent in the lounge of the seaside resort hotel, laying out a seemingly convincing case against Hugo for Dr. Finch’s death. As she presses her theory, a flaw in the timeline emerges, forcing her to reconsider her assumptions and deepening the emotional stakes for all present.",
      "paragraphs": [
        "It was the flicker of lamplight, trembling in the glass shade above the lounge’s battered piano, that drew Eleanor Voss from her reverie at the kitchen threshold. The scent of onions and the damp chill of autumn clung to her as she crossed into the lounge of the seaside resort hotel, where evening pressed its grey face against the windowpanes. Rain tapped a restless rhythm on the glass, and the glow of electric bulbs cast uncertain shadows across the patterned carpet. The air was thick with anticipation, the hush broken only by the distant strains of jazz from a radio left on somewhere behind the bar.",
        "Hugo Vane stood by the hearth, hands clasped behind his back, his silhouette outlined by the fire’s dull glow. Sylvia Trent perched on the edge of a faded armchair, her posture rigid, eyes darting between Eleanor and Hugo. The room’s warmth was deceptive; beneath it ran a current of tension that prickled the skin. Eleanor’s heart beat a frantic tattoo as she assembled her thoughts, the memory of Dr. Mallory Finch’s glass—the residue, the contradiction—burning in her mind. She set her notes on the low table, the paper’s rough edge catching on her palm.",
        "‘Thank you both for joining me,’ Eleanor began, her voice melodic but edged with resolve. ‘I know this is difficult, but we must speak plainly. Dr. Finch’s death cannot be dismissed as mere misfortune.’ She let the words settle, watching Hugo’s jaw tighten and Sylvia’s hands twist the hem of her skirt. The lounge, usually a sanctuary from the autumnal gloom, now felt like a stage set for accusation.",
        "Hugo’s response was measured, his tone smooth as ever, but his gaze did not meet Eleanor’s. ‘You seem to have made up your mind, Miss Voss. Shall I stand trial here, or will you wait for the authorities?’ A faint smile played at the corners of his mouth, but his eyes were wary. The sound of rain intensified, drumming against the window, a percussive counterpoint to the tension inside.",
        "Eleanor shook her head, her fingers tracing the rim of her teacup. ‘I am not the law, Mr. Vane. But I am seeking the truth. You were not present in the Dining Area at the crucial moment. Your business meeting across town is well-documented, but—’ she paused, searching Hugo’s face for a crack in his composure—‘your political ambitions, your history with Dr. Finch… They suggest motive, if not opportunity.’",
        "Sylvia shifted in her seat, her voice brittle. ‘This is madness, Eleanor. Hugo wasn’t even here when Dr. Finch collapsed. I saw the records myself—the meeting, the witnesses. You’re chasing shadows.’ Her words were sharp, but her eyes glistened with confusion, the strain of the past days etched deep in the lines around her mouth.",
        "Eleanor pressed on, her tone gentle but relentless. ‘Dr. Finch began complaining of stomach pains before dinner—multiple witnesses recall it. Yet, her collapse occurred long after, at ten minutes past eight. The timing of her symptoms aligns with poison ingestion, not a sudden illness. If the substance was administered during dinner, only those present in the Dining Area could have had access.’",
        "Hugo’s hand trembled as he reached for the poker, prodding the fire with more force than necessary. ‘You think I arranged for her to be poisoned in my absence? That I orchestrated it from across town?’ His words were laced with incredulity, but Eleanor caught the flicker of fear that passed over his features—a fear not of guilt, but of being misunderstood, of old wounds being laid bare.",
        "The lamplight flickered, casting Sylvia’s face in alternating bands of shadow and gold. She drew a shaky breath. ‘Dr. Finch trusted few people, but she respected you, Hugo. If you had reason to harm her, I can’t see it. Not after everything she did for you.’ Her voice cracked, the grief in it raw and unvarnished. The room seemed to shrink around them, the walls closing in with each word.",
        "Eleanor’s heart pounded as she laid out her case, the logic as cold and precise as the autumn rain outside. ‘You had motive, Mr. Vane—political gain, perhaps, or revenge for past slights. But the evidence—’ she gestured to her notes, the timeline, the witness statements—‘suggests otherwise. The kitchen staff, the meeting records, all confirm your absence from the Dining Area at the critical time. The opportunity simply isn’t there.’",
        "Hugo’s mask slipped for an instant, revealing a flash of bitterness. ‘You want a villain, Miss Voss. I understand. But I am not the man you seek. Dr. Finch and I had our differences, but I would not stoop to murder.’ He turned away, staring into the fire as if it might offer absolution.",
  ...
  "note": "",
  "audit": {
    "locked_fact_phrases": "present in paragraphs 7, 10 | absent elsewhere",
    "season_words_used": "autumn, autumnal, rain, autumn rain, autumnal gloom",
    "discriminating_test_present": "no",
    "required_clues_present": "clue_id_2: paragraph 7; clue_8: paragraph 10",
    "early_observation_present": "Eleanor observes the tension and the residue's contradiction: paragraph 2",
...
PRIMARY FAILURES
- Chapter 6: a clue/test description was copied verbatim into the prose (13 consecutive words from "The timing of her symptoms aligns with poison ingestion, not a sudden …"). Dramatize it as an observed detail, action, or dialogue in your own words — do NOT transcribe schema descriptions.
...
DEFERRED TO PHASE 2 (1 quality issue(s) — address ONLY after this attempt passes logic gates):
  (deferred) Chapter 6: a clue/test description was copied verbatim into the prose (13 consecutive words from "The timing of her symptoms aligns with poison ingestion, not a sudden …"). Dramatize it as an observed detail, action, or dialogue in your own words — do NOT transcribe schema descriptions.
...
ATTEMPT: 1/3
OFFENDING TEXT: The timing of her symptoms aligns with poison ingestion, not a sudden …
MANDATORY FIXES:
