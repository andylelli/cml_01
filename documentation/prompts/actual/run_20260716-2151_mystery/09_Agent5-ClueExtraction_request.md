...
- Project ID: `unknown`
- Timestamp: `2026-07-16T21:53:02.044Z`
...
1. Generate a clue that makes the reader directly observe: "A glass found in the dining area shows residue of a toxic substance...."
   → observation | essential | early | testimonial | step 1 | terms: glass, found, dining

2. Generate a clue that provides evidence for: "The presence of poison indicates foul play in the victim's death...."
   → contradiction | essential | early | testimonial | step 1 | terms: presence, poison, indicates

3. Generate a clue that makes the reader directly observe: "Witnesses recall Dr. Finch's complaints about stomach issues before dinner...."
   → observation | essential | early | temporal | step 2 | terms: witnesses, recall, finch's

4. Generate a clue that provides evidence for: "These complaints were consistent with the delayed effects of poisoning, not a natural illness...."
   → contradiction | essential | early | testimonial | step 2 | terms: these, complaints, consistent

5. Generate a clue that makes the reader directly observe: "The timeline of events shows Dr. Finch collapsed significantly after dinner...."
   → observation | essential | mid | temporal | step 3 | terms: timeline, events, shows

6. Generate a clue that provides evidence for: "The timing of her symptoms aligns with poison ingestion, not a sudden illness...."
   → contradiction | essential | mid | testimonial | step 3 | terms: timing, symptoms, aligns

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The presence of poison indicates foul play in the victim's death...."
   → contradiction | essential | mid | testimonial | step 1 | terms: presence, poison, indicates

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The mechanism relies on poison, dinner, and dining to expose the false timing...."
   → observation | essential | early | testimonial | terms: mechanism, relies, poison,
...
10. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Reenacting the dinner service and observing reactions when the glass with poison residue is presente..."
   → observation | essential | mid | temporal | terms: reenacting, dinner, service

11. Generate one essential mid-story clue whose description or pointsTo explicitly names Beatrice Quill and states the unique trace, preparation detail, or mechanism link that points to Beatrice Quill rather than any non-culprit.
   → observation | essential | mid | testimonial | terms: Beatrice Quill, mechanism, relies, poison,

12. Generate one essential early-or-mid clue establishing that Beatrice Quill UNIQUELY had the means/skill/access/knowledge required to execute the concealment mechanism, and that the other suspects did not — so the reveal relies only on this already-planted capability, never on a means introduced for the first time at the confrontation.
   → elimination | essential | mid | testimonial | terms: Beatrice Quill, mechanism, relies, poison,

13. Generate a clue showing observable evidence of Beatrice Quill's premeditation or planning (Professional rivalry.). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
...
18. Generate one essential early or mid elimination clue that explicitly rules out Eleanor Voss and narrows the solution toward culprit Beatrice Quill. The pointsTo text must start with "Eliminates Eleanor Voss because ..." and cite corroborated evidence.
...
## Access Constraints
Actors: Beatrice Quill, Captain Ivor Hale, Sylvia Trent
Objects: Dining Room, Bar, Kitchen
...
Create 2 red herrings that support the false assumption: "Dr. Mallory Finch died from a sudden illness caused by her pre-existing condition."
