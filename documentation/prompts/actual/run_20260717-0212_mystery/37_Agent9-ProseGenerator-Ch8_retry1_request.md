...
- Project ID: ``
- Timestamp: `2026-07-17T02:27:54.414Z`
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "The guests began to drift from the ballroom, their footsteps muffled on the parquet floor. Eleanor lingered a moment longer, her gaze fixed on the fragment of blue velvet. The tension in the room had not vanished, but it had shifted—no longer a cloud of suspic..."
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=24235; context=4346; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
Motive (specific + emotional, NEVER a bare label): develop WHY Sylvia Trent killed Hugo Vane with concrete, personal specificity drawn from their relationship and history — the emotional truth that made murder feel, to Sylvia Trent, like the only door left. A one-word motive ("jealousy", "greed", "revenge") asserted without that interior truth is a FAIL: name what was actually at stake for Sylvia Trent and why no lesser act would serve.
...
- Chapter 8:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "The guests began to drift from the ballroom, their footsteps muffled on the parquet floor. Eleanor lingered a moment longer, her gaze fixed on the fragment of blue velvet. The tension in the room had not vanished, but it...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • witnesses, mention, person [clue_fp_elimination_beatrice_quill]
      Points to: eliminates, beatrice, quill, because, independent, corroboration, places, away, decisive, mechanism, window
    • unique, fabric, coat [clue_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: links, sylvia, hugo, room
  ...
  - ⚠ SUSPECT CLEARANCE REQUIRED (MANDATORY): each suspect below MUST be named explicitly and cleared with on-page evidence and a reasoning connector (because / therefore / which proves):
    ...
    • "Captain Ivor Hale": write a dedicated paragraph that (a) names Captain Ivor Hale explicitly, (b) states the clearance method ("Broken window confirmed to be from the storm."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
    • "Beatrice Quill": write a dedicated paragraph that (a) names Beatrice Quill explicitly, (b) states the clearance method ("Witnesses confirm her whereabouts during the murder."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
...
Chapter 8 (Act 3) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The confirmed alibis of the cleared suspects."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the remaining suspect, Sylvia, is the only one left with no credible alibi."
...
[
  {
    ...
    "setting": {
      ...
      "timeOfDay": "Night",
      "atmosphere": "Tense but electric with revelation"
    },
    "characters": [
      "Eleanor Voss",
      "Dr. Mallory Finch",
    ...
    "purpose": "Clear the suspects and establish the true culprit Suspects are systematically cleared: alibi confirmed for three suspects, ruled out by timeline evidence, leaving only the culprit identified by a complete evidence chain.",
    "cluesRevealed": [
    ...
    "dramaticElements": {
      ...
      "tension": "The atmosphere is thick with anticipation as truths are revealed.",
      "microMomentBeats": [
        "Eleanor feels a sense of relief wash over her as she clears the innocent."
      ]
    },
    "summary": "Eleanor clears Dr. Finch, Captain Hale, and Beatrice Quill by confirming their alibis. The tension in the room shifts as the focus turns back to Sylvia, whose behavior becomes increasingly suspicious.",
    "beat": "revelation",
    "estimatedWordCount": 1800,
    "pivotElement": "The confirmed alibis of the cleared suspects.",
    "factEstablished": "Establishes that the remaining suspect, Sylvia, is the only one left with no credible alibi.",
    ...
    "emotionalRegister": "The confrontation reveals the depth of betrayal and the cost of ambition.",
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 8: the clue [clue_1] (coat, hugo, room, unique, fabric, matching, sylvia, dress) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
