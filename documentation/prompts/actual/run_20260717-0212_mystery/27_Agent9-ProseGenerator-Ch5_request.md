...
- Project ID: ``
- Timestamp: `2026-07-17T02:24:26.620Z`
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Ivor is caught between his desire to protect his reputation and the guilt of his past actions, questioning whether he should seek redemption or maintain his façade."
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the rain continued its relentless assault on the windows, Eleanor gathered her notes, feeling the weight of uncertainty settle once more on her shoulders. The investigation had not grown simpler—if anything, the web had tightened. Both Beatrice and Dr. Mall..."
...
Known location profile anchors: The Cliffside Retreat, Grand Lobby, Ocean View Room, Staff Quarters, Cliffside Beach, the hotel library
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Cliffside Retreat", "Grand Lobby", "Ocean View Room", "Staff Quarters", "Cliffside Beach", "the hotel library"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=15915; context=6733; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 5:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the rain continued its relentless assault on the windows, Eleanor gathered her notes, feeling the weight of uncertainty settle once more on her shoulders. The investigation had not grown simpler—if anything, the web h...".
...
Chapter 5 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The distance from the hotel to the beach."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Ivor's alibi is shaky and requires further investigation."
...
[
  {
    ...
    "purpose": "Investigate Ivor's alibi and Hugo's statements",
    "cluesRevealed": [
      "clue_6",
      "clue_7",
      "clue_8",
    ...
    "dramaticElements": {
      "conflict": "Ivor's alibi begins to crumble under scrutiny.",
      "tension": "Eleanor feels the weight of the investigation pressing down.",
      "microMomentBeats": [
        "Eleanor recalls a moment with Hugo that now feels tainted."
      ]
    },
    "summary": "Eleanor questions Captain Hale about his whereabouts during the murder. Ivor's claim of being at the bar is contradicted by Hugo's earlier statements, causing Eleanor to doubt his innocence. As they speak, she notices the distance from the hotel to the beach, which plays a crucial role in the investigation.",
    "beat": "alibis",
    "estimatedWordCount": 1800,
    "pivotElement": "The distance from the hotel to the beach.",
    "factEstablished": "Establishes that Ivor's alibi is shaky and requires further investigation.",
    ...
    "emotionalRegister": "Eleanor's discoveries lead her to confront uncomfortable truths about the suspects.",
