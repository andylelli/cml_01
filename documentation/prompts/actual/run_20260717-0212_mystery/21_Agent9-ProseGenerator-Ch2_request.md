...
- Project ID: ``
- Timestamp: `2026-07-17T02:22:36.380Z`
...
• [clue_core_contradiction_chain] sylvia, present, hugo, room, indicating, potential, involvement
  Category: spatial | Criticality: essential | Supports inference step 1
  Points to: challenges, alibi, sylvia
...
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): possibility, impersonation | possibility, impersonation
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Eleanor’s thoughts turned to the peculiar consistency in the witnesses’ accounts. If so many had seen Hugo Vane—or someone indistinguishable from him—after ten minutes past eleven, then the masquerade’s confusion might have been more than accidental. She resol..."
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=9329; context=11896; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 2:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Eleanor’s thoughts turned to the peculiar consistency in the witnesses’ accounts. If so many had seen Hugo Vane—or someone indistinguishable from him—after ten minutes past eleven, then the masquerade’s confusion might h...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • sylvia, presence, hugo, room [clue_core_contradiction_chain] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: challenges, alibi, sylvia
...
Chapter 2 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Conflicting witness statements about the last person seen with Hugo."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that multiple guests claim to have seen different people with Hugo shortly before his death."
...
[
  {
    ...
    "setting": {
      ...
      "atmosphere": "Chaotic and filled with whispers of suspicion"
    },
    "characters": [
      "Eleanor Voss",
      "Hugo Vane",
    ...
    "purpose": "Establish the crime scene and introduce initial clues",
    "cluesRevealed": [
      "clue_core_contradiction_chain"
    ],
    "dramaticElements": {
      "conflict": "Guests argue over who was last seen with Hugo.",
      "tension": "Everyone is on edge, fearing they might be next.",
      "microMomentBeats": [
        "Eleanor feels a chill as she looks at the victim's lifeless body."
      ]
    },
    "summary": "The guests gather around, murmuring in shock as Eleanor inspects the scene. She notes the conflicting statements about who was last seen with Hugo. Tensions rise as accusations start to fly, revealing the fractures in their relationships.",
    "beat": "crime",
    "estimatedWordCount": 1800,
    "pivotElement": "Conflicting witness statements about the last person seen with Hugo.",
    "factEstablished": "Establishes that multiple guests claim to have seen different people with Hugo shortly before his death.",
    ...
    "humourGuidance": {
      ...
      "form": "understatement",
      "condition": "Eleanor's dry wit can momentarily lighten the mood."
    },
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 2: the clue [clue_core_contradiction_chain] (sylvia, present, hugo, room, indicating, potential, involvement) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
