...
- Project ID: ``
- Timestamp: `2026-07-19T15:10:55.612Z`
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Beatrice grapples with the moral implications of her actions and the fear of losing everything she has worked for."
...
• [clue_8] clock, repair, tool, near, room
...
CLUES ALREADY REVEALED TO READER: clue_early_1, clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_3, clue_4, clue_culprit_direct_captain_ivor_hale, clue_5, clue_7, clue_14 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): time, death, indicated, minutes, past, eleven | time, death, indicated, minutes, past, eleven | clock, time, incorrect, regarding, death | clock, interfered, prior, murder | clock, tampered, before, party, started | direct, shows, captain, ivor, hale, means | finch, whereabouts, contradict, clock, time | fingerprints, belong, person, tampered, clock | hugo, vane, alibi, excludes, suspicion
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "The rain eased, and a shaft of midsummer light broke through the clouds, illuminating the lobby in a pale, uncertain glow. Eleanor felt the shift in atmosphere—a brief reprieve, a reminder that even in the darkest inquiry, relief could break through. Yet as sh..."
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=15825; context=6770; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_7 must appear in Act 2, Scene 2 via Direct observation
...
- Chapter 5:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "The rain eased, and a shaft of midsummer light broke through the clouds, illuminating the lobby in a pale, uncertain glow. Eleanor felt the shift in atmosphere—a brief reprieve, a reminder that even in the darkest inquir...".
...
Chapter 5 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Beatrice's nervous fidgeting during the interview."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes Beatrice's alibi, eliminating her as a suspect."
...
[
  {
    ...
    "setting": {
      ...
      "atmosphere": "Suspicious and wary"
    },
    "characters": [
      "Eleanor Voss",
      "Beatrice Quill"
    ],
    "purpose": "Clarify Beatrice's whereabouts during the murder",
    "cluesRevealed": [
    ...
    "dramaticElements": {
      "conflict": "Beatrice struggles to maintain her composure",
      "tension": "Eleanor probes deeper into Beatrice's story",
      "microMomentBeats": [
        "Beatrice fidgets with her necklace, avoiding Eleanor's gaze as she recounts her movements."
      ]
    },
    "summary": "Eleanor interviews Beatrice, who insists she was in the kitchen preparing drinks for the guests. As Eleanor listens, she notices Beatrice's nervous behavior and her inconsistent details about the timeline, but ultimately, Beatrice's alibi is corroborated by another guest.",
    "beat": "alibis",
    "estimatedWordCount": 1250,
    "pivotElement": "Beatrice's nervous fidgeting during the interview.",
    "factEstablished": "Establishes Beatrice's alibi, eliminating her as a suspect.",
    ...
    "emotionalRegister": "Eleanor uncovers a deeper conspiracy that challenges her assumptions.",
