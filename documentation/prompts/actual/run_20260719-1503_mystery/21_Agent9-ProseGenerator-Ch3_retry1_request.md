...
- Project ID: ``
- Timestamp: `2026-07-19T15:10:15.704Z`
...
Eleanor's determination grows as she begins piecing together the clues.
...
Rationale: Eleanor's dry wit can provide a contrast to the investigation's gravity.

## Reveal Groundwork (texture — do not explain, only plant)
- Plant one subtle observable beat related to: "Earlier in the story, the tension in the library reflects the weight of unspoken secrets, as each character grapples with their own past". Do not explain significance yet.
- Plant one subtle observable beat related to: "The discovery of the clock's tampering serves to the earlier conversations, exposing hidden motives". Do not explain significance yet.
- Plant one subtle observable beat related to: "As characters confront their truths, the emotional stakes amplify, revealing how interconnected their fates truly are". Do not explain significance yet.
...
• [clue_3] dusting, flour, clock, surface
  Category: physical | Criticality: essential | Supports inference step 2
  Points to: clock, interfered, prior, murder
...
CLUES ALREADY REVEALED TO READER: clue_early_1, clue_mechanism_visibility_core, clue_core_contradiction_chain — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): time, death, indicated, minutes, past, eleven | time, death, indicated, minutes, past, eleven | clock, time, incorrect, regarding, death
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Yet amid the fear and suspicion, Eleanor felt a flicker of resolve. The war had taught her that truth was a commodity, rationed and hoarded, but it was also a weapon. She would wield it carefully, prying open the cracks in every alibi, every memory. The clock’..."
...
lobby, garden, kitchen, suite, flat
...
Chapter 2: Chapter 2: Initial Reactions
  Events: "It’s still stuck, isn’t it?
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=12445; context=11369; dropped=[humour_guide, location_profiles, texture_pool]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 3:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Yet amid the fear and suspicion, Eleanor felt a flicker of resolve. The war had taught her that truth was a commodity, rationed and hoarded, but it was also a weapon. She would wield it carefully, prying open the cracks...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • flour, particles, clock [clue_3] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: clock, interfered, prior, murder
    ...
    • flour, clock [clue_4] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      ...
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         ...
         Paragraph 2 (immediately following): The detective or POV character explicitly reasons
           about what this evidence implies — who it implicates, why it may be unreliable,
           or what inference it supports. This must be a separate full paragraph, not a sentence appended to Paragraph 1.
    • flour, clock [clue_culprit_direct_captain_ivor_hale] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
...
Chapter 3 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The dusting of flour on the clock's surface."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the clock was tampered with recently, narrowing the suspect pool."
...
[
  {
    "sceneNumber": 3,
    "act": 1,
    "title": "The Clock and the Flour",
    "setting": {
      "location": "the scene",
      "timeOfDay": "Morning after the murder",
      "atmosphere": "A growing sense of dread and intrigue"
    },
    "characters": [
      "Eleanor Voss",
      "Captain Ivor Hale",
    ...
    "purpose": "Introduce physical evidence and raise suspicions",
    "cluesRevealed": [
      "clue_3",
      "clue_4",
    ...
    "dramaticElements": {
      ...
      "tension": "Eleanor's suspicions grow towards Hale",
      "microMomentBeats": [
        "Eleanor kneels down, brushing her fingers over the dust, feeling the weight of the mystery."
      ]
    },
    "summary": "Eleanor examines the clock more closely and discovers a dusting of flour on its surface. Her mind races as she connects the flour to the tampering of the clock. Captain Hale's nervous demeanor raises her suspicions further, and she begins to suspect he had access to the mechanism.",
    "beat": "first_enquiries",
    "estimatedWordCount": 1250,
    "pivotElement": "The dusting of flour on the clock's surface.",
    "factEstablished": "Establishes that the clock was tampered with recently, narrowing the suspect pool.",
    ...
    "humourGuidance": {
      ...
      "form": "dry_wit",
      "condition": "Eleanor's wit can help lighten the tension during questioning."
    },
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 3: the clue [clue_3] (dusting, flour, clock, surface) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: the clue [clue_4] (presence, flour, indicates, recent, tampering, clock) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
...
□ Chapter 3: the clue [clue_early_1] (clock, lobby, shows, minutes, past, eleven) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
...
PRIMARY FAILURES
- Chapter 3: scene location coverage missing — expected location anchor "the scene" was not grounded in prose.

REWRITE PLAN
- Preserve paragraphs that are already valid, but fully rewrite every paragraph touched by a failing issue.
- Ground the chapter explicitly in "the scene" on-page; make the anchor visible in scene prose, not only implied by atmosphere.

SUCCESS CHECKLIST
- Every listed issue below is resolved in this single attempt before you answer.
- The chapter explicitly grounds the scene in "the scene".
...
═══ SETTING DRIFT ERRORS (1) ═══
• Chapter 3: scene location coverage missing — expected location anchor "the scene" was not grounded in prose.

✓ SOLUTION: This story is set in a "Byron Bay"
✓ Use ONLY location vocabulary appropriate for this setting type
✓ DO NOT use terms from other settings (manor, train, hotel, etc.)
