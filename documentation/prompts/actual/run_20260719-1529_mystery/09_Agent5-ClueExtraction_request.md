...
- Project ID: `unknown`
- Timestamp: `2026-07-19T15:30:41.666Z`
...
1. Generate a clue that makes the reader directly observe: "A half-empty glass found near the victim's body contains remnants of a rare botanical extract...."
   → observation | essential | early | testimonial | step 1 | terms: half-empty, glass, found

2. Generate a clue that provides evidence for: "The extract indicates intentional poisoning rather than natural causes...."
   → contradiction | essential | early | testimonial | step 1 | terms: extract, indicates, intentional

3. Generate a clue that makes the reader directly observe: "Witnesses claim they heard Sylvia complaining about her health earlier that evening...."
   → observation | essential | early | testimonial | step 2 | terms: witnesses, claim, heard

4. Generate a clue that provides evidence for: "Her complaints were exploited by the murderer to mask the true nature of her death...."
   → contradiction | essential | early | testimonial | step 2 | terms: complaints, exploited, murderer

5. Generate a clue that makes the reader directly observe: "Dr. Finch's alibi places her in the kitchen during the time of death...."
   → observation | essential | mid | temporal | step 3 | terms: finch's, alibi, places

6. Generate a clue that provides evidence for: "Her presence in the kitchen allows for access to the victim's drink for poisoning...."
   → contradiction | essential | mid | spatial | step 3 | terms: presence, kitchen, allows

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The extract indicates intentional poisoning rather than natural causes...."
   → contradiction | essential | mid | testimonial | step 1 | terms: extract, indicates, intentional

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The poison, a rare botanical extract, is carefully dosed to coincide with moments when the victim's metabolic rate is at its slowest, leadin..."
   → observation | essential | early | temporal | terms: poison,, botanical, extract,
...
10. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "A staged dinner is set up to observe reactions when a similar botanical extract is introduced, revea..."
   → observation | essential | mid | temporal | terms: staged, dinner, observe
...
11. Generate one essential mid-story clue whose description or pointsTo explicitly names Hugo Vane and states the unique trace, preparation detail, or mechanism link that points to Hugo Vane rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Hugo Vane, poison,, botanical, extract,
...
12. Generate one essential early-or-mid clue establishing that Hugo Vane UNIQUELY had the means/skill/access/knowledge required to execute the concealment mechanism, and that the other suspects did not — so the reveal relies only on this already-planted capability, never on a means introduced for the first time at the confrontation.
   → elimination | essential | mid | temporal | terms: Hugo Vane, poison,, botanical, extract,

13. Generate a clue showing observable evidence of Hugo Vane's premeditation or planning (Professional jealousy.). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
...
15. Generate one essential early or mid elimination clue that explicitly rules out Dr. Mallory Finch and narrows the solution toward culprit Hugo Vane. The pointsTo text must start with "Eliminates Dr. Mallory Finch because ..." and cite corroborated evidence.
...
## Access Constraints
Actors: Eleanor Voss, Dr. Mallory Finch, Hugo Vane
Objects: The victim's drink, The rare botanical extract
...
Create 2 red herrings that support the false assumption: "The victim died from natural causes due to her fragile health."
