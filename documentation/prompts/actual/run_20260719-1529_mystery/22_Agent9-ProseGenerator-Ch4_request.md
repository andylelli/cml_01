...
- Project ID: ``
- Timestamp: `2026-07-19T15:36:02.576Z`
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Ivor grapples with the ghosts of his past, the memories of wartime horrors that refuse to fade. His struggle to adapt to a world that seems to have moved on weighs heavily on him, creating a tension that threatens to erupt."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Beatrice wrestles with the ethics of her ambition, torn between her desire for recognition and the potential harm her investigation could cause. She fears that in her quest for the truth, she may lose sight of the human stories behind the headlines."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Hugo grapples with the consequences of his greed, torn between ambition and the moral implications of his actions. The pressure of financial ruin looms large, creating a tension that threatens to unravel his carefully constructed life."
...
• [clue_3] finch, alibi, places, kitchen, time, death
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: finch, opportunity, poison, drink

• [clue_5] hugo, vane, expresses, professional, jealousy, towards, sylvia
  Category: behavioral | Criticality: essential | Supports inference step 3
  Points to: hugo, vane, potential, motive
...
CLUES ALREADY REVEALED TO READER: clue_1, clue_2, clue_mid_1, clue_fp_contradiction_step_1, clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_early_3, clue_early_1 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): victim, drink, tampered | murderer, took, advantage, sylvia, complaints | victim, drink, tampered | extract, indicates, intentional, poisoning, rather, natural | mechanism, poisoning, deliberate, timed | complaints, used, mask, true, nature, death | complaints, used, mask, true, nature, death | mechanism, poisoning, deliberate, timed
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Outside, the wind howled, but within the walls of the Seaward Hotel, the storm was only just beginning. Eleanor felt the weight of her responsibility anew. The investigation had moved beyond polite questions; it was now a matter of survival, of truth clawing i..."
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=13572; context=7984; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 4:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Outside, the wind howled, but within the walls of the Seaward Hotel, the storm was only just beginning. Eleanor felt the weight of her responsibility anew. The investigation had moved beyond polite questions; it was now...".
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Hugo's admission of his desperation for Sylvia's support in a development deal."
...
[
  {
    ...
    "purpose": "Conduct interviews to uncover motives and alibis",
    "cluesRevealed": [
      "clue_3",
      "clue_5"
    ],
    "dramaticElements": {
      "conflict": "Interrogation reveals hidden tensions.",
      "tension": "Suspects' motives are laid bare.",
      "microMomentBeats": [
        "Eleanor feels the weight of their gazes, each one a potential threat."
      ]
    },
    "summary": "In the hotel dining room, Eleanor interviews each suspect about their relationship with Sylvia. Dr. Mallory Finch reveals her professional jealousy, while Captain Hale's resentment towards Sylvia emerges. Beatrice's ambition to expose a scandal and Hugo's desperation for Sylvia's support in a development deal add layers to the investigation. Eleanor notes the inconsistencies in their accounts.",
    "beat": "motives",
    "estimatedWordCount": 1500,
    "pivotElement": "Hugo's admission of his desperation for Sylvia's support in a development deal.",
    ...
    "emotionalRegister": "A clue shifts the direction of the investigation, creating new possibilities.",
