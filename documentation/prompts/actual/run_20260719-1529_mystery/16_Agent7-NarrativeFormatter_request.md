...
- Project ID: `unknown`
- Timestamp: `2026-07-19T15:32:54.010Z`
...
**Era & Setting**: 1940s - Dilapidated Seaside Hotel
**Setting Lock**: All scenes must remain within this setting: Dilapidated Seaside Hotel. Do not move to a different location type.
...
The victim died from natural causes due to her fragile health.
*Revealed: final act*
...
### Early Clues (Act I)
- [clue_mechanism_visibility_core] temporal: The poison, a rare botanical extract, is carefully dosed to coincide with moments when the victim's metabolic rate is at its slowest.
- [clue_core_contradiction_chain] testimonial: Witnesses claim they heard Sylvia complaining about her health earlier that evening.
- [clue_1] physical: A half-empty glass found near the victim's body contains remnants of a rare botanical extract.
- [clue_2] testimonial: Her complaints were exploited by the murderer to mask the true nature of her death.
- [clue_early_1] temporal: The poison, a rare botanical extract, is carefully dosed to coincide with moments when the victim's metabolic rate is at its slowest.
- [clue_mid_1] physical: A half-empty glass found near the victim's body contains remnants of a rare botanical extract.
- [clue_early_3] testimonial: Witnesses claim they heard Sylvia complaining about her health earlier that evening.
- [clue_fp_contradiction_step_1] temporal: A half-empty glass found near the victim's body contains remnants of a rare botanical extract.

### Mid Clues (Act II)
- [clue_core_elimination_chain] testimonial: Eliminates Dr. Mallory Finch because her alibi places her in the study during the time of death.
- [clue_3] temporal: Dr. Finch's alibi places her in the kitchen during the time of death.
- [clue_4] spatial: A staged dinner is set up to observe reactions when a similar botanical extract is introduced.
- [clue_5] behavioral: Hugo Vane expresses professional jealousy towards Sylvia.
- [clue_6] physical: The presence of the poison in the victim's bloodstream is confirmed.
- [clue_culprit_direct_1] temporal: Direct evidence links Hugo Vane to the mechanism access point before the discriminating test and excludes competing suspect timelines.
- [clue_culprit_direct_hugo_vane] spatial: Direct evidence ties Hugo Vane to the mechanism access point before the discriminating test and excludes competing suspect timelines.
- [clue_mid_2] temporal: Dr. Finch's alibi places her in the kitchen during the time of death.
- [clue_mid_3] physical: The presence of the poison in the victim's bloodstream is confirmed.
- [clue_early_2] temporal: Direct evidence links Hugo Vane to the mechanism access point before the discriminating test and excludes competing suspect timelines.
- [clue_fp_contradiction_step_3] temporal: Dr. Finch's alibi places her in the kitchen during the time of death.

### Late Clues (Act III)
- [clue_late_optional_slot_1] temporal: Dinner time at eight o'clock in the evening. remains a late texture detail in the case background.

### Red Herrings
- [rh_1] Sylvia had a history of health issues that could explain her sudden collapse.
- [rh_2] Witnesses recall seeing Sylvia looking unwell in the days leading up to her death.
...
- **Dr. Mallory Finch**: Act 3, Scene 5
  - Method: Lack of any motive and inconsistent access to the victim's drink.
  - Clues: clue_mid_2, clue_early_2
- **Captain Ivor Hale**: Act 3, Scene 5
  - Method: Witnesses confirm he was in the lobby when the poisoning occurred.
  - Clues: clue_mid_3, clue_early_3
- **Beatrice Quill**: Act 3, Scene 5
  - Method: Alibi confirmed: 9 PM to 10 PM
- **Sylvia Trent**: Act 3, Scene 5
  - Method: Alibi confirmed: 8 PM to 10 PM
...
- **clue_early_1**: Act 1, Scene 3 (Found in the victim's room.)
...
- **wine_cellar_temp**: "fifty degrees" — The wine cellar's temperature affects the poison's potency.
- **meal_timetable**: "three hours after dinner" — The poison's effect is timed to occur at this interval.
- **victim_weight**: "one hundred and fifty pounds" — The victim's weight is critical for calculating the poison dosage.


## PILLAR 4 — OUTLINE COMPLETENESS CONTRACT DATA

### Character Permitted Behaviours (use for permittedBehavioursByAct per scene)
- **Eleanor Voss**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "With the victim's influence over the inheritance, Eleanor feels the ground beneath her shift. The prospect of losing everything drives her to the edge, igniting a fierce desperation that clouds her judgment." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Eleanor grapples with her fear of failure, haunted by the thought of disappointing those who depend on her and the weight of her financial decisions. The possibility of betrayal looms large, casting shadows on her relationships." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Dr. Mallory Finch**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "The victim’s threat to expose their affair looms large, casting a dark shadow over Mallory’s ambitions. The thought of losing financial support for her clinic, and the ensuing scandal, drives her to desperation." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Mallory is torn between her desire for success and the guilt of her choices. She wrestles with the moral implications of her affair and the lengths she will go to protect her reputation, fearing that the truth will cost her everything." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Captain Ivor Hale**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Ivor believes the victim is a roadblock to his vision of transforming the hotel into a haven for naval veterans, igniting a fierce resentment that bubbles beneath his surface." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Ivor grapples with the ghosts of his past, the memories of wartime horrors that refuse to fade. His struggle to adapt to a world that seems to have moved on weighs heavily on him, creating a tension that threatens to erupt." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Beatrice Quill**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "To Beatrice, the victim represents a barrier to uncovering a scandal that could bring her fame and recognition, igniting an insatiable thirst for the truth." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Beatrice wrestles with the ethics of her ambition, torn between her desire for recognition and the potential harm her investigation could cause. She fears that in her quest for the truth, she may lose sight of the human stories behind the headlines." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Sylvia Trent**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Her new will threatened to disinherit her family, igniting tensions that simmered just beneath the surface of familial love." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Though she appeared calm and nurturing, Sylvia harbored doubts about her family’s values and their ability to accept her choices. The juxtaposition of her public persona and private decisions creates a tension that underscores her relationships." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Hugo Vane**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Hugo’s desperation for the victim's support in a lucrative development deal tied to the estate drives him to contemplate drastic measures." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Hugo grapples with the consequences of his greed, torn between ambition and the moral implications of his actions. The pressure of financial ruin looms large, creating a tension that threatens to unravel his carefully constructed life." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.

### Red Herrings (must be seeded in Act I–II scenes via redHerringPlacement)
- **rh_1**: Sylvia had a history of health issues that could explain her sudden collapse. (misdirection: This could lead investigators to overlook the possibility of foul play.)
- **rh_2**: Witnesses recall seeing Sylvia looking unwell in the days leading up to her death. (misdirection: This may mislead the investigation towards attributing her death to her pre-existing conditions.)
```
