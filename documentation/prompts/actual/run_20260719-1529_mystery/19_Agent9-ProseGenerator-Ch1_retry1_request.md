...
- Project ID: ``
- Timestamp: `2026-07-19T15:34:44.813Z`
...
- Eleanor Voss
  ...
  Connection to victim: Long-time friends, but Eleanor resents Sylvia's hidden will which could ruin her hotel.; Eleanor and Sylvia have worked together for years, but conflicts over finances have strained their friendship..
  Investigation relevance: access plausibility: high | alibi window: none.
  Suspicion/pressure cue seed: Desire to solve the case and bring justice..
...
- Dr. Mallory Finch
  ...
  Investigation relevance: access plausibility: medium | alibi window: 9 PM to 10 PM | opportunity channel: Access to hotel kitchen.
  Suspicion/pressure cue seed: Inconsistent information about the victim's health.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.
...
- Captain Ivor Hale
  ...
  Suspicion/pressure cue seed: Nervous when discussing the victim's past.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Beatrice Quill
  Public identity anchor: Journalist; detective 
  Connection to victim: Beatrice is investigating Sylvia's family history, while Sylvia feels threatened by this scrutiny.; Beatrice has
...
• [clue_1] half, empty, glass, near, victim, body, contains, remnants, rare, botanical, extract
  Category: physical | Criticality: essential | Supports inference step 1
  Points to: victim, drink, tampered

• [clue_2] complaints, exploited, murderer, mask, true, nature, death
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: murderer, took, advantage, sylvia, complaints

• [clue_mid_1] half, empty, glass, near, victim, body, contains, remnants, rare, botanical, extract
  Category: physical | Criticality: essential | Supports inference step 1
  Points to: victim, drink, tampered

• [clue_fp_contradiction_step_1] half, empty, glass, near, victim, body, contains, remnants, rare, botanical, extract
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: extract, indicates, intentional, poisoning, rather, natural, causes
...
Known location profile anchors: The Seaward Hotel, The Library, The Dining Room, The Staff Kitchen, The Roof Access, a dimly lit room in the dilapidated seaside hotel
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Seaward Hotel", "The Library", "The Dining Room", "The Staff Kitchen", "The Roof Access", "a dimly lit room in the dilapidated seaside hotel"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "a dimly lit room in the dilapidated seaside hotel". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=8637; context=12819; dropped=[none]; truncated=[first_appearance_contracts, location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - Scene is set in: a dimly lit room in the dilapidated seaside hotel — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • glass, examined, crime, scene [clue_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: victim, drink, tampered
    ...
    • statements, witnesses, sylvia, health [clue_2] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: murderer, took, advantage, sylvia, complaints
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
         Paragraph 2 (immediately following): The detective or POV character explicitly reasons
           about what this evidence implies — who it implicates, why it may be unreliable,
           or what inference it supports. This must be a separate full paragraph, not a sentence appended to Paragraph 1.
    • glass, examined, crime, scene [clue_mid_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: victim, drink, tampered
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
         Paragraph 2 (immediately following): The detective or POV character explicitly reasons
           about what this evidence implies — who it implicates, why it may be unreliable,
           or what inference it supports. This must be a separate full paragraph, not a sentence appended to Paragraph 1.
    • details, poison, timing, noted, investigation [clue_fp_contradiction_step_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: extract, indicates, intentional, poisoning, rather, natural, causes
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The half-empty glass found near Sylvia's body, containing remnants of a rare botanical extract."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the victim died from something other than natural causes, contradicting the initial assumptions of her fragile health."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_1] Captain Ivor Hale mentions that Sylvia had a history of health issues, suggesting her death could be natural.
...
[
  {
    ...
    "title": "Discovery",
    "setting": {
      "location": "a dimly lit room in the dilapidated seaside hotel",
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor stands frozen, grappling with the horror of the discovery."
      ]
    },
    "summary": "In the dimly lit room of the dilapidated seaside hotel, Eleanor Voss stumbles upon the lifeless body of Sylvia Trent, her friend and confidante. Shocked, she calls for the others, revealing the grim scene to Dr. Mallory Finch, Captain Ivor Hale, Beatrice Quill, and Hugo Vane. As they gather, Eleanor notices the half-empty glass beside Sylvia's body, suggesting foul play rather than natural causes.",
    "beat": "gathering",
    "estimatedWordCount": 1800,
    "pivotElement": "The half-empty glass found near Sylvia's body, containing remnants of a rare botanical extract.",
    "factEstablished": "Establishes the victim died from something other than natural causes, contradicting the initial assumptions of her fragile health.",
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_1",
      "placementDetail": "Captain Ivor Hale mentions that Sylvia had a history of health issues, suggesting her death could be natural."
    },
    "emotionalRegister": "The atmosphere is thick with dread and uncertainty as the crime is revealed.",
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (poison, rare, botanical, extract, carefully, dosed, coincide, moments, victim, metabolic, rate, slowest) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_1] (half, empty, glass, near, victim, body, contains, remnants, rare, botanical, extract) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_2] (complaints, exploited, murderer, mask, true, nature, death) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_mid_1] (half, empty, glass, near, victim, body, contains, remnants, rare, botanical, extract) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_fp_contradiction_step_1] (half, empty, glass, near, victim, body, contains, remnants, rare, botanical, extract) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
...
```text
{
  ...
  "chapters": [
    {
      ...
      "summary": "Eleanor Voss discovers Sylvia Trent dead in a dimly lit room of the dilapidated seaside hotel. The half-empty glass near Sylvia's body and witness statements about her health raise immediate suspicions, prompting Eleanor to begin her investigation as the household gathers in shock.",
      "paragraphs": [
  ...
  "audit": {
    ...
    "required_clues_present": "clue_mechanism_visibility_core: chapter 1 paragraph 2 | clue_1: chapter 1 paragraph 2 | clue_2: chapter 1 paragraph 3 | clue_mid_1: chapter 1 paragraph 2 | clue_fp_contradiction_step_1: chapter 1 paragraph 2",
...
PRIMARY FAILURES
- Chapter 1: clue evidence "A half-empty glass found near the victim's body contains remnants of a rare botanical extract." is absent. Include an on-page observation of "A half-empty glass found near the victim's body contains remnants of a rare botanical extract." (this clue reveals: The extract indicates intentional poisoning rather than natural causes.) in the first 2 paragraphs of the chapter, followed immediately by an explicit inference paragraph.

REWRITE PLAN
- Preserve paragraphs that are already valid, but fully rewrite every paragraph touched by a failing issue.
- Insert or move a dedicated observation-plus-inference block for each missing clue: "A half-empty glass found near the victim's body contains remnants of a rare botanical extract.". The observation and inference must be separate full paragraphs.

SUCCESS CHECKLIST
- Every listed issue below is resolved in this single attempt before you answer.
- Each missing clue appears on-page as observable evidence, followed immediately by a separate inference paragraph: "A half-empty glass found near the victim's body contains remnants of a rare botanical extract.".
...
• REPAIR [clue_visibility — attempt 2 — PARAGRAPH STRUCTURE REQUIRED]: 1 clue(s) still missing.
  ...
  Clue: "A half-empty glass found near the victim's body contains remnants of a rare botanical extract."
  ...
  Paragraph B (immediately after Paragraph A): The detective or POV character explicitly state: "The extract indicates intentional poisoning rather than natural causes.". Use first-person inference language ("She realised...", "He could not help but wonder..."). Full separate paragraph — not a tacked-on sentence.
...
RETRY CLASS: unknown
ATTEMPT: 1/3
OFFENDING TEXT: A half-empty glass found near the victim's body contains remnants of a rare botanical extract.
MANDATORY FIXES:
