...
- Project ID: `unknown`
- Timestamp: `2026-07-19T15:30:33.939Z`
...
**Discriminating Test**: A staged dinner is set up to observe reactions when a similar botanical extract is introduced, revealing knowledge of the poison's effects.

**Constraints**: 5 temporal, 6 access, 2 physical
