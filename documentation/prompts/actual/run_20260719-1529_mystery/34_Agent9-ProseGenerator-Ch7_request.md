...
- Project ID: ``
- Timestamp: `2026-07-20T17:15:56.173Z`
...
• [clue_fp_contradiction_step_3] finch, alibi, places, kitchen, time, death
...
CLUES ALREADY REVEALED TO READER: clue_1, clue_2, clue_mid_1, clue_fp_contradiction_step_1, clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_early_3, clue_early_1, clue_3, clue_5, clue_mid_2, clue_early_2, clue_mid_3, clue_core_elimination_chain — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): victim, drink, tampered | murderer, took, advantage, sylvia, complaints | victim, drink, tampered | extract, indicates, intentional, poisoning, rather, natural | mechanism, poisoning, deliberate, timed | complaints, used, mask, true, nature, death | complaints, used, mask, true, nature, death | mechanism, poisoning, deliberate, timed | finch, opportunity, poison, drink | hugo, vane, potential, motive | finch, opportunity, poison, drink | physical, trace, opportunity, indicate, hugo, vane | victim, indeed, poisoned | mallory, finch, ruled, suspect
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Alone, Eleanor leaned once more against the bookshelf, the rough wood steady beneath her hand. The evidence hovered at the edge of comprehension, a pattern glimpsed but not yet grasped. The flaw in the theory against Dr. Finch left her adrift, forced to confro..."
...
Known location profile anchors: The Seaward Hotel, The Library, The Dining Room, The Staff Kitchen, The Roof Access, the hotel bar
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Seaward Hotel", "The Library", "The Dining Room", "The Staff Kitchen", "The Roof Access", "the hotel bar"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 7: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the hotel bar". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Chapter 7:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Alone, Eleanor leaned once more against the bookshelf, the rough wood steady beneath her hand. The evidence hovered at the edge of comprehension, a pattern glimpsed but not yet grasped. The flaw in the theory against Dr....".
...
Chapter 7 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Hugo's admission of his financial desperation tied to Sylvia."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Reveals Hugo's motive, suggesting he had a strong reason to want Sylvia out of the way."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "tension": "Hugo's desperation becomes evident.",
      "microMomentBeats": [
        "Eleanor watches Hugo's hands tremble as he pours a drink."
      ]
    },
    "summary": "In the dimly lit hotel bar, Eleanor confronts Hugo about his motives. As they talk, Hugo's desperation for Sylvia's support in a development deal becomes clearer. Eleanor realizes that Hugo may have had the most to gain from Sylvia's death. The tension between them thickens as secrets are laid bare.",
    "beat": "secrets",
    "estimatedWordCount": 1500,
    "pivotElement": "Hugo's admission of his financial desperation tied to Sylvia.",
    "factEstablished": "Reveals Hugo's motive, suggesting he had a strong reason to want Sylvia out of the way.",
