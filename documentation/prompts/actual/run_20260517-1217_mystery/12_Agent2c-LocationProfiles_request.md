...
- Project ID: ``
- Timestamp: `2026-05-17T12:19:03.833Z`
...
- Era-authentic markers: petrol touring cars on county roads, early telephones in homes, typewriters standard in offices, radio broadcasts common in households, passenger trains at peak popularity, early commercial aviation starting to emerge, reliable automobiles for local travel, party-line telephone exchanges common
- Tone: Classic
- No anachronisms
...
Description: A sprawling country estate featuring a grand façade, manicured gardens, and a labyrinth of rooms and corridors, designed for both leisure and social gatherings.
...
Setting constraints:
- Physical constraints: Geography allows for limited escape routes due to surrounding woodlands, Architecture includes locked rooms and hidden passages, Weather conditions can affect outdoor evidence visibility
- Geographic isolation: Relatively isolated from nearby towns, limiting immediate outside assistance.
- Access control: Certain areas such as the study and cellar are restricted to household staff and family only, Daily routines dictate specific times when rooms are occupied or empty
...
- Transportation: passenger trains at peak popularity, early commercial aviation starting to emerge
- Social norms: Great Depression affecting social classes, rising tensions due to fascism in Europe
