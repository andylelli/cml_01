...
- Project ID: ``
- Timestamp: `2026-07-16T22:42:48.249Z`
...
- Era-authentic markers: radio broadcasting, early television sets, military radar, rationed wartime vehicles, post-war automobile boom, limited public transport, long-distance telephone calls, military-style coded messages
- Tone: Classic
- No anachronisms
...
Description: A vintage seaside hotel with Art Deco architecture, featuring a lobby with a grand chandelier, ocean-view balconies, and a dining area overlooking the beach.
Crime Scene: A vintage seaside hotel with Art Deco architecture
Weather: overcast with occasional rain, typical for coastal regions
Mood: tense, with an undercurrent of suspicion among guests
...
Setting constraints:
- Physical constraints: narrow hallways limiting movement, balconies accessible only from certain rooms, stormy weather affecting outdoor access
- Geographic isolation: The hotel is situated on a remote stretch of coastline, making outside assistance slow to arrive.
- Access control: staff-only areas including the kitchen and maintenance rooms, guest room privacy protocols, restricted access to the rooftop terrace
...
- Social norms: impact of WWII on social roles, increased presence of women in the workforce
