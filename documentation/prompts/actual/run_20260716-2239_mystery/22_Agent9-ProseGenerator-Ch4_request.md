...
- Project ID: ``
- Timestamp: `2026-07-16T22:47:06.320Z`
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Eleanor is haunted by her past actions, fearing that the truth of her former affair will surface and tarnish her reputation."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Ivor grapples with the weight of his deceit, fearing the fallout if his embezzlement is discovered, while also wrestling with the morality of his actions."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Beatrice is torn between her ambition and the fear of losing her social standing, leading her to question the value of her relationships."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Sylvia struggles with her jealousy and resentment towards the victim, fearing that her artistic dreams are slipping away."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Hugo struggles with the consequences of his greed, questioning whether his ambition is worth the cost of his integrity."
...
• [clue_7] captain, ivor, hale, expressed, jealousy, finch, recent, success
  Category: behavioral | Criticality: essential | Supports inference step 3
  Points to: captain, hale, jealousy, indicate, motive, murder
...
CLUES ALREADY REVEALED TO READER: clue_1, clue_2, clue_mechanism_visibility_core, clue_witness_last_seen, clue_3, clue_4, clue_core_contradiction_chain, clue_scratch_marks, clue_clock_time — do not reveal these as new information.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "By the time Eleanor finished her round of questions, the lobby had grown dimmer, shadows lengthening as the afternoon waned. Each suspect’s story had been laid bare, but none fit cleanly within the fractured timeline. The conflicting times from the clock and t..."
...
Known location profile anchors: The Oceanic Splendor, The Grand Dining Room, The Library, The Rooftop Terrace, Staff Quarters, the dining area of the vintage seaside hotel
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Oceanic Splendor", "The Grand Dining Room", "The Library", "The Rooftop Terrace", "Staff Quarters", "the dining area of the vintage seaside hotel"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 4: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a noun-phrase atmosphere — e.g. "The smell of damp stone in the cellar…" / "A chill from the landing…" / "The sound of the clock in the hall…". Pattern: "The/A [noun] of/in/from [place]…". Anchor opening in "the dining area of the vintage seaside hotel". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Chapter 3 (score 98/100):
  Quality gaps noted: scene grounding weakness
  Address in upcoming chapters: Open next chapter with a named location anchor plus at least two sensory cues and one atmosphere marker.
- Phrases to avoid (already overused in earlier chapters): "the lobby of the vintage seaside hotel", "s just a brush with failure really".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=13389; context=8063; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 4:
  ...
  - Scene is set in: the dining area of the vintage seaside hotel — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "By the time Eleanor finished her round of questions, the lobby had grown dimmer, shadows lengthening as the afternoon waned. Each suspect’s story had been laid bare, but none fit cleanly within the fractured timeline. Th...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • witnesses, confirm, beatrice, quill, theater [clue_core_elimination_chain]
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Captain Hale's expression of jealousy."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes multiple motives among the suspects while introducing a misleading clue regarding the letter."
...
[
  {
    ...
    "setting": {
      "location": "the dining area of the vintage seaside hotel",
      "timeOfDay": "Afternoon",
      "atmosphere": "Chilly, with an underlying tension"
    },
    "characters": [
      "Eleanor Voss",
      "Captain Ivor Hale",
    ...
    "purpose": "Explore suspects' motives and introduce misleading clues",
    "cluesRevealed": [
      "clue_7",
      "clue_culprit_direct_captain_ivor_hale"
    ],
    "dramaticElements": {
      "conflict": "Suspects begin to reveal their motivations.",
      "tension": "Each motive grows more plausible, but one remains a distraction.",
      "microMomentBeats": [
        "Eleanor watches the suspects, feeling the weight of their secrets."
      ]
    },
    "summary": "Eleanor gathers the suspects in the dining area to discuss their motives. Captain Hale expresses jealousy over Dr. Finch's recent success, while Beatrice reveals her fear of losing status due to Finch's influence. Sylvia, in turn, admits to feeling stifled by Finch's control over her artistic career. However, a letter threatening Finch is also mentioned, diverting suspicion.",
    "beat": "motives",
    "estimatedWordCount": 1800,
    "pivotElement": "Captain Hale's expression of jealousy.",
    "factEstablished": "Establishes multiple motives among the suspects while introducing a misleading clue regarding the letter.",
    ...
    "emotionalRegister": "Eleanor's investigation begins to reveal deeper motives and connections among the guests.",
