...
- Project ID: ``
- Timestamp: `2026-07-15T17:23:50.814Z`
...
- Dr. Mallory Finch
  ...
  Connection to victim: Mallory attended Hugo's charity events, finding them both enthralling and repulsive.; They share a cordial relationship from previous community efforts..
  Investigation relevance: access plausibility: high | alibi window: 8-10 PM | opportunity channel: medical supplies.
...
• [clue_mechanism_visibility_core] rare, botanical, extract, cleverly, disguised, tonic, victim, frequently, consumed, masking, true, cause
...
Known location profile anchors: The Grand Seaside Hotel, The Beachside Balcony, The Drawing Room, The Staff Quarters, The Hotel Lobby, the seaside hotel
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Grand Seaside Hotel", "The Beachside Balcony", "The Drawing Room", "The Staff Quarters", "The Hotel Lobby", "the seaside hotel"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=7549; context=10341; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • witnesses, recall, victim, often, drinking, specific, tonic [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The body of Hugo Vane, lifeless on the floor, with a half-empty bottle of herbal tonic nearby."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Hugo Vane is dead, raising immediate questions about the cause of death."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_1] Dr. Mallory Finch mentions Hugo Vane's pre-existing health condition — seeds false inference about natural causes.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor Voss pauses, her heart racing as she glimpses the body, a chill running down her spine."
      ]
    },
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_1",
      "placementDetail": "Dr. Mallory Finch mentions Hugo Vane's pre-existing health condition — seeds false inference about natural causes."
    },
    "emotionalRegister": "An air of elegance gives way to an undercurrent of tension as guests gather, foreshadowing the impending murder.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (rare, botanical, extract, cleverly, disguised, tonic, victim, frequently, consumed, masking, true, cause) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
...
```text
{
  ...
  "chapters": [
    {
      ...
      "summary": "Eleanor Voss discovers the body of Hugo Vane in the seaside hotel, with Dr. Mallory Finch arriving soon after. The unsettling scene and a half-empty bottle of herbal tonic raise immediate questions about the cause of death, setting Eleanor on her investigative path.",
      "paragraphs": [
  ...
  "note": "",
  "audit": {
    "locked_fact_phrases": "present in paragraph 9 | present in paragraph 5 | present in paragraph 9",
    "season_words_used": "winter, wintry, December, overcast, grey, cold, chill, rain",
    "discriminating_test_present": "no",
    "required_clues_present": "clue_mechanism_visibility_core: paragraph 2",
    "early_observation_present": "Eleanor notes the half-empty bottle of herbal tonic, its residue and Hugo Vane's habit of drinking it nightly: paragraph 2",
