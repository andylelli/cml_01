...
- Project ID: `unknown`
- Timestamp: `2026-07-15T17:14:05.697Z`
...
**Discriminating Test**: A controlled consumption test is set up where each suspect is asked to drink a tonic in the same setting as the victim, revealing the presence of the toxin.

**Constraints**: 5 temporal, 9 access, 2 physical
