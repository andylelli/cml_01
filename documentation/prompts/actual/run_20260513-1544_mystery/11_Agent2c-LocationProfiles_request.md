...
- Project ID: ``
- Timestamp: `2026-05-13T15:46:41.340Z`
...
- Era-authentic markers: petrol touring cars on county roads, domestic telephones with party lines, typewriters for correspondence, reliable automobiles for local travel, passenger trains as primary long-distance transport, early commercial aviation for distant travel, telegrams for urgent messages, aerial mail for faster correspondence
- Tone: Classic
- No anachronisms
...
Description: A large, opulent country estate with multiple wings, extensive gardens, and a grand entrance hall, reflecting the wealth of its owners.
...
Setting constraints:
- Physical constraints: narrow corridors limiting movement for large groups, locked rooms accessible only to specific individuals, weather conditions affecting outdoor evidence collection
- Geographic isolation: The estate is situated several miles from the nearest town, creating delays in outside assistance and communication.
- Access control: restricted areas such as the library and personal study, entry permissions required for staff and guests, daily routines dictating access to certain rooms at specific times

Era constraints to include:
- Technology: petrol touring cars on county roads, domestic telephones with party lines, typewriters for correspondence
- Transportation: reliable automobiles for local travel, passenger trains as primary long-distance transport
- Social norms: Great Depression creating class tensions, strict social hierarchies and etiquette
