...
- Timestamp: `2026-07-24T12:39:33.014Z`
...
• [clue_core_elimination_chain] annabelle, marwood, seen, multiple, household, members, garden, time, murder, corroborated, staff, logs
  Category: testimonial | Criticality: essential | Supports inference step 2
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): eliminates, annabelle, marwood, suspect

• [clue_eliminate_harold_grimshaw] harold, grimshaw, alibi, confirmed, servants, timetables, bell, chime, records, placing, kitchen, murder
  Category: testimonial | Criticality: essential | Supports inference step 2
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): eliminates, harold, grimshaw, suspect

• [clue_eliminate_margaret_cox] margaret, presence, corroborated, servants, statements, household, ledger, entries, placing, dining, room, murder
  Category: testimonial | Criticality: essential | Supports inference step 2
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): eliminates, margaret, suspect

• [clue_eliminate_simon_hastings] simon, hastings, accounted, stables, logs, correspondence, annabelle, marwood, murder, timeframe
  Category: testimonial | Criticality: essential | Supports inference step 2
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): eliminates, simon, hastings, suspect

• [clue_eliminate_annabelle_marwood_narrow] eliminates, annabelle, marwood, because, alibi, corroborated, garden, staff, logs, multiple, witnesses, narrowing
  Category: testimonial | Criticality: essential | Supports inference step 3
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): eliminates, annabelle, marwood, narrows, solution, toward, charles, fenwick
...
CLUES ALREADY REVEALED TO READER: clue_puncture_wound_ceremonial_dagger, clue_minute_hand_misalignment, clue_odd_clock_note, clue_pendulum_scratch, clue_wound_timing, clue_core_contradiction_chain, clue_mechanism_visibility_core, clue_minute_hand_incorrect_time, clue_fenwick_premeditation_silence, clue_fenwick_unique_means_skill — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): concrete, fair, play, indicator, stabbing, manner | clock, minute, hand, correctly, represent, true | initial, grandfather, clock, keeping, normal, time | concrete, physical, tampering, clock, pendulum | murder, occurred, clock, fifth, chime, exactly | explicitly, overturns, false, assumption, clock, kept | core, mechanism, detail, clock, tampered | contradiction, proving, clock, minute, hand, inaccurate | charles, fenwick, motive, planning | eliminates, suspects, lack, means, focusing, charles
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Outside, the wind rattled the windowpanes, and the last of the daylight faded into wintry dusk. The inspector felt the pressure of the investigation mounting, each clue a thread pulling her deeper into the tangle. She would have to move carefully—one misstep,..."
...
Known location profile anchors: Blackthorn Manor, Manor Orchard, Manor Main Hall, Servants' Quarters, Wine Cellar, Various manor locations: garden, kitchen, dining room, stables
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Blackthorn Manor", "Manor Orchard", "Manor Main Hall", "Servants' Quarters", "Wine Cellar", "Various manor locations: garden, kitchen, dining room, stables"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 5: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a temporal subordinate clause — e.g. "When [Name] entered…" / "After the last guest…" / "Before the household had stirred…" / "As the light faded…". Anchor opening in "Various manor locations: garden, kitchen, dining room, stables". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=16874; context=6633; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality]; truncated=[location_profiles, temporal_context, continuity_context, pronoun_accuracy]
...
- clue_culprit_direct_charles_fenwick must appear in Act 2, Scene 2 via Direct observation
...
Batch chapters: 5-5.
Investigation state at start: 10 clue(s) revealed to reader; approximately 4 unresolved suspect(s).
Must change by end: Reframe prior clue meaning and update suspect implications.
Suspect pressure target(s): Annabelle Marwood, Harold Grimshaw, Margaret Cox, Simon Hastings
...
- Chapter 5:
  ...
  - Scene is set in: Various manor locations: garden, kitchen, dining room, stables — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Outside, the wind rattled the windowpanes, and the last of the daylight faded into wintry dusk. The inspector felt the pressure of the investigation mounting, each clue a thread pulling her deeper into the tangle. She wo...".
  ...
  - PLANT OBLIGATIONS (incidental appearances): each item below MUST appear in this chapter as a passing physical detail a character sees, handles, or walks past — with its significance UNFLAGGED:
    • watchmaker, screwdriver, among, charles, fenwick, personal, effects [plant:clue_fenwick_tool_possession]
    • physical, timing, contradicts, assumption, correct, clock, time [plant:clue_early_contradiction_pendulum_tampered]
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Simon Hastings quietly exchanges a concerned glance with Annabelle Marwood"
      ]
    },
    ...
    "emotionalRegister": "New evidence reframes Charles Fenwick’s behavior and motives, intensifying psychological tension and suspicion.",
