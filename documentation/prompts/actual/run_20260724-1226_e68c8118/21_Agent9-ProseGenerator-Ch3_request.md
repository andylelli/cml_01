...
- Timestamp: `2026-07-24T12:36:37.648Z`
...
Rising unease emerges as early clues hint at temporal inconsistencies, fostering suspicion and self-doubt in the investigator.
...
Characters who may be funny: Inspector Evelyn Harcourt, Simon Hastings, Charles Fenwick
Permitted forms: dry wit, observational humour, polite savagery
Rationale: Early investigative scenes allow subtle wit and irony to humanize characters and relieve tension without diminishing seriousness.

## Reveal Groundwork (texture — do not explain, only plant)
- Plant one subtle observable beat related to: "Plant one subtle anomaly that can be re-read after the resolution.". Do not explain significance yet.
- Plant one subtle observable beat related to: "It transforms the initial suspicions cast on Annabelle Marwood's nervousness from potential guilt to understandable anxiety amid confusion about timing". Do not explain significance yet.
- Plant one subtle observable beat related to: "Furthermore, the forensic analysis of the wound drying gains new weight, that the murder occurred later than the official clock time, exposing the temporal deception at the case's core". Do not explain significance yet.
...
• [clue_core_contradiction_chain] measurement, grandfather, clock, pendulum, swing, period, shows, runs, faster, standard, time, overturning
  Category: temporal | Criticality: essential | Supports inference step 1
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): explicitly, overturns, false, assumption, clock, kept, standard, time

• [clue_mechanism_visibility_core] inspection, reveals, manor, grandfather, clock, pendulum, subtly, tampered, adjusting, concealed, screw, brass
  Category: physical | Criticality: essential | Supports inference step 1
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): core, mechanism, detail, clock, tampered

• [clue_minute_hand_incorrect_time] clock, minute, hand, correctly, represent, true, time, misaligned, inconsistent, indicators
  Category: temporal | Criticality: essential | Supports inference step 2
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): contradiction, proving, clock, minute, hand, inaccurate

• [clue_minute_hand_misalignment] Investigation of clock face and hands
...
• [clue_puncture_wound_ceremonial_dagger] Direct observation
  Category: structural | Placement: early (Act 1)
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): what this observation reveals about the time or circumstances of the crime.
...
CLUES ALREADY REVEALED TO READER: clue_puncture_wound_ceremonial_dagger, clue_minute_hand_misalignment, clue_odd_clock_note, clue_pendulum_scratch, clue_wound_timing — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): concrete, fair, play, indicator, stabbing, manner | clock, minute, hand, correctly, represent, true | initial, grandfather, clock, keeping, normal, time | concrete, physical, tampering, clock, pendulum | murder, occurred, clock, fifth, chime, exactly
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "In the hush that followed, the inspector allowed herself a single, wry thought: in a house ruled by schedules and records, it was the smallest irregularities that threatened to unravel everything. She would have to watch for the places where order frayed, and..."
...
kitchen, library, garden, manor, estate, flat, study, corridor
...
Chapter 2: Chapter 2: Subtle Discrepancies
  Events: "You say the clock has always kept perfect time?
...
Known location profile anchors: Blackthorn Manor, Manor Orchard, Manor Main Hall, Servants' Quarters, Wine Cellar, Grandfather clock room and adjacent study
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Blackthorn Manor", "Manor Orchard", "Manor Main Hall", "Servants' Quarters", "Wine Cellar", "Grandfather clock room and adjacent study"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 3: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with an explicit time marker — e.g. "That morning…" / "By the time dusk fell…" / "It was nearly four o'clock…" / "On the second day after the discovery…". Time must be in the first clause. Anchor opening in "Grandfather clock room and adjacent study". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=12092; context=11379; dropped=[humour_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_minute_hand_incorrect_time must appear in Act 1, Scene 3 via Cross-check contradiction
- clue_minute_hand_misalignment must appear in Act 1, Scene 3 via Investigation of clock face and hands
- clue_puncture_wound_ceremonial_dagger must appear in Act 1, Scene 3 via Direct observation
...
- Chapter 3:
  ...
  - Scene is set in: Grandfather clock room and adjacent study — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "In the hush that followed, the inspector allowed herself a single, wry thought: in a house ruled by schedules and records, it was the smallest irregularities that threatened to unravel everything. She would have to watch...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • timing, reveals, pendulum, swings, shorter, period, normal [clue_core_contradiction_chain] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
    ...
    • concealed, screw, pendulum, brass, adjusted, shortening [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
         Place this OBSERVATION in paragraph 1 or 2 (observation only — no inference about the culprit).
    • minute, hand, position, clock, face, match, time [clue_minute_hand_incorrect_time] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      OBSERVATION ONLY: put it on the page concretely — a character sees, handles, or hears it inside the scene. The detective may NOTICE (a pause, a second glance, a pocketed item) but must NOT state what it implies. Place the observation in paragraph 1 or 2.
  ...
  - PLANT OBLIGATIONS (incidental appearances): each item below MUST appear in this chapter as a passing physical detail a character sees, handles, or walks past — with its significance UNFLAGGED:
    • multiple, witnesses, confirm, annabelle, marwood, presence, outside, manor, critical, time, window [plant:clue_core_elimination_chain]
    • timetables, bell, records, place, harold, grimshaw, away, scene, relevant, time [plant:clue_eliminate_harold_grimshaw]
    • stable, logs, letters, confirm, simon, hastings, location, away, manor, interior [plant:clue_eliminate_simon_hastings]
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Harold Grimshaw listens from the doorway, tension visible in his posture"
      ]
    },
    ...
    "cluesPlanted": [
      ...
      "clue_eliminate_harold_grimshaw",
      "clue_eliminate_simon_hastings"
    ]
  }
]
```
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 3: the clue [clue_core_contradiction_chain] (measurement, grandfather, clock, pendulum, swing, period, shows, runs, faster, standard, time, overturning) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: the clue [clue_mechanism_visibility_core] (inspection, reveals, manor, grandfather, clock, pendulum, subtly, tampered, adjusting, concealed, screw, brass) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: the clue [clue_minute_hand_incorrect_time] (clock, minute, hand, correctly, represent, true, time, misaligned, inconsistent, indicators) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: the clue [clue_minute_hand_misalignment] (minute, hand, grandfather, clock, dial, subtly, misaligned, markers, inconsistent, proper, timekeeping) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: the clue [clue_puncture_wound_ceremonial_dagger] (body, discovery, scene, puncture, wound, blood, pooling, torn, garment, sleeve, visible, indicating) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
