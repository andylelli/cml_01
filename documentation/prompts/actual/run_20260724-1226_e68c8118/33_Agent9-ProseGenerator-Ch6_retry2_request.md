...
- Timestamp: `2026-07-24T12:41:14.439Z`
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=20064; context=4609; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, continuity_context, pronoun_accuracy]
...
PRIMARY FAILURES
- Chapter 6: Chapter 6 contains control-plane leakage (instruction_shape): "This was evidence, plain and undeniable: Charles Fenwick uniquely had the skill, access, and tools required to adjust the manor’s grandfather clock pendulum, unlike other suspects." (Remove prompt, validation, retry, or scaffold terminology from reader-facing prose)
- Chapter 6: a clue/test description was copied verbatim into the prose (21 consecutive words from "Charles Fenwick uniquely had the skill, access, and tools required to …"). Dramatize it as an observed detail, action, or dialogue in your own words — do NOT transcribe schema descriptions.
...
ATTEMPT: 2/3
OFFENDING TEXT: This was evidence, plain and undeniable: Charles Fenwick uniquely had the skill, access, and tools required to adjust the manor’s grandfather clock pendulum, unlike other suspects.
MANDATORY FIXES:
- Resolve template issues before accepting this batch.
- Chapter 6: Chapter 6 contains control-plane leakage (instruction_shape): "This was evidence, plain and undeniable: Charles Fenwick uniquely had the skill, access, and tools required to adjust the manor’s grandfather clock pendulum, unlike other suspects." (Remove prompt, validation, retry, or scaffold terminology from reader-facing prose)
- Chapter 6: a clue/test description was copied verbatim into the prose (21 consecutive words from "Charles Fenwick uniquely had the skill, access, and tools required to …"). Dramatize it as an observed detail, action, or dialogue in your own words — do NOT transcribe schema descriptions.
