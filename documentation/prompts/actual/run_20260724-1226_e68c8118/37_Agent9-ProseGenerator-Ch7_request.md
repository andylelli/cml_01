...
- Timestamp: `2026-07-24T12:42:39.489Z`
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the evening deepened and the fire burned low, Inspector Evelyn Harcourt made a silent promise: she would not let the clock’s betrayal become her own. The case was narrowing, the circle tightening—but the final answer, she knew, lay just beyond the reach of..."
...
Known location profile anchors: Blackthorn Manor, Manor Orchard, Manor Main Hall, Servants' Quarters, Wine Cellar, Manor servants’ quarters and study
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Blackthorn Manor", "Manor Orchard", "Manor Main Hall", "Servants' Quarters", "Wine Cellar", "Manor servants’ quarters and study"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 7: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "Manor servants’ quarters and study". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=19949; context=4587; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, continuity_context, pronoun_accuracy]
...
Suspect pressure target(s): Margaret Cox, Harold Grimshaw
...
- Chapter 7:
  ...
  - Scene is set in: Manor servants’ quarters and study — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the evening deepened and the fire burned low, Inspector Evelyn Harcourt made a silent promise: she would not let the clock’s betrayal become her own. The case was narrowing, the circle tightening—but the final answer,...".
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Margaret Cox quietly reflects on her loyalty to the household amidst the turmoil"
      ]
    },
