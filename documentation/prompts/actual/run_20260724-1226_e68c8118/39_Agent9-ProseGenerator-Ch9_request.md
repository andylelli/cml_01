...
- Timestamp: `2026-07-24T12:43:26.562Z`
...
• [clue_late_optional_slot_1] ornate, cufflink, bearing, charles, fenwick, family, crest, near, crime, scene, unnoticed, until
  Category: physical | Criticality: optional | Supports inference step 4
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): late, physical, linking, charles, fenwick, crime, scene
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the night deepened and the wind battered the manor’s walls, Inspector Evelyn Harcourt stood alone in the study, her shadow stretching across the floor. The case was narrowing, the circle tightening. The clock, once the household’s anchor, now stood at the h..."
...
Render this test MECHANISM as live, in-scene action and dialogue, composing ENTIRELY in your own words from these elements (reproducing any briefing phrase verbatim FAILS validation): examination, measurement, grandfather, clock, pendulum, swing, period, compared, standard, timepiece, servant, note

**MANDATORY CHECKLIST - Every box must be checked:**

☐ **Evidence Integration**
  ☐ Explicitly reference or use clue: "clue_odd_clock_note" (clue) (appears in Act 1, Scene 1)
  ☐ Explicitly reference or use clue: "clue_pendulum_scratch" (clue) (appears in Act 1, Scene 2)
  ☐ Explicitly reference or use clue: "clue_minute_hand_misalignment" (clue) (appears in Act 1, Scene 3)
  ☐ Explicitly reference or use clue: "clue_fenwick_tool_possession" (clue) (appears in Act 2, Scene 1)
  ☐ Explicitly reference or use clue: "clue_wound_timing" (clue) (appears in Act 2, Scene 3)
  ☐ Explicitly reference or use clue: "clue_examination_controlled_measurement" (clue) (appears in Act 2, Scene 3)
  ☐ Explicitly reference or use clue: "clue_core_contradiction_chain" (clue) (appears in Act 1, Scene 3)
  ☐ Explicitly reference or use clue: "clue_culprit_direct_charles_fenwick" (clue) (appears in Act 2, Scene 2)
...
☐ **Suspect Elimination**
  ☐ Clearly eliminate "Annabelle Marwood" from suspicion
  ☐ Clearly eliminate "Harold Grimshaw" from suspicion
  ☐ Clearly eliminate "Margaret Cox" from suspicion
  ☐ Clearly eliminate "Simon Hastings" from suspicion
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=25311; context=5997; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
Batch chapters: 9-9.
Investigation state at start: 21 clue(s) revealed to reader; approximately 4 unresolved suspect(s).
...
- Chapter 9:
  ...
  - Scene is set in: Grandfather clock room — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the night deepened and the wind battered the manor’s walls, Inspector Evelyn Harcourt stood alone in the study, her shadow stretching across the floor. The case was narrowing, the circle tightening. The clock, once th...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • cufflink, distinctive, family, crest, discovered, near, body [clue_late_optional_slot_1]
      Points to: late, physical, linking, charles, fenwick, crime, scene
    • handwritten, note, servant, describing, grandfather, clock, running, oddly, earlier [clue_odd_clock_note] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: initial, grandfather, clock, keeping, normal, time, tampering
  ...
  - ⚠ DISCRIMINATING TEST (constraint_proof) — MANDATORY real-time scene with dialogue and confrontation. DO NOT summarize it after the fact.
    ⚠ CULPRIT-UNIQUENESS REQUIRED: the decisive evidence must expose a fact or physical characteristic that ONLY Charles Fenwick could satisfy. Announcing that the crime method occurred does NOT qualify. The test must reveal access, knowledge, or physical proof that eliminates all non-culprits before naming Charles Fenwick.
    Elements the test must dramatize (compose the scene ENTIRELY in your own sentences from these — reproducing any briefing phrase verbatim FAILS validation): examination, measurement, grandfather, clock, pendulum, swing, period, compared, standard, timepiece, servant, note
    Cite these already-revealed clue IDs during the test: clue_odd_clock_note, clue_pendulum_scratch, clue_minute_hand_misalignment, clue_fenwick_tool_possession, clue_wound_timing, clue_examination_controlled_measurement, clue_core_contradiction_chain, clue_culprit_direct_charles_fenwick
    Eliminate on-page with explicit evidence: "Annabelle Marwood", "Harold Grimshaw", "Margaret Cox", "Simon Hastings" — state EXACTLY why each is ruled out (because / therefore / which proves).
    Convict: name "Charles Fenwick" explicitly as the murderer. Connect every clue to them using "because / therefore / which proves".
    Motive statement REQUIRED: the culprit must explicitly state or acknowledge their motive during or immediately after the confrontation. Canonical motive: "To silence Lady Beatrice who refused to help financially". Do not omit it.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Fenwick’s face tightens as the evidence mounts against him"
      ]
    },
    ...
    "emotionalRegister": "The test confirms tampering; Evelyn’s confrontation with Fenwick reaches its emotional and narrative peak.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 9: the clue [clue_odd_clock_note] (servant, note, mentions, manor, grandfather, clock, running, oddly, earlier, afternoon, faint, irregularity) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
