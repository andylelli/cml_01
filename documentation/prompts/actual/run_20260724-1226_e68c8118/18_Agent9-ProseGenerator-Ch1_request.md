...
- Timestamp: `2026-07-24T12:35:21.645Z`
...
- Inspector Evelyn Harcourt
  ...
  Connection to victim: Professional acquaintance of Lady Beatrice Marwood.
  Investigation relevance: is actively driving interviews and credibility checks in this scene.
  Suspicion/pressure cue seed: Careful observation.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Charles Fenwick
  Public identity anchor: Estate Manager; suspect 
  Connection to victim: Charles Fenwick was Lady Beatrice’s trusted estate manager but had a secret affair with her niece.; Lady Beatrice and Charles Fenwick had professional respect but recent distrust after rumors of mismanagement and discovery of Charles’s affair with Annabelle Marwood..
  Investigation relevance: access plausibility: high | alibi window: Claims to be in the library from quarter past four to quarter to six | opportunity channel: Library access.
  Suspicion/pressure cue seed: Nervous glances.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Annabelle Marwood
  Public identity anchor: Niece to Lady Beatrice, aspiring artist; suspect 
  Connection to victim: Lady Beatrice was Annabelle’s aunt and guardian, often critical of Annabelle’s bohemian lifestyle.; Lady Beatrice and Annabelle Marwood had a strained relationship due to Annabelle’s debts and rebellious behavior against Lady Beatrice’s expectations..
  Investigation relevance: access plausibility: medium | alibi window: Claims to be in her room from quarter past four to six | opportunity channel: Servants’ corridors.
  Suspicion/press
...
### Annabelle Marwood
Annabelle embodies youthful rebellion against the stifling expectations of 1930s aristocratic womanhood. Her bohemian spirit and financial desperation highlight the tensions between tradition and modernity, as well as the limited agency afforded to women of her class. Her blunt speech and secret debts underscore the era’s social hypocrisies and the personal costs of maintaining appearances within rigid family structures.
Era intersection: Her personal struggles reflect the broader cultural shifts challenging class and gender roles during the early Depression era.
...
### Margaret Cox
Margaret Cox stands as the loyal yet resentful head housekeeper, embodying the complexities of service within a rigid class system. Her authority among servants contrasts with simmering anger toward the aristocracy, reflecting the era’s class tensions heightened by economic strain. Her deadpan speech and withheld truths reveal how those in subordinate roles navigate power dynamics and personal survival amid social upheaval.
Era intersection: Her internal conflict mirrors the growing but constrained awareness of class disparities and the desire for dignity among working-class women.

### Simon Hastings
Simon Hastings, the investigative journalist, represents the emerging media’s role in exposing aristocratic secrets during a time of social flux. His charm and ambition capture the era’s tension between tradition and modernity, while his ethical ambivalence highlights the complexities of truth-seeking in a stratified society. The 1930s context of rising political tensions and economic uncertainty shapes his motivations and the stakes of his investigation.
Era intersection: His pursuit of scandal reflects the growing public appetite for exposing elite secrets amid social and political upheaval.
...
Annabelle’s voice is direct and blunt, her speech swift and tinged with youthful impatience and sarcasm.
[comfortable] Look, I’m not here to sugarcoat anything. The truth’s often less pretty than the stories told.
[evasive] I was exactly where I said I was. There’s no need to twist my words into something they’re not.
[stressed] You think I want this hanging over me? I’m just trying to survive the day like everyone else.
Humour: Her bluntness often cuts through pretense, offering a raw, if sometimes uncomfortable, levity.
...
Margaret speaks plainly and deadpan, with a steady tone that conveys authority and weary resignation.
[comfortable] I see to it that things run as they should. No more, no less.
[evasive] I’m afraid I have no knowledge of such matters; my focus is the household’s order.
[stressed] There’s only so much one can tolerate before the strain shows. I do what I must.
Humour: Her deadpan delivery lends a dry, often unintentional humor to her statements.

### Simon Hastings (he/him/his)
Simon’s relaxed, conversational tone is peppered with wry observations and storytelling flourishes.
[comfortable] Isn’t it curious how things unfold? One moment a whisper, the next a storm.
[evasive] I was speaking with staff in the garden. The details beyond that are, shall we say, elusive.
[stressed] The truth is slippery in places, but I assure you, my intentions are nothing but honorable.
Humour: His observational humour provides a genial counterpoint to the manor’s tension.
...
### Simon Hastings (he/him — NEVER she/her)
Simon speaks with a relaxed, conversational tone, peppered with wry observations and a natural storytelling flair
His manner is approachable, often using rhetorical questions and casual asides to engage listeners and disarm suspicion.
He wrestles with the ethical ambiguity of exploiting tragedy for personal gain, torn between journalistic integrity and ambition.
Voice colour: Simon Hastings uses observational humour — let it surface in their dialogue where natural, not in every line.
...
• [clue_puncture_wound_ceremonial_dagger] body, discovery, scene, puncture, wound, blood, pooling, torn, garment, sleeve, visible, indicating
  Category: physical | Criticality: essential | Supports inference step 1
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): concrete, fair, play, indicator, stabbing, manner, death

• [clue_minute_hand_misalignment] minute, hand, grandfather, clock, dial, subtly, misaligned, markers, inconsistent, proper, timekeeping
  Category: physical | Criticality: essential | Supports inference step 2
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): clock, minute, hand, correctly, represent, true, time

• [clue_odd_clock_note] Direct observation of servant’s written note
...
Known location profile anchors: Blackthorn Manor, Manor Orchard, Manor Main Hall, Servants' Quarters, Wine Cellar, Main hall of the manor
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Blackthorn Manor", "Manor Orchard", "Manor Main Hall", "Servants' Quarters", "Wine Cellar", "Main hall of the manor"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "Main hall of the manor". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=8144; context=12358; dropped=[none]; truncated=[first_appearance_contracts, location_profiles, temporal_context, pronoun_accuracy]
...
- clue_odd_clock_note must appear in Act 1, Scene 1 via Direct observation of servant’s written note
...
- Chapter 1:
  ...
  - VICTIM IDENTITY LOCK (MANDATORY): name the victim as "Lady Beatrice Marwood" in the discovery scene. After first mention, do not use unnamed placeholders such as "the victim" without naming Lady Beatrice Marwood in the same paragraph.
  ...
  - Scene is set in: Main hall of the manor — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • puncture, wound, blood, pooling, torn, fabric, lady, beatrice, sleeve, observed [clue_puncture_wound_ceremonial_dagger] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      OBSERVATION ONLY: put it on the page concretely — a character sees, handles, or hears it inside the scene. The detective may NOTICE (a pause, a second glance, a pocketed item) but must NOT state what it implies. Place the observation in paragraph 1 or 2.
    • minute, hand, line, exactly, markers, clock, face [clue_minute_hand_misalignment] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      OBSERVATION ONLY: put it on the page concretely — a character sees, handles, or hears it inside the scene. The detective may NOTICE (a pause, a second glance, a pocketed item) but must NOT state what it implies. Place the observation in paragraph 1 or 2.
  - PLANT OBLIGATIONS (incidental appearances): each item below MUST appear in this chapter as a passing physical detail a character sees, handles, or walks past — with its significance UNFLAGGED:
    • timing, reveals, pendulum, swings, shorter, period, normal [plant:clue_core_contradiction_chain]
    • concealed, screw, pendulum, brass, adjusted, shortening [plant:clue_mechanism_visibility_core]
    • minute, hand, position, clock, face, match, time [plant:clue_minute_hand_incorrect_time]
    • corroborated, garden, staff, logs, witness, statements, exclude, annabelle, marwood, manor, time [plant:clue_eliminate_annabelle_marwood_narrow]
...
[
  {
    ...
    "cluesRevealed": [
      "clue_puncture_wound_ceremonial_dagger",
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Lady Beatrice Marwood stands silently near the body, her grief barely concealed"
      ]
    },
    ...
    "emotionalRegister": "A heavy, somber mood suffuses the manor with the shock of Lady Beatrice’s murder and the eerie silence of the malfunctioning clock.",
    ...
    "cluesPlanted": [
      ...
      "clue_minute_hand_incorrect_time",
      "clue_eliminate_annabelle_marwood_narrow"
    ]
  }
]
```
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 1: the clue [clue_odd_clock_note] (servant, note, mentions, manor, grandfather, clock, running, oddly, earlier, afternoon, faint, irregularity) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_puncture_wound_ceremonial_dagger] (body, discovery, scene, puncture, wound, blood, pooling, torn, garment, sleeve, visible, indicating) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_minute_hand_misalignment] (minute, hand, grandfather, clock, dial, subtly, misaligned, markers, inconsistent, proper, timekeeping) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
