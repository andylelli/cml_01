...
- Timestamp: `2026-07-24T12:28:50.432Z`
...
**Novelty Constraints**:
You must diverge from these seed cases: The Sundial Shadow Conspiracy, The Sundial’s Silent Verdict, The Thermally Sealed Study: A Manor House Mystery, The Garden Sundial Enigma, A Study in Scarlet, The Big Bow Mystery, the_clue_of_the_twisted_candle_cml2.yaml, the_leak_cml2.yaml, The Leavenworth Case, The Moonstone, The Mysterious Affair at Styles, The Mystery of the Yellow Room
...
- Prior run crime subtype: poisoning with delayed effect
- Prior run manner of death: poisoned with aconite concealed in ice cubes
- Prior run false assumption: Lord Charles Harcourt died exactly at solar noon, as indicated by the sundial’s shadow.
- Prior run discriminating test: constraint_proof
- Prior run crime subtype: strangulation with cord in locked study
- Prior run manner of death: strangled with a silk cord
- Prior run false assumption: The study door was unlocked and opened shortly after Lady Beatrice was last seen alive at early evening, so the murder must have occurred then.
- Prior run crime subtype: brass latch delayed gate bolt murder
- Prior run manner of death: struck with a heavy brass garden gate bolt
- Prior run false assumption: The garden gate was opened at noon as all household members and guests saw Lady Beatrice entering the grounds then.
...
**Uniqueness Seed**: run_e68c8118-f1d2-497a-a95a-73d7a66a4287-proj_035fdeda-92e1-4613-b170-1ffba5c017a1
...
Location: A large English manor house set in extensive grounds, featuring multiple outbuildings, servant quarters, and formal gardens. (Country house estate (Manor house))
...
Hard-logic focus tags: standard, hard-logic, mechanical, environmental, social, forensic
...
Backdrop: Amidst strict class divisions and economic strain, the Marwood family, their staff, and visitors are confined to a remote English manor where social protocols and estate duties heighten tensions and scrutiny following a sudden tragedy.
Era: 1930s (Rigid class distinctions separate gentry, staff, and visitors, with formal routines and deference to hierarchy intensified by the Great Depression's economic pressures and limited social mobility.)
Setting: A large English manor house set in extensive grounds with outbuildings, servant quarters, and formal gardens. • Country house estate (Manor house) • Typical early autumn in rural England—cool with intermittent drizzle affecting outdoor movement and evidence preservation.
Cast anchors: Inspector Evelyn Harcourt, Lady Beatrice Marwood, Charles Fenwick, Annabelle Marwood, Harold Grimshaw, Margaret Cox, Simon Hastings
Theme pressure: A cozy yet tense classic murder mystery where genteel appearances mask underlying anxieties shaped by social hierarchy and economic uncertainty.
...
1. The Manor Clock’s Pendulum Paradox
   - principle: physical_law | A precisely timed murder is masked by the manor’s grandfather clock pendulum, which due to a subtle tampering with its length and bob weight, caused a half-minute time drift during the victim's last hour, creating a false alibi based on the clock’s chimes.
   - illusion: The clock’s chimes mark the murder time exactly, as all household members heard and relied on them.
   - reality: The pendulum’s effective length was shortened by a hidden screw adjustment, increasing its swing frequency and causing the clock to run fast by thirty seconds per hour, thus the chimes heard did not correspond to actual real time, creating a shifted timeline.
   - fair clues: A faint scratch on the pendulum’s brass bob where the adjustment screw is hidden; The clock’s minute hand shows a subtle misalignment with the dial markers; A servant’s note referencing the clock ‘running oddly’ earlier that day
   - anti-trope: This is not a stopped or rewound clock but a cleverly altered mechanical timing device causing a gradual but measurable time distortion; it relies on physical laws of pendulum mechanics, not magic or hidden twins.
2. The Poisoned Fountain’s Invisible Current
   - principle: physical_law | A lethal dose was delivered into the victim’s drinking water via a poison that was introduced upstream in the manor’s garden fountain plumbing, exploiting the slow water flow and a concealed valve that reversed briefly to mix poison unnoticed.
   - illusion: Everyone assumed the water was fresh and uncontaminated at the time of drinking, as the fountain’s surface appeared still and clear.
   - reality: A hidden valve in the underground piping was manipulated to briefly reverse water flow just before the victim drank, mixing poison upstream that would otherwise have been flushed away, leaving no visible trace at the fountain itself.
   - fair clues: A faint scratch and grease mark on the valve lever concealed beneath a garden grate; Unusual residual sediment found inside the water basin; Servants’ inconsistent statements about when the fountain was last cleaned
   - anti-trope: This is not a simple poisoning by direct contact or ingestion but a subtle hydraulic manipulation requiring knowledge of the estate’s plumbing and timing, undermining assumptions about water purity.
3. The Garden Maze’s Echoing Whisper
   - principle: physical_law | A murder timed by auditory cues was misinterpreted because the garden maze’s hedges and stone walls created an echo delay that distorted the perceived timing of the victim’s scream, leading to false assumptions about the murder’s time and location.
   - illusion: Several witnesses claimed to hear the victim’s scream at a specific time and direction, creating a strong but false timeline.
   - reality: Sound echoes within the maze caused a delay of over a minute between the scream’s actual occurrence and when it was heard by witnesses, and reflections misled them about the scream’s source point.
   - fair clues: Unusually shaped hedge walls arranged in a parabolic pattern; A broken branch near the scream’s true origin inconsistent with witness statements; Measurements of echo delay times taken later by the investigator
   - anti-trope: The confusion is not due to lies or mistaken identity but a natural acoustic phenomenon that creates a measurable temporal and spatial contradiction, solvable by physics.
4. The Servants’ Timetable Trap
   - principle: social_logic | A false alibi was constructed by manipulating the household servants’ social logic and shift patterns, exploiting the natural cognitive bias toward trusting routine schedules to create a temporal contradiction in the murder timeline.
   - illusion: All servants uniformly testified to their presence in different parts of the house during the murder hour, seeming to confirm an impossible timeline that exonerated the culprit.
   - reality: The culprit exploited predictable servant shifts and social expectations to create overlapping alibis by using brief, unnoticed absences and handoffs, which only become apparent when the exact timing and social interactions are carefully reconstructed.
   - fair clues: A servant’s pocket watch stopped at a suspicious time; A half-finished meal tray found outside the kitchen; Discrepancies in the timing of servant bell chimes recorded in the household ledger
   - anti-trope: This is not a simple conspiracy or collusion but a logical exploitation of social patterns and human trust in routine, requiring careful timing and social inference.
5. The Library’s Reversed Ink Ledger
   - principle: physical_law | A forged ledger entry reversed the timeline of key events by using chemically treated invisible ink that only became visible under the heat of a fireplace, creating a false sequence of entries to mislead investigators.
   - illusion: The ledger appeared to show an innocent timeline of events, verified by servants and the victim’s handwriting forgeries.
   - reality: The culprit wrote false entries in invisible ink that revealed themselves only when warmed by the fireplace, and the ledger was switched mid-evening to confuse the true sequence of actions.
   - fair clues: Soot smudges on the ledger’s edges inconsistent with its claimed storage; A faint chemical odor detected near the fireplace; Discoloration pattern on the paper visible under daylight
   - anti-trope: This is a clever physical and chemical trick exploiting period ink technology, not a mere outright forgery or lost document, requiring scientific knowledge and timing.
...
**Setting & Era**:
- Decade: 1930s
- Location: A large English manor house set in extensive grounds, featuring multiple outbuildings, servant quarters, and formal gardens.
...
- Social Structure: strict class distinctions between gentry, staff, and visitors, formal daily schedules including meals and servant routines, expectations of deference to estate owner and hierarchy, limited social mobility intensified by Great Depression effects
- Tone: Cozy
- Theme: A classic murder mystery | hard-logic modes: standard, hard-logic, mechanical, environmental, social, forensic
...
- Use these exact names: Inspector Evelyn Harcourt, Lady Beatrice Marwood, Charles Fenwick, Annabelle Marwood, Harold Grimshaw, Margaret Cox, Simon Hastings
- Gender per character (copy exactly into each cast item's gender field): Inspector Evelyn Harcourt: female, Lady Beatrice Marwood: female, Charles Fenwick: male, Annabelle Marwood: female, Harold Grimshaw: male, Margaret Cox: female, Simon Hastings: male
- Detective Type: Inspector Evelyn Harcourt
- Victim Archetype: Lady Beatrice Marwood — MUST appear in cast with role_archetype "Victim". CRITICAL: "Lady Beatrice Marwood" is the victim and MUST NOT appear in culpability.culprits[] under any circumstances.
...
- Mechanism Families: constraint contradiction, inference-path trap, physical_law, temporal inference, physical-constraint proof, temporal, acoustics, social_logic, authority-channel manipulation, chemical reaction
- Hard-Logic Focus Tags: standard, hard-logic, mechanical, environmental, social, forensic
...
- CASE.hidden_model.mechanism.delivery_path[0] must be object
- CASE.hidden_model.mechanism.delivery_path[1] must be object
- CASE.hidden_model.mechanism.delivery_path[2] must be object
- CASE.hidden_model.mechanism.delivery_path[3] must be object
- CASE.hidden_model.mechanism.delivery_path[4] must be object
