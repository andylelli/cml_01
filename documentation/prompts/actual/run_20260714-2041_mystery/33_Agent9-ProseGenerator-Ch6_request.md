...
- Project ID: ``
- Timestamp: `2026-07-14T20:55:00.265Z`
...
• [clue_7] hugo, vane, experiencing, financial, difficulties
  Category: behavioral | Criticality: essential | Supports inference step 2
  Points to: hugo, vane, motive, murder

• [clue_core_elimination_chain] eliminates, eleanor, voss, because, seen, until, eight, thirty
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: eleanor, voss, murderer

• [clue_mid_1] witnesses, recall, hearing, raised, voice, coinciding, gramophone, playback
  Category: testimonial | Criticality: essential | Supports inference step 2
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Outside, the rain showed no sign of letting up. Within the dining room, the shadows grew longer, the air thick with secrets and the scent of cooling tea. Eleanor lingered, her thoughts circling the unanswered questions, knowing that the next revelation might c..."
...
Known location profile anchors: The Ocean View Hotel, Grand Lobby, Dining Room, Guest Room 312, Rooftop Terrace, the hotel lobby
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Ocean View Hotel", "Grand Lobby", "Dining Room", "Guest Room 312", "Rooftop Terrace", "the hotel lobby"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 6: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with an expository setup — e.g. "It was not until…" / "There had been no word since…" / "There was a note on the table…". Begin with "It was", "There was", or "There had been" followed immediately by a specific condition, event, or discovery. Do not open on generic mood alone — but still anchor the location and weave in the sensory + time-of-day grounding across the next sentence or two. Anchor opening in "the hotel lobby". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Phrases to avoid (already overused in earlier chapters): "a meeting at ten minutes past eight", "the victim s room in the seaside", "victim s room in the seaside hotel", "requesting a meeting at ten minutes past", "meeting at ten minutes past eight the", "eleanor voss pressed on to the next", "voss pressed on to the next concrete", "pressed on to the next concrete detail", "that detail shifted the reasoning eleanor voss", "detail shifted the reasoning eleanor voss weighed".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=19697; context=4115; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_2 must appear in Act 2, Scene 3 via Cross-check contradiction
...
- clue_late_1 must appear in Act 2, Scene 3 via Direct observation
...
Batch chapters: 6-6.
Investigation state at start: 12 clue(s) revealed to reader; approximately 2 unresolved suspect(s).
...
- Chapter 6:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Outside, the rain showed no sign of letting up. Within the dining room, the shadows grew longer, the air thick with secrets and the scent of cooling tea. Eleanor lingered, her thoughts circling the unanswered questions,...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • hugo, vane, fidgeting, avoiding, contact [clue_4]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • locked, door, signs, forced, entry [clue_5]
      Points to: locked, door, complicates, murder, scenario
    • witnesses, recalling, time, heard, noises [clue_6]
      Points to: sounds, room, suggest, someone, present
    • records, showing, hugo, financial, troubles [clue_7]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • gramophone, needle, resting, last, groove [clue_culprit_direct_1]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • note, content, suggesting, expectation [clue_early_1]
      Points to: timing, events, crucial, understanding, murder
    • gramophone, needle, resting, last, groove [clue_fp_contradiction_step_3]
      Points to: suggests, argument, took, place, indicating, presence, another, individual
    ...
    • hugo, vane, fidgeting, avoiding, contact [clue_late_1]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • witnesses, stating, heard, raised, voice [clue_mid_1]
      Points to: argument, took, place, indicating, another, person, presence
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Hugo's financial difficulties revealed as a motive."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes a potential motive for Hugo that complicates the investigation."
...
[
  {
    ...
    "purpose": "Explore motives and hidden connections",
    "cluesRevealed": [
      "clue_7",
    ...
    "dramaticElements": {
      "conflict": "Eleanor confronts hidden motives.",
      "tension": "Eleanor realizes the stakes are higher than anticipated.",
      "microMomentBeats": [
        "Eleanor pauses, reflecting on her own past connections with the victim."
      ]
    },
    "summary": "Eleanor discusses the case with Dr. Mallory Finch, exploring the motives behind the murder. She uncovers Hugo's financial difficulties, suggesting a motive tied to desperation. Eleanor's reflections hint at her own connections to the victim, deepening the tension.",
    "beat": "false_solution",
    "estimatedWordCount": 1800,
    "pivotElement": "Hugo's financial difficulties revealed as a motive.",
    "factEstablished": "Establishes a potential motive for Hugo that complicates the investigation.",
    ...
    "emotionalRegister": "Eleanor confronts the suspects, driving the tension to a breaking point.",
