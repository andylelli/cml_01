...
- Project ID: ``
- Timestamp: `2026-07-14T20:47:24.114Z`
...
- Eleanor Voss
  ...
  Connection to victim: Both part of the charity committee, but hold differing views on its direction.; Eleanor and Mallory had a heated disagreement during a recent committee meeting..
...
- Hugo Vane
  ...
  Connection to victim: Mallory distrusts Hugo due to his business practices.; They interacted during a charity event that raised funds for a hospital..
  Investigation relevance: access plausibility: medium | alibi window: 9:30 to 10:30 PM.
  Suspicion/pressure cue seed: Wealth.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.
...
• [clue_mechanism_visibility_core] gramophone, needle, still, groove, last, track
  Category: testimonial | Criticality: essential | Supports inference step 1
  Points to: gramophone, playing, continuously
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=7452; context=10070; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • gramophone, needle, resting, last, groove [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The gramophone's needle found still in the groove of the last track."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the victim was not alone at the time of death, contradicting initial assumptions."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor stands frozen at the door, heart racing as she processes the scene."
      ]
    },
    "summary": "Eleanor Voss arrives at the Seaside Hotel and discovers Dr. Mallory Finch and Hugo Vane in the victim's room. They stand horrified as Eleanor's eyes fall on the lifeless body of the victim, revealing a chilling scene. The gramophone's needle remains in the groove, suggesting something sinister has occurred.",
    "beat": "gathering",
    "estimatedWordCount": 1800,
    "pivotElement": "The gramophone's needle found still in the groove of the last track.",
    "factEstablished": "Establishes the victim was not alone at the time of death, contradicting initial assumptions.",
    ...
    "emotionalRegister": "The mood is tense and foreboding as guests grapple with the shock of the murder.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (gramophone, needle, still, groove, last, track) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
