...
- Project ID: ``
- Timestamp: `2026-07-14T20:53:39.633Z`
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Hugo wrestles with the consequences of his greed and the fear of losing everything he has built."
...
• [clue_fp_contradiction_step_3] witnesses, recall, hearing, raised, voice, coinciding, gramophone, playback
  Category: testimonial | Criticality: essential | Supports inference step 3
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_1, clue_3, clue_culprit_direct_hugo_vane, clue_fp_contradiction_step_1 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): gramophone, playing, continuously | meeting, expected, time, murder | manner, death, strangulation | direct, shows, hugo, vane, means, opportunity | indicates, recording, played, continuously, interrupted
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Eleanor let the silence fill the space once more. She was left with the cold outlines of fact: the ligature marks at Dr. Mallory Finch’s throat, the gramophone’s needle in its final groove, the note setting the hour of the meeting, and a man whose answers grew..."
...
- Phrases to avoid (already overused in earlier chapters): "the victim s room in the seaside", "victim s room in the seaside hotel".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=14931; context=6867; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 4:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Eleanor let the silence fill the space once more. She was left with the cold outlines of fact: the ligature marks at Dr. Mallory Finch’s throat, the gramophone’s needle in its final groove, the note setting the hour of t...".
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Hugo's nervous demeanor during questioning."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Hugo had access to the victim's room and a potential motive."
...
[
  {
    ...
    "purpose": "Interrogate Hugo and gather more information",
    "cluesRevealed": [
      "clue_4",
      "clue_5",
    ...
    "dramaticElements": {
      "conflict": "Hugo's nervousness raises more suspicion.",
      "tension": "Eleanor presses him for details.",
      "microMomentBeats": [
        "Eleanor's voice shakes slightly as she questions Hugo, revealing her own anxiety."
      ]
    },
    "summary": "Eleanor cautiously interrogates Hugo Vane, noting his nervous demeanor. As he tries to explain his whereabouts, she presses him for details about his relationship with the victim. The locked door to the victim's room is discussed, raising further questions about access and opportunity.",
    "beat": "motives",
    "estimatedWordCount": 1800,
    "pivotElement": "Hugo's nervous demeanor during questioning.",
    "factEstablished": "Establishes that Hugo had access to the victim's room and a potential motive.",
    ...
    "emotionalRegister": "The discovery of the handwritten note shifts the narrative direction significantly.",
...
```text
{
  ...
  "chapters": [
    {
      ...
      "summary": "Eleanor interrogates Hugo Vane in the tense hush of the hotel lounge, probing his motives and access to Dr. Mallory Finch’s room. Hugo’s nervousness and evasions raise suspicion, while the physical evidence—locked door, gramophone needle, and witness accounts—complicate the timeline and deepen the mystery.",
      "paragraphs": [
        ...
        "A pause settled, thick as the fog outside. Eleanor’s own voice trembled slightly as she pressed on, betraying her anxiety despite her efforts at control. “Then how do you explain the door being locked from the inside? If you didn’t have a key, and she didn’t let you in—”",
  ...
  "note": "",
  "audit": {
    "locked_fact_phrases": "present in paragraph 7, 12 | absent",
    "season_words_used": "wintry, winter, rain, drizzle, fog, grey, damp",
    "discriminating_test_present": "no",
    "required_clues_present": "clue_4: paragraph 2, 17; clue_5: paragraph 4, 9, 13; clue_culprit_direct_1: paragraph 12; clue_fp_contradiction_step_3: paragraph 6, 12",
    "early_observation_present": "Hugo’s fidgeting and avoidance: paragraph 2",
