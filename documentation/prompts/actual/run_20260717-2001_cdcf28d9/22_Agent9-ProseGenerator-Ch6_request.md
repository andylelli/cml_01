...
- Timestamp: `2026-07-17T20:11:36.308Z`
...
• [clue_7] charles, stanhope, uniquely, possesses, knowledge, clock, mechanisms, opportunity, tamper, library
  Category: temporal | Criticality: essential | Supports inference step 4
  Points to: identifies, charles, stanhope, unique, clock, tampering, capability

• [clue_8] charles, engineer, mechanical, interference, creating, false, timeline, suspect, skill, access
  Category: temporal | Criticality: essential | Supports inference step 4
  Points to: excludes, charles, stanhope, mechanical, interference

• [clue_14] charles, stanhope, uniquely, means, skill, access, execute, concealment, mechanism, involving, clock, sundial
  Category: behavioral | Criticality: essential | Supports inference step 4
  Points to: eliminates, suspects, unique, skill, access, charles, stanhope

• [clue_15] financial, pressure, political, disagreements, visible, charles, stanhope, correspondence, indicate, premeditation
  Category: behavioral | Criticality: essential | Supports inference step 4
  Points to: shows, charles, stanhope, premeditation, motive
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Bramwell paused at the door, glancing back at the assembled faces. ‘Remain available, if you please. The truth, I find, is rarely content to stay hidden. ’ As he stepped into the corridor, the ledger under his arm and the sound of the ticking clock in his ears..."
...
Known location profile anchors: Stanhope Manor Estate, Manor Courtyard by the Sundial, Manor Library, Servants’ Hall, Estate Gatehouse, Manor clock room and study
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Stanhope Manor Estate", "Manor Courtyard by the Sundial", "Manor Library", "Servants’ Hall", "Estate Gatehouse", "Manor clock room and study"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 6: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with an expository setup — e.g. "It was not until…" / "There had been no word since…" / "There was a note on the table…". Begin with "It was", "There was", or "There had been" followed immediately by a specific condition, event, or discovery. Do not open on generic mood alone — but still anchor the location and weave in the sensory + time-of-day grounding across the next sentence or two. Anchor opening in "Manor clock room and study". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=18734; context=4686; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, continuity_context, pronoun_accuracy]
...
- clue_20 must appear in Act 2, Scene 3 via Cross-check contradiction
- clue_21 must appear in Act 2, Scene 3 via Direct observation
...
- clue_culprit_direct_charles_stanhope must appear in Act 2, Scene 3 via Direct observation
...
Batch chapters: 6-6.
Investigation state at start: 14 clue(s) revealed to reader; approximately 4 unresolved suspect(s).
...
- Chapter 6:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Bramwell paused at the door, glancing back at the assembled faces. ‘Remain available, if you please. The truth, I find, is rarely content to stay hidden. ’ As he stepped into the corridor, the ledger under his arm and th...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • inspector, bramwell, conducts, timed, comparison, library, clock, pocket, watch [clue_12]
      Points to: provides, basis, timed, comparison, clock, accuracy
    • charles, stanhope, knowledge, access, correlate, timing, cloud, cover, affecting, sundial [clue_13]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • charles, clock, mechanism, knowledge, access, study, relevant, times [clue_14]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • charles, stanhope, letters, reveal, financial, stress, political, disputes [clue_15]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    ...
    • dense, cloud, bank, covered, quarter, past [clue_20]
      Points to: reinforces, contradiction, false, sundial, time, claim
    • library, clock, time, lags, behind, inspector, pocket, watch, timed, comparison [clue_21]
      Points to: supports, conclusion, deliberate, clock, tampering
    • charles, stanhope, known, expertise, clocks, access, study [clue_7]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • suspect, skill, access, clock, mechanism, except, charles [clue_8]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Charles’s hands tremble slightly as he discusses clock mechanisms"
      ]
    },
    ...
    "humourGuidance": {
      ...
      "condition": "Permitted only if delivered by a character with humourLevel > 0.7 and no direct threat or violence occurs"
    },
