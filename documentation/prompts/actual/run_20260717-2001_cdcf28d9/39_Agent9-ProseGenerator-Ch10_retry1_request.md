...
- Timestamp: `2026-07-17T20:25:20.209Z`
...
```text
{
  ...
  "note": "",
  "audit": {
    "locked_fact_phrases": "present in paragraphs 5, 8 | absent elsewhere",
    "season_words_used": "spring, springtime",
    "discriminating_test_present": "no",
    "required_clues_present": "Servant ledger, weather journal, medical report: paragraphs 3, 5, 6",
...
PRIMARY FAILURES
- Chapter 10: Chapter 10 may be missing the discriminating test scene (Include a scene that tests: A timed comparison is staged between the manor’s library clock and an external time standard using t...)
...
ATTEMPT: 1/3
OFFENDING TEXT: Chapter 10 may be missing the discriminating test scene (Include a scene that tests: A timed comparison is staged between the manor’s library clock and an external time standard using t...)
MANDATORY FIXES:
