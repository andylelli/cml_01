...
- Project ID: ``
- Timestamp: `2026-05-17T13:28:02.661Z`
...
- Era-authentic markers: petrol touring cars on county roads, domestic wiring with frequent outages, typewriters common in offices, reliable automobiles, peak passenger train services, early commercial aviation, party-line telephone exchanges, telegrams via local post offices
- Tone: Classic
- No anachronisms
...
Description: A large, sprawling country estate with expansive gardens, a grand entrance hall, and numerous rooms including a library, drawing room, and servants' quarters, reflecting both wealth and social hierarchy.
...
Setting constraints:
- Physical constraints: Geographic layout allows for limited escape routes and hidden areas within the estate., Architecture includes locked rooms and restricted areas for household staff., Weather conditions can affect outdoor movement and evidence preservation.
- Geographic isolation: The estate is situated several miles from the nearest town, limiting immediate access to outside help.
- Access control: Strict permissions required to enter certain areas of the house, such as the study and cellar., Daily routines dictate when rooms are occupied or accessible., Social hierarchies influence who can enter private spaces.

Era constraints to include:
- Technology: petrol touring cars on county roads, domestic wiring with frequent outages, typewriters common in offices
- Transportation: reliable automobiles, peak passenger train services
- Social norms: Great Depression creating economic hardship, rising class tensions and social stratification
