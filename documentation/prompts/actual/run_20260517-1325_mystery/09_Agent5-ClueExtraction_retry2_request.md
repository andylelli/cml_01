...
- Project ID: `unknown`
- Timestamp: `2026-05-17T13:27:13.609Z`
...
1. Generate a clue that makes the reader directly observe: "The clock in the drawing room shows ten minutes past eleven...."
   → observation | essential | early | temporal | step 1 | terms: clock, drawing, shows

2. Generate a clue that provides evidence for: "This indicates the time was altered, as Dr. Finch was last seen alive around eight o'clock...."
   → contradiction | essential | early | temporal | step 1 | terms: indicates, altered,, finch

3. Generate a clue that makes the reader directly observe: "Guests report the clock struck during dinner despite the murder occurring earlier...."
   → observation | essential | early | temporal | step 2 | terms: guests, report, clock

4. Generate a clue that provides evidence for: "This suggests the clock was tampered to create a false alibi for Beatrice Quill...."
   → contradiction | essential | early | temporal | step 2 | terms: suggests, clock, tampered

5. Generate a clue that makes the reader directly observe: "Tampering marks on the clock casing indicate recent adjustment...."
   → observation | essential | mid | temporal | step 3 | terms: tampering, marks, clock

6. Generate a clue that provides evidence for: "This proves that the clock was purposely altered just before the murder...."
   → contradiction | essential | mid | temporal | step 3 | terms: proves, clock, purposely

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "This indicates the time was altered, as Dr. Finch was last seen alive around eight o'clock...."
   → contradiction | essential | mid | temporal | step 1 | terms: indicates, altered,, finch

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "A mechanical clock was deliberately wound back to create a false alibi for Beatrice Quill, misleading guests about the timing of Dr. Finch's..."
...
10. Generate one essential mid-story clue whose description or pointsTo explicitly names Beatrice Quill and states the unique trace, preparation detail, or mechanism link that points to Beatrice Quill rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Beatrice Quill, mechanical, clock, deliberately

11. Generate a clue showing observable evidence of Beatrice Quill's premeditation or planning (Jealousy over Finch's attention). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: jealousy, finch's, attention
...
13. Generate one essential early or mid elimination clue that explicitly rules out Eleanor Voss and narrows the solution toward culprit Beatrice Quill. The pointsTo text must start with "Eliminates Eleanor Voss because ..." and cite corroborated evidence.
...
Create 2 red herrings that support the false assumption: "Dr. Mallory Finch was killed later than he actually was, allowing Beatrice Quill to establish her alibi."
...
Violations: 1. [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 2, 3; words: clock) and may support the true solution.; 2. [critical] Red Herring Separation: Red herring rh_2 overlaps inference corrections (steps: 1, 2, 3; words: finch, clock) and may support the true solution.
Warnings: None
Recommendations: Red herrings must support the false assumption only; Do not reuse correction-language terms from inference_path.steps[].correction in red herring text; Preserve misdirection without reinforcing culprit-identifying logic; Forbidden terms for red-herring rewrite: finch, beatrice, quill, alibi, clock; Prefer these temporal assumption terms instead: mallory, killed, later, actually, allowing, establish, guests, recall, striking, suggesting, place, dinner; Strict first-attempt contracts are active: apply strict source whitelist and required ID->source mappings exactly.; If any strict contract cannot be satisfied, return status=fail with unresolved blockers in audit.invalidSourcePaths.; Do not defer strict mapping and direct culprit evidence requirements to retry mode.
...
- must_fix[]:
  ...
  - [critical] Red Herring Separation: Red herring rh_2 overlaps inference corrections (steps: 1, 2, 3; words: finch, clock) and may support the true solution.
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
...
- required_direct_culprit_clue:
  ...
  - allowed_source_paths=CASE.cast[3].access_plausibility, CASE.cast[3].alibi_window, CASE.inference_path.steps[1].observation, CASE.inference_path.steps[1].correction, CASE.inference_path.steps[2].observation, CASE.inference_path.steps[2].correction
