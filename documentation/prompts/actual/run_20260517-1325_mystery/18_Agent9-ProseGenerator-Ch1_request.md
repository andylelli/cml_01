...
- Project ID: ``
- Timestamp: `2026-05-17T13:29:55.682Z`
...
Known location profile anchors: Middleton Manor, The Library, The Drawing Room, The Study, Servants' Quarters, the drawing room of the Quill residence
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Middleton Manor", "The Library", "The Drawing Room", "The Study", "Servants' Quarters", "the drawing room of the Quill residence"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the drawing room of the Quill residence". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.

PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=5516; context=10539; dropped=[none]; truncated=[pronoun_accuracy, location_profiles, temporal_context]
...
- Chapter 1:
  ...
  - Scene is set in: the drawing room of the Quill residence — reference it naturally within the paragraph, never as your opening phrase.
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The clock in the drawing room, stopped at ten minutes past eleven."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Beatrice Quill stands frozen, her eyes red from grief."
      ]
    },
    "summary": "Eleanor Voss arrives at the Quill residence only to find the body of the doctor Finch lying lifeless on the floor, mere feet from a clock showing ten minutes past eleven. Beatrice Quill, visibly shaken, stands nearby with Captain Hale, who is trying to maintain order.",
    ...
    "emotionalRegister": "The initial crime casts a dark shadow over the elegant facade of Middleton Manor.",
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 1: "The clock in the drawing room shows ten minutes past eleven." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: "A mechanical clock was deliberately wound back to create a false alibi for Beatrice Quill." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
