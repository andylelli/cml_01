...
- Project ID: ``
- Timestamp: `2026-07-13T19:40:22.373Z`
...
- Hugo Vane
  Public identity anchor: Writer; suspect 
  Connection to victim: Sylvia and Hugo often engage in witty banter, masking deeper tensions.; Sylvia once confronted Hugo about his harsh critiques of her hotel management..
  Investigation relevance: access plausibility: high | alibi window: Dinner time | opportunity channel: hotel dining room.
...
- Dr. Mallory Finch
  ...
  Connection to victim: directly affected by Sylvia Trent's death and its fallout.
  Investigation relevance: access plausibility: medium | alibi window: Evening of the murder | opportunity channel: medical supplies.
  Suspicion/pressure cue seed: nervous around questions about the victim.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Captain Ivor Hale
  Public identity anchor: Retired Navy Captain; suspect 
  Connection to victim: directly affected by Sylvia Trent's death and its fallout.
  Investigation relevance: access plausibility: high | alibi window: Dinner time | opportunity chann
...
Act 1 behaviour contract: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "The emotional turmoil stemming from his unrequited love for the victim fuels a desire for revenge, a dangerous cocktail of pride and regret that could lead him down a dark path." — do not surface in Act I.
...
• [clue_mechanism_visibility_core] slow, acting, poison, administered, drink, taking, effect, victim, consumed, specific, dish
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: poison, administered, drink

• [clue_mid_2] suggests, poison, ingested, immediately, before, death, drink
  Category: temporal | Criticality: essential | Supports inference step 1
...
Known location profile anchors: Cliffside Haven Hotel, Grand Lobby, Dining Room, Staff Quarters, Clifftop Balcony, the seaside hotel lobby
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Cliffside Haven Hotel", "Grand Lobby", "Dining Room", "Staff Quarters", "Clifftop Balcony", "the seaside hotel lobby"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=7853; context=12422; dropped=[none]; truncated=[first_appearance_contracts, location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • timing, sylvia, symptoms, aligns, second, course, dinner [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The shattered glass lying next to Sylvia's body, its contents spilled across the floor."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the victim died no later than twenty minutes past eight, contradicting several suspects' alibis."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor gazes at the floor, her heart racing as she dreads the implications of the discovery."
      ]
    },
    ...
    "emotionalRegister": "The atmosphere is thick with shock and mourning as guests grapple with the sudden loss.",
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (slow, acting, poison, administered, drink, taking, effect, victim, consumed, specific, dish) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_mid_2] (suggests, poison, ingested, immediately, before, death, drink) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
...
```text
{
  ...
  "chapters": [
    {
      ...
      "summary": "Eleanor Voss enters the seaside hotel lobby on a foggy summer morning and discovers Sylvia Trent dead on the dining room floor. As the guests are summoned, Eleanor is thrust into the role of investigator, observing the scene and noting the first contradictions in the timeline.",
      "paragraphs": [
  ...
  "audit": {
    ...
    "required_clues_present": "clue_mechanism_visibility_core: paragraph 8; clue_mid_2: paragraph 9",
    "early_observation_present": "Eleanor observes the glass and the timing of symptoms in paragraph 8 | present",
    "early_inference_present": "Eleanor reasons about the contradiction in the timeline in paragraph 9 | present"
  }
}
...
PRIMARY FAILURES
- Chapter 1: Chapter 1 opening block has weak sensory grounding (0 sensory markers found) (Include at least two sensory cues (sound/smell/tactile/visual) in the opening block)
- Chapter 1: Chapter 1 opening block has weak atmosphere/time grounding (Include at least one weather/time/atmosphere marker in the opening block to set the scene)
...
RETRY CLASS: unknown
ATTEMPT: 1/3
OFFENDING TEXT: Chapter 1 opening block has weak sensory grounding (0 sensory markers found) (Include at least two sensory cues (sound/smell/tactile/visual) in the opening block)
MANDATORY FIXES:
