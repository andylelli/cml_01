...
- Project ID: ``
- Timestamp: `2026-07-13T19:41:16.964Z`
...
Tension rises as suspicion begins to cloud relationships among the guests.
...
Rationale: Eleanor's dry wit can provide levity amidst the rising tension.
...
• [clue_1] timing, sylvia, symptoms, aligns, second, course, dinner
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: symptoms, triggered, specific, course, meal
...
• [clue_mid_2] Medical report analysis
  Category: structural | Placement: early (Act 1)
  Points to: what this observation reveals about the time or circumstances of the crime.
...
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): poison, administered, drink | timing, ingestion, contradicts, assumption, immediate, poisoning | timing, ingestion, contradicts, assumption, immediate, poisoning
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As she left the dining room, the contradiction in the guests’ timelines echoed in her mind—a discordant note that refused to resolve. The investigation had only just begun, but already the lines between truth and deception were blurring. The only certainty was..."
...
dining room, kitchen, corridor, lobby, flat
...
Known location profile anchors: Cliffside Haven Hotel, Grand Lobby, Dining Room, Staff Quarters, Clifftop Balcony, the hotel kitchen
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Cliffside Haven Hotel", "Grand Lobby", "Dining Room", "Staff Quarters", "Clifftop Balcony", "the hotel kitchen"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 3: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with an explicit time marker — e.g. "That morning…" / "By the time dusk fell…" / "It was nearly four o'clock…" / "On the second day after the discovery…". Time must be in the first clause. Anchor opening in "the hotel kitchen". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=12862; context=10224; dropped=[humour_guide, location_profiles]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_mid_2 must appear in Act 1, Scene 3 via Medical report analysis
...
Suspect pressure target(s): Dr. Mallory Finch, Hugo Vane
...
- Chapter 3:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As she left the dining room, the contradiction in the guests’ timelines echoed in her mind—a discordant note that refused to resolve. The investigation had only just begun, but already the lines between truth and decepti...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • witnesses, noted, sylvia, began, show, symptoms, meal [clue_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: symptoms, triggered, specific, course, meal
    ...
    • several, guests, noted, sylvia, lively, demeanor, throughout, meal [clue_9] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      ...
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         ...
         Paragraph 2 (immediately following): The detective or POV character explicitly reasons
           about what this evidence implies — who it implicates, why it may be unreliable,
           or what inference it supports. This must be a separate full paragraph, not a sentence appended to Paragraph 1.
    • several, guests, noted, sylvia, lively, demeanor, throughout, meal [clue_culprit_direct_hugo_vane] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
    ...
    • timing, sylvia, symptoms, aligns, second, course, dinner [clue_mid_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      ...
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         ...
         Paragraph 2 (immediately following): The detective or POV character explicitly reasons
           about what this evidence implies — who it implicates, why it may be unreliable,
           or what inference it supports. This must be a separate full paragraph, not a sentence appended to Paragraph 1.
    • witnesses, reported, seeing, sylvia, drink, glass, right, before, dinner [clue_mid_2] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
...
Chapter 3 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The glass with residue found in the kitchen."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the presence of a suspicious glass that could be linked to the poison, and Hugo's nervous behavior raises doubts about his innocence."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_1] Dr. Mallory Finch mentions that some guests thought they saw Sylvia looking unwell shortly before dinner — seeds false inference about her health.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor pauses, feeling the weight of their eyes on her as she questions their motives."
      ]
    },
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_1",
      "placementDetail": "Dr. Mallory Finch mentions that some guests thought they saw Sylvia looking unwell shortly before dinner — seeds false inference about her health."
    },
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 3: the clue [clue_1] (timing, sylvia, symptoms, aligns, second, course, dinner) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: the clue [clue_9] (witnesses, reported, seeing, sylvia, healthy, dinner) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
...
□ Chapter 3: the clue [clue_mid_1] (slow, acting, poison, administered, drink, taking, effect, victim, consumed, specific, dish) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: the clue [clue_mid_2] (suggests, poison, ingested, immediately, before, death, drink) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
