...
- Project ID: ``
- Timestamp: `2026-07-13T19:45:58.495Z`
...
• [clue_9] witnesses, reported, seeing, sylvia, healthy, dinner
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: supports, timeline, poisoning
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "She drew a slow breath, steadying herself. The next step was clear—she would need to test the timelines, to force a confrontation that would reveal the truth. But for now, she was alone with her doubts and her notes, the weight of the case pressing in from all..."
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=24485; context=5167; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 9:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "She drew a slow breath, steadying herself. The next step was clear—she would need to test the timelines, to force a confrontation that would reveal the truth. But for now, she was alone with her doubts and her notes, the...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • dinner, time, remains, late, texture, detail, case, background [clue_late_optional_slot_1]
      Points to: adds, late, texture, changing, essential, deduction, chain
    • several, guests, noted, sylvia, lively, demeanor, throughout, meal [clue_9] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: supports, timeline, poisoning
  ...
  - Sensory obligation — use at least two of: glow of candlelight on tables, sparkling glassware reflecting light | laughter and chatter, soft music playing | grilled meats and seafood. Mood: elegant excitement.
...
Chapter 9 (Act 3) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Eleanor's presentation of the evidence linking Hugo to the poison."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes Hugo's guilt through his reaction to the evidence presented."
...
[
  {
    ...
    "emotionalRegister": "The truth is revealed in a tense confrontation, altering the fates of all involved.",
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 9: the clue [clue_9] (witnesses, reported, seeing, sylvia, healthy, dinner) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
