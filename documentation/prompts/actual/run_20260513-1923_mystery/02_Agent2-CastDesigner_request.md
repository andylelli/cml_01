...
- Project ID: ``
- Timestamp: `2026-05-13T19:23:10.601Z`
...
**Setting**: 1930s - A large manor house set in extensive grounds, featuring formal gardens and a stable block, typical of the 1930s English countryside.
**Crime Type**: Murder
**Social Context**: Great Depression causing class tensions, rigid social hierarchies in country estates, increasingly visible fascism and political unrest in Europe
**Tone**: Classic
