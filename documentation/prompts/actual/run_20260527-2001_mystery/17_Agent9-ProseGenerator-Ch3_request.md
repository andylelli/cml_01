...
- Project ID: ``
- Timestamp: `2026-05-27T20:10:24.432Z`
...
Initial clues suggest tampering, stirring unease and suspicion amid the estate’s rigid social routines.
...
Rationale: Dry and sardonic humour can provide levity during investigative dialogue, reflecting character traits and easing narrative tension.
...
Act 1 behaviour contract: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "N/A - investigator with no personal motive" — do not surface in Act I.
...
Act 1 behaviour contract: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Captain Hale’s motive is compelling: he intends to hasten his inheritance by eliminating the victim, who planned to alter the will to reduce his share. Fearful that legal avenues would expose his prior financial mismanagement, he prefers the certainty of murder over contestation." — do not surface in Act I.
...
Act 1 behaviour contract: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Beatrice sees the victim’s death as an opportunity to destabilize the estate’s leadership, enabling her to leverage insider information for a lucrative position or payoff. The victim’s recent intention to terminate her employment after discovering a past indiscretion adds urgency and motive to her actions." — do not surface in Act I.
...
• [clue_13] The manor clock’s winding key shows fresh oil stains and a slight scratch on the back plate, indicating recent use and tampering.
  Category: physical | Criticality: essential | Supports inference step 1
  Points to: Physical evidence of recent winding key use and tampering.

• [clue_2] Witnesses heard the manor clock chime twice in quick succession just before it stopped, an abnormal behavior indicating the clock’s mechanism was disturbed.
  Category: temporal | Criticality: essential | Supports inference step 2
  Points to: Witnesses heard manor clock chime twice rapidly before stopping, indicating disturbance.

• [clue_3] The clock’s mechanism was found disturbed with scratch marks and irregularities, corroborating the abnormal chiming and tampering.
  Category: temporal | Criticality: essential | Supports inference step 2
  Points to: The clock’s mechanism was disturbed, confirming tampering.
...
Chapter 1: Chapter 1: The Stopped Clock
  Events: Eleanor Voss crossed the threshold of the study with a measured step, the faint patter of autumnal drizzle muffling the gravel outside.
...
Known location profile anchors: Stoneleigh Manor, The Great Hall, Stoneleigh Manor Library, Servants' Hall, Formal Gardens, Stoneleigh Manor, the study and adjoining hallway
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Stoneleigh Manor", "The Great Hall", "Stoneleigh Manor Library", "Servants' Hall", "Formal Gardens", "Stoneleigh Manor, the study and adjoining hallway"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 3: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with an explicit time marker — e.g. "That morning…" / "By the time dusk fell…" / "It was nearly four o'clock…" / "On the second day after the discovery…". Time must be in the first clause. Anchor opening in "Stoneleigh Manor, the study and adjoining hallway". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=9835; context=13366; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_13 must appear in Act 1, Scene 3 via Direct observation
...
- Chapter 3:
  ...
  - Scene is set in: Stoneleigh Manor, the study and adjoining hallway — reference it naturally within the paragraph, never as your opening phrase.
  - Opening atmosphere (MANDATORY — validator enforced): the first paragraph MUST contain at least one of: rain / wind / fog / storm / mist / thunder / evening / morning / night / dawn / dusk / season / afternoon / midday / noon / midnight / twilight / sunrise / sunset / daylight / sunlight / overcast / cloudy / bright / dark / grey / pale / cold / warm / chill / crisp / damp / drizzle / haze / lamplight / firelight. A chapter that omits all of these from its opening paragraph will be rejected.
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Resolute, she turned toward the door, ready to continue her inquiries. The fragile social order of Stoneleigh Manor was already fraying, and the truth lay hidden somewhere between whispered alibis and the silent testimon...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The manor clock’s winding key shows fresh oil stains and a slight scratch on the back plate, indicating recent use and tampering. [clue_13] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: Physical evidence of recent winding key use and tampering.
    ...
    • Witnesses heard the manor clock chime twice in quick succession just before it stopped, an abnormal behavior indicating the clock’s mechanism was disturbed. [clue_2] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: Witnesses heard manor clock chime twice rapidly before stopping, indicating disturbance.
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
         Paragraph 2 (immediately following): The detective or POV character explicitly reasons
           about what this evidence implies — who it implicates, why it may be unreliable,
           or what inference it supports. This must be a separate full paragraph, not a sentence appended to Paragraph 1.
    • The clock’s mechanism was found disturbed with scratch marks and irregularities, corroborating the abnormal chiming and tampering. [clue_3] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: The clock’s mechanism was disturbed, confirming tampering.
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
...
Chapter 3 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Witnesses’ report of the manor clock chiming twice in quick succession"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Confirms mechanical tampering caused abnormal clock behavior, casting doubt on the clock’s time as evidence"
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Beatrice briefly falters when recalling the clock’s chimes, hinting at hidden knowledge"
      ]
    },
    ...
    "emotionalRegister": "Initial clues suggest tampering, stirring unease and suspicion amid the estate’s rigid social routines.",
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 3: "The manor clock’s winding key shows fresh oil stains and a slight scratch on the back plate, indicating recent use and tampering." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: "Witnesses heard the manor clock chime twice in quick succession just before it stopped, an abnormal behavior indicating the clock’s mechanism was disturbed." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: "The clock’s mechanism was found disturbed with scratch marks and irregularities, corroborating the abnormal chiming and tampering." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
