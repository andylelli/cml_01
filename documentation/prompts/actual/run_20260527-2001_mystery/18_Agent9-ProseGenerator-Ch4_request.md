...
- Project ID: ``
- Timestamp: `2026-05-27T20:10:49.153Z`
...
• [clue_4] The victim’s pocket watch was found stopped at eleven-fifty, well after the manor clock’s stopped time of ten minutes past eleven.
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: Victim’s pocket watch stopped later than manor clock, indicating later time of death.

• [clue_5] The true time of death is later than the manor clock’s stopped time, invalidating alibis based on the clock’s displayed time.
  Category: temporal | Criticality: essential | Supports inference step 3
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_1, clue_13, clue_2, clue_3 — do not reveal these as new information.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Eleanor allowed herself a brief exhale, the momentary levity a welcome respite. Yet she knew the path ahead would demand unwavering attention to detail and a careful sifting of truths from half-truths. The manor clock’s backward winding was not merely a mechan..."
...
Known location profile anchors: Stoneleigh Manor, The Great Hall, Stoneleigh Manor Library, Servants' Hall, Formal Gardens, Stoneleigh Manor, victim’s bedroom
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Stoneleigh Manor", "The Great Hall", "Stoneleigh Manor Library", "Servants' Hall", "Formal Gardens", "Stoneleigh Manor, victim’s bedroom"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 4: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a noun-phrase atmosphere — e.g. "The smell of damp stone in the cellar…" / "A chill from the landing…" / "The sound of the clock in the hall…". Pattern: "The/A [noun] of/in/from [place]…". Anchor opening in "Stoneleigh Manor, victim’s bedroom". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Phrases to avoid (already overused in earlier chapters): "fresh oil stains and a slight scratch", "oil stains and a slight scratch on", "stains and a slight scratch on the", "and a slight scratch on the back", "a slight scratch on the back plate".
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=11296; context=13555; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 4:
  ...
  - Scene is set in: Stoneleigh Manor, victim’s bedroom — reference it naturally within the paragraph, never as your opening phrase.
  - Opening atmosphere (MANDATORY — validator enforced): the first paragraph MUST contain at least one of: rain / wind / fog / storm / mist / thunder / evening / morning / night / dawn / dusk / season / afternoon / midday / noon / midnight / twilight / sunrise / sunset / daylight / sunlight / overcast / cloudy / bright / dark / grey / pale / cold / warm / chill / crisp / damp / drizzle / haze / lamplight / firelight. A chapter that omits all of these from its opening paragraph will be rejected.
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Eleanor allowed herself a brief exhale, the momentary levity a welcome respite. Yet she knew the path ahead would demand unwavering attention to detail and a careful sifting of truths from half-truths. The manor clock’s...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The clock was deliberately wound backward by exactly forty minutes, not stopped naturally, as shown by the scratch marks on the clock back plate and fresh oil stains on the winding key found in the study. [clue_core_contradiction_chain]
      Points to: The clock was deliberately wound backward, not stopped naturally, indicating tampering.
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The victim’s pocket watch stopped at eleven-fifty"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the true time of death was later than the manor clock’s stopped time, invalidating some alibis"
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor pauses to reflect on the implications of the pocket watch’s time"
      ]
    },
    ...
    "emotionalRegister": "The victim’s pocket watch reveals a later time of death, shaking confidence in accepted alibis and timelines.",
