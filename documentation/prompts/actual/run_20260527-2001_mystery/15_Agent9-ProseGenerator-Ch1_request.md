...
- Project ID: ``
- Timestamp: `2026-05-27T20:09:31.850Z`
...
• [clue_mechanism_visibility_core] The clock’s mechanism relies on the manor clock and the study room setup to expose the false timing of the murder, revealing how the backward winding created a misleading time display.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: The mechanism relies on manor, clock, and study to expose the false timing.
...
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "Stoneleigh Manor, the study". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=5961; context=12280; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The clock’s mechanism relies on the manor clock and the study room setup to expose the false timing of the murder, revealing how the backward winding created a misleading time display. [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: The mechanism relies on manor, clock, and study to expose the false timing.
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The manor clock mechanism visible behind the glass, stopped at ten minutes past eleven"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the manor clock's stopped time and its mechanical complexity as a key element"
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor hesitates before entering the study, recalling the victim's last words"
      ]
    },
    ...
    "permittedBehavioursByAct": [
      ...
      {
        "characterName": "Victim",
        "behaviour": "N/A"
      }
    ],
    "redHerringPlacement": null,
    "emotionalRegister": "A tense, somber mood settles over the manor as the patriarch’s death is discovered beneath the frozen clock’s backward hands.",
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 1: "The clock’s mechanism relies on the manor clock and the study room setup to expose the false timing of the murder, revealing how the backward winding created a misleading time display." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
