...
- Project ID: ``
- Timestamp: `2026-05-17T09:22:51.136Z`
...
• [clue_1] The clock in the study shows the time as ten minutes past eleven.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: Indicates the time displayed on the clock at the scene.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=5453; context=10901; dropped=[none]; truncated=[pronoun_accuracy, location_profiles, temporal_context]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The clock in the study shows the time as ten minutes past eleven. [clue_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: Indicates the time displayed on the clock at the scene.
...
[
  {
    ...
    "summary": "In the study, the group gathers around the body of the victim, who lies lifeless with a stopped clock showing ten minutes past eleven. Eleanor, the amateur detective, takes it upon herself to investigate, noting the time discrepancy with the last sighting of the victim.",
    ...
    "emotionalRegister": "The gathering begins with a festive atmosphere overshadowed by unspoken tensions.",
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 1: "The clock in the study shows the time as ten minutes past eleven." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
