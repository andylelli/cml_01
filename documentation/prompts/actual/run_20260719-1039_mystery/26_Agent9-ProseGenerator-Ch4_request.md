...
- Project ID: ``
- Timestamp: `2026-07-19T10:47:19.107Z`
...
• [clue_8] hugo, vane, seen, near, sylvia, room, shortly, before, dinner
  Category: behavioral | Criticality: essential | Supports inference step 2
  Points to: hugo, vane, presence, near, scene, raises, suspicion

• [clue_11] eliminates, captain, ivor, hale, because, duty, time, murder
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_culprit_direct_hugo_vane, clue_core_contradiction_chain, clue_3, clue_4, clue_7 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): clock, misrepresent, time, death | direct, shows, hugo, vane, means, opportunity | clock, tampered, create, false, timeline | clock, incorrect, chiming, suggests, tampering | clock, time, altered, post, murder | timeline, events, inconsistent, clock, time
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Outside, Brighton’s streets remained shrouded in mist, the world indifferent to the drama unfolding within the hotel room. But inside, the Oceanview Grand Hotel, time had become a weapon, and Eleanor Voss was determined to discover who wielded it. The contradi..."
...
Known location profile anchors: The Oceanview Grand Hotel, The Rooftop Terrace, The Grand Dining Hall, The Hotel Library, the hotel lounge
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Oceanview Grand Hotel", "The Rooftop Terrace", "The Grand Dining Hall", "The Hotel Library", "the hotel lounge"
...
- Phrases to avoid (already overused in earlier chapters): "with the scent of damp wool and", "the scent of damp wool and the".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=13660; context=7760; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 4:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Outside, Brighton’s streets remained shrouded in mist, the world indifferent to the drama unfolding within the hotel room. But inside, the Oceanview Grand Hotel, time had become a weapon, and Eleanor Voss was determined...".
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Hugo's admission of financial troubles."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes multiple plausible motives for the suspects."
...
[
  {
    ...
    "setting": {
      ...
      "atmosphere": "Suspicion hangs in the air as motives are explored"
    },
    "characters": [
      "Eleanor Voss",
      "Hugo Vane",
    ...
    "dramaticElements": {
      "conflict": "Each suspect defends their actions while casting suspicion.",
      "tension": "Underlying tensions between characters surface.",
      "microMomentBeats": [
        "Eleanor watches Hugo's nervous fidgeting, questioning his composure."
      ]
    },
    "summary": "Eleanor interviews the suspects in the hotel lounge, delving into their relationships with Sylvia and uncovering potential motives. Hugo's financial troubles, Mallory's desire to protect the Voss family, and Beatrice's fear of exposure emerge as possible motives.",
    "beat": "motives",
    "estimatedWordCount": 1800,
    "pivotElement": "Hugo's admission of financial troubles.",
    "factEstablished": "Establishes multiple plausible motives for the suspects.",
    ...
    "emotionalRegister": "Eleanor uncovers the tampered clock, shifting her focus.",
