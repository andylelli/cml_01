...
- Project ID: `unknown`
- Timestamp: `2026-05-17T08:14:20.693Z`
...
1. Generate a clue that makes the reader directly observe: "The clock in the study was found stopped at ten minutes past eleven...."
   → observation | essential | early | temporal | step 1 | terms: clock, study, found

2. Generate a clue that provides evidence for: "This shows the clock was tampered with after Eleanor's death...."
   → contradiction | essential | early | temporal | step 1 | terms: shows, clock, tampered

3. Generate a clue that makes the reader directly observe: "Witnesses recall hearing the clock striking at odd intervals...."
   → observation | essential | early | temporal | step 2 | terms: witnesses, recall, hearing

4. Generate a clue that provides evidence for: "This suggests the clock was not functioning correctly at the time of the murder...."
   → contradiction | essential | early | temporal | step 2 | terms: suggests, clock, functioning

5. Generate a clue that makes the reader directly observe: "A discrepancy in the servant's log shows an entry exactly forty minutes after the murder...."
   → observation | essential | mid | temporal | step 3 | terms: discrepancy, servant's, shows

6. Generate a clue that provides evidence for: "This indicates the log was altered to create a false timeline...."
   → contradiction | essential | mid | temporal | step 3 | terms: indicates, altered, create

7. Generate a clue that makes the reader directly observe: "Dr. Mallory Finch's alibi states he was with Eleanor until 10:30 PM...."
   → observation | essential | mid | temporal | step 4 | terms: mallory, finch's, alibi

8. Generate a clue that provides evidence for: "This contradicts the tampering evidence and suggests premeditation...."
   → contradiction | essential | mid | testimonial | step 4 | terms: contradicts, tampering, evidence

9. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "This shows the clock was tampered with after Eleanor's death...."
   → contradiction | essential | mid | temporal | step 1 | terms: shows, clock, tampered

10. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The clock was wound back to create a false timeline for the murder...."
   → observation | essential | early | temporal | terms: clock, wound, create

11. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "A controlled comparison of the clock's striking mechanism with the time of Eleanor's death reveals t..."
   → observation | essential | mid | temporal | terms: controlled, comparison, clock's

12. Generate one essential mid-story clue whose description or pointsTo explicitly names Dr. Mallory Finch and states the unique trace, preparation detail, or mechanism link that points to Dr. Mallory Finch rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Dr. Mallory Finch, clock, wound, create

13. Generate a clue showing observable evidence of Dr. Mallory Finch's premeditation or planning (Desperation for funds). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: desperation, funds
...
16. Generate one essential early or mid elimination clue that explicitly rules out Eleanor Voss and narrows the solution toward culprit Dr. Mallory Finch. The pointsTo text must start with "Eliminates Eleanor Voss because ..." and cite corroborated evidence.
...
Objects: The clock in the study, The murder weapon

## Physical Evidence
- Fingerprints on the clock mechanism.

## Evidence-Sensitive Characters
- Eleanor Voss: sensitive items: Highly sensitive to details
- Dr. Mallory Finch: sensitive items: Sensitive to medical evidence
- Captain Ivor Hale: sensitive items: Sensitive to social status
- Beatrice Quill: sensitive items: Sensitive to social dynamics
...
Create 2 red herrings that support the false assumption: "Eleanor Voss's murder was committed after the clock showed a consistent time."
...
Violations: 1. [critical] Suspect Clue Coverage: Captain Ivor Hale is referenced but lacks elimination/alibi evidence.
Warnings: None
Recommendations: Every eligible non-culprit suspect must appear in at least one clue; Every eligible non-culprit suspect should include elimination/alibi support, not only name mentions; Clues can reference a suspect via their alibi, observed behaviour, or elimination evidence; Adding elimination clues for uncovered suspects does not require extra inference steps; Strict first-attempt contracts are active: apply strict source whitelist and required ID->source mappings exactly.; If any strict contract cannot be satisfied, return status=fail with unresolved blockers in audit.invalidSourcePaths.; Do not defer strict mapping and direct culprit evidence requirements to retry mode.
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Suspect Clue Coverage: Captain Ivor Hale is referenced but lacks elimination/alibi evidence.
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
...
- required_direct_culprit_clue:
  ...
  - allowed_source_paths=CASE.cast[1].access_plausibility, CASE.cast[1].alibi_window, CASE.cast[1].evidence_sensitivity[0], CASE.inference_path.steps[3].observation, CASE.inference_path.steps[3].correction
