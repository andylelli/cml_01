...
- Timestamp: `2026-05-29T17:57:48.899Z`
...
1. Generate a clue that makes the reader directly observe: "A ship’s clock winding key is found with a faint scratch around the hole, unusual oil stains, and th..."
   → observation | essential | early | temporal | step 1 | terms: ship’s, clock, winding

2. Generate a clue that provides evidence for: "The scratch and oil stains indicate manual forced reverse winding, causing the clock to show an arti..."
   → contradiction | essential | early | temporal | step 1 | terms: scratch, stains, indicate

3. Generate a clue that makes the reader directly observe: "Crew members testify hearing clock chimes at times conflicting with the stopped clock face, and the ..."
   → observation | essential | early | temporal | step 2 | terms: members, testify, hearing

4. Generate a clue that provides evidence for: "The clock chimes and log discrepancies prove the clock time was falsified, and actual ship time was ..."
   → contradiction | essential | early | temporal | step 2 | terms: clock, chimes, discrepancies

5. Generate a clue that makes the reader directly observe: "Ventilation shutdown logs show repeated hourly shutdowns increasing coal gas concentration near the ..."
   → observation | essential | mid | temporal | step 3 | terms: ventilation, shutdown, repeated

6. Generate a clue that provides evidence for: "The victim was poisoned gradually by coal gas, with poisoning symptoms appearing delayed and inconsi..."
   → contradiction | essential | mid | temporal | step 3 | terms: victim, poisoned, gradually

7. Generate a clue that makes the reader directly observe: "Wear marks on the bridge hatch locking mechanism and a ship engineer’s report describe a mechanical ..."
   → observation | essential | mid | temporal | step 4 | terms: marks, bridge, hatch

8. Generate a clue that provides evidence for: "This mechanism allowed the culprit to exit the bridge after committing the murder and lock the hatch..."
   → contradiction | essential | mid | temporal | step 4 | terms: mechanism, allowed, culprit

9. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The scratch and oil stains indicate manual forced reverse winding, causing the clock to show an artificially earlier time than actual...."
   → contradiction | essential | mid | temporal | step 1 | terms: scratch, stains, indicate

10. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "Captain Harold Finch reversed the ship’s bulkhead clock gear train, winding it back by forty minutes to create misleading temporal evidence...."
   → observation | essential | early | temporal | terms: captain, harold, finch

11. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "A controlled clock comparison test is staged where the ship’s bulkhead clock winding mechanism is an..."
   → observation | essential | mid | temporal | terms: controlled, clock, comparison

12. Generate one essential mid-story clue whose description or pointsTo explicitly names Captain Harold Finch and states the unique trace, preparation detail, or mechanism link that points to Captain Harold Finch rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Captain Harold Finch, captain, harold, finch

13. Generate a clue showing observable evidence of Captain Harold Finch's premeditation or planning (Prevent victim from revealing secret). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: prevent, victim, revealing

14. Generate a clue that explicitly eliminates suspect Edward Langley using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Edward Langley because ...").
   → elimination | essential | mid | testimonial | terms: Edward Langley

15. Generate a clue that explicitly eliminates suspect Marjorie Langley using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Marjorie Langley because ...").
   → elimination | essential | mid | testimonial | terms: Marjorie Langley

16. Generate one essential early or mid elimination clue that explicitly rules out Edward Langley and narrows the solution toward culprit Captain Harold Finch. The pointsTo text must start with "Eliminates Edward Langley because ..." and cite corroborated evidence.
   → elimination | essential | mid | testimonial | terms: Edward Langley, Captain Harold Finch
...
## Access Constraints
Actors: Captain Harold Finch, Edward Langley, Marjorie Langley, Detective Clara Benson, Crew members
Objects: Ship’s bulkhead clock, Victim’s cabin, Bridge locked hatch, Ventilation control panel
...
- Detective Inspector Clara Benson: sensitive items: Clock mechanism details, Crew testimony
- Edward Langley: sensitive items: Witness statements on movement, Clock time discrepancies
- Marjorie Langley: sensitive items: Witness accounts of bridge lounge presence, Timing of interactions with Helen Carmichael
- Captain Harold Finch: sensitive items: Captain's log entries, Clock maintenance records, Crew testimony about clock chimes
...
- constraint_space.time.contradictions index range: 0..3
- cast index range: 0..4

## Cast Name -> Index Map (for CASE.cast[N] paths)
- Detective Inspector Clara Benson -> 0
- Edward Langley -> 1
- Marjorie Langley -> 2
- Captain Harold Finch -> 3
- Helen Carmichael -> 4
...
Create 2 red herrings that support the false assumption: "The ship’s bulkhead clock shows the true time of death and the timeline of events can be trusted based on it."
...
- CASE.constraint_space.time.contradictions[3]
