...
- Project ID: `unknown`
- Timestamp: `2026-07-16T22:58:25.604Z`
...
**Era & Setting**: 1940s - Coastal Cliff
**Setting Lock**: All scenes must remain within this setting: Coastal Cliff. Do not move to a different location type.
...
Hugo drowned during the high tide as indicated by the hotel clock.
*Revealed: final act*
...
1. **The hotel clock shows twenty minutes past ten.**: The time indicated by the clock is not the actual time of death. → Narrows the window of opportunity for the murder.
2. **Witnesses recall seeing Hugo alive at a quarter past ten.**: Hugo could not have drowned at the time indicated by the clock. → Eliminates the possibility of drowning at high tide.
3. **The tide table has been recently altered.**: The murderer altered the tide table to mislead others. → Narrows suspicion toward the murderer who altered the tide table.

### The Discriminating Test
**Method**: trap
**Design**: The discriminating test compares table, clock, and hotel against the claimed timeline.
**Reveals**: The revealed facts are table, murder, and hotel.
...
### Early Clues (Act I)
- [clue_mechanism_visibility_core] temporal: The hotel clock shows twenty minutes past ten.
- [clue_core_contradiction_chain] temporal: The time indicated by the clock is not the actual time of death.
- [clue_3] testimonial: Witnesses recall seeing Hugo alive at a quarter past ten.
- [clue_4] temporal: Hugo could not have drowned at the time indicated by the clock.
...
- [clue_id_3] temporal: The time indicated by the clock is not the actual time of death.
- [clue_id_4] testimonial: Witnesses recall seeing Hugo alive at a quarter past ten.
- [clue_id_5] temporal: Hugo could not have drowned at the time indicated by the clock.

### Mid Clues (Act II)
- [clue_5] testimonial: The tide table has been recently altered.
- [clue_6] testimonial: The murderer altered the tide table to mislead others.
- [clue_7] temporal: The tide peak time is half past ten at night.
- [clue_8] temporal: Dr. Mallory Finch miscalculates the tide schedule.
- [clue_9] behavioral: Dr. Mallory Finch shows signs of financial desperation.
- [clue_10] testimonial: Eliminates Captain Ivor Hale because he was seen at the bar during the time of death.
- [clue_11] testimonial: Eliminates Beatrice Quill because she was at home with her family at the time of death.
- [clue_12] testimonial: Eliminates Sylvia Trent because she was at the library during the time of death.
...
- [clue_id_1] testimonial: The murderer altered the tide table to mislead others.
- [clue_id_2] temporal: Direct evidence links Dr. Mallory Finch to the mechanism access point before the discriminating test and excludes competing suspect timelines.
- [clue_id_6] testimonial: The tide table has been recently altered.
- [clue_id_7] temporal: The tide peak time is half past ten at night.
- [clue_id_8] temporal: Dr. Mallory Finch miscalculates the tide schedule.

### Late Clues (Act III)
- [clue_late_optional_slot_1] temporal: The hotel clock shows twenty minutes past ten. remains a late texture detail in the case background.

### Red Herrings
- [rh_1] Witnesses believe Hugo lobby during the high tide as indicated by the hotel hotel.
- [rh_2] The beach was crowded, leading many to assume Hugo's death was an accident during high tide.
...
- **Captain Ivor Hale**: Act 3, Scene 5
  - Method: Footprints leading away from the beach
  - Clues: clue_id_3, clue_id_4
- **Beatrice Quill**: Act 3, Scene 5
  - Method: Witnesses confirm her whereabouts
  - Clues: clue_id_5, clue_id_6
- **Sylvia Trent**: Act 3, Scene 5
  - Method: Inconsistent timeline of events
...
- **tide_time**: "twenty minutes past ten" — The time when the hotel clock stopped, indicating a key moment in the timeline.
- **witness_time**: "a quarter past ten" — The time witnesses last saw the victim alive, contradicting the supposed time of drowning.
- **tide_peak_time**: "half past ten at night" — The actual time of the high tide that was miscalculated by the murderer.


## PILLAR 4 — OUTLINE COMPLETENESS CONTRACT DATA

### Character Permitted Behaviours (use for permittedBehavioursByAct per scene)
- **Eleanor Voss**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Eleanor wishes to uncover the truth about the victim’s death to clear her own name and reputation." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Eleanor grapples with guilt over her past betrayal, fearing that her involvement in the investigation will unveil her own secrets." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Dr. Mallory Finch**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Dr. Finch feared the victim would expose her unprofessional conduct during a recent medical conference." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Dr. Finch wrestles with the guilt of unresolved feelings for the victim and the fear that her past indiscretions will come to light." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Captain Ivor Hale**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Ivor felt betrayed when the victim decided to pursue a relationship with someone else, taking a risk on the victim’s future." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Ivor struggles with feelings of betrayal and the fear that he will never find closure after losing the love he thought would return to him." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Beatrice Quill**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Beatrice believed that eliminating the victim would enhance her chances of winning Ivor’s affections." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Beatrice wrestles with feelings of jealousy and inadequacy, fearing that her ambitions may lead her down a dark path." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Sylvia Trent**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Sylvia wanted to protect her business from scandal and the potential closure it would bring." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Sylvia grapples with the guilt of her unethical decisions and the fear of losing everything she has built." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Hugo Vane**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Hugo was worried that the victim’s influence could ruin his reputation and philanthropic efforts." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Hugo grapples with the fear that his ambitions may lead to his downfall and the harm of those he wishes to help." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.

### Red Herrings (must be seeded in Act I–II scenes via redHerringPlacement)
- **rh_1**: Witnesses believe Hugo lobby during the high tide as indicated by the hotel hotel. (misdirection: This misleads the investigation by reinforcing the false timeline.)
- **rh_2**: The beach was crowded, leading many to assume Hugo's death was an accident during high tide. (misdirection: This creates a false narrative that obscures the true circumstances of his death.)
```
...
1. In Act III, include at least one scene where the detective explains why each non-culprit suspect is cleared with explicit elimination language (cleared, ruled out, alibi confirmed) and evidence references. The culprit (Dr. Mallory Finch) must be identified with a complete evidence chain.
