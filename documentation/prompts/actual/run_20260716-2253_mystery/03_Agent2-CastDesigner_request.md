...
- Project ID: ``
- Timestamp: `2026-07-16T22:53:31.767Z`
...
**Setting**: 1940s - A vintage seaside hotel featuring Art Deco architecture, with a grand lobby overlooking the beach and a series of guest rooms facing the ocean.
**Crime Type**: Murder
**Social Context**: impact of WWII on local population, increased presence of women in the workforce, growing tensions of the early Cold War
**Tone**: Classic
