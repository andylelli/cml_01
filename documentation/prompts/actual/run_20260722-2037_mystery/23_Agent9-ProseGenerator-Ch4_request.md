...
- Project ID: ``
- Timestamp: `2026-07-22T20:46:07.694Z`
...
A pivotal discovery shifts Eleanor's focus, deepening her emotional involvement.
...
Rationale: Tension scenes require a serious tone to convey the emotional stakes.
...
• [clue_mid_1] footprints, leading, beach, storage, area, anchor, kept
  Category: testimonial | Criticality: essential | Supports inference step 2
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): footprints, suggest, foul, play
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the group began to drift back toward the hotel, Eleanor lingered by the water’s edge. The cold seeped through her shoes, anchoring her in the present. She watched the waves crash and retreat, each surge erasing a little more of the past. In the hush that fo..."
...
Known location profile anchors: The Tides Hotel, The Oceanfront Dining Room, The Kitchen, Room 12, The Grand Lobby, the hotel dining room
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Tides Hotel", "The Oceanfront Dining Room", "The Kitchen", "Room 12", "The Grand Lobby", "the hotel dining room"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=13392; context=10553; dropped=[humour_guide, location_profiles, texture_pool, continuity_context]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_mid_1 must appear in Act 2, Scene 1 via Witness accounts
...
- Chapter 4:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the group began to drift back toward the hotel, Eleanor lingered by the water’s edge. The cold seeped through her shoes, anchoring her in the present. She watched the waves crash and retreat, each surge erasing a litt...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • distinct, footprints, sand [clue_mid_1]
    ...
    • witnesses, stating, captain, hale, finch [clue_culprit_direct_captain_ivor_hale]
  ...
  - PLANT OBLIGATIONS (incidental appearances): each item below MUST appear in this chapter as a passing physical detail a character sees, handles, or walks past — with its significance UNFLAGGED:
    • witnesses, discussing, last, sighting, finch [plant:clue_culprit_direct_1]
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The guests' conflicting statements about their feelings toward Dr. Finch."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes multiple motives for wanting Dr. Finch out of the picture."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor notices the way Beatrice's eyes narrow at the mention of Dr. Finch."
      ]
    },
    ...
    "emotionalRegister": "A pivotal discovery shifts Eleanor's focus, deepening her emotional involvement.",
