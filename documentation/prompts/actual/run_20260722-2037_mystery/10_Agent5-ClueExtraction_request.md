...
- Project ID: `unknown`
- Timestamp: `2026-07-22T20:40:09.055Z`
...
1. Generate a clue that makes the reader directly observe: "Tidal charts in the hotel lobby indicate the tide was high at 8:30 PM...."
   → observation | essential | early | testimonial | step 1 | terms: tidal, charts, hotel

2. Generate a clue that provides evidence for: "Dr. Finch could not have drowned at 8:30 PM as claimed...."
   → contradiction | essential | early | testimonial | step 1 | terms: finch, drowned, claimed.

3. Generate a clue that makes the reader directly observe: "Witnesses recall seeing Dr. Finch near the beach at 8:15 PM...."
   → observation | essential | early | testimonial | step 2 | terms: witnesses, recall, seeing

4. Generate a clue that provides evidence for: "If she was seen at 8:15 PM, she could not have drowned at 8:30 PM...."
   → contradiction | essential | early | testimonial | step 2 | terms: drowned

5. Generate a clue that makes the reader directly observe: "Footprints leading from the beach to the storage area where the anchor is kept...."
   → observation | essential | mid | physical | step 3 | terms: footprints, leading, beach

6. Generate a clue that provides evidence for: "The footprints suggest someone moved the victim's body post-drowning...."
   → contradiction | essential | mid | physical | step 3 | terms: footprints, suggest, someone

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "Dr. Finch could not have drowned at 8:30 PM as claimed...."
   → contradiction | essential | mid | testimonial | step 1 | terms: finch, drowned, claimed.

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The mechanism relies on drown, tidal, and chart to expose the false timing...."
   → observation | essential | early | testimonial | terms: mechanism, relies, drown,

9. Generate one essential EARLY clue giving a concrete, fair-play indicator of the manner of death (drowned) observable at the body-discovery scene — e.g. for drowning: water in the lungs, sodden clothing, or weed on the body. Do NOT name or explain the concealment trick; only the physical tell a witness could see at the scene.
   → observation | essential | early | testimonial | terms: drowned, water, sodden, drown, lungs

10. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "The discriminating test compares party, drown, and tidal against the claimed timeline...."
   → observation | essential | mid | temporal | terms: discriminating, compares, party,
...
11. Generate one essential mid-story clue whose description or pointsTo explicitly names Captain Ivor Hale and states the unique trace, preparation detail, or mechanism link that points to Captain Ivor Hale rather than any non-culprit.
   → observation | essential | mid | testimonial | terms: Captain Ivor Hale, mechanism, relies, drown,
...
12. Generate one essential early-or-mid clue establishing that Captain Ivor Hale UNIQUELY had the means/skill/access/knowledge required to execute the concealment mechanism, and that the other suspects did not — so the reveal relies only on this already-planted capability, never on a means introduced for the first time at the confrontation.
   → elimination | essential | mid | testimonial | terms: Captain Ivor Hale, mechanism, relies, drown,

13. Generate a clue showing observable evidence of Captain Ivor Hale's premeditation or planning (Jealousy over professional rivalry.). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: jealousy, professional, rivalry.
...
Create 2 red herrings that support the false assumption: "Dr. Mallory Finch drowned during the party, as guests recall seeing her shortly before the tide came in."
...
- STRICT STRUCTURAL CONTRACT (author ALL of these YOURSELF, as concrete scene-register clues — a character sees/hears/finds something. NEVER meta-boilerplate like "adds texture to the case background"; if you omit any, a deterministic pass will synthesize flat machine text in its place, which reads as machine-made):
    ...
    • REQUIRED ID: "clue_early_1" with sourceInCML=CASE.prose_requirements.clue_to_scene_mapping[2].clue_id
    • REQUIRED ID: "clue_mid_1" with sourceInCML=CASE.prose_requirements.clue_to_scene_mapping[3].clue_id
