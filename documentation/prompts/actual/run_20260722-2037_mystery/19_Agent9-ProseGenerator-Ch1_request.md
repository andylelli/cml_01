...
- Project ID: ``
- Timestamp: `2026-07-22T20:44:28.043Z`
...
- Eleanor Voss
  ...
  Connection to victim: Professional rivalry in their community work.; Both women have competed for community recognition and respect..
  Investigation relevance: is actively driving interviews and credibility checks in this scene.
  Suspicion/pressure cue seed: Personal connection to the victim..
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Captain Ivor Hale
  Public identity anchor: Naval Officer; suspect 
  Connection to victim: Mutual respect but differing views on women's roles.; Ivor appreciates Mallory's skills but often dismisses her ambitions..
  Investigation relevance: access plausibility: medium | alibi window: between 8:00 PM and 9:00 PM | opportunity channel: From the beach to the dining area..
...
- Beatrice Quill
  ...
  Investigation relevance: access plausibility: high | alibi window: between 8:00 PM and 9:00 PM.
...
- Sylvia Trent
  ...
  Connection to victim: directly affected by Dr. Mallory Finch's death and its fallout.
  Investigation relevance: access plausibility: high | alibi wind
...
Known location profile anchors: The Tides Hotel, The Oceanfront Dining Room, The Kitchen, Room 12, The Grand Lobby, the beach near the seaside hotel
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Tides Hotel", "The Oceanfront Dining Room", "The Kitchen", "Room 12", "The Grand Lobby", "the beach near the seaside hotel"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=7873; context=12036; dropped=[none]; truncated=[first_appearance_contracts, location_profiles, temporal_context, pronoun_accuracy]
...
- clue_early_1 must appear in Act 1, Scene 1 via Tidal charts in lobby
...
- Chapter 1:
  ...
  - PLANT OBLIGATIONS (incidental appearances): each item below MUST appear in this chapter as a passing physical detail a character sees, handles, or walks past — with its significance UNFLAGGED:
    • distinct, footprints, sand [plant:clue_mid_1]
    • tidal, charts, displayed, hotel, lobby [plant:clue_mid_2]
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The lifeless body of Dr. Mallory Finch washed ashore."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the victim as Dr. Mallory Finch, who was last seen shortly before her death."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor stares at the waves, the salty air heavy with dread."
      ]
    },
    ...
    "emotionalRegister": "The story opens with a sense of elegance, quickly overshadowed by the shock of the murder.",
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 1: the clue [clue_early_1] (witnesses, recall, seeing, finch, near, beach, quarter, twelve) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
