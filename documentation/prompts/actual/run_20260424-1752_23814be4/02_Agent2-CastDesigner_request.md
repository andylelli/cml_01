...
- Timestamp: `2026-04-24T17:52:50.605Z`
...
**Character Names** (pre-selected — use EXACTLY as given, do not alter, abbreviate, or substitute any name): Bernard Burgess, David Smart, Edna Noakes, Lottie Hagger, Bess Osborne
...
**Setting**: 1940s - An expansive manor house with multiple wings, extensive gardens, and a surrounding forest, reflecting the wealth of its owners.
**Crime Type**: Murder
**Social Context**: women increasingly in the workforce post-WWII, social hierarchies based on class and gender, increased scrutiny of behavior due to wartime trauma
**Tone**: Classic
