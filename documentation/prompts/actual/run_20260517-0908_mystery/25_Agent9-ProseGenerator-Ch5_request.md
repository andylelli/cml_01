...
- Project ID: ``
- Timestamp: `2026-05-17T09:13:58.047Z`
...
A critical pivot occurs when the tampering of the clock is discovered, altering the course of the investigation.
...
Permission: conditional — condition: If the moment allows for playful banter, Beatrice's humor can emerge.
Characters who may be funny: Beatrice Quill
Permitted forms: sardonic
Rationale: Permission is contextual — exercise authorial judgement based on character and tone.
...
• [clue_3] The tarnished clock hands suggest recent tampering with the clock.
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: This provides evidence of foul play.

• [clue_6] Dr. Mallory Finch showed a desire for money, which could be a motive.
  Category: behavioral | Criticality: essential | Supports inference step 2
  Points to: This suggests he had a motive for the murder.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Eleanor's heart raced as she considered the implications of their findings. They were all suspects now, bound by the threads of fate and deception. "We must find out who could have done this," Ivor insisted, her voice steady despite the turmoil around her. "We..."
...
Chapter 3: Chapter 3: The Investigation Begins
  Events: The rain drummed persistently against the windowpanes, a relentless reminder of the turmoil brewing within the study.
...
Known location profile anchors: Little Middleton Manor, The Drawing Room, The Library, The Stables, The Walled Courtyard, the library
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The Drawing Room", "The Library", "The Stables", "The Walled Courtyard", "the library"
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=10147; context=10557; dropped=[none]; truncated=[pronoun_accuracy, location_profiles, temporal_context]
...
- Chapter 5:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Eleanor's heart raced as she considered the implications of their findings. They were all suspects now, bound by the threads of fate and deception. "We must find out who could have done this," Ivor insisted, her voice st...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The tarnished clock hands suggest recent tampering with the clock. [clue_3]
      Points to: This provides evidence of foul play.
    • Dr. Mallory Finch showed a desire for money, which could be a motive. [clue_6]
      Points to: This suggests he had a motive for the murder.
  - Tonal contrast: include at least one beat of relief or ironic counterpoint. Do not sustain maximum tension for every paragraph.
  - Sensory obligation — use at least two of: Shadows pooling in corners, Dusty light illuminating the desk | The ticking of a clock, Occasional whispers from outside | The rich scent of old leather. Mood: sombre and contemplative.
...
Chapter 5 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Finch's emotional response."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes Finch had access to the clock and may have tampered with it."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Finch's hands tremble slightly as she recalls her last moments with Eleanor."
      ]
    },
    ...
    "emotionalRegister": "Revelations about relationships deepen the intrigue, challenging characters' loyalties.",
    ...
    "locationRegisterNote": "The library is a refuge of quiet contemplation, but it is also thick with unspoken secrets, where the scent of old leather mingles with the tension of recent events. It feels like a place where knowledge is both a comfort and a burden, heightening the stakes of the investigation. — Entering the library evokes a sense of mystery, as if the very walls hold the answers to the questions that haunt the characters."
  }
]
```
...
```text
{
  ...
  "audit": {
    ...
    "required_clues_present": "clue_3: paragraph 5 | clue_6: paragraph 4",
...
• Chapter 5: clue evidence "Dr. Mallory Finch showed a desire for money, which could be a motive." is absent. Include an on-page observation or reference to "Dr. Mallory Finch showed a desire for money, which could be a motive." (this clue reveals: This suggests he had a motive for the murder.) before the chapter ends.
...
• REPAIR [clue_visibility — attempt 2]: chapters 5 are missing 1 clue.
  ...
  Clue: "Dr. Mallory Finch showed a desire for money, which could be a motive."
  ...
  • Inference paragraph (immediately after): The detective or POV character state explicitly: "This suggests he had a motive for the murder.". Use first-person inference language ("She realised...", "He could not help but notice..."). This must be a full separate paragraph, not a tacked-on sentence.
