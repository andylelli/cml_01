...
- Timestamp: `2026-05-29T20:21:18.658Z`
...
• [clue_5] Guests report a single brief flash from the rooftop lamp at approximately ten-thirty pm, initially interpreted as a signal.
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: Indicates a timed signal was sent around the time of the murder, relevant to the timeline.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the autumnal light faded into dusk, the room grew colder, the ticking clocks echoing like a heartbeat in the silence. Parkins felt the weight of the investigation settle upon him anew. The tampering had shattered the initial assumptions, and the path to tru..."
...
Known location profile anchors: The Cliffhaven Hotel, Hotel Rooftop Terrace, Grand Lobby, Staff-Only Wing, Hotel Library, Hotel rooftop at dusk
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Cliffhaven Hotel", "Hotel Rooftop Terrace", "Grand Lobby", "Staff-Only Wing", "Hotel Library", "Hotel rooftop at dusk"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 4: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a noun-phrase atmosphere — e.g. "The smell of damp stone in the cellar…" / "A chill from the landing…" / "The sound of the clock in the hall…". Pattern: "The/A [noun] of/in/from [place]…". Anchor opening in "Hotel rooftop at dusk". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=10286; context=11156; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 4:
  ...
  - Scene is set in: Hotel rooftop at dusk — reference it naturally within the paragraph, never as your opening phrase.
  - Opening atmosphere (MANDATORY — validator enforced): the first paragraph MUST contain at least one of: rain / wind / fog / storm / mist / thunder / evening / morning / night / dawn / dusk / season / afternoon / midday / noon / midnight / twilight / sunrise / sunset / daylight / sunlight / overcast / cloudy / bright / dark / grey / pale / cold / warm / chill / crisp / damp / drizzle / haze / lamplight / firelight. A chapter that omits all of these from its opening paragraph will be rejected.
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the autumnal light faded into dusk, the room grew colder, the ticking clocks echoing like a heartbeat in the silence. Parkins felt the weight of the investigation settle upon him anew. The tampering had shattered the...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • Guests report a single brief flash from the rooftop lamp at approximately ten-thirty pm, initially interpreted as a signal. [clue_5]
      Points to: Indicates a timed signal was sent around the time of the murder, relevant to the timeline.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Sharon glances nervously toward the lamp, avoiding eye contact"
      ]
    },
    ...
    "emotionalRegister": "The revelation of deliberate clock tampering disrupts the timeline, heightening tension and suspicion among all parties.",
