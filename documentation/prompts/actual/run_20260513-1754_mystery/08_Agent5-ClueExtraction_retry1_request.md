...
- Project ID: `unknown`
- Timestamp: `2026-05-13T17:56:00.536Z`
...
1. Generate a clue that makes the reader directly observe: "Witnesses reported hearing the clock strike a different hour at the time of death...."
   → observation | essential | early | temporal | step 1 | terms: witnesses, reported, hearing

2. Generate a clue that provides evidence for: "The clock cannot be trusted as an accurate measure of time since it has been tampered...."
   → contradiction | essential | early | temporal | step 1 | terms: clock, cannot, trusted

3. Generate a clue that makes the reader directly observe: "A note in Eleanor's handwriting indicated she was to meet someone at a quarter to midnight...."
   → observation | essential | early | testimonial | step 2 | terms: eleanor's, handwriting, indicated

4. Generate a clue that provides evidence for: "The meeting time contradicts the clock's indication, suggesting the clock was adjusted...."
   → contradiction | essential | early | temporal | step 2 | terms: meeting, contradicts, clock's

5. Generate a clue that makes the reader directly observe: "Dr. Mallory Finch has access to the study and was the last person seen near the clock...."
   → observation | essential | mid | temporal | step 3 | terms: mallory, finch, access

6. Generate a clue that provides evidence for: "Finch had the opportunity and motive to tamper with the clock to mislead the investigation...."
   → contradiction | essential | mid | temporal | step 3 | terms: finch, opportunity, motive

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The clock cannot be trusted as an accurate measure of time since it has been tampered...."
   → contradiction | essential | mid | temporal | step 1 | terms: clock, cannot, trusted

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The clock was reset to show ten minutes past eleven, obscuring the actual time of death, which was a quarter to midnight...."
   → observation | essential | early | temporal | terms: clock, reset, minutes

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "The discriminating test compares clock, tamper, and witness against the claimed timeline...."
...
10. Generate one essential mid-story clue whose description or pointsTo explicitly names Dr. Mallory Finch and states the unique trace, preparation detail, or mechanism link that points to Dr. Mallory Finch rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Dr. Mallory Finch, clock, reset, minutes

11. Generate a clue showing observable evidence of Dr. Mallory Finch's premeditation or planning (Desire to cover up malpractice). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: desire, cover, malpractice
...
Create 2 red herrings that support the false assumption: "The murder took place at the time indicated by the clock."
...
Violations: 1. [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 1, 2, 3; words: clock, accurate) and may support the true solution.; 2. [critical] Red Herring Separation: Red herring rh_2 overlaps inference corrections (steps: 1, 2, 3; words: clock) and may support the true solution.
Warnings: None
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 1, 2, 3; words: clock, accurate) and may support the true solution.
