...
- Project ID: ``
- Timestamp: `2026-07-31T14:30:02.494Z`
...
• [clue_5] witnesses, recall, seeing, captain, hale, leave, terrace, shortly, before, twenty, eleven
  Category: temporal | Criticality: essential | Supports inference step 3
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): captain, hale, potential, involvement, murder
...
CLUES ALREADY REVEALED TO READER: clue_1, clue_2, clue_late_optional_slot_1, clue_core_contradiction_chain, clue_3, clue_culprit_direct_captain_ivor_hale, clue_4, clue_fp_elimination_sylvia_trent, clue_core_elimination_chain, clue_fp_elimination_hugo_vane — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): initial, belief, time, murder | timeline, events, surrounding, murder | nature, murder | flawed, timeline, assumption, regarding, murder | actual, time, death, significantly | captain, ivor, hale, direct, means, opportunity | mechanism, used, mislead, witnesses | eliminates, sylvia, trent, because, independent, corroboration | beatrice, quill, alibi | eliminates, hugo, vane, because, independent, corroboration
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Left alone in the library, Eleanor let her composure slip. She rubbed her temples, the pressure behind her eyes mounting. The evidence pointed to Beatrice, but her instincts rebelled. The library’s shadows seemed deeper than before, the silence more profound...."
...
Known location profile anchors: Oceanview Grand Hotel, Seaside Terrace, Grand Lobby, Hotel Library, the garden of the seaside hotel
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Oceanview Grand Hotel", "Seaside Terrace", "Grand Lobby", "Hotel Library", "the garden of the seaside hotel"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 7: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the garden of the seaside hotel". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=19900; context=4060; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 7:
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • displayed, time, clock [clue_culprit_direct_1]
...
Chapter 7 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Hale's admission of his troubled past with Finch."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Hale had a complex relationship with the victim, complicating motives."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor hesitates, torn between her feelings for Hale and her duty as an investigator."
      ]
    },
    ...
    "emotionalRegister": "A revelation recontextualizes relationships, exposing jealousy and ambition among the suspects.",
...
```text
{
  ...
  "chapters": [
    {
      ...
      "summary": "In the garden of the seaside hotel, Eleanor confronts Captain Hale about his relationship with Dr. Finch. Hale’s admission reveals a tangled, emotionally charged past, overturning Eleanor’s earlier theory and complicating the investigation.",
      "paragraphs": [
        ...
        "A shape moved near the hedge, drawing Eleanor’s attention. Captain Ivor Hale stood with his back to the hotel, hands thrust deep in his pockets, his posture rigid against the night’s damp. The faint sound of his boots scuffing the gravel echoed in the stillness, and for a moment, Eleanor hesitated, torn between the urge to retreat and the obligation to press on. The garden’s isolation seemed to magnify every sound: the soft whisper of wind through leaves, the distant clink of glass from the bar, the muted tick of her own watch. She forced herself forward, the crunch of gravel beneath her feet announcing her presence.",
  ...
  "note": "",
  "audit": {
    "locked_fact_phrases": "ten minutes past nine: paragraph 14 | present; a quarter past nine: not referenced; twenty minutes to eleven: not referenced",
    "season_words_used": "midsummer: paragraph 4",
    "discriminating_test_present": "no",
    "required_clues_present": "clue_5: paragraph 10; clue_culprit_direct_1: paragraph 14",
    "early_observation_present": "Hale’s posture, the garden’s isolation, Eleanor’s emotional state: paragraph 2",
...
ATTEMPT: 1/3
OFFENDING TEXT: The faint sound of his boots scuffing the gravel echoed in the stillness, and for a moment, Eleanor hesitated, torn between the urge to retreat and the obligation to press on.
MANDATORY FIXES:
