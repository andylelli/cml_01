...
- Project ID: `unknown`
- Timestamp: `2026-07-31T14:18:53.175Z`
...
1. Generate a clue that makes the reader directly observe: "The clock in the lobby shows a time of ten minutes past nine...."
   → observation | essential | early | temporal | step 1 | terms: clock, lobby, shows

2. Generate a clue that provides evidence for: "This contradicts the later witness statements about the time of death...."
   → contradiction | essential | early | temporal | step 1 | terms: contradicts, later, witness

3. Generate a clue that makes the reader directly observe: "Dust on the clock suggests it hasn't been tampered with in days...."
   → observation | essential | early | temporal | step 2 | terms: clock, suggests, hasn't

4. Generate a clue that provides evidence for: "The clock was tampered with just before the murder to mislead witnesses about the time...."
   → contradiction | essential | early | temporal | step 2 | terms: clock, tampered, before

5. Generate a clue that makes the reader directly observe: "Witnesses recall seeing Captain Hale leave the terrace shortly before 10:50 PM...."
   → observation | essential | mid | temporal | step 3 | terms: witnesses, recall, seeing

6. Generate a clue that provides evidence for: "This shows he had access to the area and thus could have committed the murder...."
   → contradiction | essential | mid | spatial | step 3 | terms: shows, access, committed

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "This contradicts the later witness statements about the time of death...."
   → contradiction | essential | mid | temporal | step 1 | terms: contradicts, later, witness

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The clock in the hotel lobby was tampered with to display a false time, misleading witnesses about the actual time of death...."
   → observation | essential | early | temporal | terms: clock, hotel, lobby

9. Generate one essential EARLY clue giving a concrete, fair-play indicator of the manner of death (struck with a heavy object) observable at the body-discovery scene — e.g. for blunt-force: a head wound, a bloodied heavy object, or bruising. Do NOT name or explain the concealment trick; only the physical tell a witness could see at the scene.
   → observation | essential | early | physical | terms: struck, heavy, object, wound, blood, bruis, blunt

10. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "The discriminating test compares clock, tamper, and lobby against the claimed timeline...."
...
11. Generate one essential mid-story clue whose description or pointsTo explicitly names Captain Ivor Hale and states the unique trace, preparation detail, or mechanism link that points to Captain Ivor Hale rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Captain Ivor Hale, clock, hotel, lobby
...
12. Generate one essential early-or-mid clue establishing that Captain Ivor Hale UNIQUELY had the means/skill/access/knowledge required to execute the concealment mechanism, and that the other suspects did not — so the reveal relies only on this already-planted capability, never on a means introduced for the first time at the confrontation.
   → elimination | essential | mid | temporal | terms: Captain Ivor Hale, clock, hotel, lobby

13. Generate a clue showing observable evidence of Captain Ivor Hale's premeditation or planning (Financial gain.). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: financial, gain.

14. Generate a clue that explicitly eliminates suspect Beatrice Quill using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Beatrice Quill because ...").
   → elimination | essential | mid | testimonial | terms: Beatrice Quill

15. Generate a clue that explicitly eliminates suspect Sylvia Trent using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Sylvia Trent because ...").
   → elimination | essential | mid | testimonial | terms: Sylvia Trent

16. Generate a clue that explicitly eliminates suspect Hugo Vane using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Hugo Vane because ...").
   → elimination | essential | mid | testimonial | terms: Hugo Vane

17. Generate one essential early or mid elimination clue that explicitly rules out Beatrice Quill and narrows the solution toward culprit Captain Ivor Hale. The pointsTo text must start with "Eliminates Beatrice Quill because ..." and cite corroborated evidence.
   → elimination | essential | mid | testimonial | terms: Beatrice Quill, Captain Ivor Hale
...
Create 2 red herrings that support the false assumption: "The murder of Dr. Mallory Finch occurred shortly after 9:00 PM."
...
- **clock_time**: "ten minutes past nine" — The displayed time on the clock at the moment of the murder.
- **actual_time**: "twenty minutes to eleven" — The actual time when the murder occurred.
- **witness_testimony_time**: "a quarter past nine" — The time witnesses reported hearing the clock chime.
...
- STRICT STRUCTURAL CONTRACT (author ALL of these YOURSELF, as concrete scene-register clues — a character sees/hears/finds something. NEVER meta-boilerplate like "adds texture to the case background"; if you omit any, a deterministic pass will synthesize flat machine text in its place, which reads as machine-made):
    ...
    • REQUIRED ID: "clue_1" with sourceInCML=CASE.prose_requirements.clue_to_scene_mapping[0].clue_id
    • REQUIRED ID: "clue_2" with sourceInCML=CASE.prose_requirements.clue_to_scene_mapping[1].clue_id
    • REQUIRED ID: "clue_3" with sourceInCML=CASE.prose_requirements.clue_to_scene_mapping[2].clue_id
    • REQUIRED ID: "clue_4" with sourceInCML=CASE.prose_requirements.clue_to_scene_mapping[3].clue_id
    • REQUIRED ID: "clue_5" with sourceInCML=CASE.prose_requirements.clue_to_scene_mapping[4].clue_id
    • REQUIRED ID: "clue_6" with sourceInCML=CASE.prose_requirements.clue_to_scene_mapping[5].clue_id
    • DIRECT CULPRIT CLUE: id="clue_culprit_direct_captain_ivor_hale" — observable evidence tying Captain Ivor Hale uniquely to the crime (source from: CASE.cast[2].alibi_window, CASE.cast[2].access_plausibility, CASE.inference_path.steps[2].observation, CASE.inference_path.steps[2].correction); the pointsTo must include: Captain Ivor Hale, direct evidence, means and opportunity, no other eligible suspect
