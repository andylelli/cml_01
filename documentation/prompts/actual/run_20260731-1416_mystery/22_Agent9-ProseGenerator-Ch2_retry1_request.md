...
- Project ID: ``
- Timestamp: `2026-07-31T14:25:10.556Z`
...
• [clue_2] witnesses, report, hearing, clock, chime, quarter, past, nine
  Category: temporal | Criticality: essential | Supports inference step 1
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): timeline, events, surrounding, murder
...
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): initial, belief, time, murder
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "She allowed herself a final glance at Dr. Mallory Finch, the memory of her laughter at last night’s dinner now rendered distant and unreal. The world outside pressed in—newsprint headlines, ration books, the ceaseless drone of war—yet within the hotel, time it..."
...
terrace, study, deck, corridor, lobby, lounge, bar
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=9682; context=12826; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 2:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "She allowed herself a final glance at Dr. Mallory Finch, the memory of her laughter at last night’s dinner now rendered distant and unreal. The world outside pressed in—newsprint headlines, ration books, the ceaseless dr...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • witness, testimony, clock, chime [clue_2] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
  ...
  - PLANT OBLIGATIONS (incidental appearances): each item below MUST appear in this chapter as a passing physical detail a character sees, handles, or walks past — with its significance UNFLAGGED:
    • time, noted, coroner, report [plant:clue_3]
    • displayed, time, clock [plant:clue_fp_elimination_sylvia_trent]
...
Chapter 2 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The clock chiming a quarter past nine."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that witnesses heard the clock chime at a quarter past nine, contradicting Hale's timeline."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor catches Captain Hale's eye, a flicker of unspoken tension between them."
      ]
    },
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 2: the clue [clue_2] (witnesses, report, hearing, clock, chime, quarter, past, nine) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
...
```text
{
  ...
  "chapters": [
    {
      ...
      "summary": "In the lobby of the seaside hotel, Eleanor Voss gathers the shaken guests as the clock chimes a quarter past nine, introducing a contradiction in the timeline. Emotional fractures begin to show as the suspects defend themselves, and Eleanor senses the first ripple of suspicion among them.",
      "paragraphs": [
  ...
  "note": "",
  "audit": {
    "locked_fact_phrases": "present in paragraph 6 | present in paragraph 2",
    "season_words_used": "midsummer, summer",
    "discriminating_test_present": "no",
    "required_clues_present": "clue_2: paragraph 2; clue_late_optional_slot_1: paragraph 8",
    "early_observation_present": "The clock in the lobby, tall and unyielding, chimed a quarter past nine. Its deep, resonant tone reverberated through the space, drawing every eye. Hugo Vane, who had been fussing over a tray of untouched breakfast rolls, flinched at the sound, nearly dropping a cup. \"I heard it last night, too,\" he said, his voice barely above a whisper. \"Just after—well, after the shouting stopped.\" Beatrice Quill, standing near the window with her arms wrapped tightly around herself, added, \"It’s impossible to ignore, darling. That chime carries all the way to the terrace. I distinctly remember it—though I wish I could forget.\" The words hung in the air, heavy with implication.: chapter 2 paragraph 2",
    "early_inference_present": "Eleanor’s gaze flicked from the clock to the faces around her. The contradiction gnawed at her: the clock’s hands had stood at ten minutes past nine when she found Dr. Mallory Finch, yet here was testimony—unprompted, nervous, and corroborated—that the chime at a quarter past nine had been heard by more than one guest. She pressed her lips together, considering the implications. If the clock had announced the quarter hour after the fatal event, then someone—or something—was lying. The weight of this uncertainty pressed down, sharper than the chill that seeped through the lobby’s stone floor.: chapter 2 paragraph 3"
  }
}
...
PRIMARY FAILURES
- Chapter 2: clue evidence "A bloodied heavy object is found near the body." is absent. Include an on-page observation or reference to "A bloodied heavy object is found near the body." (this clue reveals: The nature of the murder.) before the chapter ends.
