...
- Project ID: ``
- Timestamp: `2026-07-13T21:05:46.579Z`
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As she gathered her notes and the fragment of fabric, Eleanor felt a chill that had nothing to do with the wintry air. The masquerade was nearly at its end, and she stood at the threshold of revelation. Outside, the storm’s fury seemed to abate for a moment, a..."
...
Render this test MECHANISM as live, in-scene action and dialogue, composing ENTIRELY in your own words from these elements (reproducing any briefing phrase verbatim FAILS validation): torn, fabric, crime, scene, captain, hale, costume, proves, impersonating, finch
...
☐ **Evidence Integration**
  ...
  ☐ Explicitly reference or use clue: "clue_culprit_direct_captain_ivor_hale" (clue) (appears in Act 1, Scene 3)
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=25297; context=4928; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
Manner of death (MUST be named in the reveal): state plainly how the victim died — cause of death: stabbed with a hidden dagger. Surface it in the prose in plain words (e.g. "stabbed with a hidden dagger") — not only how the clock/timeline was manipulated. A reveal that explains the concealment but never the killing fails the fair-play contract.
...
- Chapter 9:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As she gathered her notes and the fragment of fabric, Eleanor felt a chill that had nothing to do with the wintry air. The masquerade was nearly at its end, and she stood at the threshold of revelation. Outside, the stor...".
  ...
  - ⚠ DISCRIMINATING TEST (trap) — MANDATORY real-time scene with dialogue and confrontation. DO NOT summarize it after the fact.
    ...
    Elements the test must dramatize (compose the scene ENTIRELY in your own sentences from these — reproducing any briefing phrase verbatim FAILS validation): torn, fabric, crime, scene, captain, hale, costume, proves, impersonating, finch
    Cite these already-revealed clue IDs during the test: clue_2, clue_culprit_direct_1, clue_3, clue_culprit_direct_captain_ivor_hale
...
Chapter 9 (Act 3) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The torn fabric that matches Hale's costume."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes Hale's guilt through the evidence of impersonation."
...
[
  {
    ...
    "purpose": "Execute the discriminating test and reveal the evidence Suspects are systematically cleared: alibi confirmed for three suspects, ruled out by timeline evidence, leaving only the culprit identified by a complete evidence chain.",
    "cluesRevealed": [
    ...
    "emotionalRegister": "The murderer is revealed, and the emotional fallout is palpable among the characters.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 9: the clue [clue_culprit_direct_captain_ivor_hale] (direct, ties, captain, ivor, hale, mechanism, access, point, before, discriminating, excludes, competing) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
