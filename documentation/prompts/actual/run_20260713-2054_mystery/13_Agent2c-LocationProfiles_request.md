...
- Project ID: ``
- Timestamp: `2026-07-13T20:58:12.919Z`
...
- Era-authentic markers: radio broadcasting, early television sets, basic radar systems, rationed fuel for automobiles, post-war automobile boom, military transport vehicles, long-distance telephone calls, military encryption techniques
- Tone: Classic
- No anachronisms
...
Description: A grand seaside hotel built in the early 20th century, featuring Art Deco architecture and a view of the ocean.
Crime Scene: English seaside
Weather: Overcast with occasional rain, typical of coastal climate in the 1940s.
Mood: Tense and suspenseful due to recent events and the lingering effects of war.
...
- Geographic isolation: Situated on a cliffside, the hotel is somewhat isolated from the nearest town, limiting immediate outside assistance.
- Access control: staff-only areas require permission from management, guest rooms can be accessed only with keys, certain amenities are off-limits after hours
...
- Social norms: impact of WWII on civilian life, increased participation of women in the workforce
