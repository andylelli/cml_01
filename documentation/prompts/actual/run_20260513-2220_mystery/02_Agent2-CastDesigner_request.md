...
- Project ID: ``
- Timestamp: `2026-05-13T22:20:48.062Z`
...
**Setting**: 1930s - A sprawling country estate with a large main house, formal gardens, and several outbuildings, reflecting the wealth of its owners.
**Crime Type**: Murder
**Social Context**: impact of the Great Depression affecting social gatherings, class distinctions prominent in estate management, growing political tensions with fascism in Europe
**Tone**: Classic
