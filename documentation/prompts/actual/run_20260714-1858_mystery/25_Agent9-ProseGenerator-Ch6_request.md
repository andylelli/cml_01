...
- Project ID: ``
- Timestamp: `2026-07-14T19:09:06.962Z`
...
• [clue_11] footprints, near, scene, crime
  Category: physical | Criticality: essential | Supports inference step 2
  Points to: footprints, provide, lead, suspect

• [clue_9] eliminates, sylvia, trent, because, seen, leaving, city, nine, forty, five, evening
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_mid_2, clue_core_contradiction_chain, clue_fp_contradiction_step_1, clue_3, clue_early_1, clue_early_2, clue_6, clue_7, clue_8, clue_fp_contradiction_step_3, clue_4, clue_10, clue_culprit_direct_1 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): mechanism, false, reflection, misled, witnesses | fingerprints, link, suspect, crime, scene | witness, testimony, contradicted, mirror, positioning | fingerprints, suggest, someone, manipulated, mirror | fingerprints, link, suspect, crime, scene | witness, testimony, contradicted, mirror, positioning | mechanism, false, reflection, misled, witnesses | eleanor, voss, ruled, suspect | captain, ivor, hale, ruled, suspect | beatrice, quill, ruled, suspect | smudge, indicates, recent, handling, linking, suspect | smudge, connects, someone, interacted, mirror | hugo, vane, behavior, raises, suspicion | physical, trace, opportunity, indicate, hugo, vane
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As she left the victim’s room, the air behind her felt heavier, charged with secrets yet to be unearthed. The mirror, now wiped clean but for the stubborn smudge, stood as a silent witness to everything that had transpired. Eleanor paused at the threshold, gla..."
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=19037; context=4718; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_mid_1 must appear in Act 2, Scene 3 via Direct observation
...
- Chapter 6:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As she left the victim’s room, the air behind her felt heavier, charged with secrets yet to be unearthed. The mirror, now wiped clean but for the stubborn smudge, stood as a silent witness to everything that had transpir...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • witnesses, report, seeing, hugo, vane, lingering, around, victim, door [clue_10]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • distinct, footprints, leading, away, victim, room [clue_11]
      Points to: footprints, provide, lead, suspect
    • detective, arranges, reenactment, using, mirror [clue_12]
      Points to: reenactment, expose, inconsistencies, witness, testimony
    ...
    • witnesses, confirm, sylvia, trent, left, city, before, murder [clue_9]
      Points to: sylvia, trent, ruled, suspect
    • mirror, positioned, angle, victim, room [clue_culprit_direct_1]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • detective, arranges, reenactment, using, mirror [clue_culprit_direct_hugo_vane]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    ...
    • victim, reflection, mirror, shows, different, position, described [clue_mid_1]
      Points to: witness, credibility, undermined, reflection, discrepancy
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The footprints discovered near the crime scene."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the footprints may belong to someone else, complicating the timeline."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Sylvia fidgets, her eyes darting around the room."
      ]
    },
    ...
    "emotionalRegister": "The realization of the emotional stakes complicates the investigation further.",
