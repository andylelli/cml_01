...
- Project ID: `unknown`
- Timestamp: `2026-07-14T19:01:09.284Z`
...
1. Generate a clue that makes the reader directly observe: "Fingerprints are found on the mirror's surface in the victim's room...."
   → observation | essential | early | spatial | step 1 | terms: fingerprints, found, mirror's

2. Generate a clue that provides evidence for: "The fingerprints suggest someone manipulated the mirror...."
   → contradiction | essential | early | physical | step 1 | terms: fingerprints, suggest, someone

3. Generate a clue that makes the reader directly observe: "The angle of the mirror contradicts the witness's account of the attack...."
   → observation | essential | early | testimonial | step 2 | terms: angle, mirror, contradicts

4. Generate a clue that provides evidence for: "The reflection of the victim's position conflicts with where the witness claims to have seen the att..."
   → contradiction | essential | early | testimonial | step 2 | terms: reflection, victim's, position

5. Generate a clue that makes the reader directly observe: "An unusual smudge is discovered on the lens of the mirror...."
   → observation | essential | mid | testimonial | step 3 | terms: unusual, smudge, discovered

6. Generate a clue that provides evidence for: "The smudge indicates recent handling, linking it to the suspect...."
   → contradiction | essential | mid | testimonial | step 3 | terms: smudge, indicates, recent

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The fingerprints suggest someone manipulated the mirror...."
   → contradiction | essential | mid | physical | step 1 | terms: fingerprints, suggest, someone

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "A strategically placed mirror creates a false reflection of the victim, misleading witnesses about the location of the crime...."
...
10. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Setting up a reenactment with the mirror to reveal the true angle of the attack...."
   → observation | essential | mid | testimonial | terms: setting, reenactment, mirror
...
11. Generate one essential mid-story clue whose description or pointsTo explicitly names Hugo Vane and states the unique trace, preparation detail, or mechanism link that points to Hugo Vane rather than any non-culprit.
   → observation | essential | mid | spatial | terms: Hugo Vane, strategically, placed, mirror
...
12. Generate one essential early-or-mid clue establishing that Hugo Vane UNIQUELY had the means/skill/access/knowledge required to execute the concealment mechanism, and that the other suspects did not — so the reveal relies only on this already-planted capability, never on a means introduced for the first time at the confrontation.
   → elimination | essential | mid | spatial | terms: Hugo Vane, strategically, placed, mirror

13. Generate a clue showing observable evidence of Hugo Vane's premeditation or planning (To silence Mallory's threats to expose him). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: silence, mallory's, threats
...
Create 2 red herrings that support the false assumption: "The victim was attacked from across the room."
