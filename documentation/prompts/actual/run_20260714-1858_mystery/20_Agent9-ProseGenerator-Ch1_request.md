...
- Project ID: ``
- Timestamp: `2026-07-14T19:07:06.047Z`
...
- Eleanor Voss
  ...
  Suspicion/pressure cue seed: Personal reputation as a detective.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Hugo Vane
  Public identity anchor: Private Investigator; suspect 
  Connection to victim: directly affected by Dr. Mallory Finch's death and its fallout.
  Investigation relevance: access plausibility: medium | alibi window: 10 PM to 11 PM.
  Suspicion/pressure cue seed: Financial ruin.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.
...
The atmosphere is filled with elegance but underlined by a sense of foreboding due to the recent murder.
...
• [clue_mechanism_visibility_core] strategically, placed, mirror, creates, false, reflection, victim, misleading, witnesses, location, crime
  Category: spatial | Criticality: essential | Supports inference step 1
  Points to: mechanism, false, reflection, misled, witnesses

• [clue_mid_2] fingerprints, mirror, surface, victim, room
...
Known location profile anchors: The Cliffside Hotel, Grand Lobby, Dining Room, Guest Rooms, Shared Balcony, the victim's room in the seaside hotel
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Cliffside Hotel", "Grand Lobby", "Dining Room", "Guest Rooms", "Shared Balcony", "the victim's room in the seaside hotel"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=7735; context=10250; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • mirror, positioned, angle, victim, room [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The strategically placed mirror reflecting the room at an unusual angle."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the victim was found in a locked room with a mirror positioned to mislead observers about the crime scene."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_1] Hugo mentions that he saw the victim attacked from across the room — seeds false inference about the angle of the crime.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor pauses, her breath catching at the sight of the body."
      ]
    },
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_1",
      "placementDetail": "Hugo mentions that he saw the victim attacked from across the room — seeds false inference about the angle of the crime."
    },
    "emotionalRegister": "The atmosphere is filled with elegance but underlined by a sense of foreboding due to the recent murder.",
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (strategically, placed, mirror, creates, false, reflection, victim, misleading, witnesses, location, crime) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_mid_2] (fingerprints, mirror, surface, victim, room) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
