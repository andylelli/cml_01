...
- Project ID: ``
- Timestamp: `2026-07-14T19:09:31.709Z`
...
• [clue_5] reflection, victim, position, conflicts, witness, claims, seen, attack
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: witness, credibility, undermined, reflection, discrepancy

• [clue_12] setting, reenactment, mirror, reveal, true, angle, attack
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: reenactment, expose, inconsistencies, witness, testimony

• [clue_mid_1] reflection, victim, position, conflicts, witness, claims, seen, attack
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: witness, credibility, undermined, reflection, discrepancy
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the suspects dispersed—Sylvia rising abruptly, Captain Hale lingering by the fire, Beatrice slipping quietly from the room—Eleanor remained seated, her mind racing through the contradictions. The footprints had complicated everything, introducing the possib..."
...
- Chapter 7: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the victim's room". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Chapter 6 (score 95/100):
  Quality gaps noted: scene grounding weakness
  Address in upcoming chapters: Open next chapter with a named location anchor plus at least two sensory cues and one atmosphere marker.
- Phrases to avoid (already overused in earlier chapters): "someone had gripped the mirror to adjust", "what could be seen from the doorway".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=20440; context=4086; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 7:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the suspects dispersed—Sylvia rising abruptly, Captain Hale lingering by the fire, Beatrice slipping quietly from the room—Eleanor remained seated, her mind racing through the contradictions. The footprints had compli...".
...
Chapter 7 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The reenactment of the attack using the mirror."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the angle of the mirror contradicts the witness's account, implicating Hugo."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Hugo's hands tremble as he realizes the implications of the test."
      ]
    },
    ...
    "emotionalRegister": "Pressure mounts as Eleanor races against time to uncover the truth.",
