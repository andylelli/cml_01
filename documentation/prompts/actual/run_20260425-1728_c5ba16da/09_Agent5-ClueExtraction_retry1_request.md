...
- Timestamp: `2026-04-25T17:29:45.084Z`
...
Violations: 1. [critical] Red Herring Separation: Red herring rh_2 overlaps inference corrections (steps: 1; words: clock, actual) and may support the true solution.
Warnings: None
Recommendations: Red herrings must support the false assumption only; Do not reuse correction-language terms from inference_path.steps[].correction in red herring text; Preserve misdirection without reinforcing culprit-identifying logic; Forbidden terms for red-herring rewrite: clock, clocks, display; Prefer these temporal assumption terms instead: shortly, showed, minutes, eleven, witnesses, recall, commotion, aligning
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Red Herring Separation: Red herring rh_2 overlaps inference corrections (steps: 1; words: clock, actual) and may support the true solution.
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
