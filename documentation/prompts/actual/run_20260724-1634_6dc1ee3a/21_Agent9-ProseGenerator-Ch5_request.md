...
- Timestamp: `2026-07-24T16:43:40.138Z`
...
• [clue_14] eliminates, margaret, langley, because, multiple, guests, verify, presence, dinner, quarter, past, seven
  Category: elimination | Criticality: essential | Supports inference step 2
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): eliminates, margaret, langley, verified, alibi

• [clue_15] eliminates, edward, barnes, because, witness, statements, place, away, manor, murder, timeframe
  Category: elimination | Criticality: essential | Supports inference step 2
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): eliminates, edward, barnes, corroborated, alibi

• [clue_16] eliminates, agnes, crowley, because, bell, tower, logs, show, access, murder, timeframe
  Category: elimination | Criticality: essential | Supports inference step 2
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): eliminates, agnes, crowley, lack, access

• [clue_17] eliminates, thomas, radcliffe, because, gardener, book, water, basin, inspection, confirm, occupied, outside
  Category: elimination | Criticality: essential | Supports inference step 2
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): eliminates, thomas, radcliffe, corroborated, alibi
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Havers remained alone in the Drawing Room, the rain now a steady percussion on the glass. He stared at the stopped clock above the mantel, its hands frozen in silent accusation. The evidence had shifted—Charles Langley’s access to the bell tower, his skill wit..."
...
Known location profile anchors: Langley Manor, Langley Manor Library, East Garden Gravel Path, Servants' Hall, Main Gatehouse, Manor Dining Room
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Langley Manor", "Langley Manor Library", "East Garden Gravel Path", "Servants' Hall", "Main Gatehouse", "Manor Dining Room"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 5: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a temporal subordinate clause — e.g. "When [Name] entered…" / "After the last guest…" / "Before the household had stirred…" / "As the light faded…". Anchor opening in "Manor Dining Room". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=17101; context=6430; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 5:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Havers remained alone in the Drawing Room, the rain now a steady percussion on the glass. He stared at the stopped clock above the mantel, its hands frozen in silent accusation. The evidence had shifted—Charles Langley’s...".
  ...
  - PLANT OBLIGATIONS (incidental appearances): each item below MUST appear in this chapter as a passing physical detail a character sees, handles, or walks past — with its significance UNFLAGGED:
    • witnesses, observe, staged, bell, ringing, measured, echo, delays [plant:clue_12]
    • corroborated, alibi, lack, bell, tower, access, margaret, langley [plant:clue_19]
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Thomas Radcliffe quietly asserts his innocence, visibly relieved"
      ]
    },
    ...
    "emotionalRegister": "Focus sharpens on Charles Langley as motive, access, and opportunity align, intensifying emotional pressure.",
