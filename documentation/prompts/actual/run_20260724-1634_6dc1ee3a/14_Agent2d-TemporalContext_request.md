...
- Timestamp: `2026-07-24T16:39:49.601Z`
...
- YOU MUST use the exact year and month specified above: April 1932
- This date has been specifically selected for THIS mystery to ensure uniqueness
- DO NOT change the year or month - use April 1932 exactly
- The season is FIXED as "spring" (it follows from April) — use it exactly; do not pick a different season
...
- All details must be historically accurate for April 1932 specifically
- Generate fresh, original descriptions - do not copy example phrasing
- Make this feel like the specific moment of April 1932
- OPTIONAL FIELD DEPTH REQUIREMENT: `fashion` and `seasonalActivities` must be specific and non-generic.
  ...
  - Include at least 3 seasonal activities tied to April and this location.
...
- Technology available: domestic electric lighting with occasional outages, manual typewriters for correspondence and record keeping, party-line telephone exchange connecting manor to nearby village, battery-powered portable radios for news broadcasts
- Forensics: latent fingerprinting with powder and brushes, basic ballistics comparison using bullets and firearms, rudimentary toxicology tests for common poisons
...
Task:
1. Use the specified date: April 1932
2. Provide seasonal context for April (weather, holidays, activities appropriate for this specific month)
