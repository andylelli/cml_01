...
- Timestamp: `2026-07-24T16:45:12.044Z`
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Yet the inspector’s mind was not at rest. The means by which the bell’s chime had been made to lie remained just out of reach—a secret caught in the echo, waiting for the final test to bring it into the light. The spring morning was brightening, but within the..."
...
Render this test MECHANISM as live, in-scene action and dialogue, composing ENTIRELY in your own words from these elements (reproducing any briefing phrase verbatim FAILS validation): ringing, choir, bell, staged, presence, witnesses, prior, measurement, echo, chamber, acoustic, delay
...
☐ **Suspect Elimination**
  ☐ Clearly eliminate "Margaret Langley" from suspicion
  ☐ Clearly eliminate "Edward Barnes" from suspicion
  ☐ Clearly eliminate "Agnes Crowley" from suspicion
  ☐ Clearly eliminate "Thomas Radcliffe" from suspicion
...
Known location profile anchors: Langley Manor, Langley Manor Library, East Garden Gravel Path, Servants' Hall, Main Gatehouse, Bell Tower and Manor Hall Grounds
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Langley Manor", "Langley Manor Library", "East Garden Gravel Path", "Servants' Hall", "Main Gatehouse", "Bell Tower and Manor Hall Grounds"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 9: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with an explicit time marker — e.g. "That morning…" / "By the time dusk fell…" / "It was nearly four o'clock…" / "On the second day after the discovery…". Time must be in the first clause. Anchor opening in "Bell Tower and Manor Hall Grounds". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=24433; context=5462; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, continuity_context, pronoun_accuracy]
...
- Chapter 9:
  ...
  - Scene is set in: Bell Tower and Manor Hall Grounds — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Yet the inspector’s mind was not at rest. The means by which the bell’s chime had been made to lie remained just out of reach—a secret caught in the echo, waiting for the final test to bring it into the light. The spring...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • witnesses, observe, staged, bell, ringing, measured, echo, delays [clue_12]
      Points to: supporting, acoustic, delay, ringing
  ...
  - ⚠ DISCRIMINATING TEST (constraint_proof) — MANDATORY real-time scene with dialogue and confrontation. DO NOT summarize it after the fact.
    ⚠ CULPRIT-UNIQUENESS REQUIRED: the decisive evidence must expose a fact or physical characteristic that ONLY Charles Langley could satisfy. Announcing that the crime method occurred does NOT qualify. The test must reveal access, knowledge, or physical proof that eliminates all non-culprits before naming Charles Langley.
    Elements the test must dramatize (compose the scene ENTIRELY in your own sentences from these — reproducing any briefing phrase verbatim FAILS validation): ringing, choir, bell, staged, presence, witnesses, prior, measurement, echo, chamber, acoustic, delay
    Cite these already-revealed clue IDs during the test: clue_12, clue_9, clue_4
    Eliminate on-page with explicit evidence: "Margaret Langley", "Edward Barnes", "Agnes Crowley", "Thomas Radcliffe" — state EXACTLY why each is ruled out (because / therefore / which proves).
    Convict: name "Charles Langley" explicitly as the murderer. Connect every clue to them using "because / therefore / which proves".
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Servants exchange uneasy looks as the test confirms delay"
      ]
    },
    ...
    "emotionalRegister": "The culprit’s deception is unveiled in a tense confrontation, shattering alibis and social facades alike.",
