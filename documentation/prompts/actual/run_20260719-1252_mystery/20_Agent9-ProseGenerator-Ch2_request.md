...
- Project ID: ``
- Timestamp: `2026-07-19T12:58:25.583Z`
...
• [clue_core_contradiction_chain] indicates, tide, high, earlier, party, timeline, suggests
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: timeline, provided, suspects, likely, false
...
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): timing, tide, crucial, case
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "The wind picked up, rattling the sparse grasses at the edge of the beach and driving a fresh chill through Eleanor’s coat. She turned back to Dr. Mallory Finch, searching the doctor’s face for some final message, but found only the blankness of death and the r..."
...
Known location profile anchors: The Gulls' Perch, The Rooftop Terrace, The Drawing Room, The Kitchen, The Secluded Beach, the hotel lobby
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Gulls' Perch", "The Rooftop Terrace", "The Drawing Room", "The Kitchen", "The Secluded Beach", "the hotel lobby"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=9664; context=12538; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 2:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "The wind picked up, rattling the sparse grasses at the edge of the beach and driving a fresh chill through Eleanor’s coat. She turned back to Dr. Mallory Finch, searching the doctor’s face for some final message, but fou...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • contradicts, timeline, events [clue_core_contradiction_chain] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: timeline, provided, suspects, likely, false
...
Chapter 2 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The conflicting statements about the time of the drowning."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Contradictions in witness statements emerge, suggesting not everyone is telling the truth."
...
[
  {
    ...
    "setting": {
      ...
      "atmosphere": "A mix of confusion and fear among guests"
    },
    "characters": [
      "Eleanor Voss",
      "Captain Ivor Hale",
    ...
    "purpose": "Establish the tension among the guests and introduce contradictions.",
    "cluesRevealed": [
      "clue_core_contradiction_chain"
    ],
    "dramaticElements": {
      "conflict": "Suspicions arise as guests react differently to the news.",
      "tension": "The atmosphere thickens with unspoken accusations.",
      "microMomentBeats": [
        "Eleanor notices Captain Hale's trembling hands as he pours a drink."
      ]
    },
    "summary": "In the hotel lobby, guests react to the news of the drowning. Eleanor observes the tension among them, particularly Captain Hale's nervous behavior. As they discuss the timeline of events, Eleanor notes contradictions in their statements.",
    "beat": "crime",
    "estimatedWordCount": 1250,
    "pivotElement": "The conflicting statements about the time of the drowning.",
    "factEstablished": "Contradictions in witness statements emerge, suggesting not everyone is telling the truth.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 2: the clue [clue_core_contradiction_chain] (indicates, tide, high, earlier, party, timeline, suggests) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
