...
- Project ID: ``
- Timestamp: `2026-07-19T12:57:51.268Z`
...
- Eleanor Voss
  ...
  Suspicion/pressure cue seed: Intense focus.
...
- Captain Ivor Hale
  ...
  Investigation relevance: access plausibility: high | alibi window: 8:00 PM to 10:00 PM | opportunity channel: Access to the beach.
...
- Beatrice Quill
  ...
  Connection to victim: Dr. Mallory Finch (friend).
  Investigation relevance: access plausibility: medium | alibi window: 7:30 PM to 9:00 PM | opportunity channel: Access to the beach.
  Suspicion/pressure cue seed: Nervous when discussing victim.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Sylvia Trent
  Public identity anchor: Hotel Owner; suspect 
  Connection to victim: Dr. Mallory Finch (acquaintance).
  Investigation relevance: access plausibility: medium | alibi window: 8:15 PM to 9:30 PM | opportunity channel: Access to the beach.
  Suspicion/pressure cue seed: Evasive about whereabouts.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but
...
The initial atmosphere is one of charm, quickly overshadowed by fear and tragedy.
...
Rationale: The opening scene establishes a serious tone as the crime is revealed.
...
Primary Location: The Gulls' Perch (Whitstable, England)
A quaint seaside hotel frequented by vacationers and business travelers, offering a charming view of the turbulent ocean.

Key Locations Available:
- The Rooftop Terrace (exterior): Crime scene
- The Drawing Room (interior): Gathering space
- The Kitchen (interior): Staff-only area
- The Secluded Beach (exterior): Crime scene and hidden meeting place

Atmosphere (tonal cue only — do NOT reproduce this phrase verbatim in prose; translate into scene-specific, character-observed sensory language): tense and suspenseful, with an underlying sense of uncertainty
Weather: overcast with intermittent rain, typical of coastal climates

Era markers: crackling radio broadcasts | early television sets flickering | military radar stations nearby | wartime rationing of fuel | increased presence of women in the workforce
...
The Rooftop Terrace (exterior):
  - Visual: dark clouds swirling above, waves crashing against rocks, flickering lanterns casting shadows
  - Sounds: wind howling through the railings, water splashing against stone, distant thunder rumbling
  - Scents: salty sea air mixed with damp earth, wet wood and rust, faint scent of candle wax
  - Touch: cold metal railing, slick, wet tiles

The Drawing Room (interior):
  - Visual: faded floral patterns on wallpaper, glow of the fireplace, dust motes dancing in sunlight
  - Sounds: gentle crackle of the fire, murmurs of conversation, clinking of teacups
  - Scents: burning wood and smoke, freshly brewed tea, musty scent of old books
  - Touch: soft velvet upholstery, warmth from the fire

The Kitchen (interior):
  - Visual: gleaming pots and pans hanging, flour-dusted countertops, faded wooden shelves lined with jars
  - Sounds: clattering of utensils, the hum of the refrigerator, water boiling on the stove
  - Scents: rich aroma of simmering stew, freshly baked pastries, sharp scent of herbs and spices
  - Touch: smoothness of polished wood, heat radiating from the stove

⛔ REFERENCE DATA — DO NOT TRANSCRIBE VERBATIM: The above profiles are structural guides only. Generate original prose that evokes these qualities; do not reproduce the exact phrasing or sentence structure of the profile paragraphs.

SCENE OPENING RULE: When opening a scene in a new location, write what the POV character directly observes and physically senses at that moment — not a general description of the room's qualities. The reader must feel present, not briefed. Sens
[truncated for prompt budget]
...
• [clue_mechanism_visibility_core] witnesses, state, heard, rhythmic, waves, crashing, specific, time
  Category: testimonial | Criticality: essential | Supports inference step 1
  Points to: timing, tide, crucial, case
...
Known location profile anchors: The Gulls' Perch, The Rooftop Terrace, The Drawing Room, The Kitchen, The Secluded Beach, the beach near the hotel
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Gulls' Perch", "The Rooftop Terrace", "The Drawing Room", "The Kitchen", "The Secluded Beach", "the beach near the hotel"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=7580; context=12279; dropped=[none]; truncated=[first_appearance_contracts, location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • witnesses, report, hearing, rhythmic, waves [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The lifeless body found on the beach, waterlogged and pale."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the victim is dead, raising immediate questions about how and why."
...
[
  {
    ...
    "dramaticElements": {
      "conflict": "The tension of the unknown looms as the body is discovered.",
      "tension": "Each character is visibly shaken, hinting at hidden connections.",
      "microMomentBeats": [
        "Eleanor hesitates, feeling the weight of the ocean's pull as she approaches the body."
      ]
    },
    "summary": "Eleanor Voss arrives at the beach, where the body of an unknown victim is discovered washed ashore. Captain Ivor Hale and Dr. Mallory Finch are present, visibly shaken. The atmosphere is heavy with tension as they realize the implications of the drowning.",
    "beat": "gathering",
    "estimatedWordCount": 1250,
    "pivotElement": "The lifeless body found on the beach, waterlogged and pale.",
    "factEstablished": "Establishes the victim is dead, raising immediate questions about how and why.",
    ...
    "emotionalRegister": "The initial atmosphere is one of charm, quickly overshadowed by fear and tragedy.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (witnesses, state, heard, rhythmic, waves, crashing, specific, time) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
