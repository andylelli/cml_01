...
- Project ID: ``
- Timestamp: `2026-07-19T12:59:35.094Z`
...
• [clue_2] witnesses, confirm, finch, near, beach, before, party
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: finch, alibi, questionable

• [clue_3] inconsistent, alleged, presence, inside, hotel
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: finch, alibi, likely, false

• [clue_4] captain, ivor, hale, seen, preparing, party, unusual, urgency
  Category: behavioral | Criticality: essential | Supports inference step 2
  Points to: captain, ivor, hale, behavior, suggests, premeditation
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_1, clue_5, clue_fp_contradiction_step_2 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): timing, tide, crucial, case | timeline, provided, suspects, likely, false | footprints, suggest, prior, access, beach | supports, drowning, theory | footprints, indicate, someone, accessed, beach, before
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "She gathered herself, smoothing the skirt of her tweed dress, and looked around the table. The investigation had only just begun, but already the boundaries between truth and invention were blurring. Eleanor felt the pressure mounting—not just for the suspects..."
...
Known location profile anchors: The Gulls' Perch, The Rooftop Terrace, The Drawing Room, The Kitchen, The Secluded Beach, the hotel bar
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Gulls' Perch", "The Rooftop Terrace", "The Drawing Room", "The Kitchen", "The Secluded Beach", "the hotel bar"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=14096; context=7834; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 4:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "She gathered herself, smoothing the skirt of her tweed dress, and looked around the table. The investigation had only just begun, but already the boundaries between truth and invention were blurring. Eleanor felt the pre...".
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The swirling tensions among the suspects as they reveal their motives."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes multiple motives, complicating the investigation."
...
[
  {
    ...
    "setting": {
      ...
      "atmosphere": "A tense environment filled with whispers and speculation"
    },
    "characters": [
      "Eleanor Voss",
      "Captain Ivor Hale",
    ...
    "purpose": "Reveal motives and introduce red herrings.",
    "cluesRevealed": [
      "clue_2",
      "clue_3",
      "clue_4"
    ...
    "dramaticElements": {
      "conflict": "Suspicions rise as motives are discussed.",
      "tension": "Eleanor feels the weight of each suspect's hidden agendas.",
      "microMomentBeats": [
        "Eleanor watches Beatrice fidget nervously with her drink."
      ]
    },
    "summary": "At the bar, Eleanor discusses potential motives with the suspects. Each reveals their reasons for being at the hotel, and Eleanor senses the tension in the air. Beatrice's ambition, Sylvia's financial worries, and Ivor's past come to light, hinting at deeper connections.",
    "beat": "motives",
    "estimatedWordCount": 1250,
    "pivotElement": "The swirling tensions among the suspects as they reveal their motives.",
    "factEstablished": "Establishes multiple motives, complicating the investigation.",
    ...
    "emotionalRegister": "A pivotal clue shifts the direction of the investigation.",
