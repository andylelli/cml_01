...
- Project ID: ``
- Timestamp: `2026-07-19T11:12:47.232Z`
...
• [clue_8] three, distinct, smudges, clock, mechanism
  Category: physical | Criticality: supporting | Supports inference step 3
  Points to: implies, recent, tampering, clock

• [clue_9] beatrice, quill, seen, preparing, clock, earlier
  Category: behavioral | Criticality: essential | Supports inference step 3
  Points to: points, beatrice, quill, suspect
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As Hugo turned away from the hearth, the rain began anew, tapping a restless rhythm against the glass. The false solution had been offered, and with it, a new uncertainty—a sense that the story of Eleanor Voss’s final hours was not yet written, and the true sh..."
...
Known location profile anchors: The Oceanview Hotel, Hotel Lobby, Dining Room, Rooftop Terrace, The Beachfront, the hotel library
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Oceanview Hotel", "Hotel Lobby", "Dining Room", "Rooftop Terrace", "The Beachfront", "the hotel library"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=20096; context=4342; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 7:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As Hugo turned away from the hearth, the rain began anew, tapping a restless rhythm against the glass. The false solution had been offered, and with it, a new uncertainty—a sense that the story of Eleanor Voss’s final ho...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • three, smudges, visible, clock, mechanism [clue_2]
      Points to: implies, recent, tampering, clock
    • clock, hands, visibly, smudged [clue_8]
      Points to: implies, recent, tampering, clock
...
Chapter 7 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The three distinct oil smudges found on the clock's mechanism."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Beatrice had access to the clock and hints at her deeper involvement."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Hugo watches as Beatrice's façade cracks, revealing her inner turmoil."
      ]
    },
    ...
    "emotionalRegister": "The characters face their deepest fears as confrontations lead to emotional reckoning.",
