...
- Project ID: ``
- Timestamp: `2026-07-19T11:10:39.056Z`
...
A critical clue shifts the investigation's focus and heightens the tension.
...
Rationale: Tension scenes require seriousness and cannot accommodate humor.
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Ivor struggles with the duality of his public image as a war hero and the private shame of his debts, fearing that exposure will shatter both."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Beatrice wrestles with the morality of her writing, torn between ambition and the potential harm her revelations could cause to those she cares about."
...
• [clue_4] beatrice, quill, seen, arguing, eleanor, earlier, evening
  Category: behavioral | Criticality: essential | Supports inference step 3
  Points to: indicates, jealousy, rivalry, potential, motive

• [clue_5] witnesses, confirm, captain, ivor, hale, time, murder
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: eliminates, captain, ivor, hale, suspect

• [clue_6] sylvia, trent, seen, leaving, hotel, seven, clock
  Category: testimonial | Criticality: essential | Supports inference step 3
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the evening wore on, the candlelight in the hotel dining room cast ever-longer shadows across the white tablecloths. Outside, the wind rattled the windowpanes, a reminder that the world beyond the hotel was just as unsettled as the company within. Hugo glan..."
...
terrace, promenade, lobby, bar, study, lounge, flat, dining room, kitchen
...
Chapter 3: Chapter 3: Witness Accounts
  Events: By the time dusk crept along the coast, the hotel dining room glowed with the muted flicker of candlelight.
...
Known location profile anchors: The Oceanview Hotel, Hotel Lobby, Dining Room, Rooftop Terrace, The Beachfront, the hotel bar
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Oceanview Hotel", "Hotel Lobby", "Dining Room", "Rooftop Terrace", "The Beachfront", "the hotel bar"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=13544; context=10262; dropped=[humour_guide, location_profiles, texture_pool]; truncated=[location_profiles, temporal_context, continuity_context, pronoun_accuracy]
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Beatrice's admission of a prior argument with Eleanor."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes potential motives for both Beatrice and Ivor, hinting at deeper conflicts."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Beatrice's eyes dart nervously as Hugo questions her."
      ]
    },
    ...
    "emotionalRegister": "A critical clue shifts the investigation's focus and heightens the tension.",
