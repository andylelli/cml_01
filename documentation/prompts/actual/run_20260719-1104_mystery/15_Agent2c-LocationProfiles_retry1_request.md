...
- Project ID: ``
- Timestamp: `2026-07-19T11:07:38.593Z`
...
- Era-authentic markers: radio broadcasting in common rooms, early television sets in select suites, military-grade radar systems used for coastal surveillance, rationed petrol for civilian vehicles, increased use of bicycles and public transport, post-war automobile boom beginning with new models, party-line telephones in guest rooms, military encryption methods for sensitive information
- Tone: Classic
- No anachronisms
...
1. keyLocations[1].sensoryVariants[2].smells is required
...
Era: 1940s
Primary Location: hotel
Description: a coastal hotel with a mix of Art Deco and Colonial architectural features, offering scenic ocean views and a promenade
Crime Scene: Brighton
Weather: overcast with occasional drizzle, typical for coastal regions
Mood: tension-filled as guests are unsettled by recent events
...
Setting constraints:
- Physical constraints: narrow hallways limiting movement and visibility, fire escapes leading to restricted areas, oceanfront views obstructed by large palm trees
- Geographic isolation: moderately isolated, accessible only via a winding coastal road, with limited nearby facilities
- Access control: staff-only areas in the kitchen and maintenance rooms, restricted access to the rooftop terrace, daily check-ins for all guests at the front desk

Era constraints to include:
- Technology: radio broadcasting in common rooms, early television sets in select suites, military-grade radar systems used for coastal surveillance
- Transportation: rationed petrol for civilian vehicles, increased use of bicycles and public transport
- Social norms: women increasingly occupying roles in the workforce, post-war trauma affecting community interactions
