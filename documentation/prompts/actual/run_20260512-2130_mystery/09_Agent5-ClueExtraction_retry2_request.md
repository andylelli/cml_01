...
- Project ID: `unknown`
- Timestamp: `2026-05-12T21:32:33.586Z`
...
2. Generate a clue that provides evidence for: "The clock's time does not match witness accounts about the timing of the murder...."
   → contradiction | essential | early | temporal | step 1 | terms: clock's, match, witness

3. Generate a clue that makes the reader directly observe: "Witnesses state they heard the clock strike the hour earlier than the time of death...."
   → observation | essential | early | temporal | step 2 | terms: witnesses, state, heard

4. Generate a clue that provides evidence for: "This indicates that the clock may have been tampered with to create a false timeline...."
   → contradiction | essential | early | temporal | step 2 | terms: indicates, clock, tampered

5. Generate a clue that makes the reader directly observe: "Fresh tool marks are found on the clock mechanism...."
   → observation | essential | mid | temporal | step 3 | terms: fresh, marks, found

6. Generate a clue that provides evidence for: "This suggests recent tampering with the clock to mislead about the murder timeline...."
   → contradiction | essential | mid | temporal | step 3 | terms: suggests, recent, tampering

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The clock's time does not match witness accounts about the timing of the murder...."
...
9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "A controlled observation is set up to compare the clock's tampering evidence with Captain Ivor Hale'..."
   → observation | essential | mid | temporal | terms: controlled, observation, compare
...
Create 2 red herrings that support the false assumption: "The murder must have occurred just before the clock struck eleven."
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 1, 2, 3; words: witness, accounts, clock) and may support the true solution.
  - [critical] Red Herring Separation: Red herring rh_2 overlaps inference corrections (steps: 2, 3; words: clock, recent, tampering) and may support the true solution.
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
