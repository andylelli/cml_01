...
- Timestamp: `2026-05-29T16:58:23.235Z`
...
**Character Names** (pre-selected — use EXACTLY as given, do not alter, abbreviate, or substitute any name): Frank Barlow, Norman Lynton, Julie Waldron, Christopher Skelton, Alice Turnbull
...
**Setting**: 1940s - A large transatlantic passenger liner operating in the immediate post-WWII period, featuring multiple decks with distinct social class accommodations and restricted access areas for crew and officers.
**Crime Type**: Murder
**Social Context**: clear social hierarchy among passengers and crew, post-war social adjustments including increased female workforce, strict etiquette and protocol in public and private ship spaces
**Tone**: Cozy
