...
- Timestamp: `2026-05-29T17:09:06.709Z`
...
Shock and disbelief ripple through the confined social world aboard the ocean liner at the discovery of the locked-cabin murder.
...
Characters who may be funny: Frank Barlow, Norman Lynton, Julie Waldron
Permitted forms: understatement, observational, polite_savagery
Rationale: Humour here can lighten initial tension and establish character voices without undermining the gravity of the crime.
...
• [clue_1] The victim’s cabin door latch is made of brass showing a slight bluish patina from seawater exposure, indicating prolonged contact with the marine environment.
  Category: spatial | Criticality: essential | Supports inference step 1
  Points to: The victim’s cabin latch material and seawater effect
...
Known location profile anchors: SS Ocean Sovereign, Atlantic Ocean - Crime Site, First Class Dining Saloon, Ship’s Bridge, Crew Quarters, Victim’s cabin, Atlantic Ocean liner, early morning
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "SS Ocean Sovereign", "Atlantic Ocean - Crime Site", "First Class Dining Saloon", "Ship’s Bridge", "Crew Quarters", "Victim’s cabin, Atlantic Ocean liner, early morning"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "Victim’s cabin, Atlantic Ocean liner, early morning". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=5617; context=9770; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - Scene is set in: Victim’s cabin, Atlantic Ocean liner, early morning — reference it naturally within the paragraph, never as your opening phrase.
  - Opening atmosphere (MANDATORY — validator enforced): the first paragraph MUST contain at least one of: rain / wind / fog / storm / mist / thunder / evening / morning / night / dawn / dusk / season / afternoon / midday / noon / midnight / twilight / sunrise / sunset / daylight / sunlight / overcast / cloudy / bright / dark / grey / pale / cold / warm / chill / crisp / damp / drizzle / haze / lamplight / firelight. A chapter that omits all of these from its opening paragraph will be rejected.
  - INVESTIGATOR ESTABLISHMENT REQUIRED: Alice Turnbull must claim or be recognised as the investigator in this chapter. Establish Alice Turnbull as the detective-in-charge within the first two paragraphs — Alice Turnbull IS the investigator. Do NOT have any character suggest a "real" detective is still coming, or imply that authority has not yet been delegated. Alice Turnbull begins the investigation in this chapter.
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The victim’s cabin door latch is made of brass showing a slight bluish patina from seawater exposure, indicating prolonged contact with the marine environment. [clue_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: The victim’s cabin latch material and seawater effect
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Alice Turnbull quietly contemplates the locked door, sensing a hidden complexity"
      ]
    },
    "summary": "the detective Turnbull arrives aboard the ocean liner and is led to the victim’s locked cabin where the body is discovered. She notes the brass latch’s faint bluish patina from seawater exposure, setting the stage for a puzzling locked-room murder.",
    "estimatedWordCount": 1800,
    "emotionalRegister": "Shock and disbelief ripple through the confined social world aboard the ocean liner at the discovery of the locked-cabin murder.",
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 1: "The victim’s cabin door latch is made of brass showing a slight bluish patina from seawater exposure, indicating prolonged contact with the marine environment." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
