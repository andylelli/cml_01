...
- Project ID: ``
- Timestamp: `2026-07-20T17:44:59.121Z`
...
- Era-authentic markers: radio broadcasts, early television sets, basic radar equipment, rationed wartime vehicles, post-war automobiles, bicycles, long-distance telephone calls, military encryption methods
- Tone: Classic
- No anachronisms
...
Description: A large, somewhat opulent seaside hotel with Art Deco architecture, featuring a grand lobby and ocean-view rooms.
...
Setting constraints:
- Physical constraints: narrow hallways limiting movement, access to beach restricted by hotel grounds, common areas crowded during peak hours
- Geographic isolation: The hotel is situated on a cliff overlooking the ocean, with the nearest town several miles away, limiting outside assistance.
- Access control: restricted access to staff-only areas, guest check-in procedures, security protocols for valuables
...
- Social norms: impact of WWII on daily life, women increasingly in workforce
