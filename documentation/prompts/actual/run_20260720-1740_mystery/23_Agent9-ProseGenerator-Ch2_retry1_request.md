...
- Project ID: ``
- Timestamp: `2026-07-20T17:49:05.325Z`
...
The initial atmosphere is one of elegance tinged with foreboding.
...
Rationale: The tone is serious and sets the stage for a murder mystery.
...
• [clue_core_contradiction_chain] indicates, time, death, manipulated
...
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): clock, time, suggests, tampering
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "She closed her eyes briefly, listening to the muted sounds of the hotel stirring awake beyond the door: the clatter of breakfast trays, the faint strains of a Glenn Miller tune from the wireless in the lobby, the distant echo of an air raid siren blending with..."
...
Known location profile anchors: The Grand Seaside Hotel, The Oceanview Suite, The Grand Lobby, The Oceanview Dining Room, The Study, the victim's room in the seaside hotel
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Grand Seaside Hotel", "The Oceanview Suite", "The Grand Lobby", "The Oceanview Dining Room", "The Study", "the victim's room in the seaside hotel"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 2: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with spoken dialogue — e.g. '"[words]," [Name] said/asked/replied/murmured.' The opening quote must be the first character on the line. Anchor opening in "the victim's room in the seaside hotel". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=9099; context=10356; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 2:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "She closed her eyes briefly, listening to the muted sounds of the hotel stirring awake beyond the door: the clatter of breakfast trays, the faint strains of a Glenn Miller tune from the wireless in the lobby, the distant...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • witnesses, recall, clock, chiming, half, past, eight [clue_core_contradiction_chain] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: timeline, murder, inconsistent
...
Chapter 2 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The clock chimes half past eight, contradicting the time shown."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the time of death may have been manipulated, raising questions about the suspects' alibis."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor glances at the clock, her brow furrowing in confusion."
      ]
    },
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 2: the clue [clue_core_contradiction_chain] (indicates, time, death, manipulated) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
...
```text
{
  ...
  "chapters": [
    {
      ...
      "summary": "Eleanor Voss examines the contradictions in the victim’s room, interrogates Captain Ivor Hale and Beatrice Quill, and realizes the timeline of Dr. Mallory Finch’s death may have been manipulated.",
      "paragraphs": [
        ...
        "Eleanor nodded, filing the detail away. The timeline was growing more tangled by the minute. If Beatrice’s recollection was correct, Dr. Finch had been alive at 'ten minutes past nine'—yet the clock’s chimes suggested the fatal moment had come earlier. The possibility that someone had tampered with the timepiece, to mislead or protect, loomed larger with every passing second.",
  ...
  "note": "",
  "audit": {
    "locked_fact_phrases": "present in paragraph 1, paragraph 2, paragraph 4, paragraph 10",
    "season_words_used": "winter, wintry, rain, cold, grey, chill",
    "discriminating_test_present": "no",
    "required_clues_present": "clue_core_contradiction_chain: chapter 2 paragraph 1, inference: chapter 2 paragraph 2",
