...
- Project ID: ``
- Timestamp: `2026-07-20T17:48:09.219Z`
...
- Eleanor Voss
  Public identity anchor: Local Hotelier; detective 
  Connection to victim: Eleanor respects Mallory's professionalism, but she suspects Mallory knows more about the victim than she lets on.; Eleanor and Mallory first met when Mallory treated Eleanor's mother, creating an uneasy gratitude..
...
- Captain Ivor Hale
  ...
  Connection to victim: Mallory respects Ivor for his military service but is annoyed by his traditional views.; They met at a charity function, where Ivor's brash comments shocked her..
  Investigation relevance: access plausibility: medium | alibi window: 9:00 PM - 9:20 PM | opportunity channel: hotel bar.
...
• [clue_mechanism_visibility_core] mechanism, relies, clock, victim, twenty, expose, false, timing
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: clock, time, suggests, tampering
...
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the victim's room in the seaside hotel". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=7546; context=10046; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • clock, victim, room, shows, twenty, minutes, past, nine, discovered [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The clock in the victim's room shows twenty minutes past nine."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the victim was found dead with the clock displaying a time that contradicts initial alibis."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_2] A neighbor mentions hearing a loud crash from the victim's room at nine o'clock — seeds false inference about a struggle.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor stands frozen at the door, the weight of the scene settling in her chest."
      ]
    },
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_2",
      "placementDetail": "A neighbor mentions hearing a loud crash from the victim's room at nine o'clock — seeds false inference about a struggle."
    },
    "emotionalRegister": "The initial atmosphere is one of elegance tinged with foreboding.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (mechanism, relies, clock, victim, twenty, expose, false, timing) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
