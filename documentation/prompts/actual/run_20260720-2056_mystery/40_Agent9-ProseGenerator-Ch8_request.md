...
- Project ID: ``
- Timestamp: `2026-07-20T21:09:40.509Z`
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_early_1, clue_mid_1, clue_core_contradiction_chain, clue_5, clue_1, clue_6, clue_2, clue_3, clue_4, clue_core_elimination_chain, clue_culprit_direct_1, clue_fp_contradiction_step_3, clue_culprit_direct_dr_mallory_finch, clue_late_1, clue_7, clue_8 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): dish, served, gala, contained, rare, poison | dish, lethal, combined, lemon, sauce | dish, cause, death | sylvia, consumed, dish, willingly, unaware, danger | sudden, death, suspicious | dish, lethal, combined, lemon, sauce | dish, cause, death | mallory, finch, means, commit, crime | finch, prime, suspect, access | indicates, possible, movement, suspect | narrowing, suspect, list, away, captain, ivor | physical, trace, opportunity, indicate, mallory, finch | indicates, acquired, poison, administered, detection | direct, shows, mallory, finch, means, opportunity | physical, trace, opportunity, indicate, mallory, finch | finch, motive, poison, sylvia | eliminates, possibility, self, harm
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the clock approached midnight, Hugo lingered by the window, watching droplets race down the glass. The folder of medical records sat unopened by anyone else, its contents now seared into the minds of all present. The emotional wounds were raw, the motives t..."
...
This is a **controlled dinner reenactment** test. The detective must:

**Test mechanism (paraphrase — do NOT copy verbatim):**
Render this test MECHANISM as live, in-scene action and dialogue, composing ENTIRELY in your own words from these elements (reproducing any briefing phrase verbatim FAILS validation): discriminating, compares, reaction, contain, poison, claimed, timeline

**MANDATORY CHECKLIST - Every box must be checked:**

☐ **Evidence Integration**
  ☐ Explicitly reference or use clue: "clue_1" (clue) (appears in Act 1, Scene 3)
  ☐ Explicitly reference or use clue: "clue_6" (clue) (appears in Act 1, Scene 3)
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=20805; context=5019; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 8:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the clock approached midnight, Hugo lingered by the window, watching droplets race down the glass. The folder of medical records sat unopened by anyone else, its contents now seared into the minds of all present. The...".
  ...
  - ⚠ DISCRIMINATING TEST (trap) — MANDATORY real-time scene with dialogue and confrontation. DO NOT summarize it after the fact.
    ...
    Elements the test must dramatize (compose the scene ENTIRELY in your own sentences from these — reproducing any briefing phrase verbatim FAILS validation): discriminating, compares, reaction, contain, poison, claimed, timeline
    Cite these already-revealed clue IDs during the test: clue_1, clue_6, clue_mechanism_visibility_core, clue_early_1
...
Chapter 8 (Act 3) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The guests' reactions to the dish reveal the truth about the poison."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the mechanism of the poisoning, implicating Dr. Mallory Finch as the culprit."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Hugo's hands tremble slightly as he prepares the test, knowing the stakes are high."
      ]
    },
    ...
    "emotionalRegister": "The climax is fraught with emotional confrontations that lay bare the truth behind the murder.",
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 8: the clue [clue_1] (indicates, potential, toxic, reaction, consumed, together) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
