...
- Project ID: ``
- Timestamp: `2026-07-20T21:02:55.044Z`
...
• [clue_2] mallory, finch, access, kitchen, medical, supplies
  Category: spatial | Criticality: essential | Supports inference step 2
  Points to: mallory, finch, means, commit, crime

• [clue_3] indicates, acquired, poison, administered, detection
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: finch, prime, suspect, access

• [clue_4] footprints, leading, kitchen, dining, area
  Category: physical | Criticality: essential | Supports inference step 3
  Points to: indicates, possible, movement, suspect
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_early_1, clue_mid_1, clue_core_contradiction_chain, clue_5, clue_1, clue_6 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): dish, served, gala, contained, rare, poison | dish, lethal, combined, lemon, sauce | dish, cause, death | sylvia, consumed, dish, willingly, unaware, danger | sudden, death, suspicious | dish, lethal, combined, lemon, sauce | dish, cause, death
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "The chapter closed with Hugo’s renewed focus on the conflicting statements and the dish that had become the centerpiece of suspicion. Each clue, once taken at face value, now demanded a second look. The investigation deepened, and Hugo’s understanding shifted:..."
...
- Phrases to avoid (already overused in earlier chapters): "the dining room of the seaside hotel", "been the channel for the fatal event", "in the heat of battle one must", "the heat of battle one must always", "heat of battle one must always steer", "of battle one must always steer true", "battle one must always steer true sylvia", "one must always steer true sylvia was", "must always steer true sylvia was a", "always steer true sylvia was a formidable".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=13569; context=8043; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 4:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "The chapter closed with Hugo’s renewed focus on the conflicting statements and the dish that had become the centerpiece of suspicion. Each clue, once taken at face value, now demanded a second look. The investigation dee...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • finch, medical, knowledge, access [clue_3]
      Points to: finch, prime, suspect, access
    • footprints, visible, floor [clue_4]
      Points to: indicates, possible, movement, suspect
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Dr. Mallory Finch's rivalry with Sylvia revealed."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that multiple suspects had plausible motives for wanting Sylvia dead."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_2] Eleanor recalls that Sylvia often complained of stomach issues — misdirection suggesting her death may be from natural causes.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor's hands tremble as she recalls a heated argument with Sylvia."
      ]
    },
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_2",
      "placementDetail": "Eleanor recalls that Sylvia often complained of stomach issues — misdirection suggesting her death may be from natural causes."
    },
    "emotionalRegister": "A pivotal revelation shifts the focus of the investigation, challenging initial assumptions.",
