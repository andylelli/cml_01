...
- Project ID: ``
- Timestamp: `2026-07-20T21:08:32.551Z`
...
```text
OBLIGATION TO SATISFY: Plant the required clue (clue_8) in this chapter as a concrete in-scene observation a character sees, does, or says — not as a summary. Detail: The medical records are available for review.
