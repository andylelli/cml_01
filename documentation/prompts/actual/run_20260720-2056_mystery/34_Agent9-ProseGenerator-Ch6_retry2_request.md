...
- Project ID: ``
- Timestamp: `2026-07-20T21:07:59.200Z`
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_early_1, clue_mid_1, clue_core_contradiction_chain, clue_5, clue_1, clue_6, clue_2, clue_3, clue_4, clue_core_elimination_chain, clue_culprit_direct_1, clue_fp_contradiction_step_3 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): dish, served, gala, contained, rare, poison | dish, lethal, combined, lemon, sauce | dish, cause, death | sylvia, consumed, dish, willingly, unaware, danger | sudden, death, suspicious | dish, lethal, combined, lemon, sauce | dish, cause, death | mallory, finch, means, commit, crime | finch, prime, suspect, access | indicates, possible, movement, suspect | narrowing, suspect, list, away, captain, ivor | physical, trace, opportunity, indicate, mallory, finch | indicates, acquired, poison, administered, detection
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As Hugo stepped back from his inquiries, he took in the details: the springtime drizzle outside, the glow of lamplight above, the whispered exchanges between staff. The kitchen of the seaside hotel, with its bustling activity and layered stories, had yielded b..."
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=18235; context=5746; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
11. FORBIDDEN OPENING STRUCTURE: Do NOT begin this chapter with: "It was the sudden hush that settled over the lounge of the seaside hotel, broken only by the faint sound of rain flickering against the windows, that signaled the moment for Hugo Vane to act."
...
- clue_late_1 must appear in Act 2, Scene 3 via Access logs from the kitchen.
...
- Chapter 6:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As Hugo stepped back from his inquiries, he took in the details: the springtime drizzle outside, the glow of lamplight above, the whispered exchanges between staff. The kitchen of the seaside hotel, with its bustling act...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • gala, menu, available, guests, view [clue_fp_contradiction_step_3]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • gala, menu, available, guests, view [clue_late_1]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The evidence linking Dr. Mallory Finch to the scene of the crime."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes a convincing but ultimately flawed theory that implicates Dr. Mallory Finch."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Dr. Finch's hands shake as she defends herself, her voice rising in pitch."
      ]
    },
    ...
    "emotionalRegister": "A dramatic confrontation reveals the true nature of the victim's relationships and motives.",
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 6: the clue [clue_culprit_direct_dr_mallory_finch] (direct, ties, mallory, finch, mechanism, access, point, before, discriminating, excludes, competing, suspect) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
