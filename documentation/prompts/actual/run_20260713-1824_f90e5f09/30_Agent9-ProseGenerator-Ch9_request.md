...
- Timestamp: `2026-07-13T18:39:35.225Z`
...
• [clue_16] eliminates, charles, wentworth, because, alibi, corroborated, multiple, household, guests, placing, library, time
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: eliminates, charles, wentworth, because, alibi, corroborated, multiple, household, guests, placing, library, time

• [clue_17] eliminates, margot, sinclair, because, servants, confirm, attending, household, accounts, main, house, murder
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: eliminates, margot, sinclair, because, servants, confirm, presence, main, house, murder

• [clue_18] eliminates, robert, hensley, because, stable, records, staff, place, tending, horses, away, garden
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: eliminates, robert, hensley, because, stable, records, staff, place, away, garden, gate, time
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Outside, the wind howled, rattling the bare branches against the glass. Within, the household waited, each member alone with their fears and their secrets. Evelyn watched the fire burn low, her thoughts circling the contradictions and the truths revealed. The..."
...
Known location profile anchors: Wentworth Manor, Garden Sundial, Wentworth Manor Library, Servants' Hall, Main Entrance Hall, Manor library and main hall
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Wentworth Manor", "Garden Sundial", "Wentworth Manor Library", "Servants' Hall", "Main Entrance Hall", "Manor library and main hall"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 9: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with an explicit time marker — e.g. "That morning…" / "By the time dusk fell…" / "It was nearly four o'clock…" / "On the second day after the discovery…". Time must be in the first clause. Anchor opening in "Manor library and main hall". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Chapter 8 (score 96/100):
  Quality gaps noted: scene grounding weakness
  Address in upcoming chapters: Open next chapter with a named location anchor plus at least two sensory cues and one atmosphere marker.
- Phrases to avoid (already overused in earlier chapters): "but the edge of anxiety was unmistakable", "forty five minutes past one in the", "five minutes past one in the afternoon".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=27108; context=4944; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, continuity_context, pronoun_accuracy]
...
Suspect pressure target(s): Charles Wentworth, Margot Sinclair, Robert Hensley, Vivian Clarke, James Porter
...
Manner of death (MUST be named in the reveal): state plainly how the victim died — cause of death: struck with a heavy brass garden gate bolt. Surface it in the prose in plain words (e.g. "struck with a heavy brass garden gate bolt") — not only how the clock/timeline was manipulated. A reveal that explains the concealment but never the killing fails the fair-play contract.
Solution chain (plot clarity, NOT a timeline ledger): present the solution as ONE clear spine the reader can follow — James Porter, by the named means, with the established opportunity, for a specific reason. Clear each other suspect in a line or two; do NOT walk through every alibi and timeline as bookkeeping. A convoluted multi-timeline elimination is the failure mode here.
...
Motive (specific + emotional, NEVER a bare label): develop WHY James Porter killed Lady Beatrice Wentworth with concrete, personal specificity drawn from their relationship and history — the emotional truth that made murder feel, to James Porter, like the only door left. A one-word motive ("jealousy", "greed", "revenge") asserted without that interior truth is a FAIL: name what was actually at stake for James Porter and why no lesser act would serve.
Closure (emotional payoff, not a verdict): end on human consequence — the cost to those left behind, James Porter's undoing, and the detective's reflection on what the truth changes — not a clinical "innocence established by the physical record." The reader should FEEL the weight of the resolution, not merely verify it.
...
- Chapter 9:
  ...
  - Scene is set in: Manor library and main hall — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Outside, the wind howled, rattling the bare branches against the glass. Within, the household waited, each member alone with their fears and their secrets. Evelyn watched the fire burn low, her thoughts circling the cont...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • multiple, guests, testify, charles, wentworth, library, murder, timeframe [clue_16]
      Points to: eliminates, charles, wentworth, because, alibi, corroborated, multiple, household, guests, placing, library, time
    • servants, testify, margot, sinclair, occupied, household, accounts, relevant, time [clue_17]
      Points to: eliminates, margot, sinclair, because, servants, confirm, presence, main, house, murder
    • stable, logs, staff, statements, place, robert, hensley, stables, murder, timeframe [clue_18]
      Points to: eliminates, robert, hensley, because, stable, records, staff, place, away, garden, gate, time
  ...
  - Sensory obligation — use at least two of: firelight flickering on walls, stained-glass colors deepened | soft footsteps on carpet, clock ticking near silence | coal smoke and wood polish. Mood: reflective tension.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Robert Hensley quietly reflects on his innocence amid accusations"
      ]
    },
    ...
    "emotionalRegister": "The controlled gate latch simulation and social scrutiny expose the butler’s guilt, breaking the false consensus.",
