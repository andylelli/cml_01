...
- Timestamp: `2026-07-13T18:27:04.565Z`
...
## Mandatory Clue Requirements (19 required)
1. Generate a clue that makes the reader directly observe: "The brass latch bolt on the garden gate shows thermal stress lines and soot discoloration consistent..."
   → observation | essential | early | testimonial | step 1 | terms: brass, latch, garden

2. Generate a clue that provides evidence for: "The latch must have been heated to a temperature sufficient to cause thermal expansion, indicating t..."
   → contradiction | essential | early | temporal | step 1 | terms: latch, heated, temperature

3. Generate a clue that makes the reader directly observe: "Multiple household servants independently recall seeing Lady Beatrice in the servants’ hall at early..."
   → observation | essential | early | temporal | step 2 | terms: multiple, household, servants

4. Generate a clue that provides evidence for: "Servants’ memories have formed a false consensus due to social reinforcement, masking the victim’s a..."
   → contradiction | essential | early | temporal | step 2 | terms: servants’, memories, formed

5. Generate a clue that makes the reader directly observe: "James Porter possesses unique technical knowledge of the garden gate’s brass latch thermal behavior ..."
   → observation | essential | mid | temporal | step 3 | terms: james, porter, possesses

6. Generate a clue that provides evidence for: "Only James Porter had the means and opportunity to exploit the latch’s delayed release to stage the ..."
   → contradiction | essential | mid | temporal | step 3 | terms: james, porter, means

7. Generate a clue that makes the reader directly observe: "The victim’s body was struck with the heavy detached brass bolt from the garden gate...."
   → observation | essential | mid | testimonial | step 4 | terms: victim’s, struck, heavy

8. Generate a clue that provides evidence for: "The murder weapon is directly linked to the garden gate mechanism, confirming the murder occurred af..."
   → contradiction | essential | mid | temporal | step 4 | terms: murder, weapon, directly

9. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The latch must have been heated to a temperature sufficient to cause thermal expansion, indicating the bolt could not have released before t..."
   → contradiction | essential | mid | temporal | step 1 | terms: latch, heated, temperature

10. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The garden gate’s brass bolt latch delays the gate release until the afternoon heat causes sufficient thermal expansion. Witnesses falsely a..."
   → observation | essential | early | temporal | terms: garden, gate’s, brass

11. Generate one essential EARLY clue giving a concrete, fair-play indicator of the manner of death (struck with a heavy brass garden gate bolt) observable at the body-discovery scene — e.g. for blunt-force: a head wound, a bloodied heavy object, or bruising. Do NOT name or explain the concealment trick; only the physical tell a witness could see at the scene.
   → observation | essential | early | testimonial | terms: struck, heavy, brass, wound, blood, bruis, blunt

12. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Demonstrate by controlled temperature simulation and gate latch observation that the garden gate’s b..."
   → observation | essential | mid | temporal | terms: demonstrate, controlled, temperature

13. Generate one essential mid-story clue whose description or pointsTo explicitly names James Porter and states the unique trace, preparation detail, or mechanism link that points to James Porter rather than any non-culprit.
   → observation | essential | mid | temporal | terms: James Porter, garden, gate’s, brass

14. Generate one essential early-or-mid clue establishing that James Porter UNIQUELY had the means/skill/access/knowledge required to execute the concealment mechanism, and that the other suspects did not — so the reveal relies only on this already-planted capability, never on a means introduced for the first time at the confrontation.
   → elimination | essential | mid | temporal | terms: James Porter, garden, gate’s, brass

15. Generate a clue showing observable evidence of James Porter's premeditation or planning (Protecting family reputation). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: protecting, family, reputation

16. Generate a clue that explicitly eliminates suspect Charles Wentworth using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Charles Wentworth because ...").
   → elimination | essential | mid | testimonial | terms: Charles Wentworth

17. Generate a clue that explicitly eliminates suspect Margot Sinclair using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Margot Sinclair because ...").
   → elimination | essential | mid | testimonial | terms: Margot Sinclair

18. Generate a clue that explicitly eliminates suspect Robert Hensley using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Robert Hensley because ...").
   → elimination | essential | mid | testimonial | terms: Robert Hensley

19. Generate one essential early or mid elimination clue that explicitly rules out Charles Wentworth and narrows the solution toward culprit James Porter. The pointsTo text must start with "Eliminates Charles Wentworth because ..." and cite corroborated evidence.
   → elimination | essential | mid | testimonial | terms: Charles Wentworth, James Porter
...
## Access Constraints
Actors: James Porter, Charles Wentworth, Robert Hensley, Margot Sinclair, Vivian Clarke
Objects: Garden gate with brass bolt latch, Garden thermometer, Heavy detached brass bolt
...
- Inspector Evelyn Harcourt: sensitive items: Physical traces, Witness testimony, Mechanical devices
- Charles Wentworth: sensitive items: Gate latch knowledge, Presence near garden gate
- Margot Sinclair: sensitive items: Library access, Servants’ testimonies
- Robert Hensley: sensitive items: Stable records, Gate latch knowledge
- Vivian Clarke: sensitive items: Servants’ hall testimony, Footprint observations
- James Porter: sensitive items: Gate latch mechanism, Kitchen and garden access
...
## Clue Density: dense
Generate at least 19 clues (mandatory requirements exceed dense target range).
Additional optional clues (4-6 extra) for texture.

## Red Herring Budget: 2
Create 2 red herrings that support the false assumption: "The garden gate was opened at noon as all household members and guests saw Lady Beatrice entering the grounds then."
...
Generate at least 19 clues and 2 red herrings that uphold fair play — every essential clue must be placed so the reader can solve the mystery before the detective reveals the answer.
