...
- Timestamp: `2026-07-13T18:36:13.934Z`
...
"she turned to the table eyeing ... and the true sequence of events"
...
Your prose has been detected copying from an earlier chapter. Every paragraph listed below appears in a prior chapter and is COMPLETELY OFF-LIMITS. Do not reproduce, rephrase, or structurally echo any of them:
  ...
  • "Inspector Evelyn Harcourt stepped briskly onto ... near the gate at Wentworth Manor."
  • "Lady Beatrice Wentworth lay motionless, her ... against the pallor of her skin."
  • "She crouched beside the gate, gloved fingers tracing the rough, cold brass."
  • "Rising, Inspector Evelyn Harcourt swept her gaze over the assembled household."
  • "The winter silence pressed in, broken ... automobile idling at the manor’s drive."
  • "Her gaze returned to the garden gate."
  • "Vivian Clarke’s composure faltered as she ... hem of the dead woman’s coat."
  • "Margot Sinclair’s voice, low and precise, cut through the tension."
  • "James Porter, when addressed, met Inspector ... with a steady, almost deferential calm."
  • "Robert Hensley’s reply, when it came, was flat and unvarnished."
  • "Charles Wentworth, when pressed, offered a brittle, sardonic smile."
  • "Inspector Evelyn Harcourt moved methodically, cataloguing the scene."
  • "A brief clearing in the fog ... bolt with an almost theatrical clarity."
  • "She summoned James Porter once more, her tone deceptively casual."
  • "Margot Sinclair lingered near the edge ... worrying the clasp of her handbag."
  • "Vivian Clarke, having recovered her poise, ... Evelyn Harcourt with a clipped efficiency."
  • "Robert Hensley’s bluntness returned as he gestured to the garden gate."
  • "The winter day was already waning, ... household retreated toward the manor’s warmth."
  • "As she turned back toward the ... slow encroachment on the estate’s isolation."
  • ""It’s colder than the devil’s own ... behind a curtain of thickening fog."
  • "The brass latch caught what little ... peculiar warping along the bolt’s length."
  • "Straightening, Evelyn let her breath plume ... racing ahead of the household’s recollections."
  • "James Porter lingered at the edge ... his gaze fixed on the ground."
  • "Evelyn watched him, weighing his words against the evidence at her fingertips."
  • "Margot Sinclair, standing a few paces ... fur collar tighter against the cold."
  • "Charles Wentworth, impatient, stepped forward, his overcoat buttoned to the throat."
  • "A brief lull settled over the ... water from the yew branches overhead."
  • "Evelyn’s thoughts circled back to the evidence."
  • "She turned to Margot, her tone gentler."
  • "James Porter lingered, his posture shrinking as the conversation shifted."
  • "Charles, unable to contain his impatience, ... the tension with a brittle laugh."
  • "As the group began to drift ... by the gate, her thoughts racing."
  • "The fog thickened, swallowing the garden in its wintry shroud."
  • "By the time the grandfather clock ... coal smoke from the kitchen range."
  • "She drew in a slow breath, ... the room biting through her coat."
  • "Vivian Clarke, her posture rigid and ... the table, broke the silence first."
  • "Evelyn pressed, her voice cool."
  • "Yet as each servant spoke, Evelyn ... wavered—a moment before, a moment after."
  • "She let the silence stretch, the ... persistent, low hum of the wind."
  • "She turned to the table, eyeing the brass bolt with renewed suspicion."
  • "Charles Wentworth’s sardonic veneer cracked, just for a moment."
  • "Evelyn offered a faint, dry smile."
  • "As the interviews wound down, Vivian Clarke lingered, her composure fraying."
  • "A gust of wintry air rattled ... casting the room into deeper shadow."
  • "A faint metallic clatter broke the ... the Garden workshop near the gate."
  • "James Porter stood before her, cap ... hand, his posture deferential but tense."
  • "Charles Wentworth lounged against a battered ... collar turned up against the chill."
  • "James’s answer came slowly, each word weighed with care."
  • "She pressed gently, her tone deceptively mild."
  • "James’s fingers tightened around his cap, the tremor more pronounced now."
  • "Evelyn turned her attention back to the physical evidence."
  • "Charles, unable to contain his impatience, interjected with a sardonic twist."
  • "James shifted, his discomfort growing."
  • "A beat of silence settled, broken ... of the workshop’s battered wall clock."
  • "Charles straightened, his posture defensive."
  • "Evelyn turned back to the bolt, her mind circling the contradictions."
  • "A sudden gust rattled the workshop ... outside swirling in the fading light."
  • "As the interview wound down, Evelyn gathered her notes, her thoughts troubled."
...
ATTEMPT: 1/3
OFFENDING TEXT: high n-gram overlap detected (0.71 >= 0.65). Rephrase this passage to avoid template leakage.
MANDATORY FIXES:
