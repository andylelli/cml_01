...
- Timestamp: `2026-07-13T18:35:15.903Z`
...
• [clue_5] james, porter, possesses, unique, technical, knowledge, garden, gate, brass, latch, thermal, behavior
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: james, porter, possesses, unique, technical, knowledge, garden, gate, brass, latch, thermal, behavior

• [clue_6] james, porter, means, opportunity, exploit, latch, delayed, release, stage, murder
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: james, porter, means, opportunity, exploit, latch, delayed, release, stage, murder
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "A gust of wintry air rattled the window, and for a moment, the lamp’s glow flickered, casting the room into deeper shadow. Evelyn gathered her notes, her thoughts circling the contradictions revealed. The wound, the bolt, the mechanism’s delay, the rehearsed t..."
...
Known location profile anchors: Wentworth Manor, Garden Sundial, Wentworth Manor Library, Servants' Hall, Main Entrance Hall, Garden workshop near the gate
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Wentworth Manor", "Garden Sundial", "Wentworth Manor Library", "Servants' Hall", "Main Entrance Hall", "Garden workshop near the gate"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 4: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a noun-phrase atmosphere — e.g. "The smell of damp stone in the cellar…" / "A chill from the landing…" / "The sound of the clock in the hall…". Pattern: "The/A [noun] of/in/from [place]…". Anchor opening in "Garden workshop near the gate". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=14446; context=6471; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
Suspect pressure target(s): James Porter, Charles Wentworth
...
- Chapter 4:
  ...
  - Scene is set in: Garden workshop near the gate — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "A gust of wintry air rattled the window, and for a moment, the lamp’s glow flickered, casting the room into deeper shadow. Evelyn gathered her notes, her thoughts circling the contradictions revealed. The wound, the bolt...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • james, porter, explains, thermal, expansion, properties, garden, gate, brass, latch, detail [clue_5]
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "James Porter’s hands tremble slightly when discussing the latch"
      ]
    },
    ...
    "emotionalRegister": "Physical evidence disproves the accepted timeline, unsettling the manor’s collective memory.",
