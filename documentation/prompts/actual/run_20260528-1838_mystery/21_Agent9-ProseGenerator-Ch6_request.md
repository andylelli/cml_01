...
- Project ID: ``
- Timestamp: `2026-05-28T18:49:08.075Z`
...
Evidence ties Captain Hale to the manipulation, deepening suspicion and emotional unease within the manor.
...
Permission: conditional — condition: Mallory Finch’s sardonic wit can surface here to express frustration and intellectual sharpness.
Characters who may be funny: Dr. Mallory Finch
Permitted forms: sardonic
Rationale: Mid-investigation tension benefits from sharp humour to convey character stress and personality.
...
• [clue_12] Captain Ivor Hale is uniquely linked to the reversed pendulum’s tampering by traces of dust on his clothing matching the pendulum bob.
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: Direct physical evidence pointing to Captain Ivor Hale as the culprit.

• [clue_13] Captain Ivor Hale’s financial records reveal payments from the victim in exchange for silence, indicating motive and premeditation.
  Category: behavioral | Criticality: essential | Supports inference step 4
  Points to: Visible evidence of Captain Ivor Hale’s motive and planning before confrontation.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the rain eased to a whisper, Eleanor allowed herself a moment’s respite. The tangled threads of suspicion had tightened around Captain Hale, but certainty remained elusive. The investigation pressed onward, the manor’s cold walls holding their secrets a lit..."
...
Known location profile anchors: Wychwood Manor, The Library, The Family Wing, Servants’ Quarters, The Formal Gardens, Manor Study
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Wychwood Manor", "The Library", "The Family Wing", "Servants’ Quarters", "The Formal Gardens", "Manor Study"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 6: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with an expository setup — e.g. "It was not until…" / "There had been no word since…" / "There was a note on the table…". Begin with "It was", "There was", or "There had been" followed immediately by a specific condition, event, or discovery. Do NOT begin with generic atmosphere. Anchor opening in "Manor Study". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Phrases to avoid (already overused in earlier chapters): "showed quarter past three when the body", "quarter past three when the body was".
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=13612; context=11466; dropped=[none]; truncated=[fair_play_contract, location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 6:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the rain eased to a whisper, Eleanor allowed herself a moment’s respite. The tangled threads of suspicion had tightened around Captain Hale, but certainty remained elusive. The investigation pressed onward, the manor’...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • A controlled demonstration comparing the pendulum bob’s dust wear and the clock’s mechanical reaction confirms the reversed swing effect. [clue_11]
      Points to: Physical evidence confirming the reversed pendulum swing mechanism.
    • Captain Ivor Hale is uniquely linked to the reversed pendulum’s tampering by traces of dust on his clothing matching the pendulum bob. [clue_12]
      Points to: Direct physical evidence pointing to Captain Ivor Hale as the culprit.
    • Captain Ivor Hale’s financial records reveal payments from the victim in exchange for silence, indicating motive and premeditation. [clue_13]
      Points to: Visible evidence of Captain Ivor Hale’s motive and planning before confrontation.
    ...
    • The pendulum swing direction was reversed, indicating the clock mechanism was tampered with to run backward, overturning the false assumption that the clock time was accurate. [clue_core_contradiction_chain]
      Points to: Explicitly overturns the false assumption about the clock's accuracy with concrete evidence.
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Financial records showing payments from victim to Captain Ivor Hale and matching dust traces on Hale’s clothing"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Captain Hale had both motive and physical evidence tying him to the clock tampering"
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor feels a pang of betrayal, recalling Hale’s proud demeanor"
      ]
    },
