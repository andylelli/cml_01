...
- Timestamp: `2026-04-25T16:46:14.074Z`
...
1. **The clock in the study shows ten minutes past eleven.**: The clock's time contradicts eyewitness accounts. → Narrows the time of death, suggesting tampering.
   **Required evidence**: Theodora was last seen at 10:45 PM.; Guests confirm she was alive until shortly before 11 PM.
2. **A unique winding key is found near the clock.**: The presence of the key indicates potential tampering with the clock. → Eliminates Joan Rayleigh, who had no access to the study.
   **Required evidence**: The clock was dusty, suggesting it had not been disturbed recently.; Witness statements about Joan's location.
3. **Dust on the clock face indicates it hasn't been disturbed in days.**: This contradicts claims of the clock being tampered with during the party. → Eliminates Philip Ingram as he had no motive to tamper with the clock.
   **Required evidence**: Witnesses confirm Philip was in the library.; Physical evidence of dust on the clock.
...
- [essential] physical →step2 (observation): A unique winding key is found near the clock.
- [essential] temporal →step2 (contradiction): The presence of the key indicates potential tampering with the clock.
...
- [essential] temporal →step3 (observation): Dust on the clock face indicates it hasn't been disturbed in days.
- [essential] temporal →step3 (contradiction): This contradicts claims of the clock being tampered with during the party.
- [essential] testimonial →step2 (elimination): Eliminates Joan Rayleigh because she has a corroborated alibi from the party host.
- [essential] behavioral →step2 (observation): Roger Merton was seen preparing financial documents just before the party.
- [essential] testimonial →step2 (elimination): Eliminates Philip Ingram because he was in a different location at the time of the murder.
- [essential] temporal →step2 (observation): A controlled test comparing the clock's time with eyewitness accounts shows inconsistencies.
- [essential] physical →step2 (observation): Fingerprints on the clock face suggest someone tampered with it.
- [essential] physical →step2 (observation): Footprints in the garden lead away from the study.
- [essential] temporal →step2 (observation): Direct evidence ties Roger Merton to the mechanism access point before the discriminating test.
...
- A unique winding key is found near the clock. (early, step 2)
- The presence of the key indicates potential tampering with the clock. (early, step 2)
- Dust on the clock face indicates it hasn't been disturbed in days. (mid, step 3)
- This contradicts claims of the clock being tampered with during the party. (mid, step 3)
- The mechanism relies on clock, study, and minut to expose the false timing. (early, step 1)
- The clock's time contradicts eyewitness accounts. (early, step 1)
- Eliminates Joan Rayleigh because she has a corroborated alibi from the party host. (mid, step 2)
- Roger Merton was seen preparing financial documents just before the party. (mid, step 2)
- Eliminates Philip Ingram because he was in a different location at the time of the murder. (mid, step 2)
- A controlled test comparing the clock's time with eyewitness accounts shows inconsistencies. (mid, step 2)
- Fingerprints on the clock face suggest someone tampered with it. (mid, step 2)
- Footprints in the garden lead away from the study. (mid, step 2)
- Direct evidence ties Roger Merton to the mechanism access point before the discriminating test. (mid, step 2)

### Red Herrings
- Theodora was seen arguing with Roger just before the party, raising suspicions about their relationship. (supports: The murder occurred just before the clock stopped showing quarter past eleven.)
- Joan was overheard discussing her dislike for Theodora, which could imply a motive. (supports: The murder occurred just before the clock stopped showing quarter past eleven.)
...
- clue clue_3: Act 1, Scene 3 (Witness statements)
