...
- Project ID: ``
- Timestamp: `2026-05-13T21:52:04.514Z`
...
• [clue_2] Witnesses recall hearing the clock striking a different hour before the murder.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: The discrepancies in the timing of the clock.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As they gathered around the body, Beatrice felt a sense of foreboding settle over her. The clock, the body, the secrets — they were all intertwined in a complex web of lies and ambition. She could sense that this was just the beginning of a dark journey, one t..."
...
Known location profile anchors: Little Middleton Manor, The Library, The Drawing Room, The Servants' Hall, the victim's home, living room
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The Library", "The Drawing Room", "The Servants' Hall", "the victim's home, living room"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 2: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with spoken dialogue — e.g. '"[words]," [Name] said/asked/replied/murmured.' The opening quote must be the first character on the line. Anchor opening in "the victim's home, living room". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=6521; context=10531; dropped=[none]; truncated=[location_profiles, temporal_context]
...
- Chapter 2:
  ...
  - Location anchor: the victim's home, living room.
  - Opening atmosphere (MANDATORY — validator enforced): the first paragraph MUST contain at least one of: rain / wind / fog / storm / mist / thunder / evening / morning / night / dawn / dusk / season / afternoon / midday / noon / midnight / twilight / sunrise / sunset / daylight / sunlight / overcast / cloudy / bright / dark. A chapter that omits all of these from its opening paragraph will be rejected.
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As they gathered around the body, Beatrice felt a sense of foreboding settle over her. The clock, the body, the secrets — they were all intertwined in a complex web of lies and ambition. She could sense that this was jus...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • Witnesses recall hearing the clock striking a different hour before the murder. [clue_2] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: The discrepancies in the timing of the clock.
...
Chapter 2 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Eleanor's claim of being in the garden during the murder"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes conflicting alibis among the suspects, raising questions about their whereabouts."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_2] Dr. Finch's hurried explanation of her hospital duties raises doubts.
...
[
  {
    ...
    "setting": {
      "location": "the victim's home, living room",
      "timeOfDay": "Late morning",
      "atmosphere": "Frenzied and chaotic as the household reacts"
    },
    "characters": [
      "Beatrice Quill",
      "Eleanor Voss",
    ...
    "purpose": "Establish initial reactions and introduce suspects' alibis",
    "cluesRevealed": [
      "clue_2"
    ],
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor clutches her pearls, her hands trembling as she recounts her last moments with the victim."
      ]
    },
    "summary": "As the household gathers, Beatrice Quill observes the reactions of the suspects. Eleanor Voss claims she was in the garden, while the doctor Finch insists she was at the hospital. Captain Hale's alibi is vague, creating suspicion.",
    "estimatedWordCount": 1800,
    "pivotElement": "Eleanor's claim of being in the garden during the murder",
    "factEstablished": "Establishes conflicting alibis among the suspects, raising questions about their whereabouts.",
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_2",
      "placementDetail": "Dr. Finch's hurried explanation of her hospital duties raises doubts."
    },
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 2: "Witnesses recall hearing the clock striking a different hour before the murder." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
