...
- Project ID: ``
- Timestamp: `2026-07-17T03:24:11.657Z`
...
- Dr. Mallory Finch
  Public identity anchor: Physician; detective 
  Connection to victim: Mutual acquaintances with hidden secrets.; Eleanor and Mallory share a social circle but harbor a deep personal secret regarding their past..
...
• [clue_mechanism_visibility_core] witness, statements, indicate, eleanor, last, seen, near, beach, time, tide
  Category: testimonial | Criticality: essential | Supports inference step 1
  Points to: eleanor, last, known, location, contradicts, high, tide, assumption
...
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "Brighton beach". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=7584; context=9700; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • witnesses, recall, seeing, eleanor, beach [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The body of Eleanor Voss, lifeless and pale against the sand."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the victim was found dead at the beach, hinting at foul play."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_2] A local fisherman mentions seeing a struggle near the water's edge just before Eleanor went missing — seeds false inference about a possible attack.
...
[
  {
    ...
    "setting": {
      ...
      "atmosphere": "Tense and heavy with the scent of salt and dread"
    },
    "characters": [
      "Dr. Mallory Finch",
      "Eleanor Voss"
    ...
    "dramaticElements": {
      "conflict": "The body of Eleanor Voss is discovered, creating immediate tension among the witnesses.",
      "tension": "The waves crash ominously as the gathered crowd whispers suspicions.",
      "microMomentBeats": [
        "Dr. Finch hesitates, feeling the weight of the crowd's gaze."
      ]
    },
    "summary": "On a grim morning at Brighton beach, the body of Eleanor Voss is discovered washed ashore. Dr. Mallory Finch, a local resident, is drawn in by the commotion. As shock ripples through the crowd, whispers of who could have been involved begin to circulate.",
    "beat": "gathering",
    "estimatedWordCount": 1800,
    "pivotElement": "The body of Eleanor Voss, lifeless and pale against the sand.",
    "factEstablished": "Establishes the victim was found dead at the beach, hinting at foul play.",
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_2",
      "placementDetail": "A local fisherman mentions seeing a struggle near the water's edge just before Eleanor went missing — seeds false inference about a possible attack."
    },
    "emotionalRegister": "The hotel exudes elegance, yet an undercurrent of tension sets the stage for the unfolding drama.",
    "dominantCharacterNote": {
      "name": "Eleanor Voss",
      "voiceRegister": "Eleanor speaks with a melodious cadence, often punctuating her sentences with soft laughter that never quite reaches her eyes."
    },
    "humourGuidance": {
      "permission": "forbidden"
    },
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (witness, statements, indicate, eleanor, last, seen, near, beach, time, tide) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
