...
- Project ID: ``
- Timestamp: `2026-07-17T03:25:31.422Z`
...
As the investigation begins, the emotional stakes rise, revealing hidden motives and fears among the guests.
...
Rationale: The investigation's seriousness prohibits levity.
...
Act 1 behaviour contract: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Believes that Eleanor's downfall would be justice for past grievances." — do not surface in Act I.
...
• [clue_parity_bridge] timing, mechanical, sounds, coincides, expected, tide, schedule, confirming, manipulation
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: connects, earlier, conclusion, timing, mechanical, sounds, coincides, expected, tide, schedule, confirming, manipulation
...
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): eleanor, last, known, location, contradicts, high | eleanor, drowned, high, tide
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As Mallory prepared to return to The Seabreeze Hotel, she reflected on the shifting landscape of suspicion. Captain Hale’s fear, Sylvia Trent’s defensiveness, Beatrice Quill’s evasiveness—all had changed the investigation’s state. The clue’s meaning was transf..."
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=10840; context=12638; dropped=[humour_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
Suspect pressure target(s): Hugo Vane, Beatrice Quill, Captain Ivor Hale, Sylvia Trent
...
- Chapter 3:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As Mallory prepared to return to The Seabreeze Hotel, she reflected on the shifting landscape of suspicion. Captain Hale’s fear, Sylvia Trent’s defensiveness, Beatrice Quill’s evasiveness—all had changed the investigatio...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • witnesses, recall, seeing, eleanor, beach [clue_parity_bridge] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: connects, earlier, conclusion, timing, mechanical, sounds, coincides, expected, tide, schedule, confirming, manipulation
  ...
  - Sensory obligation — use at least two of: warm candlelight flickering, glimmers of stars through windows | soft jazz playing from the radio, clinking of ice in glasses | the rich scent of aged whiskey. Mood: tense anticipation.
...
Chapter 3 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Hugo Vane's anxious demeanor as he avoids eye contact."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that multiple guests have conflicting views on Eleanor's character and relationships."
...
[
  {
    ...
    "setting": {
      ...
      "atmosphere": "Busy with guests, but a palpable tension hangs in the air"
    },
    "characters": [
      "Dr. Mallory Finch",
      "Hugo Vane",
    ...
    "purpose": "Introduce the investigation and initial suspects",
    "cluesRevealed": [
      "clue_parity_bridge"
    ],
    "dramaticElements": {
      "conflict": "Dr. Finch faces resistance from guests unwilling to speak.",
      "tension": "The atmosphere is thick with suspicion as guests eye each other warily.",
      "microMomentBeats": [
        "Dr. Finch catches Hugo Vane's eye, sensing his anxious demeanor."
      ]
    },
    "summary": "In the hotel lobby, Dr. Mallory Finch begins questioning guests about the events leading to Eleanor's death. Tensions rise as guests reveal their suspicions about one another, and the detective notes Hugo Vane's nervousness, which raises more questions.",
    "beat": "first_enquiries",
    "estimatedWordCount": 1800,
    "pivotElement": "Hugo Vane's anxious demeanor as he avoids eye contact.",
    "factEstablished": "Establishes that multiple guests have conflicting views on Eleanor's character and relationships.",
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 3: the clue [clue_parity_bridge] (timing, mechanical, sounds, coincides, expected, tide, schedule, confirming, manipulation) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
