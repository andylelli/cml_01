...
- Project ID: ``
- Timestamp: `2026-07-17T03:25:45.451Z`
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Sylvia grapples with the fear of losing her family's legacy and the moral implications of her financial decisions."
...
• [clue_8] hugo, vane, history, financial, troubles
  Category: behavioral | Criticality: essential | Supports inference step 3
  Points to: financial, gain, motive, murder
...
• [clue_mid_2] water, eleanor, lungs, indicates, drowning
  Category: testimonial | Criticality: essential | Supports inference step 3
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_parity_bridge — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): eleanor, last, known, location, contradicts, high | eleanor, drowned, high, tide | connects, earlier, conclusion, timing, mechanical, sounds
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "The late morning pressed on, the lobby’s subdued glow giving way to the dim flicker of warm candlelight as staff prepared for midday service. Mallory felt the tension in the air, but also a momentary relief—a counterpoint to the relentless pressure. She paused..."
...
Chapter 2: Chapter 2: Contradictions
  Events: "You said you saw her at the water's edge, just before the tide rose?
Chapter 3: Chapter 3: The Investigation Begins
  Events: Late morning sunlight filtered through the tall windows of the Brighton hotel lobby, casting pale glimmers across the mosaic floor.
...
Known location profile anchors: The Seabreeze Hotel, Grand Lobby, Ocean View Dining Room, Luxury Guest Rooms, Staff-Only Service Corridor, Brighton hotel dining room
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Seabreeze Hotel", "Grand Lobby", "Ocean View Dining Room", "Luxury Guest Rooms", "Staff-Only Service Corridor", "Brighton hotel dining room"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 4: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a noun-phrase atmosphere — e.g. "The smell of damp stone in the cellar…" / "A chill from the landing…" / "The sound of the clock in the hall…". Pattern: "The/A [noun] of/in/from [place]…". Anchor opening in "Brighton hotel dining room". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Chapter 2 (score 92/100):
  ...
  Address in upcoming chapters: Increase chapter density with concrete investigation action and sensory-grounded beats; avoid recap-only padding.
- Phrases to avoid (already overused in earlier chapters): "the tide tables posted at the seabreeze", "tide tables posted at the seabreeze hotel", "high tide at ten minutes past eleven".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=12546; context=10642; dropped=[humour_guide, location_profiles]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_3 must appear in Act 2, Scene 1 via Witness statement
...
- Chapter 4:
  ...
  - Scene is set in: Brighton hotel dining room — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "The late morning pressed on, the lobby’s subdued glow giving way to the dim flicker of warm candlelight as staff prepared for midday service. Mallory felt the tension in the air, but also a momentary relief—a counterpoin...".
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Beatrice's article proposal that could ruin Sylvia's family's reputation."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that both suspects had strong motives tied to Eleanor's influence and potential exposure."
...
[
  {
    ...
    "setting": {
      "location": "Brighton hotel dining room",
      "timeOfDay": "Afternoon",
      "atmosphere": "Quiet, with an air of anticipation as guests eat"
    },
    "characters": [
      "Dr. Mallory Finch",
      "Beatrice Quill",
    ...
    "dramaticElements": {
      "conflict": "The suspects' motives are revealed, creating tension.",
      "tension": "Suspicions heighten as personal stakes are disclosed.",
      "microMomentBeats": [
        "Beatrice's fork clinks against her plate as she hesitates to speak."
      ]
    },
    "summary": "During a tense lunch in the hotel dining room, Dr. Mallory Finch questions Beatrice Quill and Sylvia Trent about their possible motives for wanting Eleanor harmed. Each reveals hidden grievances against Eleanor, complicating the investigation.",
    "beat": "motives",
    "estimatedWordCount": 1800,
    "pivotElement": "Beatrice's article proposal that could ruin Sylvia's family's reputation.",
    "factEstablished": "Establishes that both suspects had strong motives tied to Eleanor's influence and potential exposure.",
    ...
    "emotionalRegister": "The revelation of tampered tide schedules shifts the investigation's direction, deepening the mystery.",
