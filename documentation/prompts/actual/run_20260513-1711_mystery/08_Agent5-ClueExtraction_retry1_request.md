...
- Project ID: `unknown`
- Timestamp: `2026-05-13T17:12:25.810Z`
...
1. Generate a clue that makes the reader directly observe: "The clock in the study shows ten minutes past eleven when the body is discovered...."
   → observation | essential | early | temporal | step 1 | terms: clock, study, shows

2. Generate a clue that provides evidence for: "The time indicated by the clock is critical to determining the time of death...."
   → contradiction | essential | early | temporal | step 1 | terms: indicated, clock, critical

3. Generate a clue that makes the reader directly observe: "Witnesses recall hearing a chime that would have occurred after the actual time of death...."
   → observation | essential | early | temporal | step 2 | terms: witnesses, recall, hearing

4. Generate a clue that provides evidence for: "The discrepancy in time suggests the clock has been tampered with...."
   → contradiction | essential | early | temporal | step 2 | terms: discrepancy, suggests, clock

5. Generate a clue that makes the reader directly observe: "Eleanor's diary reveals she received a threatening letter the day before...."
   → observation | essential | mid | temporal | step 3 | terms: eleanor's, diary, reveals

6. Generate a clue that provides evidence for: "The threat indicates premeditation, suggesting the motive to kill Eleanor...."
   → contradiction | essential | mid | testimonial | step 3 | terms: threat, indicates, premeditation,

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The time indicated by the clock is critical to determining the time of death...."
   → contradiction | essential | mid | temporal | step 1 | terms: indicated, clock, critical

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The clock was tampered to show a false time, misleading witnesses about the murder timeline...."
   → observation | essential | early | temporal | terms: clock, tampered, false

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "A controlled comparison of the clock's mechanism with a similar clock that has not been tampered sho..."
...
10. Generate one essential mid-story clue whose description or pointsTo explicitly names Dr. Mallory Finch and states the unique trace, preparation detail, or mechanism link that points to Dr. Mallory Finch rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Dr. Mallory Finch, clock, tampered, false

11. Generate a clue showing observable evidence of Dr. Mallory Finch's premeditation or planning (Financial gain from inheritance). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
...
Objects: The clock in the study, Eleanor's personal diary
...
Violations: 1. [critical] Red Herring Separation: Red herring rh_2 overlaps inference corrections (steps: 3; words: motive, eleanor) and may support the true solution.
Warnings: None
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Red Herring Separation: Red herring rh_2 overlaps inference corrections (steps: 3; words: motive, eleanor) and may support the true solution.
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
