...
- Project ID: ``
- Timestamp: `2026-07-19T14:15:52.036Z`
...
• [clue_5] witnesses, recall, hearing, clock, chime, several, minutes, eight
...
CLUES ALREADY REVEALED TO READER: clue_mid_1, clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_3, clue_4, clue_early_2, clue_10, clue_12, clue_mid_2, clue_7, clue_8, clue_9 — do not reveal these as new information.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the others drifted out—Mallory with her medical bag, Hale with his stoic silence, Sylvia with her brittle poise—Eleanor lingered, the weight of the evening pressing in. She could not shake the sense that, for all the clarity gained, she was no closer to res..."
...
- Chapter 5 (score 96/100):
  Quality gaps noted: scene grounding weakness
  Address in upcoming chapters: Open next chapter with a named location anchor plus at least two sensory cues and one atmosphere marker.
- Phrases to avoid (already overused in earlier chapters): "in the art gallery until nearly nine".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=18207; context=5688; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_early_1 must appear in Act 2, Scene 3 via Direct observation of clock time.
- clue_mid_2 must appear in Act 2, Scene 3 via Witness statements about hearing the chime.
...
- Chapter 6:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the others drifted out—Mallory with her medical bag, Hale with his stoic silence, Sylvia with her brittle poise—Eleanor lingered, the weight of the evening pressing in. She could not shake the sense that, for all the...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • clock, lobby, shows, eight [clue_culprit_direct_1]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • witness, statements, contrast, clock, time [clue_culprit_direct_hugo_vane]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • witnesses, report, clock, chimed, eight [clue_early_1]
      Points to: clock, time, inconsistent, witness, statements
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Eleanor's accusation of Beatrice"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes a convincing but flawed solution that points to Beatrice."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor feels the weight of the room's gaze as she makes her accusation."
      ]
    },
    ...
    "emotionalRegister": "A confrontation reveals deeper connections between the suspects and victim.",
