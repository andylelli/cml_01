...
- Project ID: ``
- Timestamp: `2026-05-10T16:31:14.188Z`
...
• [clue_mechanism_visibility_core] The mechanism relies on the clock's tampering, witness accounts, and the study of the victim's diary to expose the false timing.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: This reveals the core mechanism of the deception surrounding the clock.

• [clue_core_contradiction_chain] This indicates the clock may have been tampered with to show a later time.
  Category: temporal | Criticality: essential | Supports inference step 1
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "With the clock looming over them, Beatrice turned her attention back to it, her mind racing with questions. The mechanism relied on the clock's tampering, witness accounts, and the study of the victim's diary to expose the false timing. If they could prove the..."
  • The next chapter must open as a continuation of this beat, not as a disconnected reset.
═══════════════════════════════════════════════════════

SCENE GROUNDING CHECKLIST (MUST FOLLOW):
Known location profile anchors: Hawthorne Manor, The Drawing Room, The Library, The Servants' Hall, the study, near the clock
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Hawthorne Manor", "The Drawing Room", "The Library", "The Servants' Hall", "the study, near the clock"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 2: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with spoken dialogue — e.g. '"[words]," [Name] said/asked/replied/murmured.' The opening quote must be the first character on the line. Anchor opening in "the study, near the clock". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=6200 tokens; fixed=6204; context=2547; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context]
...
- Chapter 2:
  ...
  - Location anchor: the study, near the clock.
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "With the clock looming over them, Beatrice turned her attention back to it, her mind racing with questions. The mechanism relied on the clock's tampering, witness accounts, and the study of the victim's diary to expose t...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • This indicates the clock may have been tampered with to show a later time. [clue_core_contradiction_chain] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: This contradicts the assumption that the clock's time is accurate.
    ...
    • The mechanism relies on the clock's tampering, witness accounts, and the study of the victim's diary to expose the false timing. [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: This reveals the core mechanism of the deception surrounding the clock.
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
...
[
  {
    ...
    "setting": {
      "location": "the study, near the clock",
    ...
    "purpose": "Establish the setting and introduce the clock as a key element.",
    "cluesRevealed": [
      "clue_mechanism_visibility_core",
      "clue_core_contradiction_chain"
    ],
    "dramaticElements": {
      "conflict": "Detective faces skepticism from Captain Hale.",
      "tension": "The clock's time raises questions about the timeline.",
      "microMomentBeats": [
        "Beatrice takes a deep breath, feeling the weight of suspicion in the air."
      ]
    },
    "summary": "As the police arrive, Beatrice examines the clock in the study, which shows an unusual time. Captain Hale dismisses her concerns, but she notes the discrepancies in the timeline. The tension escalates as Eleanor and Hale argue about their whereabouts during the murder.",
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 2: "This indicates the clock may have been tampered with to show a later time." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
□ Chapter 2: "The mechanism relies on the clock's tampering, witness accounts, and the study of the victim's diary to expose the false timing." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
