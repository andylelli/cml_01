...
- Project ID: `unknown`
- Timestamp: `2026-05-10T16:26:34.169Z`
...
8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The mechanism relies on clock, witness, and study to expose the false timing...."
   → observation | essential | early | temporal | terms: mechanism, relies, clock,

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "The discriminating test compares clock, manipulate, and study against the claimed timeline...."
...
Violations: 1. [critical] Information Parity: Critical Information Parity breach: the detective has knowledge of the victim's diary that the reader does not.; 2. [critical] Logical Deducibility: The reader cannot deduce the solution logically due to missing crucial information about the victim's last seen time.; 3. [critical] Discriminating Test Timing: The discriminating test does not appear at the correct timing and relies on clues not established beforehand.
Warnings: Consider improving the clarity of the clues related to the clock's tampering to enhance reader engagement.; First-pass acceptance contract: essential early|mid mechanism, contradiction, and elimination clues; reader-solvable observation -> correction -> elimination chain before Act III.; Unified retry contract: keep cast-path coupling, discriminating evidence ID parity, and mechanism-visibility ordering non-conflicting in one output.
...
- must_fix[]:
  - [critical] Information Parity: Critical Information Parity breach: the detective has knowledge of the victim's diary that the reader does not.
  - [critical] Logical Deducibility: The reader cannot deduce the solution logically due to missing crucial information about the victim's last seen time.
  - [critical] Discriminating Test Timing: The discriminating test does not appear at the correct timing and relies on clues not established beforehand.
  - [warning] Consider improving the clarity of the clues related to the clock's tampering to enhance reader engagement.
...
- required_id_to_source_mappings[]:
  ...
  - clue_fp_contradiction_step_2 -> CASE.prose_requirements.clue_to_scene_mapping[3].clue_id
  - clue_4 -> CASE.prose_requirements.clue_to_scene_mapping[6].clue_id
  - clue_core_elimination_chain -> CASE.prose_requirements.clue_to_scene_mapping[7].clue_id
  - clue_fp_contradiction_step_3 -> CASE.prose_requirements.clue_to_scene_mapping[9].clue_id
