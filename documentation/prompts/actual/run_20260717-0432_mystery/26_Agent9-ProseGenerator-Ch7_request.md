...
- Project ID: ``
- Timestamp: `2026-07-17T04:41:31.994Z`
...
• [clue_8] bloodied, heavy, object, near, body
  Category: physical | Criticality: essential | Supports inference step 3
  Points to: provides, nature, murder

• [clue_9] captain, ivor, hale, history, manipulating, recordings, personal, gain
  Category: behavioral | Criticality: essential | Supports inference step 2
  Points to: reinforces, suspicion, captain, ivor, hale

• [clue_late_1] indicates, someone, exited, shortly, murder, occurred
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As she turned to leave, the rain intensified, drumming against the windows with a relentless rhythm. The library’s dim light seemed to recede, the shadows lengthening. Eleanor paused at the door, the chill from the corridor seeping into her bones once more. Th..."
...
Known location profile anchors: The Cliffside Grand Hotel, Grand Lobby, Ocean View Dining Hall, Oceanfront Guest Room, Rooftop Terrace, the hotel garden
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Cliffside Grand Hotel", "Grand Lobby", "Ocean View Dining Hall", "Oceanfront Guest Room", "Rooftop Terrace", "the hotel garden"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 7: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the hotel garden". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=19204; context=4222; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 7:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As she turned to leave, the rain intensified, drumming against the windows with a relentless rhythm. The library’s dim light seemed to recede, the shadows lengthening. Eleanor paused at the door, the chill from the corri...".
...
Chapter 7 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Captain Hale's admission of his history with manipulating recordings."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes deeper motives and connections between suspects, complicating the investigation."
...
[
  {
    ...
    "setting": {
      ...
      "timeOfDay": "Dusk",
      "atmosphere": "Quiet, with a sense of impending confrontation"
    },
    "characters": [
      "Eleanor Voss",
      "Dr. Mallory Finch",
    ...
    "purpose": "Reveal hidden secrets that complicate the investigation.",
    "cluesRevealed": [
      "clue_8",
      "clue_9",
      "clue_late_1"
    ...
    "dramaticElements": {
      "conflict": "Tension rises as secrets come to light.",
      "tension": "Eleanor feels the weight of the investigation pressing down on her.",
      "microMomentBeats": [
        "Eleanor takes a deep breath, steeling herself for what she might uncover."
      ]
    },
    "summary": "In the garden, Eleanor confronts Dr. Finch and Captain Hale about their pasts and hidden motives. She learns of Hale's manipulative tendencies with recordings and Finch's rivalry with Eleanor, complicating the motives even further.",
    "beat": "secrets",
    "estimatedWordCount": 1400,
    "pivotElement": "Captain Hale's admission of his history with manipulating recordings.",
    "factEstablished": "Establishes deeper motives and connections between suspects, complicating the investigation.",
    ...
    "emotionalRegister": "Pressure mounts as characters' secrets threaten to unravel in the face of confrontation.",
