...
- Timestamp: `2026-06-15T20:49:46.352Z`
...
- Era-authentic markers: petrol touring cars on county roads, early domestic telephones in homes, typewriters standard in offices, reliable automobiles for local travel, passenger trains as primary long-distance transport, early commercial aviation for select routes, party-line telephone exchanges common in rural areas, telegrams sent via local post offices
- Tone: Cozy
- No anachronisms
...
Description: A large manor house set in sprawling grounds with formal gardens, outbuildings, and a surrounding wood.
...
Setting constraints:
- Physical constraints: manor's layout includes restricted access to certain wings, weather can impede movement and outdoor evidence collection, large grounds create multiple paths for potential suspects
...
- Technology: petrol touring cars on county roads, early domestic telephones in homes, typewriters standard in offices
- Transportation: reliable automobiles for local travel, passenger trains as primary long-distance transport
- Social norms: Great Depression affecting social classes, strong class divisions evident in behavior
