...
- Timestamp: `2026-06-15T20:41:46.060Z`
...
**Setting**: 1930s - A large manor house set in sprawling grounds with formal gardens, outbuildings, and a surrounding wood.
**Crime Type**: Murder
**Social Context**: Great Depression affecting social classes, strong class divisions evident in behavior, rising fascism influencing political discussions
**Tone**: Cozy
