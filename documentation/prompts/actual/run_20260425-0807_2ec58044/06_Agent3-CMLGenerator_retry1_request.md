...
- Timestamp: `2026-04-25T08:08:20.547Z`
...
**Uniqueness Seed**: run_2ec58044-f816-487c-96d7-5c608526413d-proj_f8e7afed-9a3b-43cd-a161-70ca430c6778
...
Location: A large, stately manor house set in a rural area, surrounded by expansive gardens and woodlands. (Country house estate)
...
Hard-logic focus tags: standard, varied
...
Backdrop: A post-war inheritance dispute draws a fractured family and their staff to the manor, where social tensions and hidden resentments simmer beneath the surface.
Era: 1940s (The workforce is shifting with women taking on roles traditionally held by men, creating class tensions as societal norms are challenged and wartime trauma lingers.)
Setting: A large, stately manor house set in a rural area, surrounded by expansive gardens and woodlands. • Country house estate • Overcast with occasional rain, typical for an English countryside in late autumn.
Cast anchors: Herbert Redmore, Muriel Clifton, Barry Cromer, Ethel Woodbridge, Vivienne Plowden
...
1. The Stopped Clock Trap
   - principle: physical_law | A clock is deliberately stopped and wound back to create a false timeline of events.
   - illusion: The clock appears to show the moment of the murder accurately.
   - reality: The clock was manipulated to mislead witnesses and investigators regarding the timing of events.
   - fair clues: The clock hands are stuck at ten minutes past eleven; A faint scratch mark on the clock's winding stem; Guests recall hearing the clock chime at an unexpected time
   - anti-trope: The clock’s stopping is not merely a device for distraction; its manipulation ties directly to the time of death and alibi construction.
2. The Poisonous Garden
   - principle: physical_law | A rare plant in the garden produces a toxin that can be harvested and used to poison a drink without immediate detection.
   - illusion: The drink appears normal and safe, with no detectable scent or taste.
   - reality: The toxin takes time to show effects, allowing the murderer to create an alibi.
   - fair clues: A wilted leaf found near the victim's glass; Guests recall the sudden appearance of the plant in the garden; The victim had been overheard discussing the plant's medicinal properties
   - anti-trope: The motive may be rooted in a desire to protect others from the victim’s dangerous behavior, complicating the moral landscape.
3. The Chilled Reception
   - principle: physical_law | A heating system is tampered with to create a sudden drop in temperature in a room, causing a death that appears to be from natural causes.
   - illusion: The victim seems to have succumbed to a heart attack due to cold.
   - reality: The victim was exposed to an extreme temperature drop that was deliberately caused.
   - fair clues: A thermometer shows temperatures far below normal for the house; Guests note the sudden chill in the air before the victim collapses; The heating system shows signs of tampering
   - anti-trope: The murderer may have believed that the victim's death would prevent further harm to others, complicating their intent.
4. The Disguised Alibi
   - principle: social_logic | A guest uses a disguise and impersonates another to create a false alibi during the time of the murder.
   - illusion: Eyewitnesses are convinced they saw someone else at a different location.
   - reality: The impersonator uses knowledge of the victim’s habits to establish a seemingly solid alibi.
   - fair clues: Witnesses describe a distinctive item of clothing worn by the impersonator; A letter reveals the victim's routine that was known only to the impersonator; A photograph shows the real individual with identifiable features
   - anti-trope: The motive may stem from a desire to protect a loved one, complicating the perception of guilt.
5. The Misleading Footsteps
   - principle: cognitive_bias | Footprints are deliberately altered to mislead investigators about the murderer’s escape route.
   - illusion: The footprints appear to lead away from the scene of the crime.
   - reality: The true escape route is hidden, leading to a different part of the manor.
   - fair clues: A shoe print that doesn't match any guests' footwear; A nearby muddy patch that seems untouched despite the foot traffic; Witness accounts of the sound of footsteps leading in a different direction
   - anti-trope: The alteration of evidence is motivated by a desire to protect another individual, complicating the narrative of guilt.
...
- Social Structure: women increasingly in workforce due to WWII, social stratification influenced by wartime roles, post-war trauma affecting community dynamics
- Tone: Classic
- Theme: A classic murder mystery | hard-logic modes: standard, varied
...
- Use these exact names: Herbert Redmore, Muriel Clifton, Barry Cromer, Ethel Woodbridge, Vivienne Plowden
- Gender per character (copy exactly into each cast item's gender field): Herbert Redmore: male, Muriel Clifton: female, Barry Cromer: male, Ethel Woodbridge: female, Vivienne Plowden: female
- Detective Type: Vivienne Plowden
- Victim Archetype: Victor Plowden

**Mystery Logic**:
- Primary Axis: temporal
- False Assumption Type: Must be temporal (matching axis)
- Complexity Level: moderate
- Mechanism Families: constraint contradiction, inference-path trap, physical-constraint proof, authority-channel manipulation, cognitive-bias exploitation
- Hard-Logic Focus Tags: standard, varied
...
- CASE.discriminating_test.design is not grounded in reader-visible inference evidence — add these mechanism/test terms to earlier observations or required_evidence: recreate, timing, sequence, manipulat
- CASE.discriminating_test.pass_condition relies on detective-only reaction/confession language ("If Muriel reacts defensively when the clock is manipulated, it confirms her guilt.") — replace it with a concrete pre-test fact, contradiction, mechanism detail, or elimination the reader can verify without interpreting emotions
