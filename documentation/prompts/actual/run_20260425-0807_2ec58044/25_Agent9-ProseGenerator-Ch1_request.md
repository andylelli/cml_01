...
- Timestamp: `2026-04-25T08:13:40.309Z`
...
Known location profile anchors: Little Middleton Manor, The Drawing Room, The Library, The Kitchen, the study of Victor's house
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The Drawing Room", "The Library", "The Kitchen", "the study of Victor's house"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the study of Victor's house". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season. These are validated requirements, not style suggestions; missing them triggers a retry.

PROMPT BUDGET SUMMARY: budget=6200 tokens; fixed=4274; context=2153; dropped=[humour_guide, location_profiles, texture_pool, world_document, character_personality, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context]
...
- Chapter 1:
  ...
  - Location anchor: the study of Victor's house.
...
[
  {
    ...
    "title": "Discovery",
    "setting": {
      "location": "the study of Victor's house",
    ...
    "dramaticElements": {
      ...
      "tension": "Suspects are gathered, each with their own secrets",
      "microMomentBeats": [
        "Ethel glances nervously at Muriel, sensing unspoken tension."
      ]
    },
    "summary": "Vivienne Plowden arrives at the scene to find the household in disarray. Muriel Clifton and Ethel Woodbridge are present, both visibly shaken by the discovery of Victor's body. The atmosphere is thick with suspicion as they await the constable's arrival.",
    "estimatedWordCount": 1800,
    "emotionalRegister": "The story opens in a state of shock and disbelief after Victor's murder.",
