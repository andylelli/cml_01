...
- Timestamp: `2026-04-25T08:14:03.175Z`
...
• [clue_1] The clock in the study shows the hands stuck at ten minutes past eleven.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: This indicates a potential tampering with the time.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the interviews drew to a close, Vivienne felt a sense of unease settle over her. Each suspect had their own story, their own version of events, and yet the truth remained elusive. The drawing room, once a place of comfort, now felt like a cage, trapping the..."
...
PROMPT BUDGET SUMMARY: budget=6200 tokens; fixed=4648; context=2672; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context]
...
- Chapter 3:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the interviews drew to a close, Vivienne felt a sense of unease settle over her. Each suspect had their own story, their own version of events, and yet the truth remained elusive. The drawing room, once a place of com...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The clock in the study shows the hands stuck at ten minutes past eleven. [clue_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: This indicates a potential tampering with the time.
...
[
  {
    ...
    "purpose": "Reveal the first clue and establish the mystery of time",
    "cluesRevealed": [
      "clue_1"
    ],
    "dramaticElements": {
      "conflict": "Vivienne's curiosity about the clock grows",
      "tension": "The stuck clock raises questions about the timeline of events",
      "microMomentBeats": [
        "Vivienne stops to touch the clock, feeling its cold metal, lost in thought."
      ]
    },
    "summary": "In the study, Vivienne notices the clock stuck at ten minutes past eleven. She ponders its significance, suspecting it may hold the key to understanding the timeline of Victor's death. Muriel enters, offering a vague explanation about the clock's condition.",
    ...
    "humourGuidance": {
      ...
      "character": "Herbert Redmore",
      "condition": "if characters display dry wit"
    },
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 3: "The clock in the study shows the hands stuck at ten minutes past eleven." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
