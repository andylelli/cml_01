...
- Project ID: ``
- Timestamp: `2026-07-19T10:31:04.805Z`
...
• [clue_core_elimination_chain] eliminates, eleanor, voss, because, seen, restaurant, eight, clock, until, midnight
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: eleanor, voss, alibi

• [clue_culprit_direct_hugo_vane] direct, links, hugo, vane, mechanism, access, point, before, discriminating, excludes, competing, suspect
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_1, clue_8, clue_early_1, clue_mid_1, clue_2, clue_3, clue_4, clue_5, clue_6 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): mechanism, used, flood, room | timing, high, tide, relation, flooding | recent, flooding, event | manner, death | mechanism, used, flood, room | timing, high, tide, relation, flooding | timing, flooding | condition, valve | captain, ivor, hale, alibi | deliberate, action, opening, valve | beatrice, quill, alibi
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the group dispersed, Eleanor lingered by the window, watching the darkness deepen beyond the rain-lashed glass. Her breath fogged the pane as she traced the outline of the battered panel in her mind. The evidence had shifted; the clues, once pointing to cha..."
...
Known location profile anchors: The Crestview Hotel, The Oceanview Suite, The Grand Lobby, The Oceanview Dining Room, the hotel bar
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Crestview Hotel", "The Oceanview Suite", "The Grand Lobby", "The Oceanview Dining Room", "the hotel bar"
...
- Chapter 5 (score 96/100):
  Quality gaps noted: scene grounding weakness
  Address in upcoming chapters: Open next chapter with a named location anchor plus at least two sensory cues and one atmosphere marker.
- Phrases to avoid (already overused in earlier chapters): "let s get down to brass tacks", "the corridor mallory was meticulous she would", "corridor mallory was meticulous she would never", "mallory was meticulous she would never have", "was meticulous she would never have left", "meticulous she would never have left that", "she would never have left that valve", "would never have left that valve open", "my room between eight and ten sorting", "eleanor let the silence stretch the only".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=18914; context=4619; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context]; truncated=[location_profiles, temporal_context, continuity_context, pronoun_accuracy]
...
- Chapter 6:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the group dispersed, Eleanor lingered by the window, watching the darkness deepen beyond the rain-lashed glass. Her breath fogged the pane as she traced the outline of the battered panel in her mind. The evidence had...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • valve, shows, signs, rust, operational [clue_3]
      Points to: condition, valve
    ...
    • hidden, valve, located, behind, panel, wall [clue_culprit_direct_hugo_vane]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • valve, shows, signs, rust, operational [clue_late_1]
      Points to: condition, valve
    • witnesses, confirm, eleanor, voss, presence, restaurant, time, murder [clue_core_elimination_chain]
      Points to: eleanor, voss, alibi
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Captain Hale's shocked reaction to the accusation."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Captain Hale has a motive but Eleanor feels there's something off about the accusation."
...
[
  {
    ...
    "purpose": "Present a wrong solution to the case",
    "cluesRevealed": [
    ...
    "dramaticElements": {
      ...
      "tension": "A false solution seems plausible.",
      "microMomentBeats": [
        "Eleanor takes a deep breath, trying to calm her nerves."
      ]
    },
    "summary": "In the bar, Eleanor presents a theory that implicates Captain Hale based on his past grievances with the victim. The others seem convinced, but Eleanor feels a nagging doubt.",
    "beat": "false_solution",
    "estimatedWordCount": 1250,
    "pivotElement": "Captain Hale's shocked reaction to the accusation.",
    "factEstablished": "Establishes that Captain Hale has a motive but Eleanor feels there's something off about the accusation.",
    ...
    "emotionalRegister": "As pressure mounts, Eleanor confronts Hugo, illuminating the darker aspects of ambition.",
