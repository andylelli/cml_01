...
- Project ID: ``
- Timestamp: `2026-07-19T10:28:38.742Z`
...
- Eleanor Voss
  ...
  Connection to victim: Eleanor sought Mallory’s advice on family dynamics.; Eleanor and Mallory met at a writer's retreat where they bonded over personal struggles..
...
• [clue_mechanism_visibility_core] hidden, valve, opens, high, tide, flooding, finch, room, disguising, murder, accident
  Category: spatial | Criticality: essential | Supports inference step 1
  Points to: mechanism, used, flood, room

• [clue_core_contradiction_chain] reveals, timing, high, tide, flooding, occur
...
Known location profile anchors: The Crestview Hotel, The Oceanview Suite, The Grand Lobby, The Oceanview Dining Room, a seaside hotel room
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Crestview Hotel", "The Oceanview Suite", "The Grand Lobby", "The Oceanview Dining Room", "a seaside hotel room"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "a seaside hotel room". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=7638; context=9535; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - Scene is set in: a seaside hotel room — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • hidden, valve, located, behind, panel, wall [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The waterlogged clothing of the victim, indicating a recent drowning."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the victim was drowned and the room was flooded, suggesting foul play."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor catches her breath, trying to steady her racing heart."
      ]
    },
    "summary": "Eleanor Voss arrives at the seaside hotel, where she discovers Dr. Mallory Finch standing over the body of an unknown victim, drowned in her room. Shocked, Eleanor notes the flooding and the mystery surrounding the death.",
    "beat": "gathering",
    "estimatedWordCount": 1250,
    "pivotElement": "The waterlogged clothing of the victim, indicating a recent drowning.",
    "factEstablished": "Establishes that the victim was drowned and the room was flooded, suggesting foul play.",
    ...
    "emotionalRegister": "An unsettling atmosphere pervades the hotel, setting the stage for the ensuing drama.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (hidden, valve, opens, high, tide, flooding, finch, room, disguising, murder, accident) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_core_contradiction_chain] (reveals, timing, high, tide, flooding, occur) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
...
```text
{
  ...
  "chapters": [
    {
      ...
      "summary": "Eleanor Voss arrives at the seaside hotel and discovers Dr. Mallory Finch drowned in her room, the floor flooded and the circumstances deeply suspicious. The first clues—a hidden valve and the posted tide schedule—raise immediate questions about the timing and means of the crime.",
      "paragraphs": [
        ...
        "Eleanor knelt beside Dr. Mallory Finch, her journalist’s instinct warring with a surge of nausea. She noted the way the water had warped the floorboards and soaked the bedspread, the room transformed into a shallow lagoon. Her gaze was drawn to a warped wooden panel near the skirting board, slightly ajar, revealing the edge of a rusted valve—its surface slick with recent use. The discovery was subtle, almost hidden by the shadows, but unmistakable: someone had tampered with the inner workings of the room. Rising, Eleanor’s eyes flicked to the battered tide schedule pinned to the wall just outside the door, the ink smudged but legible. High tide had been marked in bold: ten minutes past midnight. The timing was uncomfortably precise, as if the sea itself had been summoned into the room by design.",
        "She straightened, her mind already assembling the first fragile links in the chain of suspicion. If the valve had been opened deliberately to let in the tide at ten minutes past midnight, then Dr. Mallory Finch’s drowning was no accident of nature. Someone had engineered the conditions for her death, exploiting the relentless rhythm of the sea. The posted schedule in the lobby, visible to any guest or staff member, made the timing accessible to all. Eleanor’s pulse quickened, not just with the shock of the scene, but with the knowledge that every detail—the hidden valve, the precise tide, the flooded floor—hinted at a calculated act. She forced herself to take in the room again, searching for further evidence, aware that the truth would be buried beneath layers of water and secrecy.",
        ...
        "The silence stretched, broken only by the distant rumble of thunder and the soft drip of water from the ruined ceiling. Eleanor caught her breath, steadying herself as she surveyed the scene. The evidence was all around her: Dr. Mallory Finch’s waterlogged clothing, the unnatural flooding, the hidden valve, and the tide schedule marked with the fatal hour. Each detail pressed upon her, demanding explanation. Yet the mechanism of the crime—the precise means by which the sea had been summoned to do its work—remained just out of reach.",
        "She turned away from the body, her mind already racing ahead. The war had left its mark on everyone in this hotel, shaping their secrets and ambitions. In the grey morning light, with the wind rattling the windowpanes and the scent of damp wood in her nostrils, Eleanor resolved to pursue the truth wherever it led. The first question was clear: who had known to open the valve at ten minutes past midnight, and why had Dr. Mallory Finch been left to drown in her own room?",
        "As the others withdrew, murmuring among themselves, Eleanor lingered by the warped panel, her fingers tracing the edge of the hidden valve. The cold metal was slick beneath her touch, and she felt a shiver that had nothing to do with the weather. She would have to ask difficult questions, and she suspected the answers would be equally unsettling. For now, the only certainty was that Dr. Mallory Finch had not died by accident. The sea had been made an accomplice, but the hand that had guided it remained in shadow.",
  ...
  "audit": {
    ...
    "season_words_used": "wintry, winter, pale, daylight, dawn, morning, storm, thunder, cold, rain, wind, grey, daylight | none",
    "discriminating_test_present": "no",
    "required_clues_present": "clue_mechanism_visibility_core: chapter 1 paragraph 2 | clue_core_contradiction_chain: chapter 1 paragraph 2",
