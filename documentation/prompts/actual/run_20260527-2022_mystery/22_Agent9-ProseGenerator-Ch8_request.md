...
- Project ID: ``
- Timestamp: `2026-05-27T20:32:00.286Z`
...
Irregular chimes and delayed bell testimonies expose the false timeline.
...
Permission: conditional — condition: Sparse deadpan humor by Dr. Mallory Finch permitted to reveal her guarded nature
Characters who may be funny: Dr. Mallory Finch
Permitted forms: deadpan
Rationale: Second interviews are intense but allow subtle dry humor to reveal character under stress.
...
• [clue_6] The assumed timeline based on the clock’s stopped time is false; the clock ran backward for forty minutes before stopping.
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: The timeline anchored on the stopped clock is incorrect due to retrograde running.

• [clue_9] A controlled demonstration compares the manor clock’s stopped time and chime irregularities with a standard clock, confirming the manor clock’s retrograde running.
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: Demonstrates the manor clock’s backward running and chime irregularities.

• [clue_core_contradiction_chain] The clock’s escapement lever was reversed and lubricated to cause the pendulum to swing backward, making the clock run in retrograde before the murder, overturning the false timeline assumption.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Returning to the reading table, Eleanor spread the correspondence and mechanical notes before her. The evidence was mounting, and the fragile social order of the estate was unraveling with each new revelation. Yet, amid the growing tension, Eleanor allowed her..."
...
Known location profile anchors: Pendleton Manor Estate, The East Wing Study, The Manor Library, Servants' Hall, Formal Gardens and Grounds, Manor clock room and dining hall
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Pendleton Manor Estate", "The East Wing Study", "The Manor Library", "Servants' Hall", "Formal Gardens and Grounds", "Manor clock room and dining hall"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 8: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with spoken dialogue — e.g. '"[words]," [Name] said/asked/replied/murmured.' The opening quote must be the first character on the line. Anchor opening in "Manor clock room and dining hall". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Chapter 7 (score 96/100):
  ...
  Address in upcoming chapters: Increase chapter density with concrete investigation action and sensory-grounded beats; avoid recap-only padding. | Open next chapter with a named location anchor plus at least two sensory cues and one atmosphere marker.
- Phrases to avoid (already overused in earlier chapters): "appearances often veil more than they reveal", "the manor s clocks once symbols of", "manor s clocks once symbols of order", "s clocks once symbols of order and", "clocks once symbols of order and reliability", "once symbols of order and reliability had", "symbols of order and reliability had become", "of order and reliability had become instruments", "order and reliability had become instruments of", "and reliability had become instruments of chaos".
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=17988; context=11925; dropped=[none]; truncated=[fair_play_contract, location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 8:
  ...
  - Scene is set in: Manor clock room and dining hall — reference it naturally within the paragraph, never as your opening phrase.
  - Opening atmosphere (MANDATORY — validator enforced): the first paragraph MUST contain at least one of: rain / wind / fog / storm / mist / thunder / evening / morning / night / dawn / dusk / season / afternoon / midday / noon / midnight / twilight / sunrise / sunset / daylight / sunlight / overcast / cloudy / bright / dark / grey / pale / cold / warm / chill / crisp / damp / drizzle / haze / lamplight / firelight. A chapter that omits all of these from its opening paragraph will be rejected.
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Returning to the reading table, Eleanor spread the correspondence and mechanical notes before her. The evidence was mounting, and the fragile social order of the estate was unraveling with each new revelation. Yet, amid...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The assumed timeline based on the clock’s stopped time is false; the clock ran backward for forty minutes before stopping. [clue_6]
      Points to: The timeline anchored on the stopped clock is incorrect due to retrograde running.
...
- Tonal contrast required: the previous chapter was high-tension. Dr. Mallory Finch may use deadpan to provide a brief moment of relief before tension resumes.
...
Chapter 8 (Act 3) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "A controlled demonstration comparing the manor clock’s stopped time and chime irregularities with servant diaries confirms the retrograde pendulum effect"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Proves the clock ran backward for forty minutes, falsifying the timeline and implicating Dr. Mallory Finch"
...
[
  {
    ...
    "emotionalRegister": "Pressure mounts as the investigation closes in on the culprit’s manipulation.",
