...
- Project ID: ``
- Timestamp: `2026-05-27T20:30:01.152Z`
...
Subtle clues introduce confusion and mistrust, heightening unease.
...
Permission: conditional — condition: Dry, pointed remarks from Captain Hale or Eleanor Voss to highlight social tensions without levity
Characters who may be funny: Captain Ivor Hale, Eleanor Voss
Permitted forms: dry_wit, understatement
Rationale: Early investigation scenes can include dry, restrained humor reflecting social awkwardness and subtle observations.
...
• [clue_3] Multiple servants report the dinner bell chime sounded five minutes later than usual on the murder afternoon.
  Category: temporal | Criticality: essential | Supports inference step 2
  Points to: The dinner bell timing was delayed, skewing time references.

• [clue_4] A mechanical delay was introduced in the bell’s striker, skewing all timing references anchored to the dinner bell.
  Category: spatial | Criticality: essential | Supports inference step 2
  Points to: The bell striker delay caused the dinner bell chime to be late.

• [clue_mechanism_visibility_core] Dr. Mallory Finch reversed the escapement lever of the manor’s pendulum clock, causing the pendulum to swing backward and the clock to run retrograde.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: Dr. Mallory Finch’s direct tampering with the clock mechanism.
...
• Evidence in reader's hands: The manor’s hall clock pendulum shows reversed wear marks and an oil stain on the escapement lever indicating tampering. | The clock’s escapement lever was reversed and lubricated, causing the pendulum to swing backward, making the clock run in retrograde.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As Mallory departed, Eleanor remained by the clock, her fingers tracing the worn brass edges of the escapement lever once more. The deliberate reversal and lubrication had been a calculated act, one that blurred the lines between time and truth. The manor’s fr..."
...
Known location profile anchors: Pendleton Manor Estate, The East Wing Study, The Manor Library, Servants' Hall, Formal Gardens and Grounds, Servants’ quarters and manor hall
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Pendleton Manor Estate", "The East Wing Study", "The Manor Library", "Servants' Hall", "Formal Gardens and Grounds", "Servants’ quarters and manor hall"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 3: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with an explicit time marker — e.g. "That morning…" / "By the time dusk fell…" / "It was nearly four o'clock…" / "On the second day after the discovery…". Time must be in the first clause. Anchor opening in "Servants’ quarters and manor hall". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.

[⚠ INTERNAL QUALITY DIAGNOSTICS — DO NOT REPRODUCE ANY PART OF THIS SECTION IN YOUR STORY OUTPUT. These are private generator observations for your consideration only. Your narrative must read as if this section does not exist. Never include phrases from this block in character dialogue, narration, or description.]

PRIOR CHAPTER QUALITY OBSERVATIONS:
- Chapter 1 (score 94/100):
  Quality gaps noted: word density below preferred target (911/1000); scene grounding weakness
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=10168; context=11914; dropped=[none]; truncated=[fair_play_contract, location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 3:
  ...
  - Scene is set in: Servants’ quarters and manor hall — reference it naturally within the paragraph, never as your opening phrase.
  - Opening atmosphere (MANDATORY — validator enforced): the first paragraph MUST contain at least one of: rain / wind / fog / storm / mist / thunder / evening / morning / night / dawn / dusk / season / afternoon / midday / noon / midnight / twilight / sunrise / sunset / daylight / sunlight / overcast / cloudy / bright / dark / grey / pale / cold / warm / chill / crisp / damp / drizzle / haze / lamplight / firelight. A chapter that omits all of these from its opening paragraph will be rejected.
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As Mallory departed, Eleanor remained by the clock, her fingers tracing the worn brass edges of the escapement lever once more. The deliberate reversal and lubrication had been a calculated act, one that blurred the line...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • Multiple servants report the dinner bell chime sounded five minutes later than usual on the murder afternoon. [clue_3] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: The dinner bell timing was delayed, skewing time references.
    ...
    • A mechanical delay was introduced in the bell’s striker, skewing all timing references anchored to the dinner bell. [clue_4] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: The bell striker delay caused the dinner bell chime to be late.
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
         Paragraph 2 (immediately following): The detective or POV character explicitly reasons
           about what this evidence implies — who it implicates, why it may be unreliable,
           or what inference it supports. This must be a separate full paragraph, not a sentence appended to Paragraph 1.
    • Dr. Mallory Finch reversed the escapement lever of the manor’s pendulum clock, causing the pendulum to swing backward and the clock to run retrograde. [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: Dr. Mallory Finch’s direct tampering with the clock mechanism.
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
...
Chapter 3 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Multiple servants report the dinner bell chime sounded five minutes later than usual on the murder afternoon"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the dinner bell timing was deliberately delayed, casting doubt on alibis relying on bell timing"
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_2] Beatrice Quill insists the manor’s clock faces show wear consistent with normal forward operation, reinforcing the false belief in the clock's reliability
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor Voss reflects silently on the strange timing of the dinner bell"
      ]
    },
    "summary": "Multiple servants report the dinner bell chimed five minutes later than usual on the murder afternoon. The detective observes a mechanical delay introduced in the bell’s striker, skewing all timing references anchored to the bell chime. the doctor Finch’s involvement with the clock mechanism becomes more suspicious.",
    ...
    "emotionalRegister": "Subtle clues introduce confusion and mistrust, heightening unease.",
    ...
    "humourGuidance": {
      ...
      "form": "deadpan",
      "condition": "Deadpan or understated humor by Dr. Mallory Finch or Eleanor Voss, serving as tension relief without distraction"
    },
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 3: "Multiple servants report the dinner bell chime sounded five minutes later than usual on the murder afternoon." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: "A mechanical delay was introduced in the bell’s striker, skewing all timing references anchored to the dinner bell." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: "Dr. Mallory Finch reversed the escapement lever of the manor’s pendulum clock, causing the pendulum to swing backward and the clock to run retrograde." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
