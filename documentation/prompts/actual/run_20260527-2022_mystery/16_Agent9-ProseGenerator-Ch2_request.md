...
- Project ID: ``
- Timestamp: `2026-05-27T20:29:33.958Z`
...
• [clue_2] The clock’s escapement lever was reversed and lubricated, causing the pendulum to swing backward, making the clock run in retrograde.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: The clock’s escapement lever reversal caused the retrograde pendulum motion.
...
• Evidence in reader's hands: The manor’s hall clock pendulum shows reversed wear marks and an oil stain on the escapement lever indicating tampering.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the group gathered closer, Eleanor’s voice broke the heavy quiet. “One must always remember that appearances often veil more than they reveal, wouldn’t you ” Her tone was soft, deliberate, a gentle invitation to consider the deeper truths hidden beneath the..."
...
Known location profile anchors: Pendleton Manor Estate, The East Wing Study, The Manor Library, Servants' Hall, Formal Gardens and Grounds, Clock room adjacent to the manor hall
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Pendleton Manor Estate", "The East Wing Study", "The Manor Library", "Servants' Hall", "Formal Gardens and Grounds", "Clock room adjacent to the manor hall"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 2: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with spoken dialogue — e.g. '"[words]," [Name] said/asked/replied/murmured.' The opening quote must be the first character on the line. Anchor opening in "Clock room adjacent to the manor hall". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=7553; context=10813; dropped=[none]; truncated=[fair_play_contract, location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 2:
  ...
  - Scene is set in: Clock room adjacent to the manor hall — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The clock’s escapement lever was reversed and lubricated, causing the pendulum to swing backward, making the clock run in retrograde. [clue_2] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: The clock’s escapement lever reversal caused the retrograde pendulum motion.
...
Chapter 2 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The clock’s escapement lever was reversed and lubricated, causing the pendulum to swing backward, making the clock run in retrograde"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Confirms the clock was deliberately tampered with to run backward, undermining the timeline based on the clock"
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Detective notices Dr. Finch's hesitation when discussing the clock's condition"
      ]
    },
    "summary": "The detective inspects the clock’s escapement lever and deduces it was reversed and lubricated to cause the pendulum to swing backward, making the clock run in retrograde. the doctor Finch deflects questions about her familiarity with clock mechanics, raising subtle suspicions.",
    ...
    "humourGuidance": {
      ...
      "form": "dry_wit",
      "condition": "Dry, pointed remarks from Captain Hale or Eleanor Voss to highlight social tensions without levity"
    },
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 2: "The clock’s escapement lever was reversed and lubricated, causing the pendulum to swing backward, making the clock run in retrograde." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
