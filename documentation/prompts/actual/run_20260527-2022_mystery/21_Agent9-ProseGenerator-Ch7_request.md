...
- Project ID: ``
- Timestamp: `2026-05-27T20:31:38.128Z`
...
• [clue_10] Dr. Mallory Finch’s unique trace is the reversed escapement lever with fresh oil stains, linking the tampering directly to her rather than any other suspect.
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: Direct mechanical evidence implicates Dr. Mallory Finch uniquely.

• [clue_11] Dr. Mallory Finch’s professional rivalry with Eleanor Voss and recent financial grievances are documented in correspondence found before the confrontation.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the morning light brightened, Eleanor allowed herself a brief moment of ironic reflection. The manor’s clocks, once symbols of order and reliability, had become instruments of chaos and misdirection. Yet, the truth was emerging, illuminated by the faint glo..."
...
Known location profile anchors: Pendleton Manor Estate, The East Wing Study, The Manor Library, Servants' Hall, Formal Gardens and Grounds, Manor library
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Pendleton Manor Estate", "The East Wing Study", "The Manor Library", "Servants' Hall", "Formal Gardens and Grounds", "Manor library"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 7: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "Manor library". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Chapter 6 (score 92/100):
  ...
  Address in upcoming chapters: Increase chapter density with concrete investigation action and sensory-grounded beats; avoid recap-only padding. | Open next chapter with a named location anchor plus at least two sensory cues and one atmosphere marker.
- Phrases to avoid (already overused in earlier chapters): "appearances often veil more than they reveal", "one must always present the perfect smile", "the manor s clocks once symbols of", "manor s clocks once symbols of order", "s clocks once symbols of order and", "clocks once symbols of order and reliability", "once symbols of order and reliability had", "symbols of order and reliability had become", "of order and reliability had become instruments", "order and reliability had become instruments of".
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=16339; context=11163; dropped=[none]; truncated=[fair_play_contract, location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 7:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the morning light brightened, Eleanor allowed herself a brief moment of ironic reflection. The manor’s clocks, once symbols of order and reliability, had become instruments of chaos and misdirection. Yet, the truth wa...".
  ...
  - Sensory obligation — use at least two of: flat light on book spines, dull fire embers | quiet scratching of pen, muffled footsteps outside | dust and beeswax. Mood: thoughtful stillness.
...
Chapter 7 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Dr. Mallory Finch’s unique trace is the reversed escapement lever with fresh oil stains, linking the tampering directly to her"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes Dr. Finch’s motive and direct involvement with clock tampering"
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor Voss hesitates before revealing a letter hinting at secret tensions"
      ]
    },
    "summary": "The detective discovers correspondence documenting the doctor Finch’s professional rivalry with Eleanor Voss and recent financial grievances. Physical evidence links Dr. Finch directly to the reversed escapement lever with fresh oil stains, confirming her access and involvement.",
    ...
    "humourGuidance": {
      ...
      "condition": "Allowed only if character’s humourLevel exceeds 0.7; none qualify, so forbidden"
    },
