...
- Project ID: `unknown`
- Timestamp: `2026-07-14T20:05:13.568Z`
...
**Discriminating Test**: Reenacting the toast with drinks containing the same residue to observe reactions among suspects.

**Constraints**: 4 temporal, 3 access, 2 physical
