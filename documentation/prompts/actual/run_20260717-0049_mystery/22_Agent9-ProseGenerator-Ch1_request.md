...
- Project ID: ``
- Timestamp: `2026-07-17T00:55:19.125Z`
...
- Beatrice Quill
  ...
  Connection to victim: directly affected by Hugo Vane's death and its fallout.
  Investigation relevance: access plausibility: low | alibi window: during the gala | opportunity channel: guest interactions.
  Suspicion/pressure cue seed: anxious when discussing the victim.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.
...
• [clue_id_1] toxicology, report, shows, toxin, becomes, lethal, warmed
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: conditions, toxin, becomes, lethal

• [clue_id_4] witnesses, state, hugo, unwell, before, dinner, contradicting, sudden, collapse, consuming, drink
  Category: testimonial | Criticality: essential | Supports inference step 2
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=7873; context=10326; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The clock on the wall showing eight fifteen, contradicting the timeline of events."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the victim died no later than eight fifteen, contradicting three suspects' alibis."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor stands still, her heart racing as she enters the room, fearing the worst."
      ]
    },
    ...
    "emotionalRegister": "The atmosphere is filled with anticipation and elegance, but an undercurrent of tension looms.",
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (rare, toxin, becomes, lethal, mixed, specific, beverage, served, gala, exploiting, victim, rising) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_id_1] (toxicology, report, shows, toxin, becomes, lethal, warmed) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_id_4] (witnesses, state, hugo, unwell, before, dinner, contradicting, sudden, collapse, consuming, drink) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
