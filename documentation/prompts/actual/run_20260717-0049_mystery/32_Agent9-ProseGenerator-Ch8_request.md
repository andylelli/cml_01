...
- Project ID: ``
- Timestamp: `2026-07-17T01:00:11.287Z`
...
• [clue_late_optional_slot_1] gala, start, time, seven, clock, remains, late, texture, detail, case, background
...
• [clue_mechanism_visibility_core] rare, toxin, becomes, lethal, mixed, specific, beverage, served, gala, exploiting, victim, rising
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: mechanism, toxin, lethality
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the fire burned low and the night deepened, Eleanor lingered in the lounge, the echoes of confession and accusation still reverberating in the air. The secrets laid bare tonight had not solved the case, but they had revealed the true complexity of the human..."
...
- Phrases to avoid (already overused in earlier chapters): "vane s special prepared at twenty minutes", "s special prepared at twenty minutes past", "special prepared at twenty minutes past eight", "warmed to one hundred and one degrees", "to one hundred and one degrees fahrenheit", "way of surfacing especially when the tide".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=24921; context=4830; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
Manner of death (MUST be named in the reveal): state plainly how the victim died — cause of death: poisoned with a rare toxin. Surface it in the prose in plain words (e.g. "poisoned with a rare toxin") — not only how the clock/timeline was manipulated. A reveal that explains the concealment but never the killing fails the fair-play contract.
...
- Chapter 8:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the fire burned low and the night deepened, Eleanor lingered in the lounge, the echoes of confession and accusation still reverberating in the air. The secrets laid bare tonight had not solved the case, but they had r...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • gala, start, time, seven, clock, remains, late, texture, detail, case, background [clue_late_optional_slot_1]
      Points to: adds, late, texture, changing, essential, deduction, chain
    • details, cocktail, preparation, noted, recipe, book [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: mechanism, toxin, lethality
  ...
  - ⚠ SUSPECT CLEARANCE REQUIRED (MANDATORY): each suspect below MUST be named explicitly and cleared with on-page evidence and a reasoning connector (because / therefore / which proves):
    • "Dr. Mallory Finch": write a dedicated paragraph that (a) names Dr. Mallory Finch explicitly, (b) states the clearance method ("Confirmed alibi with witnesses about her attending to another guest."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
    • "Captain Ivor Hale": write a dedicated paragraph that (a) names Captain Ivor Hale explicitly, (b) states the clearance method ("Witnesses confirm he was busy at the toast during the incident."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
    • "Beatrice Quill": write a dedicated paragraph that (a) names Beatrice Quill explicitly, (b) states the clearance method ("Witness accounts confirm she was seated away from the victim."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
...
Chapter 8 (Act 3) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The realization that the poison was likely administered just before Hugo's last drink."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the timeline for the poison's administration, leading to the final test."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor exhales deeply, her mind racing as she connects the dots."
      ]
    },
    ...
    "emotionalRegister": "The climax builds as tensions rise, leading to a confrontation that lays bare the truth.",
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 8: the clue [clue_mechanism_visibility_core] (rare, toxin, becomes, lethal, mixed, specific, beverage, served, gala, exploiting, victim, rising) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
