...
- Project ID: ``
- Timestamp: `2026-07-17T00:57:40.951Z`
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Mallory is torn between her ambition to succeed and the fear of being exposed for her unethical actions."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Beatrice struggles with the conflict between her ambitions and the moral implications of her manipulative actions."
...
• [clue_5] presence, bitter, almond, residue, near, victim
  Category: physical | Criticality: essential | Supports inference step 3
  Points to: method, murder, involving, poison

• [clue_6] sylvia, desperation, maintain, lifestyle, evident, actions, leading, gala
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_id_1, clue_id_4, clue_core_contradiction_chain, clue_id_3, clue_fp_contradiction_step_1, clue_1, clue_2, clue_culprit_direct_sylvia_trent — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): mechanism, toxin, lethality | conditions, toxin, becomes, lethal | assumption, hugo, death, natural, causes | assumption, hugo, death, natural, causes | timeline, events, leading, hugo, death | indicates, poison, added, drink | timeline, events, leading, hugo, death | conditions, toxin, becomes, lethal | direct, shows, sylvia, trent, means, opportunity
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "The day ahead promised only more questions—no easy answers, no quick resolutions. But as Eleanor stepped into the corridor, the weight of suspicion pressing in on all sides, she felt a grim satisfaction. The brush strokes of life, after all, were rarely neat...."
...
Known location profile anchors: The Ocean's Whisper Hotel, The Clifftop Balcony, The Grand Lobby, The Seaside Library, The Ocean View Dining Room, the seaside hotel dining room
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Ocean's Whisper Hotel", "The Clifftop Balcony", "The Grand Lobby", "The Seaside Library", "The Ocean View Dining Room", "the seaside hotel dining room"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=14666; context=7235; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 4:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "The day ahead promised only more questions—no easy answers, no quick resolutions. But as Eleanor stepped into the corridor, the weight of suspicion pressing in on all sides, she felt a grim satisfaction. The brush stroke...".
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The bitter almond residue found near the victim, hinting at poison."
  ...
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_2] Dr. Finch mentions Hugo drinking heavily before dinner, suggesting alcohol could be the cause of his collapse.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Beatrice glances nervously at Ivor, her ambition clashing with her fear."
      ]
    },
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_2",
      "placementDetail": "Dr. Finch mentions Hugo drinking heavily before dinner, suggesting alcohol could be the cause of his collapse."
    },
    "emotionalRegister": "Eleanor begins to uncover clues, but faces false leads that challenge her confidence.",
