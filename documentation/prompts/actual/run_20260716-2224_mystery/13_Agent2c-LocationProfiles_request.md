...
- Project ID: ``
- Timestamp: `2026-07-16T22:27:23.624Z`
...
- Era-authentic markers: radio broadcasting, early television sets, basic radar systems, rationed automobiles, wartime blackouts, increased post-war automobile availability, long-distance telephone calls, military encryption methods
- Tone: Classic
- No anachronisms
...
Description: A coastal hotel featuring Art Deco architecture, designed for leisure and social gatherings, with views of the ocean.
...
Setting constraints:
- Physical constraints: narrow hallways limiting movement, restricted access to certain guest areas, oceanfront cliffs limiting escape routes
...
- Transportation: rationed automobiles, wartime blackouts
- Social norms: effects of WWII on social behavior, women entering the workforce
