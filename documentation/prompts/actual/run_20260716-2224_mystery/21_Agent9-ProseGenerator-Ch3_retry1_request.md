...
- Project ID: ``
- Timestamp: `2026-07-16T22:32:25.471Z`
...
Tension rises as initial clues hint at deeper rivalries and hidden motives among the guests.
...
Rationale: The investigation begins under heavy emotional weight, making humor inappropriate.

## Reveal Groundwork (texture — do not explain, only plant)
- Plant one subtle observable beat related to: "The discovery of Hale's motive the previous interactions between him and Finch, marking them as more antagonistic than they seemed". Do not explain significance yet.
- Plant one subtle observable beat related to: "The tension during the tea party now appears as a façade hiding deeper resentment". Do not explain significance yet.
- Plant one subtle observable beat related to: "Additionally, Eleanor's earlier observations about the guests' dynamics gain new meaning, as the layers of distrust and competition are peeled back in light of Hale's guilt". Do not explain significance yet.
...
• [clue_3] guests, noted, finch, engaging, conversation, before, collapse
  Category: testimonial | Criticality: essential | Supports inference step 1
  Points to: finch, sudden, collapse, suspicious

• [clue_4] residue, rare, flower
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: presence, poison, consumed, finch

• [clue_early_1] guests, noted, finch, engaging, conversation, before, collapse
  Category: testimonial | Criticality: essential | Supports inference step 1
  Points to: finch, sudden, collapse, suspicious

• [clue_late_1] Direct observation
  Category: structural | Placement: early (Act 1)
  Points to: what this observation reveals about the time or circumstances of the crime.

• [clue_mid_1] Direct observation
  Category: structural | Placement: early (Act 1)
  Points to: what this observation reveals about the time or circumstances of the crime.
...
CLUES ALREADY REVEALED TO READER: clue_mid_1, clue_late_1, clue_mechanism_visibility_core, clue_core_contradiction_chain — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): presence, poison, consumed, finch | mechanism, poisoning | mechanism, poisoning | assumption, natural, causes, false
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Eleanor drew a slow breath, letting the chill of the morning steady her thoughts. She would need to press harder, to unravel the web of half-truths and misremembered details. The evidence—the residue, the petals, the timeline—was as fragile as the trust betwee..."
...
Chapter 2: Chapter 2: Initial Observations
  Events: Eleanor glanced at the others, her mind cataloguing the details.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=12314; context=11114; dropped=[humour_guide, location_profiles]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_late_1 must appear in Act 1, Scene 3 via Direct observation
...
- Chapter 3:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Eleanor drew a slow breath, letting the chill of the morning steady her thoughts. She would need to press harder, to unravel the web of half-truths and misremembered details. The evidence—the residue, the petals, the tim...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • witnesses, observed, finch, lively, engaged [clue_3] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: finch, sudden, collapse, suspicious
    ...
    • shows, traces, rare, flower [clue_4] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: presence, poison, consumed, finch
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
         Paragraph 2 (immediately following): The detective or POV character explicitly reasons
           about what this evidence implies — who it implicates, why it may be unreliable,
           or what inference it supports. This must be a separate full paragraph, not a sentence appended to Paragraph 1.
    • witnesses, observed, finch, lively, engaged [clue_early_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: finch, sudden, collapse, suspicious
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
         Paragraph 2 (immediately following): The detective or POV character explicitly reasons
           about what this evidence implies — who it implicates, why it may be unreliable,
           or what inference it supports. This must be a separate full paragraph, not a sentence appended to Paragraph 1.
    • timing, finch, symptoms, service [clue_late_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      ...
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         ...
         Paragraph 2 (immediately following): The detective or POV character explicitly reasons
           about what this evidence implies — who it implicates, why it may be unreliable,
           or what inference it supports. This must be a separate full paragraph, not a sentence appended to Paragraph 1.
    • shows, traces, rare, flower [clue_mid_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: presence, poison, consumed, finch
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
...
Chapter 3 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The tea set with residue from a rare flower"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the tea set contained residue, suggesting a possible poisoning."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_1] Dr. Mallory Finch mentions her health issues — seeds false inference about her sudden collapse.
...
[
  {
    ...
    "dramaticElements": {
      "conflict": "Tension rises as suspects defend their innocence",
      "tension": "Eleanor senses deeper motives at play",
      "microMomentBeats": [
        "Eleanor's fingers tremble as she writes down their statements, sensing their fear."
      ]
    },
    "summary": "Eleanor interviews the suspects, gathering their accounts of the events leading to Dr. Finch's death. Guests recall seeing Dr. Finch engaged in conversation before her collapse. The tea set, still on the table, is examined, revealing a residue that hints at foul play. Eleanor's instincts tell her that not everything adds up.",
    "beat": "first_enquiries",
    "estimatedWordCount": 1250,
    "pivotElement": "The tea set with residue from a rare flower",
    "factEstablished": "Establishes that the tea set contained residue, suggesting a possible poisoning.",
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_1",
      "placementDetail": "Dr. Mallory Finch mentions her health issues — seeds false inference about her sudden collapse."
    },
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 3: the clue [clue_3] (guests, noted, finch, engaging, conversation, before, collapse) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: the clue [clue_4] (residue, rare, flower) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: the clue [clue_early_1] (guests, noted, finch, engaging, conversation, before, collapse) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: the clue [clue_late_1] (poison, rare, flower, brewed, taking, hours, show, symptoms) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: the clue [clue_mid_1] (residue, rare, flower) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
...
```text
{
  ...
  "chapters": [
    {
      ...
      "summary": "Eleanor interviews the guests in the tea room, gathering their recollections of Dr. Finch’s final hour and examining the tea set for clues. The witnesses recall Dr. Finch’s lively demeanor before her collapse, and Eleanor discovers residue from a rare flower on the cups, deepening her suspicion of foul play. The pressure of the investigation exposes new cracks in the guests’ composure.",
      "paragraphs": [
        ...
        "A sudden silence fell as Eleanor lifted the teapot once more, tilting it to catch the light. There, along the spout, was a smear of blue—barely visible, but unmistakable. She dabbed it with her handkerchief, confirming her suspicion: the residue was not confined to Dr. Finch’s cup. It had touched the entire service. The implications were clear: the poison had been introduced at the source, not in any individual cup. The method was chillingly efficient.",
  ...
  "audit": {
    ...
    "required_clues_present": "clue_3: paragraph 1-3, clue_4: paragraph 4-5, clue_early_1: paragraph 1-3, clue_late_1: paragraph 12-13, clue_mid_1: paragraph 5",
    "early_observation_present": "guests recall Dr. Finch lively and engaged before collapse: paragraph 1-3 (first 25%)",
