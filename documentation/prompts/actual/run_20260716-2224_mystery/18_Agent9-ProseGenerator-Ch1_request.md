...
- Project ID: ``
- Timestamp: `2026-07-16T22:31:04.599Z`
...
- Eleanor Voss
  ...
  Connection to victim: Competing for attention in the press, Eleanor writes exposes about unethical practices.; Eleanor and Mallory had a public falling out over medical ethics after an article was published..
...
- Captain Ivor Hale
  ...
  Connection to victim: Mallory and Ivor often clash over medical ethics and military practices.; They have debated fiercely at various social gatherings about the ethics of war..
  Investigation relevance: access plausibility: medium | alibi window: during the tea party | opportunity channel: served tea.
  Suspicion/pressure cue seed: defensive when questioned.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Beatrice Quill
  Public identity anchor: Hotel Staff; suspect 
  Connection to victim: Mallory dismisses Beatrice’s ambitions, leading to resentment.; Mallory has often belittled Beatrice's contributions at work..
  Investigation relevance: access plausibility: high | alibi window: during the tea party | opportunity channel: served tea.
  Suspicion/pressure cue seed: nervous around Captain Hale.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Sylvia Trent
  Public identity anchor: Socialit
...
• [clue_mid_1] residue, rare, flower
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: presence, poison, consumed, finch

• [clue_late_1] poison, rare, flower, brewed, taking, hours, show, symptoms
...
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the coastal hotel tea room". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=7981; context=12262; dropped=[none]; truncated=[first_appearance_contracts, location_profiles, temporal_context, pronoun_accuracy]
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Dr. Finch's body, with a teacup still clutched in her hand"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Dr. Finch is the victim, found dead shortly after tea service."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor stands frozen, her breath hitching at the sight of the body."
      ]
    },
    "summary": "In the dim light of the tea room, Eleanor Voss arrives to find Dr. Mallory Finch kneeling beside the body of the victim, who lies lifeless on the floor. Shocked, she takes in the scene, noting the stillness of the room and the horrified faces of the other guests. They all had been present during the tea service just moments before the tragedy unfolded.",
    "beat": "gathering",
    "estimatedWordCount": 1250,
    "pivotElement": "Dr. Finch's body, with a teacup still clutched in her hand",
    "factEstablished": "Establishes that Dr. Finch is the victim, found dead shortly after tea service.",
    ...
    "emotionalRegister": "A sense of dread permeates the atmosphere as guests gather, unaware of the impending tragedy.",
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (poison, rare, flower, brewed, taking, hours, show, symptoms) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_mid_1] (residue, rare, flower) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_late_1] (poison, rare, flower, brewed, taking, hours, show, symptoms) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
