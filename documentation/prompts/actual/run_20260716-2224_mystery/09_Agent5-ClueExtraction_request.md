...
- Project ID: `unknown`
- Timestamp: `2026-07-16T22:26:16.002Z`
...
1. Generate a clue that makes the reader directly observe: "Guests noted Dr. Finch engaging in conversation before her collapse...."
   → observation | essential | early | temporal | step 1 | terms: guests, noted, finch

2. Generate a clue that provides evidence for: "This indicates she did not show signs of distress until after tea...."
   → contradiction | essential | early | temporal | step 1 | terms: indicates, signs, distress

3. Generate a clue that makes the reader directly observe: "The tea set was found with residue from the rare flower...."
   → observation | essential | early | testimonial | step 2 | terms: found, residue, flower.

4. Generate a clue that provides evidence for: "This confirms the presence of the poison in the tea consumed by Dr. Finch...."
   → contradiction | essential | early | testimonial | step 2 | terms: confirms, presence, poison

5. Generate a clue that makes the reader directly observe: "Captain Hale mixed the tea but claimed it was prepared by the staff...."
   → observation | essential | mid | testimonial | step 3 | terms: captain, mixed, claimed

6. Generate a clue that provides evidence for: "This discrepancy suggests he may have tampered with the tea...."
   → contradiction | essential | mid | testimonial | step 3 | terms: discrepancy, suggests, tampered

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "This indicates she did not show signs of distress until after tea...."
   → contradiction | essential | mid | temporal | step 1 | terms: indicates, signs, distress

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The poison from a rare flower was brewed in the tea, taking hours to show symptoms...."
   → observation | essential | early | temporal | terms: poison, flower, brewed
...
10. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "The discriminating test compares service, noted, and engag against the claimed timeline...."
   → observation | essential | mid | temporal | terms: discriminating, compares, service,
...
11. Generate one essential mid-story clue whose description or pointsTo explicitly names Captain Ivor Hale and states the unique trace, preparation detail, or mechanism link that points to Captain Ivor Hale rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Captain Ivor Hale, poison, flower, brewed
...
12. Generate one essential early-or-mid clue establishing that Captain Ivor Hale UNIQUELY had the means/skill/access/knowledge required to execute the concealment mechanism, and that the other suspects did not — so the reveal relies only on this already-planted capability, never on a means introduced for the first time at the confrontation.
   → elimination | essential | mid | temporal | terms: Captain Ivor Hale, poison, flower, brewed

13. Generate a clue showing observable evidence of Captain Ivor Hale's premeditation or planning (jealousy). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
...
## Access Constraints
Actors: Captain Hale, Hugo Vane
Objects: tea set, kitchen supplies

## Physical Evidence
- Tea set with residue of rare flower.

## Evidence-Sensitive Characters
- Eleanor Voss: sensitive items: sensitive to clues
...
Create 2 red herrings that support the false assumption: "Dr. Finch died from natural causes due to her known health issues."
