...
- Project ID: ``
- Timestamp: `2026-07-16T22:24:54.407Z`
...
**Setting**: 1940s - A coastal hotel featuring Art Deco architecture, designed for leisure and social gatherings, with views of the ocean.
**Crime Type**: Murder
**Social Context**: effects of WWII on social behavior, women entering the workforce, growing Cold War tensions
**Tone**: Classic
