...
- Project ID: ``
- Timestamp: `2026-07-17T04:02:01.236Z`
...
• [clue_5] footprints, leading, mirror, scene
  Category: physical | Criticality: essential | Supports inference step 3
  Points to: presence, footprints, indicates, someone, near, mirror
...
• [clue_4] mallory, finch, exhibited, signs, jealousy, lost, opportunities
  Category: behavioral | Criticality: essential | Supports inference step 2
  Points to: mallory, finch, emotional, state, suggests, premeditation

• [clue_fp_elimination_beatrice_quill] eight, clock, evening, nine, thirty
...
• [clue_fp_contradiction_step_3] layout, room, allows, multiple, entrances, mirror, obscured
  Category: spatial | Criticality: essential | Supports inference step 3
  Points to: murderer, used, side, entrance, concealed, view

• [clue_fp_elimination_sylvia_trent] eight, clock, evening, nine, fifteen
  Category: spatial | Criticality: essential | Supports inference step 1
  Points to: eliminates, sylvia, trent, because, independent, corroboration, places, away, decisive, mechanism, window

• [clue_fp_elimination_captain_ivor_hale] seven, thirty, evening, nine
  Category: spatial | Criticality: essential | Supports inference step 1
  Points to: eliminates, captain, ivor, hale, because, independent, corroboration, places, away, decisive, mechanism, window

• [clue_mid_1] layout, room, allows, multiple, entrances, mirror, obscured
  Category: spatial | Criticality: essential | Supports inference step 3
  Points to: potential, murderer, enter, unseen
...
• [clue_core_elimination_chain] eliminates, eleanor, voss, because, seen, across, street, time, murder
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_fp_contradiction_step_1, clue_1, clue_culprit_direct_dr_mallory_finch, clue_early_1, clue_3, clue_core_elimination_chain, clue_2, clue_fp_elimination_captain_ivor_hale, clue_4 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): mechanism, deception, involving, mirror | inconsistency, witness, statements, regarding, finch | mirror, altered, affect, visibility | recent, cleaning, mirror, suggests, preparation, crime | direct, shows, mallory, finch, means, opportunity | recent, cleaning, mirror, suggests, preparation, crime | potential, murderer, enter, unseen | eleanor, voss, alibi, excludes, suspect | finch, alibi, absence, murder, scene | eliminates, captain, ivor, hale, because, independent | mallory, finch, emotional, state, suggests, premeditation
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As Eleanor stepped into the corridor, the sound of rain returned—a soft, persistent whisper against the windowpanes. The tension of the dining room receded, replaced by the cold certainty that the investigation was far from over. Beatrice’s confession had shif..."
...
Known location profile anchors: The Mariner's Retreat, The Oceanview Suite, The Grand Lobby, The Oceanfront Dining Room, the seaside hotel library
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Mariner's Retreat", "The Oceanview Suite", "The Grand Lobby", "The Oceanfront Dining Room", "the seaside hotel library"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=18526; context=5088; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_late_1 must appear in Act 2, Scene 3 via Room layout diagram
...
- Chapter 6:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As Eleanor stepped into the corridor, the sound of rain returned—a soft, persistent whisper against the windowpanes. The tension of the dining room receded, replaced by the cold certainty that the investigation was far f...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • room, layout, showing, various, entry, points [clue_3]
      Points to: potential, murderer, enter, unseen
    • mallory, finch, interactions, others, show, underlying, jealousy [clue_4]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • footprints, floor, near, mirror [clue_5]
      Points to: presence, footprints, indicates, someone, near, mirror
    • strategically, placed, mirror, reflects, entry, point [clue_culprit_direct_1]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • strategically, placed, mirror, reflects, entry, point [clue_fp_contradiction_step_3]
      Points to: murderer, used, side, entrance, concealed, view
    • strategically, placed, mirror, reflects, entry, point [clue_fp_elimination_beatrice_quill]
      Points to: eliminates, beatrice, quill, because, independent, corroboration, places, away, decisive, mechanism, window
    • strategically, placed, mirror, reflects, entry, point [clue_fp_elimination_captain_ivor_hale]
      Points to: eliminates, captain, ivor, hale, because, independent, corroboration, places, away, decisive, mechanism, window
    • strategically, placed, mirror, reflects, entry, point [clue_fp_elimination_sylvia_trent]
      Points to: eliminates, sylvia, trent, because, independent, corroboration, places, away, decisive, mechanism, window
    • strategically, placed, mirror, reflects, entry, point [clue_late_1]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • room, layout, showing, various, entry, points [clue_mid_1]
      Points to: potential, murderer, enter, unseen
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The footprints leading to the mirror."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that someone was near the mirror, which is crucial to the murder's timeline."
...
[
  {
    ...
    "purpose": "Eleanor investigates Sylvia's alibi and possible motives.",
    "cluesRevealed": [
      "clue_5",
      "clue_3",
      "clue_4",
    ...
    "dramaticElements": {
      "conflict": "Sylvia's ambition clashes with her fear of exposure.",
      "tension": "Eleanor notices Sylvia's nervousness.",
      "microMomentBeats": [
        "Sylvia's breath hitches as she deflects Eleanor's questions."
      ]
    },
    "summary": "Eleanor questions Sylvia Trent about her whereabouts during the murder and her relationship with the victim. Sylvia's ambition and fear of being overshadowed by Dr. Mallory Finch surface during the conversation. Eleanor discovers footprints leading to the mirror, suggesting someone was near the scene during the murder.",
    "beat": "false_solution",
    "estimatedWordCount": 1250,
    "pivotElement": "The footprints leading to the mirror.",
    "factEstablished": "Establishes that someone was near the mirror, which is crucial to the murder's timeline.",
    ...
    "emotionalRegister": "The mounting pressure culminates in a dramatic confrontation, unveiling hidden truths.",
