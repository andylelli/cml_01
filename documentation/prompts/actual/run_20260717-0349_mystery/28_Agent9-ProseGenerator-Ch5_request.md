...
- Project ID: ``
- Timestamp: `2026-07-17T04:01:39.011Z`
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Eleanor grapples with the resentment she feels towards the victim, torn between her professional ethics and her personal vendetta."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Beatrice is torn between her desire for independence and the suffocating expectations of her family, battling jealousy and resentment towards those who threaten her freedom."
...
• [clue_2] timeline, indicates, finch, elsewhere, murder
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: finch, alibi, absence, murder, scene
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_fp_contradiction_step_1, clue_1, clue_culprit_direct_dr_mallory_finch, clue_early_1, clue_3, clue_core_elimination_chain, clue_2, clue_fp_elimination_captain_ivor_hale — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): mechanism, deception, involving, mirror | inconsistency, witness, statements, regarding, finch | mirror, altered, affect, visibility | recent, cleaning, mirror, suggests, preparation, crime | direct, shows, mallory, finch, means, opportunity | recent, cleaning, mirror, suggests, preparation, crime | potential, murderer, enter, unseen | eleanor, voss, alibi, excludes, suspect | finch, alibi, absence, murder, scene | eliminates, captain, ivor, hale, because, independent
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Outside, the mist had lifted, and a patch of blue sky shone through the clouds. The moment of relief was brief, but it was enough. In the lounge, the tension remained, coiled and waiting. Eleanor knew the investigation was far from over. The contradictions in..."
...
Known location profile anchors: The Mariner's Retreat, The Oceanview Suite, The Grand Lobby, The Oceanfront Dining Room, the seaside hotel dining room
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Mariner's Retreat", "The Oceanview Suite", "The Grand Lobby", "The Oceanfront Dining Room", "the seaside hotel dining room"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=15678; context=6514; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 5:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Outside, the mist had lifted, and a patch of blue sky shone through the clouds. The moment of relief was brief, but it was enough. In the lounge, the tension remained, coiled and waiting. Eleanor knew the investigation w...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • documentation, showing, finch, location, time, murder [clue_2]
      Points to: finch, alibi, absence, murder, scene
...
Chapter 5 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Beatrice's admission of jealousy towards the victim."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Beatrice had a motive rooted in jealousy."
...
[
  {
    ...
    "purpose": "Eleanor questions Beatrice about her relationship with the victim.",
    "cluesRevealed": [
      "clue_4",
      "clue_2"
    ],
    "dramaticElements": {
      "conflict": "Beatrice's jealousy of the victim surfaces.",
      "tension": "Eleanor senses Beatrice's discomfort.",
      "microMomentBeats": [
        "Beatrice's fingers twitch as she recalls her last conversation with the victim."
      ]
    },
    "summary": "Eleanor interviews Beatrice Quill, pressing her about her relationship with Dr. Mallory Finch. Beatrice's jealousy of the victim becomes evident as she struggles to maintain her composure. Eleanor observes Beatrice's nervous behavior, raising further suspicions about her motives.",
    "beat": "alibis",
    "estimatedWordCount": 1250,
    "pivotElement": "Beatrice's admission of jealousy towards the victim.",
    "factEstablished": "Establishes that Beatrice had a motive rooted in jealousy.",
    ...
    "emotionalRegister": "A startling revelation forces characters to confront their pasts and motives.",
