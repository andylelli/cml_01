...
- Project ID: ``
- Timestamp: `2026-07-17T03:55:49.956Z`
...
- Era-authentic markers: ubiquitous radio broadcasts, early television sets in common areas, basic radar equipment for maritime navigation, rationed fuel leading to limited car use, increased use of public buses, post-war automobile availability, long-distance telephone calls possible but expensive, military encryption methods still in use
- Tone: Classic
- No anachronisms
...
Description: A grand seaside hotel with Art Deco architecture, featuring a lobby with a sweeping staircase and ocean views from most rooms.
...
Setting constraints:
- Physical constraints: narrow hallways limit movement of large groups, oceanfront cliffs restrict expansion, locked staff-only areas for maintenance
- Geographic isolation: The hotel is situated on a remote stretch of coastline, making outside assistance slow and complicated.
- Access control: rooms are secured with key cards, certain areas off-limits to guests, such as the basement and maintenance rooms, staff required to report unusual activities

Era constraints to include:
- Technology: ubiquitous radio broadcasts, early television sets in common areas, basic radar equipment for maritime navigation
- Transportation: rationed fuel leading to limited car use, increased use of public buses
- Social norms: impact of WWII on societal roles, women entering the workforce in greater numbers
