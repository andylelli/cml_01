...
- Project ID: ``
- Timestamp: `2026-07-20T17:34:15.466Z`
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=13857; context=8192; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Template linter: high n-gram overlap detected (0.94 >= 0.65). Rephrase this passage to avoid template leakage.
...
"as the group debated eleanor s ... their whereabouts during the critical window"
