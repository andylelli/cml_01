...
- Project ID: ``
- Timestamp: `2026-07-20T17:36:14.885Z`
...
• [clue_late_optional_slot_1] clock, hotel, lobby, shows, incorrect, time, remains, late, texture, detail, case, background
...
• [clue_1] clock, lobby, shows, time, contradicting, timeline
  Category: temporal | Criticality: essential | Supports inference step 2
  Points to: timeline, murder, questionable
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_2, clue_5, clue_mid_2, clue_6, clue_7, clue_1, clue_4, clue_8, clue_core_elimination_chain, clue_early_1, clue_culprit_direct_1, clue_culprit_direct_captain_ivor_hale, clue_3, clue_mid_1 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): clock, tampered, mislead, investigation | clock, time, inconsistent, victim, last, seen | clock, tampered | manner, death, strangulation | clock, tampered, mislead, investigation | hale, motive | timeline, murder, manipulated | timeline, murder, questionable | hale, behavior, suspicious, indicate, guilt | beatrice, quill, corroborated, alibi | eleanor, voss, corroborated, alibi | physical, trace, opportunity, indicate, captain, ivor | physical, trace, opportunity, indicate, captain, ivor | direct, shows, captain, ivor, hale, means | hale, behavior, raises, suspicion, involvement | timeline, murder, manipulated
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Relief flickered briefly as Eleanor Voss’s dry wit lightened the mood. She surveyed the lobby, each guest retreating into their own thoughts. The contradiction between the clock’s reading and the last sighting of Hugo Vane was now the fulcrum of suspicion. The..."
...
This is a **mechanical knowledge check** test. The detective must:

**Test mechanism (paraphrase — do NOT copy verbatim):**
Render this test MECHANISM as live, in-scene action and dialogue, composing ENTIRELY in your own words from these elements (reproducing any briefing phrase verbatim FAILS validation): discriminating, compares, clock, lobby, claimed, timeline
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=22911; context=5174; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 9:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Relief flickered briefly as Eleanor Voss’s dry wit lightened the mood. She surveyed the lobby, each guest retreating into their own thoughts. The contradiction between the clock’s reading and the last sighting of Hugo Va...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • clock, hotel, lobby, shows, incorrect, time, remains, late, texture, detail, case, background [clue_late_optional_slot_1]
      Points to: adds, late, texture, changing, essential, deduction, chain
    • clock, reads [clue_1]
      Points to: timeline, murder, questionable
  - ⚠ SUSPECT CLEARANCE REQUIRED (MANDATORY): each suspect below MUST be named explicitly and cleared with on-page evidence and a reasoning connector (because / therefore / which proves):
    • "Dr. Mallory Finch": write a dedicated paragraph that (a) names Dr. Mallory Finch explicitly, (b) states the clearance method ("Her alibi is confirmed by multiple witnesses."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
    • "Sylvia Trent": write a dedicated paragraph that (a) names Sylvia Trent explicitly, (b) states the clearance method ("Her duties kept her occupied during the timeframe."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
    • "Beatrice Quill": write a dedicated paragraph that (a) names Beatrice Quill explicitly, (b) states the clearance method ("Alibi confirmed: nine to ten PM"), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
  ...
  - ⚠ DISCRIMINATING TEST (trap) — MANDATORY real-time scene with dialogue and confrontation. DO NOT summarize it after the fact.
    ...
    Elements the test must dramatize (compose the scene ENTIRELY in your own sentences from these — reproducing any briefing phrase verbatim FAILS validation): discriminating, compares, clock, lobby, claimed, timeline
    Cite these already-revealed clue IDs during the test: clue_1, clue_culprit_direct_1, clue_7, clue_culprit_direct_captain_ivor_hale
    ...
    Motive statement REQUIRED: the culprit must explicitly state or acknowledge their motive during or immediately after the confrontation. Canonical motive: "Resentment". Do not omit it.
...
Chapter 9 (Act 3) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The mechanical test of the clock."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Reveals Captain Hale's guilt through his reaction to the test."
...
[
  {
    ...
    "purpose": "Execute the discriminating test and observe the culprit's reaction. Suspects are systematically cleared: alibi confirmed for two suspects, ruled out by timeline evidence, leaving only the culprit identified by a complete evidence chain.",
    "cluesRevealed": [
    ...
    "emotionalRegister": "The confrontation leads to the unveiling of the murderer amidst emotional turmoil.",
