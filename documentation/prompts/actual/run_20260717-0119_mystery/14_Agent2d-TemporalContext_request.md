...
- Project ID: ``
- Timestamp: `2026-07-17T01:22:20.518Z`
...
- YOU MUST use the exact year and month specified above: March 1944
- This date has been specifically selected for THIS mystery to ensure uniqueness
- DO NOT change the year or month - use March 1944 exactly
...
- All details must be historically accurate for March 1944 specifically
- Generate fresh, original descriptions - do not copy example phrasing
- Make this feel like the specific moment of March 1944
...
- Social norms: post-WWII trauma, women entering the workforce, emerging Cold War tensions

Task:
1. Use the specified date: March 1944
