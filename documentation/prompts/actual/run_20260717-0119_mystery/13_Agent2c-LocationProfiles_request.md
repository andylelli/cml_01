...
- Project ID: ``
- Timestamp: `2026-07-17T01:21:39.706Z`
...
- Era-authentic markers: radio broadcasting, early television sets, military radar, rationed wartime vehicles, post-war automobile boom, public transportation via buses, long-distance telephone calls, military encryption methods
- Tone: Classic
- No anachronisms
...
Description: A grand seaside hotel with Art Deco architecture, featuring ocean views and a central courtyard. The hotel has several floors, with guest rooms overlooking the beach and a dining room on the main level.
Crime Scene: A grand seaside hotel
Weather: overcast with occasional drizzle, typical of coastal climates
Mood: tense and suspenseful, with an air of secrecy
...
Setting constraints:
- Physical constraints: narrow hallways limiting movement, locked access to certain floors after hours, fire escapes leading to the rear of the building
- Geographic isolation: The hotel is located on a remote stretch of coastline, with the nearest town several miles away, limiting outside assistance.
- Access control: staff-only areas including the kitchen and maintenance rooms, restricted access to the rooftop terrace, check-in required for visitors
...
- Social norms: post-WWII trauma, women entering the workforce
