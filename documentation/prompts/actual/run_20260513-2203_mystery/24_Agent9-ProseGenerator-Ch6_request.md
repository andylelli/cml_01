...
- Project ID: ``
- Timestamp: `2026-05-13T22:09:33.766Z`
...
• [clue_id_2] A reenactment is staged where all suspects are asked to recreate their whereabouts around the time of the murder.
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: Helps establish timelines and alibis.

• [clue_6] These marks suggest someone altered the clock.
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: Indicates intentional tampering.
...
CLUES ALREADY REVEALED TO READER: clue_1, clue_2, clue_core_contradiction_chain, clue_id_3, clue_mechanism_visibility_core, clue_id_1, clue_4, clue_core_elimination_chain, clue_5 — do not reveal these as new information.

CONTINUITY HANDOFF — previous chapter closing beat:
  • "Finch nodded, his expression serious. "I understand, Eleanor. I assure you, I will do everything in my power to assist you. But please, if you find any evidence that points to me, I implore you to consider the possibility that I am not the only one with someth..."
...
Known location profile anchors: Little Middleton Manor, The Drawing Room, The Library, The Kitchen, the garden
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The Drawing Room", "The Library", "The Kitchen", "the garden"
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=11827; context=9730; dropped=[none]; truncated=[location_profiles, temporal_context]
...
- Chapter 6:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Finch nodded, his expression serious. "I understand, Eleanor. I assure you, I will do everything in my power to assist you. But please, if you find any evidence that points to me, I implore you to consider the possibilit...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • A reenactment is staged where all suspects are asked to recreate their whereabouts around the time of the murder. [clue_id_2]
      Points to: Helps establish timelines and alibis.
    • These marks suggest someone altered the clock. [clue_6]
      Points to: Indicates intentional tampering.
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Hale's insistence on his outdoor presence."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Captain Hale has a corroborated alibi, reducing the suspect pool."
...
[
  {
    ...
    "setting": {
      ...
      "atmosphere": "Calm, yet filled with unspoken tension"
    },
    "characters": [
      "Eleanor Voss",
      "Captain Ivor Hale"
    ],
    "purpose": "Corroborate Captain Hale's movements during the murder",
    "cluesRevealed": [
      "clue_id_2",
      "clue_6"
    ],
    "dramaticElements": {
      "conflict": "Hale's integrity is questioned.",
      "tension": "Eleanor seeks to validate Hale's claims.",
      "microMomentBeats": [
        "Hale's eyes dart around as he recounts his story."
      ]
    },
    "summary": "Eleanor questions Captain Hale in the garden about his whereabouts during the murder. Hale insists he was outside the entire time, corroborated by a couple of passersby. Eleanor's doubts begin to fade, but she still senses something amiss.",
    "estimatedWordCount": 1800,
    "pivotElement": "Hale's insistence on his outdoor presence.",
    "factEstablished": "Establishes that Captain Hale has a corroborated alibi, reducing the suspect pool.",
    ...
    "emotionalRegister": "Beatrice's motives come into question, heightening the stakes for all involved.",
