...
- Project ID: `unknown`
- Timestamp: `2026-05-13T22:04:52.219Z`
...
1. Generate a clue that makes the reader directly observe: "The clock shows ten minutes past eleven when Eleanor is found...."
   → observation | essential | early | temporal | step 1 | terms: clock, shows, minutes

2. Generate a clue that provides evidence for: "If the clock was tampered with, then the time of death may be earlier than this...."
   → contradiction | essential | early | temporal | step 1 | terms: clock, tampered, with,

3. Generate a clue that makes the reader directly observe: "Witnesses recall hearing the clock strike twelve shortly after the murder...."
   → observation | essential | early | temporal | step 2 | terms: witnesses, recall, hearing

4. Generate a clue that provides evidence for: "If the clock was wound back, it could falsely indicate the time...."
   → contradiction | essential | early | temporal | step 2 | terms: clock, wound, back,

5. Generate a clue that makes the reader directly observe: "Visible scratch marks on the clock face indicate where it was tampered with...."
   → observation | essential | mid | temporal | step 3 | terms: visible, scratch, marks

6. Generate a clue that provides evidence for: "These marks suggest someone altered the clock...."
   → contradiction | essential | mid | temporal | step 3 | terms: these, marks, suggest

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "If the clock was tampered with, then the time of death may be earlier than this...."
   → contradiction | essential | mid | temporal | step 1 | terms: clock, tampered, with,

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "A mechanical clock was wound back by forty minutes to create a false alibi for the murderer...."
   → observation | essential | early | temporal | terms: mechanical, clock, wound

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "A reenactment is staged where all suspects are asked to recreate their whereabouts around the time o..."
   → observation | essential | mid | temporal | terms: reenactment, staged, suspects
...
10. Generate one essential mid-story clue whose description or pointsTo explicitly names Beatrice Quill and states the unique trace, preparation detail, or mechanism link that points to Beatrice Quill rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Beatrice Quill, mechanical, clock, wound

11. Generate a clue showing observable evidence of Beatrice Quill's premeditation or planning (Desire for independence). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: desire, independence
...
## Access Constraints
Actors: Eleanor Voss, Beatrice Quill, Dr. Mallory Finch, Captain Ivor Hale
Objects: The clock, The study, The kitchen

## Physical Evidence
- Scratches on the clock face indicate tampering.

## Evidence-Sensitive Characters
- Eleanor Voss: sensitive items: clock tampering, witness statements
- Dr. Mallory Finch: sensitive items: medical reports, witness testimony
- Captain Ivor Hale: sensitive items: witness statements, garden access
- Beatrice Quill: sensitive items: kitchen access, witness statements
...
Create 2 red herrings that support the false assumption: "Eleanor Voss was killed shortly after the clock struck twelve."
...
- required_id_to_source_mappings[]:
  ...
  - clue_id_1 -> CASE.prose_requirements.clue_to_scene_mapping[0].clue_id
  - clue_id_2 -> CASE.prose_requirements.clue_to_scene_mapping[1].clue_id
  - clue_id_3 -> CASE.prose_requirements.clue_to_scene_mapping[2].clue_id
