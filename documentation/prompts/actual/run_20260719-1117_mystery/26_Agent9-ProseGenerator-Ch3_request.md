...
- Project ID: ``
- Timestamp: `2026-07-19T11:24:08.019Z`
...
The discovery of Eleanor's body injects a jarring sense of urgency into the investigation.
...
Rationale: The gravity of the investigation should maintain a somber tone.

## Reveal Groundwork (texture — do not explain, only plant)
- Plant one subtle observable beat related to: "Mallory Finch's involvement reframes earlier interactions with Eleanor, highlighting the jealousy that simmered beneath their professional facade". Do not explain significance yet.
- Plant one subtle observable beat related to: "The discovery of the vial the tea service as a focal point of suspicion, shifting blame away from other suspects". Do not explain significance yet.
- Plant one subtle observable beat related to: "Finally, Ivor’s desperate actions are illuminated, revealing the lengths to which he would go to protect his reputation, embedding a deeper understanding of his character’s motivations". Do not explain significance yet.
...
• [clue_11] eleanor, froth, around, mouth, indicating, poisoning
  Category: testimonial | Criticality: essential | Supports inference step 1
  Points to: reinforces, theory, poisoning

• [clue_12] eleanor, symptoms, align, heart, attack
  Category: testimonial | Criticality: essential | Supports inference step 1
  Points to: further, supports, poisoning, hypothesis

• [clue_3] small, vial, service, area
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: vial, likely, contains, poison, used, eleanor, murder, indicating, premeditation
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_4, clue_core_contradiction_chain, clue_mid_1 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): suggests, poison, activated, heat | poison, deliberately, placed | indicates, eleanor, symptoms, align, heart, attack | suggests, poison, activated, heat
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the morning deepened and the fog pressed closer, Hugo resolved to pursue the contradictions in the witnesses’ stories. The truth, he suspected, would not be found in the obvious details, but in the spaces between them—the silences, the hesitations, the care..."
...
Chapter 2: Chapter 2: Initial Reactions
  Events: "You saw her drink it, didn’t you?
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=12297; context=10795; dropped=[humour_guide, location_profiles]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_12 must appear in Act 1, Scene 3 via Cross-check contradiction
...
- Chapter 3:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the morning deepened and the fog pressed closer, Hugo resolved to pursue the contradictions in the witnesses’ stories. The truth, he suspected, would not be found in the obvious details, but in the spaces between them...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • physical, scene, eleanor, body [clue_11] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: reinforces, theory, poisoning
    ...
    • medical, reports, contradict, heart, attack, theory [clue_12] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: further, supports, poisoning, hypothesis
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
         Paragraph 2 (immediately following): The detective or POV character explicitly reasons
           about what this evidence implies — who it implicates, why it may be unreliable,
           or what inference it supports. This must be a separate full paragraph, not a sentence appended to Paragraph 1.
    • discovery, vial, vicinity, service [clue_3] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: vial, likely, contains, poison, used, eleanor, murder, indicating, premeditation
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
         Paragraph 2 (immediately following): The detective or POV character explicitly reasons
           about what this evidence implies — who it implicates, why it may be unreliable,
           or what inference it supports. This must be a separate full paragraph, not a sentence appended to Paragraph 1.
    • vial, contents, suggest, premeditated, murder [clue_4] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: poison, deliberately, placed
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
         Paragraph 2 (immediately following): The detective or POV character explicitly reasons
...
Chapter 3 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The small vial found in the tea service area."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the victim was poisoned, contradicting initial assumptions of a heart attack."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Hugo pauses, his heart racing as he examines the froth around the victim's mouth."
      ]
    },
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 3: the clue [clue_11] (eleanor, froth, around, mouth, indicating, poisoning) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: the clue [clue_12] (eleanor, symptoms, align, heart, attack) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: the clue [clue_3] (small, vial, service, area) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: the clue [clue_4] (vial, likely, contains, poison, used, eleanor, murder, indicating, premeditation) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: the clue [clue_mid_1] (witnesses, recall, served, eleanor, unusually, warm) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
