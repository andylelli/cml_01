...
- Project ID: ``
- Timestamp: `2026-07-19T11:26:13.734Z`
...
• [clue_10] eliminates, sylvia, trent, because, captain, hale, time, murder
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: leaves, mallory, finch, prime, suspect

• [clue_early_1] mallory, finch, seen, near, service, shortly, before, eleanor, collapse
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Just as Hugo was gathering his papers, the door creaked open again and Dr. Mallory Finch stepped in, her coat still buttoned against the cold. She paused, glancing at the dying fire, then at Hugo. "You spoke with Beatrice? " she asked, voice low. When Hugo nod..."
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=18405; context=5566; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_mid_2 must appear in Act 2, Scene 3 via Vial discovery
...
- Chapter 6:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Just as Hugo was gathering his papers, the door creaked open again and Dr. Mallory Finch stepped in, her coat still buttoned against the cold. She paused, glancing at the dying fire, then at Hugo. "You spoke with Beatric...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • witnesses, confirmed, sylvia, location, hale [clue_10]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • witnesses, noted, finch, behavior, around, eleanor [clue_7]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    ...
    • witnesses, noting, temperature [clue_culprit_direct_dr_mallory_finch]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • witness, accounts, finch, proximity, service [clue_early_1]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Sylvia's quivering voice as she recalls her last encounter with the victim."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes Sylvia's jealousy, hinting at a motive but also providing an alibi."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Sylvia's voice quivers as she recalls her last encounter with the victim."
      ]
    },
    ...
    "dominantCharacterNote": {
      "name": "Sylvia Trent",
      "voiceRegister": "Sylvia speaks with refined eloquence, often delivering biting remarks wrapped in compliments."
    },
    "humourGuidance": {
