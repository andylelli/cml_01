...
- Project ID: ``
- Timestamp: `2026-05-11T19:29:50.031Z`
...
• [clue_1] The clock in the study shows the hands pointing to eleven.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: The time displayed on the clock at the scene.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=4773; context=9306; dropped=[none]; truncated=[location_profiles, temporal_context]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The clock in the study shows the hands pointing to eleven. [clue_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: The time displayed on the clock at the scene.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor glances at the clock, feeling the weight of time."
      ]
    },
    "summary": "In the dim light of the Finch study, Eleanor Voss arrives to find the doctor Finch and other guests gathered around the clock, which ominously shows the hands pointing to eleven. The atmosphere is thick with suspicion as they await the local constable's arrival.",
    "estimatedWordCount": 1800,
    "emotionalRegister": "A sense of anticipation fills the air, setting the stage for the unfolding drama.",
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 1: "The clock in the study shows the hands pointing to eleven." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
