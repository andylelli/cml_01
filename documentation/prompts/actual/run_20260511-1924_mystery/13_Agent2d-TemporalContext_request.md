...
- Project ID: ``
- Timestamp: `2026-05-11T19:28:05.976Z`
...
- YOU MUST use the exact year and month specified above: April 1933
- This date has been specifically selected for THIS mystery to ensure uniqueness
- DO NOT change the year or month - use April 1933 exactly
...
- All details must be historically accurate for April 1933 specifically
- Generate fresh, original descriptions - do not copy example phrasing
- Make this feel like the specific moment of April 1933
...
Task:
1. Use the specified date: April 1933
