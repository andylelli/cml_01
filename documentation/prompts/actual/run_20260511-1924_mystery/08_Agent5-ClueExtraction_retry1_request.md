...
- Project ID: `unknown`
- Timestamp: `2026-05-11T19:26:15.248Z`
...
1. Generate a clue that makes the reader directly observe: "The clock in the study shows the hands pointing to eleven...."
   → observation | essential | early | temporal | step 1 | terms: clock, study, shows

2. Generate a clue that provides evidence for: "The clock cannot be trusted as it was tampered with...."
   → contradiction | essential | early | temporal | step 1 | terms: clock, cannot, trusted

3. Generate a clue that makes the reader directly observe: "A note found near the clock reads 'ten minutes past eleven'...."
   → observation | essential | early | temporal | step 2 | terms: found, clock, reads

4. Generate a clue that provides evidence for: "This indicates a deliberate attempt to mislead regarding the time of death...."
   → contradiction | essential | early | temporal | step 2 | terms: indicates, deliberate, attempt

5. Generate a clue that makes the reader directly observe: "Witnesses heard the clock striking the hour wrongly...."
   → observation | essential | mid | temporal | step 3 | terms: witnesses, heard, clock

6. Generate a clue that provides evidence for: "The inconsistency suggests foul play regarding the time of death...."
   → contradiction | essential | mid | temporal | step 3 | terms: inconsistency, suggests, regarding

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The clock cannot be trusted as it was tampered with...."
   → contradiction | essential | mid | temporal | step 1 | terms: clock, cannot, trusted

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The clock was wound back to hide the true time of death...."
   → observation | essential | early | temporal | terms: clock, wound, death.

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "A controlled reenactment is staged where the clock is set to show the correct time and Dr. Finch's a..."
   → observation | essential | mid | temporal | terms: controlled, reenactment, staged
...
10. Generate one essential mid-story clue whose description or pointsTo explicitly names Dr. Mallory Finch and states the unique trace, preparation detail, or mechanism link that points to Dr. Mallory Finch rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Dr. Mallory Finch, clock, wound, death.

11. Generate a clue showing observable evidence of Dr. Mallory Finch's premeditation or planning (A past grievance with the Voss family.). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: grievance, family.
...
- Eleanor Voss: sensitive items: Willing to hide personal motives, Concern for her reputation
- Dr. Mallory Finch: sensitive items: Fear of exposure, Anger over past grievances
- Captain Ivor Hale: sensitive items: Concern for Eleanor's reputation, Distrust of the household staff
- Beatrice Quill: sensitive items: Fear of losing her job, Desire for upward mobility
...
Create 2 red herrings that support the false assumption: "The clock accurately reflected the time of death."
...
Warnings: 1 red herring(s) may accidentally support the true solution (rh_1)
...
- required_direct_culprit_clue:
  ...
  - allowed_source_paths=CASE.cast[1].access_plausibility, CASE.cast[1].alibi_window, CASE.cast[1].evidence_sensitivity[0], CASE.inference_path.steps[1].observation, CASE.inference_path.steps[1].correction
