...
- Project ID: ``
- Timestamp: `2026-07-20T20:19:11.583Z`
...
A crucial clue shifts the direction of the investigation.
...
Rationale: The tension among characters is heightened, leaving no room for humor.
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Eleanor grapples with guilt over the affair, torn between her past desires and her present need for respectability."
...
• [clue_core_elimination_chain] eliminates, eleanor, voss, because, seen, hotel, time, drowning
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: eleanor, voss, alibi, excludes, suspicion

• [clue_8] mallory, finch, seen, near, clock, tower, shortly, before, drowning
  Category: behavioral | Criticality: essential | Supports inference step 2
  Points to: mallory, finch, opportunity, manipulate, tides
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_id_4, clue_core_contradiction_chain, clue_id_6, clue_10, clue_fp_contradiction_step_1, clue_id_3 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): existence, device, alters, tide, timings | tide, contradicting, claims, high, drowning | tide, contradicting, claims, high, drowning | presence, water, lungs, indicates, drowning | presence, water, lungs, indicates, drowning | tide, contradicting, claims, high, drowning | existence, device, alters, tide, timings
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the afternoon deepened and the storm pressed closer, Sylvia gathered the reports and the device, her mind racing with possibilities. The facts refused to settle, each answer spawning new questions. She left the medical room with the sense that the investiga..."
...
drawing room, corridor, lobby, flat
...
Chapter 3: Chapter 3: The Autopsy Report
  Events: Early afternoon brought a grey hush to the hotel medical room, the distant rain tapping a persistent rhythm against the frosted glass.
...
Known location profile anchors: The Oceancrest Hotel, The Grand Lobby, The Drawing Room, Staff Quarters, Ocean View Balcony, the hotel bar
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Oceancrest Hotel", "The Grand Lobby", "The Drawing Room", "Staff Quarters", "Ocean View Balcony", "the hotel bar"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=13734; context=9622; dropped=[humour_guide, location_profiles]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 4:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the afternoon deepened and the storm pressed closer, Sylvia gathered the reports and the device, her mind racing with possibilities. The facts refused to settle, each answer spawning new questions. She left the medica...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • eleanor, voss, observed, hotel [clue_core_elimination_chain]
      Points to: eleanor, voss, alibi, excludes, suspicion
    • witnesses, report, seeing, mallory, finch, near, clock, tower [clue_8]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • tide, chart, reveals, differences, recorded, levels [clue_culprit_direct_dr_mallory_finch]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Eleanor's defensive behavior during the interrogation."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Eleanor had a potential motive linked to Hugo's threats, but her alibi is weak."
...
[
  {
    ...
    "emotionalRegister": "A crucial clue shifts the direction of the investigation.",
