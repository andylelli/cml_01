...
- Project ID: ``
- Timestamp: `2026-07-20T20:17:46.898Z`
...
- Sylvia Trent
  ...
  Connection to victim: Journalist and subject of many controversial articles, often at odds.; Sylvia has exposed many of Hugo's dealings, making him wary of her intentions..
...
- Eleanor Voss
  ...
  Connection to victim: Business partners with a history of tension over hotel investments.; Eleanor and Hugo have clashed over the hotel's future, with Eleanor resenting Hugo's controlling nature..
  Investigation relevance: access plausibility: medium | alibi window: 7:00 PM to 9:00 PM | opportunity channel: Ocean view balcony.
  Suspicion/pressure cue seed: Social reputation.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.
...
- Captain Ivor Hale
  ...
  Investigation relevance: access plausibility: high | alibi window: 8:00 PM to 10:00 PM | opportunity channel: Pier access.
...
• [clue_mechanism_visibility_core] mechanical, device, discovered, clock, tower, alters, tide, timings
  Category: spatial | Criticality: essential | Supports inference step 2
  Points to: existence, device, alters, tide, timings

• [clue_id_4] witnesses, recall, seeing, tide, unusually, before, hugo, drowning
...
Known location profile anchors: The Oceancrest Hotel, The Grand Lobby, The Drawing Room, Staff Quarters, Ocean View Balcony, the seaside hotel beach
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Oceancrest Hotel", "The Grand Lobby", "The Drawing Room", "Staff Quarters", "Ocean View Balcony", "the seaside hotel beach"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the seaside hotel beach". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=7864; context=12207; dropped=[none]; truncated=[first_appearance_contracts, location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • clock, tower, contains, unfamiliar, mechanical, apparatus [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The body of Hugo Vane found on the shore, water still dripping from his clothes."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Hugo Vane was found drowned, contradicting initial claims of a high tide."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_1] Guests whisper about having seen Hugo drown during a sudden high tide, creating a false impression of an accidental drowning.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Sylvia notices Eleanor's trembling hands as she stares at the water."
      ]
    },
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_1",
      "placementDetail": "Guests whisper about having seen Hugo drown during a sudden high tide, creating a false impression of an accidental drowning."
    },
    "emotionalRegister": "The initial atmosphere is charged with tension and foreboding.",
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (mechanical, device, discovered, clock, tower, alters, tide, timings) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_id_4] (witnesses, recall, seeing, tide, unusually, before, hugo, drowning) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
