...
- Project ID: ``
- Timestamp: `2026-07-16T19:39:13.002Z`
...
- Era-authentic markers: radio broadcasting, early television sets, basic radar systems, wartime rationing of fuel, post-war automobile boom, public transit limitations, long-distance telephone calls, military-style encryption
- Tone: Classic
- No anachronisms
...
Description: A grand seaside hotel built in the 1920s, featuring Art Deco architecture with large windows overlooking the ocean, a sprawling lobby with a grand staircase, and narrow hallways leading to guest rooms.
...
Setting constraints:
- Physical constraints: narrow corridors restrict movement, limited access to certain floors after hours, oceanfront location limits escape routes
...
- Social norms: women increasingly in the workforce, post-war societal adjustments
