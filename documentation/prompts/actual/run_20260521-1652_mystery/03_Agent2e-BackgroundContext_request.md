...
- Project ID: ``
- Timestamp: `2026-05-21T16:52:31.730Z`
...
Tone: Classic
Era decade: 1930s
Social norms: impact of the Great Depression on social hierarchies, rising class tensions, growing fascist movements in Europe
Location description: A sprawling country estate featuring a grand façade with classical columns, extensive gardens, and a series of outbuildings including a stable and a greenhouse.
Institution type: Manor house
Weather: Overcast with intermittent rain, typical for the English countryside in autumn.
Mood: Tense and foreboding, as secrets begin to surface among the guests.
...
Access control: restricted areas such as the servants' quarters and the private study, permissions required for access to the cellar and attic, daily routines dictate movement patterns of staff and guests
