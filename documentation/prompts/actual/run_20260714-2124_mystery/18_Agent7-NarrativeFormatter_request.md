...
- Project ID: `unknown`
- Timestamp: `2026-07-14T21:33:48.580Z`
...
### Early Clues (Act I)
- [clue_mechanism_visibility_core] temporal: The clock's hands are not aligned with the sunlight hitting the wall.
- [clue_core_contradiction_chain] temporal: The clock's time is incorrect due to tampering.
- [clue_3] physical: A faint smudge of clock oil is found near the clock's keyhole.
- [clue_4] temporal: The smudge indicates recent tampering with the clock.

### Mid Clues (Act II)
- [clue_5] testimonial: Witnesses recall seeing Eleanor in a different outfit than what was found.
- [clue_6] temporal: Eleanor changed outfits before her death.
- [clue_7] temporal: Comparing the clock's tampering evidence with a controlled test of its accuracy proves only Sylvia T...
- [clue_8] behavioral: Sylvia Trent exhibited signs of jealousy towards Eleanor.
- [clue_core_elimination_chain] testimonial: Eliminates Dr. Mallory Finch because he was in a different location during the murder.
- [clue_10] testimonial: Eliminates Captain Ivor Hale because he was seen by multiple witnesses at the time of the murder.
...
### Late Clues (Act III)
- [clue_late_optional_slot_1] temporal: The clock shows a specific time. remains a late texture detail in the case background.
...
- **clue_5**: Act 2, Scene 1 (Witness statement)
...
- **dining_room_clock_time**: "ten minutes past nine" — The time shown on the dining room clock when the murder was discovered.
- **sunlight_angle**: "forty-five degrees" — The angle of sunlight illuminating the wall at the time of the murder.
- **recent_wind_time**: "twenty minutes" — The time since the clock was last wound before being tampered with.


## PILLAR 4 — OUTLINE COMPLETENESS CONTRACT DATA

### Character Permitted Behaviours (use for permittedBehavioursByAct per scene)
- **Eleanor Voss**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "inheritance" — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Eleanor wrestles with her guilt over her husband's betrayals, fearing that revealing the truth would shatter her family's image and lead to her own disgrace." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Dr. Mallory Finch**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Fears exposure of her unethical practices might ruin her career." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Mallory is torn between her ambition to advance medicine and the ethical implications of her secret experiments, fearing that exposure could lead to her downfall." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Captain Ivor Hale**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Blames Eleanor for not honoring the veterans and airmen of the war, believing she undermined their sacrifices." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Ivor battles with feelings of inadequacy and resentment, struggling to reconcile his past with the respect he demands from others." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Beatrice Quill**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Saw Eleanor as a barrier to her career ambitions; could expose family secrets that would benefit her journalism." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Beatrice is torn between her ambition and her ethical boundaries, struggling to balance her drive for success with her moral compass." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Sylvia Trent**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Believes Eleanor's decisions have stifled her career, fueling her bitterness." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Sylvia struggles with feelings of inadequacy and resentment, torn between her passion for music and her bitterness towards those who have stifled her potential." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Hugo Vane**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "inheritance" — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Hugo is torn between his ambition to secure financial stability and the fear of losing the respect of his family and community." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
