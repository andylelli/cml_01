...
- Project ID: ``
- Timestamp: `2026-07-14T21:41:19.735Z`
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_3, clue_4, clue_5, clue_8, clue_culprit_direct_sylvia_trent, clue_core_elimination_chain, clue_10, clue_6 — do not reveal these as new information.
...
Known location profile anchors: Seaside Grand Hotel, The Grand Dining Room, The Library, The Grand Lobby, the grand library of the seaside hotel
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Seaside Grand Hotel", "The Grand Dining Room", "The Library", "The Grand Lobby", "the grand library of the seaside hotel"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 7: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the grand library of the seaside hotel". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=18737; context=4561; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 7:
  ...
  - Scene is set in: the grand library of the seaside hotel — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Hugo’s heart sank as he realized the implications of his deduction. The case appeared closed, but the hollowness in his chest told another story. He could not shake the sense that the truth still lurked in the shadows, w...".
  ...
  - Sensory obligation — use at least two of: Raindrops on the large bay window, Gloomy light filtering through clouds | Rain tapping against the window, Soft crackle of the fireplace | Freshly brewed tea. Mood: oppressive.
...
Chapter 7 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Eleanor's confession about her troubled past."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that there are unrelated lies complicating the investigation, leading to a reinterpretation of earlier clues."
...
[
  {
    ...
    "setting": {
      "location": "the grand library of the seaside hotel",
      "timeOfDay": "Late night after the murder",
      "atmosphere": "Mysterious as hidden truths come to light"
    },
    "characters": [
      "Hugo Vane",
      "Beatrice Quill",
    ...
    "dramaticElements": {
      ...
      "tension": "The detective grapples with the implications of new information",
      "microMomentBeats": [
        "Eleanor's hands tremble as she reveals a hidden truth."
      ]
    },
    "summary": "In the library, Hugo uncovers hidden secrets among the suspects, including Eleanor's troubled past and the doctor's unethical practices. These revelations complicate the investigation, forcing Hugo to reevaluate his previous conclusions.",
    "beat": "secrets",
    "estimatedWordCount": 1250,
    "pivotElement": "Eleanor's confession about her troubled past.",
    "factEstablished": "Establishes that there are unrelated lies complicating the investigation, leading to a reinterpretation of earlier clues.",
