...
- Timestamp: `2026-06-14T11:25:09.387Z`
...
• [clue_7] Recreate the dining conditions to compare the drink temperature at the time of the victim's death.
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: Necessary for understanding the poison activation.

• [clue_4] This off radiator confirms that the drink remained cold, supporting the idea of delayed poison activation.
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: Reinforces the timeline of events.

• [clue_early_1] Witnesses state they saw the victim with the drink shortly before ten o'clock.
  Category: testimonial | Criticality: essential | Supports inference step 2
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "The atmosphere grew heavy with unspoken thoughts as they both considered the implications of Hugh's access to the poison. Gertrude felt a sense of urgency building within her; the pieces of the puzzle were beginning to come together, but she still needed to un..."
...
Known location profile anchors: Little Middleton Manor, The Drawing Room, The Library, The Study, The Gardens, the dining room, set up for a reenactment
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The Drawing Room", "The Library", "The Study", "The Gardens", "the dining room, set up for a reenactment"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 7: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the dining room, set up for a reenactment". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Chapter 6 (score 87/100):
  ...
  Address in upcoming chapters: Increase chapter density with concrete investigation action and sensory-grounded beats; avoid recap-only padding. | Open next chapter with a named location anchor plus at least two sensory cues and one atmosphere marker.
- Phrases to avoid (already overused in earlier chapters): "of you must be prepared to share", "you must be prepared to share your", "must be prepared to share your alibi", "was found unusually cold for the time", "found unusually cold for the time of", "unusually cold for the time of year", "cold for the time of year she", "prepared earlier it could mean that the", "earlier it could mean that the poisoning", "a reminder that time was slipping away".
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=12604; context=11831; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 7:
  ...
  - Scene is set in: the dining room, set up for a reenactment — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "The atmosphere grew heavy with unspoken thoughts as they both considered the implications of Hugh's access to the poison. Gertrude felt a sense of urgency building within her; the pieces of the puzzle were beginning to c...".
...
[
  {
    ...
    "setting": {
      "location": "the dining room, set up for a reenactment",
      "timeOfDay": "Late evening, after interviewing all suspects",
      "atmosphere": "A charged atmosphere as Gertrude prepares to conduct her test."
    },
    "characters": [
      "Gertrude Walton",
      "Hugh Hadley",
    ...
    "purpose": "Execute the discriminating test to reveal the truth about the drink's temperature.",
    "cluesRevealed": [
      "clue_7",
      "clue_4",
      "clue_early_1"
    ...
    "dramaticElements": {
      "conflict": "Tension mounts as the guests await the results of the test.",
      "tension": "The stakes are high as Gertrude prepares to reveal the truth.",
      "microMomentBeats": [
        "Gertrude's hands tremble slightly as she sets up the experiment, aware of the eyes on her."
      ]
    },
    "summary": "Gertrude gathers everyone in the dining room to recreate the conditions of the evening. She sets up a comparison of the drink temperature at the time of the victim's death, revealing discrepancies that contradict the earlier claims of the witnesses. The atmosphere is thick with anticipation as she prepares to expose the truth.",
