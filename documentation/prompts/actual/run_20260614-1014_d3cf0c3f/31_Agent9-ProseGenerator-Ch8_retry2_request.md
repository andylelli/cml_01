...
- Timestamp: `2026-06-14T11:25:42.232Z`
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=14269; context=10779; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
• REPAIR [clue_visibility — attempt 3]: chapters 8 are missing 1 clue.
  For EACH missing clue below, insert a two-paragraph block near the beginning of the chapter:
  Clue: "Clue obligation: suspect clearance missing for "Mary Selby". This chapter must include a paragraph that (a) names "Mary Selby" explicitly, (b) contains a clearance phrase (e.g. "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have"), AND (c) contains an evidence connector (e.g. "because", "therefore", "which proves", "alibi", "timeline", "evidence"). Example: "Mary Selby's alibi was confirmed because multiple witnesses saw them in [location] at the time." Do not split the clearance across separate paragraphs."
