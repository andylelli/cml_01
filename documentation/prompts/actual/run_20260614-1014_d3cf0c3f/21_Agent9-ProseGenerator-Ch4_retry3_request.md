...
- Timestamp: `2026-06-14T11:23:56.207Z`
...
Gertrude’s investigation reveals conflicting alibis.
...
Rationale: The atmosphere is charged with tension, leaving no room for humor.
...
• [clue_5] Hugh Hadley was observed discussing family legacy concerns with the victim just before dinner.
  Category: behavioral | Criticality: essential | Supports inference step 2
  Points to: Indicates motive for premeditation.

• [clue_core_contradiction_chain] This contradicts the earlier observations about the temperature, indicating a false assumption about the timing of the poisoning.
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: Overturns the false assumption regarding the timing of the poisoning.

• [clue_8] Gertrude Walton was noted to be unusually nervous during the dinner.
  Category: behavioral | Criticality: essential | Supports inference step 2
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_1, clue_3, clue_fp_contradiction_step_1, clue_mid_1 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence in reader's hands: The victim was poisoned with a time-delayed poison that activated after the guest had been seen with the drink. | The drink served to the victim was found unusually cold for the time of year. | The radiator in the dining room was switched off at the time of the incident. | The drink served to the victim was found unusually cold for the time of year. | The victim was poisoned with a time-delayed poison that activated after the guest had been seen with the drink.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the guests began to share their accounts, Gertrude observed the subtle shifts in their expressions. Mary Selby had always been a loyal servant, yet now her absence left a chasm filled with uncertainty. Gertrude’s mind raced as she pieced together the fragme..."
...
Chapter 1: Chapter 1: Discovery
  Events: The evening air was thick with tension as the rain drummed against the grand windows of the dining room of the Hadley residence.
Chapter 2: Chapter 2: Initial Reactions
  Events: ‘We must do something!
...
Known location profile anchors: Little Middleton Manor, The Drawing Room, The Library, The Study, The Gardens, the dining room, now cleared of the body
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The Drawing Room", "The Library", "The Study", "The Gardens", "the dining room, now cleared of the body"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 4: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a noun-phrase atmosphere — e.g. "The smell of damp stone in the cellar…" / "A chill from the landing…" / "The sound of the clock in the hall…". Pattern: "The/A [noun] of/in/from [place]…". Anchor opening in "the dining room, now cleared of the body". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Chapter 3 (score 84/100):
  Quality gaps noted: word density below preferred target (619/1000); scene grounding weakness
  Address in upcoming chapters: Increase chapter density with concrete investigation action and sensory-grounded beats; avoid recap-only padding. | Open next chapter with a named location anchor plus at least two sensory cues and one atmosphere marker.
- Phrases to avoid (already overused in earlier chapters): "of you must be prepared to share", "you must be prepared to share your", "must be prepared to share your alibi".
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=9716; context=10456; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
Suspect pressure target(s): Hugh Hadley
...
- Chapter 4:
  ...
  - Scene is set in: the dining room, now cleared of the body — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the guests began to share their accounts, Gertrude observed the subtle shifts in their expressions. Mary Selby had always been a loyal servant, yet now her absence left a chasm filled with uncertainty. Gertrude’s mind...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • This contradicts the earlier observations about the temperature, indicating a false assumption about the timing of the poisoning. [clue_core_contradiction_chain]
      Points to: Overturns the false assumption regarding the timing of the poisoning.
...
[
  {
    "sceneNumber": 4,
    "act": 2,
    "title": "Interrogating Hugh",
    "setting": {
      "location": "the dining room, now cleared of the body",
      "timeOfDay": "Late evening, after the initial shock has subsided",
      "atmosphere": "A tense atmosphere as Gertrude questions Hugh."
    },
    "characters": [
      "Gertrude Walton",
      "Hugh Hadley"
    ],
    "purpose": "Interrogate Hugh to uncover his potential motives.",
    "cluesRevealed": [
      "clue_5",
    ...
    "dramaticElements": {
      "conflict": "Hugh becomes defensive as Gertrude presses him for details.",
      "tension": "His emotional state raises suspicion.",
      "microMomentBeats": [
        "Hugh's voice cracks as he recalls the last conversation with the victim."
      ]
    },
    "summary": "Gertrude sits across from Hugh, probing him about his last interactions with the victim. Hugh reveals his concerns about family legacy and the pressure he felt from the victim. His emotional outburst raises questions about his potential motive, leaving Gertrude with more to consider.",
    "estimatedWordCount": 1250,
    "emotionalRegister": "Gertrude’s investigation reveals conflicting alibis.",
...
```text
{
  ...
  "cast": ["Gertrude Walton", "Hugh Hadley"],
  "note": "",
  "audit": {
    "locked_fact_phrases": "present in paragraph 5 | absent",
    "season_words_used": "autumn | none",
    "discriminating_test_present": "no",
    "required_clues_present": "clue_5: paragraph 4 | clue_core_contradiction_chain: paragraph 5 | clue_8: paragraph 3",
...
Attempt context: 4/6 | primary class: unknown.
...
PRIMARY FAILURES
- Chapter 4: clue evidence "This contradicts the earlier observations about the temperature, indicating a false assumption about the timing of the poisoning." is absent. Include an on-page observation or reference to "This contradicts the earlier observations about the temperature, indicating a false assumption about the timing of the poisoning." (this clue reveals: Overturns the false assumption regarding the timing of the poisoning.) before the chapter ends.

REWRITE PLAN
- Preserve paragraphs that are already valid, but fully rewrite every paragraph touched by a failing issue.
- Insert or move a dedicated observation-plus-inference block for each missing clue: "This contradicts the earlier observations about the temperature, indicating a false assumption about the timing of the poisoning.". The observation and inference must be separate full paragraphs.

SUCCESS CHECKLIST
- Every listed issue below is resolved in this single attempt before you answer.
- Each missing clue appears on-page as observable evidence, followed immediately by a separate inference paragraph: "This contradicts the earlier observations about the temperature, indicating a false assumption about the timing of the poisoning.".
...
• REPAIR [clue_visibility — attempt 4]: chapters 4 are missing 1 clue.
  ...
  Clue: "This contradicts the earlier observations about the temperature, indicating a false assumption about the timing of the poisoning."
...
RETRY CLASS: unknown
ATTEMPT: 3/6
OFFENDING TEXT: This contradicts the earlier observations about the temperature, indicating a false assumption about the timing of the poisoning.
MANDATORY FIXES:
