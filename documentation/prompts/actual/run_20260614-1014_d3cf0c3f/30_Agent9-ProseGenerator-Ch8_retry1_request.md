...
- Timestamp: `2026-06-14T11:25:32.356Z`
...
The revelation of past grievances deepens the intrigue.
...
Rationale: The stakes are too high for humor in this intense moment.
...
• [clue_late_1] This contradicts the earlier observations about the temperature, indicating a false assumption about the timing of the poisoning.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the atmosphere thickened with anticipation, Gertrude felt the weight of the moment pressing down on her. This was not merely an experiment; it was a crucial step toward uncovering the truth behind Mary Selby’s tragic death. The stakes were high, and she cou..."
...
Known location profile anchors: Little Middleton Manor, The Drawing Room, The Library, The Study, The Gardens, the dining room, after the discriminating test
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The Drawing Room", "The Library", "The Study", "The Gardens", "the dining room, after the discriminating test"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 8: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with spoken dialogue — e.g. '"[words]," [Name] said/asked/replied/murmured.' The opening quote must be the first character on the line. Anchor opening in "the dining room, after the discriminating test". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Chapter 7 (score 92/100):
  ...
  Address in upcoming chapters: Increase chapter density with concrete investigation action and sensory-grounded beats; avoid recap-only padding. | Open next chapter with a named location anchor plus at least two sensory cues and one atmosphere marker.
- Phrases to avoid (already overused in earlier chapters): "found unusually cold for the time of", "unusually cold for the time of year", "prepared earlier it could mean that the", "earlier it could mean that the poisoning", "of you must be prepared to share", "you must be prepared to share your", "must be prepared to share your alibi", "was found unusually cold for the time", "cold for the time of year she", "could mean that the poisoning was premeditated".
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=14204; context=10779; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
Suspect pressure target(s): Mary Selby
...
Active phase for this batch: False Suspect Chapters (mode: False Suspect Clearing).
Apply this target mix in this batch:
- Setting: 10%
- Character Focus: 45%
- Evidence Contradiction: 45%
...
- Chapter 8:
  ...
  - Scene is set in: the dining room, after the discriminating test — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the atmosphere thickened with anticipation, Gertrude felt the weight of the moment pressing down on her. This was not merely an experiment; it was a crucial step toward uncovering the truth behind Mary Selby’s tragic...".
...
[
  {
    ...
    "title": "Clearing Mary",
    "setting": {
      "location": "the dining room, after the discriminating test",
      "timeOfDay": "Late evening, shortly after the test",
      "atmosphere": "A tense atmosphere as Gertrude reviews the findings."
    },
    "characters": [
      "Gertrude Walton",
      "Mary Selby"
    ],
    "purpose": "Clear Mary Selby based on corroborating evidence.",
    "cluesRevealed": [
      "clue_late_1"
    ],
    "dramaticElements": {
      "conflict": "Mary's innocence is confirmed, but suspicion remains on others.",
      "tension": "The atmosphere is fraught with unresolved tension.",
      "microMomentBeats": [
        "Mary exhales deeply, relieved but still anxious about the outcome."
      ]
    },
    "summary": "Gertrude turns her attention to Mary, reviewing the drink temperature records taken by the butler and the radiator status report. The evidence corroborates Mary's alibi, clearing her of suspicion. However, the tension remains as the focus shifts back to the remaining suspects.",
    "estimatedWordCount": 1250,
    "emotionalRegister": "Pressure mounts as the truth creeps closer to the surface.",
    "dominantCharacterNote": {
      "name": "Mary Selby",
      "voiceRegister": "Mary's voice is steady and practical, often laced with dry wit reflecting her sharp observations."
    },
    "humourGuidance": {
      "permission": "forbidden"
    },
...
```text
{
  ...
  "chapters": [
    {
      ...
      "summary": "Gertrude Walton reviews the drink temperature records and radiator status report, confirming Mary Selby's innocence while shifting focus back to the remaining suspects.",
      "paragraphs": [
        "‘The temperature is currently sixty degrees Fahrenheit,’ Gertrude announced, her voice steady as she faced the gathered guests in the dining room. The flickering candlelight cast long shadows across the polished table, remnants of the earlier chaos still evident in the scattered chairs and overturned glassware. The atmosphere was thick with tension, the rain continuing its relentless patter against the windows. Gertrude felt the weight of anticipation pressing down on her, each moment charged with the potential for revelation. She had just conducted her test to ascertain the drink's temperature, and now, the implications of her findings hung in the air like a storm cloud, ready to burst.",
        "As she glanced at Mary Selby, the loyal servant who had been at the heart of the investigation, Gertrude noticed the way Mary exhaled deeply, a mixture of relief and anxiety etched across her features. Mary had been a devoted employee, and the thought of her being implicated in such a heinous act weighed heavily on Gertrude’s conscience. ‘Mary,’ Gertrude said, her tone softening, ‘the drink served to you was found unusually cold for the time of year, which contradicts earlier assumptions about the timing of the poisoning. This evidence corroborates your alibi.’",
        "Mary’s eyes widened, and she nodded slowly, absorbing the weight of Gertrude’s words. ‘So, you’re saying I couldn’t have poisoned it?’ she asked, her voice steady yet laced with a hint of disbelief. ‘Because the drink had to be prepared earlier, before I was seen with it.’ Gertrude affirmed with a nod. ‘Exactly. The drink was prepared well in advance, and the radiator being off confirms that it remained cold. Therefore, you are cleared of suspicion.’",
        "A wave of relief washed over Mary, but Gertrude could see the lingering tension in her shoulders. ‘Thank you, Gertrude,’ Mary replied, her voice barely above a whisper. ‘But what does this mean for the rest of us? The others are still under suspicion.’ Gertrude felt a pang of sympathy for Mary; she understood the emotional toll this investigation was taking on everyone involved. The truth was still shrouded in uncertainty, and while Mary’s innocence was confirmed, the atmosphere remained fraught with unresolved tension.",
        "‘We need to focus on the remaining suspects,’ Gertrude said, her resolve hardening. ‘Hugh Hadley, Brenda Marlow, and Trevor Cheyne all have their own motives and opportunities. Clearing you does not absolve them.’ Mary nodded, her expression shifting to one of concern. ‘I just hope that whoever did this is found before more damage is done.’ Gertrude appreciated Mary’s loyalty, but she knew that the truth would require digging deeper into each suspect’s alibi and motives.",
        "‘Let’s review what we know,’ Gertrude suggested, her mind racing with the implications of her findings. ‘Hugh was the last person to speak with you before dinner, and he has expressed concerns about the estate’s future. Brenda was in the kitchen preparing drinks, and Trevor was seen leaving the premises at eight-thirty. Each of them has a story, but we need to verify their accounts.’",
        "Mary shifted her weight, her brow furrowed. ‘I overheard some of their conversations. There was tension about the estate, especially between Hugh and Brenda. They were arguing about finances just before dinner.’ Gertrude’s interest piqued at this revelation. ‘What did they say?’ she pressed, eager to uncover any additional clues that could illuminate the situation.",
        "‘I couldn’t catch every word,’ Mary admitted, her voice low. ‘But it was clear that Brenda was frustrated with Hugh’s decisions. She felt he was making mistakes that could ruin everything.’ Gertrude noted the implications of this information. If Brenda had a motive tied to the estate’s future, it could complicate the investigation further. ‘Thank you, Mary. This insight could prove invaluable,’ Gertrude replied, her mind racing with possibilities.",
        "As they continued to discuss the events leading up to the murder, Gertrude felt the pressure mount. The truth was creeping closer to the surface, but the shadows of doubt still loomed large. Each piece of information added to the complexity of the case, and she knew that time was of the essence. With Mary cleared, the focus would shift back to the remaining suspects, and Gertrude was determined to uncover the truth, no matter how deep the secrets ran."
      ]
    }
  ],
  ...
  "audit": {
    ...
    "required_clues_present": "clue_late_1: paragraph 3 | absent",
    "early_observation_present": "description: paragraph 1 | absent",
    "early_inference_present": "yes: paragraph immediately following observation | no"
  }
}
```
...
Attempt context: 2/6 | primary class: continuity.
...
PRIMARY FAILURES
- Clue obligation: suspect clearance missing for "Mary Selby". This chapter must include a paragraph that (a) names "Mary Selby" explicitly, (b) contains a clearance phrase (e.g. "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have"), AND (c) contains an evidence connector (e.g. "because", "therefore", "which proves", "alibi", "timeline", "evidence"). Example: "Mary Selby's alibi was confirmed because multiple witnesses saw them in [location] at the time." Do not split the clearance across separate paragraphs.
...
- Clue obligation: suspect clearance missing for "Trevor Cheyne". This chapter must include a paragraph that (a) names "Trevor Cheyne" explicitly, (b) contains a clearance phrase (e.g. "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have"), AND (c) contains an evidence connector (e.g. "because", "therefore", "which proves", "alibi", "timeline", "evidence"). Example: "Trevor Cheyne's alibi was confirmed because multiple witnesses saw them in [location] at the time." Do not split the clearance across separate paragraphs.
...
Attempt 2/6 — chapters 8 — 3 validation issue(s) to resolve:
...
• REPAIR [clue_visibility — attempt 2]: chapters 8 are missing 3 clues.
  For EACH missing clue below, insert a two-paragraph block near the beginning of the chapter:
  [Clue 1]: "Clue obligation: suspect clearance missing for "Mary Selby". This chapter must include a paragraph that (a) names "Mary Selby" explicitly, (b) contains a clearance phrase (e.g. "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have"), AND (c) contains an evidence connector (e.g. "because", "therefore", "which proves", "alibi", "timeline", "evidence"). Example: "Mary Selby's alibi was confirmed because multiple witnesses saw them in [location] at the time." Do not split the clearance across separate paragraphs."
  ...
  [Clue 2]: "Clue obligation: suspect clearance missing for "Brenda Marlow". This chapter must include a paragraph that (a) names "Brenda Marlow" explicitly, (b) contains a clearance phrase (e.g. "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have"), AND (c) contains an evidence connector (e.g. "because", "therefore", "which proves", "alibi", "timeline", "evidence"). Example: "Brenda Marlow's alibi was confirmed because multiple witnesses saw them in [location] at the time." Do not split the clearance across separate paragraphs."
  • Observation paragraph: A character directly observes or discovers this evidence. Be specific and sensory — describe what is seen, touched, or heard. Include the exact quoted phrase verbatim.
  • Inference paragraph (immediately after): The detective or POV character state what this implies — who it implicates, what is suspicious, or what inference it supports. Use first-person inference language ("She realised...", "He could not help but notice..."). This must be a full separate paragraph, not a tacked-on sentence.
  [Clue 3]: "Clue obligation: suspect clearance missing for "Trevor Cheyne". This chapter must include a paragraph that (a) names "Trevor Cheyne" explicitly, (b) contains a clearance phrase (e.g. "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have"), AND (c) contains an evidence connector (e.g. "because", "therefore", "which proves", "alibi", "timeline", "evidence"). Example: "Trevor Cheyne's alibi was confirmed because multiple witnesses saw them in [location] at the time." Do not split the clearance across separate paragraphs."
  • Observation paragraph: A character directly observes or discovers this evidence. Be specific and sensory — describe what is seen, touched, or heard. Include the exact quoted phrase verbatim.
  • Inference paragraph (immediately after): The detective or POV character state what this implies — who it implicates, what is suspicious, or what inference it supports. Use first-person inference language ("She realised...", "He could not help but notice..."). This must be a full separate paragraph, not a tacked-on sentence.
