...
- Timestamp: `2026-06-14T10:14:36.912Z`
...
**Character Names** (pre-selected — use EXACTLY as given, do not alter, abbreviate, or substitute any name): Hugh Hadley, Brenda Marlow, Mary Selby, Trevor Cheyne, Gertrude Walton
...
**Setting**: 1930s - An expansive country estate featuring a grand entrance, multiple wings, and extensive gardens, reflective of early 20th-century architectural styles.
**Crime Type**: Murder
**Social Context**: Great Depression economic hardship, class tensions among the wealthy and working class, rising fascist sentiments in Europe
**Tone**: Classic
