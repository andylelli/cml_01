...
- Timestamp: `2026-06-14T10:15:26.292Z`
...
1. Generate a clue that makes the reader directly observe: "The drink served to the victim was found unusually cold for the time of year...."
   → observation | essential | early | temporal | step 1 | terms: drink, served, victim

2. Generate a clue that provides evidence for: "The cold temperature suggests that the drink was prepared well in advance, affecting the timing of t..."
   → contradiction | essential | early | testimonial | step 1 | terms: temperature, suggests, drink

3. Generate a clue that makes the reader directly observe: "The radiator in the dining room was switched off at the time of the incident...."
   → observation | essential | early | temporal | step 2 | terms: radiator, dining, switched

4. Generate a clue that provides evidence for: "The off radiator confirms that the drink remained cold, supporting the idea of delayed poison activa..."
   → contradiction | essential | early | testimonial | step 2 | terms: radiator, confirms, drink

5. Generate a clue that makes the reader directly observe: "Witnesses state they saw the victim with the drink shortly before 10:00 PM...."
   → observation | essential | mid | temporal | step 3 | terms: witnesses, state, victim

6. Generate a clue that provides evidence for: "This contradicts the earlier observations about the temperature, indicating a false assumption about..."
   → contradiction | essential | mid | testimonial | step 3 | terms: contradicts, earlier, observations

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The cold temperature suggests that the drink was prepared well in advance, affecting the timing of the poison's activation...."
   → contradiction | essential | mid | testimonial | step 1 | terms: temperature, suggests, drink

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The victim was poisoned with a time-delayed poison that activated after the guest had been seen with the drink...."
   → observation | essential | early | temporal | terms: victim, poisoned, time-delayed

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Recreate the dining conditions to compare the drink temperature at the time of the victim's death, r..."
   → observation | essential | mid | temporal | terms: recreate, dining, conditions

10. Generate one essential mid-story clue whose description or pointsTo explicitly names Hugh Hadley and states the unique trace, preparation detail, or mechanism link that points to Hugh Hadley rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Hugh Hadley, victim, poisoned, time-delayed

11. Generate a clue showing observable evidence of Hugh Hadley's premeditation or planning (Desire to maintain family legacy). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: desire, maintain, family

12. Generate a clue that explicitly eliminates suspect Brenda Marlow using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Brenda Marlow because ...").
   → elimination | essential | mid | testimonial | terms: Brenda Marlow

13. Generate a clue that explicitly eliminates suspect Trevor Cheyne using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Trevor Cheyne because ...").
   → elimination | essential | mid | testimonial | terms: Trevor Cheyne

14. Generate one essential early or mid elimination clue that explicitly rules out Brenda Marlow and narrows the solution toward culprit Hugh Hadley. The pointsTo text must start with "Eliminates Brenda Marlow because ..." and cite corroborated evidence.
   → elimination | essential | mid | testimonial | terms: Brenda Marlow, Hugh Hadley
...
- Hugh Hadley: sensitive items: financial records, guest statements
- Brenda Marlow: sensitive items: dinner arrangements, servant testimonies
- Mary Selby: sensitive items: staff schedules, cleaning logs
- Trevor Cheyne: sensitive items: gambling records, guest interactions
- Gertrude Walton: sensitive items: case files, investigation reports
...
Create 2 red herrings that support the false assumption: "The victim was poisoned immediately before they were found dead."
