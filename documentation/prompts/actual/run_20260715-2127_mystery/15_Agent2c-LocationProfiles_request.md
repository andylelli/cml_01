...
- Project ID: ``
- Timestamp: `2026-07-15T21:31:03.616Z`
...
- Era-authentic markers: radio broadcasting, early television sets, military radar equipment, rationed fuel, post-war automobile availability, bicycles, long-distance telephone calls, military encrypted messages
- Tone: Classic
- No anachronisms
...
Description: A grand seaside hotel built in the 1920s, featuring art deco architecture and expansive ocean views, frequented by tourists and local elites.
...
Setting constraints:
- Physical constraints: multiple floors with narrow staircases, restricted access to certain guest areas, oceanfront cliffs limiting expansion
- Geographic isolation: Moderate isolation; accessible by coastal road but limited public transport options due to wartime restrictions.
- Access control: staff-only areas such as kitchens and service elevators, guest access to lounges and dining areas during set hours, security measures for valuable items in guest rooms
...
- Social norms: women entering the workforce post-WWII, increased awareness of PTSD
