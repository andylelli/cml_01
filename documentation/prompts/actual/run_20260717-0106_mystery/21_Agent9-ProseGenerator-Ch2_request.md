...
- Project ID: ``
- Timestamp: `2026-07-17T01:13:01.705Z`
...
• [clue_core_contradiction_chain] witnesses, claim, captain, hale, near, victim, before, murder
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: hale, proximity, victim, raises, suspicion
...
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): mechanism, attack, involved, manipulating, mirror | angle, mirror, suggests, view, dining, area
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "He moved to the window, the salt breeze slipping through a crack, and watched the others in the glass’s warped reflection. In that uncertain image, he saw the beginnings of suspicion and the first threads of fear. The day would not yield its secrets easily. Bu..."
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=9166; context=12607; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 2:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "He moved to the window, the salt breeze slipping through a crack, and watched the others in the glass’s warped reflection. In that uncertain image, he saw the beginnings of suspicion and the first threads of fear. The da...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • witnesses, report, seeing, captain, hale, dining, area [clue_core_contradiction_chain] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: hale, proximity, victim, raises, suspicion
...
Chapter 2 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Witnesses claim they saw Captain Hale near the victim before the murder."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes conflicting accounts of the events leading up to the crime, particularly around Captain Hale's presence."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Captain Hale glances nervously at the others, his hands trembling slightly."
      ]
    },
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 2: the clue [clue_core_contradiction_chain] (witnesses, claim, captain, hale, near, victim, before, murder) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
