...
- Project ID: `unknown`
- Timestamp: `2026-05-26T17:55:35.044Z`
...
2. Generate a clue that provides evidence for: "The clock was tampered to show a false time...."
   → contradiction | essential | early | temporal | step 1 | terms: clock, tampered, false

3. Generate a clue that makes the reader directly observe: "Footprints in the dust lead away from the clock face...."
   → observation | essential | early | temporal | step 2 | terms: footprints, clock, face.

4. Generate a clue that provides evidence for: "Someone tampered with the clock shortly before the murder...."
   → contradiction | essential | early | temporal | step 2 | terms: someone, tampered, clock

5. Generate a clue that makes the reader directly observe: "Captain Hale's alibi is weak; he was in the garden during the timeframe...."
   → observation | essential | mid | temporal | step 3 | terms: captain, hale's, alibi

6. Generate a clue that provides evidence for: "His access to the clock was unaccounted for...."
   → contradiction | essential | mid | temporal | step 3 | terms: access, clock, unaccounted

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The clock was tampered to show a false time...."
...
9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "A comparison of the clock's timing with the household's dinner records proves Captain Hale's false t..."
...
13. Generate one essential early or mid elimination clue that explicitly rules out Beatrice Quill and narrows the solution toward culprit Captain Ivor Hale. The pointsTo text must start with "Eliminates Beatrice Quill because ..." and cite corroborated evidence.
...
Create 2 red herrings that support the false assumption: "Dr. Mallory Finch was murdered shortly after the clock struck eleven."
...
Violations: 1. [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 1, 2, 3; words: clock, shortly) and may support the true solution.; 2. [critical] Red Herring Separation: Red herring rh_2 overlaps inference corrections (steps: 1, 2, 3; words: clock) and may support the true solution.
Warnings: None
Recommendations: Red herrings must support the false assumption only; Do not reuse correction-language terms from inference_path.steps[].correction in red herring text; Preserve misdirection without reinforcing culprit-identifying logic; Forbidden terms for red-herring rewrite: shortly, clock; Prefer these temporal assumption terms instead: mallory, finch, murdered, struck, eleven, witnesses, recall, hearing, chime; Strict first-attempt contracts are active: apply strict source whitelist and required ID->source mappings exactly.; If any strict contract cannot be satisfied, return status=fail with unresolved blockers in audit.invalidSourcePaths.; Do not defer strict mapping and direct culprit evidence requirements to retry mode.
