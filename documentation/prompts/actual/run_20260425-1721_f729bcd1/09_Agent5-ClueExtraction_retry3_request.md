...
- Timestamp: `2026-04-25T17:23:19.181Z`
...
Violations: 1. [critical] Discriminating Test ID Contract: Missing clue id(s): clue_1, clue_2
Warnings: None
Recommendations: Every CASE.discriminating_test.evidence_clues ID must exist exactly in clues[].id: clue_1, clue_2; Set these required IDs to criticality=essential and placement=early|mid.; Preserve unaffected clue IDs and wording unless dependency requires change.; Keep sourceInCML paths legal and in-range.
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Discriminating Test ID Contract: Missing clue id(s): clue_1, clue_2
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
