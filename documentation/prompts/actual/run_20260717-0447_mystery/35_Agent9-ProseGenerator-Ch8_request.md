...
- Project ID: ``
- Timestamp: `2026-07-17T04:58:27.867Z`
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "He stepped back from the mirror, the cold stinging his cheeks, and looked once more at Beatrice and Captain Ivor Hale. The secrets revealed tonight had not solved the case, but they had changed it. Personal relationships, once hidden, now cast long shadows ove..."
...
Render this test MECHANISM as live, in-scene action and dialogue, composing ENTIRELY in your own words from these elements (reproducing any briefing phrase verbatim FAILS validation): discriminating, compares, witnes, timelin, statement, claimed, timeline
...
☐ **Evidence Integration**
  ...
  ☐ Explicitly reference or use clue: "clue_10" (clue) (appears in Act 1, Scene 3)
...
- Chapter 7 (score 96/100):
  Quality gaps noted: scene grounding weakness
  Address in upcoming chapters: Open next chapter with a named location anchor plus at least two sensory cues and one atmosphere marker.
- Phrases to avoid (already overused in earlier chapters): "the manager at ten minutes past eleven", "i was in the lounge until half", "was in the lounge until half past", "in the lounge until half past ten".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=21249; context=5029; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 8:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "He stepped back from the mirror, the cold stinging his cheeks, and looked once more at Beatrice and Captain Ivor Hale. The secrets revealed tonight had not solved the case, but they had changed it. Personal relationships...".
  ...
  - ⚠ DISCRIMINATING TEST (trap) — MANDATORY real-time scene with dialogue and confrontation. DO NOT summarize it after the fact.
    ...
    Elements the test must dramatize (compose the scene ENTIRELY in your own sentences from these — reproducing any briefing phrase verbatim FAILS validation): discriminating, compares, witnes, timelin, statement, claimed, timeline
    Cite these already-revealed clue IDs during the test: clue_mechanism_visibility_core, clue_10, clue_culprit_direct_1
...
Chapter 8 (Act 3) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The comparison of witness statements and timelines."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Captain Hale's timeline does not match the evidence, implicating him directly."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Hugo's hands tremble slightly as he gathers his notes."
      ]
    },
    ...
    "emotionalRegister": "The true nature of the crime is revealed, forcing characters to confront their pasts.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 8: the clue [clue_mechanism_visibility_core] (witness, statements, incorrectly, claim, hotel, manager, present, murder) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
