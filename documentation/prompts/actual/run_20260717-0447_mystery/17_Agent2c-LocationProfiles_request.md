...
- Project ID: ``
- Timestamp: `2026-07-17T04:51:36.755Z`
...
- Era-authentic markers: radio broadcasting, early television sets, military radar technology, rationed fuel for personal vehicles, increased use of public transport, post-war automobile boom, party-line telephones, long-distance calls
- Tone: Classic
- No anachronisms
...
Description: A seaside hotel with Art Deco architectural features, featuring ocean views and public areas designed for leisure and social gatherings.
Crime Scene: a seaside hotel
Weather: overcast with intermittent rain, typical of coastal weather patterns
Mood: tense and suspenseful, as guests are on edge due to recent events
...
Setting constraints:
- Physical constraints: narrow hallways limiting movement, restricted access to certain guest areas, secluded beach access requiring a key
- Geographic isolation: The hotel is located on a cliff overlooking the ocean, making outside assistance difficult during storms.
- Access control: staff-only areas for maintenance and service, guest room privacy policies, controlled access to rooftop terrace
...
- Social norms: women entering the workforce, post-war economic recovery
