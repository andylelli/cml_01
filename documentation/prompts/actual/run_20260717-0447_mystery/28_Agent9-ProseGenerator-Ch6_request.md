...
- Project ID: ``
- Timestamp: `2026-07-17T04:56:35.757Z`
...
• [clue_3] footprints, leading, away, scene, mismatch, size, suspect
  Category: physical | Criticality: essential | Supports inference step 2
  Points to: footprints, reliable

• [clue_5] captain, hale, initials, near, murder, scene
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: captain, hale, involved, murder
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_10, clue_hat_initials, clue_core_contradiction_chain, clue_manager_absence, clue_11, clue_culprit_direct_captain_ivor_hale, clue_7, clue_4, clue_culprit_direct_1, clue_8, clue_9, clue_footprints — do not reveal these as new information.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "He looked from Dr. Mallory Finch to Sylvia Trent, then to Beatrice Quill. Each bore the marks of the day’s pressure—fear, relief, resentment, and the lingering ache of loss. The murder of Eleanor Voss had not only fractured their certainties, but also forced t..."
...
Known location profile anchors: The Seaside Elegance Hotel, The Rooftop Terrace, Lobby Lounge, The Grand Dining Room, Secluded Beach Access, the hotel library
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Seaside Elegance Hotel", "The Rooftop Terrace", "Lobby Lounge", "The Grand Dining Room", "Secluded Beach Access", "the hotel library"
...
- Chapter 5 (score 96/100):
  Quality gaps noted: scene grounding weakness
  Address in upcoming chapters: Open next chapter with a named location anchor plus at least two sensory cues and one atmosphere marker.
- Phrases to avoid (already overused in earlier chapters): "i was in the lounge until half", "was in the lounge until half past", "in the lounge until half past ten", "the manager at ten minutes past eleven".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=17731; context=5920; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_footprints must appear in Act 2, Scene 3 via Witness account
...
- Chapter 6:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "He looked from Dr. Mallory Finch to Sylvia Trent, then to Beatrice Quill. Each bore the marks of the day’s pressure—fear, relief, resentment, and the lingering ache of loss. The murder of Eleanor Voss had not only fractu...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • angle, mirror, shows, reflections [clue_12]
      Points to: mechanism, murder, involves, impersonation
    • scene, initials [clue_5]
      Points to: captain, hale, involved, murder
    • linking, hale, scene [clue_6]
      Points to: hale, involvement, murder, likely
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "A discrepancy in the timeline that makes Hugo question his conclusion."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the case is not as straightforward as it seems, leading Hugo to doubt his initial suspicions."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Hugo stares at the fireplace, lost in thought, as Eleanor fidgets nervously."
      ]
    },
    ...
    "emotionalRegister": "The mounting pressure leads to confrontations that unveil hidden truths.",
