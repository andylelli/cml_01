...
- Project ID: ``
- Timestamp: `2026-07-17T04:54:21.412Z`
...
• [clue_core_contradiction_chain] manager, left, nine, forty, five, creating, window, murder
  Category: spatial | Criticality: essential | Supports inference step 1
  Points to: manager, present, murder

• [clue_manager_absence] witnesses, hotel, manager, present, minutes, past, eleven
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_10, clue_hat_initials — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): timeline, events, questionable | timeline, provided, witnesses, unreliable | manager, present, murder
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "He turned back to Eleanor’s body, the pocket watch still resting in her lifeless hand. The contradiction between the timepieces, the manager’s unexplained absence, and the tangle of unreliable witness accounts formed the opening moves of a game Hugo had no cho..."
...
Known location profile anchors: The Seaside Elegance Hotel, The Rooftop Terrace, Lobby Lounge, The Grand Dining Room, Secluded Beach Access, the hotel lobby
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Seaside Elegance Hotel", "The Rooftop Terrace", "Lobby Lounge", "The Grand Dining Room", "Secluded Beach Access", "the hotel lobby"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=9723; context=11701; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 2:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "He turned back to Eleanor’s body, the pocket watch still resting in her lifeless hand. The contradiction between the timepieces, the manager’s unexplained absence, and the tangle of unreliable witness accounts formed the...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • hotel, records, showing, manager, departure, time [clue_core_contradiction_chain] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: manager, present, murder
  ...
  - Sensory obligation — use at least two of: shadows stretching across the floor, guests sipping tea in clusters | murmurs of conversation, clinking of china | scent of fresh pastries. Mood: sombre reflection.
...
Chapter 2 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The conflicting statements about the hotel manager's whereabouts."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the hotel manager's timeline contradicts the witnesses' statements, creating a window for the murder."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor glances nervously at Ivor, her hands wringing together."
      ]
    },
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 2: the clue [clue_core_contradiction_chain] (manager, left, nine, forty, five, creating, window, murder) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 2: the clue [clue_manager_absence] (witnesses, hotel, manager, present, minutes, past, eleven) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
