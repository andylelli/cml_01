...
- Project ID: ``
- Timestamp: `2026-07-20T19:48:05.902Z`
...
```text
{
  ...
  "audit": {
    ...
    "required_clues_present": "Dr. Mallory Finch cleared (paragraph 3); Beatrice Quill cleared (paragraph 4); Sylvia Trent cleared (paragraph 5); Captain Ivor Hale named as murderer (paragraph 6), evidence chain stated (paragraph 6)",
