...
- Project ID: ``
- Timestamp: `2026-07-20T19:47:25.077Z`
...
• [clue_9] time, death, estimated, around, minutes, past, eleven
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: timeline, events
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_early_1, clue_fp_contradiction_step_1, clue_core_contradiction_chain, clue_mid_1, clue_1, clue_4, clue_8, clue_2, clue_3, clue_5, clue_core_elimination_chain, clue_10, clue_culprit_direct_captain_ivor_hale, clue_late_1, clue_7, clue_fp_contradiction_step_3, clue_culprit_direct_1, clue_6, clue_9 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): murder, staged, look, like, accident | murder, staged, look, like, accident | indicates, someone, taken, shore, return | indicates, possible, tampering, create, confusion, around | indicates, possible, tampering, create, confusion, around | indicates, someone, taken, shore, return | indicates, manner, death, drowning | indicates, lack, witnesses, crime | aligns, timing, murder | indicates, potential, motive, captain, ivor, hale | indicates, premeditation, murder | eleanor, voss, alibi | mallory, finch, alibi | direct, shows, captain, ivor, hale, means | eleanor, voss, alibi | suggests, professional, rivalry | timing, tide, coincided, murder | physical, trace, opportunity, indicate, captain, ivor | suggests, captain, ivor, hale, potential, guilt | timeline, events
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Yet beneath the surface, motives and contradictions multiplied: Hale’s jealousy, Mallory’s loyalty conflict, Beatrice’s insecurity, Sylvia’s rivalry. The investigation was no longer a simple search for facts but a battle against deception and misdirection. Ele..."
...
This is a **timeline reconstruction** test. The detective must:

**Test mechanism (paraphrase — do NOT copy verbatim):**
Render this test MECHANISM as live, in-scene action and dialogue, composing ENTIRELY in your own words from these elements (reproducing any briefing phrase verbatim FAILS validation): reconstruct, timeline, events, using, tide, charts, clock, discrepancies, demonstrate, murder, timed, occur
...
Known location profile anchors: The Mariner's Rest, The Oceanfront Suite, The Grand Lobby, The Ocean View Dining Room, Staff Quarters, the hotel ballroom
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Mariner's Rest", "The Oceanfront Suite", "The Grand Lobby", "The Ocean View Dining Room", "Staff Quarters", "the hotel ballroom"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=20884; context=5229; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 9:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Yet beneath the surface, motives and contradictions multiplied: Hale’s jealousy, Mallory’s loyalty conflict, Beatrice’s insecurity, Sylvia’s rivalry. The investigation was no longer a simple search for facts but a battle...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • high, tide, eleven, evening, remains, late, texture, detail, case, background [clue_late_optional_slot_1]
      Points to: adds, late, texture, changing, essential, deduction, chain
    • coroner, report, notes, time, death [clue_9]
      Points to: timeline, events
  ...
  - ⚠ DISCRIMINATING TEST (trap) — MANDATORY real-time scene with dialogue and confrontation. DO NOT summarize it after the fact.
    ...
    Elements the test must dramatize (compose the scene ENTIRELY in your own sentences from these — reproducing any briefing phrase verbatim FAILS validation): reconstruct, timeline, events, using, tide, charts, clock, discrepancies, demonstrate, murder, timed, occur
    Cite these already-revealed clue IDs during the test: clue_9, clue_2, clue_4
...
Chapter 9 (Act 3) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The timeline reconstruction showing the manipulation of events."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the method of murder and implicates the true culprit."
...
[
  {
    ...
    "setting": {
      ...
      "atmosphere": "Charged with anticipation as the detective prepares to confront the suspects"
    },
    "characters": [
      "Eleanor Voss",
      "Captain Ivor Hale",
    ...
    "purpose": "Conduct the discriminating test and reveal the truth",
    "cluesRevealed": [
    ...
    "dramaticElements": {
      ...
      "tension": "All suspects are present, and the stakes are high.",
      "microMomentBeats": [
        "Eleanor's heart races as she prepares to reveal the truth."
      ]
    },
    "summary": "In the grand ballroom, Eleanor Voss gathers all the suspects to present her findings. She reconstructs the timeline, using the tide charts and the discrepancies in the clock times to demonstrate how the murder was timed to occur during high tide. With each revelation, the atmosphere thickens as the suspects react to the mounting evidence against them.",
    "beat": "final_trap",
    "estimatedWordCount": 1800,
    "pivotElement": "The timeline reconstruction showing the manipulation of events.",
    "factEstablished": "Establishes the method of murder and implicates the true culprit.",
    ...
    "emotionalRegister": "The truth about the murderer's identity is finally unveiled, leading to a dramatic resolution.",
