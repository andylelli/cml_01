...
- Project ID: ``
- Timestamp: `2026-07-20T19:43:04.377Z`
...
The discovery of footprints shifts the investigation towards a more sinister possibility.
...
Rationale: Tension scenes need to maintain a serious atmosphere to convey urgency.
...
• [clue_2] tide, charts, indicate, high, minutes, past, eleven
  Category: temporal | Criticality: essential | Supports inference step 2
  Points to: aligns, timing, murder

• [clue_3] captain, ivor, hale, seen, arguing, hugo, vane, shortly, before, death
  Category: behavioral | Criticality: essential | Supports inference step 2
  Points to: indicates, potential, motive, captain, ivor, hale

• [clue_5] murderer, watch, shows, five, minutes, past, eleven
  Category: temporal | Criticality: essential | Supports inference step 2
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_early_1, clue_fp_contradiction_step_1, clue_core_contradiction_chain, clue_mid_1, clue_1, clue_4, clue_8 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): murder, staged, look, like, accident | murder, staged, look, like, accident | indicates, someone, taken, shore, return | indicates, possible, tampering, create, confusion, around | indicates, possible, tampering, create, confusion, around | indicates, someone, taken, shore, return | indicates, manner, death, drowning | indicates, lack, witnesses, crime
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the afternoon waned and the tide receded, Eleanor lingered by the water’s edge. The investigation had begun in earnest, and the clues refused to fit the narrative of accident. She watched the waves whisper against the sand, the autumnal chill pressing in, a..."
...
Known location profile anchors: The Mariner's Rest, The Oceanfront Suite, The Grand Lobby, The Ocean View Dining Room, Staff Quarters, the hotel dining room
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Mariner's Rest", "The Oceanfront Suite", "The Grand Lobby", "The Ocean View Dining Room", "Staff Quarters", "the hotel dining room"
...
- Phrases to avoid (already overused in earlier chapters): "you know the human body is a", "know the human body is a fascinating", "the human body is a fascinating thing", "human body is a fascinating thing isn", "body is a fascinating thing isn t".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=12945; context=10613; dropped=[humour_guide, location_profiles, texture_pool, continuity_context]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 4:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the afternoon waned and the tide receded, Eleanor lingered by the water’s edge. The investigation had begun in earnest, and the clues refused to fit the narrative of accident. She watched the waves whisper against the...".
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Captain Hale's jealousy over Hugo's success."
  ...
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_2] Dr. Finch mentions seeing a figure near the water — creates doubt about the identity of the person.
...
[
  {
    ...
    "setting": {
      ...
      "atmosphere": "Intense, as tensions rise during the questioning"
    },
    "characters": [
      "Eleanor Voss",
      "Captain Ivor Hale",
    ...
    "purpose": "Interview suspects and reveal motives",
    "cluesRevealed": [
      "clue_2",
      "clue_3",
      "clue_5"
    ...
    "dramaticElements": {
      "conflict": "Suspects become defensive during questioning.",
      "tension": "Each suspect's story starts to unravel.",
      "microMomentBeats": [
        "Eleanor watches Dr. Finch fidget as she speaks."
      ]
    },
    "summary": "Eleanor Voss interviews the suspects in the hotel dining room, where tensions run high. Captain Hale's jealousy over Hugo's success surfaces during the questioning, while Dr. Finch's evasive answers raise suspicions. The detective notes that Hale's watch shows five minutes past eleven, adding to the timeline confusion.",
    "beat": "motives",
    "estimatedWordCount": 1800,
    "pivotElement": "Captain Hale's jealousy over Hugo's success.",
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_2",
      "placementDetail": "Dr. Finch mentions seeing a figure near the water — creates doubt about the identity of the person."
    },
    "emotionalRegister": "The discovery of footprints shifts the investigation towards a more sinister possibility.",
