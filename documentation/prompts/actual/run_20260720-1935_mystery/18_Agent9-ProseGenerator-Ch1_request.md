...
- Project ID: ``
- Timestamp: `2026-07-20T19:40:54.546Z`
...
- Eleanor Voss
  ...
  Connection to victim: Skeptical of Eleanor's amateur sleuthing.; They often clash over their views on social justice and crime..
...
- Captain Ivor Hale
  ...
  Investigation relevance: access plausibility: high | alibi window: 11:00 PM - 11:30 PM | opportunity channel: Military access to restricted areas.
  Suspicion/pressure cue seed: Too eager to dismiss questions about Hugo.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Dr. Mallory Finch
  Public identity anchor: Physician; suspect 
  Connection to victim: Former mentor to Hugo Vane.
  Investigation relevance: access plausibility: medium | alibi window: 11:00 PM - 11:30 PM | opportunity channel: Access to medical records.
  Suspicion/pressure cue seed: Nervous when discussing Hugo.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Beatrice Quill
  Public identity anchor: Art Student; suspect 
  Connection to victim: directly affected by Hugo Vane's death and its fallout.
  Investigation relevance: access plausibility: medium | alibi window: 11:00 PM - 11:30 PM | opportunity channel: Social events in the hotel.
...
• [clue_mechanism_visibility_core] hugo, vane, deliberately, drowned, high, tide, create, appearance, accident
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: murder, staged, look, like, accident

• [clue_early_1] hugo, vane, deliberately, drowned, high, tide, create, appearance, accident
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: murder, staged, look, like, accident

• [clue_fp_contradiction_step_1] footprints, leading, water, edge, none, returning
  Category: temporal | Criticality: essential | Supports inference step 1
...
Known location profile anchors: The Mariner's Rest, The Oceanfront Suite, The Grand Lobby, The Ocean View Dining Room, Staff Quarters, the beach behind the coastal hotel
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Mariner's Rest", "The Oceanfront Suite", "The Grand Lobby", "The Ocean View Dining Room", "Staff Quarters", "the beach behind the coastal hotel"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the beach behind the coastal hotel". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=8131; context=12737; dropped=[none]; truncated=[first_appearance_contracts, location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - Scene is set in: the beach behind the coastal hotel — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • tide, visibly, high, shore [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The footprints leading to the water's edge but none returning."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that someone was taken to the shore and did not return."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_1] Captain Ivor Hale mentions that the tide was high, suggesting an accident — seeds false inference about Hugo's death being purely accidental.
...
[
  {
    ...
    "title": "Discovery",
    "setting": {
      "location": "the beach behind the coastal hotel",
    ...
    "dramaticElements": {
      "conflict": "The discovery of a body complicates relationships among the guests.",
      "tension": "The guests are anxious as they await news of the victim.",
      "microMomentBeats": [
        "Eleanor stares at the waves, remembering the last time she saw Hugo alive."
      ]
    },
    "summary": "As dawn breaks over the coastal hotel, a group of guests discovers Hugo Vane's lifeless body washed ashore. Shock and confusion ripple through the crowd as they realize the implications of this tragedy. With the arrival of Detective Eleanor Voss, tensions mount among the guests, each harboring their own secrets.",
    "beat": "gathering",
    "estimatedWordCount": 1800,
    "pivotElement": "The footprints leading to the water's edge but none returning.",
    "factEstablished": "Establishes that someone was taken to the shore and did not return.",
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_1",
      "placementDetail": "Captain Ivor Hale mentions that the tide was high, suggesting an accident — seeds false inference about Hugo's death being purely accidental."
    },
    "emotionalRegister": "The initial discovery of Hugo's body evokes shock and fear among the guests.",
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (hugo, vane, deliberately, drowned, high, tide, create, appearance, accident) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_early_1] (hugo, vane, deliberately, drowned, high, tide, create, appearance, accident) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_fp_contradiction_step_1] (footprints, leading, water, edge, none, returning) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
