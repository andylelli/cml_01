...
- Project ID: ``
- Timestamp: `2026-07-20T19:23:53.860Z`
...
- Eleanor Voss
  Public identity anchor: Local Innkeeper; detective 
  Connection to victim: Business acquaintances with underlying tension.; Hugo's business dealings have threatened Eleanor's inn's financial stability..
  Investigation relevance: is actively driving interviews and credibility checks in this scene.
  Suspicion/pressure cue seed: personal commitment to solving the case..
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Dr. Mallory Finch
  Public identity anchor: Physician; suspect 
  Connection to victim: Financial investor and dependent.; Hugo funded Mallory's medical practice, but the relationship is strained over expectations..
  Investigation relevance: access plausibility: medium | alibi window: 8 PM to 9 PM.
  Suspicion/pressure cue seed: reputation in the community..
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.
...
• [clue_mechanism_visibility_core] murderer, impersonated, hotel, staff, create, false, alibi, committing, crime
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: murderer, wore, staff, costume, commit, crime

• [clue_mid_1] murderer, impersonated, hotel, staff, create, false, alibi, committing, crime
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: murderer, wore, staff, costume, commit, crime
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=7714; context=10170; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • hotel, staff, schedule, shows, missing, employee, time, murder [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The two clocks in the lobby showing different times."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor glances nervously at the front door, anticipating the detective's arrival."
      ]
    },
    ...
    "emotionalRegister": "The atmosphere is heavy with anticipation and underlying tension.",
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (murderer, impersonated, hotel, staff, create, false, alibi, committing, crime) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_mid_1] (murderer, impersonated, hotel, staff, create, false, alibi, committing, crime) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
  ...
  "chapters": [
    {
      ...
      "paragraphs": [
        ...
        "Mallory rose, smoothing the skirt of her dress, her eyes scanning the room for signs of struggle. The overturned chair, the scattered papers, and the faint impression of a shoe print near the window suggested more than a simple accident. ‘It’s odd,’ Mallory said, her tone clipped, ‘I saw Hugo last evening, just before the rain began. He seemed agitated, but nothing out of the ordinary. Yet now—’ She paused, her gaze drifting to the schedule Eleanor held. ‘Wasn’t there a staff member due on duty during the murder window?’ Eleanor nodded, her fingers tracing the missing name. The two women exchanged a glance, the implication settling between them: someone had been absent when they should have been present.",
