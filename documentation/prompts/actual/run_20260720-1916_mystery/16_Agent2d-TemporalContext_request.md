...
- Project ID: ``
- Timestamp: `2026-07-20T19:21:10.728Z`
...
- YOU MUST use the exact year and month specified above: November 1940
- This date has been specifically selected for THIS mystery to ensure uniqueness
- DO NOT change the year or month - use November 1940 exactly
- The season is FIXED as "fall" (it follows from November) — use it exactly; do not pick a different season
...
- All details must be historically accurate for November 1940 specifically
- Generate fresh, original descriptions - do not copy example phrasing
- Make this feel like the specific moment of November 1940
- OPTIONAL FIELD DEPTH REQUIREMENT: `fashion` and `seasonalActivities` must be specific and non-generic.
  ...
  - Include at least 3 seasonal activities tied to November and this location.
...
- Technology available: radio broadcasting in common areas, early television sets in private rooms, basic radar systems for maritime navigation
- Forensics: blood typing for crime scene analysis, ballistics testing available but rudimentary, limited trace evidence analysis
- Social norms: women increasingly in the workforce due to WWII, post-war trauma affecting social interactions, growing tensions of the early Cold War influencing public sentiment

Task:
1. Use the specified date: November 1940
2. Provide seasonal context for November (weather, holidays, activities appropriate for this specific month)
