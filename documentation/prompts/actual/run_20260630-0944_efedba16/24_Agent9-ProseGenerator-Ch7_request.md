...
- Timestamp: `2026-06-30T09:58:33.708Z`
...
• [clue_core_contradiction_chain] contrary, assumption, high, temperature, causes, minute, sundial, delay, demonstration, shows, minutes, similar
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: refutation, assumed, sundial, shadow, delay, duration

• [clue_18] eliminates, agnes, wilkes, because, stable, yard, footprints, testimony, confirm, elsewhere, murder, timeframe
  Category: testimonial | Criticality: undefined
  Points to: exclusion, agnes, wilkes, based
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Yet as the lamplight flickered and the wind clawed at the glass, Evelyn saw the cost of the day’s revelations etched on James’s face—fear, resentment, and the dawning sense that his web of invention might not hold. The net was tightening, but the final knot ha..."
...
- Chapter 7: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "Harcourt Manor Drawing Room". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=19517; context=4385; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
Suspect pressure target(s): Beatrice Langley, Edward Mallory, Agnes Wilkes
...
- Chapter 7:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Yet as the lamplight flickered and the wind clawed at the glass, Evelyn saw the cost of the day’s revelations etched on James’s face—fear, resentment, and the dawning sense that his web of invention might not hold. The n...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • demonstration, measuring, sundial, shadow, delay, comparable, temperature, conditions, reveals, shorter, minutes [clue_core_contradiction_chain]
      Points to: refutation, assumed, sundial, shadow, delay, duration
    • footprint, patterns, agnes, wilkes, statements, place, away, stable, yard, relevant, times [clue_18]
      Points to: exclusion, agnes, wilkes, based
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Beatrice’s hands tremble slightly as she insists on her innocence"
      ]
    },
