...
- Timestamp: `2026-06-30T09:56:33.661Z`
...
The sundial’s thermal expansion effect is uncovered, shifting the timeline and opening new investigative pathways.
...
Permission: conditional — condition: Only Beatrice’s polite savagery allowed; others must remain serious due to rising stakes.
Characters who may be funny: Beatrice Langley
Permitted forms: polite_savagery
Rationale: Tension demands seriousness, but Beatrice’s social sarcasm can add texture without undermining the scene.
...
• [clue_5] servants, report, hearing, victim, footsteps, stable, yard, twice, once, quarter, past, nearly
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: servants, testimony, victim, footsteps

• [clue_6] wind, direction, stable, door, acoustics, caused, echoes, sound, refraction, creating, auditory, illusions
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: auditory, illusions, invalidating, servants, footsteps, timing

• [clue_culprit_direct_james_harcourt] direct, ties, james, harcourt, mechanism, access, point, before, discriminating, excludes, competing, suspect
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: direct, shows, james, harcourt, means, opportunity, narrowing, solution, uniquely, toward, culprit, eligible
...
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): high, garden, temperature, near, sundial | thermal, expansion, mechanism, sundial, gnomon | ledger, discrepancies, indicating, forgery | invalidation, ledger, timeline, forgery | core, sundial, thermal, expansion, mechanism
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "In the hush of the corridor, she could hear the faint strains of a radio playing somewhere in the servants’ quarters—a reminder that life, for all its upheaval, continued. Yet beneath the surface, the autumn chill lingered, and with it the certainty that the r..."
...
garden, study, manor, estate, kitchen, corridor
...
Chapter 3: Chapter 3: Ledger and Shadow
  Events: The pages yielded their secrets grudgingly.
...
Known location profile anchors: Harcourt Manor Estate, The Library at Harcourt Manor, Servants’ Quarters, Formal Gardens and Sundial, Stable Yard and Coach House, Harcourt Manor Stable Yard
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Harcourt Manor Estate", "The Library at Harcourt Manor", "Servants’ Quarters", "Formal Gardens and Sundial", "Stable Yard and Coach House", "Harcourt Manor Stable Yard"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 4: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a noun-phrase atmosphere — e.g. "The smell of damp stone in the cellar…" / "A chill from the landing…" / "The sound of the clock in the hall…". Pattern: "The/A [noun] of/in/from [place]…". Anchor opening in "Harcourt Manor Stable Yard". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=13605; context=10055; dropped=[humour_guide, location_profiles]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
Suspect pressure target(s): Agnes Wilkes, Beatrice Langley
...
- Chapter 4:
  ...
  - Scene is set in: Harcourt Manor Stable Yard — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "In the hush of the corridor, she could hear the faint strains of a radio playing somewhere in the servants’ quarters—a reminder that life, for all its upheaval, continued. Yet beneath the surface, the autumn chill linger...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • demonstration, measuring, sundial, shadow, delay, comparable, temperature, conditions, reveals, shorter, minutes [clue_core_contradiction_chain]
      Points to: refutation, assumed, sundial, shadow, delay, duration
...
[
  {
    ...
    "cluesRevealed": [
      "clue_5",
      "clue_6",
      "clue_culprit_direct_james_harcourt"
    ],
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Agnes glances nervously towards the stable door, recalling the confusing sounds"
      ]
    },
    ...
    "emotionalRegister": "The sundial’s thermal expansion effect is uncovered, shifting the timeline and opening new investigative pathways.",
...
```text
{
  ...
  "chapters": [
    {
      ...
      "summary": "Evelyn investigates the stable yard, probing the servants’ contradictory accounts of hearing Lord Charles’s footsteps. She uncovers that wind and door acoustics caused echo illusions, complicating the timeline and narrowing suspicion. Agnes Wilkes is pressed about her movements, and Beatrice Langley’s presence in the kitchen is noted, shifting the pressure among the suspects.",
      "paragraphs": [
  ...
  "audit": {
    ...
    "season_words_used": "autumn, autumnal, fall, fog, mist, morning, rain, cold, chill, haze, bright, damp, wind, sunlight | present",
    "discriminating_test_present": "no",
    "required_clues_present": "clue_5: paragraph 4; clue_6: paragraph 5; clue_culprit_direct_james_harcourt: paragraph 5 (surface anomaly only, not mechanism)",
    "early_observation_present": "sound of footsteps, echo, wind, stable door: paragraph 2",
