...
- Timestamp: `2026-06-30T09:54:00.129Z`
...
**Era & Setting**: 1930s - Harcourt Manor Estate
**Setting Lock**: All scenes must remain within this setting: Harcourt Manor Estate. Do not move to a different location type.
**Primary Axis**: temporal
**Crime**: poisoning with delayed effect
**Victim**: Unknown
**Culprit**: James Harcourt
**Motive**: Unknown motive
**Method**: poisoning with delayed effect

## The False Assumption
Lord Charles Harcourt died exactly at solar noon, as indicated by the sundial’s shadow.
*Revealed: final act*

---

## Cast of Characters
- **Detective**: Evelyn Harcourt
- **Suspect**: Beatrice Langley
- **Suspect**: Agnes Wilkes
- **Suspect**: Edward Mallory
- **Witness**: Lord Charles Harcourt
- **Witness**: James Harcourt
...
### Early Clues (Act I)
- [clue_1] testimonial: Garden thermometer next to the sundial shows temperature well above seventy-five degrees Fahrenheit during the time of the murder.
- [clue_2] temporal: The brass gnomon of the sundial expands due to midday heat, delaying the sundial’s shadow alignment by approximately ten minutes.
- [clue_3] temporal: Ledger book shows a seven shilling mismatch in total sums, and ink shades differ on entries supposed to be written contemporaneously.
- [clue_4] temporal: Evidence shows the ledger entries were forged or altered, invalidating the timeline of the victim’s presence and complicity.
- [clue_mechanism_visibility_core] temporal: The brass gnomon of the sundial expands due to midday heat, delaying the sundial’s shadow alignment by approximately ten minutes. This physical property is observable before the discriminating test.

### Mid Clues (Act II)
- [clue_core_contradiction_chain] temporal: Contrary to the assumption that high temperature causes a ten-minute sundial delay, a controlled demonstration shows the delay is only about two minutes under similar conditions.
- [clue_5] testimonial: Servants report hearing the victim’s footsteps in the stable yard twice: once at quarter past ten and again nearly eleven.
- [clue_6] temporal: Wind direction and stable door acoustics caused echoes and sound refraction, creating auditory illusions that misled servants about the timing of footsteps.
- [clue_7] physical: Ice tray found with hollowed ice cubes, and servants testify the victim’s demeanor was unchanged immediately after consuming the drink.
- [clue_8] temporal: The poison was concealed in hollow ice cubes releasing toxin slowly, causing a delayed poisoning effect inconsistent with immediate symptoms.
- [clue_9] testimonial: James Harcourt was seen near the sundial and ice tray during the critical time window and had motive related to family financial disputes.
- [clue_10] testimonial: Only James had the motive, means, and opportunity to manipulate both the physical timing illusion and the poison delivery mechanism.
- [clue_13] temporal: A controlled demonstration measures the sundial’s shadow delay under similar temperature conditions, confirming a measurable but shorter delay than initially assumed.
- [clue_14] temporal: James Harcourt is uniquely linked to the brass gnomon and sundial mechanism through his knowledge and access, distinguishing him from other suspects.
- [clue_15] elimination: James Harcourt uniquely had the means, skill, and access to execute the sundial and poison concealment mechanism; other suspects lacked this capability.
- [clue_16] behavioral: James Harcourt’s financial desperation and resentment toward his father are evident from his personal letters and financial ledgers.
- [clue_17] testimonial: Eliminates Beatrice Langley because her alibi is corroborated by multiple servants who saw her in the kitchen during the murder timeframe.
- [clue_fp_elimination_edward_mallory] testimonial: Late morning until just after noon
- [clue_culprit_direct_james_harcourt] temporal: Direct evidence ties James Harcourt to the mechanism access point before the discriminating test and excludes competing suspect timelines.

### Late Clues (Act III)
- [clue_late_optional_slot_1] temporal: Sundial shadow at solar noon remains a late texture detail in the case background.
...
- **Beatrice Langley**: Act 3, Scene 5
  - Method: Multiple servant alibis and timing contradictions disprove opportunity
  - Clues: Servants’ consistent testimony on Beatrice’s whereabouts, Timing of ledger forgery excludes her access
- **Agnes Wilkes**: Act 3, Scene 5
  - Method: Acoustic explanation of footsteps clears suspicion of secret movement
  - Clues: Weather vane and footprint pattern data, Agnes’s observed duties and presence
- **Edward Mallory**: Act 3, Scene 5
  - Method: Unaware of forged ledger entries and no motive for poisoning
  - Clues: Ledger ink shade and checksum errors link to forgery, Edward’s known record-keeping habits
- **Lord Charles Harcourt**: Act 3, Scene 5
  - Method: Alibi confirmed: N/A

### Culprit Revelation Scene (REQUIRED)
- **Must appear in:** Act 3, Scene 6
- **Revelation method:** Confrontation with sundial physical test, ledger forgery proof, and ice tray evidence
