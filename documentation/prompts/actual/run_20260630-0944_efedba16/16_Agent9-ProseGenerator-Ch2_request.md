...
- Timestamp: `2026-06-30T09:55:20.275Z`
...
• [clue_2] brass, gnomon, sundial, expands, midday, heat, delaying, shadow, alignment, approximately, minutes
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: thermal, expansion, mechanism, sundial, gnomon
...
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): high, garden, temperature, near, sundial
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Evelyn straightened, her resolve hardening. She would begin with the facts: the thermometer’s reading, the sundial’s shadow, the testimony of those gathered. The truth, she knew, would not be found in the obvious. It would be coaxed from the silences, the cont..."
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=9733; context=10696; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 2:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Evelyn straightened, her resolve hardening. She would begin with the facts: the thermometer’s reading, the sundial’s shadow, the testimony of those gathered. The truth, she knew, would not be found in the obvious. It wou...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • close, inspection, reveals, brass, gnomon, sundial, faint, expansion, consistent, heat, induced [clue_2] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: thermal, expansion, mechanism, sundial, gnomon
...
[
  {
    ...
    "summary": "the detective examines the sundial and notes the brass gnomon’s thermal expansion causing a delay in the shadow’s alignment. James Harcourt watches closely, uneasy as the detective questions the reliability of the sundial’s indication of the time of death.",
    "beat": "crime",
    ...
    "humourGuidance": {
      ...
      "form": "understatement",
      "condition": "Evelyn’s dry wit may surface subtly to underscore contradictions without diminishing seriousness."
    },
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 2: the clue [clue_2] (brass, gnomon, sundial, expands, midday, heat, delaying, shadow, alignment, approximately, minutes) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
