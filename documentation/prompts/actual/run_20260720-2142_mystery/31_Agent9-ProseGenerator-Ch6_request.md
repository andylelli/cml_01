...
- Project ID: ``
- Timestamp: `2026-07-20T21:53:30.711Z`
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the evening waned and the lamplight flickered, Eleanor lingered at the bar, her thoughts circling the pivotal clues. The footprints—twelve inches, not Hugo’s—narrowed the pool. Multiple witnesses confirmed Captain Hale’s presence, further eliminating him fr..."
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=16735; context=6039; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 6:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the evening waned and the lamplight flickered, Eleanor lingered at the bar, her thoughts circling the pivotal clues. The footprints—twelve inches, not Hugo’s—narrowed the pool. Multiple witnesses confirmed Captain Hal...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • eleanor, seen, discussing, hotel, management [clue_7]
      Points to: indicates, involvement, uncovering, truth
    • witnesses, recall, seeing, mallory, finch, vicinity [clue_8]
    ...
    • witnesses, noted, mallory, finch, discomfort, victim, mentioned [clue_9]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • witnesses, report, seeing, figure, resembling, victim [clue_culprit_direct_1]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • eleanor, seen, discussing, hotel, management [clue_culprit_direct_dr_mallory_finch]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The group settles on Dr. Finch as the prime suspect."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the group is misled by their assumptions, and Eleanor realizes the case isn't solved."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor's heart races as she realizes the group is close to a wrong conclusion."
      ]
    },
    ...
    "emotionalRegister": "Suspicions are cast anew, leading to an intense emotional confrontation.",
