...
- Project ID: ``
- Timestamp: `2026-07-20T21:55:58.263Z`
...
• [clue_late_optional_slot_1] time, masquerade, ball, start, seven, clock, evening, remains, late, texture, detail, case
...
• [clue_7] eleanor, voss, sets, situation, hotel, management, compare, disguise, used, victim, costume
  Category: temporal | Criticality: essential | Supports inference step 2
  Points to: indicates, involvement, uncovering, truth
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Through the haze of anticipation, Eleanor’s understanding solidified. She had established a clear series of events—every movement, every contradiction, every pressure point mapped against the timeline. The path ahead was fraught with uncertainty, but she was r..."
...
Render this test MECHANISM as live, in-scene action and dialogue, composing ENTIRELY in your own words from these elements (reproducing any briefing phrase verbatim FAILS validation): eleanor, voss, sets, situation, hotel, management, compare, disguise, used, known, facts, victim
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=22943; context=5128; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 9:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Through the haze of anticipation, Eleanor’s understanding solidified. She had established a clear series of events—every movement, every contradiction, every pressure point mapped against the timeline. The path ahead was...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • time, masquerade, ball, start, seven, clock, evening, remains, late, texture, detail, case [clue_late_optional_slot_1]
      Points to: adds, late, texture, changing, essential, deduction, chain
    • eleanor, seen, discussing, hotel, management [clue_7]
      Points to: indicates, involvement, uncovering, truth
  - ⚠ SUSPECT CLEARANCE REQUIRED (MANDATORY): each suspect below MUST be named explicitly and cleared with on-page evidence and a reasoning connector (because / therefore / which proves):
    • "Beatrice Quill": write a dedicated paragraph that (a) names Beatrice Quill explicitly, (b) states the clearance method ("Confirmed she was assisting the victim before the incident"), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
    ...
    • "Sylvia Trent": write a dedicated paragraph that (a) names Sylvia Trent explicitly, (b) states the clearance method ("Alibi confirmed: 7:00 PM - 8:30 PM"), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
  ...
  - ⚠ DISCRIMINATING TEST (trap) — MANDATORY real-time scene with dialogue and confrontation. DO NOT summarize it after the fact.
    ...
    Elements the test must dramatize (compose the scene ENTIRELY in your own sentences from these — reproducing any briefing phrase verbatim FAILS validation): eleanor, voss, sets, situation, hotel, management, compare, disguise, used, known, facts, victim
    Cite these already-revealed clue IDs during the test: clue_7, clue_mechanism_visibility_core, clue_4, clue_early_1
    ...
    Motive statement REQUIRED: the culprit must explicitly state or acknowledge their motive during or immediately after the confrontation. Canonical motive: "Jealousy over past relationship". Do not omit it.
...
Chapter 9 (Act 3) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Eleanor compares the disguise used by the murderer against the victim's costume."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Dr. Mallory Finch's disguise does not match the victim's, revealing her as the murderer."
...
[
  {
    ...
    "emotionalRegister": "Confrontation reveals the truth, forcing characters to face their demons.",
