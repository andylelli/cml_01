...
- Project ID: ``
- Timestamp: `2026-07-20T21:52:23.154Z`
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Battles feelings of inadequacy and resentment stemming from her rivalry with Hugo, questioning her own professional integrity."
...
• [clue_9] mallory, finch, exhibited, signs, jealousy, past, relationship, victim
  Category: behavioral | Criticality: essential | Supports inference step 2
  Points to: indicates, possible, motive, linked, personal, feelings

• [clue_11] eliminates, captain, ivor, hale, because, seen, multiple, witnesses, time, murder
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: further, narrows, list, suspects
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the afternoon waned, Eleanor reflected on the evidence. The torn piece of costume, the damaged clothing, the contradictory witness statements—all pointed to an altercation before the murder. The masquerade ball’s chaos had provided cover for deception, and..."
...
Known location profile anchors: The Seaside Grand Hotel, The Ocean View Room, The Grand Lobby, The Oceanfront Dining Room, The Secluded Beach, the hotel library
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Seaside Grand Hotel", "The Ocean View Room", "The Grand Lobby", "The Oceanfront Dining Room", "The Secluded Beach", "the hotel library"
...
- Phrases to avoid (already overused in earlier chapters): "just my luck really i never thought", "my luck really i never thought i", "luck really i never thought i d", "really i never thought i d find", "i never thought i d find myself", "never thought i d find myself in", "thought i d find myself in this", "i d find myself in this mess", "d find myself in this mess he", "can you believe it everyone is talking".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=13167; context=7748; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 4:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the afternoon waned, Eleanor reflected on the evidence. The torn piece of costume, the damaged clothing, the contradictory witness statements—all pointed to an altercation before the murder. The masquerade ball’s chao...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • witnesses, noted, mallory, finch, discomfort, victim, mentioned [clue_9]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • witnesses, confirm, captain, ivor, hale, presence [clue_11]
      Points to: further, narrows, list, suspects
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Dr. Finch's admission of jealousy over a past relationship with the victim."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that multiple suspects had motives to harm the victim, increasing the complexity of the investigation."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_2] Eleanor recalls her earlier conversation with the victim, suggesting a motive.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor recalls a heated argument she overheard between Dr. Finch and the victim."
      ]
    },
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_2",
      "placementDetail": "Eleanor recalls her earlier conversation with the victim, suggesting a motive."
    },
    "emotionalRegister": "The discovery of a disguise shifts the investigation's direction.",
