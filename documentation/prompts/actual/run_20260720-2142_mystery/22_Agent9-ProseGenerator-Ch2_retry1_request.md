...
- Project ID: ``
- Timestamp: `2026-07-20T21:50:57.583Z`
...
• [clue_core_contradiction_chain] figure, murderer, disguise
  Category: testimonial | Criticality: essential | Supports inference step 1
  Points to: raises, doubts, true, identity, figure, seen

• [clue_mid_1] indicates, struggle, deception, involving, victim, clothing
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_early_2 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): indicates, murderer, disguised, themselves, victim | raises, doubts, true, identity, figure, seen
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "The morning after the masquerade ball was meant to bring relief, a return to normalcy after the night’s revelry. Instead, it ushered in a new kind of tension—a somber reckoning, a search for truth. Eleanor Voss stood at the center of it all, her dry wit muted..."
...
Known location profile anchors: The Seaside Grand Hotel, The Ocean View Room, The Grand Lobby, The Oceanfront Dining Room, The Secluded Beach, the hotel lobby
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Seaside Grand Hotel", "The Ocean View Room", "The Grand Lobby", "The Oceanfront Dining Room", "The Secluded Beach", "the hotel lobby"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=9648; context=12908; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 2:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "The morning after the masquerade ball was meant to bring relief, a return to normalcy after the night’s revelry. Instead, it ushered in a new kind of tension—a somber reckoning, a search for truth. Eleanor Voss stood at...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • witnesses, claim, figure, leaving [clue_core_contradiction_chain] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: raises, doubts, true, identity, figure, seen
  ...
  - Sensory obligation — use at least two of: shadows creeping along walls, flickering lights from the radio | the creak of furniture, soft laughter echoing | dust settling. Mood: tense anticipation.
...
Chapter 2 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Witnesses give contradictory accounts of the victim's last movements."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the victim was seen leaving the ballroom shortly before the body was discovered, creating confusion over the timeline."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor notices the nervous fidgeting of Dr. Finch as she speaks."
      ]
    },
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 2: the clue [clue_core_contradiction_chain] (figure, murderer, disguise) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 2: the clue [clue_mid_1] (indicates, struggle, deception, involving, victim, clothing) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
...
```text
{
  ...
  "chapters": [
    {
      ...
      "summary": "In the hotel lobby, Eleanor Voss confronts the chaos following Hugo Vane's death. She gathers conflicting statements from guests, observes critical clues, and reframes the meaning of prior evidence, heightening suspicion and deepening the emotional cost for all involved.",
      "paragraphs": [
  ...
  "note": "",
  "audit": {
    "locked_fact_phrases": "present in paragraph 1 | present in paragraph 5 | absent",
    "season_words_used": "autumn, autumnal",
    "discriminating_test_present": "no",
    "required_clues_present": "clue_core_contradiction_chain: paragraph 1-4 | clue_mid_1: paragraph 5",
    "early_observation_present": "Witnesses claim to have seen Hugo Vane leave the ballroom: paragraph 1",
    "early_inference_present": "Eleanor reasons about the possibility of disguise and revised suspect pool: paragraph 4"
  }
}
...
PRIMARY FAILURES
- VICTIM ALIVE: "The autumnal chill seeped through the lobby, clinging to her skin as she listened to the contradictory accounts swirling"
...
RETRY CLASS: unknown
ATTEMPT: 1/3
OFFENDING TEXT: The autumnal chill seeped through the lobby, clinging to her skin as she listened to the contradictory accounts swirling
MANDATORY FIXES:
