...
- Project ID: ``
- Timestamp: `2026-07-14T19:43:18.004Z`
...
- YOU MUST use the exact year and month specified above: July 1940
- This date has been specifically selected for THIS mystery to ensure uniqueness
- DO NOT change the year or month - use July 1940 exactly
...
- All details must be historically accurate for July 1940 specifically
- Generate fresh, original descriptions - do not copy example phrasing
- Make this feel like the specific moment of July 1940
...
Task:
1. Use the specified date: July 1940
