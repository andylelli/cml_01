...
- Project ID: ``
- Timestamp: `2026-07-14T19:53:28.233Z`
...
PRIMARY FAILURES
- Chapter 9: Chapter 9 contains control-plane leakage (obligation_term): "She spoke so all could hear: "Clue obligation: suspect clearance missing for Dr." (Remove prompt, validation, retry, or scaffold terminology from reader-facing prose)
- Chapter 9: Chapter 9 contains control-plane leakage (obligation_term): "Eleanor spoke for all to hear: "Clue obligation: suspect clearance missing for Sylvia Trent." (Remove prompt, validation, retry, or scaffold terminology from reader-facing prose)
- Chapter 9: Chapter 9 contains control-plane leakage (instruction_shape): "This chapter must include a paragraph that (a) names 'Dr." (Remove prompt, validation, retry, or scaffold terminology from reader-facing prose)
...
ATTEMPT: 2/3
OFFENDING TEXT: She spoke so all could hear: 
MANDATORY FIXES:
- Resolve template issues before accepting this batch.
- Chapter 9: Chapter 9 contains control-plane leakage (obligation_term): "She spoke so all could hear: "Clue obligation: suspect clearance missing for Dr." (Remove prompt, validation, retry, or scaffold terminology from reader-facing prose)
- Chapter 9: Chapter 9 contains control-plane leakage (obligation_term): "Eleanor spoke for all to hear: "Clue obligation: suspect clearance missing for Sylvia Trent." (Remove prompt, validation, retry, or scaffold terminology from reader-facing prose)
