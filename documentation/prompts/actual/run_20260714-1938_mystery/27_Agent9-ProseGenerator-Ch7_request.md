...
- Project ID: ``
- Timestamp: `2026-07-14T19:51:05.080Z`
...
• [clue_3] discrepancies, highlight, attack, visible, claimed
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the suspects dispersed, each carrying their own burden of doubt, Eleanor lingered by the cold hearth, staring into the flickering shadows cast by the lamplight. The evening was not yet over, nor was the case. The evidence pointed in too many directions, the..."
...
Known location profile anchors: L'Étoile de Mer, The Beachfront Balcony, Grand Lobby, Oceanview Dining Room, Hotel Library, the villa, in a secluded corner
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "L'Étoile de Mer", "The Beachfront Balcony", "Grand Lobby", "Oceanview Dining Room", "Hotel Library", "the villa, in a secluded corner"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 7: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the villa, in a secluded corner". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=19220; context=4463; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 7:
  ...
  - Scene is set in: the villa, in a secluded corner — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the suspects dispersed, each carrying their own burden of doubt, Eleanor lingered by the cold hearth, staring into the flickering shadows cast by the lamplight. The evening was not yet over, nor was the case. The evid...".
...
Chapter 7 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The revelation of Sylvia's financial mismanagement."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Sylvia had a motive to silence Beatrice due to financial threats."
...
[
  {
    ...
    "setting": {
      "location": "the villa, in a secluded corner",
      "timeOfDay": "Late evening",
      "atmosphere": "Quiet and tense, with a sense of hidden truths"
    },
    "characters": [
      "Eleanor Voss",
      "Hugo Vane",
    ...
    "purpose": "Reveal deeper motives and lies",
    "cluesRevealed": [
      "clue_3"
    ],
    "dramaticElements": {
      "conflict": "Hidden truths start to unravel",
      "tension": "The atmosphere thickens with revelations",
      "microMomentBeats": [
        "Eleanor's brow furrows as she uncovers a lie."
      ]
    },
    "summary": "Eleanor uncovers hidden secrets among the suspects, including financial troubles and past grievances. The web of lies complicates the investigation, leading her to reconsider earlier assumptions.",
    "beat": "secrets",
    "estimatedWordCount": 1800,
    "pivotElement": "The revelation of Sylvia's financial mismanagement.",
    "factEstablished": "Establishes that Sylvia had a motive to silence Beatrice due to financial threats.",
