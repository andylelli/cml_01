...
- Project ID: ``
- Timestamp: `2026-07-14T19:52:55.946Z`
...
• [clue_late_optional_slot_1] fingerprints, mirror, remains, late, texture, detail, case, background
...
• [clue_6] discriminating, compares, mirror, light, angle, claimed, timeline
  Category: temporal | Criticality: essential | Supports inference step 2
  Points to: validity, witness, testimonies
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the group dispersed, the sense of anticipation lingered, coiling in the quiet night air. Eleanor remained behind, staring at the fractured reflection in the mirror. The pattern was there, she was certain—hidden in the interplay of angles, shadows, and lies...."
...
This is a **optical demonstration** test. The detective must:

**Test mechanism (paraphrase — do NOT copy verbatim):**
Render this test MECHANISM as live, in-scene action and dialogue, composing ENTIRELY in your own words from these elements (reproducing any briefing phrase verbatim FAILS validation): discriminating, compares, mirror, light, angle, claimed, timeline
...
Known location profile anchors: L'Étoile de Mer, The Beachfront Balcony, Grand Lobby, Oceanview Dining Room, Hotel Library, the dining room, set up for the demonstration
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "L'Étoile de Mer", "The Beachfront Balcony", "Grand Lobby", "Oceanview Dining Room", "Hotel Library", "the dining room, set up for the demonstration"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 9: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with an explicit time marker — e.g. "That morning…" / "By the time dusk fell…" / "It was nearly four o'clock…" / "On the second day after the discovery…". Time must be in the first clause. Anchor opening in "the dining room, set up for the demonstration". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Chapter 8 (score 98/100):
  Quality gaps noted: scene grounding weakness
  Address in upcoming chapters: Open next chapter with a named location anchor plus at least two sensory cues and one atmosphere marker.
- Phrases to avoid (already overused in earlier chapters): "words hung in the air a challenge", "the mirror the angle twenty degrees lodged", "mirror the angle twenty degrees lodged in", "the angle twenty degrees lodged in her", "angle twenty degrees lodged in her thoughts", "let s not sugarcoat the truth shall", "s not sugarcoat the truth shall we", "emotion is merely a symptom after all", "by the distant sound of a radio".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=25243; context=4880; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 9:
  ...
  - Scene is set in: the dining room, set up for the demonstration — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the group dispersed, the sense of anticipation lingered, coiling in the quiet night air. Eleanor remained behind, staring at the fractured reflection in the mirror. The pattern was there, she was certain—hidden in the...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • fingerprints, mirror, remains, late, texture, detail, case, background [clue_late_optional_slot_1]
      Points to: adds, late, texture, changing, essential, deduction, chain
    • timeline, events, being, analyzed [clue_6]
      Points to: validity, witness, testimonies
  - ⚠ SUSPECT CLEARANCE REQUIRED (MANDATORY): each suspect below MUST be named explicitly and cleared with on-page evidence and a reasoning connector (because / therefore / which proves):
    • "Captain Ivor Hale": write a dedicated paragraph that (a) names Captain Ivor Hale explicitly, (b) states the clearance method ("Confirmed alibi by hotel staff"), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have". Cite clues: Witness accounts, Hotel records.
    • "Dr. Mallory Finch": write a dedicated paragraph that (a) names Dr. Mallory Finch explicitly, (b) states the clearance method ("Provided assistance to Beatrice before the murder"), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have". Cite clues: Witness testimony, Hotel staff confirmation.
    • "Sylvia Trent": write a dedicated paragraph that (a) names Sylvia Trent explicitly, (b) states the clearance method ("Her angle of sight was obstructed"), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have". Cite clues: Mirror position, Witness accounts.
  ...
  - ⚠ DISCRIMINATING TEST (trap) — MANDATORY real-time scene with dialogue and confrontation. DO NOT summarize it after the fact.
    ...
    Elements the test must dramatize (compose the scene ENTIRELY in your own sentences from these — reproducing any briefing phrase verbatim FAILS validation): discriminating, compares, mirror, light, angle, claimed, timeline
    Cite these already-revealed clue IDs during the test: clue_6, clue_3, clue_culprit_direct_1, clue_fp_contradiction_step_1
    ...
    Motive statement REQUIRED: the culprit must explicitly state or acknowledge their motive during or immediately after the confrontation. Canonical motive: "Jealousy over Beatrice's success". Do not omit it.
...
Chapter 9 (Act 3) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The angle of the mirror during the demonstration."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "The demonstration reveals that no one could have seen the attack from their claimed positions."
...
[
  {
    ...
    "setting": {
      "location": "the dining room, set up for the demonstration",
      "timeOfDay": "Morning",
    ...
    "purpose": "Execute the discriminating test to reveal the culprit Suspects are systematically cleared: alibi confirmed for one suspect, ruled out by timeline evidence, leaving only the culprit identified by a complete evidence chain.",
    "cluesRevealed": [
    ...
    "dramaticElements": {
      ...
      "tension": "All eyes are on Eleanor as she prepares the test",
      "microMomentBeats": [
        "Eleanor feels the weight of every suspect's gaze upon her."
      ]
    },
    "summary": "Eleanor sets up the mirror and light to demonstrate the angle and visibility of the crime scene. As she executes the test, she observes the reactions of the suspects, leading to a pivotal moment of revelation.",
    "beat": "final_trap",
    "estimatedWordCount": 1800,
    "pivotElement": "The angle of the mirror during the demonstration.",
    "factEstablished": "The demonstration reveals that no one could have seen the attack from their claimed positions.",
    ...
    "emotionalRegister": "The confrontation reveals the intertwined fates of the characters.",
...
```text
{
  ...
  "chapters": [
    {
      ...
      "summary": "Eleanor orchestrates a live demonstration in the dining room, using the mirror to reconstruct the crime and expose the truth. Each suspect is systematically cleared until only Hugo Vane remains, his guilt revealed by the evidence, motive, and a critical physical mistake.",
      "paragraphs": [
  ...
  "note": "",
  "audit": {
    "locked_fact_phrases": "present in paragraph 1, 3, 5, 6, 9 | present in paragraph 5, 6, 9",
    "season_words_used": "summer, midsummer, summer air",
    "discriminating_test_present": "yes: chapter 9 paragraph 5-13",
    "required_clues_present": "clue_late_optional_slot_1: chapter 9 paragraph 3; clue_6: chapter 9 paragraph 4-6",
    "early_observation_present": "Eleanor notes the late fingerprint on the mirror: chapter 9 paragraph 3 (first 25%)",
