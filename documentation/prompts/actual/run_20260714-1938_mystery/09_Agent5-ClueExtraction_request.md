...
- Project ID: `unknown`
- Timestamp: `2026-07-14T19:40:55.985Z`
...
1. Generate a clue that makes the reader directly observe: "The angle of the mirror in the dining room is twenty degrees...."
   → observation | essential | early | spatial | step 1 | terms: angle, mirror, dining

2. Generate a clue that provides evidence for: "This angle would distort the sightline for anyone attempting to view the scene directly...."
   → contradiction | essential | early | testimonial | step 1 | terms: angle, distort, sightline

3. Generate a clue that makes the reader directly observe: "Smudges on the mirror indicate it was recently adjusted...."
   → observation | essential | early | testimonial | step 2 | terms: smudges, mirror, indicate

4. Generate a clue that provides evidence for: "This suggests someone manipulated the mirror to hide the attack...."
   → contradiction | essential | early | testimonial | step 2 | terms: suggests, someone, manipulated

5. Generate a clue that makes the reader directly observe: "Witnesses report conflicting descriptions of the attack...."
   → observation | essential | mid | testimonial | step 3 | terms: witnesses, report, conflicting

6. Generate a clue that provides evidence for: "The discrepancies highlight that the attack was not visible to them as they claimed...."
   → contradiction | essential | mid | testimonial | step 3 | terms: discrepancies, highlight, attack

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "This angle would distort the sightline for anyone attempting to view the scene directly...."
   → contradiction | essential | mid | testimonial | step 1 | terms: angle, distort, sightline

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The Reflective Deceit..."
   → observation | essential | early | testimonial | terms: reflective, deceit
...
10. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "The discriminating test compares mirror, light, and angle against the claimed timeline...."
...
11. Generate one essential mid-story clue whose description or pointsTo explicitly names Hugo Vane and states the unique trace, preparation detail, or mechanism link that points to Hugo Vane rather than any non-culprit.
   → observation | essential | mid | testimonial | terms: Hugo Vane, reflective, deceit
...
12. Generate one essential early-or-mid clue establishing that Hugo Vane UNIQUELY had the means/skill/access/knowledge required to execute the concealment mechanism, and that the other suspects did not — so the reveal relies only on this already-planted capability, never on a means introduced for the first time at the confrontation.
   → elimination | essential | mid | testimonial | terms: Hugo Vane, reflective, deceit

13. Generate a clue showing observable evidence of Hugo Vane's premeditation or planning (Jealousy over Beatrice's success). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: jealousy, beatrice's, success
...
Create 2 red herrings that support the false assumption: "The attack on Beatrice occurred in the direct line of sight of Sylvia Trent."
