...
- Project ID: ``
- Timestamp: `2026-07-17T05:26:38.981Z`
...
- Eleanor Voss
  ...
  Connection to victim: Trusted doctor-patient relationship with unspoken tensions from past romance.; Eleanor and Dr. Mallory Finch had a close bond, especially after Eleanor's father's passing, with hidden feelings complicating their connection..
...
- Captain Ivor Hale
  Public identity anchor: Retired Naval Captain; suspect 
  Connection to victim: Past allies in the family with diverging futures.; Ivor and Mallory share past conversations about family legacy that brought them closer at times..
  Investigation relevance: access plausibility: high | alibi window: Around the time of death. | opportunity channel: Direct access to the beach.
  Suspicion/pressure cue seed: Personal honor..
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Beatrice Quill
  Public identity anchor: Art Dealer; suspect 
  Connection to victim: Mutual trust despite conflicting interests.; Their professional interactions have created a level of respect, though they disagree on some financial matters..
  Investigation relevance: access plausibility: medium | alibi window: Before the murder..
  Suspicion/pressure cue seed: Heartbreak..
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.
...
A sense of foreboding fills the air as the guests gather, unaware of the impending tragedy.
...
### Hugo Vane
Hugo Vane is a charismatic investment broker whose deceit threatens Eleanor's inheritance. His financial manipulations reveal the darker side of ambition in a war-torn society, where personal interests often clash with ethical considerations.
Era intersection: Hugo’s actions reflect the cutthroat nature of commerce during wartime, where survival often necessitates moral compromises.
...
Hugo speaks with a confident ease, often using sharp observations.
[comfortable] Ah, the price of ambition, my dear; it’s a steep one.
[evasive] I was merely enjoying the evening; nothing more to it.
[stressed] I can’t let them find out; my entire life is at stake!
Humour: His observational humor often masks his underlying tension.
...
Rationale: The opening scene establishes the tension and seriousness of the murder.
...
Hugo speaks with a confident ease, often employing sharp observations and playful banter
He has a habit of punctuating his sentences with a smirk, making his charm both disarming and unnerving.
Hugo is torn between maintaining his lavish lifestyle and the fear of losing everything due to his dishonest dealings.
...
### Hugo Vane[HE]
Voice & mannerisms: Hugo speaks with a confident ease, often employing sharp observations and playful banter. He has a habit of punctuating his sentences with a smirk, making his charm both disarming and unnerving.
SIGNATURE TIC (use sparingly — this is Hugo Vane's alone, never in anyone else's mouth; at most once in this chapter and only where the scene naturally invites it; prefer a varied paraphrase over the verbatim phrase; most chapters should omit it entirely): "Ah, the price of ambition, my dear."
Sample voice fragments (match this register and rhythm):
  [comfortable] "Ah, the price of ambition, my dear; it’s a steep one."
  [evasive] "I was merely enjoying the evening; nothing more to it."
...
Act 1 behaviour contract: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "If Eleanor inherits and discovers the embezzlement, his financial scams will be exposed, ruining him." — do not surface in Act I.
...
Primary Location: The Tidal Deception Hotel (Brighton, England)
A sprawling seaside hotel with Art Deco elegance and an air of mystery, perched precariously on the cliffs overlooking the churning sea.

Key Locations Available:
- Seaside Observation Deck (exterior): Crime scene
- Grand Dining Room (interior): Gathering space for meals and conversations
- Library and Study (interior): Quiet space for reading and reflection; a repository for secrets

Atmosphere (tonal cue only — do NOT reproduce this phrase verbatim in prose; translate into scene-specific, character-observed sensory language): tension hangs in the air due to recent events, with guests on edge
Weather: overcast with occasional rain, typical of coastal climates

Era markers: manual typewriters clacking in the office | vintage radios broadcasting news updates | rationed fuel affecting travel plans
...
Seaside Observation Deck (exterior):
  - Visual: stormy waves crashing against rocks, dark clouds swirling overhead, wet wooden planks glistening
  - Sounds: howling wind through the railings, crashing surf below, distant thunder rumbling
  - Scents: briny sea air, wet earth from the cliff, damp wood and moss
  - Touch: cold metal railing, rough wooden surface underfoot

Grand Dining Room (interior):
  - Visual: gleaming candlelight reflecting on glass, vibrant floral centerpieces, waitstaff in crisp uniforms
  - Sounds: clinking of cutlery on plates, murmurs of conversation, soft classical music playing
  - Scents: rich aroma of roasted meats, freshly baked bread, herbs and spices wafting
  - Touch: smooth surface of polished wood, coolness of fine china

Library and Study (interior):
  - Visual: intricate woodwork on door frames, comfortable armchairs inviting repose
  - Sounds: crackling fire in the hearth, pages turning softly, the distant sound of thunder
  - Scents: old leather bindings of books, smoky scent of burning wood, hint of dust in the air
  - Touch: soft fabric of armchair upholstery, smoothness of leather-bound books
...
• [clue_mechanism_visibility_core] mechanism, relies, drown, chart, indicat, expose, false, timing
  Category: testimonial | Criticality: essential | Supports inference step 1
  Points to: mechanism, crime, involve, manipulating, perceived, timing, death

• [clue_mid_1] tide, chart, contradicts, witness, reports, high
  Category: testimonial | Criticality: essential | Supports inference step 1
...
Known location profile anchors: The Tidal Deception Hotel, Seaside Observation Deck, Grand Dining Room, Library and Study, the beach near the Seaside Hotel
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Tidal Deception Hotel", "Seaside Observation Deck", "Grand Dining Room", "Library and Study", "the beach near the Seaside Hotel"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=7793; context=12082; dropped=[none]; truncated=[first_appearance_contracts, location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • witnesses, claim, high, tide, time, finch, death [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The tide chart found near the body showing low tide at twenty minutes past midnight."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the victim drowned at low tide, contradicting claims of high tide."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor stands frozen, staring at the body, grief washing over her."
      ]
    },
    ...
    "emotionalRegister": "A sense of foreboding fills the air as the guests gather, unaware of the impending tragedy.",
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (mechanism, relies, drown, chart, indicat, expose, false, timing) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_mid_1] (tide, chart, contradicts, witness, reports, high) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
