...
- Project ID: ``
- Timestamp: `2026-07-15T18:55:15.022Z`
...
• [clue_2] tampering, marks, gramophone, mechanism
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_3, clue_4, clue_1, clue_8, clue_6, clue_culprit_direct_dr_mallory_finch, clue_5, clue_9, clue_10, clue_culprit_direct_1, clue_11, clue_7, clue_12 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): mechanism, used, create, false, alibi | gramophone, role, murder, alibi | approximate, time, murder | relationship, music, murder, timing | mechanism, used, create, false, alibi | motive, mallory, finch | method, used, create, false, alibi | direct, shows, mallory, finch, means, opportunity | tampering, indicating, premeditated, actions | exclusion, captain, ivor, hale | exclusion, beatrice, quill | physical, trace, opportunity, indicate, mallory, finch | further, exclusion, captain, ivor, hale | mallory, finch, unique, capability | further, exclusion, beatrice, quill
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the group drifted apart, each lost in private reckoning, Hugo lingered by the grand piano, the cold from the marble floor seeping through his shoes. He stared at his own reflection in the black lacquer, the face of a man who had come close to the truth only..."
...
This is a **mechanical proof** test. The detective must:

**Test mechanism (paraphrase — do NOT copy verbatim):**
Render this test MECHANISM as live, in-scene action and dialogue, composing ENTIRELY in your own words from these elements (reproducing any briefing phrase verbatim FAILS validation): gramophone, mechanism, proves, mallory, finch, mechanical, knowledge, tamper
...
- Chapter 7 (score 98/100):
  Quality gaps noted: scene grounding weakness
  Address in upcoming chapters: Open next chapter with a named location anchor plus at least two sensory cues and one atmosphere marker.
- Phrases to avoid (already overused in earlier chapters): "truth is stranger than fiction isn t", "s hand hovered at his watch chain", "hand hovered at his watch chain a", "hovered at his watch chain a gesture".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=24646; context=4762; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 8:
  ...
  - Scene is set in: the hotel music room — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the group drifted apart, each lost in private reckoning, Hugo lingered by the grand piano, the cold from the marble floor seeping through his shoes. He stared at his own reflection in the black lacquer, the face of a...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • physical, tampering, visible [clue_2]
      Points to: tampering, indicating, premeditated, actions
  - ⚠ SUSPECT CLEARANCE REQUIRED (MANDATORY): each suspect below MUST be named explicitly and cleared with on-page evidence and a reasoning connector (because / therefore / which proves):
    • "Captain Ivor Hale": write a dedicated paragraph that (a) names Captain Ivor Hale explicitly, (b) states the clearance method ("Witnesses corroborate his alibi in the lobby."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have". Cite clues: clue_hallway_1, clue_hallway_2.
    • "Beatrice Quill": write a dedicated paragraph that (a) names Beatrice Quill explicitly, (b) states the clearance method ("Physical evidence shows her movements were elsewhere."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have". Cite clues: clue_hallway_3, clue_hallway_4.
    • "Sylvia Trent": write a dedicated paragraph that (a) names Sylvia Trent explicitly, (b) states the clearance method ("Her panic and alibi during the questioning clear her."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have". Cite clues: clue_hallway_5, clue_hallway_6.
  ...
  - ⚠ DISCRIMINATING TEST (trap) — MANDATORY real-time scene with dialogue and confrontation. DO NOT summarize it after the fact.
    ...
    Elements the test must dramatize (compose the scene ENTIRELY in your own sentences from these — reproducing any briefing phrase verbatim FAILS validation): gramophone, mechanism, proves, mallory, finch, mechanical, knowledge, tamper
    Cite these already-revealed clue IDs during the test: clue_7, clue_5, clue_culprit_direct_1, clue_1, clue_2
...
Chapter 8 (Act 3) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The gramophone's mechanism being tested."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Dr. Mallory Finch tampered with the gramophone, proving her guilt."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Dr. Finch's hands shake as Vane prepares the gramophone for testing."
      ]
    },
    ...
    "permittedBehavioursByAct": [
      ...
      },
      {
        ...
        "behaviour": "Exhibit professional jealousy towards Eleanor."
      }
    ],
    "redHerringPlacement": null,
    "emotionalRegister": "The climax unfolds with a dramatic reveal that unravels the mystery.",
