...
- Project ID: ``
- Timestamp: `2026-07-15T18:42:07.069Z`
...
- Era-authentic markers: radio broadcasting, early television sets, military radar technology, rationed petrol for automobiles, limited public transport, post-war automobile boom, long-distance telephone calls, military-style encrypted messages
- Tone: Classic
- No anachronisms
...
Description: A grand seaside hotel with Art Deco architecture, featuring a main lobby, dining room, and guest rooms overlooking the ocean.
...
Setting constraints:
- Physical constraints: narrow hallways limit movement, large windows provide visibility but also expose guests to outside view, staircases are the only access to upper floors
...
- Transportation: rationed petrol for automobiles, limited public transport
- Social norms: impact of WWII on daily life, women joining the workforce
