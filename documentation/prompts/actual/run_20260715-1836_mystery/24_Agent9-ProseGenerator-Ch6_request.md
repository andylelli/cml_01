...
- Project ID: ``
- Timestamp: `2026-07-15T18:52:43.577Z`
...
• [clue_11] eliminates, captain, ivor, hale, because, seen, leaving, quarter, past, nine
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: further, exclusion, captain, ivor, hale
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_3, clue_4, clue_1, clue_8, clue_6, clue_culprit_direct_dr_mallory_finch, clue_5, clue_9, clue_10 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): mechanism, used, create, false, alibi | gramophone, role, murder, alibi | approximate, time, murder | relationship, music, murder, timing | mechanism, used, create, false, alibi | motive, mallory, finch | method, used, create, false, alibi | direct, shows, mallory, finch, means, opportunity | tampering, indicating, premeditated, actions | exclusion, captain, ivor, hale | exclusion, beatrice, quill
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "The rain continued its steady assault on the lobby windows, the world outside reduced to darkness and the gleam of wet pavement. Inside, the firelight flickered, and the hunt for the truth pressed on—relentless, methodical, and now, at last, one step closer to..."
...
Known location profile anchors: The Oceanic Grand Hotel, Grand Lobby, Oceanview Dining Room, Guest Room 312, Staff-Only Corridor, the hotel library
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Oceanic Grand Hotel", "Grand Lobby", "Oceanview Dining Room", "Guest Room 312", "Staff-Only Corridor", "the hotel library"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=19553; context=3936; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_2 must appear in Act 2, Scene 3 via Witness statements
...
- Chapter 6:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "The rain continued its steady assault on the lobby windows, the world outside reduced to darkness and the gleam of wet pavement. Inside, the firelight flickered, and the hunt for the truth pressed on—relentless, methodic...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • witnesses, confirm, captain, ivor, hale, departure [clue_11]
      Points to: further, exclusion, captain, ivor, hale
    • witnesses, confirm, beatrice, quill, presence, event [clue_12]
      Points to: further, exclusion, beatrice, quill
    • physical, tampering, visible [clue_2]
      Points to: tampering, indicating, premeditated, actions
    • mallory, finch, expertise, noted [clue_7]
    ...
    • gramophone, playing, soundproof, room [clue_culprit_direct_1]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The theory implicating Beatrice Quill."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes a false solution that points towards Beatrice, creating a sense of resolution for the suspects."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Hugo's heart sinks as he realizes he's overlooked a crucial detail."
      ]
    },
    ...
    "emotionalRegister": "New evidence complicates the narrative, forcing characters to confront their pasts.",
