...
- Project ID: ``
- Timestamp: `2026-07-15T20:40:05.122Z`
...
• [clue_8] eliminates, captain, ivor, hale, because, gambling, time, toast
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: captain, ivor, hale, ruled, suspect

• [clue_1] direct, links, mallory, finch, mechanism, access, point, before, discriminating, excludes, competing, suspect
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_10, clue_3, clue_4, clue_5, clue_7, clue_2, clue_6, clue_core_elimination_chain, clue_11, clue_9, clue_culprit_direct_1, clue_culprit_direct_dr_mallory_finch — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): toast, timing, crucial, establishing, timeline, hugo | assumption, natural, causes, flawed, based, timeline | hugo, lively, state, contradicts, idea, natural | residue, indicates, potential, tampering, drink | glass, condition, contradicts, idea, natural, death | finch, presence, kitchen, raises, suspicion | finch, jealousy, provides, motive, crime | finch, presence, kitchen, raises, suspicion | finch, access, kitchen, critical, factor, investigation | eleanor, voss, ruled, suspect | analysis, supports, conclusion, murder | beatrice, quill, ruled, suspect | physical, trace, opportunity, indicate, mallory, finch | direct, shows, mallory, finch, means, opportunity
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the lamplight flickered and the wind rattled the panes, Eleanor realized that the case had become a crucible for all their fears and ambitions. The evidence pointed to Dr. Finch’s opportunity and motive, but the certainty of guilt remained elusive. The trut..."
...
- Chapter 7 (score 96/100):
  Quality gaps noted: scene grounding weakness
  Address in upcoming chapters: Open next chapter with a named location anchor plus at least two sensory cues and one atmosphere marker.
- Phrases to avoid (already overused in earlier chapters): "the toast at twenty minutes past eight", "the others searching their faces for any", "others searching their faces for any sign", "searching their faces for any sign of", "one must always keep one s enemies", "must always keep one s enemies close", "always keep one s enemies close darling", "felt the weight of the investigation settle", "a reminder that the world s troubles", "reminder that the world s troubles extended".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=22029; context=4276; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 8:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the lamplight flickered and the wind rattled the panes, Eleanor realized that the case had become a crucible for all their fears and ambitions. The evidence pointed to Dr. Finch’s opportunity and motive, but the certa...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • records, showing, captain, hale, gambling, activity [clue_8]
      Points to: captain, ivor, hale, ruled, suspect
    • witnesses, mentioning, exact, time, toast [clue_1]
...
Chapter 8 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The evidence of Dr. Finch's access to the poison"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Prepares Eleanor for the confrontation with Dr. Finch, solidifying her suspicions."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor's breath quickens as she uncovers the truth."
      ]
    },
    ...
    "emotionalRegister": "As pressure mounts, the atmosphere is charged with anticipation and anxiety, leading to a critical confrontation.",
