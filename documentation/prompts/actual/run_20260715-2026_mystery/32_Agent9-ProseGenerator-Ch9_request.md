...
- Project ID: ``
- Timestamp: `2026-07-15T20:41:58.208Z`
...
• [clue_late_optional_slot_1] time, toast, eight, twenty, evening, remains, late, texture, detail, case, background
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_10, clue_3, clue_4, clue_5, clue_7, clue_2, clue_6, clue_core_elimination_chain, clue_11, clue_9, clue_culprit_direct_1, clue_culprit_direct_dr_mallory_finch, clue_8, clue_1 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): toast, timing, crucial, establishing, timeline, hugo | assumption, natural, causes, flawed, based, timeline | hugo, lively, state, contradicts, idea, natural | residue, indicates, potential, tampering, drink | glass, condition, contradicts, idea, natural, death | finch, presence, kitchen, raises, suspicion | finch, jealousy, provides, motive, crime | finch, presence, kitchen, raises, suspicion | finch, access, kitchen, critical, factor, investigation | eleanor, voss, ruled, suspect | analysis, supports, conclusion, murder | beatrice, quill, ruled, suspect | physical, trace, opportunity, indicate, mallory, finch | direct, shows, mallory, finch, means, opportunity | captain, ivor, hale, ruled, suspect | physical, trace, opportunity, indicate, mallory, finch
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "For a moment, Eleanor allowed herself to imagine what might follow: the relief of certainty, the pain of accusation, the unraveling of loyalties that had bound them all together in this crucible of suspicion. But there was no comfort in the thought—only the kn..."
...
This is a **Chemical evidence confrontation** test. The detective must:

**Test mechanism (paraphrase — do NOT copy verbatim):**
Render this test MECHANISM as live, in-scene action and dialogue, composing ENTIRELY in your own words from these elements (reproducing any briefing phrase verbatim FAILS validation): confronting, finch, forensic, residue, kitchen, access, records
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=25923; context=5177; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 9:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "For a moment, Eleanor allowed herself to imagine what might follow: the relief of certainty, the pain of accusation, the unraveling of loyalties that had bound them all together in this crucible of suspicion. But there w...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • time, toast, eight, twenty, evening, remains, late, texture, detail, case, background [clue_late_optional_slot_1]
      Points to: adds, late, texture, changing, essential, deduction, chain
    • finch, access, kitchen [clue_6]
      Points to: finch, access, kitchen, critical, factor, investigation
  - ⚠ SUSPECT CLEARANCE REQUIRED (MANDATORY): each suspect below MUST be named explicitly and cleared with on-page evidence and a reasoning connector (because / therefore / which proves):
    • "Captain Ivor Hale": write a dedicated paragraph that (a) names Captain Ivor Hale explicitly, (b) states the clearance method ("His gambling debts were settled before the murder."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have". Cite clues: red_herring_1.
    • "Sylvia Trent": write a dedicated paragraph that (a) names Sylvia Trent explicitly, (b) states the clearance method ("No evidence of her involvement found in the investigation."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
    • "Beatrice Quill": write a dedicated paragraph that (a) names Beatrice Quill explicitly, (b) states the clearance method ("No motive connected to the case."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
  ...
  - ⚠ DISCRIMINATING TEST (trap) — MANDATORY real-time scene with dialogue and confrontation. DO NOT summarize it after the fact.
    ...
    Elements the test must dramatize (compose the scene ENTIRELY in your own sentences from these — reproducing any briefing phrase verbatim FAILS validation): confronting, finch, forensic, residue, kitchen, access, records
    Cite these already-revealed clue IDs during the test: clue_6, clue_culprit_direct_1, clue_5, clue_1
...
Chapter 9 (Act 3) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The confrontation with Dr. Finch over the residue evidence"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Reveals Dr. Finch's involvement in the poisoning, solidifying her as the prime suspect."
...
[
  {
    ...
    "emotionalRegister": "The dramatic reveal of the murderer forces characters to confront their own moralities and consequences.",
