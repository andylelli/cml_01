...
- Project ID: `unknown`
- Timestamp: `2026-07-15T20:29:12.239Z`
...
1. Generate a clue that makes the reader directly observe: "Witnesses recall the toast was made at precisely twenty minutes past eight...."
   → observation | essential | early | temporal | step 1 | terms: witnesses, recall, toast

2. Generate a clue that provides evidence for: "This timing contradicts the initial assumption of natural causes since the symptoms began later...."
   → contradiction | essential | early | testimonial | step 1 | terms: timing, contradicts, initial

3. Generate a clue that makes the reader directly observe: "An unusual residue is found in the bottom of Hugo's glass...."
   → observation | essential | early | testimonial | step 2 | terms: unusual, residue, found

4. Generate a clue that provides evidence for: "The residue indicates tampering and suggests the glass was not clean prior to serving...."
   → contradiction | essential | early | testimonial | step 2 | terms: residue, indicates, tampering

5. Generate a clue that makes the reader directly observe: "Dr. Finch was seen in the kitchen shortly before the toast...."
   → observation | essential | mid | temporal | step 3 | terms: finch, kitchen, shortly

6. Generate a clue that provides evidence for: "Her presence in the kitchen allows for access to poison...."
   → contradiction | essential | mid | spatial | step 3 | terms: presence, kitchen, allows

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "This timing contradicts the initial assumption of natural causes since the symptoms began later...."
   → contradiction | essential | mid | testimonial | step 1 | terms: timing, contradicts, initial

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The mechanism relies on drink, toast, and witness to expose the false timing...."
...
10. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Confronting Dr. Finch with the forensic residue evidence and kitchen access records...."
   → observation | essential | mid | spatial | terms: confronting, finch, forensic
...
11. Generate one essential mid-story clue whose description or pointsTo explicitly names Dr. Mallory Finch and states the unique trace, preparation detail, or mechanism link that points to Dr. Mallory Finch rather than any non-culprit.
   → observation | essential | mid | testimonial | terms: Dr. Mallory Finch, mechanism, relies, drink,
...
12. Generate one essential early-or-mid clue establishing that Dr. Mallory Finch UNIQUELY had the means/skill/access/knowledge required to execute the concealment mechanism, and that the other suspects did not — so the reveal relies only on this already-planted capability, never on a means introduced for the first time at the confrontation.
   → elimination | essential | mid | testimonial | terms: Dr. Mallory Finch, mechanism, relies, drink,

13. Generate a clue showing observable evidence of Dr. Mallory Finch's premeditation or planning (Jealousy). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: jealousy
...
- Captain Ivor Hale: sensitive items: Gambling debts
- Beatrice Quill: sensitive items: Past dealings with the victim
...
Create 2 red herrings that support the false assumption: "Hugo Vane must have died from natural causes due to his known health issues."
