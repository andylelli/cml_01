...
- Project ID: `unknown`
- Timestamp: `2026-05-14T18:25:55.805Z`
...
1. Generate a clue that makes the reader directly observe: "The clock shows ten minutes past eleven when it should have shown a quarter past twelve...."
   → observation | essential | early | temporal | step 1 | terms: clock, shows, minutes

2. Generate a clue that provides evidence for: "This indicates that the clock was tampered with to mislead the time of death...."
   → contradiction | essential | early | temporal | step 1 | terms: indicates, clock, tampered

3. Generate a clue that makes the reader directly observe: "The clock's mechanism appears worn, suggesting recent tampering...."
   → observation | essential | early | temporal | step 2 | terms: clock's, mechanism, appears

4. Generate a clue that provides evidence for: "The wear on the clock mechanism implies someone adjusted it shortly before the murder...."
   → contradiction | essential | early | temporal | step 2 | terms: clock, mechanism, implies

5. Generate a clue that makes the reader directly observe: "Dr. Mallory Finch was seen near the clock during the power outage...."
   → observation | essential | mid | temporal | step 3 | terms: mallory, finch, clock

6. Generate a clue that provides evidence for: "This places Dr. Mallory Finch at the scene when the clock could have been tampered with...."
   → contradiction | essential | mid | temporal | step 3 | terms: places, mallory, finch

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "This indicates that the clock was tampered with to mislead the time of death...."
   → contradiction | essential | mid | temporal | step 1 | terms: indicates, clock, tampered

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The mechanism relies on clock, murderer, and minut to expose the false timing...."
   → observation | essential | early | temporal | terms: mechanism, relies, clock,

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "The discriminating test compares clock, tamper, and minut against the claimed timeline...."
...
Create 2 red herrings that support the false assumption: "The victim was killed at midnight, as indicated by the clock's time."
...
Violations: 1. [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 1, 2, 3; words: clock) and may support the true solution.; 2. [critical] Red Herring Separation: Red herring rh_2 overlaps inference corrections (steps: 1, 2, 3; words: clock) and may support the true solution.
Warnings: None
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 1, 2, 3; words: clock) and may support the true solution.
  - [critical] Red Herring Separation: Red herring rh_2 overlaps inference corrections (steps: 1, 2, 3; words: clock) and may support the true solution.
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
