...
- Project ID: ``
- Timestamp: `2026-05-14T18:28:48.881Z`
...
• [clue_mechanism_visibility_core] The clock shows ten minutes past eleven when it should have shown a quarter past twelve.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: This suggests the clock is not showing the correct time.
...
Known location profile anchors: Little Middleton Manor, The Drawing Room, The Library, The Garden, the scene
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The Drawing Room", "The Library", "The Garden", "the scene"
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=5101; context=10112; dropped=[none]; truncated=[location_profiles, temporal_context]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The clock shows ten minutes past eleven when it should have shown a quarter past twelve. [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: This suggests the clock is not showing the correct time.
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The stopped clock found in the victim's hand — still showing ten minutes past eleven"
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor stares at the clock, her mind racing with fear and confusion."
      ]
    },
    "summary": "In the quiet morning after the murder, Eleanor Voss arrives at the scene, where Captain Hale, Beatrice Quill, and the doctor Finch await the detective's arrival. The tension is palpable as they discover the stopped clock showing ten minutes past eleven, indicating the time of death.",
    ...
    "emotionalRegister": "The story begins with an air of elegance and celebration, marred by the shadow of a recent murder.",
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 1: "The clock shows ten minutes past eleven when it should have shown a quarter past twelve." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
