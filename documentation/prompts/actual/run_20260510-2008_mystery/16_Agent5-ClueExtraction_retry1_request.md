...
- Project ID: `unknown`
- Timestamp: `2026-05-10T20:11:33.909Z`
...
1. Generate a clue that makes the reader directly observe: "The clock shows a faint scratch on its casing...."
   → observation | essential | early | temporal | step 1 | terms: clock, shows, faint

2. Generate a clue that provides evidence for: "This indicates recent tampering...."
   → contradiction | essential | early | testimonial | step 1 | terms: indicates, recent, tampering.

3. Generate a clue that makes the reader directly observe: "Witnesses recall hearing the clock chime at a different hour than displayed...."
   → observation | essential | early | temporal | step 2 | terms: witnesses, recall, hearing

4. Generate a clue that provides evidence for: "This suggests the clock was deliberately set to mislead...."
   → contradiction | essential | early | temporal | step 2 | terms: suggests, clock, deliberately

5. Generate a clue that makes the reader directly observe: "Beatrice was seen near the clock just before the murder...."
   → observation | essential | mid | temporal | step 3 | terms: beatrice, clock, before

6. Generate a clue that provides evidence for: "This implies she had the opportunity to tamper with the clock...."
   → contradiction | essential | mid | temporal | step 3 | terms: implies, opportunity, tamper

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "This indicates recent tampering...."
   → contradiction | essential | mid | testimonial | step 1 | terms: indicates, recent, tampering.

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The mechanism relies on the clock's tampering to expose the false timing...."
   → observation | essential | early | temporal | terms: mechanism, relies, clock's

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "A controlled demonstration proves the clock was tampered with at the time of the murder...."
   → observation | essential | mid | temporal | terms: controlled, demonstration, proves
...
10. Generate one essential mid-story clue whose description or pointsTo explicitly names Beatrice Quill and states the unique trace, preparation detail, or mechanism link that points to Beatrice Quill rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Beatrice Quill, mechanism, relies, clock's

11. Generate a clue showing observable evidence of Beatrice Quill's premeditation or planning (Fear of losing inheritance). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: losing, inheritance
...
## Access Constraints
Actors: Beatrice Quill, Dr. Mallory Finch, Captain Ivor Hale
...
Create 2 red herrings that support the false assumption: "The victim died shortly after the clock struck midnight."
...
Violations: 1. [critical] Clue Visibility: Essential clues required for the discriminating test are not all revealed before it.; 2. [critical] Information Parity: The detective has knowledge of the clock's tampering that is not fully conveyed to the reader.; 3. [critical] Logical Deducibility: The reader cannot logically deduce the solution due to the timing of the clues.; 4. [critical] Discriminating Test Timing: The discriminating test does not appear at the specified timing and relies on clues introduced after it.; 5. [critical] No Withholding: The detective knows about the clock's tampering before the reader does.
Warnings: Consider enhancing the clarity of the clues to improve reader engagement.; First-pass acceptance contract: essential early|mid mechanism, contradiction, and elimination clues; reader-solvable observation -> correction -> elimination chain before Act III.; Unified retry contract: keep cast-path coupling, discriminating evidence ID parity, and mechanism-visibility ordering non-conflicting in one output.
...
- must_fix[]:
  ...
  - [critical] Information Parity: The detective has knowledge of the clock's tampering that is not fully conveyed to the reader.
  - [critical] Logical Deducibility: The reader cannot logically deduce the solution due to the timing of the clues.
  - [critical] Discriminating Test Timing: The discriminating test does not appear at the specified timing and relies on clues introduced after it.
  - [critical] No Withholding: The detective knows about the clock's tampering before the reader does.
  - [warning] Consider enhancing the clarity of the clues to improve reader engagement.
...
- required_id_to_source_mappings[]:
  ...
  - clue_culprit_direct_beatrice_quill -> CASE.cast[3].access_plausibility
  - clue_core_contradiction_chain -> CASE.prose_requirements.clue_to_scene_mapping[2].clue_id
  - clue_fp_contradiction_step_2 -> CASE.prose_requirements.clue_to_scene_mapping[4].clue_id
  - clue_core_elimination_chain -> CASE.prose_requirements.clue_to_scene_mapping[6].clue_id
  ...
  - clue_fp_contradiction_step_3 -> CASE.prose_requirements.clue_to_scene_mapping[10].clue_id
  - clue_mechanism_visibility_core -> CASE.prose_requirements.clue_to_scene_mapping[11].clue_id
...
- required_direct_culprit_clue:
  - id=clue_culprit_direct_beatrice_quill | culprit=Beatrice Quill
  - allowed_source_paths=CASE.cast[3].access_plausibility, CASE.cast[3].alibi_window
  - required_phrases=Beatrice Quill, direct evidence, means and opportunity
