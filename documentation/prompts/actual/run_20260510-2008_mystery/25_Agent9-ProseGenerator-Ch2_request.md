...
- Project ID: ``
- Timestamp: `2026-05-10T20:14:48.677Z`
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As they began to discuss their next steps, Eleanor couldn't shake the feeling that the clock was more than just a timepiece; it was a harbinger of the chaos that had unfolded. The faint scratch on its casing, the eerie silence that enveloped them, and the weig..."
  • The next chapter must open as a continuation of this beat, not as a disconnected reset.
═══════════════════════════════════════════════════════

SCENE GROUNDING CHECKLIST (MUST FOLLOW):
Known location profile anchors: Middleton Manor, The Library, The Drawing Room, The Study, the village square
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Middleton Manor", "The Library", "The Drawing Room", "The Study", "the village square"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 2: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with spoken dialogue — e.g. '"[words]," [Name] said/asked/replied/murmured.' The opening quote must be the first character on the line. Anchor opening in "the village square". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=6200 tokens; fixed=6039; context=2481; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context]
...
- Chapter 2:
  ...
  - Location anchor: the village square.
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As they began to discuss their next steps, Eleanor couldn't shake the feeling that the clock was more than just a timepiece; it was a harbinger of the chaos that had unfolded. The faint scratch on its casing, the eerie s...".
...
[
  {
    ...
    "setting": {
      ...
      "atmosphere": "A bustling square, contrasting the earlier tension"
    },
    "characters": [
      "Eleanor Voss",
      "Dr. Mallory Finch",
    ...
    "dramaticElements": {
      ...
      "tension": "The clock’s timing discrepancies are highlighted.",
      "microMomentBeats": [
        "Dr. Finch pauses, recalling the exact moment the clock chimed."
      ]
    },
    "summary": "Eleanor interviews Dr. Finch and Hale in the village square, gathering witness statements about the night of the murder. They recount hearing the clock chime at odd intervals, raising questions about its reliability.",
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 2: "Witnesses recall hearing the clock chime at a different hour than displayed." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
