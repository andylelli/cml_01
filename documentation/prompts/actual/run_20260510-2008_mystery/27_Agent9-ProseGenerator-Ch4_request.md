...
- Project ID: ``
- Timestamp: `2026-05-10T20:15:16.100Z`
...
• [clue_3] Beatrice was seen near the clock just before the murder.
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: This implies she had the opportunity to tamper with the clock.
...
CLUES ALREADY REVEALED TO READER: clue_1, clue_2, clue_fp_contradiction_step_2_2, clue_fp_contradiction_step_3 — do not reveal these as new information.

CONTINUITY HANDOFF — previous chapter closing beat:
  • "Captain Hale leaned forward, his interest piqued. "So, if the clock was tampered with, it changes everything we know about the timeline leading up to the murder. We must find out who was near the clock during those crucial moments. This is critical to our inve..."
  • The next chapter must open as a continuation of this beat, not as a disconnected reset.
═══════════════════════════════════════════════════════

SCENE GROUNDING CHECKLIST (MUST FOLLOW):
Known location profile anchors: Middleton Manor, The Library, The Drawing Room, The Study, the library
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Middleton Manor", "The Library", "The Drawing Room", "The Study", "the library"
...
PROMPT BUDGET SUMMARY: budget=6200 tokens; fixed=8834; context=2590; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context]
...
- Chapter 4:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Captain Hale leaned forward, his interest piqued. "So, if the clock was tampered with, it changes everything we know about the timeline leading up to the murder. We must find out who was near the clock during those cruci...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • Beatrice was seen near the clock just before the murder. [clue_3]
      Points to: This implies she had the opportunity to tamper with the clock.
  - Tonal contrast: include at least one beat of relief or ironic counterpoint. Do not sustain maximum tension for every paragraph.
  - Sensory obligation — use at least two of: Raindrops streak the window, distorting the view of the garden beyond, where the fog clings to the grass., The dim light casts elongated shadows from the shelves, making the room feel even more cavernous. | The steady drumming of rain on the roof harmonizes with the crackling fire, creating a lullaby of sound., Occasional thunder rumbles in the distance, adding a sense of urgency to the quiet. | The dampness of the air carries the scent of wet earth, mingling with the musty aroma of the books.. Mood: oppressive.
...
[
  {
    ...
    "purpose": "Eleanor makes a crucial observation about the clock",
    "cluesRevealed": [
      "clue_3"
    ],
    "dramaticElements": {
      "conflict": "Eleanor feels the pressure of time running out.",
      "tension": "The clock's mechanism seems to hold the key.",
      "microMomentBeats": [
        "Eleanor brushes dust off a book, revealing a hidden note."
      ]
    },
    "summary": "In the library, Eleanor examines the clock's mechanism and recalls the witness statements. She realizes that Beatrice was near the clock just before the murder, raising her suspicions.",
    "estimatedWordCount": 1800,
    "emotionalRegister": "Eleanor's determination to uncover the truth intensifies, marking her transition into an amateur detective.",
    ...
    "locationRegisterNote": "The library feels heavy with secrets, each book a silent witness to the unfolding drama. Shadows flicker in the dim light, and the air is thick with the scent of aged paper, creating an atmosphere of both reverence and foreboding. It is a space where knowledge meets tragedy, amplifying the tension as characters confront their darkest fears amidst the echoing whispers of the past. — As a writer enters this space, the camera captures the interplay of light and shadow, emphasizing the conflict between knowledge and ignorance."
  }
]
```
