...
- Project ID: ``
- Timestamp: `2026-05-10T20:14:36.861Z`
...
Known location profile anchors: Middleton Manor, The Library, The Drawing Room, The Study, the scene of the clock tower
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Middleton Manor", "The Library", "The Drawing Room", "The Study", "the scene of the clock tower"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the scene of the clock tower". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season. These are validated requirements, not style suggestions; missing them triggers a retry.

PROMPT BUDGET SUMMARY: budget=6200 tokens; fixed=4649; context=2173; dropped=[humour_guide, location_profiles, texture_pool, world_document, character_personality, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context]
...
- Chapter 1:
  ...
  - Location anchor: the scene of the clock tower.
...
[
  {
    ...
    "dramaticElements": {
      "conflict": "The clock’s malfunction raises suspicion among the characters.",
      "tension": "Each character seems nervous about their involvement.",
      "microMomentBeats": [
        "Beatrice fidgets with her necklace, avoiding eye contact."
      ]
    },
    "summary": "As the morning light spills into the clock tower, Eleanor Voss arrives to find Captain Hale and Beatrice Quill already present. The atmosphere is thick with tension as they discuss the strange circumstances surrounding the victim's death, particularly the clock's erratic behavior.",
    "estimatedWordCount": 1800,
    "emotionalRegister": "The atmosphere is filled with anticipation as guests gather, masking an undercurrent of tension.",
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 1: "The clock shows a faint scratch on its casing." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
