...
- Project ID: `unknown`
- Timestamp: `2026-05-17T18:11:37.554Z`
...
1. Generate a clue that makes the reader directly observe: "The clock in the drawing room shows it stopped at nine o'clock...."
   → observation | essential | early | temporal | step 1 | terms: clock, drawing, shows

2. Generate a clue that provides evidence for: "This indicates that the time of death may be misrepresented...."
   → contradiction | essential | early | temporal | step 1 | terms: indicates, death, misrepresented.
...
4. Generate a clue that provides evidence for: "The scratch suggests that the clock has been tampered with...."
   → contradiction | essential | early | temporal | step 2 | terms: scratch, suggests, clock

5. Generate a clue that makes the reader directly observe: "Dr. Mallory Finch's alibi places her at the manor during the time of death...."
   → observation | essential | mid | temporal | step 3 | terms: mallory, finch's, alibi

6. Generate a clue that provides evidence for: "This creates an opportunity for her to tamper with the clock...."
   → contradiction | essential | mid | temporal | step 3 | terms: creates, opportunity, tamper

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "This indicates that the time of death may be misrepresented...."
   → contradiction | essential | mid | temporal | step 1 | terms: indicates, death, misrepresented.

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The mechanism relies on clock, indicat, and stopp to expose the false timing...."
   → observation | essential | early | temporal | terms: mechanism, relies, clock,

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "A controlled comparison of the clock's mechanism and the time of death established by witness accoun..."
...
Violations: 1. [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 2, 3; words: clock) and may support the true solution.; 2. [critical] Red Herring Separation: Red herring rh_2 overlaps inference corrections (steps: 2, 3; words: clock, creates) and may support the true solution.
Warnings: None
...
- must_fix[]:
  ...
  - [critical] Red Herring Separation: Red herring rh_2 overlaps inference corrections (steps: 2, 3; words: clock, creates) and may support the true solution.
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
