...
- Project ID: ``
- Timestamp: `2026-05-17T18:16:38.591Z`
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Dr. Finch is torn between her desire for professional recognition and her growing resentment towards the patriarchal structures that have stifled her career. She fears that her ambition may lead her down a morally compromising path, further alienating her from the very community she seeks to serve."
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Eleanor glanced back at the clock, its hands frozen at ten minutes past eleven. If the clock had indeed been tampered with, it would strengthen the case against Dr. Finch. She needed to confront the doctor with this evidence, but she had to tread carefully. Th..."
...
Known location profile anchors: Little Middleton Manor, The West Wing Library, The Drawing Room, The Servants' Hall, the drawing room, now a stage for confrontation
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The West Wing Library", "The Drawing Room", "The Servants' Hall", "the drawing room, now a stage for confrontation"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 8: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with spoken dialogue — e.g. '"[words]," [Name] said/asked/replied/murmured.' The opening quote must be the first character on the line. Anchor opening in "the drawing room, now a stage for confrontation". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Phrases to avoid (already overused in earlier chapters): "hands frozen at ten minutes past eleven", "eleanor felt a pang of sympathy for", "the rain continued its relentless patter against", "rain continued its relentless patter against the", "continued its relentless patter against the windows", "its hands frozen at ten minutes past", "frozen at ten minutes past eleven a", "the weight of the moment pressing down", "weight of the moment pressing down on", "felt a pang of sympathy for her".
[END INTERNAL DIAGNOSTICS]

PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=13168; context=10506; dropped=[none]; truncated=[pronoun_accuracy, location_profiles, temporal_context]
...
- Chapter 8:
  ...
  - Scene is set in: the drawing room, now a stage for confrontation — reference it naturally within the paragraph, never as your opening phrase.
  - Opening atmosphere (MANDATORY — validator enforced): the first paragraph MUST contain at least one of: rain / wind / fog / storm / mist / thunder / evening / morning / night / dawn / dusk / season / afternoon / midday / noon / midnight / twilight / sunrise / sunset / daylight / sunlight / overcast / cloudy / bright / dark / grey / pale / cold / warm / chill / crisp / damp / drizzle / haze / lamplight / firelight. A chapter that omits all of these from its opening paragraph will be rejected.
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Eleanor glanced back at the clock, its hands frozen at ten minutes past eleven. If the clock had indeed been tampered with, it would strengthen the case against Dr. Finch. She needed to confront the doctor with this evid...".
...
Chapter 8 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The mechanism of the clock that will be tested."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the groundwork for proving Dr. Finch's involvement in the tampering."
...
[
  {
    ...
    "emotionalRegister": "Tension peaks as Eleanor faces the truth about her friends and family.",
