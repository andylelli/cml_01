...
- Project ID: ``
- Timestamp: `2026-05-17T18:16:28.969Z`
...
Characters confront their motivations and desires, complicating their relationships.
...
Rationale: The seriousness of accusations does not lend itself to humor.
...
• [clue_1] A faint scratch is visible on the clock face.
  ...
  Points to: This may suggest tampering with the clock.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Eleanor's heart raced at this new revelation. "A creaking sound? That could mean someone else was in the house, perhaps even in the drawing room with Beatrice. We need to investigate further. If Dr. Finch had access to the clock, it could change everything we..."
...
Known location profile anchors: Little Middleton Manor, The West Wing Library, The Drawing Room, The Servants' Hall, the drawing room, now cluttered with evidence
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The West Wing Library", "The Drawing Room", "The Servants' Hall", "the drawing room, now cluttered with evidence"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 7: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the drawing room, now cluttered with evidence". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Phrases to avoid (already overused in earlier chapters): "hands frozen at ten minutes past eleven", "the weight of the moment pressing down", "weight of the moment pressing down on", "eleanor felt a pang of sympathy for", "the clock loomed ominously in the background", "the rain continued its relentless patter against", "rain continued its relentless patter against the", "continued its relentless patter against the windows", "its hands frozen at ten minutes past", "frozen at ten minutes past eleven a".
[END INTERNAL DIAGNOSTICS]

PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=12209; context=9977; dropped=[none]; truncated=[pronoun_accuracy, location_profiles, temporal_context]
...
- Chapter 7:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Eleanor's heart raced at this new revelation. "A creaking sound? That could mean someone else was in the house, perhaps even in the drawing room with Beatrice. We need to investigate further. If Dr. Finch had access to t...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • A faint scratch is visible on the clock face. [clue_1]
      Points to: This may suggest tampering with the clock.
...
Chapter 7 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The scratch on the clock that indicates tampering."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the clock has been tampered with, strengthening the case against Dr. Finch."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor's heart races as she scrutinizes the clock, piecing together the timeline."
      ]
    },
