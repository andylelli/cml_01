...
- Project ID: ``
- Timestamp: `2026-07-21T20:24:00.410Z`
...
The first investigative turn introduces false leads, deepening Eleanor's emotional cost as she battles her insecurities.
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Ivor grapples with the weight of his financial desperation, torn between his ambitions and the lengths he might go to achieve them."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Beatrice is tormented by her past choices, battling the fear that her secrets will be laid bare and destroy everything she has worked for."
...
• [clue_5] mallory, finch, observed, purchasing, unusual, quantities, salt, seafood
  Category: behavioral | Criticality: essential | Supports inference step 2
  Points to: mallory, finch, behavior, suggests, possible, planning

• [clue_1] tidal, schedule, shows, seawater, levels, peaked, time, death
  Category: temporal | Criticality: essential | Supports inference step 2
  Points to: tidal, conditions, time, death, relevant

• [clue_7] eliminates, sylvia, trent, because, seen, theater, time, death
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: alibi, excludes, sylvia, trent, suspicion

• [clue_early_1] bitter, almond, residue, near, body
  Category: physical | Criticality: essential | Supports inference step 3
  Points to: presence, residue, suggests, specific, type, poisoning
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_9, clue_late_1 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): hugo, reaction, suggests, possible, cause, death | shrimp, preparation, method, contradicts, assumption, immediate | hugo, behavior, provide, insight, state, before | hugo, reaction, suggests, possible, cause, death
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "The atmosphere in the hotel dining room remained tense, but a brief moment of relief flickered as the radio in the corner resumed its broadcast, filling the room with familiar melodies. The guests relaxed, if only for a heartbeat, before the tension returned...."
...
Known location profile anchors: The Crestview Hotel, The Beachfront Terrace, The Reading Room, The Grand Dining Room, The Staff Room, the hotel bar
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Crestview Hotel", "The Beachfront Terrace", "The Reading Room", "The Grand Dining Room", "The Staff Room", "the hotel bar"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=12815; context=10352; dropped=[humour_guide, location_profiles]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 4:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "The atmosphere in the hotel dining room remained tense, but a brief moment of relief flickered as the radio in the corner resumed its broadcast, filling the room with familiar melodies. The guests relaxed, if only for a...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • witnesses, mallory, finch, shopping [clue_5]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • tidal, schedule, indicates, peak, levels [clue_1]
      Points to: tidal, conditions, time, death, relevant
    • sylvia, trent, presence, theater, confirmed [clue_7]
      Points to: alibi, excludes, sylvia, trent, suspicion
    • residue, visible, near, body [clue_early_1]
      Points to: presence, residue, suggests, specific, type, poisoning
  - PLANT OBLIGATIONS (incidental appearances): each item below MUST appear in this chapter as a passing physical detail a character sees, handles, or walks past — with its significance UNFLAGGED:
    • residue, visible, near, body [plant:clue_10]
    • salt, shaker, residue, analyzed [plant:clue_3]
    • witnesses, recall, hugo, sudden, reaction [plant:clue_culprit_direct_1]
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Beatrice's confession about her relationship with Hugo."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that both Captain Hale and Beatrice had motives to harm Hugo, complicating the investigation."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor watches Captain Hale's eyes dart nervously, sensing his desperation."
      ]
    },
    ...
    "emotionalRegister": "The first investigative turn introduces false leads, deepening Eleanor's emotional cost as she battles her insecurities.",
