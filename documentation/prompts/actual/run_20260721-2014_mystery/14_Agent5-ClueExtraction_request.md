...
- Project ID: `unknown`
- Timestamp: `2026-07-21T20:18:29.347Z`
...
1. Generate a clue that makes the reader directly observe: "Witnesses confirm Hugo Vane had a sudden reaction after eating shrimp...."
   → observation | essential | early | temporal | step 1 | terms: witnesses, confirm, sudden

2. Generate a clue that provides evidence for: "The shrimp had been prepared with seawater, which may have diluted any poison present...."
   → contradiction | essential | early | testimonial | step 1 | terms: shrimp, prepared, seawater,

3. Generate a clue that makes the reader directly observe: "A salt shaker found in the victim's room contains residue consistent with the poison...."
   → observation | essential | early | spatial | step 2 | terms: shaker, found, victim's

4. Generate a clue that provides evidence for: "The poison was likely administered using the salt shaker...."
   → contradiction | essential | early | testimonial | step 2 | terms: poison, likely, administered

5. Generate a clue that makes the reader directly observe: "A tidal schedule shows seawater levels peaked at the time of death...."
   → observation | essential | mid | temporal | step 3 | terms: tidal, schedule, shows

6. Generate a clue that provides evidence for: "The seawater diluted the poison, delaying its effects...."
   → contradiction | essential | mid | testimonial | step 3 | terms: seawater, diluted, poison,

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The shrimp had been prepared with seawater, which may have diluted any poison present...."
   → contradiction | essential | mid | testimonial | step 1 | terms: shrimp, prepared, seawater,

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The mechanism relies on poison, seawater, and witness to expose the false timing...."
...
10. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Comparing the salt shaker's residue with a sample of the poison found in the kitchen proves the same..."
   → observation | essential | mid | testimonial | terms: comparing, shaker's, residue
...
13. Generate a clue showing observable evidence of Dr. Mallory Finch's premeditation or planning (Desperation for money.). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
...
Create 2 red herrings that support the false assumption: "Hugo Vane died from an allergic reaction to seafood."
