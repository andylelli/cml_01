...
- Project ID: ``
- Timestamp: `2026-07-21T20:23:38.051Z`
...
Unease rises as Eleanor begins her investigation, uncovering the complexities of the relationships around the victim.
...
Rationale: Eleanor's dry observations can add depth without undermining the tension.
...
• [clue_9] witnesses, noted, hugo, vane, appeared, anxious, before, dinner
  Category: behavioral | Criticality: essential | Supports inference step 1
  Points to: hugo, behavior, provide, insight, state, before, death

• [clue_late_1] witnesses, confirm, hugo, vane, sudden, reaction, eating, shrimp
...
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): hugo, reaction, suggests, possible, cause, death | shrimp, preparation, method, contradicts, assumption, immediate
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "A brief moment of relief flickered as the radio in the corner broadcast a familiar tune—Bing Crosby’s voice drifting through the uneasy silence. The guests relaxed, if only for a heartbeat, before the tension resumed its grip. Eleanor’s resolve hardened; the p..."
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=11211; context=12530; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 3:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "A brief moment of relief flickered as the radio in the corner broadcast a familiar tune—Bing Crosby’s voice drifting through the uneasy silence. The guests relaxed, if only for a heartbeat, before the tension resumed its...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • witnesses, observed, hugo, anxious, behavior [clue_9] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: hugo, behavior, provide, insight, state, before, death
    ...
    • witnesses, recall, hugo, sudden, reaction [clue_late_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: hugo, reaction, suggests, possible, cause, death
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
  ...
  - PLANT OBLIGATIONS (incidental appearances): each item below MUST appear in this chapter as a passing physical detail a character sees, handles, or walks past — with its significance UNFLAGGED:
    • captain, ivor, hale, presence, confirmed [plant:clue_core_elimination_chain]
    • suggests, poison, diluted [plant:clue_2]
    • food, plate, shows, residue [plant:clue_8]
...
Chapter 3 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Captain Hale's nervous fidgeting with his cufflinks."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Captain Hale appeared anxious before dinner, hinting at possible involvement."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor notices Captain Hale's twitchy fingers, betraying his anxiety."
      ]
    },
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 3: the clue [clue_9] (witnesses, noted, hugo, vane, appeared, anxious, before, dinner) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: the clue [clue_late_1] (witnesses, confirm, hugo, vane, sudden, reaction, eating, shrimp) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
