...
- Project ID: ``
- Timestamp: `2026-05-10T14:51:01.808Z`
...
Tone: Classic
Era decade: 1930s
Social norms: impact of the Great Depression on social classes, growing class tensions and societal divides, rise of fascism in Europe influencing local politics
Location description: A large, opulent country estate featuring grand architecture typical of the period, with sprawling gardens and a formal layout.
...
Access control: Certain areas of the manor are restricted, such as the study and library, accessible only to the owner and select staff., Daily routines of the household staff create predictable patterns of movement, influencing investigation timelines., Social hierarchies dictate who has access to various parts of the estate, impacting evidence discovery.
