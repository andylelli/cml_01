...
- Project ID: ``
- Timestamp: `2026-05-17T08:26:16.829Z`
...
- Era-authentic markers: petrol touring cars on county roads, domestic wiring with frequent outages, typewriters standard in offices, reliable automobiles for local travel, passenger trains as primary long-distance transport, early commercial aviation for select routes, party-line telephone exchanges common, telegrams sent via local post offices
- Tone: Classic
- No anachronisms
...
Description: A grand manor house with sprawling gardens, several outbuildings, and a large estate surrounding it, indicative of the wealth of its owners.
...
Setting constraints:
- Physical constraints: manor layout includes restricted areas such as the library and cellar, gardens provide natural barriers and hiding spots, weather can impact outdoor evidence collection
- Geographic isolation: The estate is situated several miles from the nearest town, limiting access to outside help.
- Access control: gates controlled by estate staff, restricted access to certain areas for non-family members, daily schedules and routines dictate movement within the house
...
- Social norms: Great Depression causing economic strain and class tensions, strict social hierarchies influencing interactions
