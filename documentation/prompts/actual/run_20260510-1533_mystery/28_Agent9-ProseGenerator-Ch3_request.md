...
- Project ID: ``
- Timestamp: `2026-05-10T15:40:44.598Z`
...
• [clue_fp_contradiction_step_2] This indicates the clock was manipulated to mislead about the time of death.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: This contradicts the timeline of the murder set by the tampered clock.

• [clue_fp_contradiction_step_2_2] The strike mechanism of the clock makes an unusual sound, suggesting tampering.
  Category: temporal | Criticality: essential | Supports inference step 2
  Points to: The unusual sound indicates recent manipulation of the clock.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "The silence stretched between them, heavy with unspoken truths. Finally, Eleanor broke the stillness. "What if we were to examine the clock more closely? Perhaps we can find evidence of tampering, something that could lead us to the truth." Dr. Finch hesitated..."
  • The next chapter must open as a continuation of this beat, not as a disconnected reset.
═══════════════════════════════════════════════════════

SCENE GROUNDING CHECKLIST (MUST FOLLOW):
Known location profile anchors: Little Middleton Manor, The Library, The Drawing Room, The Cellar, the Finch residence, dining room
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The Library", "The Drawing Room", "The Cellar", "the Finch residence, dining room"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 3: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with an explicit time marker — e.g. "At half past nine…" / "At midnight…" / "At a quarter to eleven…" / "At half past nine at night…". Time must be in the first clause. Anchor opening in "the Finch residence, dining room". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=6200 tokens; fixed=7568; context=2729; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context]
...
- Chapter 3:
  ...
  - Location anchor: the Finch residence, dining room.
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "The silence stretched between them, heavy with unspoken truths. Finally, Eleanor broke the stillness. "What if we were to examine the clock more closely? Perhaps we can find evidence of tampering, something that could le...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • This indicates the clock was manipulated to mislead about the time of death. [clue_fp_contradiction_step_2] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: This contradicts the timeline of the murder set by the tampered clock.
    ...
    • The strike mechanism of the clock makes an unusual sound, suggesting tampering. [clue_fp_contradiction_step_2_2] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: The unusual sound indicates recent manipulation of the clock.
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
...
[
  {
    ...
    "setting": {
      "location": "the Finch residence, dining room",
      "timeOfDay": "Early afternoon",
      "atmosphere": "Building tension with a sense of urgency"
    },
    "characters": [
      "Eleanor Voss",
      "Dr. Mallory Finch"
    ],
    "purpose": "Eleanor commits to the investigation, setting the stakes",
    "cluesRevealed": [
      "clue_fp_contradiction_step_2",
      "clue_fp_contradiction_step_2_2"
    ],
    "dramaticElements": {
      "conflict": "Eleanor feels the weight of the mystery pressing on her.",
      "tension": "The stakes rise as Eleanor realizes the implications of the clock's malfunction.",
      "microMomentBeats": [
        "Eleanor takes a deep breath, steeling herself for the challenges ahead."
      ]
    },
    "summary": "Eleanor resolves to uncover the truth behind the murder and the clock's role in it. She notes the unusual sound of the clock's strike mechanism and the implications it has for the timeline of the murder.",
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 3: "This indicates the clock was manipulated to mislead about the time of death." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: "The strike mechanism of the clock makes an unusual sound, suggesting tampering." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: "Witnesses recall the clock showing a different time just before the murder." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
