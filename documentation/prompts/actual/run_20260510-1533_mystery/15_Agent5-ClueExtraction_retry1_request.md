...
- Project ID: `unknown`
- Timestamp: `2026-05-10T15:36:09.625Z`
...
1. Generate a clue that makes the reader directly observe: "Witnesses recall the clock showing a different time just before the murder...."
   → observation | essential | early | temporal | step 1 | terms: witnesses, recall, clock

2. Generate a clue that provides evidence for: "This indicates the clock was manipulated to mislead about the time of death...."
   → contradiction | essential | early | temporal | step 1 | terms: indicates, clock, manipulated

3. Generate a clue that makes the reader directly observe: "The strike mechanism of the clock makes an unusual sound, suggesting tampering...."
   → observation | essential | early | temporal | step 2 | terms: strike, mechanism, clock

4. Generate a clue that provides evidence for: "The unusual sound indicates recent manipulation of the clock...."
   → contradiction | essential | early | temporal | step 2 | terms: unusual, sound, indicates

5. Generate a clue that makes the reader directly observe: "The kettle shows signs of having been recently used...."
   → observation | essential | mid | testimonial | step 3 | terms: kettle, shows, signs

6. Generate a clue that provides evidence for: "This contradicts the timeline of the murder set by the tampered clock...."
   → contradiction | essential | mid | temporal | step 3 | terms: contradicts, timeline, murder

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "This indicates the clock was manipulated to mislead about the time of death...."
   → contradiction | essential | mid | temporal | step 1 | terms: indicates, clock, manipulated

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The mechanism relies on clock, alibi, and witness to expose the false timing...."
   → observation | essential | early | temporal | terms: mechanism, relies, clock,

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Comparing the clock's internal mechanism with a fresh clock shows a discrepancy in spring tension th..."
   → observation | essential | mid | temporal | terms: comparing, clock's, internal

10. Generate one essential mid-story clue whose description or pointsTo explicitly names Dr. Mallory Finch and states the unique trace, preparation detail, or mechanism link that points to Dr. Mallory Finch rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Dr. Mallory Finch, mechanism, relies, clock,

11. Generate a clue showing observable evidence of Dr. Mallory Finch's premeditation or planning (Jealousy over the victim's inheritance plans.). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: jealousy, victim's, inheritance

12. Generate a clue that explicitly eliminates suspect Captain Ivor Hale using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Captain Ivor Hale because ...").
   → elimination | essential | mid | testimonial | terms: Captain Ivor Hale

13. Generate a clue that explicitly eliminates suspect Beatrice Quill using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Beatrice Quill because ...").
   → elimination | essential | mid | testimonial | terms: Beatrice Quill

14. Generate one essential early or mid elimination clue that explicitly rules out Captain Ivor Hale and narrows the solution toward culprit Dr. Mallory Finch. The pointsTo text must start with "Eliminates Captain Ivor Hale because ..." and cite corroborated evidence.
   → elimination | essential | mid | testimonial | terms: Captain Ivor Hale, Dr. Mallory Finch
...
- Eleanor Voss: sensitive items: Sensitive to timing discrepancies
- Dr. Mallory Finch: sensitive items: Sensitive to medical evidence
- Captain Ivor Hale: sensitive items: Sensitive to financial records
- Beatrice Quill: sensitive items: Sensitive to estate reputation
...
Create 2 red herrings that support the false assumption: "The time of death must align with the victim's last known movements."
...
Violations: 1. [critical] Clue Visibility: Essential clues required for the discriminating test are not all revealed before it.; 2. [critical] Information Parity: The detective has information about the clock's internal mechanism that the reader does not.; 3. [critical] Logical Deducibility: The reader cannot logically deduce the solution due to the absence of a clear deduction path.; 4. [critical] Discriminating Test Timing: Essential clues for the discriminating test are not adequately established beforehand.; 5. [critical] No Withholding: The detective knows about the clock's internal mechanism, which is not disclosed to the reader until the discriminating test.; 6. [critical] Solution Uniqueness: Lack of earlier elimination clues creates ambiguity about the solution until the end.
...
Recommendations: Introduce earlier clues that hint at the internal mechanism of the clock.; Ensure all essential clues are revealed before the discriminating test.; Provide a clear observation -> correction -> elimination chain leading to the solution.
...
- CASE.prose_requirements.clue_to_scene_mapping[17].clue_id
...
- REQUIRED CLUE CONTENT (must be covered by essential early/mid clues):
  ...
  - solution_uniqueness
- must_fix[]:
  - [critical] Clue Visibility: Essential clues required for the discriminating test are not all revealed before it.
  - [critical] Information Parity: The detective has information about the clock's internal mechanism that the reader does not.
  - [critical] Logical Deducibility: The reader cannot logically deduce the solution due to the absence of a clear deduction path.
  - [critical] Discriminating Test Timing: Essential clues for the discriminating test are not adequately established beforehand.
  - [critical] No Withholding: The detective knows about the clock's internal mechanism, which is not disclosed to the reader until the discriminating test.
  - [critical] Solution Uniqueness: Lack of earlier elimination clues creates ambiguity about the solution until the end.
...
- required_id_to_source_mappings[]:
  ...
  - clue_culprit_direct_dr_mallory_finch -> CASE.cast[1].access_plausibility
  - clue_mechanism_visibility_core -> CASE.prose_requirements.clue_to_scene_mapping[0].clue_id
  - clue_core_contradiction_chain -> CASE.prose_requirements.clue_to_scene_mapping[1].clue_id
  - clue_fp_contradiction_step_2 -> CASE.prose_requirements.clue_to_scene_mapping[4].clue_id
  - clue_core_elimination_chain -> CASE.prose_requirements.clue_to_scene_mapping[5].clue_id
  - clue_4 -> CASE.prose_requirements.clue_to_scene_mapping[6].clue_id
  - clue_10 -> CASE.prose_requirements.clue_to_scene_mapping[8].clue_id
  - clue_11 -> CASE.prose_requirements.clue_to_scene_mapping[9].clue_id
  - clue_12 -> CASE.prose_requirements.clue_to_scene_mapping[10].clue_id
  - clue_5 -> CASE.prose_requirements.clue_to_scene_mapping[11].clue_id
  - clue_6 -> CASE.prose_requirements.clue_to_scene_mapping[12].clue_id
  - clue_7 -> CASE.prose_requirements.clue_to_scene_mapping[13].clue_id
  - clue_8 -> CASE.prose_requirements.clue_to_scene_mapping[14].clue_id
  - clue_9 -> CASE.prose_requirements.clue_to_scene_mapping[15].clue_id
  - clue_fp_contradiction_step_3 -> CASE.prose_requirements.clue_to_scene_mapping[17].clue_id
...
- required_direct_culprit_clue:
  - id=clue_culprit_direct_dr_mallory_finch | culprit=Dr. Mallory Finch
  - allowed_source_paths=CASE.cast[1].access_plausibility, CASE.cast[1].alibi_window, CASE.cast[1].evidence_sensitivity[0]
  - required_phrases=Dr. Mallory Finch, direct evidence, means and opportunity
...
- cast_path_binding_rules[]:
  - CAST PATH COUPLING CONTRACT: If sourceInCML is CASE.cast[N].*, suspect references in description/pointsTo must match cast[N].name exactly.
  - CAST PATH COUPLING CONTRACT: Never rewrite suspect names independently of sourceInCML cast index binding.
  - cast_index_to_name_map[0] = Eleanor Voss
  - cast_index_to_name_map[1] = Dr. Mallory Finch
  - cast_index_to_name_map[2] = Captain Ivor Hale
  - cast_index_to_name_map[3] = Beatrice Quill
