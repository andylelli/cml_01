...
- Project ID: ``
- Timestamp: `2026-05-10T15:39:23.955Z`
...
• [clue_mechanism_visibility_core] Witnesses recall the clock showing a different time just before the murder.
...
Known location profile anchors: Little Middleton Manor, The Library, The Drawing Room, The Cellar, the Finch residence
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The Library", "The Drawing Room", "The Cellar", "the Finch residence"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the Finch residence". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season. These are validated requirements, not style suggestions; missing them triggers a retry.

PROMPT BUDGET SUMMARY: budget=6200 tokens; fixed=4641; context=2179; dropped=[humour_guide, location_profiles, texture_pool, world_document, character_personality, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • Witnesses recall the clock showing a different time just before the murder. [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: This suggests that the time of death may have been misrepresented.
...
[
  {
    ...
    "setting": {
      ...
      "atmosphere": "Tense household with whispers of shock"
    },
    "characters": [
      "Eleanor Voss",
      "Dr. Mallory Finch"
    ...
    "dramaticElements": {
      "conflict": "The household is in turmoil over the shocking murder.",
      "tension": "Dr. Finch's nervous demeanor raises suspicions.",
      "microMomentBeats": [
        "Eleanor notices Dr. Finch's trembling hands as he pours tea."
      ]
    },
    "summary": "Eleanor Voss, a local resident, arrives at the Finch residence to find the doctor Finch in distress over the murder of an unknown victim. The clock in the room has stopped, casting doubt on the time of death.",
    "estimatedWordCount": 1800,
    "emotionalRegister": "Eleanor feels a mix of confidence and anxiety as she navigates the garden party.",
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 1: "Witnesses recall the clock showing a different time just before the murder." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
