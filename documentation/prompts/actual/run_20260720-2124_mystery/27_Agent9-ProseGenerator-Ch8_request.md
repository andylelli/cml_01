...
- Project ID: ``
- Timestamp: `2026-07-20T21:38:21.604Z`
...
• [clue_late_optional_slot_1] dinner, service, start, remains, late, texture, detail, case, background
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "A gust of wind swept through the garden, scattering a handful of brittle leaves across the gravel. Eleanor let the cold clear her mind, the relief of action pushing back the fatigue. She would not rest—not yet. The secrets had surfaced, and with them, the path..."
...
Render this test MECHANISM as live, in-scene action and dialogue, composing ENTIRELY in your own words from these elements (reproducing any briefing phrase verbatim FAILS validation): discriminating, compares, dinner, decanter, fingerprint, claimed, timeline
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=22864; context=4858; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 8:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "A gust of wind swept through the garden, scattering a handful of brittle leaves across the gravel. Eleanor let the cold clear her mind, the relief of action pushing back the fatigue. She would not rest—not yet. The secre...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • dinner, service, start, remains, late, texture, detail, case, background [clue_late_optional_slot_1]
      Points to: adds, late, texture, changing, essential, deduction, chain
  ...
  - ⚠ SUSPECT CLEARANCE REQUIRED (MANDATORY): each suspect below MUST be named explicitly and cleared with on-page evidence and a reasoning connector (because / therefore / which proves):
    • "Captain Ivor Hale": write a dedicated paragraph that (a) names Captain Ivor Hale explicitly, (b) states the clearance method ("Proven to be in the office during the time of the murder."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
    • "Hugo Vane": write a dedicated paragraph that (a) names Hugo Vane explicitly, (b) states the clearance method ("Witnesses confirm he was discussing art with guests when the poison was administered."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
    • "Beatrice Quill": write a dedicated paragraph that (a) names Beatrice Quill explicitly, (b) states the clearance method ("Confirmed to have been in another part of the hotel during the incident."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
  ...
  - ⚠ DISCRIMINATING TEST (trap) — MANDATORY real-time scene with dialogue and confrontation. DO NOT summarize it after the fact.
    ...
    Elements the test must dramatize (compose the scene ENTIRELY in your own sentences from these — reproducing any briefing phrase verbatim FAILS validation): discriminating, compares, dinner, decanter, fingerprint, claimed, timeline
    Cite these already-revealed clue IDs during the test: clue_2, clue_culprit_direct_1, clue_8, clue_fp_contradiction_step_1
    Eliminate on-page with explicit evidence: "Captain Ivor Hale", "Beatrice Quill", "Hugo Vane" — state EXACTLY why each is ruled out (because / therefore / which proves).
...
Chapter 8 (Act 3) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The decanter and the evidence linking Dr. Finch to the crime."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the connection between Dr. Finch and the poisoned drink, revealing her guilt."
...
[
  {
    ...
    "dramaticElements": {
      "conflict": "Eleanor confronts the suspects.",
      "tension": "The atmosphere is thick with suspense.",
      "microMomentBeats": [
        "Eleanor's heart pounds as she prepares to reveal the truth."
      ]
    },
    "summary": "Eleanor gathers the suspects in the dining room, where she sets up a test involving the decanter and the timeline of events. As she reveals the evidence linking Dr. Finch to the decanter, the tension escalates, and she observes Dr. Finch's reaction closely, noting her nervousness.",
    "beat": "final_trap",
    "estimatedWordCount": 1800,
    "pivotElement": "The decanter and the evidence linking Dr. Finch to the crime.",
    "factEstablished": "Establishes the connection between Dr. Finch and the poisoned drink, revealing her guilt.",
    ...
    "emotionalRegister": "The tension escalates as Eleanor prepares for a confrontation with the suspects.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 8: the clue [clue_2] (decanter, used, serving, dinner, fingerprints, match, finch) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
