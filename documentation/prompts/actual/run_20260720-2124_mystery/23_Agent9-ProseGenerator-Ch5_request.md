...
- Project ID: ``
- Timestamp: `2026-07-20T21:36:20.711Z`
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Eleanor grapples with her feelings for Ivor, torn between her professional integrity and her personal desires, questioning if love can coexist with truth."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Ivor struggles with the trauma of his experiences and the fear of exposing his vulnerabilities, leading to a deep internal conflict about his identity and worth."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Beatrice struggles between her ambition as an artist and the moral implications of her actions, torn between love and career aspirations."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Hugo wrestles with his jealousy towards Eleanor and the lengths he is willing to go to secure his place in the journalism world, leading to a moral quandary."
...
• [clue_5] eliminates, captain, ivor, hale, because, confirmed, alibi
  Category: elimination | Criticality: essential | Supports inference step 2
  Points to: captain, ivor, hale, cannot, murderer

• [clue_6] eliminates, hugo, vane, because, town, night, murder
  Category: elimination | Criticality: essential | Supports inference step 2
  Points to: hugo, vane, cannot, murderer

• [clue_late_1] time, sylvia, collapse, shortly, dinner, service
  Category: temporal | Criticality: essential | Supports inference step 2
  Points to: timeline, supports, theory, poisoning
...
CLUES ALREADY REVEALED TO READER: clue_culprit_direct_dr_mallory_finch, clue_mid_1, clue_fp_contradiction_step_1, clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_2, clue_4, clue_7, clue_1, clue_3, clue_early_1 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): direct, shows, mallory, finch, means, opportunity | mechanism, murder, involves, decanter, tincture | indicates, finch, last, person, handle, decanter | mechanism, murder, involves, decanter, tincture | indicates, possible, poisoning | finch, involvement, murder, suggested | sylvia, condition, raises, suspicion, foul, play | presence, poison, sylvia, drink | finch, behavior, raises, suspicion, involvement | finch, behavior, point, involvement, crime | physical, trace, opportunity, indicate, mallory, finch
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "She pressed her forehead to the cold glass, her breath fogging the pane. Outside, the wind carried the distant sound of waves. Inside, the truth remained just out of reach, tangled in the web of secrets and lies. Eleanor’s resolve hardened. She would follow th..."
...
Known location profile anchors: The Seabreeze Hotel, Grand Lobby, Dining Room, Kitchen, Beach, the hotel foyer
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Seabreeze Hotel", "Grand Lobby", "Dining Room", "Kitchen", "Beach", "the hotel foyer"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 5: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a temporal subordinate clause — e.g. "When [Name] entered…" / "After the last guest…" / "Before the household had stirred…" / "As the light faded…". Anchor opening in "the hotel foyer". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=14653; context=7340; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 5:
  ...
  - Scene is set in: the hotel foyer — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "She pressed her forehead to the cold glass, her breath fogging the pane. Outside, the wind carried the distant sound of waves. Inside, the truth remained just out of reach, tangled in the web of secrets and lies. Eleanor...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • finch, fidgets, avoids, contact, questioning [clue_1]
      Points to: finch, behavior, raises, suspicion, involvement
    • captain, ivor, hale, seen, local, tavern, time, murder [clue_5]
      Points to: captain, ivor, hale, cannot, murderer
    • hugo, vane, travel, records, confirm, absence [clue_6]
      Points to: hugo, vane, cannot, murderer
    • witnesses, note, time, incident [clue_late_1]
      Points to: timeline, supports, theory, poisoning
...
Chapter 5 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Beatrice Quill's incomplete alibi, leaving her vulnerable to suspicion."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Beatrice's alibi is incomplete, raising her profile in the investigation."
...
[
  {
    ...
    "title": "Alibi Check",
    "setting": {
      "location": "the hotel foyer",
      "timeOfDay": "Late afternoon",
      "atmosphere": "Anxious, as time runs out for the suspects"
    },
    "characters": [
      "Eleanor Voss",
      "Captain Ivor Hale",
    ...
    "dramaticElements": {
      "conflict": "Tensions mount as alibis are scrutinized.",
      "tension": "Suspects become defensive.",
      "microMomentBeats": [
        "Eleanor notices Hugo's sweating hands as he speaks."
      ]
    },
    "summary": "Eleanor checks the alibis of the suspects, confirming Captain Hale's and Hugo Vane's claims, which clear them of suspicion. Beatrice Quill's whereabouts during the crucial time remain uncertain, and Eleanor senses her defensiveness as she struggles to provide a complete account.",
    "beat": "alibis",
    "estimatedWordCount": 1800,
    "pivotElement": "Beatrice Quill's incomplete alibi, leaving her vulnerable to suspicion.",
    "factEstablished": "Establishes that Beatrice's alibi is incomplete, raising her profile in the investigation.",
    ...
    "emotionalRegister": "A shocking revelation about Finch's past alters the direction of the investigation.",
