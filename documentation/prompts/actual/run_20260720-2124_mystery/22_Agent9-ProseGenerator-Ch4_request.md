...
- Project ID: ``
- Timestamp: `2026-07-20T21:35:21.265Z`
...
A breakthrough leads Eleanor to suspect Dr. Finch, adding complexity to her investigation.
...
Rationale: The tension of the moment leaves no room for humor.
...
• [clue_1] finch, exhibits, nervous, behavior, questioned, tincture
  Category: physical | Criticality: essential | Supports inference step 3
  Points to: finch, behavior, raises, suspicion, involvement

• [clue_3] finch, reaction, questions, tincture, shows, signs, anxiety
  Category: behavioral | Criticality: essential | Supports inference step 3
  Points to: finch, behavior, point, involvement, crime

• [clue_early_1] direct, links, mallory, finch, mechanism, access, point, before, discriminating, excludes, competing, suspect
...
CLUES ALREADY REVEALED TO READER: clue_culprit_direct_dr_mallory_finch, clue_mid_1, clue_fp_contradiction_step_1, clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_2, clue_4, clue_7 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): direct, shows, mallory, finch, means, opportunity | mechanism, murder, involves, decanter, tincture | indicates, finch, last, person, handle, decanter | mechanism, murder, involves, decanter, tincture | indicates, possible, poisoning | finch, involvement, murder, suggested | sylvia, condition, raises, suspicion, foul, play | presence, poison, sylvia, drink
...
corridor, lobby, dining room, kitchen, parlor
...
Chapter 3: Chapter 3: The Investigation Begins
  Events: By early afternoon, the hotel parlor was steeped in a cold, persistent quiet, the kind that settles after a storm of voices.
...
Known location profile anchors: The Seabreeze Hotel, Grand Lobby, Dining Room, Kitchen, Beach, the hotel library
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Seabreeze Hotel", "Grand Lobby", "Dining Room", "Kitchen", "Beach", "the hotel library"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=13197; context=10693; dropped=[humour_guide, location_profiles, texture_pool]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 4:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "She allowed herself a moment of ironic relief—a dry thought that, for once, the clocks’ unreliability was the least of her problems. Outside, the wind howled against the glass, but inside, the real storm was just beginni...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • eleanor, voss, confirmed, captain, ivor, hale [clue_core_elimination_chain]
      Points to: eleanor, voss, cannot, murderer
    • finch, fidgets, avoids, contact, questioning [clue_1]
      Points to: finch, behavior, raises, suspicion, involvement
    • finch, hands, tremble, slightly, discussing, tincture [clue_3]
      Points to: finch, behavior, point, involvement, crime
    • decanter, used, serving, dinner, fingerprints, match, finch [clue_early_1]
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The nervous behavior of Dr. Finch when questioned about the tincture."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that multiple suspects had motives, complicating the investigation."
...
[
  {
    ...
    "setting": {
      ...
      "timeOfDay": "Afternoon",
      "atmosphere": "Quiet tension as secrets begin to surface"
    },
    "characters": [
      "Eleanor Voss",
      "Captain Ivor Hale",
    ...
    "purpose": "Explore motives and hidden tensions among suspects",
    "cluesRevealed": [
      "clue_1",
      "clue_3",
      "clue_early_1"
    ...
    "dramaticElements": {
      "conflict": "Suspects try to fend off suspicion.",
      "tension": "Accusations begin to fly.",
      "microMomentBeats": [
        "Eleanor catches a glimpse of fear in Ivor's eyes."
      ]
    },
    "summary": "Eleanor interviews the suspects in the library, revealing potential motives. Captain Hale fears exposure of personal struggles, Hugo Vane feels threatened by Eleanor's talent, and Beatrice Quill is desperate to protect her career from scandal. Eleanor notes Dr. Finch's nervousness when questioned about the tincture, indicating a possible connection to the motive.",
    "beat": "motives",
    "estimatedWordCount": 1800,
    "pivotElement": "The nervous behavior of Dr. Finch when questioned about the tincture.",
    ...
    "emotionalRegister": "A breakthrough leads Eleanor to suspect Dr. Finch, adding complexity to her investigation.",
