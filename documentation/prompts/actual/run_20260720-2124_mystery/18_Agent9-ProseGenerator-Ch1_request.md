...
- Project ID: ``
- Timestamp: `2026-07-20T21:32:54.873Z`
...
- Eleanor Voss
  ...
  Connection to victim: Sylvia respects Eleanor for her work but feels threatened by her presence.; Sylvia has hosted Eleanor several times, always feeling overshadowed by her success..
...
• [clue_mid_1] mechanism, relies, tincture, dinner, decanter, expose, false, timing
  Category: testimonial | Criticality: essential | Supports inference step 1
  Points to: mechanism, murder, involves, decanter, tincture

• [clue_fp_contradiction_step_1] decanter, used, serving, dinner, fingerprints, match, finch
  Category: testimonial | Criticality: essential | Supports inference step 1
...
Known location profile anchors: The Seabreeze Hotel, Grand Lobby, Dining Room, Kitchen, Beach, the scene
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Seabreeze Hotel", "Grand Lobby", "Dining Room", "Kitchen", "Beach", "the scene"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=8066; context=9607; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The body of Dr. Mallory Finch lying on the floor, indicating foul play."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Dr. Mallory Finch is the victim, heightening the stakes for the investigation."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Sylvia stares blankly at the floor, struggling to hold back tears."
      ]
    },
    "summary": "Eleanor Voss arrives at the coastal hotel, where the atmosphere is thick with tension. She discovers Sylvia Trent standing in shock, staring at the lifeless body of Dr. Mallory Finch, who lies sprawled on the floor. As Eleanor processes the scene, she notes the conflicting expressions of the gathered guests, each of whom had access to the victim.",
    "beat": "gathering",
    "estimatedWordCount": 1800,
    "pivotElement": "The body of Dr. Mallory Finch lying on the floor, indicating foul play.",
    "factEstablished": "Establishes that Dr. Mallory Finch is the victim, heightening the stakes for the investigation.",
    ...
    "emotionalRegister": "The story opens with a vibrant yet tense atmosphere, setting the stage for the unfolding mystery.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (mechanism, relies, tincture, dinner, decanter, expose, false, timing) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
...
□ Chapter 1: the clue [clue_mid_1] (mechanism, relies, tincture, dinner, decanter, expose, false, timing) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_fp_contradiction_step_1] (decanter, used, serving, dinner, fingerprints, match, finch) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
