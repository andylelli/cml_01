...
- Project ID: ``
- Timestamp: `2026-07-20T21:40:26.784Z`
...
PRIMARY FAILURES
- Chapter 10: Chapter 10 contains control-plane leakage (obligation_term): "'Clue obligation: suspect clearance missing for "Captain Ivor Hale"." (Remove prompt, validation, retry, or scaffold terminology from reader-facing prose)
- Chapter 10: Chapter 10 contains control-plane leakage (obligation_term): "'Clue obligation: suspect clearance missing for "Hugo Vane"." (Remove prompt, validation, retry, or scaffold terminology from reader-facing prose)
- Chapter 10: Chapter 10 contains control-plane leakage (obligation_term): "'Clue obligation: suspect clearance missing for "Beatrice Quill"." (Remove prompt, validation, retry, or scaffold terminology from reader-facing prose)
...
ATTEMPT: 2/3
OFFENDING TEXT: 'Clue obligation: suspect clearance missing for 
MANDATORY FIXES:
- Resolve continuity issues before accepting this batch.
- Chapter 10: Chapter 10 contains control-plane leakage (obligation_term): "'Clue obligation: suspect clearance missing for "Captain Ivor Hale"." (Remove prompt, validation, retry, or scaffold terminology from reader-facing prose)
- Chapter 10: Chapter 10 contains control-plane leakage (obligation_term): "'Clue obligation: suspect clearance missing for "Hugo Vane"." (Remove prompt, validation, retry, or scaffold terminology from reader-facing prose)
