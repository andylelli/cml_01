...
- Project ID: ``
- Timestamp: `2026-07-21T19:58:21.507Z`
...
**Setting**: 1940s - A seaside hotel featuring Art Deco architecture, popular among vacationers and business travelers, with a view of the ocean.
**Crime Type**: Murder
**Social Context**: post-WWII recovery, increased female workforce participation, emerging Cold War tensions
**Tone**: Classic
