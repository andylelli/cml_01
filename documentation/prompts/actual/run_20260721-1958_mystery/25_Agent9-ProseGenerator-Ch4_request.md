...
- Project ID: ``
- Timestamp: `2026-07-21T20:06:44.315Z`
...
A pivotal clue shifts the investigation's focus, deepening the mystery.
...
Rationale: The high stakes of the investigation prevent any humor from feeling appropriate.
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Struggles with the fear of being exposed for her affair and the lengths she is willing to go to protect her career."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Struggles with the fear of being exposed for her gambling, torn between her professional responsibilities and her personal indulgences."
...
• [clue_11] mallory, finch, shows, signs, professional, jealousy, towards, hugo
  Category: behavioral | Criticality: essential | Supports inference step 2
  Points to: mallory, finch, suspect

• [clue_12] eliminates, sylvia, trent, because, gala, multiple, witnesses
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_culprit_direct_dr_mallory_finch, clue_mid_1, clue_core_contradiction_chain, clue_3, clue_4, clue_7, clue_early_1 — do not reveal these as new information.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "The morning wore on, the rain intensifying against the windows. Eleanor’s understanding of the clues evolved: the bloodied heavy object near Hugo Vane’s body, the stopped pendulum, the dust, and the conflicting accounts all demanded a new interpretation. She r..."
...
- Phrases to avoid (already overused in earlier chapters): "the grandfather clock its hands frozen at", "grandfather clock its hands frozen at five", "clock its hands frozen at five minutes", "its hands frozen at five minutes to", "hands frozen at five minutes to ten", "i saw hugo just before the gala", "saw hugo just before the gala he", "hugo just before the gala he said", "just before the gala he said his", "he was alive i m certain eleanor".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=12850; context=10839; dropped=[humour_guide, location_profiles, texture_pool, continuity_context]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 4:
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • witnesses, confirm, sylvia, presence, gala [clue_12]
      Points to: sylvia, trent, suspect
  - PLANT OBLIGATIONS (incidental appearances): each item below MUST appear in this chapter as a passing physical detail a character sees, handles, or walks past — with its significance UNFLAGGED:
    • pendulum, swinging [plant:clue_culprit_direct_1]
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Dr. Mallory Finch's jealousy towards Hugo."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Dr. Mallory Finch harbored professional jealousy towards the victim, revealing a potential motive."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_2] Eleanor notices the clock's face appears polished, suggesting recent tampering.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor catches a glimpse of Dr. Finch's uneasy expression as she mentions Hugo's philanthropy."
      ]
    },
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_2",
      "placementDetail": "Eleanor notices the clock's face appears polished, suggesting recent tampering."
    },
    "emotionalRegister": "A pivotal clue shifts the investigation's focus, deepening the mystery.",
