...
- Project ID: ``
- Timestamp: `2026-07-19T13:16:40.967Z`
...
• [clue_15] eliminates, captain, ivor, hale, because, duty, time, incident
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: captain, ivor, hale, committed, crime

• [clue_16] eliminates, beatrice, quill, because, guests, until, quarter, past, eleven
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: beatrice, quill, involved, drowning

• [clue_late_2] hugo, vane, seen, arguing, victim, shortly, before, death
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_mid_1, clue_mid_3, clue_core_contradiction_chain, clue_mid_2, clue_3, clue_4, clue_culprit_direct_hugo_vane, clue_5, clue_6, clue_early_1, clue_11, clue_17, clue_late_1 — do not reveal these as new information.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the door closed behind Beatrice, Eleanor remained by the fire, the hush of the library pressing in. The rain had nearly stopped, but the shadows lingered, long and uncertain. She felt the weight of Beatrice’s words—and the knowledge that every answer only l..."
...
Known location profile anchors: Cliffside Seaside Hotel, The Ocean-Facing Room, The Grand Lobby, The Dining Room, The Library, the hotel bar
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Cliffside Seaside Hotel", "The Ocean-Facing Room", "The Grand Lobby", "The Dining Room", "The Library", "the hotel bar"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=18542; context=4728; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_early_1 must appear in Act 2, Scene 3 via Tide chart found in victim's belongings
- clue_late_1 must appear in Act 2, Scene 3 via Business meeting logs
- clue_late_2 must appear in Act 2, Scene 3 via Witness confirmation
...
- Chapter 6:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the door closed behind Beatrice, Eleanor remained by the fire, the hush of the library pressing in. The rain had nearly stopped, but the shadows lingered, long and uncertain. She felt the weight of Beatrice’s words—an...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • duty, roster, confirming, captain, ivor, hale, presence [clue_15]
      Points to: captain, ivor, hale, committed, crime
    • guest, statements, confirming, beatrice, quill, alibi [clue_16]
      Points to: beatrice, quill, involved, drowning
    • witness, accounts, confirming, sylvia, trent, alibi [clue_17]
      Points to: sylvia, trent, involved, drowning
    • witness, accounts, confirming, eleanor, voss, alibi [clue_core_elimination_chain]
      Points to: eleanor, voss, involved, drowning
    • tide, chart, marked, times [clue_culprit_direct_1]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • victim, last, known, alive, time [clue_early_1]
    ...
    • witness, statements, hugo, vane, confrontation [clue_late_2]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Sylvia's conflicting timeline regarding her whereabouts."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Sylvia's alibi is not as solid as she claims."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Sylvia's eyes dart around the bar, avoiding Eleanor's gaze."
      ]
    },
    ...
    "emotionalRegister": "New insights reshape the narrative, deepening the mystery and emotional turmoil.",
