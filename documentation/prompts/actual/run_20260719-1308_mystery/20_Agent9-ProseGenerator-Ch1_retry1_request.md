...
- Project ID: ``
- Timestamp: `2026-07-19T13:13:55.673Z`
...
- Eleanor Voss
  ...
  Connection to victim: Eleanor wrote an article exposing a scandal involving Mallory's past.; Eleanor and Mallory share a contentious history over the article that could ruin Mallory..
  Investigation relevance: is actively driving interviews and credibility checks in this scene.
  Suspicion/pressure cue seed: Uncovering the truth.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Hugo Vane
  Public identity anchor: Unscrupulous Businessman; suspect 
  Connection to victim: directly affected by Dr. Mallory Finch's death and its fallout.
  Investigation relevance: access plausibility: high | alibi window: 6:30 PM to 8:30 PM | opportunity channel: Lobby.
...
### Hugo Vane
Hugo Vane's charm belies a dark connection to organized crime. His character illustrates the moral decay present in the quest for success amid the socio-economic uncertainties of post-war England.
Era intersection: Hugo's entanglement with crime reflects the pervasive corruption that often accompanies rapid economic changes in society.
...
Hugo's smooth and persuasive tone often reveals his cunning nature.
[comfortable] ‘Let’s make this interesting; the stakes are high!’
[evasive] ‘I’d rather not get into those details, if you don’t mind.’
[stressed] ‘I assure you, I’m fully in control of the situation.’
Humour: His observational humor often disarms others, masking deeper issues.
...
Hugo speaks with a smooth, persuasive tone, often using charm to disarm those around him
He has a tendency to observe his surroundings keenly, making pointed comments that reveal his cunning nature.
Hugo is tormented by the fear that his illegal dealings will come to light, forcing him to confront the precarious balance he has maintained between success and morality.
...
### Hugo Vane[HE]
Voice & mannerisms: Hugo speaks with a smooth, persuasive tone, often using charm to disarm those around him. He has a tendency to observe his surroundings keenly, making pointed comments that reveal his cunning nature.
SIGNATURE TIC (use sparingly — this is Hugo Vane's alone, never in anyone else's mouth; at most once in this chapter and only where the scene naturally invites it; prefer a varied paraphrase over the verbatim phrase; most chapters should omit it entirely): "‘Let’s make this interesting.’"
Sample voice fragments (match this register and rhythm):
  [comfortable] "‘Let’s make this interesting; the stakes are high!’"
  [evasive] "‘I’d rather not get into those details, if you don’t mind.’"
...
Act 1 behaviour contract: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Hugo sees the victim as a liability due to their knowledge of his illegal dealings." — do not surface in Act I.
...
• [clue_mechanism_visibility_core] tide, chart, victim, belongings, shows, seven, thirty, evening
  Category: testimonial | Criticality: essential | Supports inference step 1
  Points to: victim, drowned, high, tide

• [clue_mid_1] tide, chart, victim, belongings, shows, seven, thirty, evening
  Category: testimonial | Criticality: essential | Supports inference step 1
  Points to: victim, drowned, high, tide

• [clue_mid_3] calm, contradicts, high, tide, assumption
...
Known location profile anchors: Cliffside Seaside Hotel, The Ocean-Facing Room, The Grand Lobby, The Dining Room, The Library, the beach near the Cliffside Seaside Hotel
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Cliffside Seaside Hotel", "The Ocean-Facing Room", "The Grand Lobby", "The Dining Room", "The Library", "the beach near the Cliffside Seaside Hotel"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the beach near the Cliffside Seaside Hotel". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=7792; context=10129; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - Scene is set in: the beach near the Cliffside Seaside Hotel — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • tide, chart, marked, times [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The tide chart found in the victim's belongings."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the victim was found at low tide, contradicting earlier assumptions."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor stares at the waves, recalling her last conversation with the victim."
      ]
    },
    ...
    "emotionalRegister": "The atmosphere is heavy with anticipation, setting the stage for the unfolding mystery.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (tide, chart, victim, belongings, shows, seven, thirty, evening) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_mid_1] (tide, chart, victim, belongings, shows, seven, thirty, evening) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_mid_3] (calm, contradicts, high, tide, assumption) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
...
```text
{
  ...
  "chapters": [
    {
      ...
      "summary": "Eleanor Voss arrives at the beach near the Cliffside Seaside Hotel on a wintry morning, where Dr. Mallory Finch's body has been discovered. The scene is fraught with tension as Eleanor observes a tide chart among the victim's belongings, raising immediate questions about the time and circumstances of the drowning. Hugo Vane stands nearby, his composure strained, as Eleanor begins her investigation and notes the first unsettling contradictions.",
      "paragraphs": [
        ...
        "Hugo lingered nearby, his eyes flicking from Eleanor to the constable and back again. He cleared his throat, the sound lost in the wind. ‘If you don’t need me, Miss Voss, I should—’",
  ...
  "note": "",
  "audit": {
    "locked_fact_phrases": "present in paragraph 2, 7, 10 | absent",
    "season_words_used": "wintry, winter, cold, overcast, pale | none",
    "discriminating_test_present": "no",
    "required_clues_present": "clue_mechanism_visibility_core: paragraph 1; clue_mid_1: paragraph 2; clue_mid_3: paragraph 10",
