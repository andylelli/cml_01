...
- Project ID: ``
- Timestamp: `2026-07-19T13:15:41.460Z`
...
A false lead directs suspicion away from the real issues at hand.
...
Rationale: Tension scenes require an atmosphere of seriousness and suspense.
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Ivor is tormented by guilt over a wartime betrayal that could tarnish his legacy, creating a moral struggle between his desire to protect his reputation and the need to confront his past."
...
• [clue_5] marked, timeline, hotel, ledger, shows, time, victim, last, drink
...
• [clue_early_1] victim, must, alive, least, until, time, contradicting, high, tide, drowning
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: timeline, undermines, high, tide, drowning, theory
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_mid_1, clue_mid_3, clue_core_contradiction_chain, clue_mid_2, clue_3, clue_4, clue_culprit_direct_hugo_vane — do not reveal these as new information.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As she turned to re-enter the hotel, a final gust of wind swept across the terrace, scattering a few loose pages from her notebook. She stooped to retrieve them, her thoughts already racing ahead. The calm sea had spoken, and in its silence, it had condemned t..."
...
terrace, lobby, corridor, lounge, dining room
...
Chapter 3: Chapter 3: The Calm Sea
  Events: By early afternoon, the wind had eased to a persistent moan along the balustrade of the hotel terrace overlooking the sea.
...
Known location profile anchors: Cliffside Seaside Hotel, The Ocean-Facing Room, The Grand Lobby, The Dining Room, The Library, the hotel dining room
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Cliffside Seaside Hotel", "The Ocean-Facing Room", "The Grand Lobby", "The Dining Room", "The Library", "the hotel dining room"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=13785; context=9447; dropped=[humour_guide, location_profiles]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 4:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As she turned to re-enter the hotel, a final gust of wind swept across the terrace, scattering a few loose pages from her notebook. She stooped to retrieve them, her thoughts already racing ahead. The calm sea had spoken...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • hotel, ledger, timeline, entry [clue_5]
      Points to: victim, last, seen, alive, time
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The hotel ledger showing Ivor's questionable alibi."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Ivor's alibi may not hold up under scrutiny."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor notices Ivor's trembling hands as he speaks."
      ]
    },
    ...
    "emotionalRegister": "A false lead directs suspicion away from the real issues at hand.",
