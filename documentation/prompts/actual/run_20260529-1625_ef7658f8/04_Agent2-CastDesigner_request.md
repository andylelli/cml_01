...
- Run ID: `run_ef7658f8-a517-4c9e-aa64-b46ad6ed20a5`
- Project ID: `proj_886aae05-2df6-4340-b9a2-e2e9cd228f79`
- Timestamp: `2026-05-29T16:48:34.154Z`
...
**Character Names** (pre-selected — use EXACTLY as given, do not alter, abbreviate, or substitute any name): Christopher Moorfield, Paul Statham, George Smallwood, Virginia Lenton, Alexandra Collingwood
...
**Setting**: 1940s - A mid-1940s transatlantic ocean liner with multiple decks, segregated passenger classes, formal public spaces, and restricted crew-only areas.
**Crime Type**: Murder
**Social Context**: strict social hierarchy among passengers and crew, formal dress codes and dining protocols, women increasingly present in workforce roles aboard ship, post-war social adjustments and subtle class tensions
**Tone**: Cozy
