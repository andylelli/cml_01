...
- Project ID: ``
- Timestamp: `2026-05-17T15:29:36.744Z`
...
- Era-authentic markers: petrol-powered automobiles, domestic telephones with party lines, manual typewriters, reliable passenger automobiles, frequent passenger trains, early commercial aviation services, telephone exchanges, telegram services via local post offices
- Tone: Classic
- No anachronisms
...
Description: A sprawling country estate with grand architecture, manicured gardens, and numerous rooms for both social and private use.
...
Setting constraints:
- Physical constraints: multiple access points with restricted areas, large grounds with hedges limiting visibility, interior layout promoting certain movement patterns
- Geographic isolation: Moderately isolated, with the nearest town several miles away, limiting immediate access to external help.
- Access control: restricted areas such as the study and cellar, permissions required for staff and guests to access certain rooms, daily schedules dictating the presence of household members

Era constraints to include:
- Technology: petrol-powered automobiles, domestic telephones with party lines, manual typewriters
- Transportation: reliable passenger automobiles, frequent passenger trains
- Social norms: class divisions exacerbated by the Great Depression, increased scrutiny on the wealthy
