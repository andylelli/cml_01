...
- Project ID: ``
- Timestamp: `2026-05-17T15:29:59.735Z`
...
- Technology available: petrol-powered automobiles, domestic telephones with party lines, manual typewriters
- Forensics: fingerprinting techniques, basic toxicology tests, emerging ballistics analysis
- Social norms: class divisions exacerbated by the Great Depression, increased scrutiny on the wealthy, rising tensions due to fascism in Europe
