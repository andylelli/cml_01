...
- Project ID: ``
- Timestamp: `2026-05-17T15:31:07.274Z`
...
CHAPTER SENSORY PALETTE HINTS (evoke these qualities without copying verbatim):
  Chapter 1 palette — morning, rain, reflective solitude mood [location: The Study]:
...
• [clue_2] A note found in Eleanor's hand states a meeting time of midnight.
...
Known location profile anchors: Little Middleton Manor, The Library, The Drawing Room, The Study, The Gardens, the study of Eleanor Voss
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The Library", "The Drawing Room", "The Study", "The Gardens", "the study of Eleanor Voss"
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=5666; context=9712; dropped=[none]; truncated=[pronoun_accuracy, location_profiles, temporal_context]
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Beatrice Quill stands frozen, her hand trembling as she clutches a book of poetry."
      ]
    },
    "summary": "In the dim light of the study, Eleanor Voss and Beatrice Quill discover the lifeless body of their friend Eleanor. The clock shows ten minutes past eleven, casting doubt on the circumstances of her death.",
    ...
    "emotionalRegister": "The initial discovery of the murder creates a palpable tension that grips the manor.",
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 1: "The mechanism relies on clock, study, and minut to expose the false timing." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
...
□ Chapter 1: "A note found in Eleanor's hand states a meeting time of midnight." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
