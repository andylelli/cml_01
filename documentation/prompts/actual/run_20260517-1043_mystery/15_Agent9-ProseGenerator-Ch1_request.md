...
- Project ID: ``
- Timestamp: `2026-05-17T11:48:19.540Z`
...
Permission: conditional — condition: Eleanor's charm might surface.
Characters who may be funny: Eleanor Voss
Permitted forms: polite_savagery
Rationale: Eleanor's charm can introduce lightness amidst the tension.
...
• [clue_mechanism_visibility_core] The mechanism relies on clock, establish, and witness to expose the false timing.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: The mechanism of the clock is crucial to understanding the timing of the murder.
...
Known location profile anchors: Hawthorne Manor, The Drawing Room, The Library, Servants' Quarters, the drawing room of the victim's house
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Hawthorne Manor", "The Drawing Room", "The Library", "Servants' Quarters", "the drawing room of the victim's house"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the drawing room of the victim's house". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.

PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=5342; context=9995; dropped=[none]; truncated=[pronoun_accuracy, location_profiles, temporal_context]
...
- Chapter 1:
  ...
  - Scene is set in: the drawing room of the victim's house — reference it naturally within the paragraph, never as your opening phrase.
  - Opening atmosphere (MANDATORY — validator enforced): the first paragraph MUST contain at least one of: rain / wind / fog / storm / mist / thunder / evening / morning / night / dawn / dusk / season / afternoon / midday / noon / midnight / twilight / sunrise / sunset / daylight / sunlight / overcast / cloudy / bright / dark. A chapter that omits all of these from its opening paragraph will be rejected.
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The mechanism relies on clock, establish, and witness to expose the false timing. [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: The mechanism of the clock is crucial to understanding the timing of the murder.
...
Chapter 1 (Act 1) completeness contract:
  ...
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_1] Eleanor insists the clock showed ten minutes past eleven at the time of the murder, leading the others to believe the clock's reading is accurate.
...
[
  {
    ...
    "title": "Discovery",
    "setting": {
      "location": "the drawing room of the victim's house",
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor lingers at the door, her eyes brimming with tears as she recalls the last conversation with the victim."
      ]
    },
    "summary": "The drawing room is somber as Beatrice Quill arrives to investigate the murder. The victim's body is discovered with a clock showing ten minutes past eleven, raising questions about the timing of the death.",
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_1",
      "placementDetail": "Eleanor insists the clock showed ten minutes past eleven at the time of the murder, leading the others to believe the clock's reading is accurate."
    },
    ...
    "humourGuidance": {
      ...
      "condition": "Eleanor's charm might surface."
    },
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 1: "The mechanism relies on clock, establish, and witness to expose the false timing." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
