...
- Project ID: ``
- Timestamp: `2026-07-17T00:35:51.215Z`
...
• [clue_id_2] witnesses, claim, finch, dining, area, poison, administered, elsewhere
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: timeline, events, surrounding, finch, poisoning

• [clue_id_6] drink, half, full, unusual, sediment, bottom
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "But the respite was brief. Hugo Vane broke the silence, his tone measured. “You’ve uncovered more than you bargained for, Miss Voss. The question is—what will you do with it? ” Eleanor met his gaze, her resolve hardening. “I will follow the evidence, wherever..."
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=21907; context=4380; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
Chapter 8 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The timeline written on a notepad, detailing each suspect's movements."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes a clear timeline of events, setting the stage for the final confrontation."
...
[
  {
    ...
    "setting": {
      ...
      "timeOfDay": "Midnight",
      "atmosphere": "Dark and brooding as the night deepens"
    },
    "characters": [
      "Eleanor Voss",
      "Captain Ivor Hale",
    ...
    "dramaticElements": {
      ...
      "tension": "The atmosphere thickens as she prepares for the confrontation",
      "microMomentBeats": [
        "Eleanor stares into the darkness, contemplating the weight of her discoveries."
      ]
    },
    "summary": "Eleanor meticulously reconstructs the timeline of events leading to Dr. Finch's death. She notes the key moments and interactions among the suspects, preparing for a decisive confrontation to uncover the truth.",
    "beat": "pattern",
    "estimatedWordCount": 1250,
    "pivotElement": "The timeline written on a notepad, detailing each suspect's movements.",
    "factEstablished": "Establishes a clear timeline of events, setting the stage for the final confrontation.",
    ...
    "emotionalRegister": "The emotional intensity mounts as the characters face the consequences of their actions.",
