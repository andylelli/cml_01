...
- Project ID: `unknown`
- Timestamp: `2026-07-17T00:21:02.732Z`
...
1. Generate a clue that makes the reader directly observe: "Witnesses report Dr. Finch was seen taking a sip from his drink shortly before collapsing...."
   → observation | essential | early | temporal | step 1 | terms: witnesses, report, finch

2. Generate a clue that provides evidence for: "This suggests that the poison was ingested at that moment, linking the drink directly to his death...."
   → contradiction | essential | early | testimonial | step 1 | terms: suggests, poison, ingested

3. Generate a clue that makes the reader directly observe: "The drink was found half-full with unusual sediment at the bottom...."
   → observation | essential | early | testimonial | step 2 | terms: drink, found, half-full

4. Generate a clue that provides evidence for: "This sediment matches the composition of the delayed-action tablet, indicating it was ingested...."
   → contradiction | essential | early | testimonial | step 2 | terms: sediment, matches, composition

5. Generate a clue that makes the reader directly observe: "Guests recall Beatrice Quill was near Dr. Finch when he took his drink...."
   → observation | essential | mid | temporal | step 3 | terms: guests, recall, beatrice

6. Generate a clue that provides evidence for: "This indicates she had the opportunity to administer the poison...."
   → contradiction | essential | mid | testimonial | step 3 | terms: indicates, opportunity, administer

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "This suggests that the poison was ingested at that moment, linking the drink directly to his death...."
   → contradiction | essential | mid | testimonial | step 1 | terms: suggests, poison, ingested

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "A slowly dissolving tablet was placed in Dr. Finch's drink, releasing poison after a certain time...."
   → observation | essential | early | temporal | terms: slowly, dissolving, tablet

9. Generate one essential EARLY clue giving a concrete, fair-play indicator of the manner of death (poisoned with a delayed-action tablet) observable at the body-discovery scene — e.g. for poison: numbness, a bitter almond residue, constriction, or sudden collapse with no wound. Do NOT name or explain the concealment trick; only the physical tell a witness could see at the scene.
   → observation | essential | early | testimonial | terms: poisoned, delayed-action, tablet, numbness, bitter, residue, collapse, convulsion, no wound, froth

10. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Reenacting the event with the same drink and tablet composition while observing Quill's reactions...."
   → observation | essential | mid | behavioral | terms: reenacting, event, drink
...
11. Generate one essential mid-story clue whose description or pointsTo explicitly names Beatrice Quill and states the unique trace, preparation detail, or mechanism link that points to Beatrice Quill rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Beatrice Quill, slowly, dissolving, tablet
...
12. Generate one essential early-or-mid clue establishing that Beatrice Quill UNIQUELY had the means/skill/access/knowledge required to execute the concealment mechanism, and that the other suspects did not — so the reveal relies only on this already-planted capability, never on a means introduced for the first time at the confrontation.
   → elimination | essential | mid | temporal | terms: Beatrice Quill, slowly, dissolving, tablet

13. Generate a clue showing observable evidence of Beatrice Quill's premeditation or planning (Financial gain). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: financial

14. Generate a clue that explicitly eliminates suspect Sylvia Trent using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Sylvia Trent because ...").
...
16. Generate one essential early or mid elimination clue that explicitly rules out Sylvia Trent and narrows the solution toward culprit Beatrice Quill. The pointsTo text must start with "Eliminates Sylvia Trent because ..." and cite corroborated evidence.
   → elimination | essential | mid | testimonial | terms: Sylvia Trent, Beatrice Quill
...
Create 2 red herrings that support the false assumption: "Dr. Finch was poisoned during the charity event by an unknown intruder."
