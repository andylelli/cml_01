...
- Timestamp: `2026-05-29T21:25:10.049Z`
...
• [clue_1] The minute hand of the lobby clock is slightly misaligned with the hour markers, and scratches are found around the winding keyhole.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: Shows the lobby clock was tampered with manually, indicating manipulation of its time display.
...
Known location profile anchors: The Cliffhaven Hotel, Guest Room 312, Grand Lobby, Staff Kitchen and Service Corridor, Sea-facing Terrace, Hotel lobby
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Cliffhaven Hotel", "Guest Room 312", "Grand Lobby", "Staff Kitchen and Service Corridor", "Sea-facing Terrace", "Hotel lobby"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "Hotel lobby". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=5600; context=10819; dropped=[none]; truncated=[fair_play_contract, location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - INVESTIGATOR ESTABLISHMENT REQUIRED: Janet Warenne must claim or be recognised as the investigator in this chapter. Establish Janet Warenne as the detective-in-charge within the first two paragraphs — Janet Warenne IS the investigator. Do NOT have any character suggest a "real" detective is still coming, or imply that authority has not yet been delegated. Janet Warenne begins the investigation in this chapter.
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The minute hand of the lobby clock is slightly misaligned with the hour markers, and scratches are found around the winding keyhole. [clue_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: Shows the lobby clock was tampered with manually, indicating manipulation of its time display.
  ...
  - Sensory obligation — use at least two of: rain-streaked windows, grey light filtering through glass | steady rain on canopy, soft footsteps on wet stone | wet stone and wood polish. Mood: quiet anticipation.
...
[
  {
    "sceneNumber": 1,
    "act": 1,
    "title": "Discovery of the Body and Clock Anomaly",
    "setting": {
      "location": "Hotel lobby",
      "timeOfDay": "Morning after the murder",
      "atmosphere": "Heavy fog seeps through the windows, shadows cast by flickering Art Deco lamps"
    },
    "characters": [
      "Janet Warenne",
      "Robert Quincy",
    ...
    "purpose": "Introduce the crime and detective; establish initial mystery and setting",
    "cluesRevealed": [
      "clue_1"
    ],
    "dramaticElements": {
      "conflict": "Tension as suspects gather and the detective surveys the scene",
      "tension": "The lobby clock is stopped, but subtly off; unease grows",
      "microMomentBeats": [
        "Janet Warenne’s eyes linger on the victim’s still face, sensing something amiss beneath the surface"
      ]
    },
    "summary": "the detective Warenne arrives at the seaside hotel’s lobby, greeted by a tense group including Robert Quincy, Michael Brabazon, Frederick Rochford, and Antoinette Mandeville. The victim lies lifeless, and Janet’s attention is drawn to the lobby clock’s minute hand, which is slightly misaligned with the hour markers, hinting at deeper mystery.",
    "estimatedWordCount": 1800,
    "emotionalRegister": "A tense, somber atmosphere sets the stage as the murder is discovered amid the isolating fog and social scrutiny.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 1: "The minute hand of the lobby clock is slightly misaligned with the hour markers, and scratches are found around the winding keyhole." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
