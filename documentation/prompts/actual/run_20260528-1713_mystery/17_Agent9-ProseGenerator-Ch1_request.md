...
- Project ID: ``
- Timestamp: `2026-05-28T17:21:55.597Z`
...
A somber shock envelops the manor as the body is discovered and the clock’s stopped time suggests a clear, yet deceptive, timeline.
...
Rationale: The initial discovery of the murder sets a solemn and tense tone where humour would be inappropriate.
...
Act 1 behaviour contract: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Stands to lose professional reputation and lucrative contracts if victim reveals her secret misdiagnosis; feared victim would report malpractice, ending her career." — do not surface in Act I.
...
• [clue_1] Fine scratches are visible on the clock’s pendulum suspension spring under close inspection, indicating recent physical interference.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: These scratches reveal tampering on the clock's suspension spring, a key temporal clue.
...
Known location profile anchors: Voss Manor, Voss Manor Library, Servants' Hall, Formal Gardens, Stable Yard, Voss Manor, main hall
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Voss Manor", "Voss Manor Library", "Servants' Hall", "Formal Gardens", "Stable Yard", "Voss Manor, main hall"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "Voss Manor, main hall". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=5972; context=11676; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - Scene is set in: Voss Manor, main hall — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • Fine scratches are visible on the clock’s pendulum suspension spring under close inspection, indicating recent physical interference. [clue_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: These scratches reveal tampering on the clock's suspension spring, a key temporal clue.
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Fine scratches visible on the clock’s pendulum suspension spring under close inspection"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the grandfather clock was recently tampered with, suggesting foul play related to timekeeping"
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_1] Captain Ivor Hale mentions seeing the manor clock showing ten minutes past eleven, suggesting the murder occurred then
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Beatrice Quill pauses silently near the doorway, eyes distant with unspoken grief"
      ]
    },
    ...
    "emotionalRegister": "A somber shock envelops the manor as the body is discovered and the clock’s stopped time suggests a clear, yet deceptive, timeline.",
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 1: "Fine scratches are visible on the clock’s pendulum suspension spring under close inspection, indicating recent physical interference." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
