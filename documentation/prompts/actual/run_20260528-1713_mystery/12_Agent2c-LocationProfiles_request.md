...
- Project ID: ``
- Timestamp: `2026-05-28T17:18:31.247Z`
...
- Era-authentic markers: petrol touring cars on country roads, domestic telephone lines with party-line exchanges, manual typewriters for correspondence and record-keeping, battery-powered radios common in sitting rooms, private automobiles reliable but limited by rural road conditions, passenger steam trains connecting nearest town to major cities, early commercial aviation rare and not used for routine travel, telephones connected via manual exchanges, often party-line
- Tone: Classic
- No anachronisms
...
Era: 1930s
Primary Location: Manor house on country estate
Description: A large, privately owned country house with extensive grounds, including gardens, stables, and outbuildings, serving as both family residence and agricultural hub.
Crime Scene: Voss Manor
Weather: overcast skies with intermittent drizzle common, creating damp and muddy conditions on estate grounds
Mood: tense and formal, underscored by social unease from economic pressures and political uncertainties abroad
...
Setting constraints:
- Physical constraints: multiple locked and restricted areas including private family quarters and servant passages, ornate but compartmentalized architecture creating natural access bottlenecks, estate grounds structured to limit visibility and movement after dark, weather prone to fog and rain, affecting outdoor evidence preservation
- Geographic isolation: Situated several miles from nearest village, with limited road access and no immediate neighbors, delaying outside assistance and communication.
- Access control: estate gates locked at night with gatekeeper oversight, servants required to follow strict schedules and report movements, family members have exclusive access to private wings, visitors must be announced and admitted through main entrance

Era constraints to include:
- Technology: petrol touring cars on country roads, domestic telephone lines with party-line exchanges, manual typewriters for correspondence and record-keeping
- Transportation: private automobiles reliable but limited by rural road conditions, passenger steam trains connecting nearest town to major cities
- Social norms: strict class distinctions within the household and staff, formal etiquette governing interactions between family and servants
