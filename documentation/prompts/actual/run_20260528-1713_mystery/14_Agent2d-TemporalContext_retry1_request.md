...
- Project ID: ``
- Timestamp: `2026-05-28T17:19:47.919Z`
...
- YOU MUST use the exact year and month specified above: March 1937
- This date has been specifically selected for THIS mystery to ensure uniqueness
- DO NOT change the year or month - use March 1937 exactly
...
- All details must be historically accurate for March 1937 specifically
- Generate fresh, original descriptions - do not copy example phrasing
- Make this feel like the specific moment of March 1937
- OPTIONAL FIELD DEPTH REQUIREMENT: `fashion` and `seasonalActivities` must be specific and non-generic.
  ...
  - Include at least 3 seasonal activities tied to March and this location.
...
1. seasonal.season must be one of [spring, summer, fall, winter], got "early spring"
...
Decade: 1930s
Location: Manor house on country estate
...
- Technology available: petrol touring cars on country roads, domestic telephone lines with party-line exchanges, manual typewriters for correspondence and record-keeping, battery-powered radios common in sitting rooms
- Forensics: standard fingerprinting with regional lab processing delays, basic toxicology limited to common poisons, ballistics analysis in early development, requiring expert consultation
- Social norms: strict class distinctions within the household and staff, formal etiquette governing interactions between family and servants, impact of Great Depression influencing estate finances, awareness of rising political tensions in Europe discussed privately

Task:
1. Use the specified date: March 1937
2. Provide seasonal context for March (weather, holidays, activities appropriate for this specific month)
