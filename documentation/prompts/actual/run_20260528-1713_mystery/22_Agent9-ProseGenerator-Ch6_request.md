...
- Project ID: ``
- Timestamp: `2026-05-28T17:24:05.545Z`
...
Evidence of soot and lantern timing deepens the mystery, implicating Captain Hale and intensifying tension.
...
Rationale: Sharp wit and social barbs can relieve tension while maintaining investigative focus.
...
• [clue_10] Captain Ivor Hale is uniquely linked to the clock tampering by the distinctive fine scratches on the pendulum suspension spring matching his known handling patterns.
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: This observation directly implicates Captain Ivor Hale rather than any other suspect.

• [clue_11] Visible documents and letters in Captain Ivor Hale’s study reveal his frustration with the declining estate and the victim’s recent decisions, indicating premeditation.
  Category: behavioral | Criticality: essential | Supports inference step 3
  Points to: This behavioral clue shows Captain Ivor Hale’s motive and planning before the murder.

• [clue_13] Soot marks on the pendulum bob correspond with the timing of the stable lantern extinguishing, linking the clock’s mechanical state to the stable’s lighting conditions.
  Category: physical | Criticality: supporting | Supports inference step 3
  Points to: This physical evidence supports the timeline of events around the clock stopping and lantern extinguishing.

• [clue_14] Wax drips on the stable floor match the composition of the stable lantern’s candle, confirming the lantern was lit until shortly after the clock stopped.
  Category: physical | Criticality: supporting | Supports inference step 3
  Points to: This physical trace corroborates the lantern extinguishing timeline.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Eleanor’s fingers brushed the cold stone of the sundial once more, the rough surface grounding her in the present. She reflected on how time itself had been manipulated to conceal the truth, how a trusted mechanism had been turned against the household’s fragi..."
...
stable, manor, estate, corridor, drawing room, garden

✓ RULE: Continue using this location vocabulary. Maintain consistency with established setting type.
✓ Do NOT introduce new location types that contradict earlier chapters.

**Recent Chapter Summary (for narrative continuity):**
Chapter 3: Chapter 3: Witness Testimony and Clock Oddities
  Events: The afternoon sun, pale and veiled by a persistent springtime drizzle, cast a muted glow through the tall windows of the Voss Manor drawing room.
...
Known location profile anchors: Voss Manor, Voss Manor Library, Servants' Hall, Formal Gardens, Stable Yard, Voss Manor, Captain Hale’s study
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Voss Manor", "Voss Manor Library", "Servants' Hall", "Formal Gardens", "Stable Yard", "Voss Manor, Captain Hale’s study"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 6: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with an expository setup — e.g. "It was not until…" / "There had been no word since…" / "There was a note on the table…". Begin with "It was", "There was", or "There had been" followed immediately by a specific condition, event, or discovery. Do NOT begin with generic atmosphere. Anchor opening in "Voss Manor, Captain Hale’s study". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=14827; context=12120; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 6:
  ...
  - Scene is set in: Voss Manor, Captain Hale’s study — reference it naturally within the paragraph, never as your opening phrase.
  - Opening atmosphere (MANDATORY — validator enforced): the first paragraph MUST contain at least one of: rain / wind / fog / storm / mist / thunder / evening / morning / night / dawn / dusk / season / afternoon / midday / noon / midnight / twilight / sunrise / sunset / daylight / sunlight / overcast / cloudy / bright / dark / grey / pale / cold / warm / chill / crisp / damp / drizzle / haze / lamplight / firelight. A chapter that omits all of these from its opening paragraph will be rejected.
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Eleanor’s fingers brushed the cold stone of the sundial once more, the rough surface grounding her in the present. She reflected on how time itself had been manipulated to conceal the truth, how a trusted mechanism had b...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • Captain Ivor Hale is uniquely linked to the clock tampering by the distinctive fine scratches on the pendulum suspension spring matching his known handling patterns. [clue_10]
      Points to: This observation directly implicates Captain Ivor Hale rather than any other suspect.
    • Visible documents and letters in Captain Ivor Hale’s study reveal his frustration with the declining estate and the victim’s recent decisions, indicating premeditation. [clue_11]
      Points to: This behavioral clue shows Captain Ivor Hale’s motive and planning before the murder.
    ...
    • The sundial’s shadow reading at the time of murder does not correspond with the grandfather clock’s displayed time of ten minutes past eleven. [clue_7]
      Points to: This observation reveals a discrepancy between solar time and the clock’s time.
    • This discrepancy confirms the clock’s time is artificially altered, supporting the clock winding back forty minutes before the murder. [clue_8]
      Points to: The contradiction confirms deliberate manipulation of the clock’s time to mislead the timeline.
    • A controlled comparison of the grandfather clock’s pendulum suspension spring tension and oscillation rate before and after tampering shows accelerated movement inconsistent with normal function. [clue_9]
      Points to: This evidence must be observed before the discriminating test to understand the clock’s altered behavior.
    • These scratches indicate recent tampering inconsistent with normal clock maintenance schedules, explicitly overturning the false assumption that the stopped manor clock’s displayed time of ten minutes past eleven accurately marks the time of the murder. [clue_core_contradiction_chain]
      Points to: This contradiction chain dismantles the false timeline assumption using concrete, reader-visible evidence.
    ...
    • Soot marks on the pendulum bob correspond with the timing of the stable lantern extinguishing, linking the clock’s mechanical state to the stable’s lighting conditions. [clue_13]
      Points to: This physical evidence supports the timeline of events around the clock stopping and lantern extinguishing.
    • Wax drips on the stable floor match the composition of the stable lantern’s candle, confirming the lantern was lit until shortly after the clock stopped. [clue_14]
      Points to: This physical trace corroborates the lantern extinguishing timeline.
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Documents revealing Hale’s motive and matching soot and wax evidence linking him to clock tampering"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Directly links Captain Hale to clock tampering and establishes premeditation"
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor notes Hale’s trembling hands as he denies involvement"
      ]
    },
