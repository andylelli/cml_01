...
- Project ID: ``
- Timestamp: `2026-07-17T01:37:38.228Z`
...
- YOU MUST use the exact year and month specified above: July 1944
- This date has been specifically selected for THIS mystery to ensure uniqueness
- DO NOT change the year or month - use July 1944 exactly
- The season is FIXED as "summer" (it follows from July) — use it exactly; do not pick a different season
...
- All details must be historically accurate for July 1944 specifically
- Generate fresh, original descriptions - do not copy example phrasing
- Make this feel like the specific moment of July 1944
- OPTIONAL FIELD DEPTH REQUIREMENT: `fashion` and `seasonalActivities` must be specific and non-generic.
  ...
  - Include at least 3 seasonal activities tied to July and this location.
...
- Technology available: radio broadcasts in every guest room, early television sets in common areas, manual typewriters for correspondence
- Forensics: blood typing as a standard practice, ballistics analysis available, limited trace evidence analysis
- Social norms: impact of WWII on societal roles, especially for women, heightened awareness of Cold War tensions, post-war economic optimism mixed with trauma

Task:
1. Use the specified date: July 1944
2. Provide seasonal context for July (weather, holidays, activities appropriate for this specific month)
