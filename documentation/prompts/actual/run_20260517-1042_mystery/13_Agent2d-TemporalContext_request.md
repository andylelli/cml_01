...
- Project ID: ``
- Timestamp: `2026-05-17T11:46:46.001Z`
...
- YOU MUST use the exact year and month specified above: August 1935
- This date has been specifically selected for THIS mystery to ensure uniqueness
- DO NOT change the year or month - use August 1935 exactly
...
- All details must be historically accurate for August 1935 specifically
- Generate fresh, original descriptions - do not copy example phrasing
- Make this feel like the specific moment of August 1935
- OPTIONAL FIELD DEPTH REQUIREMENT: `fashion` and `seasonalActivities` must be specific and non-generic.
  ...
  - Include at least 3 seasonal activities tied to August and this location.
...
- Technology available: petrol touring cars on county roads, domestic wiring with frequent outages, typewriters standard in offices
- Forensics: fingerprinting standard in criminal investigations, basic toxicology tests available, emerging ballistics analysis
- Social norms: Great Depression influencing social dynamics and class tensions, rise of fascism in Europe affecting local politics, traditional gender roles prevalent in upper-class society

Task:
1. Use the specified date: August 1935
2. Provide seasonal context for August (weather, holidays, activities appropriate for this specific month)
