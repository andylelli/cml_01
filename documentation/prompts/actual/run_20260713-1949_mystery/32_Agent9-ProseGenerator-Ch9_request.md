...
- Project ID: ``
- Timestamp: `2026-07-13T20:03:45.286Z`
...
• [clue_late_optional_slot_1] last, sighting, finch, remains, late, texture, detail, case, background
...
• [clue_core_contradiction_chain] finch, drowned, time, indicated, witnesses, high, tide
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: witness, accounts, unreliable, tide, schedule
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_culprit_direct_captain_ivor_hale, clue_early_1, clue_11, clue_8, clue_late_1, clue_3, clue_4, clue_5, clue_6, clue_9, clue_mid_1, clue_10, clue_7, clue_culprit_direct_1 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): timing, events, surrounding, finch, death, inconsistent | witness, accounts, unreliable, tide, schedule | direct, shows, captain, ivor, hale, means | witness, accounts, unreliable, tide, schedule | captain, hale, potential, motive, murder | beatrice, quill, eliminated, suspect | captain, hale, account, events, inaccurate | captain, hale, account, events, inaccurate | captain, hale, testimony, false, misleading | timeline, events, unclear, conflicting, witness, statements | emotional, stress, affected, accuracy, witness, statements | sylvia, trent, eliminated, suspect | emotional, stress, affected, accuracy, witness, statements | hugo, vane, eliminated, suspect | eleanor, voss, eliminated, suspect | physical, trace, opportunity, indicate, captain, ivor
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "The terrace fell silent, the only sound the ceaseless whisper of the tide and the distant cry of a gull. Eleanor lingered by the balustrade, her thoughts racing. The notes in her pocket felt heavier than lead, the pattern they outlined both a map and a warning..."
...
Render this test MECHANISM as live, in-scene action and dialogue, composing ENTIRELY in your own words from these elements (reproducing any briefing phrase verbatim FAILS validation): tide, schedule, times, claimed, hale, witnesses, reveal, inconsistencies
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=25884; context=5082; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, continuity_context, pronoun_accuracy]
...
- Chapter 9:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "The terrace fell silent, the only sound the ceaseless whisper of the tide and the distant cry of a gull. Eleanor lingered by the balustrade, her thoughts racing. The notes in her pocket felt heavier than lead, the patter...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • last, sighting, finch, remains, late, texture, detail, case, background [clue_late_optional_slot_1]
      Points to: adds, late, texture, changing, essential, deduction, chain
    • tide, schedule, shows, high, half, past, eleven, contradicting, witness, statements [clue_core_contradiction_chain] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: witness, accounts, unreliable, tide, schedule
  ...
  - ⚠ DISCRIMINATING TEST (trap) — MANDATORY real-time scene with dialogue and confrontation. DO NOT summarize it after the fact.
    ...
    Elements the test must dramatize (compose the scene ENTIRELY in your own sentences from these — reproducing any briefing phrase verbatim FAILS validation): tide, schedule, times, claimed, hale, witnesses, reveal, inconsistencies
    Cite these already-revealed clue IDs during the test: clue_core_contradiction_chain, clue_mechanism_visibility_core, clue_6, clue_early_1
    ...
    Motive statement REQUIRED: the culprit must explicitly state or acknowledge their motive during or immediately after the confrontation. Canonical motive: "Jealousy over her influence.". Do not omit it.
...
Chapter 9 (Act 3) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The tide schedule displayed prominently for all to see."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Captain Hale's alibi collapses under scrutiny."
...
[
  {
    ...
    "setting": {
      ...
      "atmosphere": "The ballroom is dimly lit, filled with an air of anticipation."
    },
    "characters": [
      "Eleanor Voss",
      "Captain Ivor Hale",
    ...
    "dramaticElements": {
      "conflict": "The tension builds as Eleanor sets the trap.",
      "tension": "Everyone is on edge, awaiting the revelation.",
      "microMomentBeats": [
        "Eleanor's heart races as she prepares to unveil the truth."
      ]
    },
    "summary": "In the ballroom, Eleanor gathers all the guests and presents her findings. She compares the tide schedule with the alibis, revealing inconsistencies. As she lays out the evidence, she watches Captain Hale's reaction closely, sensing his guilt.",
    "beat": "final_trap",
    "estimatedWordCount": 1250,
    "pivotElement": "The tide schedule displayed prominently for all to see.",
    "factEstablished": "Establishes that Captain Hale's alibi collapses under scrutiny.",
    ...
    "emotionalRegister": "The final confrontation brings resolution but also reveals the emotional cost.",
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 9: the clue [clue_core_contradiction_chain] (finch, drowned, time, indicated, witnesses, high, tide) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
