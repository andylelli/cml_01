...
- Project ID: ``
- Timestamp: `2026-07-13T19:59:21.366Z`
...
```text
{
  ...
  "chapters": [
    {
      ...
      "summary": "Eleanor Voss, summoned by the anxious staff, discovers the body of Dr. Mallory Finch washed up on the beach below the seaside hotel. The guests gather, each revealing subtle tensions as Eleanor begins her investigation. The first contradiction emerges in the timing of the tide, sowing the seeds of doubt.",
      "paragraphs": [
  ...
  "note": "",
  "audit": {
    "locked_fact_phrases": "present in paragraph 8, 9, 14 | present",
    "season_words_used": "autumn, autumnal, fall | present",
    "discriminating_test_present": "no",
    "required_clues_present": "clue_mechanism_visibility_core: chapter 1 paragraph 8 | present",
    "early_observation_present": "description: Eleanor finds the tide schedule marked 'high tide—half past eleven' and notes a timing discrepancy (chapter 1 paragraph 8) | present",
    "early_inference_present": "yes: paragraph 14, Eleanor notes the discrepancy between the tide's peak and the last sighting"
  }
}
