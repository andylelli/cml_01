...
- Project ID: ``
- Timestamp: `2026-07-13T20:00:00.391Z`
...
The first clues introduce a sense of hope, but the emotional cost becomes evident.
...
Rationale: Eleanor's observational humor can help lighten the tension during the investigation.

## Reveal Groundwork (texture — do not explain, only plant)
- Plant one subtle observable beat related to: "As Eleanor reflects on the earlier conversations with Captain Hale, the tension in his voice takes on a new meaning, hinting at his deeper involvement". Do not explain significance yet.
- Plant one subtle observable beat related to: "Beatrice's nervous laughter during the first interview now appears as a mask for her true feelings, revealing her emotional turmoil". Do not explain significance yet.
- Plant one subtle observable beat related to: "The argument witnessed earlier between Beatrice and Mallory now casts suspicion on both women, reframing their interactions in a more sinister light". Do not explain significance yet.
...
• [clue_early_1] finch, drowned, time, indicated, witnesses, high, tide
...
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): timing, events, surrounding, finch, death, inconsistent | witness, accounts, unreliable, tide, schedule
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "The words hung in the air, heavy with implication. The group shifted uneasily, each retreating into their own thoughts. Eleanor watched them, her mind cataloguing every gesture, every hesitation. The contradictions were not yet answers, but they were a beginni..."
...
Chapter 1: Chapter 1: The Tide Brings Ashore
  Events: Eleanor Voss laid the facts out plainly where the others could see them: Mechanism relies schedule eleven drown expose.
Chapter 2: Chapter 2: Initial Investigation
  Events: Eleanor’s gaze drifted to the ornate mantle clock above the reception desk, its hands poised at ten minutes to noon.

⚠️ **VALIDATION:** Character name mismatches and setting drift are common failure modes.
Double-check every character name against the list above before using it.

**⏱ LOCKED TIME ANCHOR — use verbatim, do not paraphrase:**
Clock time (from the case ground truth): **"Last sighting of Dr. Finch"**
⚠ CONFLICT: other times appear (ten minutes to noon). Use ONLY: "Last sighting of Dr. Finch". All others are errors.
...
Known location profile anchors: The Tidal Trap Hotel, Grand Lobby, Dining Area, Guest Rooms, Oceanfront Balcony, the hotel dining room
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Tidal Trap Hotel", "Grand Lobby", "Dining Area", "Guest Rooms", "Oceanfront Balcony", "the hotel dining room"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=11970; context=12001; dropped=[humour_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 3:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "The words hung in the air, heavy with implication. The group shifted uneasily, each retreating into their own thoughts. Eleanor watched them, her mind cataloguing every gesture, every hesitation. The contradictions were...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • tide, schedule, shows, high, half, past, eleven [clue_culprit_direct_captain_ivor_hale] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
         Place this OBSERVATION in paragraph 1 or 2 (observation only — no inference about the culprit).
    • tide, schedule, shows, high, half, past, eleven, contradicting, witness, statements [clue_early_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: witness, accounts, unreliable, tide, schedule
...
Chapter 3 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Captain Hale's statement about seeing Dr. Finch before high tide."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Captain Hale's timeline conflicts with the high tide schedule."
...
[
  {
    ...
    "setting": {
      ...
      "atmosphere": "Suspenseful as guests gather for lunch, whispers abound."
    },
    "characters": [
      "Eleanor Voss",
      "Captain Ivor Hale",
    ...
    "purpose": "Introduce alibis and initial suspicions.",
    "cluesRevealed": [
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor catches Captain Hale's eye, sensing his discomfort."
      ]
    },
    "summary": "During a tense lunch, Eleanor questions the guests about their last interactions with Dr. Finch. Captain Hale's alibi raises eyebrows as he claims to have seen her just before high tide. Eleanor notes discrepancies in his story, deepening the mystery.",
    "beat": "first_enquiries",
    "estimatedWordCount": 1250,
    "pivotElement": "Captain Hale's statement about seeing Dr. Finch before high tide.",
    "factEstablished": "Establishes that Captain Hale's timeline conflicts with the high tide schedule.",
    ...
    "emotionalRegister": "The first clues introduce a sense of hope, but the emotional cost becomes evident.",
...
□ Chapter 3: the clue [clue_early_1] (finch, drowned, time, indicated, witnesses, high, tide) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
