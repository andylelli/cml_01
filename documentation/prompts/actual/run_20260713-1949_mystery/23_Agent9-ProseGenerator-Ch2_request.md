...
- Project ID: ``
- Timestamp: `2026-07-13T19:59:30.547Z`
...
• [clue_mechanism_visibility_core] mechanism, relies, schedule, eleven, drown, expose, false, timing
  Category: testimonial | Criticality: essential | Supports inference step 1
  Points to: timing, events, surrounding, finch, death, inconsistent, tide, schedule
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "The group began to drift back toward the hotel, their footsteps muffled by the damp sand. Overhead, the clouds threatened more rain, the morning’s chill deepening. Eleanor lingered a moment longer, her gaze fixed on the sea. The tide had reached its peak at ha..."
...
Known location profile anchors: The Tidal Trap Hotel, Grand Lobby, Dining Area, Guest Rooms, Oceanfront Balcony, the hotel lobby
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Tidal Trap Hotel", "Grand Lobby", "Dining Area", "Guest Rooms", "Oceanfront Balcony", "the hotel lobby"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=10008; context=12103; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 2:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "The group began to drift back toward the hotel, their footsteps muffled by the damp sand. Overhead, the clouds threatened more rain, the morning’s chill deepening. Eleanor lingered a moment longer, her gaze fixed on the...".
...
Chapter 2 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The two clocks in the hotel showing different times."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes conflicting timelines that raise questions about the circumstances of the murder."
...
[
  {
    ...
    "setting": {
      ...
      "atmosphere": "Nervous chatter fills the air as guests speculate."
    },
    "characters": [
      "Eleanor Voss",
      "Captain Ivor Hale",
    ...
    "purpose": "Begin to investigate the circumstances surrounding the death.",
    "cluesRevealed": [
      "clue_mechanism_visibility_core",
      "clue_core_contradiction_chain"
    ],
    "dramaticElements": {
      "conflict": "Tension mounts as guests begin to suspect one another.",
      "tension": "Discrepancies in timing lead to suspicion.",
      "microMomentBeats": [
        "Eleanor notices Captain Hale's trembling hands as he speaks."
      ]
    },
    "summary": "As the guests gather in the lobby, Eleanor takes charge, questioning each of them about their whereabouts. The tension escalates when she discovers two clocks show contradictory times regarding the last sighting of Dr. Finch. The conflicting information leaves the group uneasy.",
    "beat": "crime",
    "estimatedWordCount": 1250,
    "pivotElement": "The two clocks in the hotel showing different times.",
    "factEstablished": "Establishes conflicting timelines that raise questions about the circumstances of the murder.",
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 2: the clue [clue_core_contradiction_chain] (finch, drowned, time, indicated, witnesses, high, tide) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 2: the clue [clue_mechanism_visibility_core] (mechanism, relies, schedule, eleven, drown, expose, false, timing) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
