...
- Project ID: ``
- Timestamp: `2026-07-13T20:03:23.083Z`
...
• [clue_7] eliminates, eleanor, voss, because, seen, hotel, time, murder
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_culprit_direct_captain_ivor_hale, clue_early_1, clue_11, clue_8, clue_late_1, clue_3, clue_4, clue_5, clue_6, clue_9, clue_mid_1, clue_10 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): timing, events, surrounding, finch, death, inconsistent | witness, accounts, unreliable, tide, schedule | direct, shows, captain, ivor, hale, means | witness, accounts, unreliable, tide, schedule | captain, hale, potential, motive, murder | beatrice, quill, eliminated, suspect | captain, hale, account, events, inaccurate | captain, hale, account, events, inaccurate | captain, hale, testimony, false, misleading | timeline, events, unclear, conflicting, witness, statements | emotional, stress, affected, accuracy, witness, statements | sylvia, trent, eliminated, suspect | emotional, stress, affected, accuracy, witness, statements | hugo, vane, eliminated, suspect
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "In the dimness of the library, with the wind howling and the shadows deepening, Eleanor understood that the truth was more complicated—and more dangerous—than she had ever imagined. The revelation of the letter had not solved the case; it had only made the web..."
...
Known location profile anchors: The Tidal Trap Hotel, Grand Lobby, Dining Area, Guest Rooms, Oceanfront Balcony, the hotel terrace
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Tidal Trap Hotel", "Grand Lobby", "Dining Area", "Guest Rooms", "Oceanfront Balcony", "the hotel terrace"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=21917; context=4172; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, continuity_context, pronoun_accuracy]
...
- Chapter 8:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "In the dimness of the library, with the wind howling and the shadows deepening, Eleanor understood that the truth was more complicated—and more dangerous—than she had ever imagined. The revelation of the letter had not s...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • eleanor, voss, confirmed, hotel, relevant, time, frame [clue_7]
      Points to: eleanor, voss, eliminated, suspect
    • tide, schedule, shows, high, half, past, eleven [clue_culprit_direct_1]
...
Chapter 8 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Eleanor’s notes outlining the timeline of events."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the groundwork for the final confrontation."
...
[
  {
    ...
    "setting": {
      ...
      "timeOfDay": "Night",
      "atmosphere": "The terrace overlooks the ocean, the moonlight casting an eerie glow."
    },
    "characters": [
      "Eleanor Voss",
      "Captain Ivor Hale",
    ...
    "dramaticElements": {
      ...
      "tension": "The stakes are high as the truth looms closer.",
      "microMomentBeats": [
        "Eleanor gazes out at the ocean, contemplating the tragedy."
      ]
    },
    "summary": "Eleanor stands on the terrace, piecing together the timeline of events leading up to Dr. Finch's death. She prepares a final test to confront the culprit, feeling the weight of the truth pressing down on her.",
    "beat": "pattern",
    "estimatedWordCount": 1250,
    "pivotElement": "Eleanor’s notes outlining the timeline of events.",
    "factEstablished": "Establishes the groundwork for the final confrontation.",
    ...
    "emotionalRegister": "Mounting pressure leads to a confrontation that unveils the core of the mystery.",
