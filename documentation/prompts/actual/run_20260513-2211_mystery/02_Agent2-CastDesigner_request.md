...
- Project ID: ``
- Timestamp: `2026-05-13T22:11:44.597Z`
...
**Setting**: 1930s - a grand manor house set in expansive grounds, displaying a mix of Georgian and Victorian architectural styles, with multiple wings and a central courtyard
**Crime Type**: Murder
**Social Context**: Great Depression impacting social classes, increased class tensions and stratification, rising fascism in Europe influencing local politics
**Tone**: Classic
