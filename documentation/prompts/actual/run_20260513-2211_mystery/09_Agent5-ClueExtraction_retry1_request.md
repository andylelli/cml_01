...
- Project ID: `unknown`
- Timestamp: `2026-05-13T22:12:59.465Z`
...
2. Generate a clue that provides evidence for: "The time discrepancy suggests the clock may not reflect the actual time of death...."
   → contradiction | essential | early | temporal | step 1 | terms: discrepancy, suggests, clock

3. Generate a clue that makes the reader directly observe: "Witness statements indicate conflicting times regarding the murder...."
   → observation | essential | early | temporal | step 2 | terms: witness, statements, indicate

4. Generate a clue that provides evidence for: "The inconsistencies in witness accounts suggest the murder time was manipulated...."
   → contradiction | essential | early | temporal | step 2 | terms: inconsistencies, witness, accounts

5. Generate a clue that makes the reader directly observe: "Fingerprints on the clock's casing match Captain Ivor Hale...."
   → observation | essential | mid | temporal | step 3 | terms: fingerprints, clock's, casing

6. Generate a clue that provides evidence for: "This indicates that Captain Hale had tampered with the clock...."
   → contradiction | essential | mid | temporal | step 3 | terms: indicates, captain, tampered

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The time discrepancy suggests the clock may not reflect the actual time of death...."
   → contradiction | essential | mid | temporal | step 1 | terms: discrepancy, suggests, clock

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The clock was tampered with to create a false narrative of the murder timeline...."
   → observation | essential | early | temporal | terms: clock, tampered, create

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "A controlled reenactment of the clock's striking mechanism reveals the tampering...."
...
10. Generate one essential mid-story clue whose description or pointsTo explicitly names Captain Ivor Hale and states the unique trace, preparation detail, or mechanism link that points to Captain Ivor Hale rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Captain Ivor Hale, clock, tampered, create

11. Generate a clue showing observable evidence of Captain Ivor Hale's premeditation or planning (Financial desperation.). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
...
14. Generate one essential early or mid elimination clue that explicitly rules out Eleanor Voss and narrows the solution toward culprit Captain Ivor Hale. The pointsTo text must start with "Eliminates Eleanor Voss because ..." and cite corroborated evidence.
...
- Eleanor Voss: sensitive items: Eager to find truth, Sensitive to emotional cues
- Dr. Mallory Finch: sensitive items: Defensive about medical opinions, Eager to shift blame
- Captain Ivor Hale: sensitive items: Sensitive about finances, Defensive about personal life
- Beatrice Quill: sensitive items: Sensitive to public perception, Eager to please others
...
Create 2 red herrings that support the false assumption: "Eleanor Voss’s murder occurred at the time indicated by the clock."
...
- required_direct_culprit_clue:
  ...
  - allowed_source_paths=CASE.cast[2].access_plausibility, CASE.cast[2].alibi_window, CASE.cast[2].evidence_sensitivity[0], CASE.inference_path.steps[0].observation, CASE.inference_path.steps[0].correction, CASE.inference_path.steps[2].observation, CASE.inference_path.steps[2].correction
