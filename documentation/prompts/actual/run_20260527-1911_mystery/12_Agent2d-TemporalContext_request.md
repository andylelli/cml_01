...
- Project ID: ``
- Timestamp: `2026-05-27T19:17:08.530Z`
...
- YOU MUST use the exact year and month specified above: December 1931
- This date has been specifically selected for THIS mystery to ensure uniqueness
- DO NOT change the year or month - use December 1931 exactly
...
- All details must be historically accurate for December 1931 specifically
- Generate fresh, original descriptions - do not copy example phrasing
- Make this feel like the specific moment of December 1931
- OPTIONAL FIELD DEPTH REQUIREMENT: `fashion` and `seasonalActivities` must be specific and non-generic.
  ...
  - Include at least 3 seasonal activities tied to December and this location.
...
- Technology available: domestic telephones with party-line exchanges, radio broadcasts common in sitting rooms, manual typewriters for correspondence and record-keeping
- Forensics: fingerprinting as standard investigative procedure, basic toxicology available at regional labs, ballistics analysis emerging but limited in rural areas
- Social norms: marked class distinctions between gentry, staff, and local tenants, formal routines governing interactions within the manor, Great Depression influences on employment and social tensions

Task:
1. Use the specified date: December 1931
2. Provide seasonal context for December (weather, holidays, activities appropriate for this specific month)
