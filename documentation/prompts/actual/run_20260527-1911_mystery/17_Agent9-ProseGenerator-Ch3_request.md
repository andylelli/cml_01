...
- Project ID: ``
- Timestamp: `2026-05-27T19:20:42.016Z`
...
Emerging doubts and subtle contradictions unsettle initial assumptions, creating a growing sense of unease.
...
Permission: conditional — condition: Only subtle, dry wit from Eleanor Voss is permitted to provide brief respite without breaking tension.
Characters who may be funny: Eleanor Voss
Permitted forms: dry_wit
Rationale: Early investigation benefits from restrained wit to reflect Eleanor’s personality without trivializing the case.
...
• [clue_2] Unusual scratch marks are found on the back plate of the clock near the winding keyhole, and a key matching the winding mechanism is found in a drawer, suggesting tampering.
  Category: temporal | Criticality: essential | Supports inference step 2
  Points to: Physical evidence of manual interference with the clock.

• [clue_3] The clock was likely manually wound backward after the murder using the hidden key, causing the displayed time to be inaccurate by forty minutes.
  Category: temporal | Criticality: essential | Supports inference step 2
  Points to: Supports the hypothesis of manual winding backward tampering.

• [clue_servants_log] The clock was likely manually wound backward after the murder using the hidden key, causing the displayed time to be inaccurate by forty minutes.
  Category: temporal | Criticality: essential | Supports inference step 2
  Points to: Supports the hypothesis of manual winding backward tampering.

• [clue_winding_key] Unusual scratch marks are found on the back plate of the clock near the winding keyhole, and a key matching the winding mechanism is found in a drawer, suggesting tampering.
  Category: temporal | Criticality: essential | Supports inference step 2
  Points to: Physical evidence of manual interference with the clock.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the morning edged toward midday, Eleanor’s thoughts returned persistently to the clock and the servants’ logs. The contradiction between the stopped clock at ten minutes past eleven and the recorded footsteps at half past eleven was a fissure in the manor’s..."
...
- Chapter 3: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with an explicit time marker — e.g. "That morning…" / "By the time dusk fell…" / "It was nearly four o'clock…" / "On the second day after the discovery…". Time must be in the first clause. Anchor opening in "Woolverton Manor, study". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=10623; context=11220; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_servants_log must appear in Act 1, Scene 3 via Servants’ logs and footprints contradictory to clock time
- clue_winding_key must appear in Act 1, Scene 3 via Discovery of winding key in drawer
...
- Chapter 3:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the morning edged toward midday, Eleanor’s thoughts returned persistently to the clock and the servants’ logs. The contradiction between the stopped clock at ten minutes past eleven and the recorded footsteps at half...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • Unusual scratch marks are found on the back plate of the clock near the winding keyhole, and a key matching the winding mechanism is found in a drawer, suggesting tampering. [clue_2] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: Physical evidence of manual interference with the clock.
    ...
    • The clock was likely manually wound backward after the murder using the hidden key, causing the displayed time to be inaccurate by forty minutes. [clue_3] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: Supports the hypothesis of manual winding backward tampering.
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
         Paragraph 2 (immediately following): The detective or POV character explicitly reasons
           about what this evidence implies — who it implicates, why it may be unreliable,
           or what inference it supports. This must be a separate full paragraph, not a sentence appended to Paragraph 1.
    • The clock was likely manually wound backward after the murder using the hidden key, causing the displayed time to be inaccurate by forty minutes. [clue_servants_log] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: Supports the hypothesis of manual winding backward tampering.
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
         Paragraph 2 (immediately following): The detective or POV character explicitly reasons
           about what this evidence implies — who it implicates, why it may be unreliable,
           or what inference it supports. This must be a separate full paragraph, not a sentence appended to Paragraph 1.
    • Unusual scratch marks are found on the back plate of the clock near the winding keyhole, and a key matching the winding mechanism is found in a drawer, suggesting tampering. [clue_winding_key] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: Physical evidence of manual interference with the clock.
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
...
Chapter 3 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Scratch marks on the clock’s back plate near the winding keyhole and the hidden winding key"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the clock was manually wound backward after the murder, falsifying the displayed time"
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_2] Captain Hale mentions the meal bell ringing at noon, implying the clock was accurate around that time
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor notices Captain Hale’s clenched fists, hinting at hidden tension"
      ]
    },
    ...
    "emotionalRegister": "Emerging doubts and subtle contradictions unsettle initial assumptions, creating a growing sense of unease.",
    ...
    "humourGuidance": {
      ...
      "form": "dry_wit",
      "condition": "Permitted only as polite sparring or understatement by characters with wit, respecting social decorum."
    },
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 3: "Unusual scratch marks are found on the back plate of the clock near the winding keyhole, and a key matching the winding mechanism is found in a drawer, suggesting tampering." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: "The clock was likely manually wound backward after the murder using the hidden key, causing the displayed time to be inaccurate by forty minutes." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: "The clock was likely manually wound backward after the murder using the hidden key, causing the displayed time to be inaccurate by forty minutes." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: "Unusual scratch marks are found on the back plate of the clock near the winding keyhole, and a key matching the winding mechanism is found in a drawer, suggesting tampering." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
