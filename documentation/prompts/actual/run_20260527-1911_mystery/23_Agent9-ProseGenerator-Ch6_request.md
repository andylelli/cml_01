...
- Project ID: ``
- Timestamp: `2026-05-27T19:23:23.444Z`
...
Focused suspicion on Captain Hale heightens tension and narrows the investigation’s scope.
...
Permission: conditional — condition: Humor allowed only as sharp, social wit from Beatrice Quill or dry irony from Eleanor Voss.
Characters who may be funny: Eleanor Voss, Beatrice Quill
Permitted forms: dry_wit, polite_savagery
Rationale: Mid-investigation tension can be eased briefly by character wit that reflects social dynamics.
...
• [clue_6] The pendulum of the clock is stopped in an unusual position inconsistent with the displayed time, indicating the clock was tampered with after the murder.
  Category: temporal | Criticality: essential | Supports inference step 4
  Points to: Physical state of the clock inconsistent with displayed time.

• [clue_7] The physical state of the clock’s escapement confirms manual reversal, supporting the hypothesis of tampering to mislead the time of death.
  Category: temporal | Criticality: essential | Supports inference step 4
  Points to: Physical evidence confirming manual winding backward.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Eleanor rose, smoothing the folds of her coat. “Thank you both for your candor. Your cooperation is ” She paused, her gaze sweeping the drawing room with its gold-framed portraits and fading daylight. “The servants’ logs and witness statements have been instru..."
...
- Chapter 6: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with an expository setup — e.g. "It was not until…" / "There had been no word since…" / "There was a note on the table…". Begin with "It was", "There was", or "There had been" followed immediately by a specific condition, event, or discovery. Do NOT begin with generic atmosphere. Anchor opening in "Woolverton Manor, study". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Phrases to avoid (already overused in earlier chapters): "one must always smile even when the", "must always smile even when the cards", "always smile even when the cards are", "smile even when the cards are less", "it seems the clock has tales to", "seems the clock has tales to tell", "the clock has tales to tell if", "clock has tales to tell if only", "tales to tell if only one knows", "mechanical clock perched above the oak mantelpiece".
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=15194; context=11278; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 6:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Eleanor rose, smoothing the folds of her coat. “Thank you both for your candor. Your cooperation is ” She paused, her gaze sweeping the drawing room with its gold-framed portraits and fading daylight. “The servants’ logs...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    ...
    • The pendulum of the clock is stopped in an unusual position inconsistent with the displayed time, indicating the clock was tampered with after the murder. [clue_6]
      Points to: Physical state of the clock inconsistent with displayed time.
    • The physical state of the clock’s escapement confirms manual reversal, supporting the hypothesis of tampering to mislead the time of death. [clue_7]
      Points to: Physical evidence confirming manual winding backward.
    • A controlled test is arranged in the study where the clock’s winding key is used to attempt to rewind the clock, confirming the mechanism can be reversed manually. [clue_8]
      Points to: Evidence needed before the discriminating test can be understood.
    ...
    • The pendulum of the clock is stopped in an unusual position inconsistent with the displayed time, indicating the clock was tampered with after the murder. [clue_pendulum_position]
      Points to: Physical state of the clock inconsistent with displayed time.
    • A controlled test is arranged in the study where the clock’s winding key is used to attempt to rewind the clock, confirming the mechanism can be reversed manually. [clue_scratch_marks]
      Points to: Evidence needed before the discriminating test can be understood.
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The pendulum stopped in an unusual position inconsistent with the displayed time"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Confirms the clock was tampered with manually, supporting the hypothesis of falsified time"
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor pauses, troubled by the deliberate nature of the tampering"
      ]
    },
    ...
    "humourGuidance": {
      ...
      "condition": "Allowed only if delivered by Beatrice Quill with her high humor level and no direct threat or violence present."
    },
