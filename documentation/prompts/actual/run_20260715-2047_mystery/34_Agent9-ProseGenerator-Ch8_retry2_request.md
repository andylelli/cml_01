...
- Project ID: ``
- Timestamp: `2026-07-15T21:09:01.885Z`
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=23670; context=5271; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
Attempt context: 3/3 | primary class: continuity | subcode: control_plane_leakage.
...
PRIMARY FAILURES
- Chapter 8: Chapter 8 contains control-plane leakage (obligation_term): ""Clue obligation: suspect clearance missing for 'Beatrice Quill'." (Remove prompt, validation, retry, or scaffold terminology from reader-facing prose)
...
Scope: chapter(s) 8
Attempt: 3/3 | class: continuity | subcode: control_plane_leakage
