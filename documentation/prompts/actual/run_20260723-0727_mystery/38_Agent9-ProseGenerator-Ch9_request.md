...
- Project ID: ``
- Timestamp: `2026-07-23T07:43:27.545Z`
...
• [clue_core_contradiction_chain_3] measurements, masks, costumes, captain, hale, possession, reveals, identical
  Category: testimonial | Criticality: essential | Supports inference step 3
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): supports, impersonation, theory
...
This is a **comparative analysis** test. The detective must:

**Test mechanism (paraphrase — do NOT copy verbatim):**
Render this test MECHANISM as live, in-scene action and dialogue, composing ENTIRELY in your own words from these elements (reproducing any briefing phrase verbatim FAILS validation): measurements, masks, costumes, captain, hale, possession, reveals, identical

**MANDATORY CHECKLIST - Every box must be checked:**

☐ **Evidence Integration**
  ☐ Explicitly reference or use clue: "clue_core_contradiction_chain_3" (clue) (appears in Act 2, Scene 3)
  ☐ Explicitly reference or use clue: "clue_culprit_direct_captain_ivor_hale" (clue) (appears in Act 2, Scene 1)
  ☐ Explicitly reference or use clue: "clue_early_2" (clue) (appears in Act 1, Scene 2)
...
Known location profile anchors: Grand Seaside Hotel, Main Lobby, Dining Hall, Guest Rooms, Staff-Only Area, the ballroom, now a stage for confrontation
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Grand Seaside Hotel", "Main Lobby", "Dining Hall", "Guest Rooms", "Staff-Only Area", "the ballroom, now a stage for confrontation"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 9: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with an explicit time marker — e.g. "That morning…" / "By the time dusk fell…" / "It was nearly four o'clock…" / "On the second day after the discovery…". Time must be in the first clause. Anchor opening in "the ballroom, now a stage for confrontation". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=25422; context=5064; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 9:
  ...
  - Scene is set in: the ballroom, now a stage for confrontation — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As she left the ballroom, the cold followed her into the corridor, but it was a different kind of chill now—a clarity, a sense of purpose. The night was not yet over, but the masquerade’s final act was about to begin.".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • measurements, taken, masks, match [clue_core_contradiction_chain_3]
      Points to: supports, impersonation, theory
  - ⚠ SUSPECT CLEARANCE REQUIRED (MANDATORY): each suspect below MUST be named explicitly and cleared with on-page evidence and a reasoning connector (because / therefore / which proves):
    • "Dr. Mallory Finch": write a dedicated paragraph that (a) names Dr. Mallory Finch explicitly, (b) states the clearance method ("Corroborated alibi from multiple witnesses."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
    • "Beatrice Quill": write a dedicated paragraph that (a) names Beatrice Quill explicitly, (b) states the clearance method ("Witness confirmed her presence in another location during the murder."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
    • "Hugo Vane": write a dedicated paragraph that (a) names Hugo Vane explicitly, (b) states the clearance method ("Alibi confirmed: 10:00 PM - 10:30 PM"), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
  ...
  - ⚠ DISCRIMINATING TEST (trap) — MANDATORY real-time scene with dialogue and confrontation. DO NOT summarize it after the fact.
    ...
    Elements the test must dramatize (compose the scene ENTIRELY in your own sentences from these — reproducing any briefing phrase verbatim FAILS validation): measurements, masks, costumes, captain, hale, possession, reveals, identical
    Cite these already-revealed clue IDs during the test: clue_core_contradiction_chain_3, clue_culprit_direct_captain_ivor_hale, clue_early_2
...
Chapter 9 (Act 3) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The identical nature of the costumes proves Captain Hale's means to impersonate Sylvia."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Captain Hale had the means to commit the murder, exposing him as the culprit."
...
[
  {
    ...
    "setting": {
      "location": "the ballroom, now a stage for confrontation",
    ...
    "purpose": "Conduct the discriminating test to expose the culprit",
    "cluesRevealed": [
      "clue_core_contradiction_chain_3"
    ],
    "dramaticElements": {
      "conflict": "Eleanor confronts Captain Hale with the evidence",
      "tension": "The atmosphere is thick with suspense as the truth hangs in the air",
      "microMomentBeats": [
        "Eleanor's heart pounds as she lays out the evidence, feeling the weight of the moment."
      ]
    },
    "summary": "Eleanor sets a trap for Captain Hale, presenting the evidence of the identical costumes. She compares the measurements of the masks and costumes, revealing that they are identical. The implications of this finding expose Hale's ability to impersonate Sylvia.",
    "beat": "final_trap",
    "estimatedWordCount": 1250,
    "pivotElement": "The identical nature of the costumes proves Captain Hale's means to impersonate Sylvia.",
    "factEstablished": "Establishes that Captain Hale had the means to commit the murder, exposing him as the culprit.",
    ...
    "emotionalRegister": "A charged confrontation unveils the depths of deception hidden within the masquerade.",
