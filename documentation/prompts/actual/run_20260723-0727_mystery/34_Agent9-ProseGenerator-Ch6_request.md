...
- Project ID: ``
- Timestamp: `2026-07-23T07:41:51.109Z`
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "She gathered herself, drawing a slow breath, steeling her resolve for whatever came next. The conflicting timelines of the suspects’ alibis hung in the air, unresolved but insistent. As the group drifted out, one by one, the dining room was left in shadow, the..."
...
Known location profile anchors: Grand Seaside Hotel, Main Lobby, Dining Hall, Guest Rooms, Staff-Only Area, the ballroom, now a focal point of tension
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Grand Seaside Hotel", "Main Lobby", "Dining Hall", "Guest Rooms", "Staff-Only Area", "the ballroom, now a focal point of tension"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 6: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with an expository setup — e.g. "It was not until…" / "There had been no word since…" / "There was a note on the table…". Begin with "It was", "There was", or "There had been" followed immediately by a specific condition, event, or discovery. Do not open on generic mood alone — but still anchor the location and weave in the sensory + time-of-day grounding across the next sentence or two. Anchor opening in "the ballroom, now a focal point of tension". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- clue_core_contradiction_chain_3 must appear in Act 2, Scene 3 via Cross-check contradiction
- clue_core_elimination_chain_2 must appear in Act 2, Scene 3 via Corroborated elimination
- clue_core_elimination_chain_3 must appear in Act 2, Scene 3 via Corroborated elimination
...
- Chapter 6:
  ...
  - Scene is set in: the ballroom, now a focal point of tension — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "She gathered herself, drawing a slow breath, steeling her resolve for whatever came next. The conflicting timelines of the suspects’ alibis hung in the air, unresolved but insistent. As the group drifted out, one by one,...".
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The accusation against Beatrice, which feels unconvincing to Eleanor."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes a false solution that ultimately raises more questions than answers."
...
[
  {
    ...
    "setting": {
      "location": "the ballroom, now a focal point of tension",
      "timeOfDay": "Evening",
      "atmosphere": "Electric with suspicion and anticipation"
    },
    "characters": [
      "Eleanor Voss",
      "Captain Ivor Hale",
    ...
    "cluesRevealed": [],
    "dramaticElements": {
      "conflict": "Eleanor's instincts clash with the evidence presented",
      "tension": "The atmosphere is thick with unspoken accusations",
      "microMomentBeats": [
        "Eleanor's heart races as she presents her theory, sensing the disbelief in the room."
      ]
    },
    "summary": "Eleanor gathers everyone in the ballroom to present what she believes is a solution. She accuses Beatrice of the murder, claiming her financial troubles drove her to desperation. However, Eleanor notices a flaw in her own reasoning, sensing that something is amiss.",
    "beat": "false_solution",
    "estimatedWordCount": 1250,
    "pivotElement": "The accusation against Beatrice, which feels unconvincing to Eleanor.",
    "factEstablished": "Establishes a false solution that ultimately raises more questions than answers.",
