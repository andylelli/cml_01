...
- Project ID: ``
- Timestamp: `2026-07-23T07:40:05.911Z`
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Haunted by her family's mental illness history, Eleanor fears that pursuing the truth may unearth darker facets of her own identity."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Mallory battles with the weight of her professional ethics versus her desire to protect herself, torn between her duty as a psychiatrist and the fear of losing everything."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Ivor grapples with the haunting memories of his past actions during the war, fearing exposure and the judgment of society."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Beatrice wrestles with the fear of losing her social status and the lengths she is willing to go to maintain her façade."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Hugo struggles with the fear of being exposed for his shady dealings, torn between his ambition and the moral implications of his actions."
...
• [clue_culprit_direct_captain_ivor_hale] captain, hale, means, opportunity, impersonate, sylvia
...
• [clue_core_elimination_chain_2] eliminates, hugo, vane, because, seen, estate, murder
  Category: testimonial | Criticality: essential | Supports inference step 2
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): corroboration, eliminates, hugo, vane, suspect

• [clue_core_elimination_chain_3] eliminates, mallory, finch, because, eleanor, voss, time, murder
  Category: testimonial | Criticality: essential | Supports inference step 2
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): corroboration, eliminates, mallory, finch, suspect
...
Known location profile anchors: Grand Seaside Hotel, Main Lobby, Dining Hall, Guest Rooms, Staff-Only Area, the dining room
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Grand Seaside Hotel", "Main Lobby", "Dining Hall", "Guest Rooms", "Staff-Only Area", "the dining room"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=16495; context=7317; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_core_contradiction_chain_2 must appear in Act 2, Scene 2 via Cross-check contradiction
...
- Chapter 5:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the group dispersed, Eleanor lingered by the fire, her gaze lingering on the masks and the witness statements. The contradictions remained, unresolved and insistent. The masquerade was not yet over; in fact, it seemed...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • captain, hale, access, costumes, masks [clue_culprit_direct_captain_ivor_hale]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • witnesses, confirm, hugo, location, away, murder, scene [clue_core_elimination_chain_2]
      OBSERVATION ONLY: put it on the page concretely — a character sees, handles, or hears it inside the scene. The detective may NOTICE (a pause, a second glance, a pocketed item) but must NOT state what it implies.
    • witnesses, confirm, finch, presence, eleanor [clue_core_elimination_chain_3]
      OBSERVATION ONLY: put it on the page concretely — a character sees, handles, or hears it inside the scene. The detective may NOTICE (a pause, a second glance, a pocketed item) but must NOT state what it implies.
  - PLANT OBLIGATIONS (incidental appearances): each item below MUST appear in this chapter as a passing physical detail a character sees, handles, or walks past — with its significance UNFLAGGED:
    • measurements, taken, masks, match [plant:clue_core_contradiction_chain_3]
...
Chapter 5 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The conflicting timelines of the suspects' alibis."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Dr. Finch and Beatrice are cleared, but raises suspicion on Captain Hale."
...
[
  {
    ...
    "dramaticElements": {
      "conflict": "Alibis clash, raising further questions",
    ...
    "summary": "In the dining room, Eleanor examines the alibis of the suspects. She discovers that Captain Hale's timeline is suspiciously flexible, while both Dr. Finch and Beatrice are confirmed to have been elsewhere during the murder. Hugo's alibi is also corroborated, but the tension remains palpable.",
    "beat": "alibis",
    "estimatedWordCount": 1250,
    "pivotElement": "The conflicting timelines of the suspects' alibis.",
    "factEstablished": "Establishes that Dr. Finch and Beatrice are cleared, but raises suspicion on Captain Hale.",
    ...
    "emotionalRegister": "A critical clue shifts the focus of the investigation towards Hale.",
...
```text
{
  ...
  "chapters": [
    {
      ...
      "summary": "In the dining room, Eleanor scrutinizes the suspects’ alibis, uncovering contradictions in Captain Hale’s timeline while Beatrice, Hugo, and Dr. Finch are cleared by witness accounts. The pressure mounts as the focus of suspicion subtly shifts.",
      "paragraphs": [
        "After the last echoes of conversation faded from the lounge, Eleanor Voss gathered her notes and made her way into the dining room, the muted sound of rain tapping the windowpanes a constant undercurrent. The air was tinged with the scent of old wood polish and the faint, lingering aroma of roast beef from luncheon. Lamplight flickered against the silverware, casting elongated shadows across the white linen, while the wintry dusk pressed its chill against the glass, reminding everyone that evening was settling in early. The others trickled in behind her, their footsteps muffled by the thick carpet, each carrying the weight of unspoken questions.",
        "Captain Ivor Hale was the first to break the silence, his voice taut as a drawn wire. 'I trust this won’t take long, Miss Voss. Some of us have duties to attend to.' He adjusted the cuffs of his black wool tuxedo, the gesture more nervous than authoritative. Beatrice Quill, resplendent in a beaded wrap, perched herself at the end of the table, her eyes bright with a brittle sort of amusement. Hugo Vane slouched into a chair, his tweed blazer shedding the scent of tobacco and damp, while Dr. Mallory Finch stood by the sideboard, her posture immaculate, hands folded with clinical precision.",
        "Eleanor took a steadying breath, feeling the pressure of the investigation mounting in her chest. The contradictions of the masquerade—two identical costumes, the timing of the music, the certainty of the witnesses—crowded her thoughts. She laid out her notebook and addressed the group, her tone gentle but insistent. 'Let’s clarify where each of you was at the time in question. The details matter, as you well know.'",
        "A hush settled, broken only by the soft clink of glass as Hugo poured himself a measure of whisky. 'I was in the estate office with the manager,' Hugo said, his tone blunt. 'You can ask her. We were going over the books from ten until half past. I didn’t step near the ballroom.' His gaze flicked to Eleanor, challenging her to contradict him. Beatrice’s laugh was soft, almost musical. 'If only we all had such convenient witnesses, darling. I was in the lounge with Hugo—he’ll vouch for me, won’t you?' She arched a brow, her gloved fingers drumming a restless rhythm on her clutch.",
        "Hugo shrugged. 'She’s not wrong. Beatrice was with me the whole time. If she slipped away, I’d have noticed.' The exchange drew a brief, sardonic smile from Dr. Finch. 'And I was with Miss Voss in the corridor, just after ten,' Dr. Finch said, her voice calm but edged with something unspoken. 'Neither of us set foot in the ballroom after that.'",
        "Eleanor nodded, her pen poised above the page. The accounts were clear, corroborated by more than one source. She made a note, the scratch of her pen loud in the hush. The meaning of the clues shifted—where once suspicion had hovered over each guest, now the web began to thin. 'That leaves Captain Hale,' she said, her tone mild. 'You were in the ballroom at nine thirty, you said. Where were you after ten?'",
        "Captain Hale’s jaw worked, the muscle flexing beneath his skin. 'I left just after ten, as I’ve said. Walked the corridors, checked the staff. I didn’t return until the commotion began.' His eyes did not quite meet Eleanor’s. She watched him, noting the way his hand gripped the back of his chair, knuckles pale. 'Is there anyone who can confirm your whereabouts?'",
        "A pause, heavy as the darkening sky outside. 'Not precisely,' Captain Hale admitted, his tone clipped. 'The staff were busy with preparations. I didn’t keep a log, Miss Voss.' The words hung between them, the lack of corroboration more telling than any confession. Beatrice’s lips curled in a sardonic smile. 'Well, darling, isn’t that just the cherry on top? The one man with no one to vouch for him.'",
        "Eleanor’s gaze drifted to the sideboard, where a pair of masquerade masks lay beside a tape measure, left behind by the constable who had been cataloguing evidence earlier. The presence of the tape measure was unremarkable in itself—just another tool in the slow machinery of investigation—but it caught her attention, a detail to be filed away for later. She let her eyes linger on the masks, identical in every detail, their ribbons trailing like question marks across the polished wood.",
        "A sudden, loud noise echoed from the corridor—a tray dropped by a nervous hand, perhaps—causing the group to startle. The interruption was brief, but it broke the tension, and for a moment, the atmosphere softened. Dr. Finch allowed herself a small, ironic smile. 'We’re all a bit on edge, it seems. Occupational hazard.'",
        "Eleanor seized the moment of relief, her tone lightening. 'It’s the season for nerves, I suppose. Too many secrets and not enough daylight.' She closed her notebook with a decisive snap, her gaze returning to Captain Hale. 'The question remains: without an alibi, we’re left with only your word. In a masquerade, that’s a fragile thing.'",
        "Hugo Vane leaned back, his expression unreadable. 'It’s all just numbers, really. You line up the accounts, see who comes up short. I know where I was, and so does everyone else.' He glanced at Captain Hale, the implication clear. Beatrice, for once, fell silent, her bravado slipping as she studied the man across the table.",
        "Dr. Finch’s voice, when it came, was soft but firm. 'We’re not accusing, Captain. Not yet. But the facts are what they are.' She met Eleanor’s gaze, a flicker of understanding passing between them. The conflicting timelines of the suspects’ alibis had narrowed the field; where once suspicion had been a net, now it was a noose.",
        "Captain Hale’s reply was a murmur, almost lost in the hush. 'Just another day in paradise.' He forced a smile, but it did not reach his eyes. Eleanor watched him, her own unease mirrored in the tension of her hands. The investigation had pivoted—where once the clues had pointed in all directions, now they converged.",
        "The rain intensified, rattling the windows as the daylight faded to a steely dusk. The Grand Seaside Hotel felt smaller, the walls closing in as the truth drew nearer. Eleanor gathered her notes, her mind circling the new arrangement of facts: Dr. Finch and Beatrice were cleared, Hugo’s alibi was solid, and Captain Hale stood alone at the center of the web.",
        "Yet even as the pressure mounted, a strange calm settled over Eleanor. The masquerade was nearly at an end, but the final dance—the unmasking—remained. She glanced once more at the tape measure and the twin masks, the meaning of the clues shifting beneath her feet. The truth was close, but not yet in reach.",
        "As the group dispersed, Eleanor lingered by the window, watching the rain trace crooked paths down the glass. The contradictions had not vanished, but their meaning had changed: what once seemed a tangle was now a signpost. The masquerade, she realized, was not just about hiding—it was about what one chose to reveal. And soon, someone would have no choice at all."
      ]
    }
  ],
  ...
  "audit": {
    ...
    "season_words_used": "wintry, dusk, winter, chill | present",
    "discriminating_test_present": "no",
    "required_clues_present": "clue_culprit_direct_captain_ivor_hale: paragraph 9; clue_core_elimination_chain_2: paragraph 4; clue_core_elimination_chain_3: paragraph 5",
    "early_observation_present": "Eleanor notes the contradictions and shifting alibis: paragraph 3",
