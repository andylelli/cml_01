...
- Project ID: ``
- Timestamp: `2026-07-23T07:36:05.991Z`
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=7867; context=12032; dropped=[none]; truncated=[first_appearance_contracts, location_profiles, temporal_context, pronoun_accuracy]
...
```text
{
  ...
  "chapters": [
    {
      ...
      "summary": "Eleanor Voss discovers Sylvia Trent's body in the ballroom of the Grand Seaside Hotel. The principal guests gather, each displaying shock and subtle tension as Eleanor is recognized as the investigator. The first contradiction in witness statements is quietly observed.",
      "paragraphs": [
  ...
  "audit": {
    ...
    "required_clues_present": "clue_early_1: paragraph 9",
    "early_observation_present": "Eleanor observes Sylvia Trent's distinctive masquerade costume in paragraph 9 (first 25%)",
    "early_inference_present": "Eleanor notes the contradiction between the clock and her recollection of the music in paragraph 10"
  }
}
