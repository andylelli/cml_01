...
- Project ID: ``
- Timestamp: `2026-07-23T07:37:32.042Z`
...
• [clue_early_2] identical, masks, captain, hale, room
  Category: spatial | Criticality: essential | Supports inference step 1
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): presence, identical, masks, suggests, possible, impersonation
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Eleanor rose, glancing once more at the assembled guests. Each face was a study in composure, but the cracks were already showing: Captain Hale’s restless grip on his watch chain, Dr. Finch’s too-careful calm, Beatrice’s theatrical sighs, Hugo Vane’s sidelong..."
...
Known location profile anchors: Grand Seaside Hotel, Main Lobby, Dining Hall, Guest Rooms, Staff-Only Area, Captain Hale's room
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Grand Seaside Hotel", "Main Lobby", "Dining Hall", "Guest Rooms", "Staff-Only Area", "Captain Hale's room"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 2: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with spoken dialogue — e.g. '"[words]," [Name] said/asked/replied/murmured.' The opening quote must be the first character on the line. Anchor opening in "Captain Hale's room". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=10340; context=10899; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_early_2 must appear in Act 1, Scene 2 via Discovery of masks in Hale's room.
...
- Chapter 2:
  ...
  - Scene is set in: Captain Hale's room — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Eleanor rose, glancing once more at the assembled guests. Each face was a study in composure, but the cracks were already showing: Captain Hale’s restless grip on his watch chain, Dr. Finch’s too-careful calm, Beatrice’s...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • discovery, identical, masks [clue_early_2] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
  ...
  - PLANT OBLIGATIONS (incidental appearances): each item below MUST appear in this chapter as a passing physical detail a character sees, handles, or walks past — with its significance UNFLAGGED:
    • witnesses, statements, sylvia, appearance [plant:clue_culprit_direct_1]
    • witnesses, confirm, hugo, location, away, murder, scene [plant:clue_core_elimination_chain_2]
...
Chapter 2 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The two identical masks found in Captain Hale's room."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Captain Hale had access to costumes, raising suspicion."
...
[
  {
    ...
    "setting": {
      "location": "Captain Hale's room",
      "timeOfDay": "Later that morning",
      "atmosphere": "Tense, with a sense of urgency"
    },
    "characters": [
      "Eleanor Voss",
      "Captain Ivor Hale",
    ...
    "dramaticElements": {
      "conflict": "Eleanor feels the pressure of the investigation",
      "tension": "The presence of the identical masks raises suspicion",
      "microMomentBeats": [
        "Eleanor examines the masks, feeling the weight of suspicion in the air."
      ]
    },
    "summary": "Eleanor Voss enters Captain Hale's room, where she discovers two identical masks hidden away. The atmosphere is thick with tension as she realizes their significance. Captain Hale enters, his demeanor calm yet defensive, raising further questions about his involvement.",
    "beat": "crime",
    "estimatedWordCount": 1250,
    "pivotElement": "The two identical masks found in Captain Hale's room.",
    "factEstablished": "Establishes that Captain Hale had access to costumes, raising suspicion.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 2: the clue [clue_early_2] (identical, masks, captain, hale, room) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
