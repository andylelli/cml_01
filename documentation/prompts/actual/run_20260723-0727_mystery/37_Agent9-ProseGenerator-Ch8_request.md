...
- Project ID: ``
- Timestamp: `2026-07-23T07:43:03.555Z`
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the group began to disperse, the tension did not lift, but something had shifted. Captain Hale lingered by the window, his reflection fractured by the glass. Dr. Finch gathered her things with hands that trembled only slightly. Beatrice and Hugo exchanged a..."
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=22008; context=4015; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 8:
  ...
  - Scene is set in: the ballroom, now a scene of reflection — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the group began to disperse, the tension did not lift, but something had shifted. Captain Hale lingered by the window, his reflection fractured by the glass. Dr. Finch gathered her things with hands that trembled only...".
...
Chapter 8 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Eleanor's mental reconstruction of the events leading to the murder."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Eleanor is ready to confront the key suspect."
...
[
  {
    ...
    "setting": {
      "location": "the ballroom, now a scene of reflection",
      "timeOfDay": "Night",
      "atmosphere": "Heavy with anticipation and realization"
    },
    "characters": [
      "Eleanor Voss",
      "Captain Ivor Hale"
    ...
    "dramaticElements": {
      ...
      "tension": "The weight of the investigation hangs over her",
      "microMomentBeats": [
        "Eleanor closes her eyes, trying to visualize the sequence of events."
      ]
    },
    "summary": "Eleanor reflects on the events leading up to the murder, piecing together the timeline and the relationships between the suspects. She prepares for the final test to confirm her suspicions about Captain Hale.",
    "beat": "pattern",
    "estimatedWordCount": 1250,
    "pivotElement": "Eleanor's mental reconstruction of the events leading to the murder.",
    "factEstablished": "Establishes that Eleanor is ready to confront the key suspect.",
    ...
    "emotionalRegister": "The pressure builds as Eleanor confronts the truth about her own fears.",
