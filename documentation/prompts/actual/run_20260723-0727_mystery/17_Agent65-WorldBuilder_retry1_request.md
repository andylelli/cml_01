...
- Project ID: ``
- Timestamp: `2026-07-23T07:32:58.594Z`
...
Schema validation failed on attempt 1: locationRegisters[1].cameraAngle is required; locationRegisters[2].cameraAngle is required; locationRegisters[3].cameraAngle is required
