...
- Project ID: `unknown`
- Timestamp: `2026-07-23T07:30:09.010Z`
...
## Mandatory Clue Requirements (16 required)
1. Generate a clue that makes the reader directly observe: "Witnesses recall seeing 'Sylvia' in a distinctive costume shortly before the murder...."
   → observation | essential | early | temporal | step 1 | terms: witnesses, recall, seeing

2. Generate a clue that provides evidence for: "If 'Sylvia' was in the ballroom, the real Sylvia must have been elsewhere...."
   → contradiction | essential | early | spatial | step 1 | terms: 'sylvia', ballroom,, sylvia

3. Generate a clue that makes the reader directly observe: "Two identical masks were found in Captain Hale's room...."
   → observation | essential | early | spatial | step 2 | terms: identical, masks, found

4. Generate a clue that provides evidence for: "Captain Hale had the means and opportunity to impersonate Sylvia...."
   → contradiction | essential | early | testimonial | step 2 | terms: captain, means, opportunity

5. Generate a clue that makes the reader directly observe: "Timing of the music performance coincided with the murder...."
   → observation | essential | mid | testimonial | step 3 | terms: timing, music, performance

6. Generate a clue that provides evidence for: "The distraction provided Captain Hale the perfect cover to switch costumes...."
   → contradiction | essential | mid | testimonial | step 3 | terms: distraction, provided, captain

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "If 'Sylvia' was in the ballroom, the real Sylvia must have been elsewhere...."
   → contradiction | essential | mid | spatial | step 1 | terms: 'sylvia', ballroom,, sylvia

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "Captain Ivor Hale used an identical costume to impersonate Sylvia during the event, creating a dual presence in the ballroom...."
   → observation | essential | early | spatial | terms: captain, identical, costume
...
10. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Comparing the measurements of the masks and costumes in Captain Hale's possession reveals they are i..."
   → observation | essential | mid | testimonial | terms: comparing, measurements, masks
...
11. Generate one essential mid-story clue whose description or pointsTo explicitly names Captain Ivor Hale and states the unique trace, preparation detail, or mechanism link that points to Captain Ivor Hale rather than any non-culprit.
   → observation | essential | mid | spatial | terms: Captain Ivor Hale, captain, identical, costume
...
12. Generate one essential early-or-mid clue establishing that Captain Ivor Hale UNIQUELY had the means/skill/access/knowledge required to execute the concealment mechanism, and that the other suspects did not — so the reveal relies only on this already-planted capability, never on a means introduced for the first time at the confrontation.
   → elimination | essential | mid | spatial | terms: Captain Ivor Hale, captain, identical, costume

13. Generate a clue showing observable evidence of Captain Ivor Hale's premeditation or planning (Financial desperation). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
...
15. Generate a clue that explicitly eliminates suspect Hugo Vane using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Hugo Vane because ...").
   → elimination | essential | mid | testimonial | terms: Hugo Vane

16. Generate one essential early or mid elimination clue that explicitly rules out Eleanor Voss and narrows the solution toward culprit Captain Ivor Hale. The pointsTo text must start with "Eliminates Eleanor Voss because ..." and cite corroborated evidence.
...
Create 2 red herrings that support the false assumption: "Witnesses confidently claim they saw Sylvia in the ballroom at the time of the murder."
...
- **costume_id**: "two identical costumes" — Two costumes were used for the masquerade, allowing for impersonation.
- **time_of_death_id**: "ten minutes past eleven" — The victim was killed ten minutes past eleven, as corroborated by multiple witnesses.
...
- STRICT STRUCTURAL CONTRACT (author ALL of these YOURSELF, as concrete scene-register clues — a character sees/hears/finds something. NEVER meta-boilerplate like "adds texture to the case background"; if you omit any, a deterministic pass will synthesize flat machine text in its place, which reads as machine-made):
    ...
    • REQUIRED ID: "clue_early_2" with sourceInCML=CASE.prose_requirements.clue_to_scene_mapping[1].clue_id
    • REQUIRED ID: "clue_early_3" with sourceInCML=CASE.prose_requirements.clue_to_scene_mapping[2].clue_id
