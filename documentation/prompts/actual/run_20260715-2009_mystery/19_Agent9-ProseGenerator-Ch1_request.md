...
- Project ID: ``
- Timestamp: `2026-07-15T20:18:05.539Z`
...
- Eleanor Voss
  ...
  Connection to victim: Former acquaintances turned rivals over social status; Eleanor and Mallory were once friends at university, but their paths diverged sharply after Eleanor became a journalist and Mallory pursued medicine..
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=7355; context=9337; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The lifeless body of Dr. Mallory Finch sprawled on the floor, a clock showing ten minutes past seven on the wall."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the victim died no later than seven minutes past seven, contradicting several suspects' alibis."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor hesitates at the door, feeling the weight of impending revelations."
      ]
    },
    ...
    "emotionalRegister": "A mix of elegance and foreboding sets the stage for the unfolding mystery.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (clock, rewound, create, false, narrative, time, death, indicating, occurred, earlier, actually) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
