...
- Project ID: ``
- Timestamp: `2026-05-17T17:46:42.521Z`
...
• [clue_dust_on_clock] An unusual amount of dust on the clock indicates it hasn't been disturbed recently.
  Category: physical | Criticality: essential | Supports inference step 2
  Points to: Suggests that the clock was not recently manipulated.

• [clue_core_elimination_chain_3] Eliminates Beatrice Quill because she was with Eleanor Voss at the charity event.
...
CLUES ALREADY REVEALED TO READER: clue_time_display, clue_witness_statements, clue_fp_contradiction_step_1, clue_mechanism_visibility_core — do not reveal these as new information.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As Eleanor examined the clock once more, she felt a surge of determination rising within her. She would not rest until she uncovered the truth behind the murder and the deception that had taken place in Little Middleton Manor. The clock, with its frozen hands..."
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=8298; context=9693; dropped=[none]; truncated=[pronoun_accuracy, temporal_context]
...
- Chapter 4:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As Eleanor examined the clock once more, she felt a surge of determination rising within her. She would not rest until she uncovered the truth behind the murder and the deception that had taken place in Little Middleton...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • An unusual amount of dust on the clock indicates it hasn't been disturbed recently. [clue_dust_on_clock]
      Points to: Suggests that the clock was not recently manipulated.
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The dust on the clock, indicating it hasn't been touched recently"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the clock was likely tampered with after the murder to create a false timeline."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor brushes her fingers over the clock, feeling its cold surface."
      ]
    },
    ...
    "permittedBehavioursByAct": [
      {
        ...
        "behaviour": "cooperative; growing determination in Act II"
      }
    ],
    "redHerringPlacement": null,
    "emotionalRegister": "A pivotal clue regarding the clock shifts the direction of the investigation.",
