...
- Project ID: ``
- Timestamp: `2026-05-17T17:46:11.513Z`
...
• [clue_time_display] The clock in the study shows ten minutes past eleven at the time of the murder.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: Indicates the exact time displayed on the clock during the murder.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=5117; context=9157; dropped=[none]; truncated=[pronoun_accuracy, temporal_context]
...
- clue_time_display must appear in Act 1, Scene 1 via Direct observation
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The clock in the study shows ten minutes past eleven at the time of the murder. [clue_time_display] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: Indicates the exact time displayed on the clock during the murder.
...
Chapter 1 (Act 1) completeness contract:
  ...
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_1] Captain Hale mentions that the clock ran correctly at dinner, suggesting no tampering.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor glances at the clock, a shadow of fear crossing her face."
      ]
    },
    ...
    "permittedBehavioursByAct": [
      ...
      },
      {
        ...
        "behaviour": "shocked but composed; no guilt-tells in Act I"
      }
    ],
    "redHerringPlacement": {
      "redHerringId": "rh_1",
      "placementDetail": "Captain Hale mentions that the clock ran correctly at dinner, suggesting no tampering."
    },
    "emotionalRegister": "The atmosphere is heavy with tension and unease as the murder disrupts the gathering.",
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 1: "The clock in the study shows ten minutes past eleven at the time of the murder." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
