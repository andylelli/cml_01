...
- Project ID: ``
- Timestamp: `2026-05-17T18:09:03.794Z`
...
Eleanor confronts her own past, intertwining personal stakes with the case.
...
Rationale: Mallory's humor can lighten the investigation atmosphere.
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Eleanor grapples with the duality of her feelings; she yearns for revenge yet questions whether it will truly bring her peace or merely deepen her bitterness."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Mallory struggles with the implications of her choices, torn between her desire for personal happiness and the potential fallout that could jeopardize her life’s work."
...
CHAPTER SENSORY PALETTE HINTS (evoke these qualities without copying verbatim):
  Chapter 6 palette — evening, clear, Tense anticipa
[truncated for prompt budget]
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "The tension between them eased slightly, but the air remained charged with uncertainty. Eleanor turned her gaze back to the manor, where the guests continued their conversations, oblivious to the turmoil brewing just outside. The clock's hands, frozen at ten m..."
...
Chapter 3: Chapter 3: Cross-Checking Evidence
  Events: Eleanor leaned in, her breath catching as she scrutinized the clock's face.
Chapter 4: Chapter 4: Examining the Clock
  Events: The afternoon light filtered dimly through the rain-streaked windows of the study, casting shadows that danced across the room.
Chapter 5: Chapter 5: Confronting Beatrice
  Events: Eleanor's gaze fell upon Beatrice, who was standing a few paces away, her fingers nervously twisting a delicate silver necklace.
...
Known location profile anchors: Little Middleton Manor, The Library, The Drawing Room, The Servants' Hall, The Gardens, the library
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The Library", "The Drawing Room", "The Servants' Hall", "The Gardens", "the library"
...
- Chapter 4 (score 95/100):
  Quality gaps noted: word density below preferred target (901/1000); scene grounding weakness
...
- Chapter 5 (score 85/100):
  ...
  Address in upcoming chapters: Increase chapter density with concrete investigation action and sensory-grounded beats; avoid recap-only padding. | Open next chapter with a named location anchor plus at least two sensory cues and one atmosphere marker.
- Phrases to avoid (already overused in earlier chapters): "the clock shows ten minutes past eleven", "hearing it chime a quarter past eleven", "someone wanted to mislead us about the", "wanted to mislead us about the time", "mislead us about the time of death".
[END INTERNAL DIAGNOSTICS]

PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=10947; context=10615; dropped=[none]; truncated=[pronoun_accuracy, location_profiles, temporal_context]
...
- Chapter 6:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "The tension between them eased slightly, but the air remained charged with uncertainty. Eleanor turned her gaze back to the manor, where the guests continued their conversations, oblivious to the turmoil brewing just out...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • Eliminates Eleanor Voss because she was seen at the charity event during the time of the murder. [clue_core_elimination_chain]
      Points to: Confirms her alibi and rules her out as a suspect.
    • Eliminates Dr. Mallory Finch because he was attending a medical conference at the time of the murder. [clue_core_elimination_chain_2]
      Points to: Confirms his alibi and rules him out as a suspect.
    • Eliminates Beatrice Quill because she was with Eleanor Voss at the charity event. [clue_core_elimination_chain_3]
      Points to: Confirms her alibi and rules her out as a suspect.
    • Direct evidence ties Captain Ivor Hale to the mechanism access point before the discriminating test. [clue_culprit_direct_captain_ivor_hale]
      Points to: This direct evidence shows Captain Ivor Hale had means and opportunity, narrowing the solution uniquely toward the culprit.
    • An unusual amount of dust on the clock indicates it hasn't been disturbed recently. [clue_fp_contradiction_step_3]
      Points to: The clock was likely tampered with after the murder to create a false timeline.
  - Tonal contrast: include at least one beat of relief or ironic counterpoint. Do not sustain maximum tension for every paragraph.
  - Sensory obligation — use at least two of: Candlelight casting long shadows, Reflections in polished wood | The tick of a mantel clock, The faint murmur of voices from other rooms | Candle wax. Mood: Tense anticipation.
...
Chapter 6 (Act 2) completeness contract:
  ...
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Dr. Finch's alibi remains tenuous, but he claims to have been at the conference."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Dr. Finch's hand trembles as he adjusts his glasses."
      ]
    },
    ...
    "permittedBehavioursByAct": [
      {
        ...
        "behaviour": "assertive; seeking truth in Act II"
      },
      {
        "characterName": "Dr. Mallory Finch",
        "behaviour": "nervous; defensive in Act II"
      }
    ],
    "redHerringPlacement": null,
    "emotionalRegister": "A revelation about the timeline of the murder brings clarity to the chaos.",
    ...
    "locationRegisterNote": "The library feels like a tense sanctuary, where shadows and whispers intermingle. The flickering candlelight casts an eerie glow, intensifying the air of secrecy and foreboding. Every corner seems to hold a hidden truth, waiting to be uncovered amidst the dust-laden tomes. — As a writer enters, the camera should capture the juxtaposition of warmth from the fire against the cold reality of the crime, heightening the sense of unease."
  }
]
```
