...
- Project ID: ``
- Timestamp: `2026-05-17T18:08:53.432Z`
...
A pivotal clue regarding the clock shifts the direction of the investigation.
...
Rationale: Tension-filled moments should remain serious.
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Beatrice is torn between her ambition and her jealousy, struggling to reconcile her feelings towards Eleanor with her desire for success in the art world."
...
CHAPTER SENSORY PALETTE HINTS (evoke these qualities without copying verbatim):
  Chapter 5 palette — afternoon, overcast, Pensive m
[truncated for prompt budget]
...
• [clue_core_contradiction_chain] The clock's time does not match witness accounts of a quarter past eleven.
  Category: temporal | Criticality: essential | Supports inference step 2
  Points to: Contradicts the reliability of the witnesses' statements.

• [clue_fp_contradiction_step_3] An unusual amount of dust on the clock indicates it hasn't been disturbed recently.
...
CLUES ALREADY REVEALED TO READER: clue_time_display, clue_witness_statements, clue_fp_contradiction_step_1, clue_mechanism_visibility_core, clue_dust_on_clock, clue_core_elimination_chain_3 — do not reveal these as new information.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As they prepared to leave the study, Eleanor took one last look at the clock, its frozen hands a stark reminder of the mystery that lay ahead. The dust on its surface was more than just a sign of neglect; it was a clue that hinted at the deception that had unf..."
...
Chapter 2: Chapter 2: Witness Statements
  Events: The evening was thick with tension, the air heavy as the rain drummed against the windows of the drawing room.
...
Known location profile anchors: Little Middleton Manor, The Library, The Drawing Room, The Servants' Hall, The Gardens, the garden
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The Library", "The Drawing Room", "The Servants' Hall", "The Gardens", "the garden"
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=9712; context=10426; dropped=[none]; truncated=[pronoun_accuracy, location_profiles, temporal_context]
...
- Chapter 5:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As they prepared to leave the study, Eleanor took one last look at the clock, its frozen hands a stark reminder of the mystery that lay ahead. The dust on its surface was more than just a sign of neglect; it was a clue t...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The clock's time does not match witness accounts of a quarter past eleven. [clue_core_contradiction_chain]
      Points to: Contradicts the reliability of the witnesses' statements.
  ...
  - Sensory obligation — use at least two of: Muted colors of flowers, Low-hanging clouds | Wind rustling through the trees, The distant chatter of guests | Earthy scents. Mood: Pensive.
...
Chapter 5 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Beatrice's shifting demeanor during the confrontation"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Beatrice harbors jealousy towards Eleanor, complicating her alibi."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Beatrice's expression hardens as Eleanor presses her for answers."
      ]
    },
    ...
    "permittedBehavioursByAct": [
      ...
      },
      {
        ...
        "behaviour": "defensive; jealousy evident in Act II"
      }
    ],
    "redHerringPlacement": null,
    "emotionalRegister": "Eleanor confronts her own past, intertwining personal stakes with the case.",
