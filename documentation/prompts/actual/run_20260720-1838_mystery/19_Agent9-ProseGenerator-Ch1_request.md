...
- Project ID: ``
- Timestamp: `2026-07-20T18:44:51.230Z`
...
- Eleanor Voss
  ...
  Connection to victim: Had a brief romantic involvement before Hugo's ruthless side was revealed.; Eleanor and Hugo shared a passionate affair that ended when Hugo's business ethics were exposed..
  Investigation relevance: is actively driving interviews and credibility checks in this scene.
  Suspicion/pressure cue seed: Discovery of the truth.
...
• [clue_mechanism_visibility_core] rare, botanical, poison, administered, drink, takes, effect, hours, creating, confusion, around, time
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: mechanism, poison, delayed, effect

• [clue_id_2] witnesses, recall, seeing, hugo, drinking, glass, shortly, before, collapse
...
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the hotel lounge". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=7658; context=9272; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • concept, delayed, effects, poison, discussed, among, characters [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The shattered glass on the floor beside the victim's body."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Hugo was drinking just before he collapsed, raising immediate suspicions."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor Voss hesitates at the threshold, feeling the weight of the moment."
      ]
    },
    "summary": "Eleanor Voss arrives at the hotel lounge to find the atmosphere thick with tension. She discovers Hugo Vane's lifeless body slumped over a table, a glass shattered on the floor beside him. The shock ripples through the gathering guests as they realize that the night’s festivities have turned into a nightmare.",
    "beat": "gathering",
    "estimatedWordCount": 1800,
    "pivotElement": "The shattered glass on the floor beside the victim's body.",
    "factEstablished": "Establishes that Hugo was drinking just before he collapsed, raising immediate suspicions.",
    "permittedBehavioursByAct": [
      ...
      },
      {
        ...
        "behaviour": "N/A as he is the victim."
      }
    ],
    "redHerringPlacement": null,
    "emotionalRegister": "The festive atmosphere is overshadowed by a sense of impending doom.",
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (rare, botanical, poison, administered, drink, takes, effect, hours, creating, confusion, around, time) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_id_2] (witnesses, recall, seeing, hugo, drinking, glass, shortly, before, collapse) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
