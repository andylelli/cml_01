...
- Project ID: ``
- Timestamp: `2026-07-20T18:49:49.437Z`
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Beatrice wrestles with the tension between her desire for freedom and the expectations of her family, fearing that her choices could lead to disastrous consequences."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Sylvia battles with the ethical implications of her actions, torn between her ambition and the morality of her choices as she navigates the cutthroat fashion world."
...
• [clue_2] witnesses, noted, peculiar, floral, scent, lingering, hugo, clothing
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: connection, scent, poison

• [clue_3] finch, access, poison, used
  Category: behavioral | Criticality: essential | Supports inference step 3
  Points to: finch, opportunity, commit, crime

• [clue_4] mallory, finch, exhibits, signs, professional, jealousy, towards, hugo
  Category: behavioral | Criticality: essential | Supports inference step 3
  Points to: finch, motive
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_id_2, clue_core_contradiction_chain, clue_id_4, clue_1, clue_fp_contradiction_step_1, clue_fp_contradiction_step_2 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): mechanism, poison, delayed, effect | hugo, drinking, behavior, prior, collapse | hugo, drinking, behavior, prior, collapse | finch, access, poison | finch, access, poison | hugo, drink, likely, tampered, leading, death | finch, access, poison, used
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Eleanor’s authority was quietly challenged, not through outright resistance, but through evasive responses and nervous glances. The group’s reluctance to cooperate grew more pronounced, as suspicions circled back to Dr. Finch. The hotel bar was now the nerve c..."
...
Chapter 3: Chapter 3: The Investigation Begins
  Events: Late morning found the hotel bar cloaked in a silvery fog, its windows blurred and the sunlight fighting to break through the haze.
...
Known location profile anchors: The Grand Oceanview Hotel, Seaside Terrace, Library Lounge, Dining Room, Staff-Only Kitchen, the hotel dining room
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Grand Oceanview Hotel", "Seaside Terrace", "Library Lounge", "Dining Room", "Staff-Only Kitchen", "the hotel dining room"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=13111; context=10021; dropped=[humour_guide, location_profiles]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 4:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Eleanor’s authority was quietly challenged, not through outright resistance, but through evasive responses and nervous glances. The group’s reluctance to cooperate grew more pronounced, as suspicions circled back to Dr....".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • eleanor, voss, confirmed, elsewhere, time, incident [clue_core_elimination_chain]
      Points to: eleanor, voss, alibi
    • distinct, floral, scent, mentioned, multiple, witnesses [clue_2]
      Points to: connection, scent, poison
    • finch, access, poison, confirmed, investigation [clue_3]
      Points to: finch, opportunity, commit, crime
    • finch, behavior, remarks, indicate, jealousy [clue_4]
  ...
  - Sensory obligation — use at least two of: dim light casting shadows on tables, cloudy views of the sea | quiet conversation, soft music in the background | scent of fresh seafood. Mood: sombre.
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Beatrice's admission of her affair with Hugo."
...
[
  {
    ...
    "purpose": "Reveal motives and create suspicion",
    "cluesRevealed": [
      "clue_2",
      "clue_3",
      "clue_4"
    ...
    "dramaticElements": {
      "conflict": "Eleanor pressures the suspects for motives.",
      "tension": "Each suspect reveals their hidden grievances.",
      "microMomentBeats": [
        "Beatrice's voice shakes as she defends her actions."
      ]
    },
    "summary": "In the dining room, Eleanor questions Beatrice and Sylvia about their potential motives for wanting Hugo dead. Beatrice's affair is revealed, and Sylvia's jealousy as a rival designer comes to light. The tension escalates as Eleanor senses deeper secrets.",
    "beat": "motives",
    "estimatedWordCount": 2000,
    "pivotElement": "Beatrice's admission of her affair with Hugo.",
    ...
    "emotionalRegister": "A critical clue shifts the focus of suspicion, amplifying the tension.",
