...
- Project ID: ``
- Timestamp: `2026-07-20T18:57:46.603Z`
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "She glanced at Dr. Finch, whose measured calm was now fractured, and at Beatrice and Sylvia, their faces drawn, each marked by private longing and fear. The evening’s chill pressed against the windows, and Eleanor knew the investigation had deepened. The cost—..."
...
Known location profile anchors: The Grand Oceanview Hotel, Seaside Terrace, Library Lounge, Dining Room, Staff-Only Kitchen, the hotel terrace
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Grand Oceanview Hotel", "Seaside Terrace", "Library Lounge", "Dining Room", "Staff-Only Kitchen", "the hotel terrace"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=18370; context=4836; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 7:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "She glanced at Dr. Finch, whose measured calm was now fractured, and at Beatrice and Sylvia, their faces drawn, each marked by private longing and fear. The evening’s chill pressed against the windows, and Eleanor knew t...".
...
Chapter 7 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The revelation of Beatrice's and Sylvia's past connections to Hugo."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that both women had motives but were not present at the time of the murder."
...
[
  {
    ...
    "dramaticElements": {
      "conflict": "Eleanor confronts the suspects with their hidden truths.",
      "tension": "The air is thick with unspoken words as secrets surface.",
      "microMomentBeats": [
        "Eleanor's heart races as she pieces together the puzzle."
      ]
    },
    "summary": "On the terrace, Eleanor confronts Dr. Finch and Beatrice about their hidden motives and past grievances with Hugo. As secrets come to light, it becomes clear that both women had reasons to want Hugo out of the way. However, their alibis begin to clear them, leading Eleanor to a startling realization.",
    "beat": "secrets",
    "estimatedWordCount": 2000,
    "pivotElement": "The revelation of Beatrice's and Sylvia's past connections to Hugo.",
    "factEstablished": "Establishes that both women had motives but were not present at the time of the murder.",
