...
- Timestamp: `2026-04-15T17:32:27.679Z`
...
**Character Names** (pre-selected — use EXACTLY as given, do not alter, abbreviate, or substitute any name): Alison Lacy, Delphine Drury, Alan Corbet, Julie Villiers, Clive Tracy
...
**Setting**: 1940s - A grand country estate featuring large gardens, a formal ballroom, and numerous bedrooms for guests and staff, showcasing the wealth of the owners.
**Crime Type**: Murder
**Social Context**: women entering the workforce due to WWII, class distinctions emphasized, post-war trauma affecting social interactions
**Tone**: Classic
