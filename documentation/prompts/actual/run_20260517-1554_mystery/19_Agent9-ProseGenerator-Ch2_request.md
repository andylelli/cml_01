...
- Project ID: ``
- Timestamp: `2026-05-17T15:58:26.961Z`
...
The atmosphere is initially vibrant but quickly darkens with the shadow of the murder.
...
Rationale: The initial atmosphere needs to maintain seriousness due to the murder.
...
Act 1 behaviour contract: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "The fear of the victim revealing their affair is a constant shadow over Mallory's thoughts, as it could derail her career and tarnish the respect she has worked so hard to earn." — do not surface in Act I.
...
Act 1 behaviour contract: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "He believes the victim wronged him in a bitter family inheritance dispute, a wound that has never healed and now colors his perception of the murder." — do not surface in Act I.
...
• [clue_2] This indicates that the murder could not have occurred after eight o'clock.
...
• Evidence in reader's hands: The clock in the study shows the time as quarter past eight.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "The tension in the room was palpable, a taut string ready to snap at any moment. Beatrice stepped closer to Eleanor, her voice low and steady. "We start by retracing the last moments before the murder. We need to gather every detail, no matter how small. The c..."
...
Known location profile anchors: Little Middleton Manor, Drawing Room, Library, Study, Gardens, the dining room
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "Drawing Room", "Library", "Study", "Gardens", "the dining room"
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=6381; context=11007; dropped=[none]; truncated=[pronoun_accuracy, location_profiles, temporal_context]
...
- clue_2 must appear in Act 1, Scene 2 via Witness statements about the last time the victim was seen.
...
- Chapter 2:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "The tension in the room was palpable, a taut string ready to snap at any moment. Beatrice stepped closer to Eleanor, her voice low and steady. "We start by retracing the last moments before the murder. We need to gather...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • This indicates that the murder could not have occurred after eight o'clock. [clue_2] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: This contradicts any claims of the murder happening later.
...
Chapter 2 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Eleanor's shaky account of the last time she saw the victim."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that all suspects were present in the house at the time of the murder, complicating the timeline."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_2] Captain Hale mentions seeing a shadowy figure near the study, creating suspicion.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Beatrice observes the tension in the room, noting the way Ivor clenches his fists."
      ]
    },
    "summary": "Beatrice Quill interviews the suspects, including the doctor Finch and the captain Hale, who provide their last sightings of the victim. Eleanor’s account is shaky, raising suspicions about her reliability.",
    ...
    "permittedBehavioursByAct": [
      ...
      },
      {
        ...
        "behaviour": "normal social behaviour; grief if appropriate"
      },
      {
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_2",
      "placementDetail": "Captain Hale mentions seeing a shadowy figure near the study, creating suspicion."
    },
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 2: "This indicates that the murder could not have occurred after eight o'clock." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
