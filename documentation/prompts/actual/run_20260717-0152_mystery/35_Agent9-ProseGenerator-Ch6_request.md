...
- Project ID: ``
- Timestamp: `2026-07-17T02:03:12.570Z`
...
• [clue_11] captain, ivor, hale, expressed, fear, scandal, questioned, eleanor
  Category: behavioral | Criticality: essential | Supports inference step 3
  Points to: hale, fear, scandal, suggests, motive, murder
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the evening deepened and the wind howled against the windows, Hugo resolved to test each story to its breaking point. The clues, once scattered and ambiguous, were beginning to align. But the truth, he knew, would not come easily. It would have to be forced..."
...
Known location profile anchors: Cliffside Retreat Hotel, The Ocean View Lounge, Room 203 - The Seaside Suite, The Staff Kitchen, The Grand Staircase, the bar of the seaside hotel
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Cliffside Retreat Hotel", "The Ocean View Lounge", "Room 203 - The Seaside Suite", "The Staff Kitchen", "The Grand Staircase", "the bar of the seaside hotel"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=18452; context=5451; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 6:
  ...
  - Scene is set in: the bar of the seaside hotel — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the evening deepened and the wind howled against the windows, Hugo resolved to test each story to its breaking point. The clues, once scattered and ambiguous, were beginning to align. But the truth, he knew, would not...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • hale, demeanor, changes, eleanor, name, mentioned [clue_11]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • eleanor, body, located, close, beach [clue_12]
      Points to: beach, location, significant, events, surrounding, murder
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The detective's realization of a flaw in the accusation against Dr. Finch."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes a false solution that the detective knows is incorrect, keeping the tension high."
...
[
  {
    ...
    "setting": {
      ...
      "atmosphere": "The atmosphere is thick with suspicion as the detective considers the evidence."
    },
    "characters": [
      "Hugo Vane",
      "Captain Ivor Hale",
    ...
    "purpose": "Present a misleading solution that the detective will later disprove.",
    "cluesRevealed": [
      "clue_11"
    ],
    "dramaticElements": {
      "conflict": "The detective's thoughts lead to a false conclusion.",
      "tension": "The guests await the detective's findings with bated breath.",
      "microMomentBeats": [
        "Hugo takes a long drink, trying to steady his racing thoughts."
      ]
    },
    "summary": "In the bar, Hugo Vane contemplates the evidence and arrives at a seemingly convincing conclusion that Dr. Mallory Finch is the murderer, driven by her fear of exposure regarding her addiction. However, he soon realizes that this solution has one significant flaw that he cannot ignore.",
    "beat": "false_solution",
    "estimatedWordCount": 1800,
    "pivotElement": "The detective's realization of a flaw in the accusation against Dr. Finch.",
    "factEstablished": "Establishes a false solution that the detective knows is incorrect, keeping the tension high.",
    ...
    "emotionalRegister": "The uncovering of Hale's guilt alters the dynamics among the guests.",
