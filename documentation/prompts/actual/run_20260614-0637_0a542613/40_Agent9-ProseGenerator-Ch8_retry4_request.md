...
- Timestamp: `2026-06-14T06:46:01.131Z`
...
🚨 FINAL ATTEMPT — MANDATORY DISCRIMINATING TEST REBUILD:
  Write the discriminating test as exactly three paragraphs:
  Paragraph A: The detective declares aloud: "There is one thing only the true culprit could have done: [specific test]." Then explains the evidence basis.
  Paragraph B: Goes through each non-culprit suspect by name: "[Suspect] could not have [done X] because [specific evidence from the CML]."
  Paragraph C: States the culprit: "Only [Culprit Name] could have [done X]." Names the culprit explicitly and states at least two items of proof.
  Use the EXACT character names from the cast. This three-paragraph block must appear in the chapter — not compressed into single-sentence dialogue.
