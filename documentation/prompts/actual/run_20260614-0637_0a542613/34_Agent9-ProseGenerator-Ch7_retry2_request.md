...
- Timestamp: `2026-06-14T06:45:02.945Z`
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=12514; context=10401; dropped=[none]; truncated=[temporal_context, pronoun_accuracy]
...
```text
Attempt 3/6 — chapters 7 — 2 validation issue(s) to resolve:
...
• Template linter: high n-gram overlap detected (0.76 >= 0.60). Rephrase this passage to avoid template leakage.
...
• WORD COUNT TARGET [template_overlap — attempt 3]: While rephrasing for uniqueness, you MUST write at least 1250 words.
