...
- Project ID: ``
- Timestamp: `2026-05-12T19:50:53.398Z`
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=14617; context=9397; dropped=[none]; truncated=[location_profiles, temporal_context]
...
- Template linter: high n-gram overlap detected (0.94 >= 0.80). Rephrase this passage to avoid template leakage.
