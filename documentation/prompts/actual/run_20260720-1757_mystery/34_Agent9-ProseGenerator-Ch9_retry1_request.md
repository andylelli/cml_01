...
- Project ID: ``
- Timestamp: `2026-07-20T18:11:29.307Z`
...
• [clue_late_optional_slot_1] finch, last, known, movements, before, dinner, remains, late, texture, detail, case, background
...
• [clue_6] mechanism, relies, poison, victim, floor, expose, false, timing
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: mechanism, murder, revealed
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Eleanor stepped into the corridor, the chill of the night a bracing counterpoint to the stifling air she left behind. The investigation was not yet finished, but the path ahead was clearer. With her notes on the suspects' timelines in hand and a plan forming i..."
...
Render this test MECHANISM as live, in-scene action and dialogue, composing ENTIRELY in your own words from these elements (reproducing any briefing phrase verbatim FAILS validation): reenactment, staged, used, conditions, humidity, releases, poison
...
☐ **Evidence Integration**
  ...
  ☐ Explicitly reference or use clue: "clue_damp_key" (clue) (appears in Act 1, Scene 3)
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=25016; context=4844; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 9:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Eleanor stepped into the corridor, the chill of the night a bracing counterpoint to the stifling air she left behind. The investigation was not yet finished, but the path ahead was clearer. With her notes on the suspects...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • finch, last, known, movements, before, dinner, remains, late, texture, detail, case, background [clue_late_optional_slot_1]
      Points to: adds, late, texture, changing, essential, deduction, chain
    • details, mechanism, murder [clue_6]
      Points to: mechanism, murder, revealed
  - ⚠ SUSPECT CLEARANCE REQUIRED (MANDATORY): each suspect below MUST be named explicitly and cleared with on-page evidence and a reasoning connector (because / therefore / which proves):
    • "Beatrice Quill": write a dedicated paragraph that (a) names Beatrice Quill explicitly, (b) states the clearance method ("Alibi confirmed by hotel logs showing her duties."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
    • "Sylvia Trent": write a dedicated paragraph that (a) names Sylvia Trent explicitly, (b) states the clearance method ("Her alibi is verified through other guests."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
    • "Hugo Vane": write a dedicated paragraph that (a) names Hugo Vane explicitly, (b) states the clearance method ("Business calls confirmed unrelated to Dr. Finch."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
  ...
  - ⚠ DISCRIMINATING TEST (trap) — MANDATORY real-time scene with dialogue and confrontation. DO NOT summarize it after the fact.
    ...
    Elements the test must dramatize (compose the scene ENTIRELY in your own sentences from these — reproducing any briefing phrase verbatim FAILS validation): reenactment, staged, used, conditions, humidity, releases, poison
    Cite these already-revealed clue IDs during the test: clue_6, clue_core_contradiction_chain, clue_1, clue_damp_key
    ...
    Motive statement REQUIRED: the culprit must explicitly state or acknowledge their motive during or immediately after the confrontation. Canonical motive: "Jealousy from unrequited affection". Do not omit it.
...
Chapter 9 (Act 3) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The key's reaction revealing traces of poison."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes Captain Hale's guilt through the key's reaction, implicating him in the murder."
...
[
  {
    ...
    "emotionalRegister": "The emotional toll of ambition is laid bare as the true culprit is confronted.",
...
```text
{
  ...
  "chapters": [
    {
      ...
      "summary": "Eleanor stages a reenactment in Dr. Finch's hotel room, using the damp key and the recreated conditions to reveal the method of poisoning. As the key reacts and the evidence mounts, she clears the innocent and confronts Captain Ivor Hale, forcing the truth into the open.",
      "paragraphs": [
        ...
        "She turned to Beatrice Quill first. 'Beatrice, your alibi holds. The hotel logs show you were in the library from just after dinner until nearly midnight. Two guests signed in after you, and both recall seeing you sketching by the fire. That, and the log entries, confirm you could not have been here when the crime was committed.' Beatrice let out a shaky breath, relief softening the tension in her posture. 'Thank you, Eleanor,' she whispered, her voice cracking. 'I never wanted this shadow.'",
        "Eleanor continued, her gaze moving to Sylvia Trent. 'Sylvia, I have spoken to the guests on your floor. They saw you tending to Mrs. Larkin’s sick child until well after Dr. Finch retired for the evening. Your movements are accounted for, and there is no window for you to have entered this room undetected. Therefore, you are cleared.' Sylvia’s eyes filled with tears, her hands pressed to her mouth in silent gratitude. 'I—I only ever tried to help,' she managed, her voice barely above a whisper.",
        "She faced Hugo Vane next. 'Mr. Vane, your transatlantic call at ten minutes past eleven is confirmed by the switchboard operator and the telegram records. You could not have left the lounge during the crucial window. The business call, unrelated to Dr. Finch, proves your innocence.' Hugo inclined his head, the rigid set of his jaw easing. 'I appreciate your thoroughness, Miss Voss. I had no quarrel with Dr. Finch worth killing for.'",
  ...
  "note": "",
  "audit": {
    "locked_fact_phrases": "present in paragraph 1, 7, 8 | absent",
    "season_words_used": "autumn, autumnal, fall, autumn sunlight, autumn light",
    "discriminating_test_present": "yes: chapter 9 paragraph 8",
    "required_clues_present": "clue_late_optional_slot_1: chapter 9 paragraph 4; clue_6: chapter 9 paragraph 8",
    "early_observation_present": "sound of sea, creak of floorboards, warmth of room, residue on key: chapter 9 paragraph 1 (first 25%)",
