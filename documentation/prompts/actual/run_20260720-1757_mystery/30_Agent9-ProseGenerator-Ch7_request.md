...
- Project ID: ``
- Timestamp: `2026-07-20T18:09:57.373Z`
...
• [clue_1] residue, consistent, botanical, poison
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: involvement, poisoning

• [clue_2] witnesses, confirm, captain, hale, seen, near, finch, room, shortly, before, death
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the lounge emptied, the lamplight flickered, casting long shadows across the worn carpet. Eleanor pressed her fingers to her temples once more, feeling the weight of the case and her own uncertainty. Somewhere in the tangle of clues and accusations, the tru..."
...
Known location profile anchors: The Grand Seaside Hotel, The Ocean View Lounge, The Kitchen, The Drawing Room, The Seaside Balcony, Hotel library
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Grand Seaside Hotel", "The Ocean View Lounge", "The Kitchen", "The Drawing Room", "The Seaside Balcony", "Hotel library"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 7: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "Hotel library". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=19208; context=4516; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 7:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the lounge emptied, the lamplight flickered, casting long shadows across the worn carpet. Eleanor pressed her fingers to her temples once more, feeling the weight of the case and her own uncertainty. Somewhere in the...".
...
Chapter 7 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Captain Hale's admission of jealousy towards Dr. Finch."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes new layers of motive and conflict among the suspects, reshaping the investigation."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor feels a chill as she uncovers hidden motives."
      ]
    },
