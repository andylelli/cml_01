...
- Project ID: ``
- Timestamp: `2026-07-20T18:10:55.280Z`
...
• [clue_3] residue, indicates, used, deliver, poison, finch
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: method, poisoning, finch
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As Eleanor stepped into the corridor, the chill of the night pressed close, but inside she felt a new resolve. The false solution had crumbled, replaced by a more complex, more human tangle of motives and fears. The truth was nearer now, hidden in the spaces b..."
...
- Chapter 8:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As Eleanor stepped into the corridor, the chill of the night pressed close, but inside she felt a new resolve. The false solution had crumbled, replaced by a more complex, more human tangle of motives and fears. The trut...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • analysis, residue [clue_3]
      Points to: method, poisoning, finch
    • witness, testimony, finch, health, before, dinner [clue_culprit_direct_1]
...
Chapter 8 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Eleanor's notes on the suspects' timelines."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Eleanor is close to uncovering the truth, with a plan forming in her mind."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor paces, feeling the weight of the case pressing down on her."
      ]
    },
    ...
    "emotionalRegister": "Pressure mounts as secrets are unveiled, leading to a critical confrontation.",
...
```text
{
  ...
  "note": "",
  "audit": {
    "locked_fact_phrases": "present in paragraph 2, paragraph 7",
    "season_words_used": "autumn, autumnal, fall, night, wind, chill, lamplight, moonlight, gloom, shadow, dim, creak, hush, silence, stifling, warm, cold, heavy, damp",
    "discriminating_test_present": "no",
    "required_clues_present": "clue_3: paragraph 6, clue_culprit_direct_1: paragraph 5",
    "early_observation_present": "Eleanor notes the oppressive warmth and the lingering chemical scent in Dr. Finch's hotel room: paragraph 2",
    "early_inference_present": "yes: paragraph 4, as Eleanor reconstructs the suspects' timelines and infers gaps and overlaps"
  }
}
