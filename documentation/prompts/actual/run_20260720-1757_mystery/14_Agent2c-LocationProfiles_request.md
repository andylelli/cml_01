...
- Project ID: ``
- Timestamp: `2026-07-20T18:02:27.252Z`
...
- Era-authentic markers: radio broadcasting, early television sets, basic radar systems, wartime rationing affecting vehicle availability, increased use of post-war automobiles, party-line telephones, long-distance calls, military encryption methods
- Tone: Classic
- No anachronisms
...
Description: A grand seaside hotel built in the early 1920s, featuring Art Deco architecture with ocean views and a sprawling lobby.
...
Setting constraints:
- Physical constraints: narrow hallways limiting movement, staircase access to restricted areas, balconies overlooking the sea
- Geographic isolation: Located on a cliffside, making access difficult during storms and limiting escape routes.
- Access control: staff-only areas such as the kitchen and maintenance rooms, locked storage for valuables, daily guest check-in protocols

Era constraints to include:
- Technology: radio broadcasting, early television sets, basic radar systems
- Transportation: wartime rationing affecting vehicle availability, increased use of post-war automobiles
- Social norms: impact of WWII on societal roles, women increasingly in the workforce
