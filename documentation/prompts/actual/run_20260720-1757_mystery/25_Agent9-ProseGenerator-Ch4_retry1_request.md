...
- Project ID: ``
- Timestamp: `2026-07-20T18:07:44.909Z`
...
```text
{
  ...
  "chapters": [
    {
      ...
      "summary": "Eleanor gathers the main suspects in the Hotel lounge to probe their motives, uncovering Beatrice's resentment, Hugo's financial anxieties, and Captain Hale's jealousy. The investigation grows more complex as each guest's secrets and tensions surface.",
      "paragraphs": [
  ...
  "note": "",
  "audit": {
    "locked_fact_phrases": "present in paragraph 3, 15 | absent",
    "season_words_used": "autumnal, autumn, fall, autumn afternoon | present",
    "discriminating_test_present": "no",
    "required_clues_present": "clue_4: paragraph 10; clue_5: paragraph 17; clue_culprit_direct_captain_ivor_hale: paragraph 17; clue_core_elimination_chain: paragraph 15",
    "early_observation_present": "Beatrice’s trembling hands: paragraph 4 (first 25%)",
...
PRIMARY FAILURES
- Chapter 4: clue evidence "While suspicious, Captain Hale was actually delivering a message and could not have poisoned her." is absent. Include an on-page observation or reference to "While suspicious, Captain Hale was actually delivering a message and could not have poisoned her." (this clue reveals: Captain Hale is not the murderer.) before the chapter ends.

REWRITE PLAN
- Preserve paragraphs that are already valid, but fully rewrite every paragraph touched by a failing issue.
- Insert or move a dedicated observation-plus-inference block for each missing clue: "While suspicious, Captain Hale was actually delivering a message and could not have poisoned her.". The observation and inference must be separate full paragraphs.

SUCCESS CHECKLIST
- Every listed issue below is resolved in this single attempt before you answer.
- Each missing clue appears on-page as observable evidence, followed immediately by a separate inference paragraph: "While suspicious, Captain Hale was actually delivering a message and could not have poisoned her.".
...
• REPAIR [clue_visibility — attempt 2 — PARAGRAPH STRUCTURE REQUIRED]: 1 clue(s) still missing.
  ...
  Clue: "While suspicious, Captain Hale was actually delivering a message and could not have poisoned her."
  ...
  Paragraph B (immediately after Paragraph A): The detective or POV character explicitly state: "Captain Hale is not the murderer.". Use first-person inference language ("She realised...", "He could not help but wonder..."). Full separate paragraph — not a tacked-on sentence.
...
RETRY CLASS: unknown
ATTEMPT: 1/3
OFFENDING TEXT: While suspicious, Captain Hale was actually delivering a message and could not have poisoned her.
MANDATORY FIXES:
