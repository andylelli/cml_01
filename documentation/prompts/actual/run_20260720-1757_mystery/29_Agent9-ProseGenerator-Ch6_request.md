...
- Project ID: ``
- Timestamp: `2026-07-20T18:09:11.910Z`
...
• [clue_core_elimination_chain] eliminates, beatrice, quill, because, seen, library, time, death
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: narrowing, suspicion, away, beatrice, quill

• [clue_7] finch, body, exhibited, signs, convulsion, froth, mouth
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: manner, finch, death

• [clue_reenactment] witnesses, confirm, captain, hale, seen, near, finch, room, shortly, before, death
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: captain, hale, potential, involvement, murder
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As she stepped into the corridor, the wind howled anew, rattling the doors. Behind her, the dining room returned to its hush, the secrets of the Seaside Hotel lingering in every shadow. The night was far from over, and Eleanor knew—some locks, once opened, cou..."
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=18354; context=5523; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_reenactment must appear in Act 2, Scene 3 via Controlled test
- clue_witness_testimony must appear in Act 2, Scene 3 via Witness accounts
...
- Chapter 6:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As she stepped into the corridor, the wind howled anew, rattling the doors. Behind her, the dining room returned to its hush, the secrets of the Seaside Hotel lingering in every shadow. The night was far from over, and E...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • witness, testimony, captain, hale, presence [clue_2]
      Points to: captain, hale, potential, involvement, murder
    ...
    • physical, state, finch, body [clue_7]
      Points to: manner, finch, death
    ...
    • details, mechanism, murder [clue_culprit_direct_captain_ivor_hale]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • witness, testimony, captain, hale, presence [clue_reenactment]
      Points to: captain, hale, potential, involvement, murder
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Eleanor's doubt about Beatrice's guilt."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes a false solution accusing Beatrice, while Eleanor remains unconvinced."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor rubs her temples, feeling the weight of the case."
      ]
    },
    ...
    "emotionalRegister": "The reenactment of the poisoning method forces confrontations and deepens tensions.",
