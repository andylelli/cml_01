...
- Project ID: ``
- Timestamp: `2026-07-20T18:09:00.198Z`
...
• [clue_8] eliminates, hugo, vane, because, attending, meeting, time, death
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: narrowing, suspicion, away, hugo, vane

• [clue_6] mechanism, relies, poison, victim, floor, expose, false, timing
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: mechanism, murder, revealed

• [clue_witness_testimony] residue, consistent, botanical, poison
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: involvement, poisoning
...
CLUES ALREADY REVEALED TO READER: clue_residue, clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_damp_key, clue_fp_contradiction_step_1, clue_fp_contradiction_step_2, clue_4, clue_5, clue_culprit_direct_captain_ivor_hale — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): suddenness, finch, death, suspicious | suddenness, finch, death, suspicious | recent, connected, poisoning | recent, connected, poisoning | must, involved, poisoning, based, condition | residue, indicates, used, deliver, poison, finch | captain, hale, possible, motive, murder | captain, hale, murderer | direct, shows, captain, ivor, hale, means
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "She stepped to the window, watching the last of the daylight fade from the clouds, and resolved to follow each thread—resentment, fear, jealousy—to its tangled end. Outside, the wind carried the promise of another long night. Inside, the secrets of the Seaside..."
...
Known location profile anchors: The Grand Seaside Hotel, The Ocean View Lounge, The Kitchen, The Drawing Room, The Seaside Balcony, Hotel dining room
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Grand Seaside Hotel", "The Ocean View Lounge", "The Kitchen", "The Drawing Room", "The Seaside Balcony", "Hotel dining room"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 5: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a temporal subordinate clause — e.g. "When [Name] entered…" / "After the last guest…" / "Before the household had stirred…" / "As the light faded…". Anchor opening in "Hotel dining room". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Chapter 4 (score 94/100):
  ...
  Address in upcoming chapters: Surface missing clue evidence on-page with observable detail: captain, hale, alibi, regarding, actions [clue_5].
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=15099; context=6976; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 5:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "She stepped to the window, watching the last of the daylight fade from the clouds, and resolved to follow each thread—resentment, fear, jealousy—to its tangled end. Outside, the wind carried the promise of another long n...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • residue [clue_1]
      Points to: involvement, poisoning
    • hugo, vane, presence, meeting [clue_8]
      Points to: narrowing, suspicion, away, hugo, vane
    • details, mechanism, murder [clue_6]
      Points to: mechanism, murder, revealed
    • residue [clue_witness_testimony]
      Points to: involvement, poisoning
...
Chapter 5 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Hugo's confirmed business call during the time of death."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Hugo has a solid alibi, while Captain Hale's alibi is questionable."
...
[
  {
    ...
    "emotionalRegister": "New revelations about Captain Hale's past add complexity to the investigation.",
...
```text
{
  ...
  "chapters": [
    {
      ...
      "summary": "Eleanor Voss interrogates Captain Hale and Hugo Vane in the Hotel dining room, confirming Hugo’s alibi and exposing cracks in Hale’s. Physical evidence and witness testimony force Eleanor to reinterpret prior clues, shifting suspicion and deepening the mystery.",
      "paragraphs": [
        "When the first notes of dusk crept through the tall windows, Eleanor Voss lingered at the threshold of the Hotel dining room, the echo of wind and the faint scent of damp linen clinging to the air. The last of the daylight faded, replaced by the flicker of lamplight across white tablecloths and the low, charged murmur of guests at distant tables. She traced a gloved finger along the back of a mahogany chair, the wood cool and smooth beneath her touch, and let her gaze settle on the two men across from her—Captain Ivor Hale, posture rigid in his navy suit, and Hugo Vane, immaculate as ever, his cufflinks catching the glow with every practiced movement.",
        ...
        "The clink of cutlery from a distant table punctuated the tension. Hugo Vane, ever the observer, leaned back in his chair. 'If you’re implying the Captain slipped away to commit murder, I’d suggest you find a more convincing motive. The man’s too fond of order to court chaos.'",
        "Eleanor’s gaze flicked to the telegram again. The locked alibi—Hugo’s business call at 'ten minutes past eleven'—stood in stark contrast to Captain Hale’s shifting timeline. She recalled the residue on the key, the faint botanical tang that had clung to her glove, and the testimony that placed the Captain near the victim’s room around the same time. The original meaning of the clue—the key’s dampness as a mere oddity—now twisted into something more sinister: a deliberate act, masked by routine.",
        ...
        "A hush fell. Hugo’s eyes narrowed, studying Captain Hale with new interest. 'You’re not suggesting he—'",
  ...
  "cast": ["Eleanor Voss", "Captain Ivor Hale", "Hugo Vane"],
  "note": "",
  "audit": {
    "locked_fact_phrases": "present in paragraphs 5, 12, 15 | absent elsewhere",
    "season_words_used": "autumn, autumnal, fall, dusk, daylight, evening, midnight, wind, rain, lamplight, shadow, chill, damp, flicker, glow, hush",
    "discriminating_test_present": "no",
    "required_clues_present": "clue_8: paragraph 5; clue_6: paragraphs 12, 24; clue_witness_testimony: paragraph 15",
    "early_observation_present": "Eleanor notes Hugo’s telegram and the time stamp in paragraph 5 (first 25%)",
    "early_inference_present": "yes: paragraph 12, Eleanor reinterprets the key’s residue and timeline"
  }
}
