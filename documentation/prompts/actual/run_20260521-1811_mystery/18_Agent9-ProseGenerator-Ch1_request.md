...
- Project ID: ``
- Timestamp: `2026-05-21T18:17:40.805Z`
...
• [clue_mechanism_visibility_core] The mechanical clock in the study shows the hands stuck at ten minutes past eleven.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: This reveals the clock is not functioning correctly.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=5376; context=10055; dropped=[none]; truncated=[temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The mechanical clock in the study shows the hands stuck at ten minutes past eleven. [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: This reveals the clock is not functioning correctly.
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The mechanical clock stuck at ten minutes past eleven."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the victim died no later than ten minutes past eleven, introducing a key time constraint."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor lingers at the door, struggling to conceal her grief."
      ]
    },
    "summary": "In the study, Beatrice Quill discovers the body of Eleanor Voss's uncle, the victim, with a mechanical clock showing ten minutes past eleven. The atmosphere is thick with tension as Eleanor and the doctor Finch await the detective's arrival, each grappling with their own emotions.",
    ...
    "emotionalRegister": "The atmosphere is heavy with grief and tension, setting the stage for the unfolding mystery.",
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 1: "The mechanical clock in the study shows the hands stuck at ten minutes past eleven." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
