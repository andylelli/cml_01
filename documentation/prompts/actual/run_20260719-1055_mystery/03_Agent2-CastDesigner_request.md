...
- Project ID: ``
- Timestamp: `2026-07-19T10:55:50.811Z`
...
**Setting**: 1940s - A sprawling, two-story establishment with ocean views, featuring a main lobby, dining area, and numerous guest rooms. The architecture reflects a blend of Art Deco and Colonial styles, with large windows and a wraparound porch.
**Crime Type**: Murder
**Social Context**: women entering the workforce, post-war societal shifts, lingering WWII traumas
**Tone**: Classic
