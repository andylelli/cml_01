...
- Project ID: ``
- Timestamp: `2026-05-11T19:45:46.210Z`
...
- Era-authentic markers: petrol touring cars on county roads, domestic wiring with frequent outages, typewriters standard in every office, reliable passenger automobiles, peak usage of passenger trains, early commercial aviation for long distances, party-line telephone exchanges common, telegram services available for urgent messages
- Tone: Classic
- No anachronisms
...
Description: A sprawling country estate with multiple wings, grand ballrooms, and extensive gardens, surrounded by dense woods.
...
Setting constraints:
- Physical constraints: large gardens create natural barriers for movement, multiple locked rooms restrict access to certain areas, weather conditions affect outdoor evidence collection
- Geographic isolation: The estate is situated several miles from the nearest town, limiting outside assistance.
- Access control: gates require key access, monitored by staff, certain areas are off-limits to guests during events, staff schedules dictate availability of assistance

Era constraints to include:
- Technology: petrol touring cars on county roads, domestic wiring with frequent outages, typewriters standard in every office
- Transportation: reliable passenger automobiles, peak usage of passenger trains
- Social norms: Great Depression impacting social classes and economy, growing class tensions among the wealthy and working class
