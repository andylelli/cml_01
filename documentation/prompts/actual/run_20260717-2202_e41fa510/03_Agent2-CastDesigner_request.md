...
- Timestamp: `2026-07-17T22:03:48.445Z`
...
**Setting**: 1940s - A dense urban area centered on multiple historic theatres with narrow streets, marquees, and backstage alleyways, characterized by heavy foot traffic during performances and quiet, shadowed streets after hours.
**Crime Type**: Murder
**Social Context**: women increasingly active in workforce including theatre roles, post-war social adjustment and war trauma prevalent, strict social hierarchies within theatre companies, public adherence to blackout and curfew regulations
**Tone**: Cozy
