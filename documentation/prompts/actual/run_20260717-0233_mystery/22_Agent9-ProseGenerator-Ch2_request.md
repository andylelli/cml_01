...
- Project ID: ``
- Timestamp: `2026-07-17T02:41:08.529Z`
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the suspects drifted into subdued conversation, each seeking reassurance in the familiar or the trivial, Eleanor remained by the bar. Her thoughts circled the evidence: the sudden plunge to forty-eight degrees Fahrenheit, the irreconcilable times, the faces..."
...
Chapter 1: Chapter 1: Discovery in the Bar
  Events: Eleanor Voss pressed her gloved hand to the brass handle of the bar’s door, the metal cold even in the midsummer morning.

⚠️ **VALIDATION:** Character name mismatches and setting drift are common failure modes.
Double-check every character name against the list above before using it.

**⏱ LOCKED TIME ANCHOR — use verbatim, do not paraphrase:**
Clock time (from the case ground truth): **"Midnight temperature drop"**
...
Known location profile anchors: The Seafront Grand Hotel, The Oceanview Lounge, The Grand Library, The Grand Dining Room, The Staff Quarters, the bar, still filled with tension
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Seafront Grand Hotel", "The Oceanview Lounge", "The Grand Library", "The Grand Dining Room", "The Staff Quarters", "the bar, still filled with tension"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 2: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with spoken dialogue — e.g. '"[words]," [Name] said/asked/replied/murmured.' The opening quote must be the first character on the line. Anchor opening in "the bar, still filled with tension". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=9658; context=13038; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 2:
  ...
  - Scene is set in: the bar, still filled with tension — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the suspects drifted into subdued conversation, each seeking reassurance in the familiar or the trivial, Eleanor remained by the bar. Her thoughts circled the evidence: the sudden plunge to forty-eight degrees Fahrenh...".
...
Chapter 2 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The argument over the time of Hale's death."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that conflicting testimonies regarding the time of death contradict the suspects' alibis."
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 2: the clue [clue_core_contradiction_chain] (temperature, drop, indicates, poison, activated, time) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 2: the clue [clue_mechanism_visibility_core] (temperature, records, show, drop, forty, eight, degrees, fahrenheit, midnight) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
