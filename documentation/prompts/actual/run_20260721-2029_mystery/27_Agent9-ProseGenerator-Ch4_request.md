...
- Project ID: ``
- Timestamp: `2026-07-21T20:40:42.897Z`
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Fears that her illness will leave her family unprepared and in disarray, pushing her to seek closure and understanding."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Haunted by guilt over a past decision that led to loss of life, he struggles to reconcile that guilt with his desire to protect his reputation."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Torn between her romantic feelings for Captain Hale and her aspirations as a writer, she struggles to find her own identity."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Struggles with the fear of losing control over her family's wealth and the consequences of her embezzlement."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Struggles with the morality of his actions as a con artist, torn between ambition and the consequences of his deceit."
...
• [clue_2] dress, accounted, finch, belongings, implying, premeditated, disguise
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: disguise, premeditated

• [clue_3] footprint, matching, impersonator, shoe, size, outside, finch, room
  Category: spatial | Criticality: essential | Supports inference step 3
  Points to: impersonator, access, finch, room

• [clue_5] hugo, vane, seen, loitering, near, finch, room, shortly, before, murder
  Category: behavioral | Criticality: essential | Supports inference step 3
  Points to: hugo, vane, behavior, raises, suspicion
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As she stepped into the corridor, Eleanor’s thoughts lingered on the faces she had just left—the bravado of Hugo, the guarded sorrow of Captain Hale, the brittle poise of Sylvia, the restless energy of Beatrice. Each had offered an account, each had something..."
...
Known location profile anchors: The Mariner's Retreat, The Ocean View Lounge, The Grand Dining Room, The Library, the hotel lounge
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Mariner's Retreat", "The Ocean View Lounge", "The Grand Dining Room", "The Library", "the hotel lounge"
...
- Phrases to avoid (already overused in earlier chapters): "in the lobby at ten minutes past", "the lobby at ten minutes past nine", "lobby at ten minutes past nine she", "at ten minutes past nine she was", "ten minutes past nine she was alive", "seen alive at ten minutes past nine".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=14096; context=7891; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 4:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As she stepped into the corridor, Eleanor’s thoughts lingered on the faces she had just left—the bravado of Hugo, the guarded sorrow of Captain Hale, the brittle poise of Sylvia, the restless energy of Beatrice. Each had...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • eleanor, voss, seen, dining, guests [clue_core_elimination_chain]
      Points to: eleanor, voss, suspect
    • dress, missing, finch, items [clue_2]
      Points to: disguise, premeditated
    • footprints, visible, leading, away, crime, scene [clue_3]
      Points to: impersonator, access, finch, room
    • witnesses, report, hugo, vane, presence, near, crime, scene [clue_5]
  ...
  - PLANT OBLIGATIONS (incidental appearances): each item below MUST appear in this chapter as a passing physical detail a character sees, handles, or walks past — with its significance UNFLAGGED:
    • witnesses, recall, details, woman, seen, lobby [plant:clue_culprit_direct_1]
    • witnesses, recall, details, woman, seen, lobby [plant:clue_mid_1]
    • ring, identified, witnesses, belonging, finch [plant:clue_8]
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The footprint found outside Dr. Finch's room, leading to confusion about the identity of the impersonator."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that multiple suspects had motives to harm Dr. Finch."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_2] A guest mentions hearing a loud argument between Dr. Finch and another guest shortly before the murder — suggests a motive for another guest.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor stares at the floor, contemplating the tangled web of lies."
      ]
    },
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_2",
      "placementDetail": "A guest mentions hearing a loud argument between Dr. Finch and another guest shortly before the murder — suggests a motive for another guest."
    },
    "emotionalRegister": "A pivotal clue about impersonation alters the course of the investigation.",
