...
- Project ID: ``
- Timestamp: `2026-07-21T20:45:34.721Z`
...
PRIMARY FAILURES
- Chapter 9: Chapter 9 contains control-plane leakage (obligation_term): "She said, 'Clue obligation: suspect clearance missing for "Beatrice Quill"." (Remove prompt, validation, retry, or scaffold terminology from reader-facing prose)
- Chapter 9: Chapter 9 contains control-plane leakage (obligation_term): "She said, 'Clue obligation: suspect clearance missing for "Sylvia Trent"." (Remove prompt, validation, retry, or scaffold terminology from reader-facing prose)
...
ATTEMPT: 2/3
OFFENDING TEXT: She said, 'Clue obligation: suspect clearance missing for 
MANDATORY FIXES:
- Resolve template issues before accepting this batch.
- Chapter 9: Chapter 9 contains control-plane leakage (obligation_term): "She said, 'Clue obligation: suspect clearance missing for "Beatrice Quill"." (Remove prompt, validation, retry, or scaffold terminology from reader-facing prose)
- Chapter 9: Chapter 9 contains control-plane leakage (obligation_term): "She said, 'Clue obligation: suspect clearance missing for "Sylvia Trent"." (Remove prompt, validation, retry, or scaffold terminology from reader-facing prose)
