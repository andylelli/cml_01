...
- Project ID: ``
- Timestamp: `2026-07-21T20:44:03.377Z`
...
• [clue_4] footprint, match, suspects, except, hugo, vane
  Category: physical | Criticality: essential | Supports inference step 3
  Points to: hugo, vane, linked, crime

• [clue_7] hugo, vane, observed, discussing, financial, matters, finch, shortly, before, murder
  Category: behavioral | Criticality: essential | Supports inference step 3
  Points to: hugo, vane, financial, motive, murder

• [clue_8] unique, ring, impersonator, linking, finch
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: impersonator, linked, victim
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Outside, the wintry mist pressed closer, and inside, the lounge of the Seaside Hotel held its breath, waiting for the next revelation. Eleanor’s brow furrowed as she realized her mistake in the deduction. There was more to uncover—something she had missed, a d..."
...
Known location profile anchors: The Mariner's Retreat, The Ocean View Lounge, The Grand Dining Room, The Library, the hotel library
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Mariner's Retreat", "The Ocean View Lounge", "The Grand Dining Room", "The Library", "the hotel library"
...
- Phrases to avoid (already overused in earlier chapters): "in the lobby at ten minutes past", "the lobby at ten minutes past nine", "what s a girl gotta do to", "lobby at ten minutes past nine she", "seen alive at ten minutes past nine", "at ten minutes past nine yet the", "ten minutes past nine yet the coroner", "at ten minutes past nine she was", "ten minutes past nine she was alive", "minutes past nine yet the coroner s".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=20451; context=4243; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 7:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Outside, the wintry mist pressed closer, and inside, the lounge of the Seaside Hotel held its breath, waiting for the next revelation. Eleanor’s brow furrowed as she realized her mistake in the deduction. There was more...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • footprint, analysis, shows, unique, size [clue_4]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • witnesses, overheard, conversation, finances [clue_7]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • ring, identified, witnesses, belonging, finch [clue_8]
      Points to: impersonator, linked, victim
  ...
  - Sensory obligation — use at least two of: candlelight flickering on the shelves, stars twinkling outside | the soft tick of a clock, the crackle of a fire in the hearth | smoky warmth of the fireplace. Mood: serene.
...
Chapter 7 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The unique ring linked to Dr. Finch, which ties back to the impersonator."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Hugo had a financial motive and that the ring connects to the impersonator."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor's fingers brush against the spine of a book, grounding her amidst the chaos."
      ]
    },
    ...
    "emotionalRegister": "The discovery of a hidden letter shifts focus to personal motives.",
...
```text
{
  ...
  "chapters": [
    {
      ...
      "summary": "In the dim glow of the hotel library, Eleanor Voss confronts the suspects with new evidence: a unique ring linking the impersonator to Dr. Finch, and Hugo Vane’s financial quarrels with the victim. As the group’s composure unravels, suspicion shifts and the case’s complexity deepens.",
      "paragraphs": [
        ...
        "Beatrice’s eyes widened, and she leaned forward. \"Is that true, Hugo? You never said—\"",
  ...
  "note": "",
  "audit": {
    "locked_fact_phrases": "ten minutes past nine: paragraph 4, a quarter past nine: paragraph 4, one unique ring: paragraph 16 | present in paragraph 4, 16",
    "season_words_used": "wintry, winter, evening, night, firelight, mist, cold, smoky warmth, pale, glow, shadows, dim, lamplight, crackle, dark",
    "discriminating_test_present": "no",
    "required_clues_present": "clue_4: paragraph 6-8, clue_7: paragraph 10-12, clue_8: paragraph 16",
    "early_observation_present": "Eleanor’s fingers brush against the spine of a book: paragraph 1 (first 25%)",
