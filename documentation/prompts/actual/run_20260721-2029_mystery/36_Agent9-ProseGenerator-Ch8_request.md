...
- Project ID: ``
- Timestamp: `2026-07-21T20:44:29.240Z`
...
• [clue_core_elimination_chain] eliminates, eleanor, voss, because, seen, dinner, guests, dining, room, murder
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: eleanor, voss, suspect

• [clue_fp_contradiction_step_3] footprint, matching, impersonator, shoe, size, outside, finch, room
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: footprint, match, suspects, except, hugo, vane
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As she stood, Eleanor’s gaze fell to the hearthrug, where a faint muddy footprint marred the faded pattern. She frowned, crouching to inspect it. "Curious," she murmured, "that’s a rather unique size—far larger than my own, and not quite matching the others I’..."
...
- Phrases to avoid (already overused in earlier chapters): "in the lobby at ten minutes past", "the lobby at ten minutes past nine", "at ten minutes past nine yet the", "ten minutes past nine yet the coroner", "what s a girl gotta do to", "lobby at ten minutes past nine she", "seen alive at ten minutes past nine", "minutes past nine yet the coroner s", "past nine yet the coroner s estimate", "time of death at a quarter past".
...
- Chapter 8:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As she stood, Eleanor’s gaze fell to the hearthrug, where a faint muddy footprint marred the faded pattern. She frowned, crouching to inspect it. "Curious," she murmured, "that’s a rather unique size—far larger than my o...".
...
Chapter 8 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The evidence of the red dress and footprint that implicate Hugo."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the mechanism for the impersonation and points towards Hugo as the culprit."
...
[
  {
    ...
    "emotionalRegister": "The tension mounts as the investigation leads to a confrontation.",
