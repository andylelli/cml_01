...
- Project ID: ``
- Timestamp: `2026-05-12T20:41:02.869Z`
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=14748; context=10396; dropped=[none]; truncated=[location_profiles, temporal_context]
...
• Chapter 9 marked non-convergent after attempt 3/4: template
...
```
ANALYSIS_03_fair_play_structural_abort_run_a2a462c9