...
- Project ID: ``
- Timestamp: `2026-05-15T21:13:49.219Z`
...
- Era-authentic markers: petrol touring cars on country roads, early home telephones with party lines, typewriters standard in offices, reliable passenger automobiles, peak use of passenger trains, early commercial aviation starting to develop, telegrams sent from local post offices, increased use of airmail for urgent messages
- Tone: Classic
- No anachronisms
...
Description: A grand country estate with sprawling grounds, multiple wings, and a central courtyard, reflecting the opulence of its wealthy owners.
...
Setting constraints:
- Physical constraints: large gardens and hedges limiting visibility and movement, multiple locked rooms that require permissions to access, narrow staircases and hallways restricting quick movement
- Geographic isolation: situated far from the nearest town, limiting outside assistance
- Access control: restricted areas within the house, such as the library and study, scheduled access for staff to certain areas during specific hours, protocols for guests needing permission to enter private spaces

Era constraints to include:
- Technology: petrol touring cars on country roads, early home telephones with party lines, typewriters standard in offices
- Transportation: reliable passenger automobiles, peak use of passenger trains
- Social norms: Great Depression impacting social classes, rising tensions between the wealthy and working classes
