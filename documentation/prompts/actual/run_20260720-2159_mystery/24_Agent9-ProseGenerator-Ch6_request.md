...
- Project ID: ``
- Timestamp: `2026-07-20T22:08:17.514Z`
...
• [clue_core_elimination_chain] eliminates, eleanor, voss, because, seen, charity, event, across, town, murder
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: narrows, suspect, list, toward, hugo, vane
...
CLUES ALREADY REVEALED TO READER: clue_late_1, clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_1, clue_culprit_direct_hugo_vane, clue_fp_contradiction_step_2, clue_4, clue_5, clue_fp_contradiction_step_3, clue_6, clue_2 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): presence, accomplice, indicates, hugo, vane, party | presence, accomplice, indicates, hugo, vane, party | contradicts, claim, hugo, party, murder | contradicted, timeline, events | direct, shows, hugo, vane, means, opportunity | accomplice, presence, indicates, hugo, party, claimed | behavior, suggests, involved, planning, crime | hugo, financial, motive, commit, murder | jewelry, connects, hugo, crime, scene, despite | narrows, suspect, list, further | suggests, hugo, involvement, murder
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Eleanor lingered in the garden, the brooch heavy in her pocket and Beatrice’s words echoing in her mind. The alibi was plausible, but the ambition was real—and ambition, Eleanor knew, could be as dangerous as any weapon. She watched the sunlight flicker on the..."
...
Known location profile anchors: The Ocean Crest Hotel, Grand Lobby, Dining Area, Guest Rooms, Kitchen, the hotel bar
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Ocean Crest Hotel", "Grand Lobby", "Dining Area", "Guest Rooms", "Kitchen", "the hotel bar"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=18922; context=4678; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 6:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Eleanor lingered in the garden, the brooch heavy in her pocket and Beatrice’s words echoing in her mind. The alibi was plausible, but the ambition was real—and ambition, Eleanor knew, could be as dangerous as any weapon....".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • witnesses, reported, seeing, someone, leaving, hotel [clue_culprit_direct_1]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Ivor's claim about being at the bar."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Ivor was at the bar, providing him with a solid alibi."
...
[
  {
    ...
    "purpose": "Establish Ivor's alibi and motives",
    "cluesRevealed": [
      "clue_core_elimination_chain",
      "clue_culprit_direct_1"
    ],
    "dramaticElements": {
      "conflict": "Eleanor confronts Ivor about his history with the victim.",
      "tension": "Ivor's bitterness towards the victim surfaces.",
      "microMomentBeats": [
        "Eleanor catches Ivor's gaze, filled with unspoken anger."
      ]
    },
    "summary": "Eleanor questions Captain Hale, who claims he was at the bar during the murder. However, his bitterness towards the victim suggests a deeper motive, complicating the investigation.",
    "beat": "alibis",
    "estimatedWordCount": 1250,
    "pivotElement": "Ivor's claim about being at the bar.",
    "factEstablished": "Establishes that Ivor was at the bar, providing him with a solid alibi.",
