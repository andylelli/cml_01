...
- Project ID: ``
- Timestamp: `2026-07-20T22:12:03.068Z`
...
• [clue_late_optional_slot_1] footprints, leading, away, scene, remains, late, texture, detail, case, background
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "In the quiet that followed, Eleanor allowed herself a moment of doubt. The evidence pointed to Hugo, yet the group’s evasiveness suggested a deeper conspiracy, a truth that lay just beyond her grasp. She watched the flames dance in the grate, the shadows flick..."
...
Render this test MECHANISM as live, in-scene action and dialogue, composing ENTIRELY in your own words from these elements (reproducing any briefing phrase verbatim FAILS validation): discriminating, compares, accomplice, witnes, witness, claimed, timeline
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=25945; context=4944; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 9:
  ...
  - ⚠ SUSPECT CLEARANCE REQUIRED (MANDATORY): each suspect below MUST be named explicitly and cleared with on-page evidence and a reasoning connector (because / therefore / which proves):
    • "Captain Ivor Hale": write a dedicated paragraph that (a) names Captain Ivor Hale explicitly, (b) states the clearance method ("Witness statements confirm his alibi at the bar."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
    • "Beatrice Quill": write a dedicated paragraph that (a) names Beatrice Quill explicitly, (b) states the clearance method ("Evidence of her whereabouts at the time."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
    • "Sylvia Trent": write a dedicated paragraph that (a) names Sylvia Trent explicitly, (b) states the clearance method ("Witness testimony clearing her involvement."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
  ...
  - ⚠ DISCRIMINATING TEST (trap) — MANDATORY real-time scene with dialogue and confrontation. DO NOT summarize it after the fact.
    ...
    Elements the test must dramatize (compose the scene ENTIRELY in your own sentences from these — reproducing any briefing phrase verbatim FAILS validation): discriminating, compares, accomplice, witnes, witness, claimed, timeline
    Cite these already-revealed clue IDs during the test: clue_1, clue_7, clue_culprit_direct_1
...
Chapter 9 (Act 3) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The description of the accomplice matching Hugo's clothing."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Hugo was not at the party when the murder occurred, casting doubt on his alibi."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "tension": "Everyone holds their breath as the truth unfolds.",
      "microMomentBeats": [
        "Eleanor's heart races as she prepares to reveal her findings."
      ]
    },
    "summary": "Eleanor stages a test to compare the alibis of the guests against the evidence, revealing that the description of the accomplice matches Hugo's clothing. The tension in the room escalates as the implications sink in.",
    "beat": "final_trap",
    "estimatedWordCount": 1250,
    "pivotElement": "The description of the accomplice matching Hugo's clothing.",
    "factEstablished": "Establishes that Hugo was not at the party when the murder occurred, casting doubt on his alibi.",
    ...
    "emotionalRegister": "The truth is revealed in a dramatic showdown, intertwining personal and professional stakes.",
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 9: the clue [clue_1] (witnesses, reported, seeing, hugo, vane, party, throughout, evening) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
