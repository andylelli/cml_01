...
- Project ID: ``
- Timestamp: `2026-07-20T22:10:52.728Z`
...
• [clue_7] witnesses, noted, hugo, left, party, briefly, returned, quickly
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: raises, suspicion, hugo, actions

• [clue_mid_1] direct, links, hugo, vane, mechanism, access, point, before, discriminating, excludes, competing, suspect
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "But she pressed on, the brooch and the memory of footprints guiding her steps. The case was no longer a closed circle. The evidence of another’s passage had cracked the facade, and with it, the certainty of every alibi. The night was far from over, and the cos..."
...
Known location profile anchors: The Ocean Crest Hotel, Grand Lobby, Dining Area, Guest Rooms, Kitchen, the hotel lounge
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Ocean Crest Hotel", "Grand Lobby", "Dining Area", "Guest Rooms", "Kitchen", "the hotel lounge"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=22037; context=4065; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, continuity_context, pronoun_accuracy]
...
- Chapter 8:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "But she pressed on, the brooch and the memory of footprints guiding her steps. The case was no longer a closed circle. The evidence of another’s passage had cracked the facade, and with it, the certainty of every alibi....".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • guests, hugo, step, outside, moment [clue_7]
      Points to: raises, suspicion, hugo, actions
    • witnesses, reported, seeing, someone, leaving, hotel [clue_mid_1]
...
Chapter 8 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Hugo's defensive reaction to the accusations."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the group is hiding something, casting doubt on Hugo's guilt."
...
[
  {
    ...
    "purpose": "Present a false lead that misdirects the investigation",
    "cluesRevealed": [
      "clue_7",
      "clue_mid_1"
    ],
    "dramaticElements": {
      "conflict": "Eleanor confronts the group with her theory.",
      "tension": "The group reacts defensively to Eleanor's accusations.",
      "microMomentBeats": [
        "Eleanor feels a knot in her stomach as she lays out the theory."
      ]
    },
    "summary": "Eleanor presents a theory accusing Hugo based on the evidence she has gathered so far, but she notices inconsistencies in the reactions of the others, suggesting that something is off.",
    "beat": "secrets",
    "estimatedWordCount": 1250,
    "pivotElement": "Hugo's defensive reaction to the accusations.",
    "factEstablished": "Establishes that the group is hiding something, casting doubt on Hugo's guilt.",
    ...
    "emotionalRegister": "Tension escalates as Eleanor prepares for a climactic confrontation with the suspect.",
