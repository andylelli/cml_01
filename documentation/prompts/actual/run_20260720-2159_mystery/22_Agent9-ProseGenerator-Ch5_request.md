...
- Project ID: ``
- Timestamp: `2026-07-20T22:07:20.261Z`
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Beatrice wrestles with her ambition and the moral implications of her choices, torn between her desire for success and the reality of her actions."
...
• [clue_6] eliminates, beatrice, quill, because, theater, murder
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: narrows, suspect, list, further

• [clue_2] distinctive, piece, jewelry, belonging, hugo, near, victim
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: suggests, hugo, involvement, murder
...
CLUES ALREADY REVEALED TO READER: clue_late_1, clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_1, clue_culprit_direct_hugo_vane, clue_fp_contradiction_step_2, clue_4, clue_5, clue_fp_contradiction_step_3 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): presence, accomplice, indicates, hugo, vane, party | presence, accomplice, indicates, hugo, vane, party | contradicts, claim, hugo, party, murder | contradicted, timeline, events | direct, shows, hugo, vane, means, opportunity | accomplice, presence, indicates, hugo, party, claimed | behavior, suggests, involved, planning, crime | hugo, financial, motive, commit, murder | jewelry, connects, hugo, crime, scene, despite
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "She felt the weight of new knowledge pressing close: Hugo’s nervousness, his evasions, and the shadow of inheritance that now colored every recollection of Dr. Finch. The truth, she thought, was drawing nearer, but the cost—for all of them—was only beginning t..."
...
Known location profile anchors: The Ocean Crest Hotel, Grand Lobby, Dining Area, Guest Rooms, Kitchen, the hotel garden
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Ocean Crest Hotel", "Grand Lobby", "Dining Area", "Guest Rooms", "Kitchen", "the hotel garden"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=16011; context=6589; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 5:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "She felt the weight of new knowledge pressing close: Hugo’s nervousness, his evasions, and the shadow of inheritance that now colored every recollection of Dr. Finch. The truth, she thought, was drawing nearer, but the c...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • jewelry, identified, victim, family [clue_2]
      Points to: suggests, hugo, involvement, murder
    • theater, staff, confirmed, presence [clue_6]
      Points to: narrows, suspect, list, further
...
Chapter 5 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Beatrice's alibi about being at the theater."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Beatrice has a plausible alibi but raises questions about her ambition."
...
[
  {
    ...
    "dramaticElements": {
      "conflict": "Eleanor questions Beatrice about her actions.",
      "tension": "Beatrice's ambition creates suspicion.",
      "microMomentBeats": [
        "Eleanor notices a flicker of fear in Beatrice's eyes."
      ]
    },
    "summary": "Eleanor interviews Beatrice, who claims she was at the theater during the murder. However, Eleanor senses Beatrice's ambition might have led her to act against the victim, raising further suspicions.",
    "beat": "alibis",
    "estimatedWordCount": 1250,
    "pivotElement": "Beatrice's alibi about being at the theater.",
    "factEstablished": "Establishes that Beatrice has a plausible alibi but raises questions about her ambition.",
    ...
    "emotionalRegister": "The discovery of an accomplice shifts Eleanor's focus, forcing her to confront her motivations.",
