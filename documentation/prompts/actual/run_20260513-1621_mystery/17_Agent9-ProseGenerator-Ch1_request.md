...
- Project ID: ``
- Timestamp: `2026-05-13T16:27:33.650Z`
...
• [clue_mechanism_visibility_core] The clock in the study shows the hands pointing to quarter past seven.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: This indicates the time discrepancy related to the murder.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=5474; context=9209; dropped=[none]; truncated=[location_profiles, temporal_context]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The clock in the study shows the hands pointing to quarter past seven. [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: This indicates the time discrepancy related to the murder.
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The stopped clock showing ten minutes past eleven — a crucial detail in the investigation"
  ...
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_1] Eleanor was seen drinking heavily before her death, which might suggest she acted irrationally.
...
[
  {
    ...
    "summary": "In the dim light of the study, the doctor Finch stares at the lifeless body of Eleanor Voss. The clock on the wall ticks ominously, marking the moment of discovery. Finch's heart races as he realizes the implications of the scene before him.",
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_1",
      "placementDetail": "Eleanor was seen drinking heavily before her death, which might suggest she acted irrationally."
    },
    "emotionalRegister": "The atmosphere is initially festive yet tinged with underlying anxiety as guests mingle.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 1: "The clock in the study shows the hands pointing to quarter past seven." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
