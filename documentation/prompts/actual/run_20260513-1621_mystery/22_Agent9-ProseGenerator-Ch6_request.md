...
- Project ID: ``
- Timestamp: `2026-05-13T16:28:46.267Z`
...
Characters face their secrets as the investigation reveals the complexity of their motives.
...
Rationale: The mid-investigation phase is fraught with tension, leaving no room for humor.
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Beatrice is torn between her ambition and her heart; the desire for success clashes with the fear of being judged for her relationship, leaving her in a constant state of turmoil."
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Eleanor nodded, her expression softening slightly. 'Thank you, Finch. I just want to understand what happened to me. I want to make sure that whoever did this pays for their actions.' Her resolve was palpable, and Finch felt a surge of hope. Perhaps, together,..."
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=11584; context=10278; dropped=[none]; truncated=[location_profiles, temporal_context]
...
- Chapter 6:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Eleanor nodded, her expression softening slightly. 'Thank you, Finch. I just want to understand what happened to me. I want to make sure that whoever did this pays for their actions.' Her resolve was palpable, and Finch...".
  - Clue obligations: none for this chapter.
  - Tonal contrast: include at least one beat of relief or ironic counterpoint. Do not sustain maximum tension for every paragraph.
  - Sensory obligation — use at least two of: Candlelight flickers against the darkening walls, casting elongated shadows that seem to come alive., The rich colors of the room become more pronounced, the reds and golds glowing warmly in the dim light. | The soft whisper of pages turning fills the air, as a few guests seek solace in the stories within., The distant laughter from the drawing room serves as a reminder of the social gathering, yet feels disconnected from the library's solitude. | The scent of burning candles mingles with the rich aroma of leather and paper, creating a unique olfactory tapestry.. Mood: tense anticipation.
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The photograph of Beatrice and Eleanor together — a symbol of their complicated relationship"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Beatrice had strong feelings for Eleanor, adding complexity to the investigation."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Beatrice's eyes linger on a photograph of her and Eleanor, revealing her deep emotions."
      ]
    },
    ...
    "locationRegisterNote": "The library is steeped in a heavy atmosphere, filled with the weight of secrets and the remnants of past conversations. The flickering candlelight casts eerie shadows, creating a sense of foreboding as guests navigate the tension of the evening. Each book and artifact holds its own story, and the air feels thick with anticipation as the mystery unfolds. — A writer entering this space should adopt a tone of suspense, capturing the library's role as a silent witness to the events that transpire."
  }
]
```
