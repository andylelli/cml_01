...
- Project ID: ``
- Timestamp: `2026-07-20T22:24:24.332Z`
...
• [clue_5] footprints, lead, hotel, beach
  Category: physical | Criticality: essential | Supports inference step 3
  Points to: indicates, movement, hotel, beach

• [clue_id_1] footprints, lead, hotel, beach
  Category: physical | Criticality: essential | Supports inference step 3
  Points to: indicates, movement, hotel, beach
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "The lounge grew quiet again, the night pressing in from all sides. The only certainty was the absence at the heart of it all—Eleanor Voss, gone, her secrets still tangled in the shadows of L'Hôtel de la Mer. Hugo stared into the darkness beyond the window, the..."
...
Known location profile anchors: L'Hôtel de la Mer, Grand Lobby, Oceanview Dining Room, Manager's Office, Beachfront, the hotel garden
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "L'Hôtel de la Mer", "Grand Lobby", "Oceanview Dining Room", "Manager's Office", "Beachfront", "the hotel garden"
...
- Chapter 6 (score 96/100):
  Quality gaps noted: scene grounding weakness
  Address in upcoming chapters: Open next chapter with a named location anchor plus at least two sensory cues and one atmosphere marker.
- Phrases to avoid (already overused in earlier chapters): "honestly what were they thinking letting her", "highest point at ten minutes past eleven", "closed his diary the snap of the", "his diary the snap of the cover".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=19082; context=4625; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 7:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "The lounge grew quiet again, the night pressing in from all sides. The only certainty was the absence at the heart of it all—Eleanor Voss, gone, her secrets still tangled in the shadows of L'Hôtel de la Mer. Hugo stared...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • witnesses, party, mentioning, eleanor, departure, time [clue_culprit_direct_1]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • footprints, visible, ground, leading, beach [clue_5]
      Points to: indicates, movement, hotel, beach
    • footprints, visible, ground, leading, beach [clue_id_1]
      Points to: indicates, movement, hotel, beach
...
Chapter 7 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The revelation of Dr. Finch's unethical practices and their connection to Eleanor."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Dr. Finch had a motive tied to her unethical practices, complicating the investigation further."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Hugo pauses, absorbing the weight of the revelations, feeling the gravity of the situation."
      ]
    },
    ...
    "emotionalRegister": "Tension peaks as characters face the consequences of their actions.",
    "dominantCharacterNote": {
      "name": "Eleanor Voss",
      "voiceRegister": "Eleanor speaks with crisp authority, her tone polished yet occasionally laced with condescension."
    },
    "humourGuidance": {
