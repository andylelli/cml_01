...
- Project ID: ``
- Timestamp: `2026-07-20T22:22:53.121Z`
...
• [clue_3] tide, table, indicates, high, minutes, past, eleven
  Category: temporal | Criticality: essential | Supports inference step 2
  Points to: timing, drowning, coincide, high, tide

• [clue_4] timeline, drowning, occurred
  Category: temporal | Criticality: essential | Supports inference step 2
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_7, clue_id_2, clue_id_3, clue_8, clue_9, clue_6, clue_10, clue_11, clue_12 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): eleanor, left, party, earlier, expected | timeline, events, incorrect | mechanism, drowning, critical, understanding, case | eleanor, left, party, earlier, expected | timeline, events, incorrect | mallory, finch, behavior, indicates, potential, premeditation | mallory, finch, motive, crime | someone, left, party, being, noticed | captain, ivor, hale, suspect | beatrice, quill, suspect | captain, ivor, hale, excluded, suspect
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the last of the lamplight flickered over the polished silver and empty glasses, Hugo was left alone with his thoughts. The answers were closer now, the field narrowed, but the cost of each revelation weighed heavier. He knew, with a journalist’s certainty,..."
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=17610; context=5754; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 6:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the last of the lamplight flickered over the polished silver and empty glasses, Hugo was left alone with his thoughts. The answers were closer now, the field narrowed, but the cost of each revelation weighed heavier....".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • witnesses, party, mentioning, eleanor, departure, time [clue_culprit_direct_1]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • footprints, accounted, party, attendees [clue_culprit_direct_dr_mallory_finch]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Hugo's theory implicating Beatrice Quill."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes a convincing but flawed solution that implicates Beatrice Quill, highlighting the complexities of the case."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Hugo's heart races as he lays out the theory, gauging the reactions of the room."
      ]
    },
    ...
    "emotionalRegister": "Confrontation leads to revelations about hidden motives.",
