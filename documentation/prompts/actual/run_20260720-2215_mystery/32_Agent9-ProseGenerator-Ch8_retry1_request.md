...
- Project ID: ``
- Timestamp: `2026-07-20T22:26:35.008Z`
...
• [clue_late_optional_slot_1] high, tide, eleven, evening, remains, late, texture, detail, case, background
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "In that moment, the investigation shifted. The neat lines of suspicion blurred, the red herrings tangled with real guilt. Dr. Finch’s confession of fear, her admission of unethical practice, had complicated everything. Hugo knew he was closer to the truth, but..."
...
Render this test MECHANISM as live, in-scene action and dialogue, composing ENTIRELY in your own words from these elements (reproducing any briefing phrase verbatim FAILS validation): reenact, guests, movements, party, reveal, left, unnoticed
...
- Chapter 8:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "In that moment, the investigation shifted. The neat lines of suspicion blurred, the red herrings tangled with real guilt. Dr. Finch’s confession of fear, her admission of unethical practice, had complicated everything. H...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • high, tide, eleven, evening, remains, late, texture, detail, case, background [clue_late_optional_slot_1]
      Points to: adds, late, texture, changing, essential, deduction, chain
    • footprints, accounted, party, attendees [clue_6]
      Points to: someone, left, party, being, noticed
  - ⚠ SUSPECT CLEARANCE REQUIRED (MANDATORY): each suspect below MUST be named explicitly and cleared with on-page evidence and a reasoning connector (because / therefore / which proves):
    • "Captain Ivor Hale": write a dedicated paragraph that (a) names Captain Ivor Hale explicitly, (b) states the clearance method ("Witness testimony confirms he was in the dining area."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
    • "Beatrice Quill": write a dedicated paragraph that (a) names Beatrice Quill explicitly, (b) states the clearance method ("The broken bottle is traced to another guest."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
    • "Sylvia Trent": write a dedicated paragraph that (a) names Sylvia Trent explicitly, (b) states the clearance method ("Her whereabouts are accounted for by other staff."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
  ...
  - ⚠ DISCRIMINATING TEST (trap) — MANDATORY real-time scene with dialogue and confrontation. DO NOT summarize it after the fact.
    ...
    Elements the test must dramatize (compose the scene ENTIRELY in your own sentences from these — reproducing any briefing phrase verbatim FAILS validation): reenact, guests, movements, party, reveal, left, unnoticed
    Cite these already-revealed clue IDs during the test: clue_6, clue_5, clue_3, clue_id_1
...
Chapter 8 (Act 3) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The reenactment of the party's timeline and Dr. Finch's reaction."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Dr. Finch's guilt is evident through her reaction to the reenactment."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Hugo feels the weight of the moment as he prepares to reveal the truth."
      ]
    },
    ...
    "emotionalRegister": "The truth is revealed in a dramatic confrontation.",
...
```text
{
  ...
  "chapters": [
    {
      ...
      "summary": "At dawn on the hotel beach, Hugo stages a reenactment of the party's timeline, laying out the evidence and observing the suspects' reactions. The decisive test exposes Dr. Mallory Finch's guilt, clearing the other suspects and revealing the motive, method, and emotional cost of the crime.",
      "paragraphs": [
  ...
  "note": "",
  "audit": {
    "locked_fact_phrases": "present in paragraph 2, 3, 7 | present in paragraph 3, 7",
    "season_words_used": "summer, midsummer",
    "discriminating_test_present": "yes: chapter 8 paragraph 2-11",
    "required_clues_present": "clue_6: chapter 8 paragraph 7 | clue_late_optional_slot_1: chapter 8 paragraph 2",
    "early_observation_present": "The tide was out now, but he could see the faint line marking its highest reach—evidence of the swell at \"ten minutes past eleven\". (first 25%)",
