...
- Project ID: ``
- Timestamp: `2026-07-20T22:20:29.434Z`
...
• [clue_core_contradiction_chain] indicates, left, party, significantly, earlier, previously, thought
...
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): eleanor, left, party, earlier, expected
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "The first day of the investigation had begun not with certainty, but with doubt. Eleanor Voss was dead, and the stories told by those who had known her were already beginning to unravel. Hugo Vane, for all his experience, felt the familiar thrill of pursuit mi..."
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=9342; context=11778; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 2:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "The first day of the investigation had begun not with certainty, but with doubt. Eleanor Voss was dead, and the stories told by those who had known her were already beginning to unravel. Hugo Vane, for all his experience...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • contradiction, witness, accounts, expected, timeline [clue_core_contradiction_chain] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: timeline, events, incorrect
...
Chapter 2 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The conflicting accounts of when Eleanor last left the party."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that some witnesses contradict each other about Eleanor's last sighting."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_1] Captain Hale mentions that some guests believed Eleanor drowned while everyone was at the party, creating a false impression about the timing of her death.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Captain Hale clenches his fists, struggling to maintain composure as accusations swirl."
      ]
    },
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_1",
      "placementDetail": "Captain Hale mentions that some guests believed Eleanor drowned while everyone was at the party, creating a false impression about the timing of her death."
    },
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 2: the clue [clue_core_contradiction_chain] (indicates, left, party, significantly, earlier, previously, thought) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
