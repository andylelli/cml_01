...
- Project ID: ``
- Timestamp: `2026-05-11T19:09:27.294Z`
...
Tone: Classic
Era decade: 1930s
Social norms: significant impact of the Great Depression on class structures, increased tensions between social classes, growing awareness of fascism in Europe influencing local politics
Location description: A grand country estate featuring a large main house with extensive gardens and outbuildings, reflecting the wealth of its owners.
Institution type: Manor house
Weather: Overcast with occasional rain, typical for the English countryside in autumn.
Mood: Tense, with an air of suspicion among the guests.
Geographic isolation: Moderately isolated, requiring travel to reach nearby towns or assistance.
Access control: restricted areas such as the study and master bedroom, daily routines dictate access times and locations, formal permissions required for guest movements
