...
- Project ID: ``
- Timestamp: `2026-05-11T19:05:29.212Z`
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=14539; context=9667; dropped=[none]; truncated=[location_profiles, temporal_context]
...
- Chapter 9: Chapter 9 contains instruction-shaped prose (prompt leakage) (Remove imperative instructions — these read like prompt directives, not narrative prose)
