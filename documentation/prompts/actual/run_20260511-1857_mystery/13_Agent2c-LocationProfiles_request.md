...
- Project ID: ``
- Timestamp: `2026-05-11T19:00:12.469Z`
...
- Era-authentic markers: petrol touring cars on county roads, domestic wiring with frequent outages, typewriters for correspondence, reliable passenger automobiles, frequent passenger trains, early commercial aviation, party-line telephone exchanges, telegram services via local post offices
- Tone: Classic
- No anachronisms
...
Description: A grand manor house surrounded by expansive gardens and woodlands, featuring multiple rooms and hidden passageways.
...
Setting constraints:
- Physical constraints: large estate layout allows for discreet movement between rooms, access to certain areas restricted by estate staff hierarchy, weather conditions may impede outdoor investigation
- Geographic isolation: The estate is situated several miles from the nearest town, limiting immediate outside assistance.
- Access control: restricted areas such as the library and study require permission from the owner, daily routines dictate staff movement and access to various locations, social hierarchies influence who can enter specific rooms

Era constraints to include:
- Technology: petrol touring cars on county roads, domestic wiring with frequent outages, typewriters for correspondence
- Transportation: reliable passenger automobiles, frequent passenger trains
- Social norms: Great Depression impacting social classes, increased class tensions among estate workers and owners
