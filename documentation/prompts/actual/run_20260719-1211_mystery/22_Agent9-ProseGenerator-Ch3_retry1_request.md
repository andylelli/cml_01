...
- Project ID: ``
- Timestamp: `2026-07-19T12:16:48.865Z`
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=12048; context=11539; dropped=[humour_guide, location_profiles]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Template linter: high n-gram overlap detected (0.81 >= 0.65). Rephrase this passage to avoid template leakage.
...
"as the morning wore on eleanor ... walls of the coral crest hotel"
