...
- Project ID: ``
- Timestamp: `2026-07-19T12:18:14.450Z`
...
A witness statement provides a new direction for the investigation, shifting Eleanor's focus.
...
Rationale: Tension scenes should remain serious to maintain dramatic stakes.
...
• [clue_3] indicates, hugo, poisoned, must, immediately, before, toast
  Category: temporal | Criticality: essential | Supports inference step 2
  Points to: timing, poisoning, suggests, occurred, before, toast

• [clue_6] mallory, finch, known, professional, rivalry, hugo
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_id_1, clue_id_7, clue_core_contradiction_chain, clue_id_5, clue_1, clue_2, clue_culprit_direct_dr_mallory_finch — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): method, poisoning, toast | timing, hugo, drink, order, before, toast | tampering, hugo, drink, suggests, murder | hugo, health, status, before, toast, contradicts | hugo, health, status, before, toast, contradicts | timing, hugo, drink, order, before, toast | tampering, hugo, drink, suggests, murder | direct, shows, mallory, finch, means, opportunity
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As Eleanor closed her notebook, she sensed the growing emotional cost. The evidence—the bartender’s confirmation, the tampering observed, Finch’s proximity—had reshaped suspicion, transforming the spring afternoon into a landscape thick with secrets and unspok..."
...
Known location profile anchors: The Coral Crest Hotel, The Oceanview Lounge, The Grand Library, The Crystal Dining Room, The Private Beach, the seaside hotel dining room
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Coral Crest Hotel", "The Oceanview Lounge", "The Grand Library", "The Crystal Dining Room", "The Private Beach", "the seaside hotel dining room"
...
- Phrases to avoid (already overused in earlier chapters): "in my day we handled things differently", "just the most scandalous thing one must", "the most scandalous thing one must keep", "most scandalous thing one must keep things", "scandalous thing one must keep things interesting", "thing one must keep things interesting after", "one must keep things interesting after all", "you know how it goes in hospitality".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=12871; context=10928; dropped=[humour_guide, location_profiles, texture_pool, continuity_context]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 4:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As Eleanor closed her notebook, she sensed the growing emotional cost. The evidence—the bartender’s confirmation, the tampering observed, Finch’s proximity—had reshaped suspicion, transforming the spring afternoon into a...".
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The heated exchange between Dr. Finch and Captain Hale regarding Hugo's influence."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes multiple motives, particularly Dr. Finch's rivalry with the victim."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_2] Beatrice claims she saw Hugo staggering before the toast — suggests he was unwell.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor notices Captain Hale's clenched fists as he listens to Dr. Finch."
      ]
    },
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_2",
      "placementDetail": "Beatrice claims she saw Hugo staggering before the toast — suggests he was unwell."
    },
    "emotionalRegister": "A witness statement provides a new direction for the investigation, shifting Eleanor's focus.",
