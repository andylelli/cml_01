...
- Project ID: ``
- Timestamp: `2026-07-19T12:19:58.863Z`
...
• [clue_9] eliminates, sylvia, trent, because, occupied, guests, toast
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: sylvia, trent, alibi, excludes, suspicion

• [clue_id_6] eliminates, eleanor, voss, because, seen, witnesses, toast
  Category: testimonial | Criticality: essential | Supports inference step 2
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_id_1, clue_id_7, clue_core_contradiction_chain, clue_id_5, clue_1, clue_2, clue_culprit_direct_dr_mallory_finch, clue_3, clue_6, clue_id_2, clue_4, clue_5, clue_id_3, clue_core_elimination_chain, clue_8, clue_id_4 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): method, poisoning, toast | timing, hugo, drink, order, before, toast | tampering, hugo, drink, suggests, murder | hugo, health, status, before, toast, contradicts | hugo, health, status, before, toast, contradicts | timing, hugo, drink, order, before, toast | tampering, hugo, drink, suggests, murder | direct, shows, mallory, finch, means, opportunity | timing, poisoning, suggests, occurred, before, toast | mallory, finch, motive, crime | physical, trace, opportunity, indicate, mallory, finch | presence, poison, tonic, water, bottle | tampering, hugo, drink | timing, poisoning, suggests, occurred, before, toast | eleanor, voss, alibi, excludes, suspicion | beatrice, quill, alibi, excludes, suspicion | presence, poison, tonic, water, bottle
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the night deepened, Eleanor closed her notebook, the evidence reframed, the suspects exposed to uncertainty. Eleanor’s heart raced with the sense that the truth was within reach—yet just beyond it, the cost of revelation threatened to destabilize the fragil..."
...
Known location profile anchors: The Coral Crest Hotel, The Oceanview Lounge, The Grand Library, The Crystal Dining Room, The Private Beach, the seaside hotel garden
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Coral Crest Hotel", "The Oceanview Lounge", "The Grand Library", "The Crystal Dining Room", "The Private Beach", "the seaside hotel garden"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 7: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the seaside hotel garden". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Chapter 4 (score 95/100):
  ...
  Address in upcoming chapters: Increase chapter density with concrete investigation action and sensory-grounded beats; avoid recap-only padding.
- Phrases to avoid (already overused in earlier chapters): "just the most scandalous thing one must", "the most scandalous thing one must keep", "most scandalous thing one must keep things", "scandalous thing one must keep things interesting", "thing one must keep things interesting after", "one must keep things interesting after all", "at half past eight at night the", "in my day we handled things differently", "you know how it goes in hospitality", "know how it goes in hospitality we".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=17700; context=5980; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 7:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the night deepened, Eleanor closed her notebook, the evidence reframed, the suspects exposed to uncertainty. Eleanor’s heart raced with the sense that the truth was within reach—yet just beyond it, the cost of revelat...".
...
Chapter 7 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Dr. Finch's visible discomfort when confronted about her past with Hugo."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Dr. Finch had a professional motive to harm Hugo, deepening suspicion."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor feels the weight of the truth pressing down on her."
      ]
    },
