...
- Project ID: ``
- Timestamp: `2026-07-16T21:20:11.954Z`
...
• [clue_5] bitter, almond, residue, scene
  Category: physical | Criticality: essential | Supports inference step 3
  Points to: indicates, method, poisoning

• [clue_2] drink, last, item, consumed, before, symptoms, appeared, identifying, time, poisoning
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the rain drummed steadily against the windows, Eleanor gathered her things and stepped into the corridor. The dining area of the hotel, once a stage for accusation, was now a tableau of absence. The next act would demand sharper questions—and perhaps, at la..."
...
- Chapter 6: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with an expository setup — e.g. "It was not until…" / "There had been no word since…" / "There was a note on the table…". Begin with "It was", "There was", or "There had been" followed immediately by a specific condition, event, or discovery. Do not open on generic mood alone — but still anchor the location and weave in the sensory + time-of-day grounding across the next sentence or two. Anchor opening in "Beatrice Quill's hotel room". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=18232; context=5758; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility]; truncated=[location_profiles, temporal_context, continuity_context, pronoun_accuracy]
...
- clue_3 must appear in Act 2, Scene 3 via Chemistry book found
...
- Chapter 6:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the rain drummed steadily against the windows, Eleanor gathered her things and stepped into the corridor. The dining area of the hotel, once a stage for accusation, was now a tableau of absence. The next act would dem...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • faint, bitter, smell, near, beatrice, body [clue_5]
      Points to: indicates, method, poisoning
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "A bitter almond residue is found at the scene."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the poison used was likely more potent than previously considered."
...
[
  {
    "sceneNumber": 6,
    "act": 2,
    "title": "A Bitter Discovery",
    "setting": {
      "location": "Beatrice Quill's hotel room",
      "timeOfDay": "Late afternoon",
      "atmosphere": "Ominous and revealing"
    },
    "characters": [
      "Eleanor Voss",
      "Dr. Mallory Finch"
    ],
    "purpose": "Discover a critical piece of evidence",
    "cluesRevealed": [
      "clue_5",
      "clue_2",
    ...
    "dramaticElements": {
      "conflict": "Eleanor finds evidence that complicates the case.",
      "tension": "The atmosphere thickens with suspicion.",
      "microMomentBeats": [
        "Eleanor feels a chill as she examines the bitter almond residue."
      ]
    },
    "summary": "Eleanor returns to the scene and discovers a bitter almond residue that suggests the poison used was more deadly than initially thought. This revelation deepens the mystery surrounding Dr. Finch's involvement and the nature of Beatrice's death.",
    "beat": "false_solution",
    "estimatedWordCount": 1800,
    "pivotElement": "A bitter almond residue is found at the scene.",
    "factEstablished": "Establishes that the poison used was likely more potent than previously considered.",
    ...
    "emotionalRegister": "Eleanor confronts her own past, intertwining her story with the victim's fate.",
