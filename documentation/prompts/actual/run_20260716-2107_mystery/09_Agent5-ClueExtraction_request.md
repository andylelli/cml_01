...
- Project ID: `unknown`
- Timestamp: `2026-07-16T21:09:53.358Z`
...
1. Generate a clue that makes the reader directly observe: "The cocktail glass in Beatrice's room shows residue of a plant toxin...."
   → observation | essential | early | spatial | step 1 | terms: cocktail, glass, beatrice's

2. Generate a clue that provides evidence for: "The presence of toxin indicates foul play, contradicting the assumption of natural illness...."
   → contradiction | essential | early | testimonial | step 1 | terms: presence, toxin, indicates

3. Generate a clue that makes the reader directly observe: "Witnesses confirm Beatrice was last seen drinking her favorite cocktail at 9 PM...."
   → observation | essential | early | testimonial | step 2 | terms: witnesses, confirm, beatrice

4. Generate a clue that provides evidence for: "Her drink was the last item she consumed before symptoms appeared, identifying the time of poisoning..."
   → contradiction | essential | early | temporal | step 2 | terms: drink, consumed, before

5. Generate a clue that makes the reader directly observe: "A chemistry book in Dr. Finch's possession discusses the properties of the poison found in Beatrice'..."
   → observation | essential | mid | testimonial | step 3 | terms: chemistry, finch's, possession

6. Generate a clue that provides evidence for: "Dr. Finch's knowledge of the poison indicates premeditation since she had access to the toxin...."
   → contradiction | essential | mid | spatial | step 3 | terms: finch's, knowledge, poison

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The presence of toxin indicates foul play, contradicting the assumption of natural illness...."
   → contradiction | essential | mid | testimonial | step 1 | terms: presence, toxin, indicates

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The mechanism relies on poison, toxin, and cocktail to expose the false timing...."
...
10. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "The discriminating test compares suspect, cocktail, and residue against the claimed timeline...."
   → observation | essential | mid | temporal | terms: discriminating, compares, suspect,
...
11. Generate one essential mid-story clue whose description or pointsTo explicitly names Dr. Mallory Finch and states the unique trace, preparation detail, or mechanism link that points to Dr. Mallory Finch rather than any non-culprit.
   → observation | essential | mid | testimonial | terms: Dr. Mallory Finch, mechanism, relies, poison,
...
12. Generate one essential early-or-mid clue establishing that Dr. Mallory Finch UNIQUELY had the means/skill/access/knowledge required to execute the concealment mechanism, and that the other suspects did not — so the reveal relies only on this already-planted capability, never on a means introduced for the first time at the confrontation.
   → elimination | essential | mid | testimonial | terms: Dr. Mallory Finch, mechanism, relies, poison,

13. Generate a clue showing observable evidence of Dr. Mallory Finch's premeditation or planning (Fear of exposure.). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
...
17. Generate one essential early or mid elimination clue that explicitly rules out Eleanor Voss and narrows the solution toward culprit Dr. Mallory Finch. The pointsTo text must start with "Eliminates Eleanor Voss because ..." and cite corroborated evidence.
...
## Access Constraints
Actors: Dr. Mallory Finch, Sylvia Trent, Hugo Vane
Objects: Cocktail glass with poison residue, Prescription bottle
...
- Captain Ivor Hale: sensitive items: low
- Beatrice Quill: sensitive items: none
- Sylvia Trent: sensitive items: medium
- Hugo Vane: sensitive items: high
...
Create 2 red herrings that support the false assumption: "Beatrice Quill died from a sudden illness caused by her pre-existing condition."
