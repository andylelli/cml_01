...
- Project ID: `unknown`
- Timestamp: `2026-05-17T20:51:13.491Z`
...
2. Generate a clue that provides evidence for: "This suggests the murder occurred after dinner, contradicting the schedule...."
   → contradiction | essential | early | temporal | step 1 | terms: suggests, murder, occurred

3. Generate a clue that makes the reader directly observe: "A slight scratch on the clock's case indicates tampering...."
   → observation | essential | early | temporal | step 2 | terms: slight, scratch, clock's

4. Generate a clue that provides evidence for: "This indicates someone altered the clock to mislead others about the time...."
   → contradiction | essential | early | temporal | step 2 | terms: indicates, someone, altered

5. Generate a clue that makes the reader directly observe: "A torn piece of the dinner schedule was found in Eleanor's pocket...."
   → observation | essential | mid | testimonial | step 3 | terms: piece, dinner, schedule

6. Generate a clue that provides evidence for: "This suggests she was aware of the schedule's deception...."
   → contradiction | essential | mid | testimonial | step 3 | terms: suggests, aware, schedule's

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "This suggests the murder occurred after dinner, contradicting the schedule...."
...
9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "A confrontation is staged where Captain Hale must account for the altered time on the clock while re..."
   → observation | essential | mid | temporal | terms: confrontation, staged, captain
...
Create 2 red herrings that support the false assumption: "Eleanor must have been killed during the dinner, as per the schedule."
