...
- Project ID: ``
- Timestamp: `2026-05-13T21:42:19.045Z`
...
- YOU MUST use the exact year and month specified above: December 1939
- This date has been specifically selected for THIS mystery to ensure uniqueness
- DO NOT change the year or month - use December 1939 exactly
...
- All details must be historically accurate for December 1939 specifically
- Generate fresh, original descriptions - do not copy example phrasing
- Make this feel like the specific moment of December 1939
...
- Technology available: petrol touring cars on county roads, domestic wiring with occasional outages, early telephones in homes, typewriters standard in offices
- Forensics: fingerprinting standard for criminal identification, basic toxicology tests available, emerging ballistics analysis techniques
- Social norms: Great Depression creating economic hardship and class tensions, increasing awareness of fascism and political unrest in Europe, traditional gender roles and societal expectations prevalent

Task:
1. Use the specified date: December 1939
