...
- Project ID: ``
- Timestamp: `2026-07-15T18:11:09.022Z`
...
- Mechanism family hints: access path illusion, geometry-based movement, timetable dependency
- Hard-logic mode tags: transit or seaside topology
- Difficulty mode: standard

Novelty constraints:
- Diverge from: The Clockwork Deception, The Clockwork Conundrum, The Clockwork Deceit, The Ticking Deception, The Clockwork Conspiracy, The Delayed Demise, The Tidal Deception, The Delayed Deception, The Tidal Trap, Echoes of Deceit, Masquerade of Authority, Reflections of Deceit
...
- Avoid patterns: Prior run crime subtype: mechanical manipulation | Prior run manner of death: strangled | Prior run false-assumption axis: temporal | Prior run false assumption: Eleanor Voss was murdered at the time indicated by the hotel clock. | Prior run discriminating test: trap | Prior run manner of death: strangled with a silk scarf | Prior run false assumption: The murder occurred at the time indicated by the clock. | Prior run discriminating test: constraint_proof | Prior run crime subtype: mechanical assassination | Prior run false assumption: The murder occurred around ten minutes past eleven, as indicated by the dining room clock. | Prior run false assumption: The time of death was as indicated by the hotel clock. | Prior run false assumption: The murder occurred at the time indicated by the hotel clock. | Prior run crime subtype: delayed-action poison | Prior run manner of death: poisoned with a slow-acting toxin | Prior run false-assumption axis: behavioral | Prior run false assumption: The victim must have been poisoned at the time of the toast. | Prior run crime subtype: poisoning | Prior run manner of death: poisoned with a botanical toxin | Prior run false assumption: Beatrice Quill died from a sudden illness caused by her pre-existing condition. | Prior run crime subtype: drowning

LOCKED THEME — PRIMARY DEVICE CONSTRAINT (non-negotiable):
The theme commits to a specific murder-mechanism family: optics (from the theme: "Golden Age murder driven by an optical method, where a mirror-and-lens reflection falsified a witness's sightline across the room. Enforce strict fair-play: reveal all mechanism-critical clues to reader by mid-story, place the discriminating test no later than early Act III, include at least 3 explicit evidence clues tied to final deduction, and ensure every red herring is inference-isolated from the true solution chain.").
- The PRIMARY device (devices[0]) MUST realize this mechanism family. Its corePrinciple, surfaceIllusion, underlyingReality, fairPlayClues, and lockedFacts must all concern optics — not a substitute method.
