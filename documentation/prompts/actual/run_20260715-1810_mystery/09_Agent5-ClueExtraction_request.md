...
- Project ID: `unknown`
- Timestamp: `2026-07-15T18:12:57.693Z`
...
1. Generate a clue that makes the reader directly observe: "The mirror in the dining area shows fresh adjustment marks...."
   → observation | essential | early | testimonial | step 1 | terms: mirror, dining, shows

2. Generate a clue that provides evidence for: "The fresh marks indicate it was recently altered to mislead the view...."
   → contradiction | essential | early | testimonial | step 1 | terms: fresh, marks, indicate

3. Generate a clue that makes the reader directly observe: "Witnesses describe seeing the culprit enter from the main entrance...."
   → observation | essential | early | testimonial | step 2 | terms: witnesses, describe, seeing

4. Generate a clue that provides evidence for: "This contradicts the layout of the room as confirmed by the mirror's position...."
   → contradiction | essential | early | spatial | step 2 | terms: contradicts, layout, confirmed

5. Generate a clue that makes the reader directly observe: "Scratches on the floor lead away from the mirror towards the service entrance...."
   → observation | essential | mid | testimonial | step 3 | terms: scratches, floor, mirror

6. Generate a clue that provides evidence for: "The scratches indicate the culprit moved towards the service entrance, not the main entrance...."
   → contradiction | essential | mid | testimonial | step 3 | terms: scratches, indicate, culprit

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The fresh marks indicate it was recently altered to mislead the view...."
   → contradiction | essential | mid | testimonial | step 1 | terms: fresh, marks, indicate

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "A carefully placed mirror and lens create a false reflection, leading witnesses to misinterpret the direction of the culprit's movement...."
   → observation | essential | early | spatial | terms: carefully, placed, mirror
...
10. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Reenacting the scene with the mirror adjusted to its original position to reveal the true sightline...."
   → observation | essential | mid | testimonial | terms: reenacting, scene, mirror
...
11. Generate one essential mid-story clue whose description or pointsTo explicitly names Beatrice Quill and states the unique trace, preparation detail, or mechanism link that points to Beatrice Quill rather than any non-culprit.
   → observation | essential | mid | spatial | terms: Beatrice Quill, carefully, placed, mirror
...
12. Generate one essential early-or-mid clue establishing that Beatrice Quill UNIQUELY had the means/skill/access/knowledge required to execute the concealment mechanism, and that the other suspects did not — so the reveal relies only on this already-planted capability, never on a means introduced for the first time at the confrontation.
   → elimination | essential | mid | spatial | terms: Beatrice Quill, carefully, placed, mirror
...
- Eleanor Voss: sensitive items: Sensitive to optical clues
- Dr. Mallory Finch: sensitive items: Witness testimony
...
Create 2 red herrings that support the false assumption: "Witnesses believe they saw the culprit enter through the main entrance."
