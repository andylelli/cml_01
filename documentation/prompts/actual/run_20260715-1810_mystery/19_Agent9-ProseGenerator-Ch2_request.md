...
- Project ID: ``
- Timestamp: `2026-07-15T18:25:23.428Z`
...
• [clue_mechanism_visibility_core] carefully, placed, mirror, lens, create, false, reflection, leading, witnesses, misinterpret, direction, culprit
  Category: spatial | Criticality: essential | Supports inference step 1
  Points to: mechanism, false, reflection

• [clue_core_contradiction_chain] witnesses, describe, seeing, culprit, enter, main, entrance
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: initial, assumption, culprit, entry, point
...
CLUES ALREADY REVEALED TO READER: clue_9, clue_10, clue_culprit_direct_beatrice_quill — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): method, murder | timing, murder | direct, shows, beatrice, quill, means, opportunity
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "She straightened, smoothing her skirt with deliberate care. ‘We’ll need to keep everyone here until we understand what happened,’ Eleanor said, her voice steady. ‘No one leaves, not until the truth is less elusive than the Scarborough sun in January. ’ The oth..."
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=9844; context=12466; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 2:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "She straightened, smoothing her skirt with deliberate care. ‘We’ll need to keep everyone here until we understand what happened,’ Eleanor said, her voice steady. ‘No one leaves, not until the truth is less elusive than t...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • witness, statements, entrance, used, culprit [clue_core_contradiction_chain] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: initial, assumption, culprit, entry, point
...
Chapter 2 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The fresh adjustment marks on the mirror."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the mirror was tampered with, suggesting someone tried to mislead the view."
...
[
  {
    ...
    "setting": {
      ...
      "atmosphere": "Tension lingers in the air as the detective begins her inquiry."
    },
    "characters": [
      "Eleanor Voss",
      "Dr. Mallory Finch",
    ...
    "dramaticElements": {
      ...
      "tension": "Conflicting testimonies create doubt.",
      "microMomentBeats": [
        "Eleanor bites her lip, sensing the growing animosity in the room."
      ]
    },
    "summary": "Eleanor Voss begins her investigation, questioning the suspects about their whereabouts during the murder. Dr. Finch claims she was in the kitchen preparing breakfast, while Captain Hale insists he was outside. Beatrice Quill and Hugo Vane exchange nervous glances. Eleanor notices that a mirror in the dining area has fresh adjustment marks, suggesting it was recently altered. The conflicting accounts of the suspects lead her to question their honesty as they argue over who saw what.",
    "beat": "crime",
    "estimatedWordCount": 1250,
    "pivotElement": "The fresh adjustment marks on the mirror.",
    "factEstablished": "Establishes that the mirror was tampered with, suggesting someone tried to mislead the view.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 2: the clue [clue_core_contradiction_chain] (witnesses, describe, seeing, culprit, enter, main, entrance) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 2: the clue [clue_mechanism_visibility_core] (carefully, placed, mirror, lens, create, false, reflection, leading, witnesses, misinterpret, direction, culprit) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 2: the clue [clue_3] (fresh, marks, indicate, recently, altered, mislead, view) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
