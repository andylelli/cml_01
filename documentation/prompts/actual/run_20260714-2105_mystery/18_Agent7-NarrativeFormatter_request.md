...
- Project ID: `unknown`
- Timestamp: `2026-07-14T21:11:42.555Z`
...
**Era & Setting**: 1940s - seaside
**Setting Lock**: All scenes must remain within this setting: seaside. Do not move to a different location type.
...
Captain Hale was in his office at the time of the murder, as he stated.
*Revealed: final act*
...
### Early Clues (Act I)
- [clue_mechanism_visibility_core] testimonial: Witnesses report seeing Captain Hale in the lobby at eight, just after the murder.
- [clue_core_contradiction_chain] temporal: Hale's alibi claiming he was in his office at that time is false.
- [clue_1] testimonial: A missing button from a hotel uniform is found at the crime scene.
- [clue_2] testimonial: The button suggests a hotel staff member was present during the murder.
...
- [clue_early_1] testimonial: Witnesses report seeing Captain Hale in the lobby at eight, just after the murder.
- [clue_mid_1] temporal: Hale's alibi claiming he was in his office at that time is false.
- [clue_late_1] testimonial: A missing button from a hotel uniform is found at the crime scene.

### Mid Clues (Act II)
- [clue_core_elimination_chain] testimonial: Eliminates Eleanor Voss because she was seen at the masquerade ball starting at half past eight at night.
- [clue_3] behavioral: Hale instructs staff to create a cover story that conflicts with witness accounts.
- [clue_4] testimonial: This manipulation indicates Hale's involvement in obscuring the truth.
- [clue_5] physical: Footprints found leading away from the crime scene.
- [clue_6] behavioral: Captain Ivor Hale desires to maintain order in the hotel.
- [clue_fp_elimination_hugo_vane] testimonial: Claims to have been in the dining area.
...
### Late Clues (Act III)
- [clue_late_optional_slot_1] temporal: Time of death at approximately eight o'clock. remains a late texture detail in the case background.

### Red Herrings
- [rh_1] Hale was seen in his stated earlier in the evening, which supports his claim.
- [rh_2] A guest reported seeing a shadowy figure near the victim's room.
...
- **Dr. Mallory Finch**: Act 3, Scene 5
  - Method: Witness corroboration
  - Clues: clue_id_1, clue_id_2
- **Sylvia Trent**: Act 3, Scene 5
  - Method: Jewelry misplaced during preparation.
  - Clues: clue_id_3, clue_id_4
- **Hugo Vane**: Act 3, Scene 5
  - Method: Old business note unrelated to murder.
...
- **clue_culprit_direct_captain_ivor_hale**: Act 1, Scene 3 (Witness statement)
...
- **button_found**: "one" — A missing button from the hotel employee's uniform found at the crime scene.
- **witness_count**: "three" — Three witnesses recall seeing the murderer at the ball.
- **costume_matching**: "the same" — The costume matches the description of a character seen at the event.
- **ball_time**: "half past eight at night" — The masquerade ball started at half past eight at night, coinciding with the time of the murder.


## PILLAR 4 — OUTLINE COMPLETENESS CONTRACT DATA

### Character Permitted Behaviours (use for permittedBehavioursByAct per scene)
- **Eleanor Voss**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Initially drawn to the hotel for a feature on post-war recovery, Eleanor's instincts compel her to dig deeper into the murder that disrupts the fragile peace." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Eleanor wrestles with the guilt of not being able to save her brother, which complicates her pursuit of justice for others." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Dr. Mallory Finch**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "The victim's potential revelations about her practices could expose her dark past and destroy the career she has painstakingly built." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Dr. Finch grapples with guilt over her unethical choices, fearing that exposure could lead to the loss of everything she values." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Captain Ivor Hale**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "The victim had discovered his smuggling activities and was poised to expose him, threatening his carefully crafted image." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "While he relishes the thrill of his secret life, Captain Hale is increasingly aware of the moral decay it brings, forcing him to question his choices." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Beatrice Quill**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "The humiliation she felt at the victim's hands drove Beatrice to a boiling point, leading her to contemplate dark choices." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Beatrice struggles with her feelings of inadequacy, torn between her desire for validation and the resentment she harbors towards those who belittle her." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Sylvia Trent**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "The victim's plan to expose her financial troubles threatened to unravel the social standing Sylvia had fought so hard to maintain." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Sylvia struggles with the duality of her public persona and her private struggles, fearing that the truth will shatter her carefully constructed life." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Hugo Vane**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "The victim had evidence of his shady practices, putting Hugo at risk of exposure." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Hugo is torn between his ambition and the moral implications of his actions, struggling to reconcile his greed with the potential consequences." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.

### Red Herrings (must be seeded in Act I–II scenes via redHerringPlacement)
- **rh_1**: Hale was seen in his stated earlier in the evening, which supports his claim. (misdirection: This observation misleads the reader into believing Hale's captain is solid.)
- **rh_2**: A guest reported seeing a shadowy figure near the victim's room. (misdirection: This sighting distracts from the evidence against Hale.)
```
