...
- Project ID: ``
- Timestamp: `2026-07-14T21:14:45.795Z`
...
• [clue_core_contradiction_chain] hale, alibi, claiming, office, time, false
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: hale, alibi, cannot, trusted

• [clue_mid_1] hale, alibi, claiming, office, time, false
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: hale, alibi, cannot, trusted
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_early_1, clue_late_1 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): hale, alibi, questionable | hale, alibi, questionable | hotel, employee, involved, murder
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "She moved aside as the constable arrived, but it was clear from the way eyes turned to her, the way Hugo Vane deferred and Captain Hale bristled, that the role of investigator had already been assigned. Eleanor Voss, for better or worse, was the axis upon whic..."
...
study, deck, corridor, lobby, lounge, flat
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=9443; context=11363; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 2:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "She moved aside as the constable arrived, but it was clear from the way eyes turned to her, the way Hugo Vane deferred and Captain Hale bristled, that the role of investigator had already been assigned. Eleanor Voss, for...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • time, death, approximately, eight, clock [clue_core_contradiction_chain] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: hale, alibi, cannot, trusted
  ...
  - Sensory obligation — use at least two of: flat light from the sky, shadows lengthening in corners | silence punctuated by distant laughter, the distant crash of waves | dust from the corners. Mood: suspicious stillness.
...
Chapter 2 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Hale's insistence about being in his office while witnesses contradict him."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Hale's alibi is contradicted by witness accounts."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor's fingers tremble slightly as she takes a deep breath, ready to ask her questions."
      ]
    },
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 2: the clue [clue_core_contradiction_chain] (hale, alibi, claiming, office, time, false) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 2: the clue [clue_mid_1] (hale, alibi, claiming, office, time, false) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
