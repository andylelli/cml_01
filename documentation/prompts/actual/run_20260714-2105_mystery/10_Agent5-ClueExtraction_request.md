...
- Project ID: `unknown`
- Timestamp: `2026-07-14T21:07:27.366Z`
...
1. Generate a clue that makes the reader directly observe: "Witnesses report seeing Captain Hale in the lobby at eight, just after the murder...."
   → observation | essential | early | temporal | step 1 | terms: witnesses, report, seeing

2. Generate a clue that provides evidence for: "Hale's alibi claiming he was in his office at that time is false...."
   → contradiction | essential | early | temporal | step 1 | terms: hale's, alibi, claiming

3. Generate a clue that makes the reader directly observe: "A missing button from a hotel uniform is found at the crime scene...."
   → observation | essential | early | testimonial | step 2 | terms: missing, button, hotel

4. Generate a clue that provides evidence for: "The button suggests a hotel staff member was present during the murder...."
   → contradiction | essential | early | testimonial | step 2 | terms: button, suggests, hotel

5. Generate a clue that makes the reader directly observe: "Hale instructs staff to create a cover story that conflicts with witness accounts...."
   → observation | essential | mid | testimonial | step 3 | terms: instructs, staff, create

6. Generate a clue that provides evidence for: "This manipulation indicates Hale's involvement in obscuring the truth...."
   → contradiction | essential | mid | testimonial | step 3 | terms: manipulation, indicates, hale's

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "Hale's alibi claiming he was in his office at that time is false...."
   → contradiction | essential | mid | temporal | step 1 | terms: hale's, alibi, claiming

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The mechanism relies on hotel, staff, and witness to expose the false timing...."
   → observation | essential | early | testimonial | terms: mechanism, relies, hotel,
...
10. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Setting up a staged confrontation with hotel staff to reveal Hale's manipulation of alibi...."
   → observation | essential | mid | temporal | terms: setting, staged, confrontation
...
11. Generate one essential mid-story clue whose description or pointsTo explicitly names Captain Ivor Hale and states the unique trace, preparation detail, or mechanism link that points to Captain Ivor Hale rather than any non-culprit.
   → observation | essential | mid | testimonial | terms: Captain Ivor Hale, mechanism, relies, hotel,
...
12. Generate one essential early-or-mid clue establishing that Captain Ivor Hale UNIQUELY had the means/skill/access/knowledge required to execute the concealment mechanism, and that the other suspects did not — so the reveal relies only on this already-planted capability, never on a means introduced for the first time at the confrontation.
   → elimination | essential | mid | testimonial | terms: Captain Ivor Hale, mechanism, relies, hotel,

13. Generate a clue showing observable evidence of Captain Ivor Hale's premeditation or planning (Desires to maintain order in the hotel.). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: desires, maintain, order
...
## Access Constraints
Actors: Captain Hale, Hotel staff
Objects: Victim's room, Manager's office
...
Create 2 red herrings that support the false assumption: "Captain Hale was in his office at the time of the murder, as he stated."
