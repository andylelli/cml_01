...
- Timestamp: `2026-06-14T10:10:51.340Z`
...
Attempt context: 5/6 | primary class: template.
...
ATTEMPT: 4/6
OFFENDING TEXT: high n-gram overlap detected (0.81 >= 0.65). Rephrase this passage to avoid template leakage.
MANDATORY FIXES:
- Resolve template issues before accepting this batch.
- Template linter: high n-gram overlap detected (0.81 >= 0.65). Rephrase this passage to avoid template leakage.
```
