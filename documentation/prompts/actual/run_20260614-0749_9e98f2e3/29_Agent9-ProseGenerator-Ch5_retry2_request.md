...
- Timestamp: `2026-06-14T10:10:00.175Z`
...
A revelation about Wilfred’s motivations deepens the mystery and complicates relationships.
...
Permission: conditional — condition: if characters use humor to deflect tension
Characters who may be funny: Julian Cromer
Permitted forms: sardonic
Rationale: Julian's sardonic remarks can add depth while easing tension.
...
• [clue_6] Eliminates Julian Cromer because he has a verified alibi from the party host.
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: This confirms he could not have committed the murder.

• [clue_culprit_direct_wilfred_wellow] Direct evidence ties Wilfred Wellow to the mechanism access point before the discriminating test.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Wilfred swallowed hard, his eyes darting to the path that led back to the manor. “I was just... making sure everything was in order,” he replied, his voice strained. Joan could sense the tension in his words, the way he avoided her gaze. The garden, with its o..."
...
Known location profile anchors: Little Middleton Manor, Drawing Room, Library, Servants' Hall, Gardens, the dining room of the Wellow residence
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "Drawing Room", "Library", "Servants' Hall", "Gardens", "the dining room of the Wellow residence"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 5: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a temporal subordinate clause — e.g. "When [Name] entered…" / "After the last guest…" / "Before the household had stirred…" / "As the light faded…". Anchor opening in "the dining room of the Wellow residence". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=9651; context=10615; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
Batch chapters: 5-5.
Investigation state at start: 8 clue(s) revealed to reader; approximately 2 unresolved suspect(s).
Must change by end: Increase or complicate suspicion through new pressure revelation.
Suspect pressure target(s): Patricia Corfield
...
- Chapter 5:
  ...
  - Scene is set in: the dining room of the Wellow residence — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Wilfred swallowed hard, his eyes darting to the path that led back to the manor. “I was just... making sure everything was in order,” he replied, his voice strained. Joan could sense the tension in his words, the way he...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • Footprints in the garden lead to the back entrance. [clue_3]
...
[
  {
    "sceneNumber": 5,
    "act": 2,
    "title": "Patricia's Departure",
    "setting": {
      "location": "the dining room of the Wellow residence",
      "timeOfDay": "Mid-afternoon",
      "atmosphere": "Tension thickens as secrets are revealed"
    },
    "characters": [
      "Joan Plowden",
      "Patricia Corfield"
    ],
    "purpose": "Confirm Patricia's alibi and gather more information",
    "cluesRevealed": [
      "clue_6",
      "clue_culprit_direct_wilfred_wellow"
    ],
    "dramaticElements": {
      "conflict": "Patricia's insistence on her innocence feels forced.",
      "tension": "Joan senses something is amiss.",
      "microMomentBeats": [
        "Patricia's eyes dart around, searching for a way out."
      ]
    },
    "summary": "Joan speaks with Patricia in the dining room, where she insists she left the party at ten-thirty. Joan cross-references this with other guests’ statements, noting inconsistencies. Patricia's anxious demeanor raises Joan's suspicions even further.",
    "estimatedWordCount": 1250,
    "emotionalRegister": "A revelation about Wilfred’s motivations deepens the mystery and complicates relationships.",
...
```text
{
  ...
  "chapters": [
    {
      ...
      "paragraphs": [
        ...
        "“You mentioned earlier that you were busy in the kitchen,” Joan said, attempting to redirect the conversation. “Did anyone else see you there?” Patricia hesitated, her gaze dropping to the table as if searching for answers among the polished wood. \"I believe Mrs. Wellow was there, but I can't say for certain who else might have been present at that time,\" she finally admitted, her voice barely above a whisper. The admission felt like a crack in her armor, and Joan's heart raced at the potential for new revelations.",
        "The tension hung in the air, thick and palpable. Joan could sense that Patricia was on the verge of revealing something significant, but the fear of exposure held her back. As the rain continued to patter against the windows, Joan realized that the answers she sought were still shrouded in uncertainty. The inconsistencies in Patricia's story made her harder to dismiss, and Joan knew that the investigation was far from over."
      ]
    }
  ],
  "cast": [
  ...
  "audit": {
    ...
    "required_clues_present": "clue_6: chapter 5 paragraph 6 | clue_culprit_direct_wilfred_wellow: chapter 5 paragraph 8",
...
Attempt context: 3/6 | primary class: unknown.
...
PRIMARY FAILURES
- Chapter 5: clue evidence "Footprints in the garden lead to the back entrance." is absent. Include an on-page observation or reference to "Footprints in the garden lead to the back entrance." (this clue reveals: This suggests someone used the entrance to leave after the murder.) before the chapter ends.

REWRITE PLAN
- Preserve paragraphs that are already valid, but fully rewrite every paragraph touched by a failing issue.
- Insert or move a dedicated observation-plus-inference block for each missing clue: "Footprints in the garden lead to the back entrance.". The observation and inference must be separate full paragraphs.

SUCCESS CHECKLIST
- Every listed issue below is resolved in this single attempt before you answer.
- Each missing clue appears on-page as observable evidence, followed immediately by a separate inference paragraph: "Footprints in the garden lead to the back entrance.".
...
• REPAIR [clue_visibility — attempt 3]: chapters 5 are missing 1 clue.
  For EACH missing clue below, insert a two-paragraph block near the beginning of the chapter:
  Clue: "Footprints in the garden lead to the back entrance."
  ...
  • Inference paragraph (immediately after): The detective or POV character state explicitly: "This suggests someone used the entrance to leave after the murder.". Use first-person inference language ("She realised...", "He could not help but notice..."). This must be a full separate paragraph, not a tacked-on sentence.
...
RETRY CLASS: unknown
ATTEMPT: 2/6
OFFENDING TEXT: Footprints in the garden lead to the back entrance.
MANDATORY FIXES:
