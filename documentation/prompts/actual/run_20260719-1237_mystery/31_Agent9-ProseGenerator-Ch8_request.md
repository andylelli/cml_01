...
- Project ID: ``
- Timestamp: `2026-07-19T12:47:06.541Z`
...
• [clue_9] eleanor, voss, confirmed, alibi, time, murder
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: eliminates, eleanor, voss, suspect

• [clue_12] hugo, vane, group, friends, murder
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: eliminates, hugo, vane, suspect

• [clue_mid_2] captain, ivor, hale, seen, handling, forged, documents
  Category: testimonial | Criticality: essential | Supports inference step 3
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the group began to disperse, the cold settling deeper into their bones, Eleanor lingered beneath the arbor. She breathed in the scent of wet earth, the salty tang of the sea, and let the sound of the rain steady her nerves. The truth was close—so close she..."
...
Known location profile anchors: The Oceanview Hotel, The Grand Dining Room, The Drawing Room, The Library, The Garden, the hotel study
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Oceanview Hotel", "The Grand Dining Room", "The Drawing Room", "The Library", "The Garden", "the hotel study"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=22249; context=4104; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 8:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the group began to disperse, the cold settling deeper into their bones, Eleanor lingered beneath the arbor. She breathed in the scent of wet earth, the salty tang of the sea, and let the sound of the rain steady her n...".
...
Chapter 8 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The timeline reconstruction that leads to the final test."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Prepares the groundwork for the final test, indicating who is most likely guilty."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor scribbles notes furiously, piecing together the timeline."
      ]
    },
    ...
    "emotionalRegister": "Building pressure culminates in a confrontation among the suspects, revealing hidden truths.",
