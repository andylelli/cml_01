...
- Project ID: ``
- Timestamp: `2026-07-19T12:42:43.693Z`
...
- Eleanor Voss
  ...
  Connection to victim: Eleanor admires Mallory’s commitment to her patients, but suspects her financial troubles might lead to questionable decisions.; Eleanor and Mallory were once friends, but a falling out over professional ethics has created distance..
  Investigation relevance: is actively driving interviews and credibility checks in this scene.
  Suspicion/pressure cue seed: Her reputation as a capable investigator..
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Captain Ivor Hale
  Public identity anchor: Retired Naval Officer; suspect 
  Connection to victim: Mallory respects Ivor’s military service but feels he looks down upon her profession.; They often crossed paths in local health initiatives, but their interactions are often strained..
  Investigation relevance: access plausibility: high | alibi window: 9:00 PM to 10:00 PM | opportunity channel: Lounge.
  Suspicion/pressure cue seed: Maintaining his honor..
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Beatrice Quill
  Public identity anchor: Socialite and Aspiring Actress; suspect 
  Connection to victim: Mallory sees Beatrice as frivolous, but worries about her influence over younger women in town.; They once collaborated on a charity event, but Mallory was frustrated by Beatrice's lack of seriousness..
  Investigation relevance: access plausibility: medium | alibi window: 9:15 PM to 10:15 PM | opportunity channel: Lounge.
  Suspicion/pressure cue seed: Her career and reputation..
  Investigator rea
...
Tension and unease permeate the hotel as guests gather, unaware of the dark secret about to unfold.
...
• [clue_mechanism_visibility_core] witnesses, recall, seeing, official, looking, figure, enter, victim, room, before, murder
  Category: testimonial | Criticality: essential | Supports inference step 1
  Points to: presence, official, looking, figure, suggests, potential, foul, play
...
Known location profile anchors: The Oceanview Hotel, The Grand Dining Room, The Drawing Room, The Library, The Garden, the scene
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Oceanview Hotel", "The Grand Dining Room", "The Drawing Room", "The Library", "The Garden", "the scene"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=7716; context=12295; dropped=[none]; truncated=[first_appearance_contracts, location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • witnesses, report, official, looking, figure, entering, victim, room [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
...
Chapter 1 (Act 1) completeness contract:
  ...
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_1] Captain Hale mentions having seen a legitimate officer leaving the victim's room — seeds false inference about an official involvement.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Dr. Finch stares at the door, her hands trembling with unspoken grief."
      ]
    },
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_1",
      "placementDetail": "Captain Hale mentions having seen a legitimate officer leaving the victim's room — seeds false inference about an official involvement."
    },
    "emotionalRegister": "Tension and unease permeate the hotel as guests gather, unaware of the dark secret about to unfold.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (witnesses, recall, seeing, official, looking, figure, enter, victim, room, before, murder) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
