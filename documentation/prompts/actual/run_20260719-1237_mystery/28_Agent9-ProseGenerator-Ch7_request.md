...
- Project ID: ``
- Timestamp: `2026-07-19T12:46:06.179Z`
...
• [clue_6] discrepancies, indicate, forgery, suggesting, murderer, impersonating, someone
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: implication, impersonation, narrows, down, suspect, list

• [clue_7] captain, ivor, hale, seen, handling, forged, documents
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: observation, raises, suspicion, towards, captain, ivor, hale

• [clue_mid_1] discrepancies, indicate, forgery, suggesting, murderer, impersonating, someone
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: implication, impersonation, narrows, down, suspect, list
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Left alone in the hush of the library, Eleanor gathered her notes, her mind racing. The solution she had presented was convincing—airtight, even—but it rang hollow. The true answer, she sensed, lay not in the evidence she had marshaled, but in the contradictio..."
...
Known location profile anchors: The Oceanview Hotel, The Grand Dining Room, The Drawing Room, The Library, The Garden, the hotel garden
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Oceanview Hotel", "The Grand Dining Room", "The Drawing Room", "The Library", "The Garden", "the hotel garden"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=20137; context=4093; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 7:
  ...
  - Sensory obligation — use at least two of: raindrops clinging to flower petals, the garden glistening in the grey light | the soft patter of rain on leaves, the distant sound of thunder | the scent of wet earth. Mood: melancholic solitude.
...
Chapter 7 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Captain Hale's nervousness when confronted about the forged documents."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Hale was seen handling the forged documents, linking him directly to the crime."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor pauses to breathe in the salty air, contemplating the lies she's uncovered."
      ]
    },
