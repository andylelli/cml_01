...
- Project ID: ``
- Timestamp: `2026-07-19T12:43:23.958Z`
...
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): presence, official, looking, figure, suggests, potential
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Eleanor made a mental note of every detail, every hesitation. The contradiction between the stopped watch and the guests’ accounts gnawed at her. Someone was lying, or perhaps all of them were, each for their own reasons. She glanced once more at Dr. Mallory F..."
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=9278; context=12584; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 2:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Eleanor made a mental note of every detail, every hesitation. The contradiction between the stopped watch and the guests’ accounts gnawed at her. Someone was lying, or perhaps all of them were, each for their own reasons...".
...
Chapter 2 (Act 1) completeness contract:
  ...
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that at least one suspect is lying about their timeline."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor watches the suspects, noting their nervous glances at one another."
      ]
    },
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 2: the clue [clue_core_contradiction_chain] (figure, likely, impersonator, using, forged, documents, gain, access) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
