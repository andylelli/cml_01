...
- Project ID: ``
- Timestamp: `2026-07-19T12:44:51.533Z`
...
• [clue_3] forensic, analysis, shows, fingerprints, forged, documents
  Category: physical | Criticality: essential | Supports inference step 2
  Points to: fingerprints, lead, identifying, forger

• [clue_4] fingerprints, match, known, authority, figures
  Category: physical | Criticality: essential | Supports inference step 2
  Points to: absence, matches, suggests, forger, outsider

• [clue_early_1] forensic, analysis, shows, fingerprints, forged, documents
  Category: physical | Criticality: essential | Supports inference step 2
  Points to: fingerprints, lead, identifying, forger
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Yet the relief was short-lived. The contradictions in the stories, the forged documents, the hidden letter—all pointed to a web of deception more intricate than she had first imagined. Eleanor felt the weight of the investigation settle anew on her shoulders...."
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=15439; context=7919; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 5:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Yet the relief was short-lived. The contradictions in the stories, the forged documents, the hidden letter—all pointed to a web of deception more intricate than she had first imagined. Eleanor felt the weight of the inve...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • forensic, results, indicate, matches, fingerprints [clue_4]
      Points to: absence, matches, suggests, forger, outsider
...
Chapter 5 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The analysis revealing discrepancies in the forged documents."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the forensic evidence contradicts the suspects' alibis."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor feels the weight of the room's silence as she reviews the alibis."
      ]
    },
    ...
    "emotionalRegister": "The revelation of impersonation reshapes the investigation and challenges assumptions about trust.",
