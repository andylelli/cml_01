...
- Project ID: `unknown`
- Timestamp: `2026-05-12T16:46:48.061Z`
...
1. Generate a clue that makes the reader directly observe: "The clock in the study shows a faint scratch on its casing...."
   → observation | essential | early | temporal | step 1 | terms: clock, study, shows

2. Generate a clue that provides evidence for: "The scratch indicates it was tampered with recently...."
   → contradiction | essential | early | testimonial | step 1 | terms: scratch, indicates, tampered

3. Generate a clue that makes the reader directly observe: "Witnesses claim Eleanor was last seen alive at eight o'clock...."
   → observation | essential | early | temporal | step 2 | terms: witnesses, claim, eleanor

4. Generate a clue that provides evidence for: "This contradicts the clock's stopping time, suggesting tampering...."
   → contradiction | essential | early | temporal | step 2 | terms: contradicts, clock's, stopping

5. Generate a clue that makes the reader directly observe: "A missing spring component was found near the crime scene...."
   → observation | essential | mid | testimonial | step 3 | terms: missing, spring, component

6. Generate a clue that provides evidence for: "The missing component suggests deliberate tampering with the clock...."
   → contradiction | essential | mid | temporal | step 3 | terms: missing, component, suggests

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The scratch indicates it was tampered with recently...."
   → contradiction | essential | mid | testimonial | step 1 | terms: scratch, indicates, tampered

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "A spring-driven clock was tampered with to mislead witnesses about the time of death...."
   → observation | essential | early | temporal | terms: spring-driven, clock, tampered

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "A controlled reenactment is staged where all suspects are asked to explain their whereabouts at the ..."
...
10. Generate one essential mid-story clue whose description or pointsTo explicitly names Dr. Mallory Finch and states the unique trace, preparation detail, or mechanism link that points to Dr. Mallory Finch rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Dr. Mallory Finch, spring-driven, clock, tampered

11. Generate a clue showing observable evidence of Dr. Mallory Finch's premeditation or planning (Jealousy over Eleanor's potential marriage). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: jealousy, eleanor's, potential
...
- Eleanor Voss: sensitive items: time of death, alibi verification
- Dr. Mallory Finch: sensitive items: medical records, personal letters
- Captain Ivor Hale: sensitive items: location records, timing of activities
- Beatrice Quill: sensitive items: investigative reports, personal notes
...
Create 2 red herrings that support the false assumption: "Eleanor Voss must have died around the time the clock stopped."
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 2, 3; words: stopping, clock) and may support the true solution.
  - [critical] Red Herring Separation: Red herring rh_2 overlaps inference corrections (steps: 2, 3; words: tampering, clock) and may support the true solution.
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
