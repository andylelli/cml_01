...
- Project ID: ``
- Timestamp: `2026-07-14T20:31:04.127Z`
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Ivor wrestles with guilt from his past decisions during the war, leading to a deep-seated fear of being perceived as outdated in a rapidly changing world."
...
• [clue_7] captain, ivor, hale, seen, near, water, around, time, incident
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: raises, suspicion, towards, captain, hale

• [clue_8] witnesses, noted, captain, hale, anxious, demeanor, questioned
  Category: behavioral | Criticality: essential | Supports inference step 3
  Points to: suggests, premeditation, hale, part

• [clue_9] eliminates, eleanor, voss, because, verified, alibi, time, incident
  Category: elimination | Criticality: essential | Supports inference step 3
  Points to: narrows, suspect, list

• [clue_10] eliminates, beatrice, quill, because, attending, party, time
  Category: elimination | Criticality: essential | Supports inference step 3
  Points to: further, narrows, suspect, list

• [clue_11] eliminates, sylvia, trent, because, seen, market, time, incident
  Category: elimination | Criticality: essential | Supports inference step 3
  Points to: eliminates, another, suspect

• [clue_12] eliminates, hugo, vane, because, town, business
  Category: elimination | Criticality: supporting | Supports inference step 3
  Points to: further, narrows, suspect, list
...
Known location profile anchors: The Ocean’s Edge Hotel, Private Beach Cove, Lounge Bar, Staff Kitchen, the seaside hotel dining room
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Ocean’s Edge Hotel", "Private Beach Cove", "Lounge Bar", "Staff Kitchen", "the seaside hotel dining room"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=15248; context=7281; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
Suspect pressure target(s): Beatrice Quill, Captain Ivor Hale, Sylvia Trent
...
- Chapter 5:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Outside, the storm pressed against the glass, and within the lounge, the guests settled into uneasy silence, the shadow of Dr. Finch’s influence lingering like the scent of salt and smoke.".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • sylvia, trent, confirmed, market [clue_11]
      Points to: eliminates, another, suspect
    • hugo, vane, travel, receipt, confirming, absence [clue_12]
      Points to: further, narrows, suspect, list
...
Chapter 5 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Captain Hale's anxious demeanor when questioned about the timeline."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Captain Hale's alibi is questionable, casting doubt on his innocence."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor's heart races as she confronts Beatrice about her alibi."
      ]
    },
    ...
    "emotionalRegister": "New evidence complicates the investigation, altering the stakes for all involved.",
