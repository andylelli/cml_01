...
- Project ID: `unknown`
- Timestamp: `2026-07-27T18:07:00.074Z`
...
1. Generate a clue that makes the reader directly observe: "The clock in the lobby shows a time of ten minutes past eleven...."
   → observation | essential | early | temporal | step 1 | terms: clock, lobby, shows

2. Generate a clue that provides evidence for: "This contradicts witness statements that Hugo was last seen alive at nine o'clock...."
   → contradiction | essential | early | temporal | step 1 | terms: contradicts, witness, statements

3. Generate a clue that makes the reader directly observe: "Witnesses report the clock was unusually silent earlier that evening...."
   → observation | essential | early | temporal | step 2 | terms: witnesses, report, clock

4. Generate a clue that provides evidence for: "This indicates the clock may have been tampered with before the murder...."
   → contradiction | essential | early | temporal | step 2 | terms: indicates, clock, tampered

5. Generate a clue that makes the reader directly observe: "The fingerprints found on the clock face do not match any of the suspects...."
   → observation | essential | mid | temporal | step 3 | terms: fingerprints, found, clock

6. Generate a clue that provides evidence for: "This suggests that the clock was tampered with by someone else...."
   → contradiction | essential | mid | temporal | step 3 | terms: suggests, clock, tampered

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "This contradicts witness statements that Hugo was last seen alive at nine o'clock...."
   → contradiction | essential | mid | temporal | step 1 | terms: contradicts, witness, statements

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The mechanism relies on clock, lobby, and minut to expose the false timing...."
...
10. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "The discriminating test compares clock, lobby, and minut against the claimed timeline...."
   → observation | essential | mid | temporal | terms: discriminating, compares, clock,

11. Generate one essential mid-story clue whose description or pointsTo explicitly names Dr. Mallory Finch and states the unique trace, preparation detail, or mechanism link that points to Dr. Mallory Finch rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Dr. Mallory Finch, mechanism, relies, clock,

12. Generate one essential early-or-mid clue establishing that Dr. Mallory Finch UNIQUELY had the means/skill/access/knowledge required to execute the concealment mechanism, and that the other suspects did not — so the reveal relies only on this already-planted capability, never on a means introduced for the first time at the confrontation.
   → elimination | essential | mid | temporal | terms: Dr. Mallory Finch, mechanism, relies, clock,

13. Generate a clue showing observable evidence of Dr. Mallory Finch's premeditation or planning (Professional rivalry with Hugo). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: professional, rivalry

14. Generate a clue that explicitly eliminates suspect Captain Ivor Hale using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Captain Ivor Hale because ...").
...
17. Generate one essential early or mid elimination clue that explicitly rules out Captain Ivor Hale and narrows the solution toward culprit Dr. Mallory Finch. The pointsTo text must start with "Eliminates Captain Ivor Hale because ..." and cite corroborated evidence.
...
## Access Constraints
Actors: All suspects had access to the lobby clock.
Objects: The lobby clock
...
Create 2 red herrings that support the false assumption: "Hugo was murdered just after nine o'clock."
...
- STRICT STRUCTURAL CONTRACT (author ALL of these YOURSELF, as concrete scene-register clues — a character sees/hears/finds something. NEVER meta-boilerplate like "adds texture to the case background"; if you omit any, a deterministic pass will synthesize flat machine text in its place, which reads as machine-made):
    • REQUIRED ID: "clue_culprit_direct_dr_mallory_finch" with sourceInCML=CASE.cast[1].alibi_window
    ...
    • DIRECT CULPRIT CLUE: id="clue_culprit_direct_dr_mallory_finch" — observable evidence tying Dr. Mallory Finch uniquely to the crime (source from: CASE.cast[1].alibi_window, CASE.cast[1].access_plausibility); the pointsTo must include: Dr. Mallory Finch, direct evidence, means and opportunity, no other eligible suspect
