...
- Project ID: ``
- Timestamp: `2026-07-27T18:17:56.529Z`
...
• [clue_culprit_direct_1] direct, links, mallory, finch, mechanism, access, point, before, discriminating, excludes, competing, suspect
  ...
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): physical, trace, opportunity, indicate, mallory, finch, means, making, direct, clue, culprit, identification
...
• [clue_culprit_direct_dr_mallory_finch] direct, ties, mallory, finch, mechanism, access, point, before, discriminating, excludes, competing, suspect
  ...
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): direct, shows, mallory, finch, means, opportunity, narrowing, solution, uniquely, toward, culprit, eligible

• [clue_fp_elimination_beatrice_quill] eight, clock, evening
  Category: temporal | Criticality: essential | Supports inference step 1
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): eliminates, beatrice, quill, because, independent, corroboration, places, away, decisive, mechanism, window

• [clue_fp_elimination_sylvia_trent] eight, clock, evening
  Category: temporal | Criticality: essential | Supports inference step 1
...
• [clue_mid_3] indicates, clock, tampered, before, murder
  Category: temporal | Criticality: essential | Supports inference step 3
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): timeline, events, distorted
...
CLUES ALREADY REVEALED TO READER: clue_early_1, clue_core_contradiction_chain, clue_fp_contradiction_step_2, clue_late_1, clue_mid_1, clue_mid_2, clue_core_elimination_chain — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): timeline, murder, inconsistent, witness, statements | timeline, murder, unreliable | indicates, clock, tampered, before, murder | manner, death, likely, blunt, force | reliability, clock, timekeeper, questionable | potential, involvement, unknown, third, party | captain, ivor, hale, suspect
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Eleanor closed her notebook, her thoughts in turmoil. The contradictions had multiplied: the unmoving clock, the bloodied candlestick, the shifting alibis. She glanced once more at Beatrice and Sylvia, each now lost in her own thoughts, the mask of composure s..."
...
Known location profile anchors: The Crestview Hotel, The Grand Dining Room, The Library, The Lounge, The Staff Quarters, the library of the grand art deco seaside hotel
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Crestview Hotel", "The Grand Dining Room", "The Library", "The Lounge", "The Staff Quarters", "the library of the grand art deco seaside hotel"
...
- clue_culprit_direct_dr_mallory_finch must appear in Act 2, Scene 3 via Behavioral observation
...
- clue_late_1 must appear in Act 2, Scene 3 via Fingerprints on the clock
- clue_mid_2 must appear in Act 2, Scene 3 via Direct observation
...
- Chapter 6:
  ...
  - Scene is set in: the library of the grand art deco seaside hotel — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Eleanor closed her notebook, her thoughts in turmoil. The contradictions had multiplied: the unmoving clock, the bloodied candlestick, the shifting alibis. She glanced once more at Beatrice and Sylvia, each now lost in h...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • clock, lobby [clue_culprit_direct_1]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • mallory, finch, expertise, clocks [clue_culprit_direct_dr_mallory_finch]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • clock, lobby [clue_fp_elimination_beatrice_quill]
    ...
    • clock, lobby [clue_fp_elimination_sylvia_trent]
      OBSERVATION ONLY: put it on the page concretely — a character sees, handles, or hears it inside the scene. The detective may NOTICE (a pause, a second glance, a pocketed item) but must NOT state what it implies.
    • heavy, object, blood [clue_late_1]
      OBSERVATION ONLY: put it on the page concretely — a character sees, handles, or hears it inside the scene. The detective may NOTICE (a pause, a second glance, a pocketed item) but must NOT state what it implies.
    • fingerprints, clock [clue_mid_2]
      OBSERVATION ONLY: put it on the page concretely — a character sees, handles, or hears it inside the scene. The detective may NOTICE (a pause, a second glance, a pocketed item) but must NOT state what it implies.
    • tampering, clock [clue_mid_3]
      OBSERVATION ONLY: put it on the page concretely — a character sees, handles, or hears it inside the scene. The detective may NOTICE (a pause, a second glance, a pocketed item) but must NOT state what it implies.
  ...
  - Sensory obligation — use at least two of: warm glow of the fireplace, sunset casting hues on the water | the crackling of the fire, soft laughter from the lounge | the rich aroma of aged whiskey. Mood: contemplative.
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The flawed accusation against Captain Hale."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor's mind races as she considers the implications of her accusations."
      ]
    },
    ...
    "emotionalRegister": "A revelation recontextualizes earlier events, reshaping Eleanor's understanding of the case.",
...
"that detail shifted the reasoning weighed ... toward manner death likely blunt force"
...
⛔ PRIOR CHAPTER DUPLICATION LOCK — 90 protected passage(s):
Your prose has been detected copying from an earlier chapter. Every paragraph listed below appears in a prior chapter and is COMPLETELY OFF-LIMITS. Do not reproduce, rephrase, or structurally echo any of them:
  ...
  • "Eleanor Voss stepped briskly through the ... morning clinging to her wool coat."
  • "It was not the silence that ... his chest as if in mid-gesture."
  • "The clock above the reception desk drew her eye."
  • "A low murmur rose as the ... by the gravity of the scene."
  • "Captain Ivor Hale stood at attention ... his cufflinks catching the dim light."
  • "Beatrice Quill arrived in a flurry ... hair swept into a dramatic knot."
  • "Sylvia Trent glided in last, her ... of pearls resting at her throat."
  • "Eleanor drew a slow breath, the ... of expectation settling on her shoulders."
  • "The lobby clock continued its measured ... the tension that thickened the air."
  • "A bellhop hovered at the edge ... foot, eyes fixed on the floor."
  • "She rose, smoothing her skirt, and ... the room with a quiet authority."
  • "As Eleanor moved to the reception ... a neat pile for her review."
  • "A faint click drew her gaze ... beside a vase of autumn chrysanthemums."
  • "Captain Hale, meanwhile, had taken up ... posture suggesting both vigilance and unease."
  • "Sylvia Trent drifted toward Eleanor, her voice low."
  • "The rain intensified, drumming a steady rhythm against the glass."
  • "With the first facts in hand—the ... the guests—Eleanor Voss began her investigation."
  • ""If we could all remain calm ... drizzle tapping at the glass doors."
  • "The echo of the rain was ... of staff moving behind the scenes."
  • "A sudden silence settled over the group as Dr."
  • "Captain Ivor Hale shifted his weight, ... his shoes creaking against the marble."
  • "At the edge of the group, ... voice trembling with carefully practiced distress."
  • "Sylvia Trent, pearls gleaming against her ... that never quite reached her eyes."
  • "Eleanor’s hand lingered near the reception ... the smooth lacquer as she listened."
  • "She let her gaze move across ... but impossible for her to ignore."
  • "The conversations grew quieter, each guest ... as Eleanor continued her gentle interrogation."
  • "“Perhaps,” Eleanor mused aloud, her tone ... are chasing the wrong hour altogether."
  • "A flicker of relief passed between ... the small routines of the evening."
  • "Eleanor made a note in her book, her pen scratching softly."
  • "That detail shifted the reasoning."
  • "As she closed her notebook, Eleanor ... gaze fixed on the rain-blurred windows."
  • "Late morning brought a brittle, grey ... constant reminder of the world beyond."
  • "A hush fell as Eleanor’s gaze ... on the clock in the lobby."
  • "Eleanor closed her notebook with a ... the attention of the assembled guests."
  • "Dr."
  • "Captain Ivor Hale straightened, his broad ... filling the space near the staircase."
  • "Beatrice Quill turned from the window, ... expression a careful study in distress."
  • "Sylvia Trent, pearls gleaming against her ... hands and offered a gentle smile."
  • "A brief silence followed, broken only ... war news somewhere behind closed doors."
  • "She crossed to the side table, ... petals faded to russet and gold."
  • "“You all seem certain of your whereabouts,” Eleanor said, her tone wry."
  • "Dr."
  • "Beatrice Quill let out a nervous laugh, the sound brittle."
  • "Sylvia Trent’s reply was smoother."
  • "Eleanor let the silence linger, watching as the group shifted uneasily."
  • "A sudden gust rattled the windowpanes, drawing everyone’s attention for a heartbeat."
  • "The hum of the radio drifted ... announcing news from the front lines."
  • "She turned her attention to the ... open beside a stack of telegrams."
  • "As Eleanor surveyed the room, she ... alliances and fractures among the guests."
  • "She let her gaze return to ... fixed at ten minutes past eleven."
  • "A moment of relief surfaced as ... the tension, offered a sardonic remark."
  • "Eleanor allowed herself a small, wry smile."
  • "The glow of table lamps pressed ... rain whispered against the tall windows."
  • "A soft melody drifted from the ... the tension that filled the room."
  • "“Thank you both for agreeing to ... more a shield than a greeting."
  • "Dr."
  • "Eleanor made a show of jotting ... but her gaze lingered on Dr."
  • "Dr."
  • "Captain Hale cleared his throat, straightening the lapels of his double-breasted suit."
  • "Dr."
  • "Eleanor studied her for a moment, ... closed her notebook with deliberate care."
  • "A hush fell, broken only by ... guests discussing the latest war news."
  • "“If you must know, I hardly slept last night."
  • "Captain Hale shifted, the leather of his chair creaking."
  • "Eleanor’s heart beat faster as she ... the growing pressure in the room."
  • "Captain Hale shook his head."
  • "Eleanor let the exchange hang, recording ... where a chime should have sounded."
  • "The fire crackled in the hearth, ... the room, but the tension remained."
  • "A brief moment of relief surfaced ... a broken clock and a murder."
  • "But as the laughter faded, Eleanor’s ... unwavering assertion of his own routine."
  • "The hours outside slipped toward dusk, ... rain lessening to a fine mist."
  • "As Eleanor made her way to ... lobby, her fingertips brushing the glass."
  • "The lounge behind her hummed with ... way to the greater storm within."
  • "As the last of the daylight ... that tapped at the tall windows."
  • "She glanced back toward the corridor, ... storm of nerves she’d left behind."
  • "“Thank you both for meeting me,” ... more for herself than her guests."
  • "Beatrice Quill was first to speak, ... tone pitched high, her gestures dramatic."
  • "Sylvia Trent’s reply was smoother, her words delivered with a practiced sweetness."
  • "Eleanor let the silence stretch, the ... occasional creak of the building settling."
  • "“The staff must be mistaken,” Beatrice ... trembling on the edge of indignation."
  • "Sylvia’s response was more measured, but no less defensive."
  • "Eleanor leaned back, her pen poised above the page."
  • "A sudden gust rattled the windows, drawing all three women’s attention."
  • "Beatrice’s voice broke the silence, brittle and high."
  • "Sylvia’s reaction was subtler, but no less telling."
  • "Eleanor returned to the table, her mind racing."
  • "A moment of relief surfaced as ... tension, let out a nervous laugh."
  • "Sylvia, not to be outdone, offered her own brand of reassurance."
  • "That detail shifted the reasoning."
  • "Eleanor closed her notebook, her thoughts in turmoil."
