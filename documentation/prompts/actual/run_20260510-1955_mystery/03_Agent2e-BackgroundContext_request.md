...
- Project ID: ``
- Timestamp: `2026-05-10T19:55:17.981Z`
...
Tone: Classic
Era decade: 1930s
Social norms: Great Depression impacting upper class lifestyles, class tensions evident in social interactions, rising concerns about fascism in Europe influencing local politics
Location description: A sprawling country estate featuring a grand entrance hall, multiple drawing rooms, and extensive gardens, surrounded by dense woodlands and rolling hills.
Institution type: Manor house
Weather: Overcast with intermittent rain, creating a damp and chilly environment.
Mood: Tense and secretive, with an air of suspicion among the household members.
Geographic isolation: Moderately isolated, with the nearest town several miles away, limiting immediate assistance.
Access control: staff-only areas such as the kitchen and servants' quarters, formal permissions required for access to private study, daily routines dictate access times for various areas
