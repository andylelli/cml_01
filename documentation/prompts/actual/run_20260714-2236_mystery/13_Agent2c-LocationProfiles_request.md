...
- Project ID: ``
- Timestamp: `2026-07-15T03:50:13.721Z`
...
- Era-authentic markers: radio broadcasting, early television sets, military radar, rationed wartime vehicles, post-war automobile boom, long-distance telephone calls, military encryption methods
- Tone: Classic
- No anachronisms
...
Description: An elegant seaside hotel built in the early 1920s, featuring Art Deco elements and a view of the ocean.
...
Setting constraints:
- Physical constraints: narrow hallways limiting access, staircase leading to a restricted rooftop terrace
- Geographic isolation: Located on a cliffside, the hotel is several miles from the nearest town, limiting outside assistance.
- Access control: staff-only areas such as the kitchen and supply rooms, guestroom access controlled by keycards
...
- Social norms: women entering the workforce, post-war trauma
