...
- Project ID: ``
- Timestamp: `2026-05-17T11:48:00.627Z`
...
• [clue_1] The clock in the library shows ten minutes past eleven when it is found stopped.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: This indicates the last recorded time before the clock stopped.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=5121; context=9377; dropped=[none]; truncated=[pronoun_accuracy, location_profiles, temporal_context]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The clock in the library shows ten minutes past eleven when it is found stopped. [clue_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: This indicates the last recorded time before the clock stopped.
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The stopped clock in the library, frozen at ten minutes past eleven."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the time of death to be around ten minutes past eleven."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Beatrice Quill stands frozen, her eyes red from crying."
      ]
    },
    ...
    "emotionalRegister": "A sense of foreboding hangs over the manor as a murder disrupts the facade of wealth.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 1: "The clock in the library shows ten minutes past eleven when it is found stopped." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
