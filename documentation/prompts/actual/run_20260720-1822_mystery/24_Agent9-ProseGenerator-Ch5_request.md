...
- Project ID: ``
- Timestamp: `2026-07-20T18:31:46.447Z`
...
The emotional stakes rise as deeper connections are exposed, complicating motives.
...
Rationale: The rising stakes and emotional turmoil necessitate a serious atmosphere.
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Ivor struggles with feelings of betrayal and the desire for revenge, battling his emotions while maintaining his heroic facade."
...
• [clue_7] eliminates, eleanor, voss, because, seen, conversing, finch, before, dinner
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: excludes, eleanor, voss, suspicion

• [clue_8] eliminates, captain, ivor, hale, because, kitchen, preparing, food
  Category: testimonial | Criticality: essential | Supports inference step 2
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_3, clue_4, clue_culprit_direct_hugo_vane, clue_5, clue_11, clue_12 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): finch, drinking, habits, dinner | contradicts, assumption, finch, health, issues | presence, toxic, substance | indicates, toxic, substance, involved | direct, shows, hugo, vane, means, opportunity | indicates, possible, foul, play | suggests, hugo, vane, potential, involvement, poisoning | indicates, hugo, vane, motive
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As Eleanor stepped into the corridor, the hush of the lounge receded behind her, replaced by the muffled sounds of the hotel returning to life. The investigation was far from over, but the boundaries had shifted once again. Outside, the rain continued its stea..."
...
Known location profile anchors: The Azure Crest Hotel, The Grand Lobby, The Dining Saloon, The Guest Rooms, The Library, the kitchen of the seaside hotel
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Azure Crest Hotel", "The Grand Lobby", "The Dining Saloon", "The Guest Rooms", "The Library", "the kitchen of the seaside hotel"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=14964; context=8757; dropped=[humour_guide, location_profiles, texture_pool, continuity_context]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 5:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As Eleanor stepped into the corridor, the hush of the lounge receded behind her, replaced by the muffled sounds of the hotel returning to life. The investigation was far from over, but the boundaries had shifted once aga...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • glass, shows, signs, tampering [clue_6]
...
Chapter 5 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The kitchen staff's corroboration of Ivor's alibi."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Ivor wipes his brow, trying to maintain his composure amidst the chaos."
      ]
    },
    ...
    "emotionalRegister": "The emotional stakes rise as deeper connections are exposed, complicating motives.",
