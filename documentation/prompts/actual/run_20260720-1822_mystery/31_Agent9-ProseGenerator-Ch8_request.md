...
- Project ID: ``
- Timestamp: `2026-07-20T18:35:37.143Z`
...
• [clue_late_optional_slot_1] dinner, party, time, remains, late, texture, detail, case, background
...
• [clue_mechanism_visibility_core] witnesses, recall, finch, frequently, asking, refills, dinner
  Category: testimonial | Criticality: essential | Supports inference step 1
  Points to: finch, drinking, habits, dinner
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_3, clue_4, clue_culprit_direct_hugo_vane, clue_5, clue_11, clue_12, clue_7, clue_8, clue_9, clue_10, clue_6, clue_culprit_direct_1 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): finch, drinking, habits, dinner | contradicts, assumption, finch, health, issues | presence, toxic, substance | indicates, toxic, substance, involved | direct, shows, hugo, vane, means, opportunity | indicates, possible, foul, play | suggests, hugo, vane, potential, involvement, poisoning | indicates, hugo, vane, motive | excludes, eleanor, voss, suspicion | excludes, captain, ivor, hale, suspicion | excludes, beatrice, quill, suspicion | excludes, sylvia, trent, suspicion | indicates, method, poisoning | physical, trace, opportunity, indicate, hugo, vane
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Eleanor gathered the glass and her notes, her hands steady now. The test had revealed much, but not enough. The truth hovered just out of reach, obscured by fog and fear. Yet for the first time, she felt the shape of the answer forming—a pattern emerging from..."
...
Manner of death (MUST be named in the reveal): state plainly how the victim died — cause of death: poisoned with a slow-acting toxin. Surface it in the prose in plain words (e.g. "poisoned with a slow-acting toxin") — not only how the clock/timeline was manipulated. A reveal that explains the concealment but never the killing fails the fair-play contract.
...
- Chapter 8:
  ...
  - ⚠ SUSPECT CLEARANCE REQUIRED (MANDATORY): each suspect below MUST be named explicitly and cleared with on-page evidence and a reasoning connector (because / therefore / which proves):
    • "Captain Ivor Hale": write a dedicated paragraph that (a) names Captain Ivor Hale explicitly, (b) states the clearance method ("Confirmed alibi in the bar during the time of death."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have". Cite clues: witness statements, bar tab records.
    • "Beatrice Quill": write a dedicated paragraph that (a) names Beatrice Quill explicitly, (b) states the clearance method ("Evidence shows the note was unrelated to the murder."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have". Cite clues: note analysis, witness statements.
    • "Sylvia Trent": write a dedicated paragraph that (a) names Sylvia Trent explicitly, (b) states the clearance method ("Witnesses confirm she was not in the dining area at the time."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have". Cite clues: witness accounts.
...
Chapter 8 (Act 3) completeness contract:
  ...
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Hugo is the only suspect left with access to the victim's drink."
...
[
  {
    ...
    "purpose": "Clear the remaining suspects based on evidence Suspects are systematically cleared: alibi confirmed for three suspects, ruled out by timeline evidence, leaving only the culprit identified by a complete evidence chain.",
    "cluesRevealed": [
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor takes a deep breath, steadying herself before addressing the suspects."
      ]
    },
    ...
    "emotionalRegister": "The truth is revealed in a confrontation that forces characters to face their demons.",
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 8: the clue [clue_mechanism_visibility_core] (witnesses, recall, finch, frequently, asking, refills, dinner) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
