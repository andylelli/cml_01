...
- Project ID: ``
- Timestamp: `2026-07-20T18:29:24.016Z`
...
- Eleanor Voss
  ...
  Connection to victim: Rivals in their professions, both vying for recognition.; Mallory and Eleanor often compete for the same stories, leading to a contentious dynamic..
  Investigation relevance: is actively driving interviews and credibility checks in this scene.
  Suspicion/pressure cue seed: Curious about the victim's health.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=7562; context=9324; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The overturned glass on the table, with a faint odor lingering in the air."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the victim died in the dining room, indicating foul play."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_1] Dr. Finch mentions that the victim had a heart condition, leading to speculation about a natural cause of death.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor glances nervously at the door, anticipating the detective's arrival."
      ]
    },
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_1",
      "placementDetail": "Dr. Finch mentions that the victim had a heart condition, leading to speculation about a natural cause of death."
    },
    "emotionalRegister": "The atmosphere is lively yet tinged with an undercurrent of tension as the guests enjoy their evening.",
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (witnesses, recall, finch, frequently, asking, refills, dinner) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
