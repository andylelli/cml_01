...
- Project ID: ``
- Timestamp: `2026-05-15T21:40:14.105Z`
...
Tone: Classic
Era decade: 1930s
Social norms: Great Depression creating economic hardship, class tensions evident among social strata, increasing fascist sentiments in Europe affecting local politics
Location description: A sprawling manor house set in the English countryside, characterized by its grand architecture, extensive gardens, and a labyrinth of rooms and halls that reflect the opulence of a bygone era.
Institution type: Country house estate
Weather: Overcast with intermittent rain, creating a gloomy ambiance.
Mood: Tense and foreboding, as underlying class tensions and personal secrets come to the fore.
Geographic isolation: The estate is located several miles from the nearest town, making outside help slow to arrive.
Access control: Certain areas of the manor are off-limits to staff and guests, such as the private study of the owner., Daily routines are established, with staff expected to follow strict schedules, limiting their availability.
