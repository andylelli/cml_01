...
- Project ID: ``
- Timestamp: `2026-05-17T08:44:43.815Z`
...
- Era-authentic markers: domestic wiring with frequent outages, typewriters standard in offices, early telephones in homes, radio broadcasts common, reliable petrol-powered automobiles, peak passenger train service, early commercial aviation, party-line telephone exchanges
- Tone: Classic
- No anachronisms
...
Description: A large, imposing country estate featuring grand architecture with expansive gardens and a secluded atmosphere.
...
Setting constraints:
- Physical constraints: multiple rooms with limited access depending on social hierarchy, walled gardens restricting movement, sudden weather changes affecting outdoor investigations
- Geographic isolation: Located several miles from the nearest town, limiting outside help and resources.
- Access control: restricted areas such as the library and study reserved for the family, guarded entrances with limited staff access, daily schedules dictating movement patterns of residents

Era constraints to include:
- Technology: domestic wiring with frequent outages, typewriters standard in offices, early telephones in homes
- Transportation: reliable petrol-powered automobiles, peak passenger train service
- Social norms: Great Depression impacting class dynamics, emerging tensions due to rising fascism
