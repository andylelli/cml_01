...
- Project ID: `unknown`
- Timestamp: `2026-05-17T22:17:56.114Z`
...
1. Generate a clue that makes the reader directly observe: "The clock in the study shows ten minutes to ten when the victim is found...."
   → observation | essential | early | temporal | step 1 | terms: clock, study, shows

2. Generate a clue that provides evidence for: "The time discrepancy suggests the clock may have been tampered with...."
   → contradiction | essential | early | temporal | step 1 | terms: discrepancy, suggests, clock

3. Generate a clue that makes the reader directly observe: "Witnesses recall seeing Captain Hale near the garden at nine o'clock...."
   → observation | essential | early | temporal | step 2 | terms: witnesses, recall, seeing

4. Generate a clue that provides evidence for: "He had the opportunity to tamper with the clock and was unaccounted for during the time of death...."
   → contradiction | essential | early | temporal | step 2 | terms: opportunity, tamper, clock

5. Generate a clue that makes the reader directly observe: "Footprints in the garden lead away from the scene but do not match Hale's shoes...."
   → observation | essential | mid | physical | step 3 | terms: footprints, garden, scene

6. Generate a clue that provides evidence for: "The footprints were likely staged to mislead the investigation...."
   → contradiction | essential | mid | physical | step 3 | terms: footprints, likely, staged

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The time discrepancy suggests the clock may have been tampered with...."
...
11. Generate a clue showing observable evidence of Captain Ivor Hale's premeditation or planning (Jealousy over the victim's father's favor). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: jealousy, victim's, father's
...
13. Generate one essential early or mid elimination clue that explicitly rules out Eleanor Voss and narrows the solution toward culprit Captain Ivor Hale. The pointsTo text must start with "Eliminates Eleanor Voss because ..." and cite corroborated evidence.
...
Objects: The tampered clock, The garden path

## Physical Evidence
- Scratches on the clock's mechanism indicate tampering.

## Evidence-Sensitive Characters
- Eleanor Voss: sensitive items: guestbook entries, garden footprints
- Dr. Mallory Finch: sensitive items: medical records
- Captain Ivor Hale: sensitive items: witness statements
- Beatrice Quill: sensitive items: investigation reports
...
Create 2 red herrings that support the false assumption: "The murder occurred after the clock showed ten minutes to ten."
...
Violations: 1. [critical] Inference Path Coverage: Discriminating test evidence_clues reference missing clue id(s): clue_clock_tampering, clue_witness_statements, clue_footprint_analysis; 2. [critical] Inference Path Coverage: Discriminating test references no evidence found in the clue set
Warnings: Inference step 2 has no contradiction clue
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Inference Path Coverage: Discriminating test evidence_clues reference missing clue id(s): clue_clock_tampering, clue_witness_statements, clue_footprint_analysis
  - [critical] Inference Path Coverage: Discriminating test references no evidence found in the clue set
  - [warning] Inference step 2 has no contradiction clue
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
...
- required_id_to_source_mappings[]:
  ...
  - clue_footprint_analysis -> CASE.discriminating_test.evidence_clues[2]
...
- required_direct_culprit_clue:
  ...
  - allowed_source_paths=CASE.cast[2].access_plausibility, CASE.cast[2].alibi_window, CASE.cast[2].evidence_sensitivity[0], CASE.inference_path.steps[0].observation, CASE.inference_path.steps[0].correction
