...
- Timestamp: `2026-04-24T20:51:36.519Z`
...
Violations: 1. [critical] Deterministic Guardrail: Essential clue count 0 is below required minimum 3; 2. [critical] Deterministic Guardrail: Early clue count 0 is below required minimum 2; 3. [critical] Deterministic Guardrail: Mid clue count 0 is below required minimum 2
Warnings: Late clue count 0 is below preferred minimum 1
Recommendations: Move essential clues to early/mid placement; Avoid private/detective-only clue phrasing; Ensure clue IDs are unique and timeline is balanced; Strict first-attempt contracts are active: apply strict source whitelist and required ID->source mappings exactly.; If any strict contract cannot be satisfied, return status=fail with unresolved blockers in audit.invalidSourcePaths.; Do not defer strict mapping and direct culprit evidence requirements to retry mode.
...
- Fix these unresolved targets first:
  - [critical] Deterministic Guardrail: Essential clue count 0 is below required minimum 3
  - [critical] Deterministic Guardrail: Early clue count 0 is below required minimum 2
  - [critical] Deterministic Guardrail: Mid clue count 0 is below required minimum 2
