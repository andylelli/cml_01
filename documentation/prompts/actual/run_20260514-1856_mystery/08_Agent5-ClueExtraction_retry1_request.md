...
- Project ID: `unknown`
- Timestamp: `2026-05-14T18:59:20.035Z`
...
1. Generate a clue that makes the reader directly observe: "The clock in the central hall shows an incorrect time...."
   → observation | essential | early | temporal | step 1 | terms: clock, central, shows

2. Generate a clue that provides evidence for: "The clock being wrong suggests it may have been tampered with...."
   → contradiction | essential | early | temporal | step 1 | terms: clock, being, wrong

3. Generate a clue that makes the reader directly observe: "Dr. Mallory Finch was seen near the clock shortly before the murder...."
   → observation | essential | early | temporal | step 2 | terms: mallory, finch, clock

4. Generate a clue that provides evidence for: "His presence near the clock indicates he had the opportunity to tamper with it...."
   → contradiction | essential | early | temporal | step 2 | terms: presence, clock, indicates

5. Generate a clue that makes the reader directly observe: "The winding key for the clock was found in Captain Ivor Hale's possession...."
   → observation | essential | mid | temporal | step 3 | terms: winding, clock, found

6. Generate a clue that provides evidence for: "The discovery of the key suggests he may have tampered with the clock...."
   → contradiction | essential | mid | temporal | step 3 | terms: discovery, suggests, tampered

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The clock being wrong suggests it may have been tampered with...."
   → contradiction | essential | mid | temporal | step 1 | terms: clock, being, wrong

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The clock in the central hall was tampered with to show an incorrect time, misleading witnesses about the timeline of events...."
   → observation | essential | early | temporal | terms: clock, central, tampered

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "The discriminating test compares clock, central, and incorrect against the claimed timeline...."
...
10. Generate one essential mid-story clue whose description or pointsTo explicitly names Captain Ivor Hale and states the unique trace, preparation detail, or mechanism link that points to Captain Ivor Hale rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Captain Ivor Hale, clock, central, tampered

11. Generate a clue showing observable evidence of Captain Ivor Hale's premeditation or planning (Desperation to resolve financial issues.). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: desperation, resolve, financial
...
Create 2 red herrings that support the false assumption: "The murder occurred after the clock struck the hour."
...
- required_direct_culprit_clue:
  ...
  - allowed_source_paths=CASE.cast[2].access_plausibility, CASE.cast[2].alibi_window, CASE.cast[2].evidence_sensitivity[0], CASE.inference_path.steps[1].observation, CASE.inference_path.steps[1].correction, CASE.inference_path.steps[2].observation, CASE.inference_path.steps[2].correction
