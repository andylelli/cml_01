...
- Project ID: ``
- Timestamp: `2026-05-13T19:03:57.271Z`
...
• [clue_1] The clock in the study shows ten minutes past ten, but is found stopped.
...
Known location profile anchors: Little Middleton Manor, The Library, The Drawing Room, The Servants' Hall, the study of Eleanor Voss
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The Library", "The Drawing Room", "The Servants' Hall", "the study of Eleanor Voss"
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=5212; context=10167; dropped=[none]; truncated=[location_profiles, temporal_context]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The clock in the study shows ten minutes past ten, but is found stopped. [clue_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: This indicates a discrepancy in the timeline of events.
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The clock in the study shows ten minutes past ten, but is found stopped."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the victim died no later than ten minutes past ten, contradicting three suspects' alibis."
...
[
  {
    ...
    "dramaticElements": {
      "conflict": "A locked room mystery is established with every suspect present.",
      "tension": "Each character seems to hide something as they await the detective.",
      "microMomentBeats": [
        "Eleanor glances nervously at the clock, as if it holds the answers."
      ]
    },
    "summary": "In the dim light of the study, the group gathers around the lifeless body, their expressions a mixture of shock and fear. Eleanor Voss, the host, struggles to maintain her composure as Dr. Finch examines the scene, while Beatrice and Captain Hale exchange uneasy glances.",
    "estimatedWordCount": 1800,
    "pivotElement": "The clock in the study shows ten minutes past ten, but is found stopped.",
    ...
    "emotionalRegister": "A festive atmosphere masks the underlying tension among the guests.",
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 1: "The clock in the study shows ten minutes past ten, but is found stopped." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
