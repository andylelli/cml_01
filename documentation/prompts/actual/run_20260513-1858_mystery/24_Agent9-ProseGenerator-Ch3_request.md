...
- Project ID: ``
- Timestamp: `2026-05-13T19:05:06.057Z`
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=8022; context=11141; dropped=[none]; truncated=[location_profiles, temporal_context]
...
- Template linter: high n-gram overlap detected (0.92 >= 0.80). Rephrase this passage to avoid template leakage.
