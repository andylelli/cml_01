...
- Project ID: `unknown`
- Timestamp: `2026-05-13T19:00:06.848Z`
...
Violations: 1. [critical] Suspect Clue Coverage: Beatrice Quill is referenced but lacks elimination/alibi evidence.
Warnings: None
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Suspect Clue Coverage: Beatrice Quill is referenced but lacks elimination/alibi evidence.
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
