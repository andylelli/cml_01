...
- Project ID: ``
- Timestamp: `2026-07-16T21:03:25.553Z`
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "A gust of wind rattled the window, and the fire flared, sending a brief wave of warmth through the library. For a heartbeat, the tension eased, and Eleanor allowed herself a dry, almost wry thought: in a world so full of contradictions, perhaps even the clocks..."
...
Known location profile anchors: The Grand Seaside Hotel, Oceanfront Balcony, The Reading Room, The Grand Dining Room, Hotel garden
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Grand Seaside Hotel", "Oceanfront Balcony", "The Reading Room", "The Grand Dining Room", "Hotel garden"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 7: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "Hotel garden". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Chapter 6 (score 96/100):
  Quality gaps noted: scene grounding weakness
  Address in upcoming chapters: Open next chapter with a named location anchor plus at least two sensory cues and one atmosphere marker.
- Phrases to avoid (already overused in earlier chapters): "dinner was announced at half past eight", "once i didn t see mr vane", "didn t see mr vane after dinner", "t see mr vane after dinner began".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=20781; context=4320; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 7:
  ...
  - Scene is set in: Hotel garden — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "A gust of wind rattled the window, and the fire flared, sending a brief wave of warmth through the library. For a heartbeat, the tension eased, and Eleanor allowed herself a dry, almost wry thought: in a world so full of...".
...
Chapter 7 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Dr. Finch's admission of her fear of losing the grant."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Dr. Finch's ambition may have led her to consider drastic actions regarding Hugo."
...
[
  {
    ...
    "setting": {
      ...
      "atmosphere": "Quiet and tense, with shadows lurking"
    },
    "characters": [
      "Eleanor Voss",
      "Dr. Mallory Finch",
    ...
    "dramaticElements": {
      ...
      "tension": "Eleanor confronts Dr. Finch about her past",
      "microMomentBeats": [
        "Eleanor feels a pang of sympathy for Dr. Finch, sensing her desperation."
      ]
    },
    "summary": "Eleanor confronts Dr. Finch about her past and the lies she has told. The tension escalates as Eleanor realizes that these secrets are intertwined with the case.",
    "beat": "secrets",
    "estimatedWordCount": 1250,
    "pivotElement": "Dr. Finch's admission of her fear of losing the grant.",
    "factEstablished": "Establishes that Dr. Finch's ambition may have led her to consider drastic actions regarding Hugo.",
    ...
    "emotionalRegister": "Tension reaches a peak, culminating in confrontations fueled by hidden truths.",
