...
- Project ID: ``
- Timestamp: `2026-07-16T21:03:02.479Z`
...
• [clue_11] mallory, finch, uniquely, means, rewind, clock
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: mallory, finch, knowledge, makes, prime, suspect

• [clue_13] mallory, finch, shows, signs, nervousness, questioned, clock
  Category: behavioral | Criticality: essential | Supports inference step 3
  Points to: mallory, finch, demeanor, raises, suspicion, involvement
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "A moment of uneasy quiet followed, broken only by the persistent ticking of the bar’s old wall clock and the distant sound of rain against the glass. The investigation had shifted again: one suspect cleared, the circle drawn tighter. Eleanor felt the weight of..."
...
Known location profile anchors: The Grand Seaside Hotel, Oceanfront Balcony, The Reading Room, The Grand Dining Room, Hotel library
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Grand Seaside Hotel", "Oceanfront Balcony", "The Reading Room", "The Grand Dining Room", "Hotel library"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 6: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with an expository setup — e.g. "It was not until…" / "There had been no word since…" / "There was a note on the table…". Begin with "It was", "There was", or "There had been" followed immediately by a specific condition, event, or discovery. Do not open on generic mood alone — but still anchor the location and weave in the sensory + time-of-day grounding across the next sentence or two. Anchor opening in "Hotel library". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=19318; context=4262; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_mid_1 must appear in Act 2, Scene 3 via Witness account
...
- Chapter 6:
  ...
  - Scene is set in: Hotel library — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "A moment of uneasy quiet followed, broken only by the persistent ticking of the bar’s old wall clock and the distant sound of rain against the glass. The investigation had shifted again: one suspect cleared, the circle d...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • mallory, finch, known, expertise, clock, mechanisms [clue_11]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • mallory, finch, fidgets, avoids, contact, questioning [clue_13]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • witnesses, confirm, seeing, mallory, finch, vicinity, clock [clue_7]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    ...
    • clock, room, shows, minutes, past, nine [clue_culprit_direct_1]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
  ...
  - Sensory obligation — use at least two of: warm glow from lamps, shadows elongating across the floor | soft laughter from the dining room, the crackle of the fire | scent of burning logs. Mood: comforting warmth.
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The realization that Beatrice's motive, while strong, does not align with the timing of the murder."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that while Beatrice had a motive, the timing of her alibi contradicts her involvement."
...
[
  {
    ...
    "setting": {
      ...
      "timeOfDay": "Night",
      "atmosphere": "Quiet, with an air of tension as secrets unfold"
    },
    "characters": [
      "Eleanor Voss",
      "Captain Ivor Hale",
    ...
    "purpose": "Introduce a misleading theory",
    "cluesRevealed": [
      "clue_11",
      "clue_13"
    ],
    "dramaticElements": {
      "conflict": "A convincing but incorrect theory emerges",
      "tension": "Eleanor feels the pressure as she considers the implications",
      "microMomentBeats": [
        "Eleanor recalls a time when Hugo confided in her, deepening her resolve."
      ]
    },
    "summary": "Eleanor theorizes a false solution, implicating Beatrice Quill based on her jealousy toward Hugo. However, she notices a flaw in the theory that keeps her from fully committing to it.",
    "beat": "false_solution",
    "estimatedWordCount": 1250,
    "pivotElement": "The realization that Beatrice's motive, while strong, does not align with the timing of the murder.",
    "factEstablished": "Establishes that while Beatrice had a motive, the timing of her alibi contradicts her involvement.",
    ...
    "emotionalRegister": "The stakes rise as personal motives are revealed, complicating relationships.",
