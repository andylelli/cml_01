...
- Project ID: `unknown`
- Timestamp: `2026-07-16T20:59:05.833Z`
...
**Era & Setting**: 1940s - a grand seaside hotel built in the early 1900s
**Setting Lock**: All scenes must remain within this setting: a grand seaside hotel built in the early 1900s. Do not move to a different location type.
...
Hugo Vane was murdered shortly before dinner, as indicated by the clock.
*Revealed: final act*
...
### Early Clues (Act I)
- [clue_mechanism_visibility_core] temporal: A clock was rewound to misrepresent the time of death.
- [clue_core_contradiction_chain] temporal: The clock has been tampered with to mislead the time of death.
- [clue_3] physical: A handkerchief with Hugo's blood is found near the rewound clock.
- [clue_4] temporal: The handkerchief's location indicates a struggle occurred near the clock.
...
- [clue_early_1] temporal: A clock was rewound to misrepresent the time of death.
- [clue_mid_2] physical: A handkerchief with Hugo's blood is found near the rewound clock.
- [clue_late_1] temporal: The handkerchief's location indicates a struggle occurred near the clock.

### Mid Clues (Act II)
- [clue_5] temporal: Witnesses report hearing a ticking sound shortly before the body was discovered.
- [clue_6] temporal: The ticking sound implies the clock was recently tampered with.
- [clue_7] testimonial: Dr. Mallory Finch was seen near the clock shortly before the murder.
- [clue_core_elimination_chain] testimonial: Eliminates Captain Ivor Hale because he was at the bar during the time of the murder.
- [clue_9] testimonial: Eliminates Beatrice Quill because she was attending a dinner party across town.
- [clue_11] temporal: Dr. Mallory Finch uniquely had the means to rewind the clock.
- [clue_13] behavioral: Dr. Mallory Finch shows signs of nervousness when questioned about the clock.
...
- [clue_mid_1] temporal: The ticking sound implies the clock was recently tampered with.

### Late Clues (Act III)
- [clue_late_optional_slot_1] temporal: Dinner started at half past eight remains a late texture detail in the case background.
...
- **Captain Ivor Hale**: Act 3, Scene 5
  - Method: Witnesses confirm he was at the bar during the time of death
  - Clues: clue_early_1, clue_mid_2
- **Beatrice Quill**: Act 3, Scene 5
  - Method: Evidence shows she was not in the vicinity at the time
  - Clues: clue_mid_2, clue_late_1
- **Sylvia Trent**: Act 3, Scene 5
  - Method: Alibi confirmed: 8:45 PM - 9:15 PM
- **Hugo Vane**: Act 3, Scene 5
  - Method: Alibi confirmed: evening

### Culprit Revelation Scene (REQUIRED)
- **Must appear in:** Act 3, Scene 6
- **Revelation method:** Confrontation with evidence linking the tampering to the culprit
...
- **rewound_time**: "ten minutes past nine" — The time displayed on the tampered clock at the moment of discovery.
- **dinner_start_time**: "half past eight" — The actual start time of the dinner event, conflicting with the clock's display.


## PILLAR 4 — OUTLINE COMPLETENESS CONTRACT DATA

### Character Permitted Behaviours (use for permittedBehavioursByAct per scene)
- **Eleanor Voss**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Drawn to investigate her friend’s suspicious death while visiting the hotel to cover a story." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Eleanor grapples with feelings of inadequacy, torn between her professional ambitions and the emotional turmoil at home." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Dr. Mallory Finch**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Dr. Finch feared losing a prestigious grant that was promised to the victim." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Dr. Finch wrestles with the dark shadows of her ambition, fearing that her envy may lead her to ruin." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Captain Ivor Hale**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Believed the victim was undermining his efforts to fund veterans' programs." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Captain Hale grapples with the ghosts of his past, fearing that his PTSD will compromise his capacity to help others." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Beatrice Quill**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Was in a secret relationship with a colleague who got rejected by the victim." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Beatrice struggles with the balance between her job security and the resentment she feels towards the victim, torn between ambition and morality." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Sylvia Trent**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Desperately wanted the victim's advertising contract for a major client." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Sylvia grapples with the moral implications of her past actions, questioning whether her ambition is worth the cost." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Hugo Vane**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Hugo was about to lose the family hotel if the victim exposed his financial troubles." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Hugo is tormented by the fear of losing everything he has worked for and the shame of his financial failures." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
