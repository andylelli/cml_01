...
- Project ID: ``
- Timestamp: `2026-07-16T21:02:09.762Z`
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Sylvia grapples with the moral implications of her past actions, questioning whether her ambition is worth the cost."
...
• [clue_5] witnesses, report, hearing, ticking, sound, shortly, before, body, discovered
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: ticking, noise, indicates, clock, recent, manipulation

• [clue_6] ticking, sound, implies, clock, recently, tampered
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: timing, ticking, sound, raises, suspicion, clock, integrity

• [clue_7] mallory, finch, seen, near, clock, shortly, before, murder
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: mallory, finch, presence, near, clock, raises, suspicion
...
CLUES ALREADY REVEALED TO READER: clue_early_1, clue_mid_2, clue_late_1, clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_3, clue_4, clue_culprit_direct_dr_mallory_finch — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): clock, tampered, mislead, time, death | handkerchief, location, suggests, violent, encounter | struggle, location, provides, insight, events, leading | clock, tampered, mislead, time, death | clock, tampering, indicates, deliberate, attempt, mislead | handkerchief, location, suggests, violent, encounter | struggle, location, provides, insight, events, leading | direct, shows, mallory, finch, means, opportunity
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the drizzle outside thickened, the lobby’s lamplight flickered over the brass clock and the bloodied handkerchief. Eleanor’s mind churned with contradictions—times that did not agree, stories that did not fit—and the sure knowledge that the next revelation..."
...
Known location profile anchors: The Grand Seaside Hotel, Oceanfront Balcony, The Reading Room, The Grand Dining Room, Hotel dining room
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Grand Seaside Hotel", "Oceanfront Balcony", "The Reading Room", "The Grand Dining Room", "Hotel dining room"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 4: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a noun-phrase atmosphere — e.g. "The smell of damp stone in the cellar…" / "A chill from the landing…" / "The sound of the clock in the hall…". Pattern: "The/A [noun] of/in/from [place]…". Anchor opening in "Hotel dining room". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=13988; context=8013; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 4:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the drizzle outside thickened, the lobby’s lamplight flickered over the brass clock and the bloodied handkerchief. Eleanor’s mind churned with contradictions—times that did not agree, stories that did not fit—and the...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • several, witnesses, mention, ticking, noise, prior, discovery [clue_5]
      Points to: ticking, noise, indicates, clock, recent, manipulation
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The revelation that Dr. Mallory Finch had a significant motive tied to a grant."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Dr. Mallory Finch had a motive related to a prestigious grant that Hugo controlled."
...
[
  {
    ...
    "setting": {
      ...
      "timeOfDay": "Afternoon",
      "atmosphere": "Tense, with whispers of suspicion in the air"
    },
    "characters": [
      "Eleanor Voss",
      "Captain Ivor Hale",
    ...
    "dramaticElements": {
      "conflict": "Suspects' motives are revealed, leading to accusations",
      "tension": "The atmosphere thickens as Eleanor connects the dots",
      "microMomentBeats": [
        "Eleanor reflects on her own past with Hugo, feeling the weight of their history."
      ]
    },
    "summary": "Eleanor gathers the suspects in the dining room to discuss their motives. Tensions rise as accusations fly, and Eleanor begins to connect the dots between their motives and the murder.",
    "beat": "motives",
    "estimatedWordCount": 1250,
    "pivotElement": "The revelation that Dr. Mallory Finch had a significant motive tied to a grant.",
    "factEstablished": "Establishes that Dr. Mallory Finch had a motive related to a prestigious grant that Hugo controlled.",
    ...
    "emotionalRegister": "A false lead creates anxiety, pushing Eleanor into a deeper investigation.",
