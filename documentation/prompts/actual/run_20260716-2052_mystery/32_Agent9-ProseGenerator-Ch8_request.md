...
- Project ID: ``
- Timestamp: `2026-07-16T21:03:53.824Z`
...
• [clue_late_optional_slot_1] dinner, started, half, past, eight, remains, late, texture, detail, case, background
...
Render this test MECHANISM as live, in-scene action and dialogue, composing ENTIRELY in your own words from these elements (reproducing any briefing phrase verbatim FAILS validation): eleanor, voss, compare, clock, tampering, alibis, suspects, dinner
...
- Chapter 7 (score 96/100):
  Quality gaps noted: scene grounding weakness
  Address in upcoming chapters: Open next chapter with a named location anchor plus at least two sensory cues and one atmosphere marker.
- Phrases to avoid (already overused in earlier chapters): "dinner was announced at half past eight", "the clock in hugo vane s room", "once i didn t see mr vane", "didn t see mr vane after dinner", "t see mr vane after dinner began".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=24485; context=5202; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 8:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Eleanor nodded, the garden’s darkness pressing in. The investigation had shifted again: one suspect eliminated, another’s motives laid bare. The answer, she sensed, was waiting—silent, patient, and as relentless as the t...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • dinner, started, half, past, eight, remains, late, texture, detail, case, background [clue_late_optional_slot_1]
      Points to: adds, late, texture, changing, essential, deduction, chain
  ...
  - ⚠ SUSPECT CLEARANCE REQUIRED (MANDATORY): each suspect below MUST be named explicitly and cleared with on-page evidence and a reasoning connector (because / therefore / which proves):
    • "Captain Ivor Hale": write a dedicated paragraph that (a) names Captain Ivor Hale explicitly, (b) states the clearance method ("Witnesses confirm he was at the bar during the time of death"), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have". Cite clues: clue_early_1, clue_mid_2.
    • "Beatrice Quill": write a dedicated paragraph that (a) names Beatrice Quill explicitly, (b) states the clearance method ("Evidence shows she was not in the vicinity at the time"), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have". Cite clues: clue_mid_2, clue_late_1.
    • "Sylvia Trent": write a dedicated paragraph that (a) names Sylvia Trent explicitly, (b) states the clearance method ("Alibi confirmed: 8:45 PM - 9:15 PM"), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
  ...
  - ⚠ DISCRIMINATING TEST (trap) — MANDATORY real-time scene with dialogue and confrontation. DO NOT summarize it after the fact.
    ...
    Elements the test must dramatize (compose the scene ENTIRELY in your own sentences from these — reproducing any briefing phrase verbatim FAILS validation): eleanor, voss, compare, clock, tampering, alibis, suspects, dinner
    Cite these already-revealed clue IDs during the test: clue_core_contradiction_chain, clue_6, clue_mechanism_visibility_core, clue_early_1
...
Chapter 8 (Act 3) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The tampered clock that reveals the true time of death."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the tampering of the clock directly links Dr. Mallory Finch to the murder."
...
[
  {
    ...
    "setting": {
      ...
      "timeOfDay": "Evening",
      "atmosphere": "Electric with anticipation as suspects gather"
    },
    "characters": [
      "Eleanor Voss",
      "Dr. Mallory Finch",
    ...
    "dramaticElements": {
      "conflict": "Eleanor sets a trap to reveal the culprit",
      "tension": "The stakes are high as the truth hangs in the balance",
      "microMomentBeats": [
        "Eleanor feels the weight of responsibility as she prepares to confront the suspects."
      ]
    },
    "summary": "Eleanor gathers all the suspects in the ballroom, preparing to reveal her findings. She presents the evidence of the clock's tampering and how it implicates Dr. Finch.",
    "beat": "final_trap",
    "estimatedWordCount": 1250,
    "pivotElement": "The tampered clock that reveals the true time of death.",
    "factEstablished": "Establishes that the tampering of the clock directly links Dr. Mallory Finch to the murder.",
    ...
    "emotionalRegister": "The culmination of pressures leads to a dramatic unveiling of the murderer.",
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 8: the clue [clue_core_contradiction_chain] (clock, tampered, mislead, time, death) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
