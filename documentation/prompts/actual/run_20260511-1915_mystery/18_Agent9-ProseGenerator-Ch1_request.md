...
- Project ID: ``
- Timestamp: `2026-05-11T19:20:26.003Z`
...
• [clue_mechanism_visibility_core] The clock shows ten minutes past eleven at the time of Eleanor's discovery.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: Establishes the time of discovery.
...
Known location profile anchors: Little Middleton Manor, The Library, The Study, The Servants' Hall, the library of the Hale residence
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Little Middleton Manor", "The Library", "The Study", "The Servants' Hall", "the library of the Hale residence"
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=5060; context=8981; dropped=[none]; truncated=[location_profiles, temporal_context]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The clock shows ten minutes past eleven at the time of Eleanor's discovery. [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: Establishes the time of discovery.
  ...
  - Sensory obligation — use at least two of: Rain-streaked windows blur the view of the gardens outside, where droplets cling to petals like pearls., The grey light filtering through the glass adds a ghostly quality to the room, casting elongated shadows. | The steady drumming of rain on the roof creates a soothing yet oppressive soundscape, wrapping the library in a cocoon of isolation., Occasional thunder rumbles in the distance, a stark reminder of the tempest brewing outside. | The scent of damp earth permeates the air, mingling with the musty aroma of the books, creating a heady mixture.. Mood: oppressive.
...
[
  {
    ...
    "dramaticElements": {
      "conflict": "The household is in disarray after the shocking discovery.",
      "tension": "Each character's demeanor hints at hidden secrets.",
      "microMomentBeats": [
        "Eleanor glances at the clock, its hands frozen at ten minutes past eleven."
      ]
    },
    "summary": "Eleanor Voss arrives at the Hale residence to find the captain Hale in a state of distress. A body is discovered in the library, and the clock shows ten minutes past eleven, suggesting something is amiss. The tension in the room is palpable as the household grapples with the shock of the murder.",
    "estimatedWordCount": 1800,
    "emotionalRegister": "A facade of happiness masks deep-rooted familial tensions.",
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 1: "The clock shows ten minutes past eleven at the time of Eleanor's discovery." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
