...
- Project ID: ``
- Timestamp: `2026-05-14T18:47:25.980Z`
...
- Era-authentic markers: petrol-driven automobiles, domestic telephones, typewriters, reliable automobiles, passenger trains, early commercial aviation, telephone communication, telegram services
- Tone: Classic
- No anachronisms
...
Description: A large, isolated manor house set within expansive grounds, featuring gardens and possibly a small wood.
...
Setting constraints:
- Physical constraints: layout restricts movement to main corridors, formal rooms are off-limits to staff, weather can impede outdoor access
- Geographic isolation: The estate is located several miles from the nearest town, limiting outside assistance.
- Access control: restricted access to the upper floors, staff only allowed in service areas, formal permission required to enter the study

Era constraints to include:
- Technology: petrol-driven automobiles, domestic telephones, typewriters
- Transportation: reliable automobiles, passenger trains
- Social norms: Great Depression impact on class structure, rising tensions between social classes
