...
- Project ID: ``
- Timestamp: `2026-07-15T21:22:09.382Z`
...
• [clue_4] fingerprints, mirror, indicated, recent, handling
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: culprit, handled, mirror, right, before, murder

• [clue_6] eliminates, eleanor, voss, because, seen, nearby, time, murder
...
• [clue_8] eliminates, sylvia, trent, because, attending, meeting, time, murder
  Category: elimination | Criticality: essential | Supports inference step 2
  Points to: eliminates, sylvia, trent, suspect

• [clue_9] eliminates, hugo, vane, because, seen, leaving, party, time, murder
  Category: elimination | Criticality: essential | Supports inference step 2
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_early_1, clue_fp_contradiction_step_1, clue_core_contradiction_chain, clue_mid_2, clue_fp_contradiction_step_2, clue_3, clue_5, clue_culprit_direct_beatrice_quill, clue_12, clue_11, clue_fp_elimination_sylvia_trent, clue_mid_1 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): mechanism, murder, involved, deception, reflection | mechanism, murder, involved, deception, reflection | indicates, person, appeared | indicates, person, appeared | movement, mirror, suggests, intentional, obstruction, sightlines | movement, mirror, suggests, intentional, obstruction, sightlines | movement, mirror, suggests, intentional, obstruction, sightlines | indicates, person, appeared | direct, shows, beatrice, quill, means, opportunity | indicates, beatrice, quill, possible, motive | indicates, disturbance, occurred, before, murder | eliminates, sylvia, trent, because, independent, corroboration | physical, trace, opportunity, indicate, beatrice, quill
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the rain tapered off and the dining room emptied, Eleanor gathered her notes and slipped the mysterious letter into her handbag. The shadows in the hotel seemed deeper now, the secrets more tightly wound. She knew the next step would require more than caref..."
...
Known location profile anchors: The Coastal Mirage Hotel, The Guest Room - 214, The Grand Lobby, The Staff Quarters, The Dining Room, the hotel bar
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Coastal Mirage Hotel", "The Guest Room - 214", "The Grand Lobby", "The Staff Quarters", "The Dining Room", "the hotel bar"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=16197; context=7575; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_6 must appear in Act 2, Scene 2 via Direct observation
...
- Chapter 5:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the rain tapered off and the dining room emptied, Eleanor gathered her notes and slipped the mysterious letter into her handbag. The shadows in the hotel seemed deeper now, the secrets more tightly wound. She knew the...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • witnesses, confirming, eleanor, voss, presence [clue_6]
      Points to: eliminates, eleanor, voss, suspect
...
Chapter 5 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The realization that Beatrice's alibi is missing."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Beatrice's alibi is unverified, increasing suspicion towards her."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor takes a deep breath, steeling herself for the next round of questioning."
      ]
    },
    ...
    "emotionalRegister": "A critical discovery alters Eleanor's understanding of the case, deepening the intrigue.",
