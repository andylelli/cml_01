...
- Project ID: ``
- Timestamp: `2026-07-15T21:21:33.726Z`
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Haunted by her recent divorce, Eleanor fears that her inadequacies may prevent her from succeeding in both love and her career."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Ivor grapples with the ghosts of his past, torn between the hero he was and the man he has become, fearing that his reputation is built on shaky ground."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Sylvia grapples with her extravagant lifestyle and the reality of her financial situation, torn between maintaining her image and facing the truth about her debts."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Hugo struggles with his feelings of inadequacy and jealousy, torn between his ambition and the ethical dilemmas of his profession."
...
• [clue_12] beatrice, quill, known, jealous, finch, success
  Category: behavioral | Criticality: essential | Supports inference step 3
  Points to: indicates, beatrice, quill, possible, motive

• [clue_11] witnesses, reported, hearing, loud, crash, shortly, before, murder
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: indicates, disturbance, occurred, before, murder

• [clue_fp_elimination_sylvia_trent] unknown
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: eliminates, sylvia, trent, because, independent, corroboration, places, away, decisive, mechanism, window

• [clue_mid_1] direct, links, beatrice, quill, mechanism, access, point, before, discriminating, excludes, competing, suspect
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_early_1, clue_fp_contradiction_step_1, clue_core_contradiction_chain, clue_mid_2, clue_fp_contradiction_step_2, clue_3, clue_5, clue_culprit_direct_beatrice_quill — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): mechanism, murder, involved, deception, reflection | mechanism, murder, involved, deception, reflection | indicates, person, appeared | indicates, person, appeared | movement, mirror, suggests, intentional, obstruction, sightlines | movement, mirror, suggests, intentional, obstruction, sightlines | movement, mirror, suggests, intentional, obstruction, sightlines | indicates, person, appeared | direct, shows, beatrice, quill, means, opportunity
...
Known location profile anchors: The Coastal Mirage Hotel, The Guest Room - 214, The Grand Lobby, The Staff Quarters, The Dining Room, the hotel dining room
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Coastal Mirage Hotel", "The Guest Room - 214", "The Grand Lobby", "The Staff Quarters", "The Dining Room", "the hotel dining room"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=13936; context=7502; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 4:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the rain began to patter softly against the window, Eleanor resolved to press further. The shadows in Dr. Finch’s hotel room were deepening, and with them, the sense that the truth was close—just out of sight, waiting...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • visible, fingerprints, surface, mirror [clue_4]
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The revelation of Beatrice's jealousy towards Finch."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes multiple motives that could point to different suspects."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_2] Eleanor finds a note in Dr. Finch's pocket indicating a meeting with a mysterious figure — misleading about the nature of the murder.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor watches the suspects, her heart racing as she senses hidden tensions."
      ]
    },
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_2",
      "placementDetail": "Eleanor finds a note in Dr. Finch's pocket indicating a meeting with a mysterious figure — misleading about the nature of the murder."
    },
    "emotionalRegister": "A pivotal moment of revelation forces the investigation to shift focus.",
