...
- Project ID: ``
- Timestamp: `2026-07-19T09:54:15.173Z`
...
- Eleanor Voss
  ...
  Connection to victim: Eleanor is curious about Dr. Finch's past with the victim.; Eleanor and Dr. Finch met during a writing workshop and share a mutual respect..
  Investigation relevance: is actively driving interviews and credibility checks in this scene.
  Suspicion/pressure cue seed: Attention to detail.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Captain Ivor Hale
  Public identity anchor: Retired Naval Officer; suspect 
  Connection to victim: Dr. Finch and Captain Hale have a tense professional relationship.; They both served on the board of a local charity but often disagreed on its direction..
  Investigation relevance: access plausibility: medium | alibi window: around the time of the murder | opportunity channel: Staff access to the kitchen.
  Suspicion/pressure cue seed: Restlessness.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Beatrice Quill
  Public identity anchor: Hotel Receptionist; suspect 
  Connection to victim: Dr. Finch has advised Beatrice on her mental health struggles.; They often chat during Beatrice's breaks at the hotel..
  Investigation relevance: access plausibility: high | alibi window: during the dinner | opportunity channel: Access to the victim's room.
  Suspicion/pressure cue seed: Emotional outbursts.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.
...
• [clue_mechanism_visibility_core] poison, absorbed, skin, contact, mechanism, activated, combined, specific, natural, coastal, plant
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: core, mechanism, poisoning, linked

• [clue_mid_1] witnesses, recall, finch, complaining, unusual, rash, using, beach
...
Known location profile anchors: The Oceanic Hotel, The Grand Lobby, The Dining Room, Private Beach Access, The Hotel Library, the victim's hotel room at the seaside hotel
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Oceanic Hotel", "The Grand Lobby", "The Dining Room", "Private Beach Access", "The Hotel Library", "the victim's hotel room at the seaside hotel"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the victim's hotel room at the seaside hotel". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=8211; context=12532; dropped=[none]; truncated=[first_appearance_contracts, location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - Scene is set in: the victim's hotel room at the seaside hotel — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • detailed, note, among, finch, belongings, mentions, specific, natural [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The half-empty bottle of beach oil found next to the victim's body."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the victim died in suspicious circumstances, raising immediate questions about the beach oil."
...
[
  {
    ...
    "title": "Discovery",
    "setting": {
      "location": "the victim's hotel room at the seaside hotel",
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor hesitates at the door, feeling the weight of the moment before entering."
      ]
    },
    "summary": "Eleanor Voss arrives at the seaside hotel to find Dr. Mallory Finch's lifeless body in her room. Shocked, she calls for help as the other guests gather, revealing their concern and confusion. A half-empty bottle of beach oil sits ominously beside the victim.",
    "beat": "gathering",
    "estimatedWordCount": 1250,
    "pivotElement": "The half-empty bottle of beach oil found next to the victim's body.",
    "factEstablished": "Establishes the victim died in suspicious circumstances, raising immediate questions about the beach oil.",
    ...
    "emotionalRegister": "The atmosphere is thick with tension and anticipation, setting the stage for the unfolding drama.",
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (poison, absorbed, skin, contact, mechanism, activated, combined, specific, natural, coastal, plant) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_1] (half, empty, bottle, beach, finch, room, label, indicating, contains, toxic, substance) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_culprit_direct_captain_ivor_hale] (direct, ties, captain, ivor, hale, mechanism, access, point, before, discriminating, excludes, competing) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_mid_1] (witnesses, recall, finch, complaining, unusual, rash, using, beach) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
