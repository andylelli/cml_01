...
- Project ID: ``
- Timestamp: `2026-07-19T09:56:39.493Z`
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "But as the laughter faded, the reality of the situation reasserted itself. Captain Hale’s nervousness, Beatrice’s evasions, Sylvia’s polished answers, Hugo’s bluntness—all were pieces of a puzzle that refused to fit. Eleanor felt the weight of the investigatio..."
...
Known location profile anchors: The Oceanic Hotel, The Grand Lobby, The Dining Room, Private Beach Access, The Hotel Library, the hotel library
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Oceanic Hotel", "The Grand Lobby", "The Dining Room", "Private Beach Access", "The Hotel Library", "the hotel library"
...
- Chapter 4 (score 96/100):
  Quality gaps noted: scene grounding weakness
  Address in upcoming chapters: Open next chapter with a named location anchor plus at least two sensory cues and one atmosphere marker.
- Phrases to avoid (already overused in earlier chapters): "one must always consider the finer details", "only by the distant sound of waves", "by the distant sound of waves and", "the distant sound of waves and the", "distant sound of waves and the persistent", "told her to see the hotel doctor", "broken only by the distant sound of", "not merely inconvenient they were the heart", "merely inconvenient they were the heart of".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=16969; context=5977; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_2 must appear in Act 2, Scene 2 via Behavioral observation
...
- Chapter 5:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "But as the laughter faded, the reality of the situation reasserted itself. Captain Hale’s nervousness, Beatrice’s evasions, Sylvia’s polished answers, Hugo’s bluntness—all were pieces of a puzzle that refused to fit. Ele...".
  ...
  - Sensory obligation — use at least two of: shadows deepening in corners, cloudy light filtering through windows | the occasional cough, the rustle of papers | the mustiness of old books. Mood: brooding silence.
...
Chapter 5 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The unusual residue found on Dr. Finch's belongings."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that someone tampered with Dr. Finch's belongings, deepening the mystery."
...
[
  {
    "sceneNumber": 5,
    "act": 2,
    "title": "Unearthing Secrets",
    "setting": {
      "location": "the hotel library",
      "timeOfDay": "Late afternoon",
      "atmosphere": "Dimly lit and quiet, filled with books and whispers"
    },
    "characters": [
      "Eleanor Voss",
      "Captain Ivor Hale",
    ...
    "purpose": "Delve into the suspects' backgrounds and reveal secrets.",
    "cluesRevealed": [
      "clue_3",
      "clue_4",
      "clue_6"
    ...
    "dramaticElements": {
      "conflict": "Eleanor discovers hidden connections between the suspects.",
      "tension": "The atmosphere is charged as secrets are revealed.",
      "microMomentBeats": [
        "Eleanor feels a chill as she uncovers a hidden truth about Beatrice."
      ]
    },
    "summary": "Eleanor investigates the hotel library, discovering an unusual residue on Dr. Finch's belongings that suggests tampering. She also uncovers Captain Hale's nervousness during dinner, hinting at a deeper secret.",
    "beat": "alibis",
    "estimatedWordCount": 1250,
    "pivotElement": "The unusual residue found on Dr. Finch's belongings.",
    "factEstablished": "Establishes that someone tampered with Dr. Finch's belongings, deepening the mystery.",
    ...
    "emotionalRegister": "A revelation recontextualizes previous interactions, heightening the stakes for all involved.",
    ...
    "locationRegisterNote": "The Hotel Library is a sanctuary of calm amidst the chaos, filled with the scent of old books and the crackle of firelight. Here, the weight of secrets hangs heavy, as guests seek refuge in stories while their own narratives unfold. — A writer should feel the juxtaposition of tranquility and tension, where each book holds the potential for revelation.",
