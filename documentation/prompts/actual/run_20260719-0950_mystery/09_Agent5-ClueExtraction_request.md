...
- Project ID: `unknown`
- Timestamp: `2026-07-19T09:51:32.255Z`
...
**Crime**: murder
**Primary axis**: behavioral axis
**Cast**: 6 characters
**Requested density**: minimal
**Effective density**: dense (auto-escalated to satisfy mandatory requirements)

## Mandatory Clue Requirements (18 required)
1. Generate a clue that makes the reader directly observe: "A half-empty bottle of beach oil is found in Dr. Finch's room with a label indicating it contains a ..."
   → observation | essential | early | spatial | step 1 | terms: half-empty, bottle, beach

2. Generate a clue that provides evidence for: "The presence of the beach oil suggests a possible link to the poisoning, as it could contain the tox..."
   → contradiction | essential | early | testimonial | step 1 | terms: presence, beach, suggests

3. Generate a clue that makes the reader directly observe: "Witnesses recall Dr. Finch complaining of an unusual rash after using the beach oil...."
   → observation | essential | early | temporal | step 2 | terms: witnesses, recall, finch

4. Generate a clue that provides evidence for: "The rash indicates a possible adverse reaction to the oil, strengthening the connection between the ..."
   → contradiction | essential | early | behavioral | step 2 | terms: indicates, possible, adverse

5. Generate a clue that makes the reader directly observe: "A note mentioning the rare coastal plant is found among Dr. Finch's belongings...."
   → observation | essential | mid | testimonial | step 3 | terms: mentioning, coastal, plant

6. Generate a clue that provides evidence for: "This note implies that the plant was known to Dr. Finch, suggesting she may have used it intentional..."
   → contradiction | essential | mid | testimonial | step 3 | terms: implies, plant, known

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The presence of the beach oil suggests a possible link to the poisoning, as it could contain the toxic substance...."
   → contradiction | essential | mid | testimonial | step 1 | terms: presence, beach, suggests

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The poison was absorbed through a skin contact mechanism that only activated when combined with a specific natural oil from a coastal plant...."
   → observation | essential | early | temporal | terms: poison, absorbed, through

9. Generate one essential EARLY clue giving a concrete, fair-play indicator of the manner of death (poisoned with a botanical toxin) observable at the body-discovery scene — e.g. for poison: numbness, a bitter almond residue, constriction, or sudden collapse with no wound. Do NOT name or explain the concealment trick; only the physical tell a witness could see at the scene.
   → observation | essential | early | testimonial | terms: poisoned, botanical, toxin, numbness, bitter, residue, collapse, convulsion, no wound, froth

10. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "A controlled experiment is staged where guests are asked to apply the beach oil under supervision to..."
   → observation | essential | mid | behavioral | terms: controlled, experiment, staged
...
11. Generate one essential mid-story clue whose description or pointsTo explicitly names Captain Ivor Hale and states the unique trace, preparation detail, or mechanism link that points to Captain Ivor Hale rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Captain Ivor Hale, poison, absorbed, through
...
12. Generate one essential early-or-mid clue establishing that Captain Ivor Hale UNIQUELY had the means/skill/access/knowledge required to execute the concealment mechanism, and that the other suspects did not — so the reveal relies only on this already-planted capability, never on a means introduced for the first time at the confrontation.
   → elimination | essential | mid | temporal | terms: Captain Ivor Hale, poison, absorbed, through

13. Generate a clue showing observable evidence of Captain Ivor Hale's premeditation or planning (Jealousy over Dr. Finch's reputation). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: jealousy, finch's, reputation

14. Generate a clue that explicitly eliminates suspect Eleanor Voss using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Eleanor Voss because ...").
...
17. Generate a clue that explicitly eliminates suspect Hugo Vane using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Hugo Vane because ...").
   → elimination | essential | mid | testimonial | terms: Hugo Vane

18. Generate one essential early or mid elimination clue that explicitly rules out Eleanor Voss and narrows the solution toward culprit Captain Ivor Hale. The pointsTo text must start with "Eliminates Eleanor Voss because ..." and cite corroborated evidence.
   → elimination | essential | mid | testimonial | terms: Eleanor Voss, Captain Ivor Hale
...
- Eleanor Voss: sensitive items: Media coverage impact
- Captain Ivor Hale: sensitive items: Reputation at stake
- Beatrice Quill: sensitive items: Public image
- Sylvia Trent: sensitive items: Artistic reputation
- Hugo Vane: sensitive items: Business reputation
...
Create 2 red herrings that support the false assumption: "Dr. Mallory Finch died from a sudden medical condition due to her past health issues."
