...
- Project ID: ``
- Timestamp: `2026-07-19T09:52:37.922Z`
...
- Era-authentic markers: radio broadcasting, early television sets, military-grade radar, code-breaking machines, rationed gasoline for personal vehicles, increased use of public transport, post-war automobile boom, long-distance telephone calls
- Tone: Classic
- No anachronisms
...
Description: A seaside hotel built in the early 1930s featuring Art Deco architecture, with a prominent view of the ocean and a private beach.
...
Setting constraints:
- Physical constraints: narrow hallways limiting movement, locked staff-only areas, oceanfront access restricted during storms
- Geographic isolation: Moderately isolated, requiring a drive to the nearest town for outside assistance.
- Access control: restricted access to the roof and service areas, check-in procedures for guests, staff hierarchy dictates access to certain areas
