...
- Project ID: ``
- Timestamp: `2026-07-17T02:57:55.328Z`
...
- Eleanor Voss
  ...
  Suspicion/pressure cue seed: Personal satisfaction in solving a case..
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Beatrice Quill
  Public identity anchor: Hotel Waitress; suspect 
  Connection to victim: Hugo Vane (acquaintance).
  Investigation relevance: access plausibility: high | alibi window: 7 PM to 9 PM | opportunity channel: Access to guest rooms.
  Suspicion/pressure cue seed: Financial stability..
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Captain Ivor Hale
  Public identity anchor: Retired Naval Officer; suspect 
  Connection to victim: Their past as naval officers has forged a strong bond, but also hidden animosities.; Ivor and Hugo served together and have shared secrets from the war..
  Investigation relevance: access plausibility: high | alibi window: 8 PM to 9 PM | opportunity channel: Access to beach area.
  Suspicion/pressure cue seed: Maintaining reputation..
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Sylvia Trent
  Public identity anchor: Hotel Manager; suspect 
  Connection to victim: Hugo Vane (rival).
  Investigation relevance: access plausibility: medium | alibi window: 8 PM to 10 PM | opportunity channel: Access to hotel grounds.
  Suspicion/pressure cue see
...
• [clue_mechanism_visibility_core] timing, tide, rise, victim, last, known, movements, contradict, suggesting, impossible, scenario
  Category: testimonial | Criticality: essential | Supports inference step 1
  Points to: victim, drowning, scenario, impossible

• [clue_9] timing, tide, rise, victim, last, known, movements, contradict, suggesting, impossible, scenario
  Category: testimonial | Criticality: supporting | Supports inference step 1
  Points to: victim, drowning, scenario, impossible

• [clue_id_2] witnesses, report, conflicting, times, event
...
Known location profile anchors: The Crestview Hotel, The Seaside Lounge, The Hotel Kitchen, The Rooftop Terrace, The Grand Staircase, the beach near the Seaside Hotel
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Crestview Hotel", "The Seaside Lounge", "The Hotel Kitchen", "The Rooftop Terrace", "The Grand Staircase", "the beach near the Seaside Hotel"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=7948; context=11864; dropped=[none]; truncated=[first_appearance_contracts, location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • tide, chart, shows, minutes, past, nine [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
         Place this OBSERVATION in paragraph 1 or 2 (observation only — no inference about the culprit).
    • victim, last, seen, quarter [clue_9] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: victim, drowning, scenario, impossible
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The body of Hugo Vane, discovered on the beach."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes the victim was found dead on the beach, leading to initial suspicion."
...
[
  {
    ...
    "setting": {
      ...
      "atmosphere": "Tense and heavy with the scent of salt and despair"
    },
    "characters": [
      "Eleanor Voss",
      "Hugo Vane",
    ...
    "dramaticElements": {
      ...
      "tension": "The tension among the gathered suspects as they await the detective's arrival.",
      "microMomentBeats": [
        "Eleanor takes a deep breath, steeling herself against the rising tide of grief."
      ]
    },
    "summary": "As the morning sun breaks through the clouds, Eleanor Voss arrives at the beach to find Hugo Vane's lifeless body washed ashore. Shocked by the sight, she quickly assesses the scene, noting the gathered suspects, all of whom had their own reasons to be near the water. The conflicting accounts of the time of death raise immediate questions.",
    "beat": "gathering",
    "estimatedWordCount": 1800,
    "pivotElement": "The body of Hugo Vane, discovered on the beach.",
    "factEstablished": "Establishes the victim was found dead on the beach, leading to initial suspicion.",
    ...
    "emotionalRegister": "The story begins with a sense of foreboding, as the atmosphere of the hotel feels charged with tension.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (timing, tide, rise, victim, last, known, movements, contradict, suggesting, impossible, scenario) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_9] (timing, tide, rise, victim, last, known, movements, contradict, suggesting, impossible, scenario) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_id_2] (witnesses, report, conflicting, times, event) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
