...
- Project ID: ``
- Timestamp: `2026-07-17T03:03:09.114Z`
...
• [clue_late_optional_slot_1] tide, chart, showing, remains, late, texture, detail, case, background
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Eleanor paused at the door, her hand on the knob, and let herself look back one last time at the study—the battered desk, the flickering lamp, the tide chart spread like a battlefield. The night was still thick with unspoken truths, but for the first time, she..."
...
This is a **temporal comparison** test. The detective must:

**Test mechanism (paraphrase — do NOT copy verbatim):**
Render this test MECHANISM as live, in-scene action and dialogue, composing ENTIRELY in your own words from these elements (reproducing any briefing phrase verbatim FAILS validation): tide, chart, witness, accounts, reveals, inconsistencies
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=27543; context=4842; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 9:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Eleanor paused at the door, her hand on the knob, and let herself look back one last time at the study—the battered desk, the flickering lamp, the tide chart spread like a battlefield. The night was still thick with unsp...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • tide, chart, showing, remains, late, texture, detail, case, background [clue_late_optional_slot_1]
      Points to: adds, late, texture, changing, essential, deduction, chain
  ...
  - ⚠ SUSPECT CLEARANCE REQUIRED (MANDATORY): each suspect below MUST be named explicitly and cleared with on-page evidence and a reasoning connector (because / therefore / which proves):
    • "Captain Ivor Hale": write a dedicated paragraph that (a) names Captain Ivor Hale explicitly, (b) states the clearance method ("Verified hotel lobby presence during the time of drowning."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
    • "Dr. Mallory Finch": write a dedicated paragraph that (a) names Dr. Mallory Finch explicitly, (b) states the clearance method ("Confirmed alibi by hotel staff."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
    • "Sylvia Trent": write a dedicated paragraph that (a) names Sylvia Trent explicitly, (b) states the clearance method ("Alibi confirmed: 8 PM to 10 PM"), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
  ...
  - ⚠ DISCRIMINATING TEST (trap) — MANDATORY real-time scene with dialogue and confrontation. DO NOT summarize it after the fact.
    ...
    Elements the test must dramatize (compose the scene ENTIRELY in your own sentences from these — reproducing any briefing phrase verbatim FAILS validation): tide, chart, witness, accounts, reveals, inconsistencies
    Cite these already-revealed clue IDs during the test: clue_4, clue_10, clue_11
...
Chapter 9 (Act 3) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The tide chart showing low tide at ten minutes past nine."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes Beatrice's guilt through her reaction to the evidence presented."
...
[
  {
    ...
    "setting": {
      ...
      "timeOfDay": "Midnight",
      "atmosphere": "The ballroom is eerily quiet, filled with tension"
    },
    "characters": [
      "Eleanor Voss",
      "Beatrice Quill"
    ],
    "purpose": "Conduct the discriminating test to expose the culprit Suspects are systematically cleared: alibi confirmed for two suspects, ruled out by timeline evidence, leaving only the culprit identified by a complete evidence chain.",
    "cluesRevealed": [
      "clue_late_optional_slot_1",
      "clue_4"
    ],
    "dramaticElements": {
      "conflict": "Eleanor sets the trap for Beatrice.",
      "tension": "The atmosphere is thick with anticipation as the truth is about to unfold.",
      "microMomentBeats": [
        "Eleanor's heart pounds as she prepares to confront Beatrice."
      ]
    },
    "summary": "Eleanor gathers the suspects in the ballroom, setting the stage for her final confrontation. She presents the tide chart and the conflicting witness statements, revealing the inconsistencies in Beatrice's story. As she lays out the timeline, Beatrice's demeanor shifts, exposing her guilt.",
    "beat": "final_trap",
    "estimatedWordCount": 1800,
    "pivotElement": "The tide chart showing low tide at ten minutes past nine.",
    "factEstablished": "Establishes Beatrice's guilt through her reaction to the evidence presented.",
    ...
    "emotionalRegister": "The climax unfolds with a confrontation that unravels the complex web of lies surrounding Vane's death.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 9: the clue [clue_4] (inconsistencies, witness, accounts, suggest, misinterpretation, timing) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
