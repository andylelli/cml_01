...
- Project ID: ``
- Timestamp: `2026-07-21T21:00:37.658Z`
...
• [clue_5] victim, watch, time, shows, minutes, past, eleven
  Category: physical | Criticality: essential | Supports inference step 3
  Points to: time, death

• [clue_6] eliminates, captain, ivor, hale, because, security, logs, show, different, location, time, death
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: captain, ivor, hale, alibi

• [clue_late_1] witness, reports, dining, area, indicate, differing, timings
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_fp_contradiction_step_1, clue_core_contradiction_chain, clue_1, clue_culprit_direct_dr_mallory_finch, clue_early_1, clue_core_elimination_chain, clue_2, clue_culprit_direct_1, clue_3, clue_4, clue_mid_1 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): planned, nature, crime | timing, tide, suggests, sylvia, drowned, time | timing, high, tide | duration, submersion | direct, shows, mallory, finch, means, opportunity | timing, high, tide | mallory, finch, opportunity, commit, crime | relationship, tide, height, submersion | physical, trace, opportunity, indicate, mallory, finch | potential, suspect, movement | reliability, witness, accounts | physical, trace, opportunity, indicate, mallory, finch
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "The bar’s heavy atmosphere persisted, but beneath it, Hugo sensed that the puzzle had shifted. The meaning of the clues had changed: the footprints were no longer a trivial detail, but a pivot point in the investigation. The stage was set for the next act, wit..."
...
Known location profile anchors: Seashell Hotel, Hotel Lobby, Dining Room, Guest Rooms, Kitchen, the Seashell Hotel's dining area
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Seashell Hotel", "Hotel Lobby", "Dining Room", "Guest Rooms", "Kitchen", "the Seashell Hotel's dining area"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 6: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with an expository setup — e.g. "It was not until…" / "There had been no word since…" / "There was a note on the table…". Begin with "It was", "There was", or "There had been" followed immediately by a specific condition, event, or discovery. Do not open on generic mood alone — but still anchor the location and weave in the sensory + time-of-day grounding across the next sentence or two. Anchor opening in "the Seashell Hotel's dining area". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Phrases to avoid (already overused in earlier chapters): "we didn t have time for nonsense", "in the dining room from half past", "the dining room from half past nine", "dining room from half past nine until", "room from half past nine until eleven", "one way to gamble with your life", "from ten o clock until half past", "ten o clock until half past eleven", "the contradiction between the tide charts and", "the price of ambition can be quite".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=18284; context=5706; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility]; truncated=[location_profiles, temporal_context, continuity_context, pronoun_accuracy]
...
- clue_late_1 must appear in Act 2, Scene 3 via Reenactment results
...
- Chapter 6:
  ...
  - Scene is set in: the Seashell Hotel's dining area — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "The bar’s heavy atmosphere persisted, but beneath it, Hugo sensed that the puzzle had shifted. The meaning of the clues had changed: the footprints were no longer a trivial detail, but a pivot point in the investigation....".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • witness, statements, timing, events [clue_4]
      Points to: reliability, witness, accounts
    • time, displayed, victim, watch [clue_5]
      Points to: time, death
    • security, logs, confirming, captain, ivor, hale, alibi [clue_6]
      Points to: captain, ivor, hale, alibi
    ...
    • mechanism, connects, drowning, manipulation [clue_fp_contradiction_step_3]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • witness, statements, timing, events [clue_late_1]
      Points to: reliability, witness, accounts
...
Chapter 6 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The witness statement claiming Ivor was seen near the beach."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Ivor is accused based on misleading evidence, creating doubt in the detective's reasoning."
...
[
  {
    ...
    "setting": {
      "location": "the Seashell Hotel's dining area",
      "timeOfDay": "Late evening",
      "atmosphere": "Sombre, with a sense of impending doom"
    },
    "characters": [
      "Hugo Vane",
      "Eleanor Voss",
    ...
    "dramaticElements": {
      "conflict": "Hugo mistakenly accuses an innocent suspect.",
      "tension": "The atmosphere thickens as everyone reacts to the accusation.",
      "microMomentBeats": [
        "Eleanor gasps, her face pale as she hears the accusation."
      ]
    },
    "summary": "Hugo, piecing together the evidence, mistakenly accuses Captain Ivor Hale based on circumstantial evidence and a false timeline. The revelation of a witness claiming to have seen Ivor near the beach sends shockwaves through the group. The tension peaks as Ivor vehemently denies the accusation, but Hugo's confidence in his deduction remains unshaken.",
    "beat": "false_solution",
    "estimatedWordCount": 1800,
    "pivotElement": "The witness statement claiming Ivor was seen near the beach.",
    "factEstablished": "Establishes that Ivor is accused based on misleading evidence, creating doubt in the detective's reasoning.",
    ...
    "emotionalRegister": "The revelation of hidden motives alters the perception of previous events, intensifying the stakes for all involved.",
