...
- Project ID: ``
- Timestamp: `2026-07-21T20:56:33.700Z`
...
- Hugo Vane
  Public identity anchor: Wealthy Benefactor; detective 
  Connection to victim: Hugo often seeks Sylvia's help to understand hotel guests better.; Sylvia provides insights on guests' interests and desires for Hugo's benefits..
...
- Eleanor Voss
  ...
  Connection to victim: Both are vying for the attention of affluent hotel guests in their respective careers.; Eleanor used to showcase her art at the hotel where Sylvia worked..
  Investigation relevance: access plausibility: high | alibi window: 9:00 PM - 11:00 PM | opportunity channel: Dining room.
  Suspicion/pressure cue seed: Frequent glances at Sylvia.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Dr. Mallory Finch
  Public identity anchor: Physician; suspect 
  Connection to victim: directly affected by Sylvia Trent's death and its fallout.
  Investigation relevance: access plausibility: medium | alibi window: 10:00 PM - 11:30 PM | opportunity channel: Hotel lobby.
  Suspicion/pressure cue seed: Nervous demeanor when questioned.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.
...
• [clue_fp_contradiction_step_1] tide, charts, sylvia, room, indicate, high, minutes, past, eleven
  Category: testimonial | Criticality: essential | Supports inference step 1
...
Known location profile anchors: Seashell Hotel, Hotel Lobby, Dining Room, Guest Rooms, Kitchen, the beach behind the Seashell Hotel
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Seashell Hotel", "Hotel Lobby", "Dining Room", "Guest Rooms", "Kitchen", "the beach behind the Seashell Hotel"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the beach behind the Seashell Hotel". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=8259; context=11682; dropped=[none]; truncated=[first_appearance_contracts, location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - Scene is set in: the beach behind the Seashell Hotel — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - PLANT OBLIGATIONS (incidental appearances): each item below MUST appear in this chapter as a passing physical detail a character sees, handles, or walks past — with its significance UNFLAGGED:
    • visible, water, line, victim, clothing [plant:clue_1]
    • mechanism, connects, drowning, manipulation [plant:clue_culprit_direct_dr_mallory_finch]
    • tide, charts, sylvia, room, showing, specific, timing [plant:clue_early_1]
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The body of Sylvia Trent, face down in the sand."
  ...
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_2] Witnesses reported seeing a figure on the beach, but it was too dark to identify.
...
[
  {
    ...
    "title": "Discovery",
    "setting": {
      "location": "the beach behind the Seashell Hotel",
      "timeOfDay": "Morning after the murder",
      "atmosphere": "Tense, gloomy with the scent of saltwater lingering"
    },
    "characters": [
      "Hugo Vane",
      "Eleanor Voss",
    ...
    "dramaticElements": {
      "conflict": "Tension mounts as the group discovers the body.",
      "tension": "The atmosphere thickens with suspicion as everyone realizes they are potential suspects.",
      "microMomentBeats": [
        "Eleanor stares at the waves, lost in thought, as the body is revealed."
      ]
    },
    "summary": "Hugo Vane arrives at the beach, where the body of Sylvia Trent is discovered washed ashore. Shock ripples through the witnesses as they process the grim sight. The group consists of Eleanor Voss, Dr. Mallory Finch, and Captain Ivor Hale, all of whom had interacted with Sylvia recently. Hugo notices that two clocks show contradictory times regarding the tide.",
    "beat": "gathering",
    "estimatedWordCount": 1800,
    "pivotElement": "The body of Sylvia Trent, face down in the sand.",
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_2",
      "placementDetail": "Witnesses reported seeing a figure on the beach, but it was too dark to identify."
    },
    "emotionalRegister": "A foreboding atmosphere hangs over the hotel as guests settle in, foreshadowing the impending tragedy.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (mechanism, relies, drown, manipulate, chart, expose, false, timing) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_fp_contradiction_step_1] (tide, charts, sylvia, room, indicate, high, minutes, past, eleven) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
