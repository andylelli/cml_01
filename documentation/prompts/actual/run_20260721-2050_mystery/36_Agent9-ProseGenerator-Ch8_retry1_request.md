...
- Project ID: ``
- Timestamp: `2026-07-21T21:02:51.387Z`
...
• [clue_late_optional_slot_1] high, tide, minutes, past, eleven, remains, late, texture, detail, case, background
...
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): planned, nature, crime | timing, tide, suggests, sylvia, drowned, time | timing, high, tide | duration, submersion | direct, shows, mallory, finch, means, opportunity | timing, high, tide | mallory, finch, opportunity, commit, crime | relationship, tide, height, submersion | physical, trace, opportunity, indicate, mallory, finch | potential, suspect, movement | reliability, witness, accounts | physical, trace, opportunity, indicate, mallory, finch | time, death | captain, ivor, hale, alibi | reliability, witness, accounts | potential, guilt, knowledge, crime | mallory, finch, potential, involvement | indicates, opportunity, manipulate
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As Hugo gathered his notes and prepared to leave the library, he glanced once more at Dr. Finch’s trembling hands. The investigation had not yet named its culprit, but the web of contradictions was tightening—a puzzle waiting to be solved, shaped by secrets an..."
...
Render this test MECHANISM as live, in-scene action and dialogue, composing ENTIRELY in your own words from these elements (reproducing any briefing phrase verbatim FAILS validation): discriminating, compares, drown, manipulate, chart, claimed, timeline
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=23203; context=5011; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, continuity_context, pronoun_accuracy]
...
- Chapter 8:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As Hugo gathered his notes and prepared to leave the library, he glanced once more at Dr. Finch’s trembling hands. The investigation had not yet named its culprit, but the web of contradictions was tightening—a puzzle wa...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • high, tide, minutes, past, eleven, remains, late, texture, detail, case, background [clue_late_optional_slot_1]
      Points to: adds, late, texture, changing, essential, deduction, chain
  ...
  - ⚠ SUSPECT CLEARANCE REQUIRED (MANDATORY): each suspect below MUST be named explicitly and cleared with on-page evidence and a reasoning connector (because / therefore / which proves):
    • "Eleanor Voss": write a dedicated paragraph that (a) names Eleanor Voss explicitly, (b) states the clearance method ("Witnesses corroborate her alibi."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
    • "Captain Ivor Hale": write a dedicated paragraph that (a) names Captain Ivor Hale explicitly, (b) states the clearance method ("His alibi aligns with security logs."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
    • "Beatrice Quill": write a dedicated paragraph that (a) names Beatrice Quill explicitly, (b) states the clearance method ("Beatrice was with other staff during the time."), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have".
  ...
  - ⚠ DISCRIMINATING TEST (trap) — MANDATORY real-time scene with dialogue and confrontation. DO NOT summarize it after the fact.
    ...
    Elements the test must dramatize (compose the scene ENTIRELY in your own sentences from these — reproducing any briefing phrase verbatim FAILS validation): discriminating, compares, drown, manipulate, chart, claimed, timeline
    Cite these already-revealed clue IDs during the test: clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_culprit_direct_1, clue_fp_contradiction_step_1
...
Chapter 8 (Act 3) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Dr. Mallory Finch's reaction during the confrontation."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Dr. Mallory Finch's reaction confirms her guilt in the crime."
...
[
  {
    ...
    "setting": {
      ...
      "atmosphere": "Dramatic, charged with tension"
    },
    "characters": [
      "Hugo Vane",
      "Eleanor Voss",
    ...
    "dramaticElements": {
      "conflict": "The culprit is caught in their own deception.",
      "tension": "The atmosphere is thick with anticipation as the trap is set.",
      "microMomentBeats": [
        "Hugo's heart races as he prepares to confront the guilty party."
      ]
    },
    "summary": "Hugo stages a trap on the beach, using the tide charts and the evidence of submersion to confront Dr. Mallory Finch. As he lays out the timeline and evidence, her reaction betrays her guilt, leading to a decisive moment where she is exposed.",
    "beat": "final_trap",
    "estimatedWordCount": 1800,
    "pivotElement": "Dr. Mallory Finch's reaction during the confrontation.",
    "factEstablished": "Establishes that Dr. Mallory Finch's reaction confirms her guilt in the crime.",
    ...
    "emotionalRegister": "The truth comes to light, forcing characters to face the consequences of their actions in a dramatic confrontation.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 8: the clue [clue_mechanism_visibility_core] (mechanism, relies, drown, manipulate, chart, expose, false, timing) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
...
```text
{
  ...
  "chapters": [
    {
      ...
      "summary": "Hugo Vane stages a trap on the wintry beach behind the Seashell Hotel, using tide charts and physical evidence to confront Dr. Mallory Finch. The discriminating test exposes her guilt, clearing the other suspects and revealing the motive, method, and consequence of Sylvia Trent’s murder.",
      "paragraphs": [
  ...
  "note": "",
  "audit": {
    "locked_fact_phrases": "present in paragraphs 2, 4, 11 | absent",
    "season_words_used": "winter, wintry, dawn, early morning, fog, drizzle, cold, pale, sunlight | none",
    "discriminating_test_present": "yes: chapter 8 paragraph 8",
    "required_clues_present": "clue_mechanism_visibility_core: chapter 8 paragraph 2; clue_late_optional_slot_1: chapter 8 paragraph 2 | absent",
    "early_observation_present": "description: chapter 8 paragraph 2 (first 25%) | absent",
    "early_inference_present": "yes: paragraph immediately following observation | no"
  }
}
...
PRIMARY FAILURES
- Final reveal completeness failed: reveal must explicitly connect culprit to death method ("drowned").
