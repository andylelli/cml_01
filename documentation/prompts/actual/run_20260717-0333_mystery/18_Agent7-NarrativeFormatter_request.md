...
- Project ID: `unknown`
- Timestamp: `2026-07-17T03:37:46.279Z`
...
**Era & Setting**: 1940s - Brighton
**Setting Lock**: All scenes must remain within this setting: Brighton. Do not move to a different location type.
...
Eleanor Voss died from an unexpected health crisis.
*Revealed: final act*
...
### Early Clues (Act I)
- [clue_mechanism_visibility_core] testimonial: Witnesses confirm Eleanor was drinking a glass of lemonade before her collapse.
- [clue_core_contradiction_chain] testimonial: Eleanor's drink was likely tampered with since the lemonade was not provided by the restaurant.
- [clue_3] physical: A half-empty glass of lemonade was tested and found to contain traces of a botanical poison.
- [clue_4] testimonial: The poison found in the glass confirms that Eleanor was deliberately poisoned.
- [clue_id_2] physical: A half-empty glass of lemonade was tested and found to contain traces of a botanical poison.
- [clue_id_3] testimonial: Witnesses confirm Eleanor was drinking a glass of lemonade before her collapse.
- [clue_fp_contradiction_step_1] testimonial: Witnesses confirm Eleanor was drinking a glass of lemonade before her collapse.
- [clue_fp_contradiction_step_2] testimonial: A half-empty glass of lemonade was tested and found to contain traces of a botanical poison.

### Mid Clues (Act II)
- [clue_5] temporal: Beatrice Quill was seen entering the kitchen shortly before the lemonade was served.
- [clue_6] testimonial: Beatrice had the opportunity to poison Eleanor's drink.
- [clue_7] behavioral: Beatrice Quill exhibited signs of jealousy over Eleanor's charm.
- [clue_core_elimination_chain] testimonial: Eliminates Dr. Mallory Finch because he was attending to another patient during the time of the incident.
- [clue_culprit_direct_1] testimonial: Direct evidence links Beatrice Quill to the mechanism access point before the discriminating test and excludes competing suspect timelines.
- [clue_culprit_direct_beatrice_quill] temporal: Direct evidence ties Beatrice Quill to the mechanism access point before the discriminating test and excludes competing suspect timelines.
- [clue_id_1] testimonial: Direct evidence links Beatrice Quill to the mechanism access point before the discriminating test and excludes competing suspect timelines.
- [clue_fp_contradiction_step_3] testimonial: Beatrice Quill was seen entering the kitchen shortly before the lemonade was served.

### Late Clues (Act III)
- [clue_late_optional_slot_1] temporal: Dinner service commenced at seven o'clock remains a late texture detail in the case background.

### Red Herrings
- [rh_1] Some believe Eleanor died from an unexpected health crisis due to her history of fainting spells.
- [rh_2] Witnesses recall Eleanor having a brief conversation with Captain Ivor Hale about her health before dinner.
...
- **Dr. Mallory Finch**: Act 3, Scene 5
  - Method: Confirmed alibi from other guests
  - Clues: clue_id_1, clue_id_2
- **Captain Ivor Hale**: Act 3, Scene 5
  - Method: No access to the kitchen during the meal.
  - Clues: clue_id_1, clue_id_2
- **Sylvia Trent**: Act 3, Scene 5
  - Method: Witness statements confirm her presence elsewhere.
  - Clues: clue_id_1, clue_id_2
...
- **Revelation method:** Confrontation with Beatrice using all evidence gathered.

### Clue Placement Guidelines
- **clue_mechanism_visibility_core**: Act 1, Scene 1 (Witness statement)
- **clue_3**: Act 1, Scene 2 (Direct observation)
...
- **clue_id_2**: Act 1, Scene 3 (Test results presented)
...
- **pH_acidity**: "three" — The pH level required for the poison to activate.
- **time_to_dissolve**: "three hours" — The time it takes for the poison to fully dissolve in the lemonade.
- **lemonade_delivery_time**: "ten minutes past four" — The time the lemonade was delivered to the victim.


## PILLAR 4 — OUTLINE COMPLETENESS CONTRACT DATA

### Character Permitted Behaviours (use for permittedBehavioursByAct per scene)
- **Eleanor Voss**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Her decision to dismiss a long-standing employee without warning ignited a flame of bitterness, leading to speculation that her former colleague might seek revenge." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Eleanor grapples with guilt over her past decisions and their consequences, fearing that her secrets will come to light and shatter the reputation she has fought so hard to build." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Dr. Mallory Finch**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Mallory feared that Eleanor would discover her addiction and expose her, ruining her reputation and career." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Mallory struggles with the duality of her role as a healer while battling her own demons, leading to feelings of shame and guilt that plague her every decision." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Captain Ivor Hale**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Ivor's belief that Eleanor's management style was undermining the hotel's military discipline fueled a growing discontent within him." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Ivor battles with the conflict between his ingrained beliefs and the changing world around him, leading to feelings of inadequacy and frustration as he struggles to adapt." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Beatrice Quill**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Beatrice saw Eleanor's death as her golden opportunity for advancement, a chance to finally step out of the shadows and into the limelight." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Beatrice grapples with the moral implications of her ambition, torn between her desire for success and the lengths she is willing to go to achieve it." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Sylvia Trent**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Sylvia feared that Eleanor would expose her unethical reporting methods, a revelation that could tarnish her reputation as a journalist." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Sylvia grapples with the ethical implications of her work, torn between her ambition and the consequences of her actions on her integrity as a journalist." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.
- **Hugo Vane**: Act I: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Hugo's financial stake in the hotel means that Eleanor's untimely death could benefit him, raising questions about his true intentions." — do not surface in Act I. | Act II: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Hugo grapples with the duality of his charm and the darker aspects of his dealings, leading to a moral struggle that questions his integrity and the path he has chosen." | Act III: Full character reveal permissible. Emotional truth should be explicit — confrontation, confession, or vindication as role demands.

### Red Herrings (must be seeded in Act I–II scenes via redHerringPlacement)
- **rh_1**: Some believe Eleanor died from an unexpected health crisis due to her history of fainting spells. (misdirection: This distracts from the possibility of poisoning.)
- **rh_2**: Witnesses recall Eleanor having a brief conversation with Captain Ivor Hale about her health before dinner. (misdirection: This suggests her collapse was due to a pre-existing condition.)
```
