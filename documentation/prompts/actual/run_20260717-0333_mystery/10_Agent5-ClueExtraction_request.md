...
- Project ID: `unknown`
- Timestamp: `2026-07-17T03:34:36.265Z`
...
1. Generate a clue that makes the reader directly observe: "Witnesses confirm Eleanor was drinking a glass of lemonade before her collapse...."
   → observation | essential | early | temporal | step 1 | terms: witnesses, confirm, eleanor

2. Generate a clue that provides evidence for: "Eleanor's drink was likely tampered with since the lemonade was not provided by the restaurant...."
   → contradiction | essential | early | testimonial | step 1 | terms: eleanor's, drink, likely

3. Generate a clue that makes the reader directly observe: "A half-empty glass of lemonade was tested and found to contain traces of a botanical poison...."
   → observation | essential | early | physical | step 2 | terms: half-empty, glass, lemonade

4. Generate a clue that provides evidence for: "The poison found in the glass confirms that Eleanor was deliberately poisoned...."
   → contradiction | essential | early | testimonial | step 2 | terms: poison, found, glass

5. Generate a clue that makes the reader directly observe: "Beatrice Quill was seen entering the kitchen shortly before the lemonade was served...."
   → observation | essential | mid | temporal | step 3 | terms: beatrice, quill, entering

6. Generate a clue that provides evidence for: "Beatrice had the opportunity to poison Eleanor's drink...."
   → contradiction | essential | mid | testimonial | step 3 | terms: beatrice, opportunity, poison

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "Eleanor's drink was likely tampered with since the lemonade was not provided by the restaurant...."
   → contradiction | essential | mid | testimonial | step 1 | terms: eleanor's, drink, likely

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The mechanism relies on botanical, witness, and confirm to expose the false timing...."
   → observation | essential | early | testimonial | terms: mechanism, relies, botanical,
...
10. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Confronting Beatrice with the evidence of her entering the kitchen and the poison's presence in the ..."
   → observation | essential | mid | testimonial | terms: confronting, beatrice, evidence
...
11. Generate one essential mid-story clue whose description or pointsTo explicitly names Beatrice Quill and states the unique trace, preparation detail, or mechanism link that points to Beatrice Quill rather than any non-culprit.
   → observation | essential | mid | testimonial | terms: Beatrice Quill, mechanism, relies, botanical,
...
12. Generate one essential early-or-mid clue establishing that Beatrice Quill UNIQUELY had the means/skill/access/knowledge required to execute the concealment mechanism, and that the other suspects did not — so the reveal relies only on this already-planted capability, never on a means introduced for the first time at the confrontation.
   → elimination | essential | mid | testimonial | terms: Beatrice Quill, mechanism, relies, botanical,

13. Generate a clue showing observable evidence of Beatrice Quill's premeditation or planning (Jealousy over Eleanor's charm). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: jealousy, eleanor's, charm
...
15. Generate one essential early or mid elimination clue that explicitly rules out Dr. Mallory Finch and narrows the solution toward culprit Beatrice Quill. The pointsTo text must start with "Eliminates Dr. Mallory Finch because ..." and cite corroborated evidence.
...
## Access Constraints
Actors: Beatrice Quill, Dr. Mallory Finch, Sylvia Trent
Objects: Lemonade pitcher, Kitchen supplies
...
Create 2 red herrings that support the false assumption: "Eleanor Voss died from an unexpected health crisis."
