...
- Project ID: ``
- Timestamp: `2026-07-17T03:43:45.788Z`
...
The investigation begins, revealing the suspects' hidden motives.
...
Rationale: The mood is tense as the investigation begins.
...
• [clue_fp_contradiction_step_1] witnesses, confirm, eleanor, drinking, glass, lemonade, before, collapse
  Category: testimonial | Criticality: essential | Supports inference step 1
  Points to: eleanor, drink, likely, tampered, since, lemonade, provided, restaurant

• [clue_fp_contradiction_step_2] half, empty, glass, lemonade, contain, traces, botanical, poison
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: poison, glass, eleanor, deliberately, poisoned

• [clue_id_2] half, empty, glass, lemonade, contain, traces, botanical, poison
  Category: physical | Criticality: essential | Supports inference step 2
  Points to: eleanor, deliberately, poisoned

• [clue_4] poison, glass, eleanor, deliberately, poisoned
  Category: testimonial | Criticality: supporting | Supports inference step 2
  Points to: eleanor, deliberately, poisoned

• [clue_id_3] witnesses, confirm, eleanor, drinking, glass, lemonade, before, collapse
  Category: testimonial | Criticality: essential | Supports inference step 1
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_3, clue_core_contradiction_chain — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): eleanor, drink, likely, tampered | eleanor, deliberately, poisoned | eleanor, drink, likely, tampered
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the evening wore on, the guests settled into uneasy silence, each lost in private calculation. The dining room, once a place of conviviality, now felt more like a courtroom. Hugo resolved to keep pressing, to unravel the tangle of motives and opportunities..."
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=13011; context=10803; dropped=[humour_guide, location_profiles, texture_pool, continuity_context]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_id_2 must appear in Act 1, Scene 3 via Test results presented
...
- Chapter 3:
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • witnesses, eleanor, glass, lemonade [clue_fp_contradiction_step_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: eleanor, drink, likely, tampered, since, lemonade, provided, restaurant
    ...
    • witnesses, eleanor, glass, lemonade [clue_fp_contradiction_step_2] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: poison, glass, eleanor, deliberately, poisoned
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
         Paragraph 2 (immediately following): The detective or POV character explicitly reasons
           about what this evidence implies — who it implicates, why it may be unreliable,
           or what inference it supports. This must be a separate full paragraph, not a sentence appended to Paragraph 1.
    • glass, contained, residue [clue_id_2] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: eleanor, deliberately, poisoned
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
         Paragraph 2 (immediately following): The detective or POV character explicitly reasons
           about what this evidence implies — who it implicates, why it may be unreliable,
           or what inference it supports. This must be a separate full paragraph, not a sentence appended to Paragraph 1.
    • witnesses, eleanor, glass, lemonade [clue_id_3] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: eleanor, drink, likely, tampered
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
         Paragraph 2 (immediately following): The detective or POV character explicitly reasons
           about what this evidence implies — who it implicates, why it may be unreliable,
           or what inference it supports. This must be a separate full paragraph, not a sentence appended to Paragraph 1.
    • results, showed, poison, lemonade [clue_4] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: eleanor, deliberately, poisoned
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
...
Chapter 3 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The test results showing traces of poison in the lemonade."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the lemonade contained traces of a botanical poison, indicating foul play."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Hugo glances at the glass, pondering its significance."
      ]
    },
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 3: the clue [clue_fp_contradiction_step_1] (witnesses, confirm, eleanor, drinking, glass, lemonade, before, collapse) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: the clue [clue_fp_contradiction_step_2] (half, empty, glass, lemonade, contain, traces, botanical, poison) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: the clue [clue_id_2] (half, empty, glass, lemonade, contain, traces, botanical, poison) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: the clue [clue_id_3] (witnesses, confirm, eleanor, drinking, glass, lemonade, before, collapse) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: the clue [clue_4] (poison, glass, eleanor, deliberately, poisoned) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: the clue [clue_core_contradiction_chain] (eleanor, drink, likely, tampered, since, lemonade, provided, restaurant) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: the clue [clue_3] (half, empty, glass, lemonade, contain, traces, botanical, poison) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
