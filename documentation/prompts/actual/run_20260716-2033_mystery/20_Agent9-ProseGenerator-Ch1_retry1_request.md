...
- Project ID: ``
- Timestamp: `2026-07-16T20:40:58.401Z`
...
- Eleanor Voss
  Public identity anchor: Local Inkeeper; detective 
  Connection to victim: Rival innkeeper and physician; each blames the other for their past grievances with the victim.; Eleanor and Mallory have long disagreed over the quality of their respective establishments and their relationships with the victim..
...
- Captain Ivor Hale
  ...
  Connection to victim: Mutual disdain; both have loved the victim at different times, leading to competition.; Mallory and Ivor have shared a rivalry since they both pursued the victim..
  Investigation relevance: access plausibility: medium | alibi window: limited.
  Suspicion/pressure cue seed: reputation and honor.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.
...
- Beatrice Quill
  ...
  Investigation relevance: access plausibility: high | alibi window: medium.
  Suspicion/pressure cue seed: emotional attachment.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.
...
### Captain Ivor Hale
Captain Ivor Hale's character is shaped by the remnants of his military service, carrying the burden of past romances and unresolved emotions. His struggle with PTSD is emblematic of many veterans grappling with their identities in a post-war world. As he navigates the complexities of loyalty and betrayal, Ivor's journey becomes a reflection of the psychological toll of war on returning soldiers and their relationships.
Era intersection: Ivor's internal conflict mirrors the broader societal struggle of veterans attempting to reintegrate while confronting their own demons.
...
Captain Hale’s voice carries a commanding presence, often laced with sardonic humor.
...
[stressed] I can’t shake this feeling... something isn’t right, not at all.
Humour: Ivor's sardonic humor adds depth to his character, making his interactions layered with complexity.
...
Act 1 behaviour contract: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "Believes the victim's betrayal with Eleanor shattered his dreams of rekindling their relationship." — do not surface in Act I.
...
• [clue_mechanism_visibility_core] cunning, impersonation, using, tailored, outfit, allows, killer, appear, places, creating, false, alibi
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: reveals, mechanism, behind, impersonation

• [clue_mid_1] tailored, suit, indicates, someone, impersonating, finch
...
Known location profile anchors: The Clifftop Haven, The Rooftop Terrace, The Drawing Room, The Kitchen, The Central Courtyard, the scene of the murder in the seaside hotel
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Clifftop Haven", "The Rooftop Terrace", "The Drawing Room", "The Kitchen", "The Central Courtyard", "the scene of the murder in the seaside hotel"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the scene of the murder in the seaside hotel". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=8130; context=11312; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - Scene is set in: the scene of the murder in the seaside hotel — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • tailored, outfit, design [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
         Place this OBSERVATION in paragraph 1 or 2 (observation only — no inference about the culprit).
    • tailored, suit, worn, suspect [clue_mid_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: implies, true, identity, seen, questionable
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The victim's lifeless body sprawled on the floor, a glass of poisoned drink nearby."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the victim was poisoned, setting the stage for the investigation."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_1] Captain Ivor Hale mentions he saw a suspicious figure near the victim's room the night before — seeds false inference about potential outside involvement.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor stands frozen at the doorway, heart racing as she processes the horror before her."
      ]
    },
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_1",
      "placementDetail": "Captain Ivor Hale mentions he saw a suspicious figure near the victim's room the night before — seeds false inference about potential outside involvement."
    },
    "emotionalRegister": "The atmosphere is thick with tension and secrets, reflecting the unease of the guests.",
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 1: the clue [clue_1] (witnesses, tailored, suit, near, victim, room, shortly, before, murder) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (cunning, impersonation, using, tailored, outfit, allows, killer, appear, places, creating, false, alibi) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_mid_1] (tailored, suit, indicates, someone, impersonating, finch) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
