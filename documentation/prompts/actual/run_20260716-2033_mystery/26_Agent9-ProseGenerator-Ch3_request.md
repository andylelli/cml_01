...
- Project ID: ``
- Timestamp: `2026-07-16T20:43:41.857Z`
...
Eleanor begins to uncover clues, but the emotional weight of the investigation starts to take its toll.
...
Rationale: As the investigation begins, light humor can provide a contrast to the tension.
...
• [clue_4] fabric, matches, costume, used, impersonation
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: reinforces, idea, impersonator, linked, murder
...
CLUES ALREADY REVEALED TO READER: clue_1, clue_mechanism_visibility_core, clue_mid_1, clue_2, clue_3 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): suggests, potential, suspect, vicinity, victim | reveals, mechanism, behind, impersonation | implies, true, identity, seen, questionable | implies, true, identity, seen, questionable | suggests, connection, fabric, murder
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the guests drifted away in twos and threes, Eleanor lingered by the suit, the fabric, and the stubbornly contradictory clocks. She knew the next steps would demand more than careful observation—they would require a willingness to confront the facades each g..."
...
Chapter 2: Chapter 2: The Contradictory Hour
  Events: "You saw the suit too, didn’t you?
...
Known location profile anchors: The Clifftop Haven, The Rooftop Terrace, The Drawing Room, The Kitchen, The Central Courtyard, the hotel dining room
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Clifftop Haven", "The Rooftop Terrace", "The Drawing Room", "The Kitchen", "The Central Courtyard", "the hotel dining room"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=12613; context=11360; dropped=[humour_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 3:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the guests drifted away in twos and threes, Eleanor lingered by the suit, the fabric, and the stubbornly contradictory clocks. She knew the next steps would demand more than careful observation—they would require a wi...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • fabric, characteristics, align, costume [clue_4] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: reinforces, idea, impersonator, linked, murder
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
         Paragraph 2 (immediately following): The detective or POV character explicitly reasons
           about what this evidence implies — who it implicates, why it may be unreliable,
           or what inference it supports. This must be a separate full paragraph, not a sentence appended to Paragraph 1.
    • tailored, suit, seen, near, victim, room [clue_culprit_direct_beatrice_quill] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
...
Chapter 3 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "A piece of fabric matching Beatrice's costume found near the victim."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Beatrice Quill was in close proximity to the victim before the murder, raising suspicion."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Dr. Finch's voice trembles as she recounts her last encounter with the victim."
      ]
    },
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 3: the clue [clue_3] (piece, fabric, killer, costume, near, victim, body) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: the clue [clue_4] (fabric, matches, costume, used, impersonation) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
...
□ Chapter 3: the clue [clue_mechanism_visibility_core] (cunning, impersonation, using, tailored, outfit, allows, killer, appear, places, creating, false, alibi) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: the clue [clue_mid_1] (tailored, suit, indicates, someone, impersonating, finch) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
