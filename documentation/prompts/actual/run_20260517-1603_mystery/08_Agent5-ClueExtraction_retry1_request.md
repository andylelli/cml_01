...
- Project ID: `unknown`
- Timestamp: `2026-05-17T16:04:37.108Z`
...
1. Generate a clue that makes the reader directly observe: "The clock in the study shows 8:20 PM when Eleanor is found...."
   → observation | essential | early | temporal | step 1 | terms: clock, study, shows

2. Generate a clue that provides evidence for: "This indicates the clock was tampered with shortly before her death...."
   → contradiction | essential | early | temporal | step 1 | terms: indicates, clock, tampered

3. Generate a clue that makes the reader directly observe: "A torn piece of paper with the correct time is found near the clock...."
   → observation | essential | early | temporal | step 2 | terms: piece, paper, correct

4. Generate a clue that provides evidence for: "This suggests someone knew the correct time and manipulated the clock...."
   → contradiction | essential | early | temporal | step 2 | terms: suggests, someone, correct

5. Generate a clue that makes the reader directly observe: "Footprints leading to the clock suggest recent interaction...."
   → observation | essential | mid | temporal | step 3 | terms: footprints, leading, clock

6. Generate a clue that provides evidence for: "Only someone familiar with Eleanor's habits would know to manipulate the clock...."
   → contradiction | essential | mid | temporal | step 3 | terms: someone, familiar, eleanor's

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "This indicates the clock was tampered with shortly before her death...."
   → contradiction | essential | mid | temporal | step 1 | terms: indicates, clock, tampered

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The mechanism relies on clock, study, and 8 to expose the false timing...."
   → observation | essential | early | temporal | terms: mechanism, relies, clock,

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "A reenactment of the time manipulation is staged, forcing Captain Hale to account for the clock's ta..."
   → observation | essential | mid | temporal | terms: reenactment, manipulation, staged,
...
Create 2 red herrings that support the false assumption: "Eleanor was murdered shortly after she last interacted with others."
...
Violations: 1. [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 1, 3; words: shortly, familiar) and may support the true solution.
Warnings: None
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 1, 3; words: shortly, familiar) and may support the true solution.
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
