...
- Project ID: ``
- Timestamp: `2026-05-17T16:03:29.516Z`
...
**Setting**: 1930s - a sprawling manor house with formal gardens and extensive grounds, often isolated from nearby towns
**Crime Type**: Murder
**Social Context**: impact of the Great Depression on social classes, rising tensions due to fascism in Europe, increased scrutiny on social hierarchies
**Tone**: Classic
