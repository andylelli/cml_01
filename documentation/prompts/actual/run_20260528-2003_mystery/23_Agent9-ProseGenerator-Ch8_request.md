...
- Project ID: ``
- Timestamp: `2026-05-28T20:15:17.435Z`
...
The investigator’s trap exposes the mechanical deceit and challenges the culprit’s alibi, heightening confrontational stakes.
...
Characters who may be funny: Eleanor Voss, Dr. Mallory Finch, Beatrice Quill, Captain Ivor Hale
Permitted forms: dry_wit, understatement, polite_savagery, self_deprecating
Rationale: Later interviews may include pointed humour reflecting rising stakes and character defensiveness.
...
• [clue_12] A blackmail threat from the victim’s estate manager to Dr. Mallory Finch is found, showing premeditation and motive.
...
• [clue_core_contradiction_chain] The clock was physically tampered with, altering its pendulum swing and causing the clock to run slower than real time, invalidating the clock’s stopped time as the time of death.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "The rain continued its steady murmur against the windows, the autumnal night deepening outside Voss Manor House. Within the clock room, the truth had begun to emerge from the shadows, its edges sharp and unsettling. Eleanor’s investigation had pierced the veil..."
...
Known location profile anchors: Voss Manor, Voss Manor Library, Servants’ Hall, Formal Gardens, Gatehouse Entrance, Voss Manor House, study
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Voss Manor", "Voss Manor Library", "Servants’ Hall", "Formal Gardens", "Gatehouse Entrance", "Voss Manor House, study"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 8: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with spoken dialogue — e.g. '"[words]," [Name] said/asked/replied/murmured.' The opening quote must be the first character on the line. Anchor opening in "Voss Manor House, study". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Phrases to avoid (already overused in earlier chapters): "in the village from half past ten", "frozen at twenty past midnight a detail", "at twenty past midnight a detail that", "slow the pendulum s swing causing the", "the pendulum s swing causing the clock", "pendulum s swing causing the clock to", "as the rain continued its steady fall", "the rain continued its steady fall outside", "dr finch s lips pressed into a", "finch s lips pressed into a thin".
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=17565; context=11572; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 8:
  ...
  - Scene is set in: Voss Manor House, study — reference it naturally within the paragraph, never as your opening phrase.
  - Opening atmosphere (MANDATORY — validator enforced): the first paragraph MUST contain at least one of: rain / wind / fog / storm / mist / thunder / evening / morning / night / dawn / dusk / season / afternoon / midday / noon / midnight / twilight / sunrise / sunset / daylight / sunlight / overcast / cloudy / bright / dark / grey / pale / cold / warm / chill / crisp / damp / drizzle / haze / lamplight / firelight. A chapter that omits all of these from its opening paragraph will be rejected.
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "The rain continued its steady murmur against the windows, the autumnal night deepening outside Voss Manor House. Within the clock room, the truth had begun to emerge from the shadows, its edges sharp and unsettling. Elea...".
...
Chapter 8 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "A blackmail threat from the victim’s estate manager to Dr. Mallory Finch is found, showing premeditation and motive"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes a motive for Dr. Finch to tamper with the clock and the victim’s death"
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor hesitates, troubled by the betrayal implicit in the blackmail"
      ]
    },
    "summary": "Eleanor discovers a blackmail threat from the victim’s estate manager directed at the doctor Finch, suggesting premeditation and a motive for tampering with the clock and the murder.",
    ...
    "emotionalRegister": "Pressure mounts as evidence converges, forcing a tense confrontation fraught with personal and social consequences.",
    ...
    "humourGuidance": {
      ...
      "form": "dry_wit",
      "condition": "Allowed only if humour is subtle and character-appropriate, avoiding any threat or violence."
    },
