...
- Project ID: ``
- Timestamp: `2026-05-28T20:09:18.809Z`
...
- YOU MUST use the exact year and month specified above: September 1938
- This date has been specifically selected for THIS mystery to ensure uniqueness
- DO NOT change the year or month - use September 1938 exactly
...
- All details must be historically accurate for September 1938 specifically
- Generate fresh, original descriptions - do not copy example phrasing
- Make this feel like the specific moment of September 1938
- OPTIONAL FIELD DEPTH REQUIREMENT: `fashion` and `seasonalActivities` must be specific and non-generic.
  ...
  - Include at least 3 seasonal activities tied to September and this location.
...
- Technology available: domestic rotary dial telephones with party-line connections, radio broadcasts as primary home entertainment and news source, manual typewriters for correspondence and record keeping
- Forensics: standard fingerprinting with local police lab processing delays, basic toxicology limited to common poisons like arsenic, emerging ballistics analysis with limited regional expertise
- Social norms: rigid class distinctions between landed gentry, staff, and local workers, formal daily routines with strict adherence to etiquette and protocol, impact of Great Depression fostering subtle class tensions within estate

Task:
1. Use the specified date: September 1938
2. Provide seasonal context for September (weather, holidays, activities appropriate for this specific month)
