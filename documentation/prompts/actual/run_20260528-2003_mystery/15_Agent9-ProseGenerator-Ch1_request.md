...
- Project ID: ``
- Timestamp: `2026-05-28T20:11:56.635Z`
...
• [clue_1] The grandfather clock’s pendulum suspension spring shows a slight deformation and oily residue inconsistent with normal wear.
  Category: physical | Criticality: essential | Supports inference step 1
  Points to: Indicates physical tampering with the clock’s pendulum mechanism.
...
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "Voss Manor House, main hall". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=6180; context=11846; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The grandfather clock’s pendulum suspension spring shows a slight deformation and oily residue inconsistent with normal wear. [clue_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: Indicates physical tampering with the clock’s pendulum mechanism.
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The grandfather clock’s pendulum suspension spring shows a slight deformation and oily residue inconsistent with normal wear"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes physical evidence of clock tampering at the crime scene"
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_1] Captain Ivor Hale mentions the butler’s log noting the grandfather clock stopped at ten minutes past eleven with no disturbances — seeds false inference about the clock’s accuracy
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor Voss pauses at the doorway, overwhelmed by grief yet determined to uncover the truth"
      ]
    },
    ...
    "emotionalRegister": "A heavy, somber mood settles over the manor as the crime is discovered, invoking shock and a sense of loss.",
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 1: "The grandfather clock’s pendulum suspension spring shows a slight deformation and oily residue inconsistent with normal wear." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
