...
- Project ID: ``
- Timestamp: `2026-05-28T20:13:09.865Z`
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Dr. Finch wrestles with the conflict between her Hippocratic duty to do no harm and the personal grudges that color her view of the family’s power struggles. The fear of losing her place fuels a quiet bitterness that she struggles to contain."
...
• [clue_5] A watch found on the victim’s desk stopped at twenty past midnight, conflicting with the grandfather clock’s stopped time of ten minutes past eleven.
  Category: physical | Criticality: essential | Supports inference step 3
  Points to: Indicates the victim’s time of death was later than the clock’s stopped time.

• [clue_6] The victim’s personal watch indicates a later time of death than the manor clock, supporting the corrected timeline over the clock’s stopped time.
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: Contradicts the false assumption that the clock’s stopped time is accurate.

• [clue_core_elimination_chain] Eliminates Captain Ivor Hale because stable hand testimony and clock chiming inconsistencies corroborate his absence from the manor grounds at the true time of death, narrowing suspicion toward Dr. Mallory Finch.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "The servants’ quarters, usually a place of routine and quiet industry, now felt charged with a fragile tension. Eleanor’s questions had unearthed a discordant note in the household’s rhythm, one that echoed the subtle betrayal embedded in the grandfather clock..."
...
Known location profile anchors: Voss Manor, Voss Manor Library, Servants’ Hall, Formal Gardens, Gatehouse Entrance, Voss Manor House, victim’s study
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Voss Manor", "Voss Manor Library", "Servants’ Hall", "Formal Gardens", "Gatehouse Entrance", "Voss Manor House, victim’s study"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 4: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a noun-phrase atmosphere — e.g. "The smell of damp stone in the cellar…" / "A chill from the landing…" / "The sound of the clock in the hall…". Pattern: "The/A [noun] of/in/from [place]…". Anchor opening in "Voss Manor House, victim’s study". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Chapter 3 (score 98/100):
  ...
  Address in upcoming chapters: Increase chapter density with concrete investigation action and sensory-grounded beats; avoid recap-only padding.
- Phrases to avoid (already overused in earlier chapters): "as the rain continued its steady fall", "the rain continued its steady fall outside", "lips pressed into a thin line".
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=10780; context=11839; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 4:
  ...
  - Scene is set in: Voss Manor House, victim’s study — reference it naturally within the paragraph, never as your opening phrase.
  - Opening atmosphere (MANDATORY — validator enforced): the first paragraph MUST contain at least one of: rain / wind / fog / storm / mist / thunder / evening / morning / night / dawn / dusk / season / afternoon / midday / noon / midnight / twilight / sunrise / sunset / daylight / sunlight / overcast / cloudy / bright / dark / grey / pale / cold / warm / chill / crisp / damp / drizzle / haze / lamplight / firelight. A chapter that omits all of these from its opening paragraph will be rejected.
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "The servants’ quarters, usually a place of routine and quiet industry, now felt charged with a fragile tension. Eleanor’s questions had unearthed a discordant note in the household’s rhythm, one that echoed the subtle be...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • A watch found on the victim’s desk stopped at twenty past midnight, conflicting with the grandfather clock’s stopped time of ten minutes past eleven. [clue_5]
      Points to: Indicates the victim’s time of death was later than the clock’s stopped time.
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "A watch found on the victim’s desk stopped at twenty past midnight, conflicting with the grandfather clock’s stopped time of ten minutes past eleven"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the victim’s time of death was later than the grandfather clock indicates, casting doubt on suspect alibis"
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor reflects quietly on the implications of the watch’s stopped time, sensing the timeline is more complex"
      ]
    },
    ...
    "emotionalRegister": "A mid-story revelation overturns the accepted timeline, injecting urgency and refocusing suspicion.",
