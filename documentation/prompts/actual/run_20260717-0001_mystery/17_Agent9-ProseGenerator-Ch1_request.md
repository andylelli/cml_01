...
- Project ID: ``
- Timestamp: `2026-07-17T00:07:22.327Z`
...
- Eleanor Voss
  Public identity anchor: Socialite and Philanthropist; suspect 
  Connection to victim: Former business partners turned rivals.; Eleanor and Hugo had a falling out over business decisions that left her in debt..
  Investigation relevance: access plausibility: high | alibi window: None | opportunity channel: Investigative access.
  Suspicion/pressure cue seed: Solving the mystery.
...
- Dr. Mallory Finch
  ...
  Investigation relevance: access plausibility: medium | alibi window: 10 minutes before death | opportunity channel: Medical knowledge.
...
- Captain Ivor Hale
  ...
  Connection to victim: directly affected by Hugo Vane's death and its fallout.
  Investigation relevance: access plausibility: high | alibi window: None | opportunity channel: Access to hotel.
  Suspicion/pressure cue seed: Honor.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Beatrice Quill
  Public identity anchor: Nurse; suspect 
  Connection to victim: directly affected by Hugo Vane's death and its fallout.
  Investigation relevance: access plausibility: medium | alibi window: 30 minutes before death | opportunity channel: Social gatherings.
  Suspicion/pre
...
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "the bar area of the Oceanview Hotel". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=8112; context=12442; dropped=[none]; truncated=[first_appearance_contracts, location_profiles, temporal_context, pronoun_accuracy]
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The faint smudge on the convex mirror above the bar."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the victim was found in the bar area, raising questions about the circumstances of their death."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_1] Witnesses insist they saw the murderer standing directly at the bar when the crime occurred.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor stands frozen, the weight of grief pressing down on her."
      ]
    },
    "summary": "As the morning sun filters through the bar's windows, Eleanor Voss arrives at the Oceanview Hotel, only to stumble upon a lifeless body sprawled across the floor. Shock ripples through the room as Dr. Mallory Finch, Captain Ivor Hale, Beatrice Quill, Sylvia Trent, and Hugo Vane gather around, their faces pale with disbelief. Eleanor notices a faint smudge on the convex mirror above the bar, hinting at a contradiction in the witness statements.",
    "beat": "gathering",
    "estimatedWordCount": 1800,
    "pivotElement": "The faint smudge on the convex mirror above the bar.",
    "factEstablished": "Establishes that the victim was found in the bar area, raising questions about the circumstances of their death.",
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_1",
      "placementDetail": "Witnesses insist they saw the murderer standing directly at the bar when the crime occurred."
    },
    "emotionalRegister": "The atmosphere is charged with suspense, setting the stage for the unfolding mystery.",
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (cleverly, placed, convex, mirror, redirects, light, altering, perceived, position, murderer) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_1] (faint, smudge, convex, mirror, near) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_3] (ligature, marks, visible, victim, throat) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
