...
- Project ID: ``
- Timestamp: `2026-07-17T00:10:11.812Z`
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Dr. Finch grapples with the guilt of her unethical practices, torn between her desire for success and the morality of her actions."
...
• [clue_core_elimination_chain] eliminates, captain, ivor, hale, because, seen, dining, room, time, murder
  Category: testimonial | Criticality: essential | Supports inference step 2
  Points to: excludes, captain, ivor, hale, suspect

• [clue_2] direction, light, shows, certain, positions, create, reflection
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: limits, possible, locations, murderer

• [clue_4] mallory, finch, observed, acting, nervously, around, convex, mirror
...
CLUES ALREADY REVEALED TO READER: clue_1, clue_3, clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_5, clue_early_1, clue_fp_contradiction_step_1 — do not reveal these as new information.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As she closed her journal, Eleanor fixed the mirror with a steady gaze. The smudge lingered at the edge of sight, a silent challenge. The truth, she knew, would be found not in a single detail, but in the way the fragments fit—or failed to fit—together. For no..."
...
- Chapter 4: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a noun-phrase atmosphere — e.g. "The smell of damp stone in the cellar…" / "A chill from the landing…" / "The sound of the clock in the hall…". Pattern: "The/A [noun] of/in/from [place]…". Anchor opening in "the bar area of the Oceanview Hotel". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=13931; context=7353; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 4:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As she closed her journal, Eleanor fixed the mirror with a steady gaze. The smudge lingered at the edge of sight, a silent challenge. The truth, she knew, would be found not in a single detail, but in the way the fragmen...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • captain, ivor, hale, presence, dining, room [clue_core_elimination_chain]
      Points to: excludes, captain, ivor, hale, suspect
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Dr. Finch's nervous behavior around the convex mirror."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Dr. Finch's alibi is shaky, casting doubt on her innocence."
  RED HERRING (MANDATORY — seed naturally, not flagged as false): [rh_2] Some witnesses claim they heard a struggle coming from the bar area.
...
[
  {
    ...
    "dramaticElements": {
      "conflict": "Accusations fly as the suspects defend themselves.",
      "tension": "Eleanor feels the weight of the investigation pressing down on her.",
      "microMomentBeats": [
        "Dr. Finch's voice trembles as she recounts her alibi, revealing a crack in her facade."
      ]
    },
    "summary": "Eleanor questions Dr. Mallory Finch, Captain Ivor Hale, and Beatrice Quill, attempting to piece together their alibis. Dr. Finch claims she was in the dining room, while Captain Hale insists he was with Beatrice. As Eleanor presses for details, she observes Dr. Finch's nervous behavior around the convex mirror, raising her suspicions.",
    "beat": "motives",
    "estimatedWordCount": 1800,
    "pivotElement": "Dr. Finch's nervous behavior around the convex mirror.",
    ...
    "redHerringPlacement": {
      "redHerringId": "rh_2",
      "placementDetail": "Some witnesses claim they heard a struggle coming from the bar area."
    },
    "emotionalRegister": "A witness's statement leads to a significant shift in the investigation's direction.",
