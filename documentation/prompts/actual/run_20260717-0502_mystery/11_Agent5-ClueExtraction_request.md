...
- Project ID: `unknown`
- Timestamp: `2026-07-17T05:04:51.434Z`
...
1. Generate a clue that makes the reader directly observe: "A half-empty bottle of poison found in Beatrice's cleaning cart...."
   → observation | essential | early | testimonial | step 1 | terms: half-empty, bottle, poison

2. Generate a clue that provides evidence for: "This poison's presence in Beatrice's cart suggests she had access to it...."
   → contradiction | essential | early | spatial | step 1 | terms: poison's, presence, beatrice's

3. Generate a clue that makes the reader directly observe: "Witnesses report seeing Beatrice enter Eleanor's room shortly before her death...."
   → observation | essential | early | temporal | step 2 | terms: witnesses, report, seeing

4. Generate a clue that provides evidence for: "Beatrice had the opportunity to administer the poison while cleaning...."
   → contradiction | essential | early | testimonial | step 2 | terms: beatrice, opportunity, administer

5. Generate a clue that makes the reader directly observe: "Test results reveal Eleanor had high levels of the poison in her bloodstream...."
   → observation | essential | mid | physical | step 3 | terms: results, reveal, eleanor

6. Generate a clue that provides evidence for: "The presence of poison directly contradicts the heart attack theory...."
   → contradiction | essential | mid | testimonial | step 3 | terms: presence, poison, directly

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "This poison's presence in Beatrice's cart suggests she had access to it...."
   → contradiction | essential | mid | spatial | step 1 | terms: poison's, presence, beatrice's

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The mechanism relies on poison, natural, and half-empty to expose the false timing...."
...
10. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "A staged reenactment where Beatrice is asked to serve a similar drink to a guest while the detective..."
   → observation | essential | mid | testimonial | terms: staged, reenactment, beatrice
...
13. Generate a clue showing observable evidence of Beatrice Quill's premeditation or planning (Desire for revenge on Eleanor for past insults). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: desire, revenge, eleanor
...
16. Generate one essential early or mid elimination clue that explicitly rules out Dr. Mallory Finch and narrows the solution toward culprit Beatrice Quill. The pointsTo text must start with "Eliminates Dr. Mallory Finch because ..." and cite corroborated evidence.
...
- Beatrice Quill: sensitive items: Cleaning schedule
...
Create 2 red herrings that support the false assumption: "Eleanor Voss died from a heart attack due to her known health issues."
