...
- Project ID: ``
- Timestamp: `2026-07-17T05:15:49.897Z`
...
• [clue_5] witnesses, confirm, mallory, finch, seen, hospital, time, death
  Category: testimonial | Criticality: supporting | Supports inference step 2
  Points to: mallory, finch, alibi

• [clue_8] eliminates, captain, ivor, hale, because, time, death
  Category: testimonial | Criticality: supporting | Supports inference step 2
  Points to: captain, ivor, hale, alibi

• [clue_late_1] presence, poison, directly, contradicts, heart, attack, theory
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Hugo lingered by the window, the distant sound of waves mingling with the muted hum of the lounge. The spring air was heavy with secrets, and the test results had shattered the last illusion of safety. The case had turned, and with it, the balance of suspicion..."
...
Known location profile anchors: The Grand Azure Hotel, The Broken Promenade, The Sapphire Lounge, The Reading Room, The Servants’ Quarters, Hotel dining area
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Grand Azure Hotel", "The Broken Promenade", "The Sapphire Lounge", "The Reading Room", "The Servants’ Quarters", "Hotel dining area"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 7: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "Hotel dining area". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Chapter 7:
  ...
  - Scene is set in: Hotel dining area — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Hugo lingered by the window, the distant sound of waves mingling with the muted hum of the lounge. The spring air was heavy with secrets, and the test results had shattered the last illusion of safety. The case had turne...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • mallory, finch, noted, hospital [clue_5]
      Points to: mallory, finch, alibi
    • witnesses, confirm, captain, ivor, hale [clue_8]
      Points to: captain, ivor, hale, alibi
...
Chapter 7 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Beatrice's anxious reaction as she serves the drink."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Prepares the stage for revealing Beatrice's guilt through her behavior."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Hugo's heart races as he watches Beatrice's hands shake."
      ]
    },
    ...
    "emotionalRegister": "Pressure mounts as the detective closes in, with revelations threatening to unravel the fabric of trust.",
