...
- Timestamp: `2026-06-14T13:42:59.076Z`
...
- Jane O'Connor
  Public identity anchor: Young Journalist; Detective 
  ...
  Suspicion/pressure cue seed: Calm and observant.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Colin Enright
  Public identity anchor: Family Lawyer; Suspect 
  Connection to victim: directly tied to the victim's social circle.
  Investigation relevance: access plausibility: high | alibi window: 10:00 PM - 11:30 PM | opportunity channel: Business dealings.
  Suspicion/pressure cue seed: Nervous fidgeting.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.
...
• [clue_7] The clock was tampered with to show a later time, misleading the investigation regarding the time of death.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: This reveals the mechanism of deception.

• [clue_culprit_direct_colin_enright] Direct evidence ties Colin Enright to the mechanism access point before the discriminating test.
  Category: temporal | Criticality: essential | Supports inference step 1
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=7067; context=10234; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - VICTIM IDENTITY LOCK (MANDATORY): name the victim as "Brian Scanlon" in the discovery scene. After first mention, do not use unnamed placeholders such as "the victim" without naming Brian Scanlon in the same paragraph.
  ...
  - INVESTIGATOR ESTABLISHMENT REQUIRED: Jane O'Connor must claim or be recognised as the investigator in this chapter. Establish Jane O'Connor as the detective-in-charge within the first two paragraphs — Jane O'Connor IS the investigator. Do NOT have any character suggest a "real" detective is still coming, or imply that authority has not yet been delegated. Jane O'Connor begins the investigation in this chapter.
...
[
  {
    ...
    "setting": {
      ...
      "atmosphere": "Tense and somber as guests gather"
    },
    "characters": [
      "Jane O'Connor",
      "Colin Enright",
    ...
    "dramaticElements": {
      ...
      "tension": "Guests are anxious and suspicious of each other",
      "microMomentBeats": [
        "Colin stares blankly at the floor, trying to comprehend the horror."
      ]
    },
    "summary": "As the guests gather in the study, they discover Brian Scanlon's lifeless body sprawled across the floor. Jane O'Connor, a local resident, is among them, and her shock quickly turns to determination to uncover the truth. Tension mounts as Colin Enright, Carol Molloy, and Sean Murphy stand nearby, each looking guilty. The clock on the wall shows ten minutes past eleven, raising immediate questions about the time of death.",
    "estimatedWordCount": 1250,
    "emotionalRegister": "The atmosphere is thick with tension and uncertainty following the murder.",
...
□ Chapter 1: "The clock was tampered with to show a later time, misleading the investigation regarding the time of death." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: "Direct evidence ties Colin Enright to the mechanism access point before the discriminating test." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
