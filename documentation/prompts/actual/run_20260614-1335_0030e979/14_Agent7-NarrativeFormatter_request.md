...
- Timestamp: `2026-06-14T13:42:38.513Z`
...
1. In Act III, include at least one scene where the detective explains why each non-culprit suspect is cleared with explicit elimination language (cleared, ruled out, alibi confirmed) and evidence references. The culprit (Colin Enright) must be identified with a complete evidence chain.
