...
- Project ID: ``
- Timestamp: `2026-07-21T19:40:08.325Z`
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Ivor is haunted by guilt over his wartime actions, torn between the desire to protect his legacy and the truth of his past."
...
Act 2 behaviour contract: May show unease, evasion, or mild defensiveness when questioned. One behavioural tell is permitted. Internal conflict emerging: "Sylvia is torn between maintaining her status and the growing weight of guilt over her embezzlement, a conflict that threatens her carefully constructed world."
...
• [clue_6] eliminates, captain, ivor, hale, because, seen, conversing, guests, eight, clock, evening
  Category: elimination | Criticality: essential | Supports inference step 2
  Points to: captain, ivor, hale, cannot, murderer

• [clue_7] eliminates, sylvia, trent, because, seen, leaving, party, seven, clock, evening
  Category: elimination | Criticality: essential | Supports inference step 2
  Points to: sylvia, trent, cannot, murderer

• [clue_fp_contradiction_step_3] tide, schedule, indicates, time, party
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "He let the silence stretch, the only sound the faint crackle of the fire and the whisper of pages turning somewhere deep among the stacks. The investigation had reached a new threshold: Dr. Finch and Beatrice both had reasons to wish Eleanor harm, and neither..."
...
Known location profile anchors: The Crestview Hotel, Grand Lobby, The Ocean View Dining Room, The Seaside Terrace, The Library, Seaside Hotel - Front Porch
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Crestview Hotel", "Grand Lobby", "The Ocean View Dining Room", "The Seaside Terrace", "The Library", "Seaside Hotel - Front Porch"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 5: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a temporal subordinate clause — e.g. "When [Name] entered…" / "After the last guest…" / "Before the household had stirred…" / "As the light faded…". Anchor opening in "Seaside Hotel - Front Porch". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=14588; context=6925; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, continuity_context, pronoun_accuracy]
...
- clue_4 must appear in Act 2, Scene 2 via Witness statement
...
- Chapter 5:
  ...
  - Scene is set in: Seaside Hotel - Front Porch — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "He let the silence stretch, the only sound the faint crackle of the fire and the whisper of pages turning somewhere deep among the stacks. The investigation had reached a new threshold: Dr. Finch and Beatrice both had re...".
  ...
  - PLANT OBLIGATIONS (incidental appearances): each item below MUST appear in this chapter as a passing physical detail a character sees, handles, or walks past — with its significance UNFLAGGED:
    • comparison, tide, schedule, witness, accounts [plant:clue_4]
    • tide, gauge, indicating, seven, feet [plant:clue_12]
...
Chapter 5 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Captain Hale's assertion of being with guests at eight o'clock."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that both Hale and Sylvia's alibis are potentially false."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Captain Hale's face flushes as he struggles to maintain his composure under questioning."
      ]
    },
    ...
    "emotionalRegister": "A significant revelation changes the direction of the investigation, exposing hidden motives.",
