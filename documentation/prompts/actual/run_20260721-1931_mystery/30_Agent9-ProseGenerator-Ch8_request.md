...
- Project ID: ``
- Timestamp: `2026-07-21T19:42:33.033Z`
...
• [clue_id_1] witnesses, noted, tide, party
  Category: testimonial | Criticality: essential | Supports inference step 1
  Points to: timeline, aligns, tide

• [clue_id_2] tide, gauge, shows, water, levels, party
  Category: temporal | Criticality: essential | Supports inference step 2
  Points to: eleanor, drowned, high, tide

• [clue_late_optional_slot_1] seven, clock, evening, party, begins, remains, late, texture, detail, case, background
...
CLUES ALREADY REVEALED TO READER: clue_mechanism_visibility_core, clue_core_contradiction_chain, clue_11, clue_9, clue_fp_contradiction_step_1, clue_5, clue_8, clue_id_3, clue_6, clue_7, clue_fp_contradiction_step_3, clue_3, clue_10, clue_4, clue_12 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): confrontation, occurred, shortly, before, death | eleanor, drowned, high, tide | timeline, aligns, tide | eleanor, likely, dangerous, situation, before, death | suggests, confrontation, occurred, shortly, before, death | mallory, finch, motives, related, professional, jealousy | connection, murder | eleanor, drowned, claimed, time, tide | captain, ivor, hale, cannot, murderer | sylvia, trent, cannot, murderer | eleanor, drowned, claimed, time, tide | eleanor, drowned, claimed, time, tide | eleanor, drowned | timeline, events, inconsistent, drowning, claim | claim, drowning, high, tide, false
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the group dispersed, tension lingered in the air, thick as the wintry fog outside. Hugo remained by the table, his heart racing, his mind whirring with possibilities. The trap had been set, the truth forced into the open by the cold, impartial evidence. But..."
...
This is a **constraint proof** test. The detective must:

**Test mechanism (paraphrase — do NOT copy verbatim):**
Render this test MECHANISM as live, in-scene action and dialogue, composing ENTIRELY in your own words from these elements (reproducing any briefing phrase verbatim FAILS validation): tide, schedule, witness, accounts, reveals, impossibility, drowning, party

**MANDATORY CHECKLIST - Every box must be checked:**

☐ **Evidence Integration**
  ☐ Explicitly reference or use clue: "clue_4" (clue) (appears in Act 2, Scene 2)
  ☐ Explicitly reference or use clue: "clue_11" (clue) (appears in Act 1, Scene 3)
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=21337; context=4970; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, character_contracts, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 8:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the group dispersed, tension lingered in the air, thick as the wintry fog outside. Hugo remained by the table, his heart racing, his mind whirring with possibilities. The trap had been set, the truth forced into the o...".
    ...
    • tide, gauge, indicating, water, levels [clue_id_2] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      ...
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         ...
         Paragraph 2 (immediately following): The detective or POV character explicitly reasons
           about what this evidence implies — who it implicates, why it may be unreliable,
           or what inference it supports. This must be a separate full paragraph, not a sentence appended to Paragraph 1.
    • seven, clock, evening, party, begins, remains, late, texture, detail, case, background [clue_late_optional_slot_1]
      Points to: adds, late, texture, changing, essential, deduction, chain
  ...
  - ⚠ DISCRIMINATING TEST (constraint_proof) — MANDATORY real-time scene with dialogue and confrontation. DO NOT summarize it after the fact.
    ...
    Elements the test must dramatize (compose the scene ENTIRELY in your own sentences from these — reproducing any briefing phrase verbatim FAILS validation): tide, schedule, witness, accounts, reveals, impossibility, drowning, party
    Cite these already-revealed clue IDs during the test: clue_4, clue_11, clue_12, clue_id_1
...
Chapter 8 (Act 3) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Witness testimony confirming each suspect's alibi."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Captain Hale exhales sharply, relief washing over him as his alibi holds up."
      ]
    },
    ...
    "emotionalRegister": "The confrontation culminates in a dramatic reveal, forcing characters to face the consequences of their actions.",
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 8: the clue [clue_id_1] (witnesses, noted, tide, party) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 8: the clue [clue_id_2] (tide, gauge, shows, water, levels, party) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
