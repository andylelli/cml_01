...
- Project ID: ``
- Timestamp: `2026-07-21T19:36:43.787Z`
...
- Hugo Vane
  ...
  Suspicion/pressure cue seed: Observant and analytical.
...
The atmosphere is charged with anticipation as guests gather, overshadowed by the impending tragedy.
...
• [clue_mechanism_visibility_core] witnesses, recall, eleanor, arguing, captain, hale, near, water, edge
  Category: testimonial | Criticality: essential | Supports inference step 1
  Points to: confrontation, occurred, shortly, before, death
...
Known location profile anchors: The Crestview Hotel, Grand Lobby, The Ocean View Dining Room, The Seaside Terrace, The Library, Seaside Hotel
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "The Crestview Hotel", "Grand Lobby", "The Ocean View Dining Room", "The Seaside Terrace", "The Library", "Seaside Hotel"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 1: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "Seaside Hotel". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=7686; context=9476; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - Scene is set in: Seaside Hotel — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • witnesses, observing, argument, eleanor, captain, hale [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
  ...
  - PLANT OBLIGATIONS (incidental appearances): each item below MUST appear in this chapter as a passing physical detail a character sees, handles, or walks past — with its significance UNFLAGGED:
    • witnesses, recalling, tide, levels [plant:clue_11]
    • witnesses, recalling, eleanor, presence, near, water [plant:clue_9]
    • witnesses, observing, argument, eleanor, captain, hale [plant:clue_fp_contradiction_step_1]
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "Eleanor's lifeless body found at the water's edge."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that Eleanor Voss has drowned, raising immediate questions about the circumstances."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor stares blankly at the waves, her face pale with shock."
      ]
    },
    ...
    "emotionalRegister": "The atmosphere is charged with anticipation as guests gather, overshadowed by the impending tragedy.",
    "dominantCharacterNote": {
      "name": "Eleanor Voss",
      "voiceRegister": "Eleanor's speech is marked by a refined cadence, often laced with sharp wit that deflects probing inquiries."
    },
    "humourGuidance": {
      "permission": "forbidden"
    },
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (witnesses, recall, eleanor, arguing, captain, hale, near, water, edge) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
