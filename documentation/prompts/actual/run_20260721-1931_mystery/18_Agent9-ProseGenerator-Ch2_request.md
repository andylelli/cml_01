...
- Project ID: ``
- Timestamp: `2026-07-21T19:37:17.227Z`
...
Act 1 behaviour contract: Show normal social behaviour; grief or confusion if appropriate. No guilt signals permitted. Hidden motive: "The victim's intention to publish a damaging article about Mallory's past unethical practices serves as a catalyst for her potential involvement." — do not surface in Act I.
...
• [clue_core_contradiction_chain] tide, gauge, shows, water, levels, party
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the constable’s footsteps echoed up the path, Hugo straightened and drew a long, steadying breath. He was the investigator now, whether by choice or necessity. The truth, he suspected, would be as treacherous as the tides that had claimed Eleanor Voss. But..."
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=9454; context=11985; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 2:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the constable’s footsteps echoed up the path, Hugo straightened and drew a long, steadying breath. He was the investigator now, whether by choice or necessity. The truth, he suspected, would be as treacherous as the t...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • tide, gauge, indicating, water, levels [clue_core_contradiction_chain] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: eleanor, drowned, high, tide
  ...
  - PLANT OBLIGATIONS (incidental appearances): each item below MUST appear in this chapter as a passing physical detail a character sees, handles, or walks past — with its significance UNFLAGGED:
    • mallory, finch, meticulously, arranging, items, party [plant:clue_5]
    • footprints, sand, leading, towards, water [plant:clue_8]
    • tide, schedule, showing, party, time [plant:clue_id_3]
...
Chapter 2 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The tide gauge displaying low water levels."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that there are conflicting statements regarding the tide levels at the time of Eleanor's drowning."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Captain Hale clenches his jaw, his eyes darting nervously as accusations fly."
      ]
    },
...
□ Forbidden seasonal words: spring, summer, autumn.
□ Chapter 2: the clue [clue_core_contradiction_chain] (tide, gauge, shows, water, levels, party) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
