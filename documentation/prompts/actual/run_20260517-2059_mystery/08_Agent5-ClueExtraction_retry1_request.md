...
- Project ID: `unknown`
- Timestamp: `2026-05-17T21:00:21.422Z`
...
1. Generate a clue that makes the reader directly observe: "The clock in the library shows the hands are slightly askew...."
   → observation | essential | early | temporal | step 1 | terms: clock, library, shows

2. Generate a clue that provides evidence for: "This suggests tampering occurred just before the murder...."
   → contradiction | essential | early | temporal | step 1 | terms: suggests, tampering, occurred
...
4. Generate a clue that provides evidence for: "This indicates recent manipulation of the clock mechanism...."
   → contradiction | essential | early | temporal | step 2 | terms: indicates, recent, manipulation

5. Generate a clue that makes the reader directly observe: "Witnesses say the clock struck a different time than their recollection...."
   → observation | essential | mid | temporal | step 3 | terms: witnesses, clock, struck

6. Generate a clue that provides evidence for: "This discrepancy suggests the clock was altered to mislead...."
   → contradiction | essential | mid | temporal | step 3 | terms: discrepancy, suggests, clock

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "This suggests tampering occurred just before the murder...."
   → contradiction | essential | mid | temporal | step 1 | terms: suggests, tampering, occurred

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The mechanism relies on clock, library, and slightly to expose the false timing...."
   → observation | essential | early | temporal | terms: mechanism, relies, clock,

9. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Comparing the clock time with witness accounts reveals the tampering...."
   → observation | essential | mid | temporal | terms: comparing, clock, witness
...
11. Generate a clue showing observable evidence of Dr. Mallory Finch's premeditation or planning (Professional jealousy). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
...
Create 2 red herrings that support the false assumption: "Eleanor Voss must have been alive for longer than indicated by the evidence."
...
- required_direct_culprit_clue:
  ...
  - allowed_source_paths=CASE.cast[1].access_plausibility, CASE.cast[1].alibi_window, CASE.inference_path.steps[0].observation, CASE.inference_path.steps[0].correction
