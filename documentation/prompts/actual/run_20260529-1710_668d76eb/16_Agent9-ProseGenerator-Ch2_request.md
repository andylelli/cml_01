...
- Timestamp: `2026-05-29T17:20:12.405Z`
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "With that, the inspector stepped back into the main hall, his eyes once again drawn to the silent clock. Time had been manipulated here, but the truth would not be so easily concealed. The game was afoot, and the shadows of Ashcombe Manor held their secrets cl..."
...
study, drawing room, garden, manor
...
Known location profile anchors: Ashcombe Manor, Ashcombe Manor Woodland Clearing, Ashcombe Manor Library, Servants’ Hall, Ashcombe Manor Gatehouse, Manor clock room
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Ashcombe Manor", "Ashcombe Manor Woodland Clearing", "Ashcombe Manor Library", "Servants’ Hall", "Ashcombe Manor Gatehouse", "Manor clock room"
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=8097; context=10845; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 2:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "With that, the inspector stepped back into the main hall, his eyes once again drawn to the silent clock. Time had been manipulated here, but the truth would not be so easily concealed. The game was afoot, and the shadows...".
...
[
  {
    ...
    "humourGuidance": {
      ...
      "form": "dry_wit",
      "condition": "Humour is permitted only as subtle dry wit from Inspector Hargrave to highlight contradictions without breaking tension."
    },
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 2: "The clock was recently wound backward, which is mechanically difficult and leaves distinct marks on the winding mechanism." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
□ Chapter 2: "Scratch marks on the clock winding key show wear inconsistent with normal forward winding, indicating tampering." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
