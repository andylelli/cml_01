...
- Timestamp: `2026-05-29T17:34:50.763Z`
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=43401; context=4430; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, continuity_context, pronoun_accuracy]
...
8. RETRY MITIGATION: Split-chapter mode is active. Use at least 4 substantial paragraphs per chapter with explicit scene transitions.
...
```text
Attempt 3/6 — chapters 20 — 1 validation issue(s) to resolve:

═══ PROSE QUALITY ERRORS (1) ═══
• Chapter 20 marked non-convergent after attempt 2/6: structure
