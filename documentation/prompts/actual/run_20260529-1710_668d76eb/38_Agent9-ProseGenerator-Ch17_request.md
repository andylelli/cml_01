...
- Timestamp: `2026-05-29T17:30:20.334Z`
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=36152; context=4425; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
```text
Attempt 3/6 — chapters 17 — 1 validation issue(s) to resolve:

═══ PROSE QUALITY ERRORS (1) ═══
• Chapter 17 marked non-convergent after attempt 2/6: template
