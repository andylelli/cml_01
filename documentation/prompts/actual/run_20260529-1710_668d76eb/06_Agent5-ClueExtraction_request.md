...
- Timestamp: `2026-05-29T17:13:03.178Z`
...
**Cast**: 5 characters
**Requested density**: moderate
**Effective density**: dense (auto-escalated to satisfy mandatory requirements)

## Mandatory Clue Requirements (16 required)
1. Generate a clue that makes the reader directly observe: "Scratch marks on the clock winding key show wear inconsistent with normal forward winding...."
   → observation | essential | early | temporal | step 1 | terms: scratch, marks, clock

2. Generate a clue that provides evidence for: "The clock was recently wound backward, which is mechanically difficult and leaves distinct marks...."
   → contradiction | essential | early | temporal | step 1 | terms: clock, recently, wound

3. Generate a clue that makes the reader directly observe: "The gardener’s diary notes the sun’s position and corresponding shadow angle at half past ten, match..."
   → observation | essential | early | testimonial | step 2 | terms: gardener’s, diary, notes

4. Generate a clue that provides evidence for: "Henry Pritchard was near the garden gate at half past ten, verified by shadow geometry, contradictin..."
   → contradiction | essential | early | temporal | step 2 | terms: henry, pritchard, garden

5. Generate a clue that makes the reader directly observe: "Staff bell logs and kitchen duty rosters confirm Margaret Blythe was in the kitchen between ten and ..."
   → observation | essential | mid | temporal | step 3 | terms: staff, kitchen, rosters

6. Generate a clue that provides evidence for: "Margaret’s alibi is solid for the true murder time after eleven forty, removing her from suspicion...."
   → contradiction | essential | mid | temporal | step 3 | terms: margaret’s, alibi, solid

7. Generate a clue that makes the reader directly observe: "Evelyn Ashcombe’s claimed presence in the drawing room between nine and eleven conflicts with the co..."
   → observation | essential | mid | temporal | step 4 | terms: evelyn, ashcombe’s, claimed

8. Generate a clue that provides evidence for: "Evelyn’s alibi only covers the falsified clock time; she had opportunity during the true murder wind..."
   → contradiction | essential | mid | temporal | step 4 | terms: evelyn’s, alibi, covers

9. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The clock was recently wound backward, which is mechanically difficult and leaves distinct marks...."
   → contradiction | essential | mid | temporal | step 1 | terms: clock, recently, wound

10. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The murderer wound the manor clock backward by forty minutes to create a false timeline placing the victim’s death earlier than it actually ..."
   → observation | essential | early | temporal | terms: murderer, wound, manor

11. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "A controlled comparison is conducted between the clock’s mainspring tension and the timing of the la..."
   → observation | essential | mid | temporal | terms: controlled, comparison, conducted

12. Generate one essential mid-story clue whose description or pointsTo explicitly names Evelyn Ashcombe and states the unique trace, preparation detail, or mechanism link that points to Evelyn Ashcombe rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Evelyn Ashcombe, murderer, wound, manor

13. Generate a clue showing observable evidence of Evelyn Ashcombe's premeditation or planning (Financial control and family honor at risk). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: financial, control, family

14. Generate a clue that explicitly eliminates suspect Margaret Blythe using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Margaret Blythe because ...").
   → elimination | essential | mid | testimonial | terms: Margaret Blythe

15. Generate a clue that explicitly eliminates suspect Henry Pritchard using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Henry Pritchard because ...").
   → elimination | essential | mid | testimonial | terms: Henry Pritchard

16. Generate one essential early or mid elimination clue that explicitly rules out Margaret Blythe and narrows the solution toward culprit Evelyn Ashcombe. The pointsTo text must start with "Eliminates Margaret Blythe because ..." and cite corroborated evidence.
   → elimination | essential | mid | testimonial | terms: Margaret Blythe, Evelyn Ashcombe
...
## Access Constraints
Actors: Evelyn Ashcombe, Margaret Blythe, Henry Pritchard, Charles Wentworth
Objects: Library clock, Winding key, Garden gate, Staff bell
...
- Inspector Lionel Hargrave: sensitive items: Clock mechanics, Witness testimonies
- Evelyn Ashcombe: sensitive items: Alibi integrity, Access to victim
- Charles Wentworth: sensitive items: Time of death, Last known movements
- Margaret Blythe: sensitive items: Clock mechanics, Staff schedules
- Henry Pritchard: sensitive items: Shadow angles, Movement timings
...
- constraint_space.time.contradictions index range: 0..4
- cast index range: 0..4

## Cast Name -> Index Map (for CASE.cast[N] paths)
- Inspector Lionel Hargrave -> 0
- Evelyn Ashcombe -> 1
- Charles Wentworth -> 2
- Margaret Blythe -> 3
- Henry Pritchard -> 4
...
Create 2 red herrings that support the false assumption: "The manor clock’s stopped time accurately indicates the time of death, and all witness alibis are based on this correct clock time."
...
- CASE.constraint_space.time.contradictions[4]
