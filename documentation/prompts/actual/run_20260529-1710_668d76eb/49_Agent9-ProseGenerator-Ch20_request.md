...
- Timestamp: `2026-05-29T17:35:16.383Z`
...
```text
{
  ...
  "chapters": [
    {
      ...
      "paragraphs": [
        ...
        "The aftermath was somber. Charles Wentworth sat quietly, the burden of family legacy etched deeply upon his face. Margaret Blythe’s steady presence was a reminder of the household’s enduring order amid upheaval. Henry Pritchard, cleared by immutable natural evidence, maintained a wary distance from the unfolding drama. The fragile restoration of order was tempered by the knowledge that the mechanism of this crime carried a moral grayness—justice had been served, but at a cost that would haunt the manor’s inhabitants for years to come."
      ]
    }
  ],
  "cast": [
  ...
  "note": "Chapter 20 provides the final confrontation and resolution, fulfilling all mandatory elements including suspect clearances, confession, method explanation, consequence, and emotional aftermath, with varied paragraph lengths and rich sensory details.",
  "audit": {
...
```text
Attempt 4/6 — chapters 20 — 2 validation issue(s) to resolve:
