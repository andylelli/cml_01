...
- Timestamp: `2026-05-29T17:36:06.997Z`
...
```text
Attempt 6/6 — chapters 20 — 1 validation issue(s) to resolve:
...
Write chapters 20 completely from scratch. Satisfy EVERY constraint listed above in a single pass.
