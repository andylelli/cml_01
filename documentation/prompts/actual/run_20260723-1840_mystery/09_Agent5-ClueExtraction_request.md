...
- Project ID: `unknown`
- Timestamp: `2026-07-23T18:42:21.023Z`
...
1. Generate a clue that makes the reader directly observe: "Witnesses recall seeing Dr. Finch in a blue dress at the time of the murder...."
   → observation | essential | early | temporal | step 1 | terms: witnesses, recall, seeing

2. Generate a clue that provides evidence for: "Dr. Finch was not wearing the blue dress later described by witnesses, indicating she may have switc..."
   → contradiction | essential | early | testimonial | step 1 | terms: finch, wearing, dress

3. Generate a clue that makes the reader directly observe: "A pair of shoes with a distinctive tread pattern matching Captain Hale's was found near the scene...."
   → observation | essential | early | behavioral | step 2 | terms: shoes, distinctive, tread

4. Generate a clue that provides evidence for: "The tread pattern indicates that Captain Hale was present at the scene...."
   → contradiction | essential | early | behavioral | step 2 | terms: tread, pattern, indicates

5. Generate a clue that makes the reader directly observe: "Hotel logs show discrepancies in the timeline of events...."
   → observation | essential | mid | temporal | step 3 | terms: hotel, discrepancies, timeline

6. Generate a clue that provides evidence for: "The logs indicate that the murder occurred during a time when Hale was supposedly impersonating Finc..."
   → contradiction | essential | mid | temporal | step 3 | terms: indicate, murder, occurred

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "Dr. Finch was not wearing the blue dress later described by witnesses, indicating she may have switched outfits...."
   → contradiction | essential | mid | testimonial | step 1 | terms: finch, wearing, dress

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The mechanism relies on witness, recall, and seeing to expose the false timing...."
   → observation | essential | early | testimonial | terms: mechanism, relies, witness,

9. Generate one essential EARLY clue giving a concrete, fair-play indicator of the manner of death (strangled) observable at the body-discovery scene — e.g. for strangulation: ligature marks, petechiae in the eyes, or a disturbed collar. Do NOT name or explain the concealment trick; only the physical tell a witness could see at the scene.
   → observation | essential | early | testimonial | terms: strangled, ligature, marks, throat, collar, petechiae, bruis

10. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "Reenact witnesses' accounts of the evening to see if they can identify the real Captain Hale...."
   → observation | essential | mid | testimonial | terms: reenact, witnesses', accounts

11. Generate one essential mid-story clue whose description or pointsTo explicitly names Captain Ivor Hale and states the unique trace, preparation detail, or mechanism link that points to Captain Ivor Hale rather than any non-culprit.
   → observation | essential | mid | testimonial | terms: Captain Ivor Hale, mechanism, relies, witness,

12. Generate one essential early-or-mid clue establishing that Captain Ivor Hale UNIQUELY had the means/skill/access/knowledge required to execute the concealment mechanism, and that the other suspects did not — so the reveal relies only on this already-planted capability, never on a means introduced for the first time at the confrontation.
   → elimination | essential | mid | testimonial | terms: Captain Ivor Hale, mechanism, relies, witness,

13. Generate a clue showing observable evidence of Captain Ivor Hale's premeditation or planning (Blackmail). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: blackmail

14. Generate a clue that explicitly eliminates suspect Dr. Mallory Finch using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Dr. Mallory Finch because ...").
   → elimination | essential | mid | testimonial | terms: Dr. Mallory Finch

15. Generate a clue that explicitly eliminates suspect Beatrice Quill using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Beatrice Quill because ...").
   → elimination | essential | mid | testimonial | terms: Beatrice Quill

16. Generate a clue that explicitly eliminates suspect Sylvia Trent using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Sylvia Trent because ...").
   → elimination | essential | mid | testimonial | terms: Sylvia Trent

17. Generate one essential early or mid elimination clue that explicitly rules out Dr. Mallory Finch and narrows the solution toward culprit Captain Ivor Hale. The pointsTo text must start with "Eliminates Dr. Mallory Finch because ..." and cite corroborated evidence.
...
Create 2 red herrings that support the false assumption: "Dr. Mallory Finch was with Eleanor Voss at the time of the murder."
...
- **time_of_signal**: "ten minutes past eight" — The exact time the suspects switched locations, pivotal to the alibi.
- **witness_hat_color**: "red" — The color of the hat matching the suspect's outfit, noted by witnesses.
...
- STRICT STRUCTURAL CONTRACT (author ALL of these YOURSELF, as concrete scene-register clues — a character sees/hears/finds something. NEVER meta-boilerplate like "adds texture to the case background"; if you omit any, a deterministic pass will synthesize flat machine text in its place, which reads as machine-made):
    • REQUIRED ID: "clue_culprit_direct_captain_ivor_hale" with sourceInCML=CASE.cast[2].alibi_window
    • REQUIRED ID: "clue_early_1" with sourceInCML=CASE.prose_requirements.clue_to_scene_mapping[0].clue_id
    • REQUIRED ID: "clue_mid_1" with sourceInCML=CASE.prose_requirements.clue_to_scene_mapping[1].clue_id
    • REQUIRED ID: "clue_late_1" with sourceInCML=CASE.prose_requirements.clue_to_scene_mapping[2].clue_id
    • DIRECT CULPRIT CLUE: id="clue_culprit_direct_captain_ivor_hale" — observable evidence tying Captain Ivor Hale uniquely to the crime (source from: CASE.cast[2].alibi_window, CASE.cast[2].access_plausibility, CASE.inference_path.steps[1].observation, CASE.inference_path.steps[1].correction, CASE.inference_path.steps[2].observation, CASE.inference_path.steps[2].correction); the pointsTo must include: Captain Ivor Hale, direct evidence, means and opportunity, no other eligible suspect
