...
- Project ID: ``
- Timestamp: `2026-07-23T18:43:35.072Z`
...
- Era-authentic markers: radio broadcasting, early television sets, military radar, rationed fuel for automobiles, post-war automobile boom, public transportation via buses, long-distance telephone calls, military encryption methods
- Tone: Classic
- No anachronisms
...
Description: A modest seaside hotel with Art Deco influences, featuring ocean views and a rustic charm, frequented by both locals and tourists.
...
Setting constraints:
- Physical constraints: narrow hallways limiting movement, fire escapes only accessible from certain floors, common areas subject to guest privacy
- Geographic isolation: Situated on a remote stretch of coastline, the hotel is several miles from the nearest town, limiting outside assistance.
- Access control: staff-only areas such as the kitchen and service corridors, restricted access to guest rooms without permission, security measures at the front desk for visitor logging
...
- Social norms: women entering the workforce, post-war societal adjustments
