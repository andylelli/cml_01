...
- Project ID: `unknown`
- Timestamp: `2026-05-17T13:10:02.894Z`
...
2. Generate a clue that provides evidence for: "The time shown on the clock does not reflect the actual time of death...."
   → contradiction | essential | early | temporal | step 1 | terms: shown, clock, reflect

3. Generate a clue that makes the reader directly observe: "A note found in Eleanor's study references an appointment at midnight...."
   → observation | essential | early | testimonial | step 2 | terms: found, eleanor's, study

4. Generate a clue that provides evidence for: "The appointment indicates Eleanor was alive and had plans beyond the clock's indicated time...."
   → contradiction | essential | early | temporal | step 2 | terms: appointment, indicates, eleanor

5. Generate a clue that makes the reader directly observe: "Footprints leading away from the study suggest a hasty exit...."
   → observation | essential | mid | physical | step 3 | terms: footprints, leading, study

6. Generate a clue that provides evidence for: "The footprints indicate someone left the scene quickly after the time of death...."
   → contradiction | essential | mid | temporal | step 3 | terms: footprints, indicate, someone

7. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The time shown on the clock does not reflect the actual time of death...."
   → contradiction | essential | mid | temporal | step 1 | terms: shown, clock, reflect

8. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The clock in the study was adjusted to mislead the timing of Eleanor's death...."
   → observation | essential | early | temporal | terms: clock, study, adjusted
...
10. Generate one essential mid-story clue whose description or pointsTo explicitly names Captain Ivor Hale and states the unique trace, preparation detail, or mechanism link that points to Captain Ivor Hale rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Captain Ivor Hale, clock, study, adjusted

11. Generate a clue showing observable evidence of Captain Ivor Hale's premeditation or planning (inheritance from Eleanor). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: inheritance, eleanor
...
Create 2 red herrings that support the false assumption: "Eleanor Voss was murdered at ten minutes past eleven."
...
- If any target mentions red-herring overlap, include rewrite table entries as: old phrase -> replacement phrase.
    ...
    - violation_codes[]:
      - none
- must_fix[]:
  - [critical] Red Herring Separation: Red herring rh_1 overlaps inference corrections (steps: 1, 2; words: clock, eleanor) and may support the true solution.
  - [critical] Red Herring Separation: Red herring rh_2 overlaps inference corrections (steps: 3; words: footprints, someone, scene) and may support the true solution.
    - targeted_clue_ids[]:
      - none
    - preserve_clue_ids[]:
      - none
