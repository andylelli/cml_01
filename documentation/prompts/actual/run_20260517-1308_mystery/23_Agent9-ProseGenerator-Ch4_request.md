...
- Project ID: ``
- Timestamp: `2026-05-17T13:13:34.894Z`
...
• [clue_3] Footprints leading away from the study suggest a hasty exit.
  Category: physical | Criticality: essential | Supports inference step 3
  Points to: Someone left the study quickly.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As they prepared to confront the others, Beatrice felt a surge of determination. The note in her hand felt heavy with the promise of revelations yet to come. The clock may have stopped, but their investigation was just beginning. Each question posed would peel..."
...
Known location profile anchors: Middleton Hall, The Drawing Room, The Library, The Servants' Hall, The Central Courtyard, the hallway outside the study
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Middleton Hall", "The Drawing Room", "The Library", "The Servants' Hall", "The Central Courtyard", "the hallway outside the study"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 4: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a noun-phrase atmosphere — e.g. "The smell of damp stone in the cellar…" / "A chill from the landing…" / "The sound of the clock in the hall…". Pattern: "The/A [noun] of/in/from [place]…". Anchor opening in "the hallway outside the study". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Phrases to avoid (already overused in earlier chapters): "beatrice felt a chill run through her", "the notion that eleanor had been alive", "notion that eleanor had been alive long", "that eleanor had been alive long after", "eleanor had been alive long after the", "had been alive long after the clock", "been alive long after the clock had", "alive long after the clock had stopped", "long after the clock had stopped filled", "after the clock had stopped filled her".
[END INTERNAL DIAGNOSTICS]

PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=9331; context=11320; dropped=[none]; truncated=[pronoun_accuracy, temporal_context]
...
- Chapter 4:
  ...
  - Scene is set in: the hallway outside the study — reference it naturally within the paragraph, never as your opening phrase.
  - Opening atmosphere (MANDATORY — validator enforced): the first paragraph MUST contain at least one of: rain / wind / fog / storm / mist / thunder / evening / morning / night / dawn / dusk / season / afternoon / midday / noon / midnight / twilight / sunrise / sunset / daylight / sunlight / overcast / cloudy / bright / dark / grey / pale / cold / warm / chill / crisp / damp / drizzle / haze / lamplight / firelight. A chapter that omits all of these from its opening paragraph will be rejected.
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As they prepared to confront the others, Beatrice felt a surge of determination. The note in her hand felt heavy with the promise of revelations yet to come. The clock may have stopped, but their investigation was just b...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • Footprints leading away from the study suggest a hasty exit. [clue_3]
      Points to: Someone left the study quickly.
...
Chapter 4 (Act 2) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The fresh footprints leading away from the study"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that someone left the scene quickly after the time of death, narrowing down suspects."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Beatrice kneels to examine the footprints, feeling the weight of the investigation."
      ]
    },
    ...
    "permittedBehavioursByAct": [
      ...
      },
      {
        ...
        "behaviour": "nervousness as he recalls the evening."
      },
      {
    ...
    "emotionalRegister": "New evidence shifts the direction of the investigation, heightening the stakes.",
