...
- Timestamp: `2026-04-25T07:39:24.634Z`
...
- [essential] temporal →step1 (observation): Reader-visible pre-test clue: clock's tampering is not shared with the reader until the discriminating test.
...
- Reader-visible pre-test clue: clock's tampering is not shared with the reader until the discriminating test. (early, step 1)
