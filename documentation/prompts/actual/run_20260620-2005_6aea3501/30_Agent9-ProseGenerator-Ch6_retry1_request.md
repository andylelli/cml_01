...
- Timestamp: `2026-06-20T20:14:23.380Z`
...
• [clue_core_contradiction_chain] The scratches indicate deliberate tampering of the clock mechanism by a tool, contradicting the assumption that the clock stopped naturally.
...
• [clue_culprit_direct_1] Direct evidence links John Avery to the mechanism access point before the discriminating test and excludes competing suspect timelines.
...
• [clue_clock_hands_scratches] John Avery premeditated the clock manipulation to create a false timeline, giving himself a concealed window for the murder.
  Category: behavioral | Criticality: essential | Supports inference step 4
  Points to: John Avery premeditated the clock manipulation to create a false timeline, giving himself a concealed window for the murder.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the evening deepened, the springtime drizzle persisted, the estate’s isolation underscored by the glow of gas lamps and the muted sounds of distant radios. Finch allowed himself a brief moment of reflection, recognizing the shifting pressure within the hous..."
...
Known location profile anchors: Langley Manor, The Family Drawing Room, The Manor Library, Servants’ Hall, Estate Gatehouse, Manor library
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Langley Manor", "The Family Drawing Room", "The Manor Library", "Servants’ Hall", "Estate Gatehouse", "Manor library"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 6: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with an expository setup — e.g. "It was not until…" / "There had been no word since…" / "There was a note on the table…". Begin with "It was", "There was", or "There had been" followed immediately by a specific condition, event, or discovery. Do NOT begin with generic atmosphere. Anchor opening in "Manor library". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Phrases to avoid (already overused in earlier chapters): "finch watched for any flicker of uncertainty", "she wore a pleated skirt and knit", "wore a pleated skirt and knit cardigan", "clara s role as confidante and gatekeeper", "s role as confidante and gatekeeper placed", "role as confidante and gatekeeper placed her", "as confidante and gatekeeper placed her at", "confidante and gatekeeper placed her at the", "and gatekeeper placed her at the intersection", "gatekeeper placed her at the intersection of".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=17284; context=6515; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_12 must appear in Act 2, Scene 3 via Direct observation
- clue_13 must appear in Act 2, Scene 3 via Behavioral observation
- clue_14 must appear in Act 2, Scene 3 via Corroborated elimination
- clue_15 must appear in Act 2, Scene 3 via Cross-check contradiction
...
- clue_cleaning_schedule must appear in Act 2, Scene 3 via Cleaning duty roster
- clue_clock_hands_scratches must appear in Act 2, Scene 3 via Direct observation of clock mechanism
- clue_core_contradiction_chain must appear in Act 2, Scene 3 via Cross-check contradiction
...
- clue_culprit_direct_john_avery must appear in Act 2, Scene 3 via Direct observation
- clue_kitchen_testimony must appear in Act 2, Scene 3 via Kitchen staff confirming Clara’s presence
- clue_pendulum_scratch must appear in Act 2, Scene 3 via Inspector’s close examination of pendulum bob
- clue_servant_testimony must appear in Act 2, Scene 3 via Multiple servants confirm Margaret’s location
...
Batch chapters: 6-6.
Investigation state at start: 16 clue(s) revealed to reader; approximately 1 unresolved suspect(s).
...
- Chapter 6:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the evening deepened, the springtime drizzle persisted, the estate’s isolation underscored by the glow of gas lamps and the muted sounds of distant radios. Finch allowed himself a brief moment of reflection, recognizi...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • Butler John Avery’s detailed schedule conflicts by exactly forty minutes with the manor clock time, showing a deliberate mismatch. [clue_7]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • John Avery premeditated the clock manipulation to create a false timeline, giving himself a concealed window for the murder. [clue_8]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • Direct evidence links John Avery to the mechanism access point before the discriminating test and excludes competing suspect timelines. [clue_cleaning_schedule]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • John Avery premeditated the clock manipulation to create a false timeline, giving himself a concealed window for the murder. [clue_clock_hands_scratches]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • The scratches indicate deliberate tampering of the clock mechanism by a tool, contradicting the assumption that the clock stopped naturally. [clue_core_contradiction_chain]
      Points to: The scratches indicate deliberate tampering of the clock mechanism by a tool, contradicting the assumption that the clock stopped naturally.
    • Eliminates Clara Mitchell because her whereabouts during the murder time are confirmed by servant logs and kitchen staff testimony, focusing suspicion on John Avery. [clue_core_elimination_chain]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • Direct evidence links John Avery to the mechanism access point before the discriminating test and excludes competing suspect timelines. [clue_culprit_direct_1]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • Direct evidence ties John Avery to the mechanism access point before the discriminating test and excludes competing suspect timelines. [clue_culprit_direct_john_avery]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • John Avery is uniquely linked to the clock manipulation through the matching scratch patterns and his exclusive access to the clock-winder’s tool. [clue_kitchen_testimony]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • Butler John Avery’s detailed schedule conflicts by exactly forty minutes with the manor clock time, showing a deliberate mismatch. [clue_pendulum_scratch]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
  ...
  - Sensory obligation — use at least two of: warm lamplight pools, shadows cast by bookshelves | quiet ticking clock, soft sigh of settling house | warm beeswax. Mood: reflective calm.
...
[
  {
    ...
    "emotionalRegister": "Butler John Avery’s implication through clock tampering reveals a premeditated betrayal, escalating tension toward confrontation.",
    ...
    "humourGuidance": {
      ...
      "condition": "Allowed only if a character with humourLevel > 0.7 is present and no direct threat or violence occurs"
    },
...
PRIMARY FAILURES
- Chapter 6: a clue/test description was copied verbatim into the prose (17 consecutive words from "The scratches indicate deliberate tampering of the clock mechanism by …"). Dramatize it as an observed detail, action, or dialogue in your own words — do NOT transcribe schema descriptions.
- Chapter 6: clue evidence "rh_2" is absent. Include an on-page observation or reference to "rh_2" before the chapter ends.
...
- Insert or move a dedicated observation-plus-inference block for each missing clue: "rh_2". The observation and inference must be separate full paragraphs.

SUCCESS CHECKLIST
- Every listed issue below is resolved in this single attempt before you answer.
- Each missing clue appears on-page as observable evidence, followed immediately by a separate inference paragraph: "rh_2".
...
DEFERRED TO PHASE 2 (2 quality issue(s) — address ONLY after this attempt passes logic gates):
  (deferred) Chapter 6: a clue/test description was copied verbatim into the prose (17 consecutive words from "The scratches indicate deliberate tampering of the clock mechanism by …"). Dramatize it as an observed detail, action, or dialogue in your own words — do NOT transcribe schema descriptions.
  (deferred) Template linter: high n-gram overlap detected (0.88 >= 0.65). Rephrase this passage to avoid template leakage.
