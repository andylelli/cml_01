...
- Timestamp: `2026-06-20T20:07:00.003Z`
...
1. Generate a clue that makes the reader directly observe: "The manor clock’s hands have unusual scratches near the center pin inconsistent with normal wear and..."
   → observation | essential | early | temporal | step 1 | terms: manor, clock’s, hands

2. Generate a clue that provides evidence for: "The scratches indicate deliberate tampering of the clock mechanism by a tool, contradicting the assu..."
   → contradiction | essential | early | temporal | step 1 | terms: scratches, indicate, deliberate

3. Generate a clue that makes the reader directly observe: "A servant recalls hearing the manor clock ticking oddly and running backwards shortly before it stop..."
   → observation | essential | early | temporal | step 2 | terms: servant, recalls, hearing

4. Generate a clue that provides evidence for: "The clock was wound backward deliberately, shifting the timeline by approximately forty minutes, inv..."
   → contradiction | essential | early | temporal | step 2 | terms: clock, wound, backward

5. Generate a clue that makes the reader directly observe: "The stable logbook shows Edward Langley entering the stables at half past eleven, forty minutes afte..."
   → observation | essential | mid | temporal | step 3 | terms: stable, logbook, shows

6. Generate a clue that provides evidence for: "Edward’s claimed alibi at the stables after the murder time is disproved, eliminating him as the mur..."
   → contradiction | essential | mid | temporal | step 3 | terms: edward’s, claimed, alibi

7. Generate a clue that makes the reader directly observe: "Butler John Avery’s detailed schedule conflicts by exactly forty minutes with the manor clock time, ..."
   → observation | essential | mid | temporal | step 4 | terms: butler, avery’s, detailed

8. Generate a clue that provides evidence for: "John Avery premeditated the clock manipulation to create a false timeline, giving himself a conceale..."
   → contradiction | essential | mid | temporal | step 4 | terms: avery, premeditated, clock

9. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The scratches indicate deliberate tampering of the clock mechanism by a tool, contradicting the assumption that the clock stopped naturally...."
   → contradiction | essential | mid | temporal | step 1 | terms: scratches, indicate, deliberate

10. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The murderer's plan hinged on manipulating the manor clock to show a later time than actual, by winding it backward 40 minutes before it sto..."
   → observation | essential | early | temporal | terms: murderer's, hinged, manipulating

11. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "A controlled comparison of the manor clock’s scratched hands and pendulum bob with the clock-winder’..."
   → observation | essential | mid | temporal | terms: controlled, comparison, manor

12. Generate one essential mid-story clue whose description or pointsTo explicitly names John Avery and states the unique trace, preparation detail, or mechanism link that points to John Avery rather than any non-culprit.
   → observation | essential | mid | temporal | terms: John Avery, murderer's, hinged, manipulating

13. Generate a clue showing observable evidence of John Avery's premeditation or planning (Protect family secrets and control over estate). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: protect, family, secrets

14. Generate a clue that explicitly eliminates suspect Clara Mitchell using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Clara Mitchell because ...").
   → elimination | essential | mid | testimonial | terms: Clara Mitchell

15. Generate one essential early or mid elimination clue that explicitly rules out Clara Mitchell and narrows the solution toward culprit John Avery. The pointsTo text must start with "Eliminates Clara Mitchell because ..." and cite corroborated evidence.
   → elimination | essential | mid | testimonial | terms: Clara Mitchell, John Avery
...
## Access Constraints
Actors: Butler John Avery, Margaret Langley, Edward Langley, Clara Mitchell
Objects: Manor clock, Clock-winder’s tool, Stable logbook, Key rings
...
- Inspector Harold Finch: sensitive items: Physical clues, Witness testimony, Time records
- Margaret Langley: sensitive items: Time logs, Access records, Witness statements
- Edward Langley: sensitive items: Stable logs, Servant testimony, Clock timings
- Clara Mitchell: sensitive items: Servant logs, Kitchen staff testimony, Clock examination
- John Avery: sensitive items: Clock mechanism, Staff schedules, Key rings
...
Create 2 red herrings that support the false assumption: "The stopped manor clock’s displayed time accurately indicates the time of the murder."
