...
- Timestamp: `2026-05-28T20:44:17.765Z`
...
• [clue_2] The clock likely malfunctioned, causing the minute hand to slip backward due to mechanical looseness and vibrations.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: Initial assumption that the clock's stopped time might be unreliable due to mechanical failure.
...
• Evidence in reader's hands: The engine room clock's minute hand is visibly stopped at ten minutes past eleven, and inspection shows the pendulum is halted.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As Joan prepared to summon the crew for questioning, she allowed herself a moment of reflection. The discovery of James Healy’s body was only the beginning. The clock’s halted minute hand at ten minutes past eleven was a crucial clue, but the truth it conceale..."
...
Known location profile anchors: SS Atlantic Passage, Atlantic Ocean - Open Decks, Engine Room, First-Class Dining Saloon, Crew Quarters Corridor, Engine room, later morning
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "SS Atlantic Passage", "Atlantic Ocean - Open Decks", "Engine Room", "First-Class Dining Saloon", "Crew Quarters Corridor", "Engine room, later morning"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 2: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with spoken dialogue — e.g. '"[words]," [Name] said/asked/replied/murmured.' The opening quote must be the first character on the line. Anchor opening in "Engine room, later morning". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=7530; context=10165; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 2:
  ...
  - Scene is set in: Engine room, later morning — reference it naturally within the paragraph, never as your opening phrase.
  - Opening atmosphere (MANDATORY — validator enforced): the first paragraph MUST contain at least one of: rain / wind / fog / storm / mist / thunder / evening / morning / night / dawn / dusk / season / afternoon / midday / noon / midnight / twilight / sunrise / sunset / daylight / sunlight / overcast / cloudy / bright / dark / grey / pale / cold / warm / chill / crisp / damp / drizzle / haze / lamplight / firelight. A chapter that omits all of these from its opening paragraph will be rejected.
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As Joan prepared to summon the crew for questioning, she allowed herself a moment of reflection. The discovery of James Healy’s body was only the beginning. The clock’s halted minute hand at ten minutes past eleven was a...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The clock likely malfunctioned, causing the minute hand to slip backward due to mechanical looseness and vibrations. [clue_2] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: Initial assumption that the clock's stopped time might be unreliable due to mechanical failure.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Tadhg fidgets, avoiding direct eye contact when questioned about the clock’s mechanism"
      ]
    },
    ...
    "humourGuidance": {
      ...
      "character": "Joan Kavanagh",
      "form": "dry_wit",
      "condition": "Only subtle, dry wit from characters like Joan Kavanagh or Tadhg Cahill is permitted to ease tension without undermining seriousness."
    },
...
□ Forbidden seasonal words: summer, autumn, winter.
□ Chapter 2: "The clock likely malfunctioned, causing the minute hand to slip backward due to mechanical looseness and vibrations." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
