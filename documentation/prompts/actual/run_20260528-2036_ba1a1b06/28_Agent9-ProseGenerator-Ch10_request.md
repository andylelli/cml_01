...
- Timestamp: `2026-05-28T20:48:07.976Z`
...
A bittersweet closure where justice prevails but leaves emotional scars and altered relationships.
...
Permission: conditional — condition: Subtle, dry humour may be used by Joan Kavanagh to underscore the bittersweet closure of the case.
Characters who may be funny: Joan Kavanagh
Permitted forms: dry_wit, understatement
Rationale: The resolution can allow mild humour to reflect healing and humanize characters after tension.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the first light of springtime dawn filtered weakly through the portholes, the mechanical drone softened, and the tension in the engine room and observation deck began to ease. Joan allowed herself a moment to breathe, the warm metal surfaces beneath her fin..."
...
Chapter 9: Chapter 9: The Discriminating Test
  Events: Cahill’s breath hitched, and his hands trembled visibly as the truth closed in.
...
Known location profile anchors: SS Atlantic Passage, Atlantic Ocean - Open Decks, Engine Room, First-Class Dining Saloon, Crew Quarters Corridor, Captain’s quarters
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "SS Atlantic Passage", "Atlantic Ocean - Open Decks", "Engine Room", "First-Class Dining Saloon", "Crew Quarters Corridor", "Captain’s quarters"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 10: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a noun-phrase atmosphere — e.g. "The smell of damp stone in the cellar…" / "A chill from the landing…" / "The sound of the clock in the hall…". Pattern: "The/A [noun] of/in/from [place]…". Anchor opening in "Captain’s quarters". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=20888; context=10862; dropped=[humour_guide, location_profiles]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 10:
  ...
  - Scene is set in: Captain’s quarters — reference it naturally within the paragraph, never as your opening phrase.
  - Opening atmosphere (MANDATORY — validator enforced): the first paragraph MUST contain at least one of: rain / wind / fog / storm / mist / thunder / evening / morning / night / dawn / dusk / season / afternoon / midday / noon / midnight / twilight / sunrise / sunset / daylight / sunlight / overcast / cloudy / bright / dark / grey / pale / cold / warm / chill / crisp / damp / drizzle / haze / lamplight / firelight. A chapter that omits all of these from its opening paragraph will be rejected.
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the first light of springtime dawn filtered weakly through the portholes, the mechanical drone softened, and the tension in the engine room and observation deck began to ease. Joan allowed herself a moment to breathe,...".
  - Clue obligations: none for this chapter.
  - Tonal contrast: include at least one beat of relief or ironic counterpoint. Do not sustain maximum tension for every paragraph.
  - ⚠ SUSPECT CLEARANCE REQUIRED (MANDATORY): each suspect below MUST be named explicitly and cleared with on-page evidence and a reasoning connector (because / therefore / which proves):
    • "Arthur Murphy": write a dedicated paragraph that (a) names Arthur Murphy explicitly, (b) states the clearance method ("Verified alibi via engine room access logs and timing"), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have". Cite clues: Arthur Murphy's alibi window, Ship logs recording engine vibrations, Crew testimony.
    • "Valerie Flanagan": write a dedicated paragraph that (a) names Valerie Flanagan explicitly, (b) states the clearance method ("Limited access and inconsistent presence near engine room stairwell"), (c) shows the supporting evidence using "because / therefore / which proves", and (d) the clearing event must be shown as an in-scene moment — a named witness, a physical record, or a witnessed observation. Asserting the alibi without showing how it was confirmed is not sufficient. Accepted clearance phrases: "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have". Cite clues: Passenger movement logs, Witness sightings, Ship whistle timing.
...
⛔ MANDATORY RESOLUTION — THIS IS THE FINAL CHAPTER:
  ...
  1. ACCUSATION: The detective names Tadhg Cahill and states the charge.
  2. CULPRIT RESPONSE: Tadhg Cahill confesses with detail, or reacts in a way that confirms guilt.
  3. METHOD: State exactly how "The ship's engine room clock suffered a mechanical failure caused by the intense vibrations of the main engine, causing the minute hand to slip backward exactly forty minutes due to a loosened gear. This created a false appearance that the murder occurred at ten minutes past eleven, while in reality, the victim was killed nearly an hour earlier. The culprit, Tadhg Cahill, exploited this temporal distortion to mask his presence in the engine room and fabricate an alibi." was used — specific, not vague.
  4. CONSEQUENCE: What happens to Tadhg Cahill (arrested, fled, taken into custody).
  ...
  6. SUSPECT CLEARANCES (MANDATORY — lint-enforced): every non-culprit suspect below MUST be named explicitly and cleared in a dedicated paragraph in THIS chapter:
    • "Arthur Murphy" — include a paragraph that: (a) names "Arthur Murphy" by name, (b) states a clearance phrase (cleared / ruled out / innocent / alibi holds / alibi confirmed / could not have), (c) includes a reasoning connector (because / therefore / which proves / alibi). Example: "Arthur Murphy was cleared because [evidence]; [their] alibi confirmed [they] could not have committed the crime." All three elements must be in the SAME paragraph — do not split across paragraphs.
    • "Valerie Flanagan" — include a paragraph that: (a) names "Valerie Flanagan" by name, (b) states a clearance phrase (cleared / ruled out / innocent / alibi holds / alibi confirmed / could not have), (c) includes a reasoning connector (because / therefore / which proves / alibi). Example: "Valerie Flanagan was cleared because [evidence]; [their] alibi confirmed [they] could not have committed the crime." All three elements must be in the SAME paragraph — do not split across paragraphs.
    • "Joan Kavanagh" — include a paragraph that: (a) names "Joan Kavanagh" by name, (b) states a clearance phrase (cleared / ruled out / innocent / alibi holds / alibi confirmed / could not have), (c) includes a reasoning connector (because / therefore / which proves / alibi). Example: "Joan Kavanagh was cleared because [evidence]; [their] alibi confirmed [they] could not have committed the crime." All three elements must be in the SAME paragraph — do not split across paragraphs.
...
Cahill’s breath hitched, and his hands trembled visibly as the truth closed in. For a fleeting moment, the dry wit that had once punctuated his words was replaced by a palpable vulnerability. Joan allowed the silence to linger, the mechanical drone filling the narrow space of the engine room and observation deck. The warm furnace glow flickered softly, casting long shadows that danced across the brass fittings and steel walls. Steam drifted in light beams, curling like ghostly fingers through the dim air, while the steady pulse of the engines thrummed beneath their feet, a constant reminder of the SS Atlantic Passage’s relentless journey through the vernal Atlantic. Joan’s gaze remained fixed on the worn brass face of the engine room clock, its minute hand forever frozen at ten minutes past eleven, the silent witness to a deception about to be unraveled.

The detective’s voice cut through the thick atmosphere with quiet authority. "We will now proceed with the reenactment," Joan announced, her tone steady but charged with purpose. "Observe closely how the clock behaves under conditions replicating the engine vibrations recorded in the ship’s logs at a quarter to " She gestured toward the assembled crew members and officers, including Arthur Murphy and Valerie Flanagan, whose presence underscored the gravity of the moment. The room held its breath as Joan carefully initiated the simulation, the logs confirming a sharp spike in engine vibrations precisely at the appointed time. The mechanical drone intensified, punctuated by the soft clanking of tools and the hiss of steam, while the warm glow from the furnace doors bathed the space in a flickering light.

As the vibrations reached their peak, the minute hand of the clock began to move. At first, it ticked forward with mechanical precision, but then, unmistakably, it slipped backward by forty minutes. The subtle but deliberate motion was impossible to ignore. Joan’s eyes locked with Cahill’s, whose composed facade faltered for the first time. The tension in the room thickened as the implications settled like a weight upon all present. Joan’s steady gaze did not waver. "The clock’s malfunction is not a mere accident," she declared softly. "The worn gear responsible for this backward slip was deliberately tampered with, exploiting the engine’s vibrations to create a false timeline. This manipulation concealed the true time of Mr. Healy’s "

Cahill swallowed hard, his hands trembling as he struggled to maintain composure. "You may find the timing rather inconvenient," he said with a strained smile, "but I assure you, I had no reason to be anywhere near that clock during the critical " His voice was deliberate, but the nervous flicker in his eyes betrayed the weight of Joan’s accusation. Joan stepped closer, her tone measured but unyielding. "Your alibi places you attending to a patient between ten minutes past ten and a quarter to eleven, which overlaps precisely with the time the clock’s minute hand slipped backward. Yet, the manipulation required access and intent—both of which you possessed. Your professional rivalry with Mr. Healy was no secret, and your evasiveness when questioned about the clock’s mechanism deepened "

The detective’s words hung in the air, the mechanical pulse of the engines a relentless backdrop to the unfolding confrontation. Joan paced slowly, her eyes scanning the faces of those gathered. Arthur Murphy’s expression was unreadable, his gaze flicking between Joan and Cahill with a mixture of curiosity and calculation. Valerie Flanagan stood poised, her fingers tightening briefly around the edge of her handbag, the silk scarf at her throat whispering softly in the stillness. Joan’s voice softened as she addressed the assembled group. "The testimonies of crew members who saw Mr. Healy alive after the clock’s stopped time, combined with the ship’s logs and this reenactment, confirm that the murder occurred earlier than ten minutes past eleven. The clock’s backward slip by forty minutes was a deliberate act to obscure the "

Joan turned her attention back to Cahill, whose lips pressed into a thin line. "The evidence is clear," she said quietly. "You exploited the clock’s vulnerability, manipulating the mechanism to protect yourself by falsifying the time of death. The clock was your accomplice, but it was your hand that caused its " Cahill’s breath hitched again, the tremor in his hands now unmistakable. For a moment, the weight of the revelation seemed to crush the dry wit that had once been his shield. "Sometimes, the truth is the hardest medicine to swallow," he murmured, his voice edged with weary irony. "But I assure you, I am not the villain you "

Joan’s gaze remained steady, her expression unreadable. "The heart isn’t the only thing that skips a beat on this ship," she replied softly, the words a quiet echo of Cahill’s earlier remark. "Yet, the clock’s malfunction has exposed more than just time—it has revealed the fragile boundary between justice and " The room was silent save for the steady hum of the engines and the faint hiss of steam. The warm furnace glow flickered, casting angular shadows across Cahill’s face, revealing the strain beneath his composed exterior. Joan allowed herself a brief moment of ironic relief before continuing. "With the alibis of Mr. Murphy and Miss Flanagan confirmed, and the clock’s manipulation proven, the path forward is "

Cahill’s shoulders sagged slightly, the tension in his posture finally breaking. Joan stepped back, signaling the end of the reenactment. The assembled witnesses exchanged glances, the weight of the truth settling heavily among them. Joan’s voice was firm as she addressed the group. "The investigation now turns to the consequences of this revelation. The fragile social order aboard the SS Atlantic Passage has been shaken, and justice must be served without prejudice or " The detective’s eyes met Cahill’s once more, a mixture of professional triumph and personal despair reflected in her gaze. "The truth is seldom clean or simple," Joan said quietly. "But it is the only path to peace aboard this "

As the first light of springtime dawn filtered weakly through the portholes, the mechanical drone softened, and the tension in the engine room and observation deck began to ease. Joan allowed herself a moment to breathe, the warm metal surfaces beneath her fingertips grounding her in the present. The trap had been sprung, the clock’s betrayal laid bare, and the tangled threads of deceit were unraveling. Yet beneath the surface, Joan sensed the moral complexity that would linger long after the case was closed. The line between justice and loyalty had blurred, and the consequences would ripple through the lives of all aboard the SS Atlantic Passage.
--- END PRIOR CHAPTER 9 ---
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Joan allows a brief moment of silent reflection on the tragedy"
      ]
    },
    ...
    "emotionalRegister": "A bittersweet closure where justice prevails but leaves emotional scars and altered relationships.",
...
```text
{
  ...
  "chapters": [
    {
      "title": "Chapter 10: Suspect Clearance and Culprit Confrontation",
      "summary": "Joan Kavanagh clears Arthur Murphy and Valerie Flanagan with verified alibis and confronts Tadhg Cahill with evidence, leading to his confession and the resolution of the case.",
      "paragraphs": [
        "As the first light of springtime dawn filtered weakly through the portholes, the mechanical drone softened, and the tension in the engine room and observation deck began to ease. Joan allowed herself a moment to breathe, the warm metal surfaces beneath her fingertips grounding her in the present. The trap had been sprung, the clock’s betrayal laid bare, and the tangled threads of deceit were unraveling. Yet beneath the surface, Joan sensed the moral complexity that would linger long after the case was closed. The line between justice and loyalty had blurred, and the consequences would ripple through the lives of all aboard the SS Atlantic Passage.",
        "The Captain’s quarters, where the final reckoning was to unfold, held a muted formality. The scent of polished wood mingled with the faint trace of leather-bound books, their spines worn by time and use. The pale morning light cast long shadows that flickered softly beneath the brass lamp fixtures, lending a quiet gravity to the room. Joan stood near the heavy oak desk, her gaze steady as she prepared to address the assembled group. Arthur Murphy and Valerie Flanagan were present, their expressions guarded but attentive. Tadhg Cahill entered last, his posture rigid, the weight of impending judgment evident in the set of his shoulders.",
        "Joan began without preamble. \"Mr. Murphy,\" she said, her voice clear and measured, \"we have thoroughly reviewed the engine room access logs and witness statements concerning your whereabouts between ten minutes past ten and a quarter to eleven. Can you confirm your movements during that period?\"",
        "Arthur Murphy’s lips curled into a faint, sardonic smile. \"Detective, I was far from the engine room, attending to correspondence in the First-Class Dining Saloon. Several passengers, including Mr. Cahill, can attest to my presence there,\" he replied smoothly. \"My alibi is as solid as the ship’s hull.\"",
        "Joan nodded, turning to the thick logbook resting on the desk. \"The engine room logs corroborate your account, Mr. Murphy. Multiple witnesses place you away from the engine room during the critical window. This clears you of any involvement in the manipulation of the clock or the murder.\"",
        "Murphy’s smile widened slightly, though his eyes remained guarded. \"I appreciate the thoroughness, Detective. It is a relief to be cleared, though the experience has been less than pleasant. One does not enjoy being under such scrutiny, especially when ambitions are at stake.\"",
        "Joan allowed herself a brief, ironic smile. \"Ambition cuts deeper than any blade, Mr. Murphy. But it is the truth we seek, not convenience.\"",
        "Turning her attention to Valerie Flanagan, Joan’s tone softened. \"Miss Flanagan, passenger movement logs and witness sightings confirm your presence on the upper deck during the timeframe in question. Can you confirm this?\"",
        "Valerie’s eyes flickered nervously, a subtle tremor betraying her composed exterior. She adjusted the silk scarf at her throat, the fabric whispering softly. \"Yes, Detective. I was on the upper deck, taking in the vernal air. Several passengers, including the steward who delivered my morning tea, can confirm my presence there.\"",
        "Joan nodded, noting the consistency of the accounts. \"The ship’s whistle sounded precisely at the hour, and the logs record your movements well before and after that time. This places you far from the engine room and its clock mechanism during the critical period.\"",
        "Valerie met Joan’s gaze steadily, her fingers tightening briefly around the edge of her handbag. \"I trust this confirms my alibi, Detective.\"",
        "\"It does,\" Joan replied firmly. \"This eliminates you as a suspect in the clock’s manipulation and the murder.\"",
        "A brief silence settled over the room, the weight of revelations pressing down like the cold Atlantic fog outside. Joan’s eyes flicked between the two cleared suspects, then back to her notes. The elimination of Arthur Murphy and Valerie Flanagan sharpened the focus of the investigation, narrowing the field to a smaller circle of possibility.",
        "Joan’s voice broke the silence, steady and resolute. \"With Mr. Murphy and Miss Flanagan’s alibis confirmed, the evidence increasingly points toward another individual with both motive and opportunity.\" She allowed the implication to hang in the air, watching the subtle reactions among those present.",
        "Arthur Murphy’s expression darkened momentarily, the sardonic edge sharpening. \"It seems the game is narrowing, Detective. I trust the truth will emerge, no matter how uncomfortable.\"",
        "Valerie Flanagan’s eyes darted again, this time with a flicker of apprehension. She swallowed, regaining composure. \"The truth, Detective, is often more complicated than it appears.\"",
        "Joan’s gaze hardened. \"Indeed. The clock’s manipulation was no accident. The minute hand’s backward slip by forty minutes was deliberate, designed to conceal the true timeline of the murder. The mechanical failure was an accomplice, but the hand that caused it must be accounted for.\"",
        "Joan turned her steady gaze to Tadhg Cahill, who stood rigid, his face pale beneath the soft lamplight. \"Dr. Cahill,\" Joan began, her voice calm but unyielding, \"the ship’s engine room clock suffered a mechanical failure caused by the intense vibrations of the main engine, causing the minute hand to slip backward exactly forty minutes due to a loosened gear. This created a false appearance that the murder occurred at ten minutes past eleven, while in reality, the victim was killed nearly an hour earlier. You exploited this temporal distortion to mask your presence in the engine room and fabricate an alibi.\"",
        "Cahill’s breath hitched, his hands trembling visibly as the weight of Joan’s words settled upon him. His eyes flickered with a mixture of resignation and something deeper—regret. \"You may find the timing rather inconvenient,\" he said quietly, his voice edged with weary irony, \"but I assure you, I was attending to a patient between ten minutes past ten and a quarter to eleven, as my records show. I was not near the engine room during that time.\"",
        "Joan’s gaze did not waver. \"Your alibi holds for that window, but the murder occurred before the clock’s minute hand slipped backward. Your exclusive access to the clock mechanism and your professional rivalry with Mr. Healy gave you both motive and means. The evidence is clear.\"",
        "Cahill’s shoulders sagged, the tension in his posture finally breaking. His voice was low, laden with the weight of confession. \"It was not meant to be this way,\" he murmured. \"I feared that Mr. Healy’s accusations would destroy a fellow crew member, and in my desperation, I manipulated the clock to protect him. The timing was everything—I needed to create doubt, to buy time. But the truth, as always, finds a way.\"",
        "Joan listened, the moral complexity of Cahill’s confession settling heavily in the room. \"Your actions blurred the line between justice and loyalty,\" she said softly. \"But justice must prevail aboard this ship, no matter how painful.\"",
        "The door opened quietly, and two crew members entered to take Cahill into custody. His hands trembled as he allowed himself to be led away, the weight of his choices etched deeply into his features. Joan watched silently, the somber reality of the resolution settling over her like the vernal mist outside.",
        "Turning to Arthur Murphy and Valerie Flanagan, Joan offered a brief nod. \"Thank you for your cooperation. Your alibis have been confirmed, and you are cleared of suspicion.\"",
        "Arthur Murphy inclined his head, a faint smile playing on his lips. \"Justice, however imperfect, is served. I only hope the peace it brings is lasting.\"",
        "Valerie Flanagan’s eyes softened slightly, the tension easing from her posture. \"The truth is never simple, but it is necessary. Thank you, Detective.\"",
        "Joan allowed herself a moment of silent reflection, the weight of the tragedy pressing upon her. James Healy’s death had shattered the fragile order aboard the SS Atlantic Passage, and the path to justice had been paved with moral ambiguity and human frailty. The ship’s engines hummed steadily beneath the hull, a relentless pulse against the quiet aftermath. Joan’s gaze drifted to the window, where the pale springtime light filtered through the haze, a reminder that even in the darkest moments, the dawn must come."
      ]
    }
  ],
  "cast": ["Tadhg Cahill", "James Healy", "Arthur Murphy", "Valerie Flanagan", "Joan Kavanagh"],
  "note": "Chapter 10 fulfills all resolution requirements: suspect clearances, confrontation, confession, method explanation, consequences, and emotional aftermath.",
  "audit": {
    "locked_fact_phrases": "present in paragraphs 15, 17",
    "season_words_used": "springtime, spring, vernal",
    "discriminating_test_present": "no",
    "required_clues_present": "none",
...
```text
Attempt 2/6 — chapters 10 — 5 validation issue(s) to resolve:

═══ CLUE OBLIGATION FAILURES (2) ═══
• Clue obligation: suspect clearance missing for "Arthur Murphy". This chapter must include a paragraph that (a) names "Arthur Murphy" explicitly, (b) contains a clearance phrase (e.g. "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have"), AND (c) contains an evidence connector (e.g. "because", "therefore", "which proves", "alibi", "timeline", "evidence"). Example: "Arthur Murphy's alibi was confirmed because multiple witnesses saw them in [location] at the time." Do not split the clearance across separate paragraphs.
• Clue obligation: suspect clearance missing for "Valerie Flanagan". This chapter must include a paragraph that (a) names "Valerie Flanagan" explicitly, (b) contains a clearance phrase (e.g. "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have"), AND (c) contains an evidence connector (e.g. "because", "therefore", "which proves", "alibi", "timeline", "evidence"). Example: "Valerie Flanagan's alibi was confirmed because multiple witnesses saw them in [location] at the time." Do not split the clearance across separate paragraphs.

See the RETRY MICRO-PROMPTS section below for specific paragraph-by-paragraph repair instructions.

═══ CHARACTER NAME ERRORS (1) ═══
• Final chapter: no resolution event detected. Include a scene where Tadhg Cahill confesses, is arrested, or the detective explicitly names them as the murderer with evidence.

✓ SOLUTION: The ONLY characters who exist are: Tadhg Cahill, James Healy, Arthur Murphy, Valerie Flanagan, Joan Kavanagh
...
• Chapter 10: Chapter 10 may be missing the discriminating test scene (Include a scene that tests: A controlled reenactment compares the stopped engine room clock's gear condition and vibration logs ...)
...
Your prose has been detected copying from an earlier chapter. Every paragraph listed below appears in a prior chapter and is COMPLETELY OFF-LIMITS. Do not reproduce, rephrase, or structurally echo any of them:
  ...
  • "Joan Kavanagh stepped cautiously through the ... that hung heavy in the air."
  • "Her eyes were drawn immediately to ... mounted above the main control panel."
  • "The halted clock suggested a precise ... the last moments before the tragedy."
  • "At the far end of the ... slumped against the cold steel bulkhead."
  • "Tadhg Cahill stood nearby, his expression ... examined the scene with clinical detachment."
  • "Joan’s gaze shifted back to the clock."
  • "The detective’s mind raced through the possibilities."
  • "Tadhg Cahill cleared his throat, breaking the silence."
  • "Joan’s attention returned to the body."
  • "As she rose, Joan’s eyes caught ... on the floor near the body."
  • "Joan straightened and called softly, "Tadhg, ... the body and the clock mechanism."
  • "Tadhg nodded, his expression tightening."
  • "Joan turned back to the clock, ... visible through a small glass panel."
  • "The detective’s eyes scanned the engine room once more."
  • "As Joan prepared to summon the ... allowed herself a moment of reflection."
  • ""The clock’s minute hand is frozen ... steel walls of the engine room."
  • "Joan rose slowly, the weight of her observation settling heavily."
  • "Tadhg Cahill stood nearby, his posture taut as he watched Joan’s inspection."
  • "Cahill’s eyes flickered briefly toward the clock, then away."
  • "Joan studied him, noting the subtle signs of nervousness."
  • ""Only that it seemed to have ... a loose thread on his sleeve."
  • "Joan nodded thoughtfully, appreciating the dry ... undercurrent of unease beneath Cahill’s words."
  • "The detective’s attention shifted to the ... faint glow from the furnace doors."
  • "Cahill’s gaze dropped to the floor, ... of distant tools punctuating the silence."
  • "Joan allowed a moment’s pause before continuing."
  • "Cahill nodded, though his fingers clenched briefly at his sides."
  • "The detective turned toward the narrow ... glow on the damp steel steps."
  • "Before leaving, Joan cast one last ... frozen at ten minutes past eleven."
  • "Before leaving, Joan cast one last ... frozen at ten minutes past eleven."
  • "The significance of this entry was not lost on Joan."
  • "Joan straightened and moved toward the ... gleaming dully in the subdued light."
  • "The detective’s thoughts were interrupted by ... tension that hung in the air."
  • "Cahill’s expression tightened imperceptibly."
  • "Joan allowed herself a brief moment of ironic relief."
  • "Her first interview was with Arthur ... SS Atlantic Passage were well known."
  • "Murphy’s smile was thin, his eyes calculating."
  • "Joan made a note of his ... rich aroma of coffee and pastries."
  • "Next, Joan sought out Valerie Flanagan, ... aboard was marked by whispered speculation."
  • "Valerie’s eyes met Joan’s steadily."
  • "Joan left the cabin with a growing sense of unease."
  • "Returning to the engine room, Joan ... brass face cold beneath her fingers."
  • "Joan’s gaze hardened with resolve."
  • "Joan Kavanagh’s gaze remained fixed on ... with the weight of new uncertainty."
  • "She moved with purposeful steps through ... and passengers in the common room."
  • "Her first interview was with Arthur ... dim glow of a hanging lamp."
  • "Murphy’s lips curved into a faint, sardonic smile."
  • ""He appeared preoccupied, perhaps troubled," Murphy replied smoothly."
  • "Joan nodded thoughtfully, filing away Murphy’s account."
  • "Next, Joan sought out a group ... life aboard the SS Atlantic Passage."
  • "Joan’s eyes narrowed as she absorbed the collective evidence."
  • "Amid the growing tension, Joan allowed ... a brief moment of ironic relief."
  • "Arthur Murphy watched quietly from his ... unreadable as Joan gathered the statements."
  • "Joan stepped away from the group, ... down as the vernal light waned."
  • "As Joan stepped away from the ... the relentless journey across the Atlantic."
  • "Tadhg’s coat hung loosely from his ... air seeping through the ship’s ventilation."
  • "Joan nodded slowly, but her gaze did not waver."
  • "“You had exclusive access to the engine room clock mechanism, Dr."
  • "Joan’s eyes narrowed."
  • "Joan folded her arms, watching the ... tension ripple through Cahill’s composed facade."
  • "Joan allowed herself a brief, ironic smile."
  • "Joan stepped closer, voice softer but no less determined."
  • "The detective regarded him silently, weighing the contradictions and the subtle clues."
  • "As the evening shadows lengthened in ... scrutinize the clock’s mechanism once more."
  • "As the evening shadows lengthened in ... scrutinize the clock’s mechanism once more."
  • "Tadhg Cahill stood nearby, his posture ... mingling with the warm metal air."
  • "Joan began the controlled reenactment by ... for the minute hand’s backward slip."
  • "The detective’s gaze shifted to the ... for the engine room clock mechanism."
  • "Joan’s fingers tapped thoughtfully on the ... uncovering visible evidence of Cahill’s premeditation."
  • "To eliminate other suspects, Joan turned her attention to Valerie Flanagan."
  • "The detective allowed herself a brief ... the pieces began to fit together."
  • "Joan’s final act in the engine ... experimental evidence was clear and indisputable."
  • "Joan Kavanagh set down her pen ... voices in the Crew common room."
  • "The room’s atmosphere was thick with ... amplifying the subtle undercurrents of suspicion."
  • "Joan approached Arthur Murphy first, her tone calm but unwavering."
  • "Murphy’s lips curled into a faint, sardonic smile."
  • "Joan nodded, her eyes steady."
  • "Murphy’s smile widened slightly, though his eyes remained guarded."
  • "Turning her attention to Valerie Flanagan, Joan’s voice softened slightly."
  • "Valerie’s eyes flickered nervously, a subtle tremor betraying her otherwise composed demeanor."
  • "Joan nodded, noting the consistency of the accounts."
  • "A brief silence settled over the ... like the cold Atlantic fog outside."
  • "Joan’s voice broke the silence, steady and resolute."
  • "Arthur Murphy’s expression darkened momentarily, the sardonic edge sharpening."
  • "Valerie Flanagan’s eyes darted again, this time with a flicker of apprehension."
  • "Joan’s gaze hardened."
  • "The detective’s thoughts returned to the ... and his nervous demeanor under questioning."
  • "Joan allowed herself a moment of ... relief, recalling Cahill’s earlier dry wit."
  • "The night deepened outside, the ship’s ... relentless pulse against the uncertainty within."
  • ""The night deepened outside, the ship’s ... audible over the constant mechanical drone."
  • "Tadhg Cahill stood nearby, his posture ... coal smoke clinging to his coat."
  • "Joan moved toward the logbook resting ... salt stains from the Atlantic air."
  • "Cahill’s jaw tightened, and for a ... the strain beneath his composed exterior."
  • "The detective’s preparations involved assembling a ... alive after the clock’s stopped time."
  • "Joan allowed herself a brief moment ... that danced across the steel walls."
  • "As the test commenced, the room ... and the soft clanking of tools."
  • "Cahill’s breath hitched, and his hands ... visibly as the truth closed in."
  • "Cahill’s breath hitched, and his hands ... visibly as the truth closed in."
  • "The detective’s voice cut through the thick atmosphere with quiet authority."
  • "As the vibrations reached their peak, ... of the clock began to move."
  • "Cahill swallowed hard, his hands trembling as he struggled to maintain composure."
  • "The detective’s words hung in the ... relentless backdrop to the unfolding confrontation."
  • "Joan turned her attention back to ... lips pressed into a thin line."
  • "Joan’s gaze remained steady, her expression unreadable."
  • "Cahill’s shoulders sagged slightly, the tension in his posture finally breaking."
  • "As the first light of springtime ... and observation deck began to ease."
...
• REPAIR [clue_visibility — attempt 2]: chapters 10 are missing 2 clues.
  ...
  [Clue 1]: "Clue obligation: suspect clearance missing for "Arthur Murphy". This chapter must include a paragraph that (a) names "Arthur Murphy" explicitly, (b) contains a clearance phrase (e.g. "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have"), AND (c) contains an evidence connector (e.g. "because", "therefore", "which proves", "alibi", "timeline", "evidence"). Example: "Arthur Murphy's alibi was confirmed because multiple witnesses saw them in [location] at the time." Do not split the clearance across separate paragraphs."
  ...
  [Clue 2]: "Clue obligation: suspect clearance missing for "Valerie Flanagan". This chapter must include a paragraph that (a) names "Valerie Flanagan" explicitly, (b) contains a clearance phrase (e.g. "cleared", "ruled out", "innocent", "alibi holds", "alibi confirmed", "could not have"), AND (c) contains an evidence connector (e.g. "because", "therefore", "which proves", "alibi", "timeline", "evidence"). Example: "Valerie Flanagan's alibi was confirmed because multiple witnesses saw them in [location] at the time." Do not split the clearance across separate paragraphs."
  • Observation paragraph: A character directly observes or discovers this evidence. Be specific and sensory — describe what is seen, touched, or heard. Include the exact quoted phrase verbatim.
  • Inference paragraph (immediately after): The detective or POV character state what this implies — who it implicates, what is suspicious, or what inference it supports. Use first-person inference language ("She realised...", "He could not help but notice..."). This must be a full separate paragraph, not a tacked-on sentence.
