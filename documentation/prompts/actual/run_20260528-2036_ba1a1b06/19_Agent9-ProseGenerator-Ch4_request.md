...
- Timestamp: `2026-05-28T20:44:59.064Z`
...
• [clue_5] Crew members report seeing James Healy alive after the apparent time of death shown by the stopped clock at ten minutes past eleven.
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: Testimonial evidence that the victim was alive after the clock stopped.

• [clue_6] The victim was alive after the time the clock indicates, showing that the murder happened earlier than the clock's stopped time.
  Category: temporal | Criticality: essential | Supports inference step 3
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Joan’s gaze hardened with resolve. The clock was no longer a silent witness but a key piece of evidence that demanded careful scrutiny. The detective knew that the next steps would be critical: verifying alibis against this new timeline, probing for inconsiste..."
...
Known location profile anchors: SS Atlantic Passage, Atlantic Ocean - Open Decks, Engine Room, First-Class Dining Saloon, Crew Quarters Corridor, Crew quarters and common areas
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "SS Atlantic Passage", "Atlantic Ocean - Open Decks", "Engine Room", "First-Class Dining Saloon", "Crew Quarters Corridor", "Crew quarters and common areas"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 4: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a noun-phrase atmosphere — e.g. "The smell of damp stone in the cellar…" / "A chill from the landing…" / "The sound of the clock in the hall…". Pattern: "The/A [noun] of/in/from [place]…". Anchor opening in "Crew quarters and common areas". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- Phrases to avoid (already overused in earlier chapters): "the only thing that skips a beat", "only thing that skips a beat on", "thing that skips a beat on this", "that skips a beat on this ship", "skips a beat on this ship it", "ten minutes past ten and a quarter", "minutes past ten and a quarter to", "past ten and a quarter to eleven", "i was not near the engine room", "was not near the engine room during".
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=10784; context=11273; dropped=[none]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 4:
  ...
  - Scene is set in: Crew quarters and common areas — reference it naturally within the paragraph, never as your opening phrase.
  - Opening atmosphere (MANDATORY — validator enforced): the first paragraph MUST contain at least one of: rain / wind / fog / storm / mist / thunder / evening / morning / night / dawn / dusk / season / afternoon / midday / noon / midnight / twilight / sunrise / sunset / daylight / sunlight / overcast / cloudy / bright / dark / grey / pale / cold / warm / chill / crisp / damp / drizzle / haze / lamplight / firelight. A chapter that omits all of these from its opening paragraph will be rejected.
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Joan’s gaze hardened with resolve. The clock was no longer a silent witness but a key piece of evidence that demanded careful scrutiny. The detective knew that the next steps would be critical: verifying alibis against t...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • Crew members report seeing James Healy alive after the apparent time of death shown by the stopped clock at ten minutes past eleven. [clue_5]
      Points to: Testimonial evidence that the victim was alive after the clock stopped.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Arthur Murphy watches quietly, his expression unreadable"
      ]
    },
    ...
    "emotionalRegister": "The revelation of the clock’s malfunction shatters accepted timelines, forcing a reevaluation of all evidence.",
    "dominantCharacterNote": {
      "name": "James Healy",
      "voiceRegister": "Gruff and clipped, James’s speech is economical and weighted, with occasional dry, cutting remarks."
    },
    "humourGuidance": {
