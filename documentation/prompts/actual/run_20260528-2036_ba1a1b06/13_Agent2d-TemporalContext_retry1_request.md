...
- Timestamp: `2026-05-28T20:41:59.000Z`
...
- YOU MUST use the exact year and month specified above: March 1940
- This date has been specifically selected for THIS mystery to ensure uniqueness
- DO NOT change the year or month - use March 1940 exactly
...
- All details must be historically accurate for March 1940 specifically
- Generate fresh, original descriptions - do not copy example phrasing
- Make this feel like the specific moment of March 1940
...
1. seasonal.season must be one of [spring, summer, fall, winter], got "late winter/early spring"
...
- Technology available: radio communication throughout the ship, early radar systems primarily for navigation, mechanical typewriters for record-keeping
- Forensics: blood typing as standard for identification, ballistics analysis limited to basic firearms, trace evidence analysis in early stages
...
Task:
1. Use the specified date: March 1940
