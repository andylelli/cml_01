...
- Timestamp: `2026-06-29T20:17:17.000Z`
...
1. Generate a clue that makes the reader directly observe: "Edith Marwood’s watch, found stopped in the garden, shows a clear shadow on its face cast by the sun..."
   → observation | essential | early | testimonial | step 1 | terms: edith, marwood’s, watch,

2. Generate a clue that provides evidence for: "The shadow length and direction correspond to a time later than servants’ claimed time of death base..."
   → contradiction | essential | early | temporal | step 1 | terms: shadow, length, direction

3. Generate a clue that makes the reader directly observe: "Household ledger pages show financial entries dated after the servants’ claimed time of death, with ..."
   → observation | essential | early | temporal | step 2 | terms: household, ledger, pages

4. Generate a clue that provides evidence for: "Since Edith had confronted Edward about ledger falsifications, the ledger’s timing proves the murder..."
   → contradiction | essential | early | temporal | step 2 | terms: since, edith, confronted

5. Generate a clue that makes the reader directly observe: "Edward Marwood’s study logs and housekeeper’s testimony conflict; Edward claims presence in study fr..."
   → observation | essential | mid | testimonial | step 3 | terms: edward, marwood’s, study

6. Generate a clue that provides evidence for: "Given the adjusted murder time from sundial and ledger evidence, Edward’s alibi overlaps with the mu..."
   → contradiction | essential | mid | temporal | step 3 | terms: given, adjusted, murder

7. Generate a clue that makes the reader directly observe: "Only Edward had the authority and unmonitored access to manipulate the watch’s position in the garde..."
   → observation | essential | mid | spatial | step 4 | terms: edward, authority, unmonitored

8. Generate a clue that provides evidence for: "This exclusive access and knowledge prove premeditation and ability to stage the false timeline...."
   → contradiction | essential | mid | temporal | step 4 | terms: exclusive, access, knowledge

9. Generate one essential early or mid contradiction clue that explicitly overturns the false assumption with reader-visible evidence before the discriminating test. Anchor: "The shadow length and direction correspond to a time later than servants’ claimed time of death based on solar geometry for Little Middleton..."
   → contradiction | essential | mid | temporal | step 1 | terms: shadow, length, direction

10. Generate at least one essential early or mid observation clue that makes the core mechanism reader-visible before the discriminating test. The clue must surface this mechanism detail concretely: "The murder was concealed by manipulating the timeline through false servant testimonies and the misuse of the sundial’s shadow as an alibi. ..."
   → observation | essential | early | temporal | terms: murder, concealed, manipulating

11. Generate a clue that provides observable evidence the reader must see BEFORE the discriminating test can be understood. The test exploits this evidence — it does NOT reveal it. Evidence for: "A controlled sundial shadow experiment is conducted by placing an identical watch face at the sundia..."
   → observation | essential | mid | temporal | terms: controlled, sundial, shadow

12. Generate one essential mid-story clue whose description or pointsTo explicitly names Edward Marwood and states the unique trace, preparation detail, or mechanism link that points to Edward Marwood rather than any non-culprit.
   → observation | essential | mid | temporal | terms: Edward Marwood, murder, concealed, manipulating

13. Generate one essential early-or-mid clue establishing that Edward Marwood UNIQUELY had the means/skill/access/knowledge required to execute the concealment mechanism, and that the other suspects did not — so the reveal relies only on this already-planted capability, never on a means introduced for the first time at the confrontation.
   → elimination | essential | mid | temporal | terms: Edward Marwood, murder, concealed, manipulating

14. Generate a clue showing observable evidence of Edward Marwood's premeditation or planning (Fear of scandal exposure after Edith's threats). This MUST be visible to the reader before the confrontation scene — the detective cannot privately know this and withhold it.
   → observation | essential | mid | behavioral | terms: scandal, exposure, after

15. Generate a clue that explicitly eliminates suspect Beatrice Hargrave using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Beatrice Hargrave because ...").
   → elimination | essential | mid | testimonial | terms: Beatrice Hargrave

16. Generate a clue that explicitly eliminates suspect Charles Whitmore using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Charles Whitmore because ...").
   → elimination | essential | mid | testimonial | terms: Charles Whitmore

17. Generate a clue that explicitly eliminates suspect Daphne Sinclair using corroborated alibi or physical evidence. The pointsTo text must state the exclusion logic directly (for example: "Eliminates Daphne Sinclair because ...").
   → elimination | essential | mid | testimonial | terms: Daphne Sinclair

18. Generate one essential early or mid elimination clue that explicitly rules out Beatrice Hargrave and narrows the solution toward culprit Edward Marwood. The pointsTo text must start with "Eliminates Beatrice Hargrave because ..." and cite corroborated evidence.
   → elimination | essential | mid | testimonial | terms: Beatrice Hargrave, Edward Marwood
...
## Access Constraints
Actors: Edward Marwood, Charles Whitmore, Beatrice Hargrave, Arthur Langley, Daphne Sinclair
Objects: Family wing, Study, Garden sundial, Servants' quarters
...
- Arthur Langley: sensitive items: Ledger records, Clock and sundial timings
- Beatrice Hargrave: sensitive items: Ledger pages, Kitchen access logs
- Charles Whitmore: sensitive items: Access logs, Household schedules
- Daphne Sinclair: sensitive items: Garden sundial, Guest logs
- Edward Marwood: sensitive items: Study ledger, Access to family wing
...
Create 2 red herrings that support the false assumption: "The victim was murdered shortly before sunset as all household servants consistently testified."
