...
- Timestamp: `2026-06-29T20:24:30.264Z`
...
• [clue_core_elimination_chain] eliminates, beatrice, hargrave, because, kitchen, access, logs, ledger, page, handling, times, confirm
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: eliminates, beatrice, hargrave, because, corroborated, alibi, access, logs

• [clue_15] eliminates, charles, whitmore, because, access, logs, household, schedules, confirm, attending, public, event
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: eliminates, charles, whitmore, because, corroborated, alibi, access, logs

• [clue_16] eliminates, daphne, sinclair, because, guest, logs, sundial, area, surveillance, confirm, visiting, wing
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: eliminates, daphne, sinclair, because, corroborated, alibi, surveillance

• [clue_18] eliminates, beatrice, hargrave, because, kitchen, access, logs, ledger, page, handling, times, confirm
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: eliminates, beatrice, hargrave, because, corroborated, alibi, narrows, toward, edward, marwood
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Yet even as the pressure mounted, Arthur caught a glimmer of relief in Edward’s eyes—a desperate hope that bluster and denial might yet carry the day. It was an ironic counterpoint to the menace of the morning, a reminder that the line between control and coll..."
...
Known location profile anchors: Marwood Manor, The Sundial Terrace, Marwood Manor Library, Servants' Hall, Family Study, Various manor locations
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Marwood Manor", "The Sundial Terrace", "Marwood Manor Library", "Servants' Hall", "Family Study", "Various manor locations"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 7: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a named character performing a physical action or motion — e.g. "[Name] crossed the threshold…" / "[Name] set down the glass…" / "[Name] rose from the chair…". Anchor opening in "Various manor locations". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=19091; context=4551; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
Suspect pressure target(s): Beatrice Hargrave, Charles Whitmore, Daphne Sinclair
...
- Chapter 7:
  ...
  - Scene is set in: Various manor locations — reference it naturally within the paragraph, never as your opening phrase.
...
- Tonal contrast required: the previous chapter was high-tension. Arthur Langley may use dry_wit to provide a brief moment of relief before tension resumes.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Beatrice sighs with relief; Daphne’s composure steadies"
      ]
    },
    ...
    "humourGuidance": {
      ...
      "condition": "Permitted only if no direct threat or violence occurs and delivered by characters with high humour levels."
    },
