...
- Timestamp: `2026-06-29T20:26:18.455Z`
...
CLUES ALREADY REVEALED TO READER: clue_1, clue_2, clue_3, clue_4, clue_mechanism_visibility_core, clue_14, rh_1, rh_2, clue_5, clue_6, clue_7, clue_8, clue_core_contradiction_chain, clue_culprit_direct_1, clue_culprit_direct_edward_marwood, clue_core_elimination_chain, clue_15, clue_16, clue_18, clue_12, clue_13, clue_late_optional_slot_1 — do not reveal these as new information.
...
• Suspect cleared: Beatrice Hargrave[SHE] — Proof of kitchen presence and ledger corrections unrelated to murder
• Suspect cleared: Charles Whitmore[HE] — Servants’ testimonies and location in main hall during murder time
• Suspect cleared: Daphne Sinclair[SHE] — Alibi verified by guest logs and Arthur Langley’s confirmation
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "Edward’s silence was absolute. He did not protest, did not plead. Instead, he stared at the sundial experiment notes on the table, the evidence arrayed before him like a final judgment. The truth, once obscured by loyalty and fear, now stood exposed in the col..."
...
Known location profile anchors: Marwood Manor, The Sundial Terrace, Marwood Manor Library, Servants' Hall, Family Study, Library
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Marwood Manor", "The Sundial Terrace", "Marwood Manor Library", "Servants' Hall", "Family Study", "Library"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 10: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a noun-phrase atmosphere — e.g. "The smell of damp stone in the cellar…" / "A chill from the landing…" / "The sound of the clock in the hall…". Pattern: "The/A [noun] of/in/from [place]…". Anchor opening in "Library". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=26447; context=4461; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
Suspect pressure target(s): Edward Marwood, Beatrice Hargrave, Charles Whitmore, Daphne Sinclair
...
Manner of death (MUST be named in the reveal): state plainly how the victim died — cause of death: stabbed with a dagger. Surface it in the prose in plain words (e.g. "stabbed with a dagger") — not only how the clock/timeline was manipulated. A reveal that explains the concealment but never the killing fails the fair-play contract.
Solution chain (plot clarity, NOT a timeline ledger): present the solution as ONE clear spine the reader can follow — Edward Marwood, by the named means, with the established opportunity, for a specific reason. Clear each other suspect in a line or two; do NOT walk through every alibi and timeline as bookkeeping. A convoluted multi-timeline elimination is the failure mode here.
...
Motive (specific + emotional, NEVER a bare label): develop WHY Edward Marwood killed Edith Marwood with concrete, personal specificity drawn from their relationship and history — the emotional truth that made murder feel, to Edward Marwood, like the only door left. A one-word motive ("jealousy", "greed", "revenge") asserted without that interior truth is a FAIL: name what was actually at stake for Edward Marwood and why no lesser act would serve.
Closure (emotional payoff, not a verdict): end on human consequence — the cost to those left behind, Edward Marwood's undoing, and the detective's reflection on what the truth changes — not a clinical "innocence established by the physical record." The reader should FEEL the weight of the resolution, not merely verify it.
...
- Chapter 10:
  ...
  - Scene is set in: Library — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "Edward’s silence was absolute. He did not protest, did not plead. Instead, he stared at the sundial experiment notes on the table, the evidence arrayed before him like a final judgment. The truth, once obscured by loyalt...".
  ...
  - ⚠ CULPRIT REVELATION REQUIRED (Confrontation with sundial shadow evidence, ledger analysis, and authority channel breach): this chapter MUST name "Edward Marwood" explicitly as the murderer before the chapter ends. Include a complete evidence chain using "because / therefore / which proves" for each piece of proof. Do not let the chapter end with the culprit unnamed or the verdict ambiguous.
  - Motive statement REQUIRED: the culprit must explicitly state or acknowledge their motive in this chapter. Canonical motive: "Fear of scandal exposure after Edith's threats". Do not paraphrase or omit it.
...
⛔ MANDATORY RESOLUTION — THIS IS THE FINAL CHAPTER:
  ...
  1. ACCUSATION: The detective names Edward Marwood and states the charge.
  2. CULPRIT RESPONSE: Edward Marwood confesses with detail, or reacts in a way that confirms guilt.
  3. METHOD: State BOTH how the victim was killed (name the manner of death — e.g. the stab wound, the poison, the blow) AND how the scene/timeline was manipulated (compose in your own words from these elements, do NOT quote them verbatim: murder, concealed, manipulating, timeline, false, servant, testimonies, misuse, sundial, shadow, alibi, edward). Naming only the concealment is a failure.
  4. CONSEQUENCE: What happens to Edward Marwood (arrested, fled, taken into custody).
  ...
  6. SUSPECT CLEARANCES (MANDATORY — lint-enforced): every non-culprit suspect below MUST be named explicitly and cleared in a dedicated paragraph in THIS chapter:
    • "Arthur Langley" — include a paragraph that: (a) names "Arthur Langley" by name, (b) states a clearance phrase (cleared / ruled out / innocent / alibi holds / alibi confirmed / could not have), (c) includes a reasoning connector (because / therefore / which proves / alibi). Example: "Arthur Langley was cleared because [evidence]; [their] alibi confirmed [they] could not have committed the crime." All three elements must be in the SAME paragraph — do not split across paragraphs.
    • "Beatrice Hargrave" — include a paragraph that: (a) names "Beatrice Hargrave" by name, (b) states a clearance phrase (cleared / ruled out / innocent / alibi holds / alibi confirmed / could not have), (c) includes a reasoning connector (because / therefore / which proves / alibi). Example: "Beatrice Hargrave was cleared because [evidence]; [their] alibi confirmed [they] could not have committed the crime." All three elements must be in the SAME paragraph — do not split across paragraphs.
    • "Charles Whitmore" — include a paragraph that: (a) names "Charles Whitmore" by name, (b) states a clearance phrase (cleared / ruled out / innocent / alibi holds / alibi confirmed / could not have), (c) includes a reasoning connector (because / therefore / which proves / alibi). Example: "Charles Whitmore was cleared because [evidence]; [their] alibi confirmed [they] could not have committed the crime." All three elements must be in the SAME paragraph — do not split across paragraphs.
    • "Daphne Sinclair" — include a paragraph that: (a) names "Daphne Sinclair" by name, (b) states a clearance phrase (cleared / ruled out / innocent / alibi holds / alibi confirmed / could not have), (c) includes a reasoning connector (because / therefore / which proves / alibi). Example: "Daphne Sinclair was cleared because [evidence]; [their] alibi confirmed [they] could not have committed the crime." All three elements must be in the SAME paragraph — do not split across paragraphs.
...
Charles Whitmore was cleared because the Servants’ testimonies and location in main hall during murder time established by the evidence and the timeline placed Charles Whitmore outside the fatal sequence of events. Charles Whitmore's alibi was confirmed, which proved Charles Whitmore could not have been the culprit the room first feared.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Edward’s defiant silence breaks into resigned acceptance"
      ]
    },
    ...
    "emotionalRegister": "The manor faces the emotional fallout of truth and loss, with fractured relationships and uncertain futures.",
