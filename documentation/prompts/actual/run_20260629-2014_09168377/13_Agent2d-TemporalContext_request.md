...
- Timestamp: `2026-06-29T20:19:47.555Z`
...
- YOU MUST use the exact year and month specified above: January 1937
- This date has been specifically selected for THIS mystery to ensure uniqueness
- DO NOT change the year or month - use January 1937 exactly
- The season is FIXED as "winter" (it follows from January) — use it exactly; do not pick a different season
...
- All details must be historically accurate for January 1937 specifically
- Generate fresh, original descriptions - do not copy example phrasing
- Make this feel like the specific moment of January 1937
...
- Technology available: radio receivers common in drawing rooms, domestic telephones connected via party-line exchanges, manual typewriters used for correspondence and record-keeping
- Forensics: fingerprinting standard practice with regional lab analysis delays, basic toxicology tests available but limited sensitivity, ballistics analysis emerging, dependent on external experts
- Social norms: strict class distinctions governing interactions between staff and family, daily routines and meal times highly regimented, deference expected toward estate owner and senior household members

Task:
1. Use the specified date: January 1937
