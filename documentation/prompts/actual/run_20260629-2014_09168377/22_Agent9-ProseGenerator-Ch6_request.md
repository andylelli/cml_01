...
- Timestamp: `2026-06-29T20:24:11.805Z`
...
• [clue_7] edward, authority, unmonitored, access, manipulate, watch, position, garden, sundial, area, confirmed, logs
  Category: spatial | Criticality: essential | Supports inference step 4
  Points to: edward, authority, unmonitored

• [clue_8] exclusive, access, knowledge, prove, premeditation, ability, stage, false, timeline, contradicting, servant, claims
  Category: temporal | Criticality: essential | Supports inference step 4
  Points to: exclusive, access, knowledge

• [clue_core_contradiction_chain] shadow, length, direction, correspond, time, servants, claimed, death, based, solar, geometry, little
  Category: temporal | Criticality: supporting | Supports inference step 1
  Points to: shadow, length, direction

• [clue_culprit_direct_1] direct, links, edward, marwood, mechanism, access, point, before, discriminating, excludes, competing, suspect
  Category: testimonial | Criticality: essential | Supports inference step 1
  Points to: physical, trace, opportunity, indicate, edward, marwood, means, making, direct, clue, culprit, identification

• [clue_culprit_direct_edward_marwood] direct, ties, edward, marwood, mechanism, access, point, before, discriminating, excludes, competing, suspect
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: direct, shows, edward, marwood, means, opportunity, narrowing, solution, uniquely, toward, culprit, eligible
...
CLUES ALREADY REVEALED TO READER: clue_1, clue_2, clue_3, clue_4, clue_mechanism_visibility_core, clue_14, rh_1, rh_2, clue_5, clue_6 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): edith, marwood, watch | shadow, length, direction | household, ledger, pages | since, edith, confronted | murder, concealed, manipulating | scandal, exposure | rh_1 | rh_2 | edward, marwood, study | given, adjusted, murder
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "He jotted a note in his pocketbook, the scratch of his pen loud in the quiet. The investigation’s focus had shifted: Edward Marwood’s alibi, once a shield, was now a source of suspicion. Motive and opportunity had aligned, and the cost of concealment was writt..."
...
Known location profile anchors: Marwood Manor, The Sundial Terrace, Marwood Manor Library, Servants' Hall, Family Study, Garden sundial area and household office
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Marwood Manor", "The Sundial Terrace", "Marwood Manor Library", "Servants' Hall", "Family Study", "Garden sundial area and household office"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 6: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with an expository setup — e.g. "It was not until…" / "There had been no word since…" / "There was a note on the table…". Begin with "It was", "There was", or "There had been" followed immediately by a specific condition, event, or discovery. Do not open on generic mood alone — but still anchor the location and weave in the sensory + time-of-day grounding across the next sentence or two. Anchor opening in "Garden sundial area and household office". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.

[⚠ INTERNAL QUALITY DIAGNOSTICS — DO NOT REPRODUCE ANY PART OF THIS SECTION IN YOUR STORY OUTPUT. These are private generator observations for your consideration only. Your narrative must read as if this section does not exist. Never include phrases from this block in character dialogue, narration, or description.]

PRIOR CHAPTER QUALITY OBSERVATIONS:
- Chapter 4 (score 88/100):
  Quality gaps noted: required clue surfacing incomplete (2/4)
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=17671; context=6141; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, physical_plausibility]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- clue_14 must appear in Act 2, Scene 3 via Behavioral observation
...
- clue_culprit_direct_edward_marwood must appear in Act 2, Scene 3 via Direct observation
...
- Chapter 6:
  ...
  - Scene is set in: Garden sundial area and household office — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "He jotted a note in his pocketbook, the scratch of his pen loud in the quiet. The investigation’s focus had shifted: Edward Marwood’s alibi, once a shield, was now a source of suspicion. Motive and opportunity had aligne...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • edward, exclusive, access, ledger, knowledge, documented, others, lack [clue_13]
    ...
    • edward, seen, nervously, writing, notes, potential, scandal, edith, confrontation [clue_14]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • charles, whitmore, attendance, public, event, documented, witnessed, murder, time [clue_15]
      Points to: eliminates, charles, whitmore, because, corroborated, alibi, access, logs
    • guest, logs, surveillance, place, daphne, sinclair, away, garden, sundial, area, murder, time [clue_16]
      Points to: eliminates, daphne, sinclair, because, corroborated, alibi, surveillance
    • beatrice, kitchen, access, ledger, handling, times, confirm, absence, crime, scene [clue_18]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • access, logs, show, exclusive, unmonitored, edward, garden, sundial, area [clue_7]
      Points to: edward, authority, unmonitored
    • edward, exclusive, access, alongside, timeline, contradictions [clue_8]
      Points to: exclusive, access, knowledge
    • beatrice, kitchen, access, logs, servant, testimonies, confirm, presence, away, crime, scene, murder [clue_core_elimination_chain]
      Points to: eliminates, beatrice, hargrave, because, corroborated, alibi, access, logs
    • stopped, watch, visible, cast, shadow, face, garden [clue_culprit_direct_1]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • experiment, replicates, sundial, shadow, identical, watch, face, confirming, timing, discrepancies [clue_culprit_direct_edward_marwood]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • shadow, measurements, contradict, servants, timeline, explicitly [clue_core_contradiction_chain]
      Points to: shadow, length, direction
...
[
  {
    ...
    "emotionalRegister": "Revelations about timeline manipulation recast earlier events with betrayal and deceit.",
    ...
    "humourGuidance": {
      ...
      "character": "Beatrice Hargrave",
      "form": "polite_savagery",
      "condition": "Allowed only if delivered by a character with humourLevel > 0.7 and no direct threat or violence present."
    },
