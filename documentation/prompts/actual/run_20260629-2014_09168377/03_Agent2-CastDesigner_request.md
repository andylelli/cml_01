...
- Timestamp: `2026-06-29T20:15:25.238Z`
...
**Setting**: 1930s - A large, isolated manor house with multiple wings, servant quarters, and extensive grounds including gardens and stables.
**Crime Type**: Murder
**Social Context**: strict class distinctions governing interactions between staff and family, daily routines and meal times highly regimented, deference expected toward estate owner and senior household members
**Tone**: Cozy
...
2. Schema fix required: crimeDynamics.detectiveCandidates[0] must be string, got object
