...
- Timestamp: `2026-06-29T20:23:37.823Z`
...
## Character Pressure
Daphne Sinclair is approaching a point of breakdown. Stress and strain should be accumulating visibly — through behaviour, not statement. No confrontation yet.
...
• [clue_5] edward, marwood, study, logs, housekeeper, testimony, conflict, claims, presence, four, afternoon, recalls
  Category: testimonial | Criticality: essential | Supports inference step 3
  Points to: edward, marwood, study

• [clue_6] given, adjusted, murder, time, sundial, ledger, edward, alibi, overlaps, window, making, claimed
  Category: temporal | Criticality: essential | Supports inference step 3
  Points to: given, adjusted, murder
...
CLUES ALREADY REVEALED TO READER: clue_1, clue_2, clue_3, clue_4, clue_mechanism_visibility_core, clue_14, rh_1, rh_2 — do not reveal these as new information.

INVESTIGATION LOG — WHAT IS ESTABLISHED (do not re-establish, do not repeat):
• Evidence already established (reference only — do NOT restate or quote these; advance beyond them): edith, marwood, watch | shadow, length, direction | household, ledger, pages | since, edith, confronted | murder, concealed, manipulating | scandal, exposure | rh_1 | rh_2
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "As the room emptied, Arthur caught a final glimpse of Edward, hunched over his notebook, the word 'scandal' circled twice. The evidence was mounting—not enough for accusation, but sufficient to force a reassessment of every testimony. The winter darkness press..."
...
Known location profile anchors: Marwood Manor, The Sundial Terrace, Marwood Manor Library, Servants' Hall, Family Study, Study and servants’ quarters
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Marwood Manor", "The Sundial Terrace", "Marwood Manor Library", "Servants' Hall", "Family Study", "Study and servants’ quarters"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 5: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with a temporal subordinate clause — e.g. "When [Name] entered…" / "After the last guest…" / "Before the household had stirred…" / "As the light faded…". Anchor opening in "Study and servants’ quarters". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=14738; context=9137; dropped=[humour_guide, location_profiles, texture_pool, continuity_context]; truncated=[location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 5:
  ...
  - Scene is set in: Study and servants’ quarters — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "As the room emptied, Arthur caught a final glimpse of Edward, hunched over his notebook, the word 'scandal' circled twice. The evidence was mounting—not enough for accusation, but sufficient to force a reassessment of ev...".
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    Render each as something a character SEES, DOES, or SAYS on the page. The bracketed text is a
    DESCRIPTION of the evidence for you — do NOT transcribe it as narration. Copying a clue's
    description sentence verbatim into the prose FAILS validation.
    • murder, time, window, overlaps, edward, claimed, study, occupancy [clue_6]
      Points to: given, adjusted, murder
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Edward’s hand trembles briefly as he recounts his alibi"
      ]
    },
    ...
    "emotionalRegister": "Focus shifts onto Edward Marwood as motive and opportunity align, deepening tensions.",
