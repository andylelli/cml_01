...
- Project ID: ``
- Timestamp: `2026-07-17T04:20:25.268Z`
...
- Eleanor Voss
  ...
  Connection to victim: Professional acquaintances with a troubled history over medical ethics.; Eleanor exposed a medical malpractice case that involved Mallory years ago..
  Investigation relevance: is actively driving interviews and credibility checks in this scene.
  Suspicion/pressure cue seed: sharp attention to detail.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Captain Ivor Hale
  Public identity anchor: Retired Naval Officer; suspect 
  Connection to victim: Friends turned adversaries over differing war experiences.; Both served in the war, but Ivor’s actions haunt Mallory as she feels guilty about her choices..
  Investigation relevance: access plausibility: high | alibi window: 8:00 PM to 9:00 PM | opportunity channel: hotel access.
  Suspicion/pressure cue seed: nervous when discussing the victim.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Beatrice Quill
  Public identity anchor: Socialite; suspect 
  Connection to victim: Business partners in a charity event.; They organized a fundraiser together, though Beatrice's financial troubles may threaten their partnership..
  Investigation relevance: access plausibility: medium | alibi window: 7:45 PM to 8:30 PM | opportunity channel: hotel staff access.
  Suspicion/pressure cue seed: defensive when questioned.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Hugo Vane
  Public identity anchor: Disillusio
...
• [clue_mechanism_visibility_core] mechanism, relies, clock, witness, noted, expose, false, timing
...
• [clue_mid_1] mechanism, relies, clock, witness, noted, expose, false, timing
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: clock, mechanism, tampered
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=7969; context=11785; dropped=[none]; truncated=[first_appearance_contracts, location_profiles, temporal_context, pronoun_accuracy]
...
- Chapter 1:
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • clock, mechanism, visible, shows, signs, tampering [clue_mechanism_visibility_core] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
...
Chapter 1 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The victim's body lying on the floor with a head wound."
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the victim was murdered, creating immediate tension among the suspects."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor glances nervously at the clock, sensing the weight of the moment."
      ]
    },
    "summary": "Eleanor Voss arrives at the seaside hotel to find a tense atmosphere. In a dimly lit room, she discovers the victim's body sprawled on the floor, a head wound visible. Shock ripples through the room as Captain Hale, Beatrice Quill, Hugo Vane, and Dr. Finch react to the scene. Eleanor notes that the clock shows a different time than what witnesses claim.",
    "beat": "gathering",
    "estimatedWordCount": 1800,
    "pivotElement": "The victim's body lying on the floor with a head wound.",
    "factEstablished": "Establishes that the victim was murdered, creating immediate tension among the suspects.",
    ...
    "emotionalRegister": "An atmosphere of opulence is marred by an undercurrent of dread.",
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 1: the clue [clue_mechanism_visibility_core] (mechanism, relies, clock, witness, noted, expose, false, timing) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_core_contradiction_chain] (witness, noted, clock, striking, quarter, nine, before, murder) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_mid_1] (mechanism, relies, clock, witness, noted, expose, false, timing) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
...
```text
{
  ...
  "chapters": [
    {
      ...
      "summary": "Eleanor Voss arrives at the seaside hotel and discovers Dr. Mallory Finch dead in the Grand Library. The discovery of the body, a contradictory clock, and the reactions of the assembled suspects set the investigation in motion.",
      "paragraphs": [
  ...
  "note": "",
  "audit": {
    "locked_fact_phrases": "present in paragraph 1, 2, 3, 9 | absent",
    "season_words_used": "summer, summery, midsummer | none",
    "discriminating_test_present": "no",
    "required_clues_present": "clue_mechanism_visibility_core: paragraph 1; clue_core_contradiction_chain: paragraph 2; clue_mid_1: paragraph 1",
    "early_observation_present": "Eleanor observes the clock at ten minutes past eight and notes the contradiction with Beatrice's statement in paragraph 1",
