...
- Project ID: ``
- Timestamp: `2026-05-17T19:53:35.427Z`
...
Tension escalates as the investigation reveals secrets and motives.
...
Rationale: Eleanor's sharp wit can lighten the tension of the investigation.
...
• [clue_1] The clock shows ten minutes past eleven, but is smudged.
  Category: temporal | Criticality: essential | Supports inference step 1
  Points to: Indicates the clock was tampered with.

• [clue_2] Witnesses recall the clock striking the hour incorrectly before the incident.
  Category: temporal | Criticality: essential | Supports inference step 2
  Points to: Suggests the clock cannot be trusted.
...
• Evidence in reader's hands: The clock in the study was set back to mislead the investigation regarding the time of death. | The smudge indicates recent handling, suggesting tampering.
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "In that moment, Beatrice understood that the truth would not be easily uncovered. Each character held their secrets close, and as they began to piece together the fragments of Eleanor's last moments, the realization dawned that the truth might be more complica..."
...
- Chapter 3: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with an explicit time marker — e.g. "That morning…" / "By the time dusk fell…" / "It was nearly four o'clock…" / "On the second day after the discovery…". Time must be in the first clause. Anchor opening in "Eleanor Voss's study". HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/sound/echo/silence/creak/whisper/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark. These are validated requirements, not style suggestions; missing them triggers a retry.
...
PROMPT BUDGET SUMMARY: budget=32000 tokens; fixed=8143; context=10769; dropped=[none]; truncated=[pronoun_accuracy, location_profiles, temporal_context]
...
- Chapter 3:
  ...
  - Continuity bridge: in the first 120 words, visibly connect from the previous chapter's final beat. Carry forward one unresolved element (object, accusation, emotional pressure, or immediate physical action) from: "In that moment, Beatrice understood that the truth would not be easily uncovered. Each character held their secrets close, and as they began to piece together the fragments of Eleanor's last moments, the realization dawn...".
  - CLUE OBLIGATIONS — mandatory prose elements (do NOT omit or bury):
    • The clock shows ten minutes past eleven, but is smudged. [clue_1] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: Indicates the clock was tampered with.
    ...
    • Witnesses recall the clock striking the hour incorrectly before the incident. [clue_2] ⚠ EARLY PLACEMENT — write this in paragraphs 1 or 2 of the chapter
      Points to: Suggests the clock cannot be trusted.
      ↳ MANDATORY TWO-PARAGRAPH STRUCTURE (must appear in paragraphs 1 or 2 — no later):
         Paragraph 1: The POV character physically approaches or directly observes this evidence.
           The narration or dialogue explicitly states what is seen (use the exact locked phrase if one applies).
...
Chapter 3 (Act 1) completeness contract:
  PIVOT ELEMENT (MANDATORY — write this into the prose, shown not told): "The note mentioning 'an hour gone by.'"
  FACT ESTABLISHED (MANDATORY — reader must know this by chapter end): "Establishes that the tampered clock misleads the investigation regarding the time of death."
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Eleanor stares blankly at the note, her mind racing with fear."
      ]
    },
...
□ Forbidden seasonal words: spring, summer, winter.
□ Chapter 3: "The clock shows ten minutes past eleven, but is smudged." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
□ Chapter 3: "Witnesses recall the clock striking the hour incorrectly before the incident." is placed in the first 25% of the chapter, followed by an explicit inference or suspicion paragraph.
