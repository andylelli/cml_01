...
- Timestamp: `2026-07-24T17:25:40.740Z`
...
- Inspector Harold Wren
  ...
  Connection to victim: directly affected by Lady Beatrice Ellsworth's death and its fallout.
  Investigation relevance: is actively driving interviews and credibility checks in this scene.
  Suspicion/pressure cue seed: Solve the case and uphold justice.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Charles Pembroke
  Public identity anchor: Estate Manager; suspect 
  Connection to victim: Lady Beatrice trusted Charles as her estate manager but recently decided to change her will, jeopardizing Charles's expected inheritance.; Lady Beatrice Ellsworth and Charles Pembroke had a longstanding professional relationship, but the will change caused severe tension between them..
  Investigation relevance: access plausibility: high | alibi window: Between midday and one o'clock | opportunity channel: Access to sundial and gardens.
  Suspicion/pressure cue seed: Frequently agitated after victim's death.
  Investigator read: include one immediate observational inference (gesture, gaze target, pause, object grip), but do not state guilt as fact.

- Simon Clarkson
  Public identity anchor: Head Gardener; suspect 
  Connection to victim: Simon, the head gardener, was publicly reprimanded by Lady Beatrice for budget issues, straining their working relationship.; Lady Beatrice Ellsworth and Simon Clarkson's professional relationship soured after the austerity measures imposed by Lady Beatrice..
  Investigation relevance: access plausibility: high | alibi window: Late morning to early afternoon | opportunity channel: Access to gardens and toolshed.
  Suspicio
...
### Eleanor Fairchild
Eleanor Fairchild is the charming socialite navigating the precariousness of wealth and status in the early 1930s. Her florid, theatrical speech and sardonic wit mask a desperation to maintain social standing amid changing fortunes, reflecting the vulnerability of women dependent on inheritance and favor in a class-conscious society. Her ambiguous alibi and personal conflicts illustrate the era’s tensions between appearance and reality in high society.
Era intersection: Eleanor’s ambitions and fears underscore the era’s fragile social hierarchies and the role of women’s agency within them.

### Thomas Granger
Thomas Granger epitomizes the discreet butler balancing loyalty with concealed ambitions in a hierarchical estate environment. His formal speech and self-deprecating humor reflect the social expectations of service roles in the 1930s, while his hidden resentments reveal the vulnerabilities of those reliant on aristocratic patronage. His presence underscores the delicate social fabric of the manor, where personal scandals and financial stakes lurk beneath polished manners.
Era intersection: Thomas’s internal conflict illustrates the tenuous position of senior staff amid shifting economic and social tides of the Depression era.
...
Lively, theatrical, with flirtatious and sardonic wit that shifts swiftly between coquettish charm and biting remarks.
[comfortable] Darling, one must play the game to win it; fortune favors the bold and the clever alike.
[evasive] I was elsewhere, as anyone could attest; such rumours are the pastime of those with idle tongues.
[stressed] One tires of whispers and falsehoods; they cling like shadows in the night.
Humour: Her sardonic wit punctuates her speech with playful yet cutting remarks.

### Thomas Granger (he/him/his)
Formal and measured with polished manners, interspersed with dry, self-deprecating humor revealing quiet awareness of his ambitions.
[comfortable] Well, one does what one can, doesn’t one? The estate runs on more than just good intentions.
[evasive] I was overseeing preparations; several staff may confirm my presence during that time.
[stressed] There are limits to what any man can manage before the strain shows, even behind a calm face.
Humour: His dry humor offers subtle irony on his own ambitions and constraints.
...
### Thomas Granger (he/him — NEVER she/her)
Thomas speaks with a polished formality, occasionally punctuated by dry, self-deprecating humor that reveals a wry awareness of his own ambitions and limitations
His tone remains respectful but carries subtle hints of irony when discussing matters of status and duty.
Thomas is torn between his duty to the estate and the desire to secure his own future, haunted by the fear that his secrets might surface and undo him.
...
• [clue_thermometer_reading] Direct observation of garden thermometer
...
Known location profile anchors: Ashcombe Manor, Walled Garden Sundial, Manor Library, Servants’ Hall, Estate Gatehouse, Garden near the sundial
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Ashcombe Manor", "Walled Garden Sundial", "Manor Library", "Servants’ Hall", "Estate Gatehouse", "Garden near the sundial"
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=8448; context=12399; dropped=[none]; truncated=[first_appearance_contracts, location_profiles, temporal_context, pronoun_accuracy]
...
- clue_thermometer_reading must appear in Act 1, Scene 1 via Direct observation of garden thermometer
...
Suspect pressure target(s): Charles Pembroke, Simon Clarkson, Margaret Huxley, Eleanor Fairchild, Thomas Granger
...
- Chapter 1:
  ...
  - VICTIM IDENTITY LOCK (MANDATORY): name the victim as "Lady Beatrice Ellsworth" in the discovery scene. After first mention, do not use unnamed placeholders such as "the victim" without naming Lady Beatrice Ellsworth in the same paragraph.
  ...
  - Scene is set in: Garden near the sundial — reference it naturally within the paragraph, never as your opening phrase.
  ...
  - INVESTIGATOR ESTABLISHMENT REQUIRED: Inspector Harold Wren must claim or be recognised as the investigator in this chapter. Establish Inspector Harold Wren as the detective-in-charge within the first two paragraphs — Inspector Harold Wren IS the investigator. Do NOT have any character suggest a "real" detective is still coming, or imply that authority has not yet been delegated. Inspector Harold Wren begins the investigation in this chapter.
  ...
  - PLANT OBLIGATIONS (incidental appearances): each item below MUST appear in this chapter as a passing physical detail a character sees, handles, or walks past — with its significance UNFLAGGED:
    • observation, sundial, warped, copper, plate, frost, crystals, reveals, physical, mechanism, delaying, shadow [plant:clue_mechanism_visibility_core]
    • sundial, shadow, points, time, quarter, past, watch, stopped [plant:clue_shadow_time_contradiction]
    • wristwatch, lady, beatrice, body, stopped, exactly, quarter, past [plant:clue_stopped_watch]
    • sundial, shadow, points, time, quarter, past, watch, stopped [plant:clue_witness_statements]
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Lady Beatrice stands silently near the body, her face pale with grief"
      ]
    },
    ...
    "emotionalRegister": "A heavy stillness and somber shock settle over the estate at the discovery of the murder.",
...
□ Forbidden seasonal words: spring, autumn, winter.
□ Chapter 1: the clue [clue_thermometer_reading] (thermometer, garden, wall, recorded, temperature, thirty, degrees, fahrenheit) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
□ Chapter 1: the clue [clue_struck_wound_observation] (victim, severe, head, wound, consistent, being, struck, heavy, copper, sundial, gnomon, blood) is placed in the first 25% of the chapter, dramatized in your own words, followed by an explicit inference or suspicion paragraph.
