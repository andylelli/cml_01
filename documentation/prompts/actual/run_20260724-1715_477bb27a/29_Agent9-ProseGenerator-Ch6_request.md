...
- Timestamp: `2026-07-24T17:31:24.927Z`
...
• [clue_victim_before_quarter_past_ten_contradiction] since, victim, died, before, quarter, past, charles, pembroke, alibi, claiming, presence, eleven
  Category: temporal | Criticality: essential | Supports inference step 3
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): contradiction, invalidating, charles, pembroke, alibi

• [clue_witness_timing_conflict] witnesses, claim, seeing, victim, alive, until, twenty, past, conflicting, stopped, watch, time
  Category: testimonial | Criticality: essential | Supports inference step 2
  Later significance (context for YOU — do NOT state this in the prose; meaning surfaces only at the licensed deduction beats): conflict, witness, statements, physical, time
...
CONTINUITY HANDOFF — previous chapter closing beat:
  • "The late afternoon light slanted across the office, casting long shadows that stretched toward the garden. Inspector Harold Wren lingered at the window, watching as Eleanor Fairchild paused among the rosebeds, her silhouette etched against the summery haze. He..."
...
Known location profile anchors: Ashcombe Manor, Walled Garden Sundial, Manor Library, Servants’ Hall, Estate Gatehouse, Library
LOCATION NAME CAPITALISATION (HARD REQUIREMENT — validated):
All named locations in your prose MUST use the EXACT capitalisation from the CML profiles.
Canonical forms: "Ashcombe Manor", "Walled Garden Sundial", "Manor Library", "Servants’ Hall", "Estate Gatehouse", "Library"
Writing a location in lowercase (e.g. "drawing room" instead of "Drawing Room") is a validated error. Every time you mention a named location, copy its capitalisation from the list above.
- Chapter 6: OPENING STYLE (HARD): Start the VERY FIRST SENTENCE with an expository setup — e.g. "It was not until…" / "There had been no word since…" / "There was a note on the table…". Begin with "It was", "There was", or "There had been" followed immediately by a specific condition, event, or discovery. Do not open on generic mood alone — but still anchor the location and weave in the sensory + time-of-day grounding across the next sentence or two. Anchor opening in "Library". The opening style above governs only your FIRST SENTENCE; the grounding below may land anywhere in the first 2 paragraphs (it need not be sentence one, and never conflicts with the chosen opening style). HARD REQUIREMENT for the first 2 paragraphs: (a) include 2+ sensory words — choose from smell/scent/odor/fragrance/sound/echo/silence/whisper/creak/cold/warm/damp/rough/smooth/glow/shadow/flicker/dim — and (b) include 1+ atmosphere/time word — choose from rain/wind/fog/storm/mist/thunder/evening/morning/night/dawn/dusk/lighting/weather/season/afternoon/midday/noon/midnight/twilight/sunrise/sunset/daylight/sunlight/overcast/cloudy/bright/dark/grey/pale/chill/crisp/drizzle/haze/lamplight/firelight. These are validated requirements, not style suggestions; missing them triggers a retry.
...
- USED-UP PHRASINGS (these exact wordings are spent — they already appear in earlier chapters and repetition is this story's biggest measured quality risk): "inspector harold wren lingered by the sundial", "harold wren lingered by the sundial his", "in the kitchen from noon until two".
...
PROMPT BUDGET SUMMARY: budget=24000 tokens; fixed=19960; context=4760; dropped=[humour_guide, location_profiles, texture_pool, continuity_context, world_document, character_personality, physical_plausibility, era_authenticity, temporal_context, craft_guide]; truncated=[location_profiles, temporal_context, continuity_context, pronoun_accuracy]
...
- clue_argument_context must appear in Act 2, Scene 3 via Witness accounts of argument between Lady Beatrice and Eleanor Fairchild
- clue_charles_premeditation_observation must appear in Act 2, Scene 3 via Behavioral observation
- clue_comparing_watch_and_sundial must appear in Act 2, Scene 3 via Direct observation
- clue_core_elimination_chain must appear in Act 2, Scene 3 via Corroborated elimination
- clue_culprit_direct_charles_pembroke must appear in Act 2, Scene 3 via Behavioral observation
- clue_footprint_moisture must appear in Act 2, Scene 3 via Forensic soil moisture analysis near sundial
- clue_gardener_testimony must appear in Act 2, Scene 3 via Simon Clarkson’s statements about garden activity
- clue_housekeeper_alibi must appear in Act 2, Scene 3 via Housekeeper Margaret Huxley’s alibi testimony
- clue_physical_evidence_contradiction must appear in Act 2, Scene 3 via Cross-check contradiction
- clue_servants_schedule must appear in Act 2, Scene 3 via Review of servants’ daily routine logs
- clue_staff_witness must appear in Act 2, Scene 3 via Staff testimony confirming Thomas Granger’s whereabouts
- clue_sundial_warping must appear in Act 2, Scene 3 via Physical inspection of sundial in garden
- clue_vehicle_log must appear in Act 2, Scene 3 via Chauffeur log entries for Thomas Granger
- clue_witness_timing_conflict must appear in Act 2, Scene 3 via Interviews with household witnesses
...
Suspect pressure target(s): Eleanor Fairchild
...
- Chapter 6:
  ...
  - CLUE OBLIGATIONS — each clue below MUST be dramatized, but in YOUR OWN WORDS:
    ...
    • witnesses, recall, heated, argument, charles, pembroke, lady, beatrice, regarding, professional, rivalry, fear [clue_charles_premeditation_observation]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • stopped, watch, time, quarter, past, sundial, shadow, indicates, inconsistent, temperature, data [clue_comparing_watch_and_sundial]
    ...
    • multiple, staff, confirm, margaret, huxley, attending, household, duties, kitchen, murder, timeframe [clue_housekeeper_alibi]
      OBSERVATION ONLY: put it on the page concretely — a character sees, handles, or hears it inside the scene. The detective may NOTICE (a pause, a second glance, a pocketed item) but must NOT state what it implies.
    • frost, crystals, copper, warping, confirm, physical, contraction, sundial [clue_physical_evidence_contradiction]
      OBSERVATION ONLY: put it on the page concretely — a character sees, handles, or hears it inside the scene. The detective may NOTICE (a pause, a second glance, a pocketed item) but must NOT state what it implies.
    ...
    • staff, recall, seeing, charles, pembroke, near, garden, gates, shortly, before, murder [clue_staff_witness]
      ⛔ SPOILER EMBARGO (pre-reveal chapter): surface ONLY the surface anomaly a character can see/hear/find.
         Do NOT name who it implicates, state the tamper direction or magnitude, or explain the mechanism in this chapter.
         Present it as an unexplained discrepancy; the culprit and method are revealed later.
    • close, examination, reveals, frost, crystals, sundial, base, slight, warping, copper, plate [clue_sundial_warping]
      OBSERVATION ONLY: put it on the page concretely — a character sees, handles, or hears it inside the scene. The detective may NOTICE (a pause, a second glance, a pocketed item) but must NOT state what it implies.
    • estate, vehicle, shows, departures, nine, eleven [clue_vehicle_log]
      OBSERVATION ONLY: put it on the page concretely — a character sees, handles, or hears it inside the scene. The detective may NOTICE (a pause, a second glance, a pocketed item) but must NOT state what it implies.
    • several, witnesses, report, seeing, lady, beatrice, alive, quarter, past [clue_witness_timing_conflict]
      OBSERVATION ONLY: put it on the page concretely — a character sees, handles, or hears it inside the scene. The detective may NOTICE (a pause, a second glance, a pocketed item) but must NOT state what it implies.
  ...
  - PLANT OBLIGATIONS (incidental appearances): each item below MUST appear in this chapter as a passing physical detail a character sees, handles, or walks past — with its significance UNFLAGGED:
    • close, examination, reveals, frost, crystals, sundial, base, slight, warping, copper, plate [plant:clue_sundial_warping]
    • frost, crystals, copper, warping, confirm, physical, contraction, sundial [plant:clue_physical_evidence_contradiction]
    • stopped, watch, time, quarter, past, sundial, shadow, indicates, inconsistent, temperature, data [plant:clue_comparing_watch_and_sundial]
  ...
  - Sensory obligation — use at least two of: golden lamp light pooling on desk, deep shadows in bookcases | soft crackle from fireplace, rustling curtains | warm beeswax and wood smoke. Mood: quiet tension and watchfulness.
...
[
  {
    ...
    "dramaticElements": {
      ...
      "microMomentBeats": [
        "Lady Beatrice quietly mourns the victim, unaware of the growing suspicion"
      ]
    },
    ...
    "cluesPlanted": [
      ...
      "clue_physical_evidence_contradiction",
