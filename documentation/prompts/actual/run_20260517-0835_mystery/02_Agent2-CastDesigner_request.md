...
- Project ID: ``
- Timestamp: `2026-05-17T08:36:03.791Z`
...
**Setting**: 1930s - a large manor house set within expansive grounds, featuring gardens and a small woodland area
**Crime Type**: Murder
**Social Context**: impact of the Great Depression on social classes, growing class tensions within society, rise of fascism affecting political discourse
**Tone**: Classic
