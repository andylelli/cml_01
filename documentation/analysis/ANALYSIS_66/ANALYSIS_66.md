...
| **6** | Probe #3 + the standing shipped-page pronoun census; then ONE external re-read | ~£1.5 + owner ~20min | 1–5 | 🟡 two runs burned, both invalid as the probe (see §7); relaunch pending on the completed fix | 2026-07-23 |
