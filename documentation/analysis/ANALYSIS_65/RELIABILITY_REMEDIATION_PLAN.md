...
| **5** | Post-Phase-1-probe re-rank (R1): measure what the inversion killed; fix top residual | ~2–4h | A_65 Phase-1 probe + Phase 3 | ⛔ **blocked by design** — this phase IS the probe read; nothing to build until it lands | — |
