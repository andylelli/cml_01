...
**Board status as of 2026-07-21 evening: 7.1–7.6 CLOSED · 7.7 M3 IN FLIGHT · 7.8 conditional · 7.9 pending.** The 7.6 design AND build both landed same-day (A_64); the owner cut the remaining run budget 33% (one probe — spent — and M3 pinned at exactly 4 runs).
